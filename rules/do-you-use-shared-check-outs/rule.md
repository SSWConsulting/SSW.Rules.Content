...
<p>In conjunction with <a href="/TFS/RulesToBetterVersionControlwithTFS(AKASourceControl)/Pages/CheckinRegularly.aspx">regular check-ins</a>, files in source control should never be locked unless absolutely necessary. Use either 'Unchanged - Keep any existing lock' - or 'None - Allow shared checkout'.</p>
