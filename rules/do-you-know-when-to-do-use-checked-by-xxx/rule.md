...
Reply to the "Done" email like below and CC the person who checked the email for you. In this way, you show it was double checked. <br>   <dl class="goodImage"><br><br>::: good  <br>![Figure: Reply Email with "Checked by XXX"](ruleDoneCheckedBy.png)  <br>:::<br></dl>
