...
* **Prepaid Time & Materials:** Time and Materials clients have the option of a prepaid discount – buying blocks of 40 hours per resource in advance entitles them to a $15 per hour discount on the hourly rate of each developer. This discount scales depending on the number of hours bought (eg. 80 hours = $20 off, 160 hours = $25 off). See the specific terms on our [Terms & Conditions](http://www.ssw.com.au/ssw/Standards/Forms/ConsultingOrderTermsConditions.aspx).
