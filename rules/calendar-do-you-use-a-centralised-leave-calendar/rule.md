...
The easiest way to do this is to use a shared calendar that is just used for leave. At SSW, we have the  **SSW Absence** calendar for this. This requires people to send their leave requests as an appointment to SSW Absence.

::: china
China Office:\
**SSW China Absence** - Hangzhou office leave requests should be sent to this address instead.
:::
