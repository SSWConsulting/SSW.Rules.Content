...
Try to categorise the task depending on the level of importance. Then, the number of approvers for an item should be based on this categorisation.

- Low-Medium Importance: 1 approval
  - e.g. Submitting a leave request
- Medium-High Importance: 2 approvals
  - e.g. Sending a company wide email 
- Critical Importance: 3+ approvals or consider leaving it with the "original approver".
  - e.g. Opening a new office location 
...
5. Explain to the new approvers if they think the approval may be controversial or if unsure about how to handle something add in the "original approver". That way everyone is aligned
