...
If you have to use some sort of secret or key to log in to the service being referenced, then some thought needs to be given to how those secrets can be secured.
