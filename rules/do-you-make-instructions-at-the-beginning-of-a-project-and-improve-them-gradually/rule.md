...
In the rule [Do you make awesome documentation?](/awesome-documentation) you can see the kinds of documents you need and how to structure them.
...
Add a readme.md to your solution (See [this guidance for markdown](https://docs.microsoft.com/en-us/azure/devops/project/wiki/markdown-guidance?view=vsts)).
...
![Figure: Level 2 Documentation includes database build scripts. We use SSW SQL Deploy to make keeping all databases on the same version simple](instructions-level2.jpg)  
