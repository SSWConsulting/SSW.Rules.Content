...
You should &#160;understand the hierarchy&#160;and try to use the heading tags ({ltHTMLChar}H1{gtHTMLChar}, {ltHTMLChar}H2{gtHTMLChar} or {ltHTMLChar}H3{gtHTMLChar}...) for titles and subtitles.&#160;<div>This has the following benefits&#58;<br><br></div>
