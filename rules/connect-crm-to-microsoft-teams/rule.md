...
* **Option A** - [Customize the command bar - Power Apps | Microsoft Docs](https://docs.microsoft.com/en-us/powerapps/maker/model-driven-apps/use-command-designer?WT.mc_id=DX-MVP-33518) (new approach - customizing command bar using the command designers)
