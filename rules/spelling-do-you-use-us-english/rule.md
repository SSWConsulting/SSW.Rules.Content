...
* Aim for the majority. Most web traffic is from American users, based in the USA and they expect American (most probably will assume anything different is an error)
