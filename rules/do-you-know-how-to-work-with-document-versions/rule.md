...
2. Make sure you are showing the version column in your document view. <br>      <dl class="image"><br><br>::: ok  <br>![](VersionColumn_Small.jpg)  <br>:::<br></dl>    TIP: You can add the column by selecting Modify View
3. Whenever you edit the document and check it in, SharePoint will automatically increase the version number.
    ...
    1. Save the file locally by selecting Send To | Download a Copy <br>         <dl class="image"><br><br>::: ok  <br>![](SaveFileLocally_Small.jpg)  <br>:::<br></dl>
