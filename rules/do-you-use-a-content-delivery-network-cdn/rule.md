...
<span class='intro'> <p>​If your site takes too long to load, there is a high chance your users will not wait and abandon viewing it. It is therefore important that we use techniques to make pages&#160;load as quickly as possible. One of these techniques is to use a Content Delivery Network (CDN) to deliver resource files, like images,&#160;javascript and CSS libraries, from a location as close to the user as possible.&#160;This will reduce the latency of resource loading and make for happier users.&#160;<br></p> </span>
