...
It is important for Sprint capacity planning to be consistent across all teams. As such, there should be consistency in how you estimate and calculate your story points. It's unreasonable to think that someone will be able to work productively and consecutively for 8 hours straight on a particular task. For example, if a task is allotted a 4 for effort (8 hours), the developer will probably spend 6 hours coding, and 2 of those 8 hours fixing bugs, or working on the admin side of things. This should be mapped out and consistently factored into the estimation of size and allocation of effort.
