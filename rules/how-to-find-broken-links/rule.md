...
<dl class="goodCode"><dt><pre>{ltHTMLChar}a href='KB.aspx?KBID=Q1097707'{gtHTMLChar}{ltHTMLChar}strong{gtHTMLChar}Q1097707{ltHTMLChar}/strong{gtHTMLChar}-How do I turn Option Strict on by default in VB.NET?{ltHTMLChar}/a{gtHTMLChar}<br></pre></dt><dd>Figure&#58; Example source code - finding broken links<br></dd></dl><p> It will return all the knowledge base articles in a paged format. The link scanner will click the Next Page link and eventually scan through the entire knowledge base. </p><p>
