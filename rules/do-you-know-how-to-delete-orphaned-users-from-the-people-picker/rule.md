...
**Figure: A user in the People Picker that was deleted from Active Directory** ![Figure: Searching in Active Directory for the user shows the user is in fact deleted](PeoplePicker-searching.jpg)
