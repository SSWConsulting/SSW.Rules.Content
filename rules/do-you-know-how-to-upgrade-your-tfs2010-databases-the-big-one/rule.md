...
<span class='intro'> <p>We recommend doing a <a href="/TFS/RulesToBetterTFS2012Migration/Pages/MigrationChoices.aspx">move to a new environment</a>&#160;because it has a much easier rollback path if something goes wrong.</p>
