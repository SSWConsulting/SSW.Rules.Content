...
<p>The <b>{ltHTMLChar}img{gtHTMLChar}</b> tag of HTML has 2 attributes that should not be used - height and width. &#160;Any image resizing should&#160; be done via CSS.&#160;If the height / width ratio doesn't match that of original image, the image will be stretched.</p>
