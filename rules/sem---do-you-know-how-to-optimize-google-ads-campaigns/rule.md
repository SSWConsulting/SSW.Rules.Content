...
<span class='intro'> <p>Google AdWords can be a useful and successful marketing platform when actively monitored and optimised. This should be done daily, where possible, to ensure that ads are not running and spending money ineffectively.</p> </span>
