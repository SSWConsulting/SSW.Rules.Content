...
<dl class="image"><br><br>::: ok  <br>![Figure: How to open Publish Web Site dialog box](PublishWebsite.jpg)  <br>:::<br></dl><dl class="image"><br><br>::: ok  <br>![Figure: Publish Web Site dialog box](PublishWebsiteDialog.JPG)  <br>:::<br></dl>    See more about [Publishing Web Sites](https://msdn.microsoft.com/en-us/library/20yh9f1b.aspx).
...
<dl class="image"><br><br>::: ok  <br>![Figure: How to open Publish Web dialog ('WebApp' is the name of this application)](PublishWebApp.jpg)  <br>:::<br></dl><dl class="image"><br><br>::: ok  <br>![Figure: Publish Web dialog box](PublishWebAppDialog.JPG)  <br>:::<br></dl>    See more about [How to Publish Web Applications](https://msdn.microsoft.com/en-us/library/aa983453.aspx).
