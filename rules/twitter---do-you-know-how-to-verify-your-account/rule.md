...
<span class='intro'> Twitter now lets anyone request a verified account (the blue tick goes public). Twitter says that an account will be verified if it is deemed of be of public interest.<br> </span>
