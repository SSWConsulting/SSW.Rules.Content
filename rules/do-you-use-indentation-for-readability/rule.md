...
<font class="ms-rteCustom-FigureGood" size="+0">Figure&#58; Good example – this reads a little better</font><p>Your new text should be kept to the left. When quoting text on web pages, other people or quoting past email history, indent it.</p><p><strong>Note&#58;</strong> This is almost as important as the <a href="/Pages/HowToUseBalloons.aspx">Do you use balloons instead of a 'Wall of Text'?</a> rule.</p><p><strong>See Also&#58;</strong> <a href="/Pages/KeeptheContext.aspx">Do&#160;you use {gtHTMLChar} and indentation to keep the context?</a><br>&#160;</p>
