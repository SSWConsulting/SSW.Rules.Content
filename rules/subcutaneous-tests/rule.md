...
---
Automated-UI testing tools like PlayWright are a great way to test the real experience of the users. Unfortunately, sometimes these tests can feel a bit too fragile. When that happens, Subcutaneous (aka just beneath the skin) tests look to solve this pain point by doing integration testing just below the UI.
...
e.g. [PlayWright](https://playwright.dev/)
