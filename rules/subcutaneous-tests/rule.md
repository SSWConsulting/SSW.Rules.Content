...
The gold standard is to automate the testing of subcutaneous tests by incorporating them into your DevOps processes such as when you perform a Pull Request.

You can do this using GitHub Actions or Azure DevOps.
