...
<span class='intro'> When providing a search to a list that has&#160; a builtin filter cotrols, your&#160;users can&#160;get confused when they see&#160;an unexpected result. Give an option to widen the search when filter is applied to the search in such a case as below example. </span>
