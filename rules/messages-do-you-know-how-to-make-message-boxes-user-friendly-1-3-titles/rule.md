...
::: bad  
![Figure: Bad Example - Title contains brief description of error, which is already contained in the message box](/BadMsgTitle.jpg)  
:::

::: good  
![Figure: Good Example - Title contains Product Name ("SSW eXtreme Emails!") and Product Version ("12.56")](/GoodMsgTitle.jpg)  
:::
