...
<p>· Consume the OData by SQL Server, via TSQL ???&#160;&#160;&#160; Then use BCS to call SQL Server. 
  <br>Summary&#58; SharePoint BCS -{gtHTMLChar} DataSourceType&#58; SQL Server -{gtHTMLChar} OData- {gtHTMLChar} CRM database</p>
...
<p>· Consume the OData by a BCS adapter + code calling web services (same story as above). 
  <br>Summary&#58; SharePoint BCS -{gtHTMLChar} code calling OData- {gtHTMLChar} CRM database</p>

<p>· Consume the RSS by &quot;SharePoint RSS view web part&quot; directly. 
  <br>Summary&#58; SharePoint RSS view web part -{gtHTMLChar} OData- {gtHTMLChar} CRM database 
