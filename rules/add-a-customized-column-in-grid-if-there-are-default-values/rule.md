...
::: bad
![Figure: you need to compare with the default values to know whether it is modified](badexampleforcustomizedcolumn.gif)
:::

::: good
![Figure: a "(customized)" column is an easier way to know if you have changed from the defaults](goodexampleforcustomizedcolumn.gif)
:::
