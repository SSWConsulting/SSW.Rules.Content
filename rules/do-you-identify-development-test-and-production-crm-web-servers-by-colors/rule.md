...
<h3 class="ssw15-rteElement-H3">CRM 2011</h3><p>Edit 
   ...
   <span class="ssw-rteStyle-FigureNormal">Figure&#58; CRM Ribbon color green to signify production environment</span></p><h3 class="ssw15-rteElement-H3">CRM 4</h3><p>Edit,<strong> {ltHTMLChar}CrmWebsiteRoot{gtHTMLChar}\</strong><strong>_common\styles\global.css.aspx</strong></p><dl class="image"><dt><div class="greyBox"><pre>         body.stage
            &#123;
