...
Dev containers take the whole idea of docker containerization to another level. By setting up a repo to have the right configuration, the dev team can be certain that every developer is going to get the exact same experience. To learn more read the rule: [Project setup - Do you containerize your dev environment?](/dev-containers)
