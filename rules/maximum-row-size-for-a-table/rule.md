...
type: rule
archivedreason: Duplicate of [https://ww.ssw.com.au/rules/only-use-unicode-datatypes-in-special-circumstances](/rules/only-use-unicode-datatypes-in-special-circumstances)
