...
When would you need a client's initials:

- Encouraged for all projects, but **required** for fixed-price projects as their initials on the original specifications would show that everyone was aligned and approved the specifications.

- If the client pushes back "Why am I signing it?" reply with: 
"This is not a legal document but a good practice to do before we start coding. It is cheaper to change the mockup's now. Changing the code once it is written is much more expensive."
