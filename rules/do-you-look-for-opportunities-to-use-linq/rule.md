...
<p>​For example, replace your foreach loops with Linq.</p><div class="ssw-rteStyle-CodeArea"><pre>var lucrativeCustomers = new List{ltHTMLChar}Customer{gtHTMLChar}();
...
<div class="ssw-rteStyle-CodeArea"><pre>var lucrativeCustomers = Customers.Where(c ={gtHTMLChar} c.Orders.Count {gtHTMLChar} 0).ToList();</pre></div> 
