...
&#123;
    ...
    &#125;
&#125;</pre></div>
<span class="ssw-rteStyle-FigureBad">Figure&#58; Bad Example - imperative programming using a foreach loop.</span> <div class="ssw-rteStyle-CodeArea"><pre>var lucrativeCustomers = Customers.Where(c ={gtHTMLChar} c.Orders.Count {gtHTMLChar} 0).ToList();</pre></div>
