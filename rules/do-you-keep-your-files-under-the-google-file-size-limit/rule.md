...
<span class='intro'> <p>As per Google on&#160;<a href="https&#58;//support.google.com/gsa/answer/4411411#settings" target="_blank">Spe cifications</a>&#58;</p><p class="ssw15-rteElement-Reference">A maximum file size may be enforced per crawler. Content which is after the maximum file size may be ignored. Google currently enforces a size limit of 500kb.</p> </span>
