...
<img alt="" class="ms-rteCustom-ImageArea" src="BadDesigner.png" /> <span class="ms-rteCustom-FigureBad">Bad example - Connection and Command objects in the Designer</span> <img alt="" class="ms-rteCustom-ImageArea" src="GoodDesigner.png" /> <span class="ms-rteCustom-FigureGood">Good example - Only visual elements in the designer</span> 
