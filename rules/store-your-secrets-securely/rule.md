...
These secrets **must not** be stored in source control in plain text – it is insecure by nature, and means they are sitting out in the open, wherever code has been downloaded, for anyone to see.
