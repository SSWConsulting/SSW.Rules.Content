...
2. **Exception #1 - Critical Bugs go into current Sprint**   
...
:::  
:::  
**Figure: Figure: The above email sample from a customer will, by default, go into a future Sprint, not the current**
