...
seoDescription: esigners often struggle to explain small UI tweaks to
  developers. Instead of vague messages or screenshots, use DevTools and a short
  recording to clearly demonstrate the changes.
uri: devtools-design-changes
authors: []
created: 2025-12-09T16:00:00.000Z
guid: 2bff4cda-f1d7-49ef-ad6c-b83a71e60422
---
...
* **Be direct** – Developers appreciate specific, actionable feedback.
...
This technique builds a shared understanding between designers and developers – and gets better results for users.

---

### Related Rules

- [Do you change from X to Y?](/change-from-x-to-y)
- [Do you cater to your audience?](/do-you-cater-to-your-audience)
- [Do you go beyond text when using Teams, Zoom, Skype, Chat?](/communication-do-you-go-beyond-text-when-using-teams-zoom-skype-chat)
- [Do you use Chrome DevTools Device Mode to design and test your mobile views?](/do-you-use-chrome-devtools-device-mode-to-design-and-test-your-mobile-views)
- [Do you make CSS changes safely?](/css-changes)
- [Do you keep developers away from design work?](/keep-developers-away-from-design-work)
- [Do you hand over mockups to developers?](/hand-over-mockups-to-developers)
