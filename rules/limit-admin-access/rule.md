...
Note: If you are still using Azure DevOps, force-push permissions into a repo is only allowed for Project Administrators, so pick your administrators well.
...
::: good
![Good Example: Only one admin](notManyAdmins.png)
:::
