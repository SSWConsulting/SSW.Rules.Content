...
Every change to an appointment is a hassle and it's good to be explicit as to why the appointment had to change. There are also people that need some pressure put on them when they change an appointment multiple times so that we don't end up on V7 🤣.
