...
Projects often fail because clients think suppliers under-deliver and over-charge. 

* The client and the supplier have different expectations about the goals of the project.
* This difference of opinion often leads to a project's absolute failure.

![This should be labeled as "CAPTION / ALT TEXT" ](screen-shot-2021-07-22-at-5.45.35-pm.png "This should be (optional) - in most cases won't be needed...")
...
### **Talk dollars at the first meeting**
...
### **Be transparent about rates and resourcing**
