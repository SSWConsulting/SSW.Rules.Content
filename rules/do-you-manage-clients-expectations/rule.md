...
**Be transparent about rates and resourcing** Defining the hourly rates and resources that will be available to clients makes sure they are not surprised at a later date. Additionally, explaining the differences between resources helps explain why specific resources are grouped together and what kind of services they provide. At SSW we have [clear definitions](https://github.com/SSWConsulting/SSW.Roles) for all of our roles so that clients understand the part their resources play.
