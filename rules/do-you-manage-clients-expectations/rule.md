...
There's no doubt custom software development is a challenging industry. According to [Critical Success Factors In Software Projects by John S. Reel](http://servicetech.weebly.com/uploads/5/3/8/0/5380587/8_critical_success_factors_in_software.pdf): **Nearly 75% of all development projects missed their target release date or never ship at all.** But what is so interesting is that **at least 7 of the 10 most common signs of product development failure are present before the design is created or a single line of code is written**.
