...
<p>Just like a car, applications need servicing and tuning every now and then to stay in top condition. They might need alterations to deal with new business problems, or just tuning to increase efficiency. 
   <br></p><dl class="image"><dt><img src="/PublishingImages/sucessful-project-and-now.jpeg" alt="sucessful-project-and-now.jpeg" /></dt><dd>Figure&#58; What happens after the software has been delivered and the development team moves on. The next phase is maintenance​<br></dd></dl>
