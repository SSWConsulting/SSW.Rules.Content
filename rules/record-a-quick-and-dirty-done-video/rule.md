...
**Note:** You will be able to alter the PIP, remove it, go full screen on your face. Also note that you'll need to set the output to 30 FPS in your OBS settings, not 60 FPS as outlined in the video. Setting your output to 30 FPS will ensure you don't experience synching issues or lag between the video and audio.
