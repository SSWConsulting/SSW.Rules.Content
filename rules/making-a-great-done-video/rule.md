...
9. One-Take - Record it in one take, but start again if it's super bad. If something out-of-your control happens, try to be natural! If you mistype a word or click the wrong button, don't freak out and start again, incorporate it e.g. "Whoops, clicked build accidently. Let me just refresh and go again." Note: if your video is short (1-2 mins), then starting again may be optimal. However, if your video is long e.g. 15-20 minutes, then try to incorporate any accidental errors and keep going. 
