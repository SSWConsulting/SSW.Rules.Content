...
We don't like hard coded string inside our programme. We are using model-driven development, in which we create or reuse code, and perform changes in configuration file rather the in-code changing. [More information on implementing our configuration](/rules/do-you-use-configuration-management-application-block).   
<!--endintro-->
