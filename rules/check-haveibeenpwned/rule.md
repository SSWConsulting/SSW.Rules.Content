---
type: rule
title: Do you check passwords in haveibeenpwned?
...
Even better, if you are a superstar 🤩 then the gold standard for password management is to use a [password manager](https://www.ssw.com.au/rules/password-manager/)
