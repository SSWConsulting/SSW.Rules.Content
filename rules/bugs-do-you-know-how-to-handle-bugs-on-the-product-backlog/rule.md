...
See [<font color="#000080">Do you know when to create bugs?</font>](/rules/during-a-sprint-do-you-know-when-to-create-bugs) for detailed information on identifying when something is a bug, and when to just fix it.
