...
<dl class="goodImage"><dt> 
      <img alt="Designing border protection." src="http&#58;//www.ssw.com.au/ssw/Standards/Rules/Images/BorderProtectionExample.png" style="margin&#58;5px;width&#58;600px;" /> 
   ...
   <strong>Border protection in action&#58;</strong></p><dl class="badImage"><dt> 
      <img alt="SSW Link Auditor - UI without border protection." src="http&#58;//www.ssw.com.au/ssw/Standards/Rules/Images/BorderProtectionBad.png" style="margin&#58;5px;" /> 
   </dt><dd>Figure&#58; Bad Example - Controls placed very near to the border and not aligned correctly</dd></dl><dl class="goodImage"><dt> 
      <img alt="SSW Link Auditor - UI with border protection." src="http&#58;//www.ssw.com.au/ssw/Standards/Rules/Images/BorderProtectionGood.png" style="margin&#58;5px;" /> 
   </dt><dd>Figure&#58; Good Example - All controls are in the border protection area and aligned correctly</dd></dl><dl class="image"><dt> 
      <img alt="SSW Link Auditor - UI with border protection." src="http&#58;//www.ssw.com.au/ssw/Standards/Rules/Images/BorderProtectionDesign.png" style="margin&#58;5px;" /> 
