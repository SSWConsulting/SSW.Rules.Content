...
<ol><li>
      You can add a 301 redirect in code<p class="ssw15-rteElement-CodeArea">&#160;{ltHTMLChar}% Response.RedirectPermanent(&quot;NEW PAGE URL HERE&quot;) %{gtHTMLChar}</p>Although this works well it is difficult to manage the list of redirects and you need to keep the page around.
   </li><li>
