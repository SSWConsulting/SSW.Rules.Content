...
<span class='intro'> <p>​We should always use computed columns (in SQL Server 2005 and later they can be persisted) to avoid these types of denormalized columns.​<br></p><dl class="badImage"><dt>
