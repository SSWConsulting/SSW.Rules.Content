...
**Why you should care about duplicate content** While having duplicate meta title or <meta> description tags may not impact your search engine performance directly it can still result in a [poor user experience](https://www.semrush.com/blog/duplicate-meta-descriptions/). For example, if two pages with the same title appear in the same set of search results the user may be unsure of which link to click. It may also impact your rankings in other search engines.
