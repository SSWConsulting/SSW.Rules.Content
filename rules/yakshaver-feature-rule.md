---
title: 'Use the YakShaver desktop app to Manage Releases'
---

## Overview

The YakShaver app has introduced a new feature in its settings to manage releases efficiently. You can now view the current version of the YakShaver app you're using and switch between different PR pre-releases seamlessly.
...
1. Go to the settings in the YakShaver app.
2. Navigate to the releases section.
3. Select the desired PR pre-release.
