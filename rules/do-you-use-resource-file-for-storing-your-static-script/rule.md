...
<dl class="goodCode">
    ...
    <pre>     string.Format(@&quot;{ltHTMLChar}script type=&quot;&quot;text/javascript&quot;&quot;{gtHTMLChar}                  <br>       function deleteOwnerRow(rowId)                    <br>      &#123; &#123;0&#125;.Delete(&#123;0&#125;.GetRowFromClientId(rowId)); &#125; {ltHTMLChar}/script{gtHTMLChar} &quot;, <br>       OwnersGrid.ClientID);                                    </pre>
    </dt>
...
<dl class="goodCode">
    ...
    <pre>     {ltHTMLChar}script type=&quot;&quot;text/javascript&quot;&quot;{gtHTMLChar}<br>     function deleteOwnerRow(rowId)<br>     &#123;<br>            &#123;0&#125;.Delete(&#123;0&#125;.GetRowFromClientId(rowId));<br>     &#125;<br>     {ltHTMLChar}/script{gtHTMLChar} </pre>
    </dt>
</dl>
