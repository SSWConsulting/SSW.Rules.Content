...
5. Install all rest of the standard Software that does not support Chocolatey [SSW Only]   <br>          [Standard Software](https://intranet.ssw.com.au/SysAdmin/Lists/WinImageInstalledSoftware/AllItems.aspx) for SSW
