...
---
If there is an upgrade available (see ["Have you installed the latest DNN version?"](https://ssw.com.au/ssw/Standards/Rules/RulestoBetterDotNetNuke.aspx#LatestVersion) ), follow the following steps to perform the upgrade.
...
4. Download the latest DotNetNuke upgrade package:
   ...
   1. From the www.dotnetnuke.com site. You may need login credentials if you are using a non-community version of DNN or
   2. Click the "Upgrade Available" button that appears when you are *not* running the latest version (see ["Have you installed the latest DNN version?"](https://ssw.com.au/ssw/Standards/Rules/RulestoBetterDotNetNuke.aspx#LatestVersion)).
5. Create a basic html document called app_offline.htm. This page will be shown on the site while you are doing the upgrade.
   ...
   To Perform the Upgrade.](2024-04-20_13-29-45.png)
   :::
...
:::
7. Click through the newly upgraded site to perform a [smoke test](http://www.ssw.com.au/ssw/Standards/Rules/RulesToBetterUnitTests.aspx#TypesOfTests).
