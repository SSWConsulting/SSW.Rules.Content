...
### Tip 1: Check if the Product Owner can explain the process 

Ask if they already have a prototype of the feature or if someone can perform the task manually and can explain the process.  
...
### Tip 3: Record Specification Reviews 
