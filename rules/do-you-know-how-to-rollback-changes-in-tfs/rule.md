...
_ Right click your solution and **Undo Pending Changes** <img alt="Undo Pending changes" src="rollback1.gif" width="266" height="307"> 2. If you aren’t so lucky and have made some commits along the way then the only option is to use the Rollback command.
_ To use this you will need to install [Team Foundation Server Power Tools v1.2](http://www.ssw.com.au/ssw/Redirect/TFSPowerToolsDownload.htm) \* Find the revision before you started checking code in using the **History command** <img alt="Revision List" src="rollback2.gif" width="595" height="178">
