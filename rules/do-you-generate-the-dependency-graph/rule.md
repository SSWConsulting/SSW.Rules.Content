...
The other option to generate dependency graph is by installing ReSharper extension in Visual Studio. Check the [official docs](https://www.jetbrains.com/resharper/) about installing ReSharper.
