...
<dl class="ssw15-rteElement-ImageArea"><dt><div> 
      ...
      </div><p class="ssw15-rteElement-CodeArea">{ltHTMLChar}label for=&quot;phone&quot;{gtHTMLChar}Phone{ltHTMLChar}/label{gtHTMLChar}&#58; {ltHTMLChar}input 
         <span class="ssw15-rteStyle-Highlight">type=&quot;text&quot;</span> name=&quot;phone&quot;{gtHTMLChar}{ltHTMLChar}/input{gtHTMLChar}</p></dt><dd class="ssw15-rteElement-FigureBad">Figure&#58; Bad Example – This field is using a text type and shows a standard keyboard on mobile</dd></dl>
<br>
<dl class="ssw15-rteElement-ImageArea"><dt><div> 
      <img width="200px" src="/PublishingImages/fieldtype-tel.PNG" alt="" />
      </div>
      <p class="ssw15-rteElement-CodeArea">{ltHTMLChar}label for=&quot;phone&quot;{gtHTMLChar}Phone{ltHTMLChar}/label{gtHTMLChar}&#58; {ltHTMLChar}input 
         <span class="ssw15-rteStyle-Highlight">type=&quot;tel&quot;</span> name=&quot;phone&quot;{gtHTMLChar}{ltHTMLChar}/input{gtHTMLChar}</p></dt><dd class="ssw15-rteElement-FigureGood">Figure&#58; Good Example – This field is using the correct field type and shows the keypad on mobile</dd></dl><p>
   <br>
