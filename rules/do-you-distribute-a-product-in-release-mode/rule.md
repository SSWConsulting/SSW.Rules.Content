...
<dl class="goodImage">
    <dt><img style="border-bottom:0px solid;border-left:0px solid;border-top:0px solid;border-right:0px solid;" border="0" alt="Debug configuration" src="DebugConfiguration.gif" /> </dt>
</dl>
<b>Figure: Set "Generate Debugging Information" to True on the project properties page (VS 2003).</b>
<dl class="goodImage">
    <dt><img style="border-bottom:0px solid;border-left:0px solid;border-top:0px solid;border-right:0px solid;" border="0" alt="Advanced Build Settings" src="VS2005AdvancedBuildSettings.gif" /> </dt>
</dl>
