...
---
We all know that we should [Store Secrets Securely](https://www.ssw.com.au/rules/store-your-secrets-securely/) using Key Vault, but did you know that rather than have developers having to deal with a combination of Key Vault and Configuration, you can abstract Key Vault out of your application code and leave developers to only have to deal with Configuration?
