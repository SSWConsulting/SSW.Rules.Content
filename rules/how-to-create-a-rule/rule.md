...
7. Now fix up the images – This part is a bit painful
...
14. Check on the summary page (e.g. ssw.com.au/rules/<mark>RulesToBetterSomething</mark>/ ) if the order is correct 
