...
<ul><li>Subject&#58; {ltHTMLChar}Client Name{gtHTMLChar} Sprint XX Review/Retro </li><li>This is a reply to the 
   ...
   <p>&#160;</p><p>As per 
      ...
      <a href="/Pages/Do-you-create-a-Sprint-Review-email.aspx">http&#58;//rules.ssw.com.au/Management/RulesToBetterScrumUsingTFS/Pages/Do-you-create-a-Sprint-Review-email.aspx</a>{gtHTMLChar}</p></div>
