...
<img src="consitency.png" alt="" style="float:right;margin-left:10px;" />Say we are creating a windows forms application. We can expect to:<ul><li><b> Improve productivity - because there are fewer decisions to make, and you build on existing work.</b> <br>For example, we don't need to discuss the pros and cons of MDI versus SDI because there is <a href="http://www.ssw.com.au/ssw/Standards/Rules/RulesToBetterWindowsForms.aspx#AvoidMDI" shape="rect">already a standard</a>​.<br></li>
