...
[Azure has 100s of offerings](https://azure.microsoft.com/services?WT.mc_id=AZ-MVP-33518) and it can be hard to know what the right services are to choose for any given application.
