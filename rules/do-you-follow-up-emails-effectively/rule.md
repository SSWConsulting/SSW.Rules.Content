...
<dl class="badImage"><dt> 
   ...
   <b>{ltHTMLChar}period of time{gtHTMLChar}@followupthen.com</b> and it will send you an email when that time expires, reminding you to follow up with another email. 
