...
::: bad  
![Figure: Bad example - Inbox with noise from Azure Devops](Inbox-with-noise-email.png)
:::

You can create a folder and rules in your Microsoft Outlook to move noisy emails out of the inbox based on the sender. Here are the [step by step guide](https://support.microsoft.com/en-gb/office/always-move-messages-from-a-specific-sender-e28d03c0-077d-4366-a348-4536f0fc9008)  on how to move email from specific senders to individual folder.

::: good  
![Figure: Good example - Move Azure DevOps emails to a newly created "Azure Devops" folder](Noise-email-in-individual-folder.png)
:::
