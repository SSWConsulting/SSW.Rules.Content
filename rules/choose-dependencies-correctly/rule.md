...
## **Learning the risks** of using external packages
...
### 2. Is it maintained by somebody credible?
...
### 6. Does it have good transparency?
...
### 7. What are the bundle characteristics?
...
### 8. Is it aligned with your license and legal considerations?
...
Choosing a good package is only half the job, [maintaining them is an ongoing responsibility](/maintain-dependencies-correctly). Dependencies evolve constantly; new features are added, security patches are released, breaking changes appear, and ecosystem standards shift.
