...
<span class='intro'> <p class="ssw15-rteElement-P">​​​You should check, write an email&#160;report of application health to the application manager and fix the most occurring&#160;bug of that week,&#160;every day. This will ensure that the health of the application will improve over time.</p> </span>
