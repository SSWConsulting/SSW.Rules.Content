...
---
When a company has many different office locations, often people in one office aren't familiar with people in other offices. This problem is particularly pronounced where you have offices that span multiple time zones or countries.

### The Solution
So, to remedy this issue, it is crucial to build interaction between all of the company offices. Building interaction may improve the following:
