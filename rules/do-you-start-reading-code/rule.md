...
<div>For example, {ltHTMLChar}p{gtHTMLChar}&#160;is for a paragraph,&#160;not for defining a section.&#160;{ltHTMLChar}b{gtHTMLChar} is for bolding,&#160;not for&#160;emphasizing&#160;({ltHTMLChar}strong{gtHTMLChar} and&#160;{ltHTMLChar}em{gtHTMLChar}) do that.</div>
<div><br></div>
