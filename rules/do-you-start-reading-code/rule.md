...
<div>var&#160;result = new List{ltHTMLChar}ProductGroup{gtHTMLChar}(groups.Values);<br>result.Sort(delegate(ProductGroup groupX, ProductGroup groupY)<br>&#123;<br>&#160;&#160;&#160; return<br>&#160;&#160;&#160;&#160;&#160;&#160;&#160; groupX.ProductCount {gtHTMLChar} groupY.ProductCount ? -1 &#58;<br>&#160;&#160;&#160;&#160;&#160;&#160;&#160; groupX.ProductCount {ltHTMLChar} groupY.ProductCount ? 1 &#58;<br>&#160;&#160;&#160;&#160;&#160;&#160;&#160; 0;<br>&#125;);</div>
...
<div class="ssw-rteStyle-CodeArea"><pre>result = products
    ...
    .Select(group ={gtHTMLChar} <span>n</span><span>ew</span><span></span><span> </span>&#123; CategoryName = group.Key, ProductCount = group.Count() &#125;);</pre></div>
