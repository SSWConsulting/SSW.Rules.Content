...
* A link to an [architecture diagram](/rules/architecture-diagram) which outlines a high-level overview of the project. 
* Links to any lower level architecture diagrams of the system e.g. [Azure resources diagram (auto generated)](/rules/azure-resources-diagram)
...
**7. _docs\Definition-of-Done.md** - Ensures that your team [maintains a high level of quality with a Definition of Done](/rules/definition-of-done)

**8. _docs\Definition-of-Ready.md** – Ensures that all your PBIs are well defined to an agreed standard before adding them to a Sprint (see [have-a-definition-of-ready](/rules/have-a-definition-of-ready))
...
We can choose to continue paying the interest, or we can pay the debt in full by redoing the piece of work in a cleaner way. Learn about [the importance of paying back technical debt.](/rules/technical-debt/)
