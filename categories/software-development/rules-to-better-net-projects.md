...
<div class="topcommonTestimonialBox" style="padding: 4px; margin-bottom: 8px; margin-left: 15px; border-left-color: #cccccc; border-left-width: 5px; border-left-style: solid; margin-right: 15px; border-bottom-color: #cccccc; border-bottom-width: 1px; border-bottom-style: solid;"><a href="http://www.ssw.com.au/ssw/Testimonials/ViewAll.aspx"><img alt="What others have to say about us" src="http://www.ssw.com.au/ssw/Images/Testimonials_Heading.png" border="0" style="margin-bottom: 2px;"/></a><br/>
<table cellspacing="0" cellpadding="0" border="0" style="margin-left: 5px;">
<tbody>
<tr>
<td valign="top" width="10"><img alt="See what people think about this product" src="http://www.ssw.com.au/ssw/Images/Testimonials_LeftQuote.png" align="left" style="margin-top: 3px; margin-right: 3px;"/></td>
...
<td valign="top" width="10"><img alt="See what people think about this product" src="http://www.ssw.com.au/ssw/Images/Testimonials_RightQuote.png" align="right" style="margin-top: 3px; margin-left: 3px;"/></td></tr></tbody></table>
