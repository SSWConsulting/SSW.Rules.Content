...
redirects:
  - rules-to-better-gpt
seoDescription: Practical rules for getting the most from AI tools like ChatGPT and Copilot. Learn how to use AI effectively and responsibly in your day-to-day work.
index:
  ...
  - rule: public/uploads/rules/check-your-ai-writing/rule.mdx
