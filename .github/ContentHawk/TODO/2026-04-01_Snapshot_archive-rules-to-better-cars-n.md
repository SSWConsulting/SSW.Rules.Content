...
| Search Scope        | Archive rules to better cars. All rules in categories/others/rules-to-better-cars.mdx                      |
| Processing Priority | Sort by lastUpdated               |
| Issue Preferences   | Create up to 5 issues per run                 |
| PR Preferences      | Bundle up to 3 PRs per issues                    |
| Label               | `archive-rules-to-better-cars-n`                      |
| Created             | 2026-04-01                    |
