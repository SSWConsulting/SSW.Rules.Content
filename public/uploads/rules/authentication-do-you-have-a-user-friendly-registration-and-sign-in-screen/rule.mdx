...
<imageEmbed
  ...
  captionText={"Bad example - non-friendly sign in screen"}
...
<imageEmbed
  ...
  captionText={"Good example - friendly sign in screen for many new visitors"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - friendly sign in screen for few new visitors"}
