...
<imageEmbed
  ...
  caption={"Good example - Build Passing with no summary issues"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Steps added to build definition"}
...
<imageEmbed
  ...
  caption={"Bad Code with a Good Code Health Implementation - Build broke due to compile errors. Must fix to proceed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad Code with a Good Code Health Implementation - Successful build with warnings. These should be reprioritised as errors, or removed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Code with a Good Code Health Implementation - Successful build with no warnings"}
  src="/uploads/rules/do-you-run-the-code-health-checks-in-your-visualstudio-com-continuous-integration-build/VSO-Build-Good-1.png"
/>