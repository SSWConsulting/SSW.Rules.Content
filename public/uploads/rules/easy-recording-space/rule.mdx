...
<imageEmbed
  ...
  caption={"Bad example - Shared noisy environment makes it hard to capture clear audio and branded visuals"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Difficult setups leading to inconsistent quality and wasting time"}
...
<imageEmbed
  ...
  caption={"Good example - Plug and play system that ensures consistent quality and saves time"}
