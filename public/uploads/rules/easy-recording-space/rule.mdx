...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Shared noisy environment makes it hard to capture clear audio and branded visuals" src="/uploadshttps://github.com/user-attachments/assets/9b7c9969-7082-4a25-87db-1c9c564b19a5" />

* **Non-permanent setup** - Setting up and tearing down equipment each time you want to record

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Difficult setups leading to inconsistent quality and wasting time" src="/uploadshttps://github.com/user-attachments/assets/1686da19-626b-4840-988f-660113c4ac49" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Plug and play system that ensures consistent quality and saves time" src="/uploadshttps://github.com/user-attachments/assets/883aff45-3714-478d-9365-ba98aac57a06" />
