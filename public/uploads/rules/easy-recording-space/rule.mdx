...
<imageEmbed
  ...
  figureText={"Bad example - Shared noisy environment makes it hard to capture clear audio and branded visuals"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Difficult setups leading to inconsistent quality and wasting time"}
...
<imageEmbed
  ...
  figureText={"Good example - Plug and play system that ensures consistent quality and saves time"}
