...
<imageEmbed
  ...
  figureText={"Select Settings (cog) | Apps for Dynamics 365 menu item"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Dynamics 365 apps for Outlook"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"In Outlook open a new Email and see Dynamics 365 app that opens a Dynamics sidebar"}
