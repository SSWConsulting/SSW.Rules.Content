...
seoDescription: How to handover tasks and responsibilities to others effectively,
  ensuring a smooth transition and minimizing misunderstandings.
...
1. Please fix
  ...
  figureText={"Bad example - Task not directly reallocated"}
/>
...
1. Please fix
  ...
  figureText={"Good example - Clear reassignment from Andy to David"}
/>
...
\&lt;As per [ssw.com.au/rules/how-to-hand-over-tasks-to-others](/how-to-hand-over-tasks-to-others)&gt;
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Clear reassignment from Andy to Mary"}
/>