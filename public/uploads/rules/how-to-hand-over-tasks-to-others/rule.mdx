...
1. Please fix
  ...
  caption={"Bad example - Task not directly reallocated"}
/>
...
1. Please fix
  ...
  caption={"Good example - Clear reassignment from Andy to David"}
/>
...
\&lt;As per [ssw.com.au/rules/how-to-hand-over-tasks-to-others](/how-to-hand-over-tasks-to-others)&gt;
  ...
  captionStyle="goodExample"
  caption={"Good example - Clear reassignment from Andy to Mary"}
/>