...
- do-you-have-a-healthcheck-page-(from-zsvalidate)-to-make-sure-your-website-is-healthy
seoDescription: Ensure your website's health by having a Health Check page with /zsValidate
  to prevent deployment errors and identify coding mistakes.
...
<imageEmbed
  ...
  captionText={"Sample Health Checks page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Sample Health of an endpoint being viewed in a timeline, so I can see when a resource was last healthy"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Microsoft Service Health - admin.microsoft.com/servicestatus"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Google Workspace Status Dashboard - www.google.com/appsstatus/dashboard"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Apple System Status - www.apple.com/au/support/systemstatus"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"MailChimp status - status.mailchimp.com"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Check everything with care"}
