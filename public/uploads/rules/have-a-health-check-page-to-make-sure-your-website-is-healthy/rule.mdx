...
<imageEmbed
  ...
  caption={"Sample Health Checks page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Sample Health of an endpoint being viewed in a timeline, so I can see when a resource was last healthy"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Microsoft Service Health - admin.microsoft.com/servicestatus"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Google Workspace Status Dashboard - www.google.com/appsstatus/dashboard"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Apple System Status - www.apple.com/au/support/systemstatus"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"MailChimp status - status.mailchimp.com"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Check everything with care"}
