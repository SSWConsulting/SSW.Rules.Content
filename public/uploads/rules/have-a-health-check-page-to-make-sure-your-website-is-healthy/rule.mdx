...
<imageEmbed
  ...
  figureText={"Sample Health Checks page"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Sample Health of an endpoint being viewed in a timeline, so I can see when a resource was last healthy"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Microsoft Service Health - admin.microsoft.com/servicestatus"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Google Workspace Status Dashboard - www.google.com/appsstatus/dashboard"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Apple System Status - www.apple.com/au/support/systemstatus"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"MailChimp status - status.mailchimp.com"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Check everything with care"}
