...
<imageEmbed
  ...
  captionText={"Bad Example - This field was manually updated from code in the middle tier."}
...
<imageEmbed
  ...
  captionText={"Good Example - There was no code in the middle tier to calculate this (and it has the correct name)"}
...
<imageEmbed
  ...
  captionText={"Setting up a computed column in the table designer"}
