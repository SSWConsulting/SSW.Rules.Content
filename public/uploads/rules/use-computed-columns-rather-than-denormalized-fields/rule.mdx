...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This field was manually updated from code in the middle tier."
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="There was no code in the middle tier to calculate this (and it has the correct name)"
