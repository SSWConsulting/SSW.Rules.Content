...
isArchived: false
lastUpdated: 2020-01-09 09:06:13+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example - This field was manually updated from code in the middle tier."}
...
<imageEmbed
  ...
  figureText={"Good Example - There was no code in the middle tier to calculate this (and it has the correct name)"}
...
<imageEmbed
  ...
  figureText={"Setting up a computed column in the table designer"}
