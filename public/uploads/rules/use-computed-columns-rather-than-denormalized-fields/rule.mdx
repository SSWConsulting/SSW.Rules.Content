...
<imageEmbed
  ...
  caption={"Bad Example - This field was manually updated from code in the middle tier."}
...
<imageEmbed
  ...
  caption={"Good Example - There was no code in the middle tier to calculate this (and it has the correct name)"}
...
<imageEmbed
  ...
  caption={"Setting up a computed column in the table designer"}
