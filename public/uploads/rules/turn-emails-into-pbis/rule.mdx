...
isArchived: false
lastUpdated: 2025-05-16 04:51:13+00:00
...
<imageEmbed
  ...
  caption={"Should the email be turned into a PBI?"}
...
**Subject:** TimePro PBI 50209: ☠️ Displaying past employees
  ...
  caption={"OK example - Has the email header data but not @mentioning users"}
/>
...
**Subject:** TimePro PBI 50209: ☠️ Displaying past employees
  ...
  caption={"Good example - Has the email header data and @mentions users"}
/>
...
<imageEmbed
  ...
  caption={"Bad example - Don't work from your email inbox!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Put it in a PBI!"}
...
&dash; Chris
  ...
  captionStyle="goodExample"
  caption={"Good example - send it to Zendesk!"}
/>