...
<imageEmbed
  ...
  figureText={"Should the email be turned into a PBI?"}
...
**Subject:** TimePro PBI 50209: ☠️ Displaying past employees
  ...
  figureText={"OK example - Has the email header data but not @mentioning users"}
/>
...
**Subject:** TimePro PBI 50209: ☠️ Displaying past employees
  ...
  figureText={"Good example - Has the email header data and @mentions users"}
/>
...
<imageEmbed
  ...
  figureText={"Bad example - Don't work from your email inbox!"}
...
<imageEmbed
  ...
  figureText={"Good example - Put it in a PBI!"}
...
&dash; Chris
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - send it to Zendesk!"}
/>