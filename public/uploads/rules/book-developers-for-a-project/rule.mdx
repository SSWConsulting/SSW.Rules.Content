...
<imageEmbed
  ...
  figureText={"OK example - Using the Service Calendar, you can see who is and is not available at a given time"}
...
<imageEmbed
  ...
  figureText={"Good example - Build a Power BI report to show the CRM data more succinctly"}
...
<imageEmbed
  ...
  figureText={"A complete appointment booking Brendan to work for SSW for 5 days"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Click Appointment to create a new appointment in CRM"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"A complete CRM Appointment for a 1-day booking"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Internally 'Booked' days show as black and 'Pencilled In' days show as grey"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Outlook | Dynamics 365 App | Click Untrack and then Delete"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Appointments tracked from with Outlook desktop"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add account to your Outlook"}
