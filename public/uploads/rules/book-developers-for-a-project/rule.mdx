...
created: 2022-05-10 19:30:31+00:00
...
<imageEmbed
  ...
  caption={"OK example - Using the Service Calendar, you can see who is and is not available at a given time"}
...
<imageEmbed
  ...
  caption={"Good example - Build a Power BI report to show the CRM data more succinctly"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A complete appointment booking Brendan to work for SSW for 5 days"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Click Appointment to create a new appointment in CRM"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A complete CRM Appointment for a 1-day booking"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Internally 'Booked' days show as black and 'Pencilled In' days show as grey"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Outlook | Dynamics 365 App | Click Untrack and then Delete"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Appointments tracked from with Outlook desktop"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Add account to your Outlook"}
