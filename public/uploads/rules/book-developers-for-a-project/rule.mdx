...
seoDescription: Scheduling developers' time efficiently and effectively with Dynamics
  365 and Outlook to ensure maximum productivity.
created: 2012-12-06 13:32:15
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="ok" figure="OK example - Using the Service Calendar, you can see who is and is not available at a given time" src="/uploads/rules/book-developers-for-a-project/service-calendar-crm-online-version-blurred.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Good example - Build a Power BI report to show the CRM data more succinctly" src="/uploads/rules/book-developers-for-a-project/bookedindays.png" />
...
3. If the booking requires the client (like a Spec Review), invite them as optional. If you do this, also make it a Teams Meeting and add your email signature
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="A complete appointment booking Brendan to work for SSW for 5 days" src="/uploads/rules/book-developers-for-a-project/Dynamics1.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Click Appointment to create a new appointment in CRM" src="/uploads/rules/book-developers-for-a-project/Dynamics-Calendar-App.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="A complete CRM Appointment for a 1-day booking" src="/uploads/rules/book-developers-for-a-project/Dynamics-Appointment.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Internally 'Booked' days show as black and 'Pencilled In' days show as grey" src="/uploads/rules/book-developers-for-a-project/2020-03-20_10-49-19.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Outlook | Dynamics 365 App | Click Untrack and then Delete" src="/uploads/rules/book-developers-for-a-project/dynamics-untrack.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Appointments tracked from with Outlook desktop" src="/uploads/rules/book-developers-for-a-project/Appointments tracked from Outlook desktop.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Add account to your Outlook" src="/uploads/rules/book-developers-for-a-project/Add account.jpg" />
