...
<boxEmbed
  ...
  caption={"Bad Example - Passive voice leads the reader down a winding path"}
/>
...
<boxEmbed
  ...
  caption={"Good Example - Active voice is more direct and engaging"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - Passive voice"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Now that's an engaging sentence"}
/>
