...
<imageEmbed
  ...
  caption={"Bad example - Manually exporting PSTs is prone to errors"}
...
<imageEmbed
  ...
  caption={"Good Example - An automatic, cloud-based backup solution takes snapshots of your data daily and makes it very easy to recover and restore any emails"}
