...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Manually exporting PSTs is prone to errors"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="An automatic, cloud-based backup solution takes snapshots of your data daily and makes it very easy to recover and restore any emails"
