...
<imageEmbed
  ...
  captionText={"Bad example - An unknown length of time. So let them know"}
...
<imageEmbed
  ...
  captionText={"Good example – The coffee cup tells the user that they will be here a while"}
