...
````
  ...
  caption={"Bad example - While it may look the same, the bold is no longer part of the link element, which can cause inconsistencies and reduces semantic clarity"}
/>
...
````
  ...
  caption={"Good example - Cleaner HTML, better accessibility, and more consistent styling across your design system"}
/>
