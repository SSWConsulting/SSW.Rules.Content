...
lastUpdated: 2026-04-15T21:11:22.798Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Most of the Visual Studio UI is too small to read and the Output window takes up a lot of space" src="/uploads/rules/enable-presentation-mode-in-visual-studio/present_off.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Presentation mode creates a full alternative profile so you can adjust font sizes across the whole UI" src="/uploads/rules/enable-presentation-mode-in-visual-studio/present_on.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Open Visual Studio Presentation mode" src="/uploads/rules/enable-presentation-mode-in-visual-studio/open-vs-presentation-mode.png" />

## Text Editor

Change font size in your text editor. Zoom in from 100% to 200%.

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Small font size" src="/uploads/rules/enable-presentation-mode-in-visual-studio/text-editor-bad.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Good font size" src="/uploads/rules/enable-presentation-mode-in-visual-studio/text-editor-good.png" />

## Command Prompt

And don't forget to change your command prompt as well. Increase the font size from 12 to 16 or more.

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Command prompts are hard to read" src="/uploads/rules/enable-presentation-mode-in-visual-studio/cmd-bad.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Font size for command prompt should be about twice as much as by default" src="/uploads/rules/enable-presentation-mode-in-visual-studio/cmd-good.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Command Prompt profiles" src="/uploads/rules/enable-presentation-mode-in-visual-studio/command-prompt-profiles.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Open Presentation Prompt" src="/uploads/rules/enable-presentation-mode-in-visual-studio/cmd-open-presentation-mode.png" />
