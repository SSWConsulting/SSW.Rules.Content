...
<imageEmbed
  ...
  caption={"Bad example - Most of the Visual Studio UI is too small to read and the Output window takes up a lot of space"}
...
<imageEmbed
  ...
  caption={"Good example - Presentation mode creates a full alternative profile so you can adjust font sizes across the whole UI"}
...
<imageEmbed
  ...
  caption={"Open Visual Studio Presentation mode"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Small font size"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Good font size"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Command prompts are hard to read"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Font size for command prompt should be about twice as much as by default"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Command Prompt profiles"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Open Presentation Prompt"}
