...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Most of the Visual Studio UI is too small to read and the Output window takes up a lot of space"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Presentation mode creates a full alternative profile so you can adjust font sizes across the whole UI"
