...
<imageEmbed
  ...
  captionText={"Bad example - Most of the Visual Studio UI is too small to read and the Output window takes up a lot of space"}
...
<imageEmbed
  ...
  captionText={"Good example - Presentation mode creates a full alternative profile so you can adjust font sizes across the whole UI"}
...
<imageEmbed
  ...
  captionText={"Open Visual Studio Presentation mode"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Small font size"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Good font size"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Command prompts are hard to read"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Font size for command prompt should be about twice as much as by default"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Command Prompt profiles"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Open Presentation Prompt"}
