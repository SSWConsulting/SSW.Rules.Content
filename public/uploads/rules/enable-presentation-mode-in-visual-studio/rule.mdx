...
isArchived: false
lastUpdated: 2021-01-04 15:48:37+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Most of the Visual Studio UI is too small to read and the Output window takes up a lot of space"}
...
<imageEmbed
  ...
  figureText={"Good example - Presentation mode creates a full alternative profile so you can adjust font sizes across the whole UI"}
...
<imageEmbed
  ...
  figureText={"Open Visual Studio Presentation mode"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Small font size"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Good font size"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Command prompts are hard to read"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Font size for command prompt should be about twice as much as by default"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Command Prompt profiles"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Open Presentation Prompt"}
