---
seoDescription: When retrieving data, it's more efficient to only collect the necessary
  information, reducing computation, IO, memory usage, and CPU load on the calling
  side.
type: rule
...
created: 2021-12-13 17:06:46.280000+00:00
