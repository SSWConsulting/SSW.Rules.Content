...
created: 2022-03-03 12:25:15+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Lots of notifications"}
...
<imageEmbed
  ...
  figureText={"Good example - Turn off Watching settings"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Workflow notification settings"}
...
<imageEmbed
  ...
  figureText={"How to configure the rule in Outlook"}
