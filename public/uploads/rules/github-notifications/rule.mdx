...
<imageEmbed
  ...
  caption={"Bad example - Lots of notifications"}
...
<imageEmbed
  ...
  caption={"Good example - Turn off Watching settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Workflow notification settings"}
...
<imageEmbed
  ...
  caption={"How to configure the rule in Outlook"}
