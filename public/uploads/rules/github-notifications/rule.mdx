...
<imageEmbed
  ...
  captionText={"Bad example - Lots of notifications"}
...
<imageEmbed
  ...
  captionText={"Good example - Turn off Watching settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Workflow notification settings"}
...
<imageEmbed
  ...
  captionText={"How to configure the rule in Outlook"}
