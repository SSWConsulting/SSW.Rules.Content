...
<imageEmbed
  ...
  captionText={"Good example - Organizations that balance compliance and agility are less likely to face regulatory issues"}
...
<imageEmbed
  ...
  captionText={"Bad example - Overemphasis on compliance can make an organization rigid and slow to respond to market changes"}
