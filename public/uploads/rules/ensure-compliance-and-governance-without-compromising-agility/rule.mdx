...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Organizations that balance compliance and agility are less likely to face regulatory issues"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Overemphasis on compliance can make an organization rigid and slow to respond to market changes"
