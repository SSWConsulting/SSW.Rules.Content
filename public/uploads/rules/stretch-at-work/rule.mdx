...
<imageEmbed
  ...
  figureText={"Bad example - Common bad posture when sitting on a desk"}
...
<imageEmbed
  ...
  figureText={"Good example - Head behind neck and bend backwards"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="goodExample"
  figureText={"Good example - Chest opener stretch"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="goodExample"
  figureText={"Good example - Standing hip flexor stretch"}
