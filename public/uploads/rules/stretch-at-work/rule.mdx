...
<imageEmbed
  ...
  caption={"Bad example - Common bad posture when sitting on a desk"}
...
<imageEmbed
  ...
  caption={"Good example - Head behind neck and bend backwards"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  caption={"Good example - Chest opener stretch"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  caption={"Good example - Standing hip flexor stretch"}
