...
<boxEmbed
  ...
  captionText={"Good example – Both the developer and Bench Masters were notified and could act quickly."}
/>
...
<boxEmbed
  ...
  captionText={"Bad example – Lack of communication caused confusion and wasted available resources."}
/>
