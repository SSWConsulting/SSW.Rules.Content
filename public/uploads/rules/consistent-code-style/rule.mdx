...
<imageEmbed
  ...
  captionText={"Good example - Project using a \".editorconfig\" file"}
...
<imageEmbed
  ...
  captionText={"Bad example - Project using StyleCop (old)"}
...
<imageEmbed
  ...
  captionText={"Creating .editorconfig in VS 2022"}
  src="/uploads/rules/consistent-code-style/vs2022-add-editorconfig.png"
/>
