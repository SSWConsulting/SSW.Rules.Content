...
<imageEmbed
  ...
  figureText={"Bad example - No ticks and crosses + no sound - 0:38 - 0:48"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Distracting tick + loud sound - 0:59 - 1:02"}
...
<imageEmbed
  ...
  figureText={"OK example - Red cross with the right size + location + subtle sound - 1:54 - 2:02"}
...
<imageEmbed
  ...
  figureText={"Good example - The red cross and bad example in the lower third + subtle sound - 0:58 - 1:07"}
