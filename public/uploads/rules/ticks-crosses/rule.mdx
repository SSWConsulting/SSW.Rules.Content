---
type: rule
seoDescription: Use ticks and crosses with subtle sound effects in video examples
  to effectively highlight good and bad practices without interfering with audience
  comprehension.
...
- author: sofie-hong
created: 2022-12-21 01:54:19+00:00
...
createdBy: Sofie Hong [SSW]
createdByEmail: 108442257+SofieHong@users.noreply.github.com
isArchived: false
---
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="No ticks and crosses + no sound - 0:38 - 0:48"
  src="/uploads/rules/ticks-crosses/bad-example-1-no-tick-and-cross-no-sound.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Distracting tick + loud sound - 0:59 - 1:02"
  src="/uploads/rules/ticks-crosses/bad-example-2-distracting-tick-loud-sound.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="Red cross with the right size + location + subtle sound - 1:54 - 2:02"
  src="/uploads/rules/ticks-crosses/good-example-1-red-cross-with-the-right-size-subtle-sound.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The red cross and bad example in the lower third + subtle sound - 0:58 - 1:07"
  src="/uploads/rules/ticks-crosses/ask-from-x-to-y.png"
/>
...
![Figure: Distracting red cross with loud sound](/uploads/rules/ticks-crosses/video-1-distracting-red-cross-with-loud-sound.png)

![Figure: Question #1 feedback](/uploads/rules/ticks-crosses/ctf-1-yes-v2.png)

![Figure: Question #1 feedback - Option Others](/uploads/rules/ticks-crosses/ctf-1-options.png)
...
![Figure: The red cross with the right size and subtle sound](/uploads/rules/ticks-crosses/video-2-the-red-cross-with-the-right-size-and-subtle-sound.png)

![Figure: Question #2 feedback](/uploads/rules/ticks-crosses/ctf-2-yes-v2.png)

![Figure: Question #2 feedback - Option Others](/uploads/rules/ticks-crosses/ctf-2-others.png)
...
![Figure: The red cross and bad example in the lower third, without sound and no colour](/uploads/rules/ticks-crosses/video-3-the-red-cross-bad-example-in-the-lower-third-without-sound-and-no-colour.png)

![Figure: Question #3 feedback](/uploads/rules/ticks-crosses/ctf-3-v3-v2.png)

![Figure: Question #3 feedback - Option Others](/uploads/rules/ticks-crosses/ctf-3-others.png)
...
![Figure: The good example with a more subtle sound](/uploads/rules/ticks-crosses/video-4-.png)

![Figure: Question #4 feedback](/uploads/rules/ticks-crosses/ctf-4.png)

![Figure: Question #4 feedback - Option Others](/uploads/rules/ticks-crosses/ctf-4-blur.png)
