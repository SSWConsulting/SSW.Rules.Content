...
isArchived: true
lastUpdated: 2025-07-16 23:30:45+00:00
...
<imageEmbed
  ...
  captionText={"Cursor Command Generation (ctrl-K)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Cursor Chat Context, opened by typing `@`"}
...
<imageEmbed
  ...
  captionText={"Bad example - Using ChatGPT with only one instruction, requiring you to copy paste the commands into the IDE"}
...
<imageEmbed
  ...
  captionText={"Good example - Using Cursor Agent to create a Tina App, with multiple provided instructions"}
