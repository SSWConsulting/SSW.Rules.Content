...
<imageEmbed
  ...
  caption={"Cursor Command Generation (ctrl-K)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Cursor Chat Context, opened by typing `@`"}
...
<imageEmbed
  ...
  caption={"Bad example - Using ChatGPT with only one instruction, requiring you to copy paste the commands into the IDE"}
...
<imageEmbed
  ...
  caption={"Good example - Using Cursor Agent to create a Tina App, with multiple provided instructions"}
