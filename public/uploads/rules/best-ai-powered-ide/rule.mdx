...
<imageEmbed
  ...
  figureText={"Cursor Command Generation (ctrl-K)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Cursor Chat Context, opened by typing `@`"}
...
<imageEmbed
  ...
  figureText={"Bad example - Using ChatGPT with only one instruction, requiring you to copy paste the commands into the IDE"}
...
<imageEmbed
  ...
  figureText={"Good example - Using Cursor Agent to create a Tina App, with multiple provided instructions"}
