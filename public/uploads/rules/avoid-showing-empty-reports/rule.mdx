...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Making a user select the parameters before seeing the data"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Empty report caused by incorrect parameter default values (probably hard coded for when the developer wrote the report in 2006)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This report shows initial data as the developer configure useful parameters (in this case default values for the entire month of October Note: in US date format)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Using an Expression to set the default values.(This will not be good enough if there is no data in the current month)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using a query to set default values for report parameters"
