...
created: 2024-08-02 10:30:33+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Making a user select the parameters before seeing the data"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Empty report caused by incorrect parameter default values (probably hard coded for when the developer wrote the report in 2006)"}
...
<imageEmbed
  ...
  figureText={"Good example - This report shows initial data as the developer configure useful parameters (in this case default values for the entire month of October Note: in US date format)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Using an Expression to set the default values.(This will not be good enough if there is no data in the current month)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Using a query to set default values for report parameters"}
...
<imageEmbed
  ...
  figureText={"Create a dataset to query the data and provide useful default parameter values for your report"}
