...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="SugarLearning's wizard for creating a company" src="/uploads/rules/show-users-wizard-progress/sugarlearning-wizard.png" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="The heading from booking.com shows the user at what stage of the ordering process they are at, and what they can expect next. This covers the whole billing process" src="/uploads/rules/show-users-wizard-progress/booking-wizard.png" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Virgin Australia uses a more subtle but also effective approach" src="/uploads/rules/show-users-wizard-progress/virginblue-wizard.png" />
