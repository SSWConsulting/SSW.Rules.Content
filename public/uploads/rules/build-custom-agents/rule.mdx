...
lastUpdated: 2026-03-17T09:07:16.965Z
...
* **You need consistent behavior** - when a task requires specific guardrails, tools, or domain knowledge every time
...
Custom agents can also be equipped with **skills** (slash commands) to guide their behavior for specific tasks. While tools give agents the ability to interact with external systems, skills inject specialized prompts and workflows that standardize how agents approach their work.
...
See [Do you use MCP servers for context?](/mcp-servers-for-context) for more on skills vs MCP servers.
