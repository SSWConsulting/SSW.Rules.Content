...
4. Access reporter
  ...
  caption={"Bad example - Replying inline can mess up the history. No indentation makes it harder to read"}
/>
...
Not Done
  ...
  caption={"OK example - Replying inline should be avoided, but if you have a good reason to, use different colors and indentation for a better readability"}
/>
...
4. Access reporter
  ...
  caption={"Good example - Copying questions and answering without altering the history. Include indentation and different colors for a better readability"}
/>
