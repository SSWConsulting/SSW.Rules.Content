...
4. Access reporter
  ...
  figureText={"Bad example - Replying inline can mess up the history. No indentation makes it harder to read"}
/>
...
Not Done
  ...
  figureText={"OK example - Replying inline should be avoided, but if you have a good reason to, use different colors and indentation for a better readability"}
/>
...
4. Access reporter
  ...
  figureText={"Good example - Copying questions and answering without altering the history. Include indentation and different colors for a better readability"}
/>
