...
<imageEmbed
  ...
  caption={"Bad example - Dark wall on the side, boring wall in the middle, reflective surface with people passing behind, lack of depth"}
...
<imageEmbed
  ...
  caption={"Good example - Interesting background but not distracting, relevant furniture, set reflects theme of show"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - The light is far too bright in comparison to the rest of the shot"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - These lights are diffused enough that the rest of the picture is clearly visible"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Too much clutter on the desk, unnecessary dirty bowl, loose sheets of paper, this would only work if you wanted to illustrate that the character is messy"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Clear space, clear point of focus, minimal cables, only necessary items"}
