...
seoDescription: Essential production design tips for filmmakers and designers—discover
  ...
  your storytelling.
title: Do you use proper Production Design?
categories:
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Dark wall on the side, boring wall in the middle, reflective surface with people passing behind, lack of depth"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Interesting background but not distracting, relevant furniture, set reflects theme of show"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The light is far too bright in comparison to the rest of the shot"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="These lights are diffused enough that the rest of the picture is clearly visible"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Too much clutter on the desk, unnecessary dirty bowl, loose sheets of paper, this would only work if you wanted to illustrate that the character is messy"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Clear space, clear point of focus, minimal cables, only necessary items"
