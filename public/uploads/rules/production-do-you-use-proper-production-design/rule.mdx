...
created: 2011-12-07 06:50:58+00:00
createdBy: Titus Maclaren
createdByEmail: titusmaclaren@ssw.com.au
guid: 193513ae-37cb-4633-aa14-17b8e020984f
isArchived: false
lastUpdated: 2019-02-21 19:50:00+00:00
lastUpdatedBy: Tiago Araujo
lastUpdatedByEmail: TiagoAraujo@ssw.com.au
redirects: []
seoDescription: Essential production design tips for filmmakers and designers—discover
  how to create visually compelling sets, costumes, and environments that enhance
  your storytelling.
...
<imageEmbed
  ...
  figureText={"Bad example - Dark wall on the side, boring wall in the middle, reflective surface with people passing behind, lack of depth"}
...
<imageEmbed
  ...
  figureText={"Good example - Interesting background but not distracting, relevant furniture, set reflects theme of show"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - The light is far too bright in comparison to the rest of the shot"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - These lights are diffused enough that the rest of the picture is clearly visible"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Too much clutter on the desk, unnecessary dirty bowl, loose sheets of paper, this would only work if you wanted to illustrate that the character is messy"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Clear space, clear point of focus, minimal cables, only necessary items"}
