...
<imageEmbed
  ...
  caption={"Bad example - Estimation using t-shirt sizes"}
...
<imageEmbed
  ...
  caption={"OK example - Estimation using Planning Poker with large numbers"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  caption={"OK example - Estimation using Planning Poker with only small numbers"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  caption={"PBI estimates using the \"Thrown method\""}
