...
<imageEmbed
  ...
  figureText={"Bad example - Estimation using t-shirt sizes"}
...
<imageEmbed
  ...
  figureText={"OK example - Estimation using Planning Poker with large numbers"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="okExample"
  figureText={"OK example - Estimation using Planning Poker with only small numbers"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="okExample"
  figureText={"PBI estimates using the \"Thrown method\""}
