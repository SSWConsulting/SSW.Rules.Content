...
<imageEmbed
  ...
  captionText={"Bad example - Estimation using t-shirt sizes"}
...
<imageEmbed
  ...
  captionText={"OK example - Estimation using Planning Poker with large numbers"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  captionText={"OK example - Estimation using Planning Poker with only small numbers"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  captionText={"PBI estimates using the \"Thrown method\""}
