...
<imageEmbed
  ...
  captionText={"Bad example - Able to select only one Project Type on Dynamics"}
...
<imageEmbed
  ...
  captionText={"Good example - Able to select multiple Skills from combo box on Dynamics"}
