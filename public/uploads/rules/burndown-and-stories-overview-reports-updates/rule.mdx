...
<imageEmbed
  ...
  figureText={"Project Progress – There is $30k spent and $8K outstanding"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Burndown report - Shows the progress of the team in the current Sprint – ETA is March 29 and Ana has no work to do"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Stories Overview report - Shows the progress of the User Stories in the current Sprint and nothing has been tested and no active bugs"}
