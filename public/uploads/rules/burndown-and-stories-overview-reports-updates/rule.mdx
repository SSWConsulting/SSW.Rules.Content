...
![Figure 1: Project Progress – There is $30k spent and $8K outstanding](/uploads/rules/burndown-and-stories-overview-reports-updates/../../assets/project-progress-capture.jpg)

### 2. Current hours remaining and hours completed for the current Sprint

![Figure 2: Burndown report - Shows the progress of the team in the current Sprint – ETA is March 29 and Ana has no work to do](/uploads/rules/burndown-and-stories-overview-reports-updates/../../assets/burndown.jpg)
...
![Figure 3: Stories Overview report - Shows the progress of the User Stories in the current Sprint and nothing has been tested and no active bugs](/uploads/rules/burndown-and-stories-overview-reports-updates/../../assets/stories-overview.jpg)
