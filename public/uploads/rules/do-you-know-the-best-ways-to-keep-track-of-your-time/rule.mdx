...
<imageEmbed
  ...
  captionText={"Bad example – Physical Diaries are no longer needed"}
...
<imageEmbed
  ...
  captionText={"Good example – Azure DevOps commit messages are a very accurate recording of what work was done"}
