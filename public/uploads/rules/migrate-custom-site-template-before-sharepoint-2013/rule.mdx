...
type: rule
uri: migrate-custom-site-template-before-sharepoint-2013
---
...
![](/uploads/rules/migrate-custom-site-template-before-sharepoint-2013/missingSiteTemplateError.jpg)
...
![](/uploads/rules/migrate-custom-site-template-before-sharepoint-2013/siteTemplateStructure.jpg)

3.Package the site template’s **definition** XML file to map location “ **\{SharePointRoot}\TEMPLATE\1033\XML** ”.

![](/uploads/rules/migrate-custom-site-template-before-sharepoint-2013/siteTemplateDefinitionFile.jpg)
