...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The sample applications do not include the concept of a business"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="An enterprise solution should include a business layer and a data layer abstraction"
