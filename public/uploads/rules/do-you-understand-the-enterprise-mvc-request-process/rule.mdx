...
<imageEmbed
  ...
  captionText={"Bad example – The sample applications do not include the concept of a business"}
...
<imageEmbed
  ...
  captionText={"Good example – An enterprise solution should include a business layer and a data layer abstraction"}
