...
<imageEmbed
  ...
  figureText={"Good example - Asking \"Can I call you?\" - especially for complicated conversations"}
...
<imageEmbed
  ...
  figureText={"Height-adjustable monitor and laptop stand"}
...
<imageEmbed
  ...
  figureText={"Bad example - Ugly background showing an air conditioner"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Nice background"}
