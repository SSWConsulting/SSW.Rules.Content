...
<imageEmbed
  ...
  caption={"Good example - Asking \"Can I call you?\" - especially for complicated conversations"}
...
<imageEmbed
  ...
  caption={"Height-adjustable monitor and laptop stand"}
...
<imageEmbed
  ...
  caption={"Bad example - Ugly background showing an air conditioner"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Nice background"}
