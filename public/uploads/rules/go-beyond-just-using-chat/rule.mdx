...
<imageEmbed
  ...
  captionText={"Good example - Asking \"Can I call you?\" - especially for complicated conversations"}
...
<imageEmbed
  ...
  captionText={"Height-adjustable monitor and laptop stand"}
...
<imageEmbed
  ...
  captionText={"Bad example - Ugly background showing an air conditioner"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Nice background"}
