...
isArchived: false
lastUpdated: 2025-07-07 01:00:02+00:00
...
<imageEmbed
  ...
  captionText={"Bad example – Project builds without errors or warnings, but it uses unwanted or obsolete APIs"}
...
<imageEmbed
  ...
  captionText={"Good example – The analyzer blocks the build and guides the developer towards the approved approach"}
