...
<imageEmbed
  ...
  captionText={"Notice that SharePoint protection only selects the SharePoint_Config and Content databases"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Ensure you back up the remaining databases in the SharePoint SQL Instance"}
