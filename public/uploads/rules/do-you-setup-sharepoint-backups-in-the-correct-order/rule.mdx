...
<imageEmbed
  ...
  figureText={"Notice that SharePoint protection only selects the SharePoint_Config and Content databases"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Ensure you back up the remaining databases in the SharePoint SQL Instance"}
