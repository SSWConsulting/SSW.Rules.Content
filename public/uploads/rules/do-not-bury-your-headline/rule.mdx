...
sidebarVideo: 'https://www.youtube.com/shorts/aM35RlMposA'
authors:
  - title: Adam Cogan
...
When communicating important information, it's crucial to ensure that the main purpose is immediately clear. 

Burying the headline, by placing the primary message deep within the text, can lead to confusion and miscommunication.

<endIntro />

* **State the main purpose early** - The main purpose of an email should be in the first sentence. This helps ensure that even if the recipient [skims the email](/f-shaped-pattern), they understand the primary message.
...
<boxEmbed
  ...
  body={<>
    ...
    Thanks for your help with the project. The updates you made were mostly correct. I have reviewed the code and noticed a few things. Some sections of the code need refactoring. I think it's better if we avoid adding those changes until we meet tomorrow.
    
    Thanks,
    John
  </>}
  figurePrefix="bad"
  figure="The main point is buried and not immediately clear"
/>
...
<boxEmbed
  ...
  body={<>
    ...
    I have reviewed the code and some sections need refactoring.
    
    Can we meet tomorrow to review before any changes are made?
  ...
  figurePrefix="good"
  figure="The main point is clear and immediately addressed"
/>
