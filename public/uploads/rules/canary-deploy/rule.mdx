...
<imageEmbed
  ...
  captionText={"Example canary deployment spreadsheet – track who is testing, the environment, and their feedback"}
...
**Outcome:** It’s unclear who will test, when they’ll start, and how feedback is documented.
  ...
  captionText={"Bad example – No clear plan, no single source of truth, no tracked outcomes"}
/>
...
**Outcome:** Everyone knows who is next to test, what issues have been found, and what the next steps are.
  ...
  captionText={"Good example – A single, consistently updated spreadsheet for your canary rollouts"}
/>
