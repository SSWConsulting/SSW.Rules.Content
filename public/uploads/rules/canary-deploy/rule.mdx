...
type: rule
uri: canary-deploy
created: 2025-02-17T18:49:35-03:00
...
<imageEmbed
  alt="Canary deployment tracking spreadsheet"
  size="large"
  showBorder={false}
  figurePrefix="none"
...
**Outcome:** It’s unclear who will test, when they’ll start, and how feedback is documented.
  ...
  figurePrefix="bad"
  figure="No clear plan, no single source of truth, no tracked outcomes"
/>
...
**Outcome:** Everyone knows who is next to test, what issues have been found, and what the next steps are.
  ...
  figurePrefix="good"
  figure="A single, consistently updated spreadsheet for your canary rollouts"
/>
