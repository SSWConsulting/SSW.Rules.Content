...
<imageEmbed
  ...
  captionText={"Bad example - Oldies use yellow sticky notes"}
...
Thanks,
  ...
  captionText={"Good example - Use <1week@followupthen.com> to be reminded of this email in one week"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Schedule send option in Outlook"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Set a follow-up date"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Add an additional reminder to follow up"}
...
<imageEmbed
  ...
  captionText={"OK example - Using Follow Up Flags to set email reminders"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"See your whole day of tasks on a single window including flagged emails"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Right click | schedule send"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Remind App in Teams"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Phone reminders are great for tasks that need to be actioned immediately"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Meetings are the best way to follow up on tasks that require multiple people's attention"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Having a task or PBI in place makes sure a problem gets addressed"}
