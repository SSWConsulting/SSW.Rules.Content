...
created: 2009-03-27 03:06:15+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Oldies use yellow sticky notes"}
...
Thanks,
  ...
  figureText={"Good example - Use <1week@followupthen.com> to be reminded of this email in one week"}
/>
...
<imageEmbed
  ...
  figureText={"Good example - Schedule send option in Outlook"}
...
<imageEmbed
  ...
  figureText={"Set a follow-up date"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add an additional reminder to follow up"}
...
<imageEmbed
  ...
  figureText={"OK example - Using Follow Up Flags to set email reminders"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"See your whole day of tasks on a single window including flagged emails"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Right click | schedule send"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Remind App in Teams"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Phone reminders are great for tasks that need to be actioned immediately"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Meetings are the best way to follow up on tasks that require multiple people's attention"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Having a task or PBI in place makes sure a problem gets addressed"}
