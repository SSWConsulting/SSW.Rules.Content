...
<imageEmbed
  ...
  caption={"Bad example - Oldies use yellow sticky notes"}
...
Thanks,
  ...
  caption={"Good example - Use <1week@followupthen.com> to be reminded of this email in one week"}
/>
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  caption={"Good example - Schedule send option in Outlook"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  caption={"Add an additional reminder to follow up"}
...
<imageEmbed
  ...
  caption={"OK example - Using Follow Up Flags to set email reminders"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"See your whole day of tasks on a single window including flagged emails"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Right click | schedule send"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Phone reminders are great for tasks that need to be actioned immediately"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Meetings are the best way to follow up on tasks that require multiple people's attention"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Having a task or PBI in place makes sure a problem gets addressed"}
