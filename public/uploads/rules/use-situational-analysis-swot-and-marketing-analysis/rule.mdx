...
<imageEmbed
  ...
  caption={"SWOT analysis template to help you ask the big questions about your business"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"You should follow these steps in order to conduct your market analysis"}
