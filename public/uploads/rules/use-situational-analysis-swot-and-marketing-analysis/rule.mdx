...
<imageEmbed
  ...
  figureText={"SWOT analysis template to help you ask the big questions about your business"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"You should follow these steps in order to conduct your market analysis"}
