...
created: 2019-11-05 23:02:44+00:00
createdBy: Tiago Araujo
createdByEmail: TiagoAraujo@ssw.com.au
guid: dc80624c-10d3-4141-bb84-aa5b159a84cd
isArchived: false
lastUpdated: 2021-07-02 22:18:49.934000+00:00
lastUpdatedBy: Tiago Araújo [SSW]
lastUpdatedByEmail: tiagov8@gmail.com
redirects:
- schema-do-you-use-bit-numeric-data-type-correctly
seoDescription: Schema optimization tip - Use bit/numeric data types correctly by
  choosing between tinyint, smallint, int, and bigint based on your specific requirements.
