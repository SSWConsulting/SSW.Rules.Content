...
isArchived: false
lastUpdated: 2019-07-29 23:02:32+00:00
...
<imageEmbed
  ...
  figureText={"The bad was is to browse the code"}
...
<imageEmbed
  ...
  figureText={"Run Code Metrics in Visual Studio"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Red dots indicate the code that is hard to maintain. E.g. Save() and LoadCustomer()"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Find out who the devs are by using CodeLens and start a conversation"}
