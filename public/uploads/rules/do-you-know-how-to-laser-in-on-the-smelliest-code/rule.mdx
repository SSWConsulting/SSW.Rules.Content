...
<imageEmbed
  ...
  captionText={"The bad was is to browse the code"}
...
<imageEmbed
  ...
  captionText={"Run Code Metrics in Visual Studio"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Red dots indicate the code that is hard to maintain. E.g. Save() and LoadCustomer()"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Find out who the devs are by using CodeLens and start a conversation"}
