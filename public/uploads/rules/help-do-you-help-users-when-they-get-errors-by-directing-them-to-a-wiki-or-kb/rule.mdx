...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Figure - Bad Example: User now has to Google to find out how to fix this error](../../assets/NoDirectForError.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Figure - Good Example: If you click on the "Get Help..." link on the bottom of the form it will take you to a wiki page with common issues and resolutions](../../assets/DirectForError.jpg)',
  shouldDisplay: true
} } />
