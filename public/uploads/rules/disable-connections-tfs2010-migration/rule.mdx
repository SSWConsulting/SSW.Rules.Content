---
archivedreason: Outdated - Applies to TFS 2010 migration operational steps (end-of-life). For modern guidance, see [Steps required when migrating to the cloud](/steps-required-when-migrating-to-the-cloud).
isArchived: true
authors:
- title: Adam Cogan
