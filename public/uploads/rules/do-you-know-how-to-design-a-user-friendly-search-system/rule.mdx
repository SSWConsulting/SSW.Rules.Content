...
<imageEmbed
  ...
  caption={"Bad example - Search fields are on the same form as the data entry controls"}
...
<imageEmbed
  ...
  caption={"Good example - Search functionality on a dedicated form with a recently updated records and standard search"}
