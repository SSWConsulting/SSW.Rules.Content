---
seoDescription: Design a user-friendly search system that simplifies data retrieval
  and enhances overall application usability by prioritizing clarity, simplicity,
  and adaptability.
type: rule
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Search fields are on the same form as the data entry controls"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Search functionality on a dedicated form with a recently updated records and standard search"
