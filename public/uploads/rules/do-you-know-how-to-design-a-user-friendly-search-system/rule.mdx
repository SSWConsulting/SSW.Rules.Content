...
<imageEmbed
  ...
  captionText={"Bad example - Search fields are on the same form as the data entry controls"}
...
<imageEmbed
  ...
  captionText={"Good example - Search functionality on a dedicated form with a recently updated records and standard search"}
