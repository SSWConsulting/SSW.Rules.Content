...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Asking ChatGPT to explain this code"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"ChatGPT explains the code"}
