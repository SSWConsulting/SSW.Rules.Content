...
<imageEmbed
  ...
  caption={"Good example - The Legend of Engadine on iOS and Android is free to play, but a one-time purchase unlocks premium features."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Microsoft 365 is available to home and business users for a low recurring cost"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Cronometer offers a paid and free tier. On the free tier, users see ads, but can pay to remove them"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - The Zinio app is a digital magazine platform. The app is free, but users pay to subscribe to a magazine or to purchase individual issues"}
