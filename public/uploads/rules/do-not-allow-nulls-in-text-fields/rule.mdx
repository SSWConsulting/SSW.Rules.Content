...
isArchived: false
lastUpdated: 2021-04-09 00:20:24.480000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"A check box is required if you want to allow user to use Null value on the UI"}
