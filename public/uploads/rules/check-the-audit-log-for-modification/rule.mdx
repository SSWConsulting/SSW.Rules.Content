...
<imageEmbed
  ...
  caption={"check nobody was modifying the intranet during the long migration"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Modifications are done on the old SharePoint intranet during the migration process (hence not migrated to the cloud)"}
