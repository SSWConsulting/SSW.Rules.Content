...
isArchived: false
lastUpdated: 2021-07-06 17:56:13.647000+00:00
...
<imageEmbed
  ...
  figureText={"check nobody was modifying the intranet during the long migration"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Modifications are done on the old SharePoint intranet during the migration process (hence not migrated to the cloud)"}
