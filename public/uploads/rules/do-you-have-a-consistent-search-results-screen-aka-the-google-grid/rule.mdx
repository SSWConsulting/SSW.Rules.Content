...
<imageEmbed
  ...
  captionText={"Good example – Adopt Google's search result layout"}
...
<imageEmbed
  ...
  captionText={"The header of SSW results screen - filter, number of results found, search criteria and time taken"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - The footer of SSW product order listing page has the hyperlinks for pages 1 to 10 centered"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Google's classic search results"}
