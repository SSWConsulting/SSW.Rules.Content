---
seoDescription: Upgrading DotNetNuke to the latest version ensures your site remains
  secure and features-rich.
type: rule
...
authors:
- author: adam-cogan
created: 2014-03-14 03:24:00+00:00
...
4. Download the latest DotNetNuke upgrade package:
   ...
   A. From the dotnetnuke.com site. You may need login credentials if you are using a non-community version of DNN or
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="No maintenance page. Users may see errors while the site is partially upgraded"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="HTML page to let users know the site is offline to perform the Upgrade"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Latest version has been copied and site is unavailable (suggestion to DNN team: remove the underline from the non-link)"
  src="/uploads/rules/upgrade-dnn-to-the-latest-version/removeunderline.jpg"
/>


5. Access the /install/install.aspx?mode=upgrade page (e.g. `mysite.com/install/install.aspx?mode=upgrade`) using a web browser. The site will begin an automatic upgrade process:
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Automatic upgrade running"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Automatic upgrade completed (suggestion to DNN team: put an underline under the link)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Latest version and no upgrades available"
