...
<imageEmbed
  ...
  figureText={"Bad example - No maintenance page. Users may see errors while the site is partially upgraded"}
...
<imageEmbed
  ...
  figureText={"Good example - HTML page to let users know the site is offline to perform the Upgrade"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Latest version has been copied and site is unavailable (suggestion to DNN team: remove the underline from the non-link)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Automatic upgrade running"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Automatic upgrade completed (suggestion to DNN team: put an underline under the link)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Latest version and no upgrades available"}
