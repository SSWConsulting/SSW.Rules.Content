...
<imageEmbed
  ...
  figureText={"Bad example - Do not manually change settings on each node"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Good example - Changing settings through Group Policy keeps node settings the same"}
