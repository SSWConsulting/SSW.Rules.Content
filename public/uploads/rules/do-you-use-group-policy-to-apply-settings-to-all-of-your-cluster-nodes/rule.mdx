...
isArchived: false
lastUpdated: 2013-04-20 12:29:55+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - Do not manually change settings on each node"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Good example - Changing settings through Group Policy keeps node settings the same"}
