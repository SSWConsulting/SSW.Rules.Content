...
lastUpdated: 2026-02-03T01:45:26.171Z
lastUpdatedBy: Hark
...
<boxEmbed
  body={<>
    Important: Creating a Power BI Template App requires using both:
    
    * Power BI Service (Web / Online) – workspace setup, app creation, app management, and publishing
    * Power BI Desktop (Windows) – report creation, data connections, query editing, and parameter configuration
    
    Some steps cannot be completed in Power BI Service alone.
  </>}
  figurePrefix="none"
  figure=""
  style="info"
...
* [Power BI Desktop App](https://www.microsoft.com/en-us/power-platform/products/power-bi/desktop) (use [VMWare](https://www.vmware.com/products/desktop-hypervisor/workstation-and-fusion) / [Parallels](https://www.parallels.com/) / [Azure VM](https://azure.microsoft.com/en-us/products/virtual-machines) if you are on Mac)
