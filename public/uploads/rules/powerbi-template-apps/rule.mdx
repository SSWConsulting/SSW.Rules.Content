...
lastUpdated: 2026-06-05T07:29:32.307Z
...
* Sample database with dummy data** **with **Read** access
  * Keep it small - rule of thumb: **.pbix** under \~10 MB

#### Step 1: Create the Workspace

<imageEmbed alt="Something here as well alt" size="large" showBorder={false} figurePrefix="none" figure="Something here figure text" src="/uploads/rules/powerbi-template-apps/release-management.png" />

In [app.powerbi.com](https://app.powerbi.com):

1. All workspaces (left side panel) | New workspace
2. Set Name & Description
    <imageEmbed alt="Something here as well alt" size="large" showBorder={false} figurePrefix="none" figure="Something here figure text" src="/uploads/rules/powerbi-template-apps/create-workspace.png" />
3. Advanced section | Workspace type | Power BI Pro
    <imageEmbed alt="Something here as well alt" size="large" showBorder={false} figurePrefix="none" figure="Something here figure text" src="/uploads/rules/powerbi-template-apps/workspace-type.png" />
4. Advanced section | Template apps | Tick off “Develop template apps” (this can't be setup after the workspace is created, so must be enabled now)
    <imageEmbed alt="Something here as well alt" size="large" showBorder={false} figurePrefix="none" figure="Something here figure text" src="/uploads/rules/powerbi-template-apps/develop-template-apps.png" />
5. Click Apply
...
2. **Create and Configure the App**
   ...
   1. This will open up a form, fill out all the fields
   ![](/uploads/rules/powerbi-template-apps/create-app-form.png)
   1. In the Navigation pane, select the reports to be included in the app
   ![](/uploads/rules/powerbi-template-apps/create-app-select-reports.png)
   1. Once everything is filled out, click the "Create app" button
