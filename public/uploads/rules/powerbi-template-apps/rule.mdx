...
lastUpdated: 2026-06-05T06:45:57.738Z
...
* Power BI Desktop App (Windows Only)
  * Mac users - borrow Windows machine or run Windows VM on **VMWare Fusion** (free - recommended ⭐) or Parallels
* Sample database with dummy data to publish with template app
  * the **.pbix & DB in-memory** file should be under \~10 MB
