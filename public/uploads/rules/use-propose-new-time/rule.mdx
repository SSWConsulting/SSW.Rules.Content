...
isArchived: false
lastUpdated: 2020-11-13 00:45:13+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - The person who sent the appointment has to interpret your message, then go back in and edit the appointment"}
...
<imageEmbed
  ...
  figureText={"Good example - Click one of these... and then..."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - New time is proposed, and the person who sent the original appointment can easily accept your proposal (or view all proposals if there are multiple recipients)"}
