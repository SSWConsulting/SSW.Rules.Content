...
created: 2012-12-10 19:53:40+00:00
...
- do-you-make-batch-files-for-deployment-to-test-and-production-servers-(crm-4-only)
seoDescription: CRM developers should not manually move from Dev to Test and Production
  servers. Instead, they can use batch files for deployment to automate the process.
title: Do you make batch files for deployment to Test and Production servers? (CRM
  4 Only)
categories:
