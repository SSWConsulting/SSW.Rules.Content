...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Create the default stacking layout with Bootstrap"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The default stacking behavior on small devices"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="On a smaller device, these columns now arrange horizontally as desired"
