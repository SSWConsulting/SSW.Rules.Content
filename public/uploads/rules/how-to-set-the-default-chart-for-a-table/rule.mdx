...
<imageEmbed
  ...
  figureText={"The first chart in the list is the default"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Two sorts, first alphabetical sort for the defaults, second alphabetical sort for the remaining charts"}
