...
<imageEmbed
  ...
  figureText={"Bad example - When working with people online, drawing on some paper, taking a photo, and emailing it... is the least collaborative way to work"}
...
<imageEmbed
  ...
  figureText={"OK example - Teams Whiteboard is a good collaborating tool while working online. (Using a pen and touch device provides the best experience, using a mouse is not pleasant)"}
...
<imageEmbed
  ...
  figureText={"Good example - An architecture diagram exists on established projects after many discussions"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Samsung Flip can be flipped from horizontal to vertical"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Paper whiteboards don't work when someone is in Sydney and the other attendee is in Melbourne"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Whiteboards are not a sign of a modern office"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Writable walls can be dirty even after cleaning up"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Pens/Styluses help to draw better sketches"}
