...
<imageEmbed
  ...
  captionText={"Bad example - When working with people online, drawing on some paper, taking a photo, and emailing it... is the least collaborative way to work"}
...
<imageEmbed
  ...
  captionText={"OK example - Teams Whiteboard is a good collaborating tool while working online. (Using a pen and touch device provides the best experience, using a mouse is not pleasant)"}
...
<imageEmbed
  ...
  captionText={"Good example - An architecture diagram exists on established projects after many discussions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Samsung Flip can be flipped from horizontal to vertical"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Paper whiteboards don't work when someone is in Sydney and the other attendee is in Melbourne"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Whiteboards are not a sign of a modern office"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Writable walls can be dirty even after cleaning up"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Pens/Styluses help to draw better sketches"}
