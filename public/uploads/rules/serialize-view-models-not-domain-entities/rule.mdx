...
<imageEmbed
  ...
  caption={"Bad example - A naive WebAPI implementation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - A naive update operation"}
...
<imageEmbed
  ...
  caption={"Good Example - Update an Entity from a submitted View Model"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - A Read Operation that selects directly into a view model"}
