...
<imageEmbed
  ...
  captionText={"Bad example - A naive WebAPI implementation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - A naive update operation"}
...
<imageEmbed
  ...
  captionText={"Good Example - Update an Entity from a submitted View Model"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - A Read Operation that selects directly into a view model"}
