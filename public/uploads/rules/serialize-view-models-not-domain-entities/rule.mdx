...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="A naive WebAPI implementation"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="A naive update operation"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Update an Entity from a submitted View Model"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A Read Operation that selects directly into a view model"
