...
- do-you-serialize-view-models-(aka-dtos)-not-domain-entities
seoDescription: Do you serialize View Models (aka DTOs) not Domain Entities when building
  a simple API based on Entity Framework?
...
<imageEmbed
  ...
  figureText={"Bad example - A naive WebAPI implementation"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - A naive update operation"}
...
<imageEmbed
  ...
  figureText={"Good Example - Update an Entity from a submitted View Model"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - A Read Operation that selects directly into a view model"}
