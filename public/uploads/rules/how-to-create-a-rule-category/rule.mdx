...
<imageEmbed
  ...
  captionText={"a friendly url will be automatically generated"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Any futher created \"rule pages\" belong to this \"rule category\" will be listed on this page"}
