...
Dave
  ...
  figureText={"Bad example - Sending a large attachment"}
/>
...
Dave
  ...
  figureText={"Good example - Sending a link instead of an attachment"}
/>
...
<imageEmbed
  ...
  figureText={"SharePoint makes it easy to share or just copy the link"}
