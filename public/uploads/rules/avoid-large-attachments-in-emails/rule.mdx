...
Dave
  ...
  captionText={"Bad example - Sending a large attachment"}
/>
...
Dave
  ...
  captionText={"Good example - Sending a link instead of an attachment"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"SharePoint makes it easy to share or just copy the link"}
