...
Dave
  ...
  caption={"Bad example - Sending a large attachment"}
/>
...
Dave
  ...
  caption={"Good example - Sending a link instead of an attachment"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"SharePoint makes it easy to share or just copy the link"}
