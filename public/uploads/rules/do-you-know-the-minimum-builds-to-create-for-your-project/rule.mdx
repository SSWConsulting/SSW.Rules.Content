...
<imageEmbed
  ...
  caption={"Two builds named in the format [TeamProject].[Areapath]_[Branch].CI|Nightly for every branch"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"You can control what tests are run and what data is collected while they are running"}
...
<imageEmbed
  ...
  caption={"Bad example - you can't tell what these builds do if they are in a larger list"}
...
<imageEmbed
  ...
  caption={"Good example - you know exactly what project, branch and type of build these are for"}
