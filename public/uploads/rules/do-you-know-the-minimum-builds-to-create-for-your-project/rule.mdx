...
<imageEmbed
  ...
  figureText={"Two builds named in the format [TeamProject].[Areapath]_[Branch].CI|Nightly for every branch"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"You can control what tests are run and what data is collected while they are running"}
...
<imageEmbed
  ...
  figureText={"Bad example - you can't tell what these builds do if they are in a larger list"}
...
<imageEmbed
  ...
  figureText={"Good example - you know exactly what project, branch and type of build these are for"}
