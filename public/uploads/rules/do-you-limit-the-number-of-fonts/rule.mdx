...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Different fonts and styles of a flourished type face used. Makes your slide hard to read for the audience"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Even though there are a lot of words, the important ones are clear because there is only one font used, with colors to emphasize"
