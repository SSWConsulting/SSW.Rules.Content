...
<imageEmbed
  ...
  caption={"Bad example - Different fonts and styles of a flourished type face used. Makes your slide hard to read for the audience"}
...
<imageEmbed
  ...
  caption={"Good example - Even though there are a lot of words, the important ones are clear because there is only one font used, with colors to emphasize"}
