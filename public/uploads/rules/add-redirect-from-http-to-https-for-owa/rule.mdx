...
created: 2016-05-02 06:48:16+00:00
...
seoDescription: Simplify Outlook Web App (OWA) access by configuring automatic redirects
  from HTTP to HTTPS for mail.domain.com.
...
<imageEmbed
  ...
  figureText={"Bad example - No redirect in place for OWA"}
...
<imageEmbed
  ...
  figureText={"Good example - Redirect from HTTP to https for OWA"}
