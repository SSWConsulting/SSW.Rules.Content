...
<imageEmbed
  ...
  figureText={"Good example - You can clearly see the point where a fix to production improved the initial page load"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Reviewing the Web test results that provides vital information"}
