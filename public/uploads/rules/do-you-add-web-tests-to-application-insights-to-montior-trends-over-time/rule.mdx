...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - You can clearly see the point where a fix to production improved the initial page load](App-Insights-Web-Test.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - Reviewing the Web test results that provides vital information](App-Insights-Web-Test-drilldown.png)',
  shouldDisplay: true
} } />
