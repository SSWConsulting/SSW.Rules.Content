...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="You can clearly see the point where a fix to production improved the initial page load"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Reviewing the Web test results that provides vital information"
