...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Dates shown as text in graphics (creates extra work to change every time)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="No dates shown as text in graphics (can be re-used without editing)"
