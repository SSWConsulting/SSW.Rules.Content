...
<imageEmbed
  ...
  captionText={"Bad example - Rebecca has a workspace that has not been accessed in a while"}
...
<imageEmbed
  ...
  captionText={"Good example - All of Julian's workspaces are current"}
