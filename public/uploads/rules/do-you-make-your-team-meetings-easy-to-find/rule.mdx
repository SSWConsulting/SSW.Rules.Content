...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="A team member searching for the Daily Scrum cannot find it if it is scheduled like a normal meeting"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="In the past, a SharePoint page was the best way to make meetings visible to the team"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A Microsoft Teams Channel Calendar allows team members to see the Team's meetings before being invited"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Hitting decline on a Microsoft Outlook calendar item only removes you from the meeting temporarily"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Remove yourself from the meeting"
