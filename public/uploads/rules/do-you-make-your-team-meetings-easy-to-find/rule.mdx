...
<imageEmbed
  ...
  caption={"Bad example - A team member searching for the Daily Scrum cannot find it if it is scheduled like a normal meeting"}
...
<imageEmbed
  ...
  caption={"OK example - In the past, a SharePoint page was the best way to make meetings visible to the team"}
...
<imageEmbed
  ...
  caption={"Good example - A Microsoft Teams Channel Calendar allows team members to see the Team's meetings before being invited"}
...
<imageEmbed
  ...
  caption={"Adding a Channel Calendar"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Admin portal - Show Teams email adress in Outlook"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Microsoft Outlook group calendars allow meetings to be edited"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"In Microsoft Teams add the event to your calendar"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"In Microsoft Outlook edit the appointment using the group calendar"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Hitting decline on a Microsoft Outlook calendar item only removes you from the meeting temporarily"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Remove yourself from the meeting"}
