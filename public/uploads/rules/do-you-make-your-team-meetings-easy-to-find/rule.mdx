...
lastUpdated: 2026-06-03T05:11:50.843Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="A team member searching for the Daily Scrum cannot find it if it is scheduled like a normal meeting" src="/uploads/rules/do-you-make-your-team-meetings-easy-to-find/teams-meetings-bad-example.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="ok" figure="In the past, a SharePoint page was the best way to make meetings visible to the team" src="/uploads/rules/do-you-make-your-team-meetings-easy-to-find/team-meetings-ok-example.jpg" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="A Microsoft Teams Channel Calendar allows team members to see the Team's meetings before being invited" src="/uploads/rules/do-you-make-your-team-meetings-easy-to-find/teams-calendar-good.png" />


<youtubeEmbed url="MYIjVqD8AUo" description="Video: An awesome introduction to Channel Calendars in Teams (7 min)" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Adding a Channel Calendar" src="/uploads/rules/do-you-make-your-team-meetings-easy-to-find/adding-channel-calendar.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Admin portal - Show Teams email adress in Outlook" src="/uploads/rules/do-you-make-your-team-meetings-easy-to-find/2023-10-06_14-57-03.jpg" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Microsoft Outlook group calendars allow meetings to be edited" src="/uploads/rules/do-you-make-your-team-meetings-easy-to-find/team-calendar.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="In Microsoft Teams add the event to your calendar" src="/uploads/rules/do-you-make-your-team-meetings-easy-to-find/teams-add-to-calendar.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="In Microsoft Outlook edit the appointment using the group calendar" src="/uploads/rules/do-you-make-your-team-meetings-easy-to-find/EditSugarLearningDailyScrum.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Hitting decline on a Microsoft Outlook calendar item only removes you from the meeting temporarily" src="/uploads/rules/do-you-make-your-team-meetings-easy-to-find/declining-appointment.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Remove yourself from the meeting" src="/uploads/rules/do-you-make-your-team-meetings-easy-to-find/edit-appointment.png" />
