...
<imageEmbed
  ...
  captionText={"Bad example - Bryden Oliver showing twice on LinkedIn Search"}
...
<imageEmbed
  ...
  captionText={"LinkedIn doesn’t let you disable/hibernate an account that has a Recruiter License"}
...
<imageEmbed
  ...
  captionText={"Good example - Secondary account clearly states that this is a 'Recruitment account' and is not current"}
