...
<imageEmbed
  ...
  caption={"Bad example - Bryden Oliver showing twice on LinkedIn Search"}
...
<imageEmbed
  ...
  caption={"LinkedIn doesn’t let you disable/hibernate an account that has a Recruiter License"}
...
<imageEmbed
  ...
  caption={"Good example - Secondary account clearly states that this is a 'Recruitment account' and is not current"}
