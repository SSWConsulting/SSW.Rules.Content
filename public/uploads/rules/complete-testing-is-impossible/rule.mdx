...
created: 2022-10-05 03:25:30.775000+00:00
guid: a58ba6fa-1f34-40f5-afea-95e986f7e557
related:
- rule: public/uploads/rules/why-testing-is-important/rule.mdx
seoDescription: Discover why "complete testing" is a myth and how to prioritize effective
  testing instead.
...
<imageEmbed
  ...
  captionText={"Bill Lumbergh might well ask someone to \"test everything\" (from the movie Office Space)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Don't take on impossible missions!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Aim for \"good enough\" testing over complete testing"}
