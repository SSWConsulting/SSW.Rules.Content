...
<imageEmbed
  ...
  caption={"Bill Lumbergh might well ask someone to \"test everything\" (from the movie Office Space)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Don't take on impossible missions!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Aim for \"good enough\" testing over complete testing"}
