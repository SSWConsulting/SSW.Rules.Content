...
<imageEmbed
  ...
  figureText={"Bill Lumbergh might well ask someone to \"test everything\" (from the movie Office Space)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Don't take on impossible missions!"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Aim for \"good enough\" testing over complete testing"}
