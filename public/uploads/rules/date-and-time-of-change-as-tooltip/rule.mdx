...
<imageEmbed
  ...
  caption={"Bad example – Cannot find date or time in tooltip on hover"}
...
<imageEmbed
  ...
  caption={"Good example – On hover, Facebook shows the date and time"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Date change on hover over time of change for sugarlearning item"}
