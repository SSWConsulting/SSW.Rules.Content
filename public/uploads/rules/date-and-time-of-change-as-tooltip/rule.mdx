...
<imageEmbed
  ...
  figureText={"Bad example – Cannot find date or time in tooltip on hover"}
...
<imageEmbed
  ...
  figureText={"Good example – On hover, Facebook shows the date and time"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – Date change on hover over time of change for sugarlearning item"}
