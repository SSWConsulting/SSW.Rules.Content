...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Cannot find date or time in tooltip on hover"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="On hover, Facebook shows the date and time"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Date change on hover over time of change for sugarlearning item"
