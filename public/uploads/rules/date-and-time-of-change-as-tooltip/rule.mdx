...
<imageEmbed
  ...
  captionText={"Bad example – Cannot find date or time in tooltip on hover"}
...
<imageEmbed
  ...
  captionText={"Good example – On hover, Facebook shows the date and time"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – Date change on hover over time of change for sugarlearning item"}
