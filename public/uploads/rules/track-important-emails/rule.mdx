...
<imageEmbed
  ...
  caption={"Tracking an email in Outlook"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Look for the \"Track\" button in the Timeline section of Dynamics 365 web interface to track emails (highlighted in red)"}
