...
<imageEmbed
  ...
  captionText={"Tracking an email in Outlook"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Look for the \"Track\" button in the Timeline section of Dynamics 365 web interface to track emails (highlighted in red)"}
