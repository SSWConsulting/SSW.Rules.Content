...
<imageEmbed
  ...
  figureText={"Tracking an email in Outlook"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Look for the \"Track\" button in the Timeline section of Dynamics 365 web interface to track emails (highlighted in red)"}
