...
**Eddie:** What is FBC?
  ...
  caption={"Bad example: This conversation is unclear as Eddie doesn't know FBC"}
/>
...
**Eddie:** Awesome!
  ...
  caption={"Good example: No acronyms, clear communication"}
/>
...
**Eddie:** Yeah! FBC sounds great.
  ...
  captionStyle="goodExample"
  caption={"Good example: Defined acronyms can be used, but be careful to not assume the other person is aware of the term if you don't know for sure"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example: NB is unclear and old-fashioned"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example: \"Note\" is more common and understandable"}
/>
