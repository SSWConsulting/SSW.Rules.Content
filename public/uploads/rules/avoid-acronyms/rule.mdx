...
created: 2023-06-01 00:22:32.616000+00:00
...
**Eddie:** What is FBC?
  ...
  captionText={"Bad example: This conversation is unclear as Eddie doesn't know FBC"}
/>
...
**Eddie:** Awesome!
  ...
  captionText={"Good example: No acronyms, clear communication"}
/>
...
**Eddie:** Yeah! FBC sounds great.
  ...
  captionStyle="goodExample"
  captionText={"Good example: Defined acronyms can be used, but be careful to not assume the other person is aware of the term if you don't know for sure"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example: NB is unclear and old-fashioned"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example: \"Note\" is more common and understandable"}
/>
