...
created: 2015-10-25 13:35:00+00:00
createdBy: Ben Cull
createdByEmail: BenCull@ssw.com.au
guid: 2b768e59-9f1c-4475-91df-e75b4f0ec0b8
isArchived: false
lastUpdated: 2019-09-16 05:20:41+00:00
lastUpdatedBy: Brendan Richards
lastUpdatedByEmail: BrendanRichards@ssw.com.au
redirects: []
seoDescription: Discover performance bottlenecks and optimize your application with
  Application Insights, uncovering key insights into request failures, page load times,
  and scaling issues.
...
<imageEmbed
  ...
  captionText={"There are 3 spikes to investigate (one on each graph), but which is the most important? Hint: look at the scales!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The 'Average of Browser page load time by URL base' graph will highlight the slowest page."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"In this case, the user agent string gives away the cause, Baidu (a Chinese search engine) got stuck and failed to index the page."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"In this case, the most important detail to action is the Get Healthcheck issue. Now you should be able to optimise the slowest pages"}
