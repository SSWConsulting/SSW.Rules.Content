...
<imageEmbed
  ...
  caption={"There are 3 spikes to investigate (one on each graph), but which is the most important? Hint: look at the scales!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The 'Average of Browser page load time by URL base' graph will highlight the slowest page."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"In this case, the user agent string gives away the cause, Baidu (a Chinese search engine) got stuck and failed to index the page."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"In this case, the most important detail to action is the Get Healthcheck issue. Now you should be able to optimise the slowest pages"}
