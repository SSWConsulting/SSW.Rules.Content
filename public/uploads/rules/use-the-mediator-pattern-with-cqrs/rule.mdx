---
archivedreason: Updated to [ssw.com.au/rules/keep-business-logic-out-of-the-presentation-layer](/keep-business-logic-out-of-the-presentation-layer)
authors:
- title: Adam Cogan
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Although this application clearly has repository and business logic layers, the logic that orchestrates these dependencies is in the ASP.NET Controller and is difficult to reuse"
