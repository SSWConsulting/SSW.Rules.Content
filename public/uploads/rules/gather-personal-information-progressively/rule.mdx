...
<imageEmbed
  ...
  captionText={"Bad example - Comprehensive form requesting overwhelming information at once"}
...
<imageEmbed
  ...
  captionText={"Good example - Simplified form asking for minimal information intiitally"}
