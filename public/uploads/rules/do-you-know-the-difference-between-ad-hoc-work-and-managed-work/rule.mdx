...
<imageEmbed
  ...
  caption={"Good example: Work is done as needed, when needed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example: Scope and tasks are arranged ahead of time during the Spec Review process"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example: A Product Backlog is created with individual Product Backlog Items sized in effort"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example: A Sprint is created for the week with the Product Backlog Items ready to be tracked"}
