...
created: 2010-08-12 08:33:31+00:00
createdBy: SSW2000\cameronshaw
createdByEmail: CameronShaw@ssw.com.au
guid: 8e97289a-3f49-4c32-9063-f2bcb221f8b6
isArchived: false
lastUpdated: 2020-09-11 05:56:38+00:00
lastUpdatedBy: Penny Walker
lastUpdatedByEmail: PennyWalker@ssw.com.au
redirects: []
seoDescription: Do you know the difference between Ad-hoc Work and Managed Work? Learn
  how to manage tasks effectively on a Time and Materials basis with Scrum Master
  or Project Manager.
...
<imageEmbed
  ...
  figureText={"Good example: Work is done as needed, when needed"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example: Scope and tasks are arranged ahead of time during the Spec Review process"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example: A Product Backlog is created with individual Product Backlog Items sized in effort"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example: A Sprint is created for the week with the Product Backlog Items ready to be tracked"}
