...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Work is done as needed, when needed"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Scope and tasks are arranged ahead of time during the Spec Review process"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A Product Backlog is created with individual Product Backlog Items sized in effort"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A Sprint is created for the week with the Product Backlog Items ready to be tracked"
