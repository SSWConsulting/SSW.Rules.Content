...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="File shares and version control lack versioning, discoverability, and dependency management"
/>
...
<boxEmbed
  ...
  figurePrefix="ok"
  figure="3rd party tools add package management but introduce an external dependency"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="VSTS Team Build integrates packaging directly into your CI/CD pipeline"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Sharing source or binaries via packages created using Sonatype Nexus. Already supports Component Governance"
/>
