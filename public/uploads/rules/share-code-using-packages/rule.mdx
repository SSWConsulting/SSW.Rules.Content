...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Start from Visual Studio Marketplace"}
...
<boxEmbed
  ...
  caption={"Good example - Sharing source or binaries via packages created using Sonatype Nexus. Already supports Component Governance"}
/>
