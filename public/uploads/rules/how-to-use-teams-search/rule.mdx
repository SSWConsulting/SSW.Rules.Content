...
<imageEmbed
  ...
  figureText={"Search results for \"marketing\""}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Use the 3 built-in tabs to search through the different types of results"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Built-in filters for Messages"}
