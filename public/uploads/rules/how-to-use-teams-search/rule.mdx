...
<imageEmbed
  ...
  caption={"Search results for \"marketing\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Use the 3 built-in tabs to search through the different types of results"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Built-in filters for Messages"}
