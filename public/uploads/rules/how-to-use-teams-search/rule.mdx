...
<imageEmbed
  ...
  captionText={"Search results for \"marketing\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Use the 3 built-in tabs to search through the different types of results"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Built-in filters for Messages"}
