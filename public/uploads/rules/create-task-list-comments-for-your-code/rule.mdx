...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The comment doesn't show in Task List window"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Marked TODO in the comment, so you can see it in Task List window and double-click to jump to"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Marked HACK in the comment, so you can see it in Task List window and double-click to jump to"
