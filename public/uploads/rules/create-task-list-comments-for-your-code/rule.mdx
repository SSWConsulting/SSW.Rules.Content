...
<imageEmbed
  ...
  figureText={"Bad example - the comment doesn't show in Task List window"}
...
<imageEmbed
  ...
  figureText={"Good example - Marked TODO in the comment, so you can see it in Task List window and double-click to jump to"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Marked HACK in the comment, so you can see it in Task List window and double-click to jump to"}
