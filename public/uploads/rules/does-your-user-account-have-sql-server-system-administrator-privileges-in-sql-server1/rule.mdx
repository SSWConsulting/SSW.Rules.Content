...
isArchived: true
lastUpdated: 2015-08-12 16:09:46+00:00
...
title: "Do you Does your user account have SQL Server System Administrator privileges in SQL — does your user account have sql server system administrator privileges in sql server1?"
  Server?
type: rule
