...
<imageEmbed
  ...
  caption={"New Expense claim required fields"}
...
<imageEmbed
  ...
  caption={"Bad example - The Subject field and Office field are blank"}
...
<imageEmbed
  ...
  caption={"Good example - All the fields are filled in and the subject field is relevant and short"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Non-reimbursable expense"}
