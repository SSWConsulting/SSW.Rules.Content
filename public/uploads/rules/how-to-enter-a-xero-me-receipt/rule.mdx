...
<imageEmbed
  ...
  captionText={"New Expense claim required fields"}
...
<imageEmbed
  ...
  captionText={"Bad example - The Subject field and Office field are blank"}
...
<imageEmbed
  ...
  captionText={"Good example - All the fields are filled in and the subject field is relevant and short"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Non-reimbursable expense"}
