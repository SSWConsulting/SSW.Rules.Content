...
<imageEmbed
  ...
  captionText={"Step 1 - Open the person's shared calendar"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Step 2 - Make sure you invite the person you're sending for"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The attendees will receive an appointment that says you sent it on behalf of the other person"}
