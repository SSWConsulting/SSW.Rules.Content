...
<boxEmbed
  ...
  captionText={"Bad example - None of these things are that big a deal, but they add up to no one wanting to work with Bob"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - Jim has great professional integrity."}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - Although it's only a little late, you still haven't delivered on what you promised"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - Getting ahead of the deadline and making a new commitment"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - Acknowledging an improvement for next time"}
/>
