...
isArchived: false
lastUpdated: 2021-10-12 22:03:39.434000+00:00
...
<boxEmbed
  ...
  figureText={"Bad example - None of these things are that big a deal, but they add up to no one wanting to work with Bob"}
/>
...
<boxEmbed
  ...
  figureText={"Good example - Jim has great professional integrity."}
/>
...
<boxEmbed
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - Although it's only a little late, you still haven't delivered on what you promised"}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Getting ahead of the deadline and making a new commitment"}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Acknowledging an improvement for next time"}
/>
