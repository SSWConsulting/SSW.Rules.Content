...
<imageEmbed
  ...
  captionText={"Good example - Location of Data&#123;&#123; YourUserName &#125;&#125; with OneDrive - &#123;&#123; YourOrganization &#125;&#125; folder in it"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Backup is being done automatically"}
