...
<imageEmbed
  ...
  captionText={"On these 2 emails... Subject \"test\" has recipient on \"To:\"; and subject \"test 2\" has recipient on \"Cc:\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Click View | View Settings | Conditional Formatting | Add | Condition"}
