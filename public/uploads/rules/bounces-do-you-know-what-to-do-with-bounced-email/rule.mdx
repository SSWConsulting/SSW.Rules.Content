...
<imageEmbed
  ...
  figureText={"Enter the domain to check"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Then select \"Blacklist Check\""}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Getting a zero is good, so you know that you are not blacklisted... so Step 1 is good"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Seeing at least 2 MX records is good... Run an SMTP Test to test mail servers. So Step 2 is good"}
...
The problem is likely your end
  ...
  figureText={"What to send the person"}
/>