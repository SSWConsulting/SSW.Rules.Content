...
<imageEmbed
  ...
  caption={"Enter the domain to check"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Then select \"Blacklist Check\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Getting a zero is good, so you know that you are not blacklisted... so Step 1 is good"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Seeing at least 2 MX records is good... Run an SMTP Test to test mail servers. So Step 2 is good"}
...
The problem is likely your end
  ...
  captionStyle="default"
  caption={"What to send the person"}
/>