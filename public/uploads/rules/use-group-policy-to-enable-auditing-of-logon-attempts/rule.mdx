...
isArchived: false
lastUpdated: 2024-02-13 00:32:14+00:00
...
<imageEmbed
  ...
  captionText={"Select 'Audit logon events'"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Select 'Audit: Force audit policy...'"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Successful and Failed login attempts will now appear in Event Viewer | Security"}
