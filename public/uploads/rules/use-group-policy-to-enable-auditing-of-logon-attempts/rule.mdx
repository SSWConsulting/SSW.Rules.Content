...
<imageEmbed
  ...
  caption={"Select 'Audit logon events'"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Select 'Audit: Force audit policy...'"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Successful and Failed login attempts will now appear in Event Viewer | Security"}
