...
<imageEmbed
  ...
  figureText={"Select 'Audit logon events'"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Select 'Audit: Force audit policy...'"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Successful and Failed login attempts will now appear in Event Viewer | Security"}
