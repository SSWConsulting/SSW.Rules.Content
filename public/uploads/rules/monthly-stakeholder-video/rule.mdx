...
\&lt; As per [https://ssw.com.au/rules/monthly-stakeholder-video](https://ssw.com.au/rules/monthly-stakeholder-video) &gt;
  ...
  captionText={"Good example - Watching the video with the Product Owner, then sending it in an email with a task so you can confirm visibility from your team."}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - a list of reports to review each month (this one is a SharePoint example)"}
