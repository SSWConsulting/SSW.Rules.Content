...
\&lt; As per [https://www.ssw.com.au/rules/monthly-stakeholder-video](https://www.ssw.com.au/rules/monthly-stakeholder-video) &gt;
  </>}
  figurePrefix="none"
  figure=""
/>
...
\&lt; As per [https://www.ssw.com.au/rules/monthly-stakeholder-video](https://www.ssw.com.au/rules/monthly-stakeholder-video) &gt;
  ...
  figurePrefix="good"
  figure="Watching the video with the Product Owner, then sending it in an email with a task so you can confirm visibility from your team."
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A list of reports to review each month (this one is a SharePoint example)"
