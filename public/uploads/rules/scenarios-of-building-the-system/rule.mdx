...
<imageEmbed
  ...
  figureText={"The common scenario of a Large Project"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Option 1 - All projects in one single solution"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Option 2 - Every application with its own solution"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Option 3 - Using Staging Areas"}
