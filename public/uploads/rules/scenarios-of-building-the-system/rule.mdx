...
<imageEmbed
  ...
  captionText={"The common scenario of a Large Project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Option 1 - All projects in one single solution"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Option 2 - Every application with its own solution"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Option 3 - Using Staging Areas"}
