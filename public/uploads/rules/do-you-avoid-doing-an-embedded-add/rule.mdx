...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The 'Add New' button, shown in Figure 1, opened the page in the same window"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The 'New' button in Outlook opens a new form for you to construct your email"
