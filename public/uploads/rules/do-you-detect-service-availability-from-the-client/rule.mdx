...
created: 2018-12-10 04:58:24+00:00
createdBy: BrendanRichards
createdByEmail: BrendanRichards@ssw.com.au
guid: b22a548e-76d1-4090-baae-0c58cca49cdb
isArchived: false
lastUpdated: 2025-10-17 04:04:03+00:00
lastUpdatedBy: Alvin Shen [SSW]
lastUpdatedByEmail: 68266870+AlvinShenSSW@users.noreply.github.com
redirects: []
seoDescription: Detect service availability issues and implement fallback strategies
  using our open-source library for seamless handling of blocked services in China
...
<imageEmbed
  ...
  caption={"Figure Bad Example: Attempted requests to Facebook, Google, and Youtube from China took a long time to timeout, adding significant delays to the rendering of this page"}
...
<imageEmbed
  ...
  caption={"Good Example - Only 4 errors on F12 in China. Using SSW.ServiceDetector, there were only short, canceled requests raised to blocked services. The site was then able to fall-back gracefully for some services and load YouKu for videos"}
