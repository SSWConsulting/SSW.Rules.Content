...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "![Figure Bad Example: Attempted requests to Facebook, Google, and Youtube from China took a long time to timeout, adding significant delays to the rendering of this page](/uploads/rules/do-you-detect-service-availability-from-the-client/BlockedDependencies_1710232021933.png)",
  shouldDisplay: true
} } />
