...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Outlook | Follow up flag | Custom reminder"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Microsoft To Do within Outlook"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Zendesk | Agent workspace | Due date and time"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Zendesk Admin Center | Automations | Send email 24 hours before due date"}
