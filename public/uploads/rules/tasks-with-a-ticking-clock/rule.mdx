...
<imageEmbed
  ...
  figureText={"Outlook | Follow up flag | Custom reminder"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Microsoft To Do within Outlook"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Zendesk | Agent workspace | Due date and time"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Zendesk Admin Center | Automations | Send email 24 hours before due date"}
