...
<imageEmbed
  ...
  captionText={"Bad example - In website project, Visual Studio does not have a UI for its command line"}
...
<imageEmbed
  ...
  captionText={"Good example - In web application project, Visual Studio provides a UI for its command line"}
