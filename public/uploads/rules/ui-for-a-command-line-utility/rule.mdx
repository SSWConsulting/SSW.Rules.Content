...
<imageEmbed
  ...
  caption={"Bad example - In website project, Visual Studio does not have a UI for its command line"}
...
<imageEmbed
  ...
  caption={"Good example - In web application project, Visual Studio provides a UI for its command line"}
