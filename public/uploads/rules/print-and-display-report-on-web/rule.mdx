...
<imageEmbed
  ...
  figureText={"Good example - For proper printing, first change the Report's Page Width to 28cm (or 11in) and top and bottom margins to 0.5cm"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Then change the Report's Body Width to 25.4cm (or 10in)"}
...
<imageEmbed
  ...
  figureText={"Bad example - PDF page with 1cm margin (wasted much space on top and bottom)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - PDF page with 0.5cm margin (you have more room for content)"}
