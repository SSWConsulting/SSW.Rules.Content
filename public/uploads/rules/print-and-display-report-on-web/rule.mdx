...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="For proper printing, first change the Report's Page Width to 28cm (or 11in) and top and bottom margins to 0.5cm"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Then change the Report's Body Width to 25.4cm (or 10in)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="PDF page with 1cm margin (wasted much space on top and bottom)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="PDF page with 0.5cm margin (you have more room for content)"
