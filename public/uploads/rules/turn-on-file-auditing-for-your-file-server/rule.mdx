...
created: 2020-08-24 21:11:18+00:00
createdBy: TiagoAraujo
createdByEmail: TiagoAraujo@ssw.com.au
guid: f274fa44-ce17-4bde-981d-ef3329d3c8af
isArchived: false
lastUpdated: 2020-08-24 21:27:04+00:00
lastUpdatedBy: TiagoAraujo
lastUpdatedByEmail: TiagoAraujo@ssw.com.au
redirects:
- do-you-turn-on-file-auditing-for-your-file-server
seoDescription: Enable file auditing on your Windows server to monitor and track access
  to files and folders, ensuring enhanced security and compliance.
...
<imageEmbed
  ...
  captionText={"Good Example - Auditing Successes and Failures in your file shares"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Filtered logs with file access information"}
