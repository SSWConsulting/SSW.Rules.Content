...
<imageEmbed
  ...
  caption={"Operating System's Regional Settings"}
...
<imageEmbed
  ...
  caption={"Bad example - Screens with inconsistent date formats"}
...
<imageEmbed
  ...
  caption={"Good example - Screens with consistent date formats"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Date format incorrect due to unmodified web page language settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Set English (Australia) as the top priority in the browser language settings"}
