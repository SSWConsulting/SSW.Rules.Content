...
<imageEmbed
  ...
  captionText={"Operating System's Regional Settings"}
...
<imageEmbed
  ...
  captionText={"Bad example - Screens with inconsistent date formats"}
...
<imageEmbed
  ...
  captionText={"Good example - Screens with consistent date formats"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Date format incorrect due to unmodified web page language settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Set English (Australia) as the top priority in the browser language settings"}
