...
<imageEmbed
  ...
  figureText={"Operating System's Regional Settings"}
...
<imageEmbed
  ...
  figureText={"Bad example - Screens with inconsistent date formats"}
...
<imageEmbed
  ...
  figureText={"Good example - Screens with consistent date formats"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Date format incorrect due to unmodified web page language settings"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Set English (Australia) as the top priority in the browser language settings"}
