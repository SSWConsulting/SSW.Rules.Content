...
<imageEmbed
  ...
  captionText={"Good example - Assigning roles in PIM"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Having the option of Eligible and Active makes PIM flexible"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Activate just-in-time roles only when you need it"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - PIM emails you when assignments and roles are activated, you can see straight away if something's wrong!"}
