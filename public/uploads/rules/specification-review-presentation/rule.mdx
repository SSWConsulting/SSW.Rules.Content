...
<imageEmbed
  ...
  captionText={"It's a lot easier to get a signature when you've got the right people in the room"}
...
<boxEmbed
  ...
  captionText={"Bad example – A common mistake is to tell the client you will complete it later"}
/>
...
<boxEmbed
  ...
  captionText={"Good example – This is an appointment with a specific time for the next schedule"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Export your PowerPoint presentation as a video"}
