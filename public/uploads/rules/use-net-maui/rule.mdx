...
<imageEmbed
  ...
  figureText={"Bad example - Xamarin project targeting a single platform"}
...
<imageEmbed
  ...
  figureText={"Good example - Cross-platform .NET MAUI app targeting multiple platforms with a shared codebase"}
...
<imageEmbed
  ...
  figureText={".NET MAUI allows you to use C# and XAML to build your apps from a rich toolkit of more than 40 controls, layouts, and pages"}
