...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="This name suggests an action which sounds like it could be a method - but it's meant to represent the order itself"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="A class name that clearly represents a thing is much easier to understand - you couldn't misinterpret this as a method"
/>
