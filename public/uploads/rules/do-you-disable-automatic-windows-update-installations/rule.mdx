...
<imageEmbed
  ...
  captionText={"Bad example – Install updates automatically"}
...
<imageEmbed
  ...
  captionText={"Good example – Download updates but let user choose whether to install them"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Better example – Windows Updates setting is pushed to *ALL* users via group policy"}
