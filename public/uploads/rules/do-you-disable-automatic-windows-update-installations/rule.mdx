...
<imageEmbed
  ...
  caption={"Bad example – Install updates automatically"}
...
<imageEmbed
  ...
  caption={"Good example – Download updates but let user choose whether to install them"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Better example – Windows Updates setting is pushed to *ALL* users via group policy"}
