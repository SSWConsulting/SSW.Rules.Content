...
isArchived: false
lastUpdated: 2021-02-27 02:16:12.387000+00:00
...
<imageEmbed
  ...
  figureText={"Bad example – Install updates automatically"}
...
<imageEmbed
  ...
  figureText={"Good example – Download updates but let user choose whether to install them"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Better example – Windows Updates setting is pushed to *ALL* users via group policy"}
