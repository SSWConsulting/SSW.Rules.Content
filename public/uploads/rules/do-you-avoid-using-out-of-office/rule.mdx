...
<imageEmbed
  ...
  caption={"Bad example – Outlook OWA setting the automatic reply"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example – This appointment has “Out Of Office” status which will change other peoples Teams status (unless every person was to change it to \"Free\")"}
...
<imageEmbed
  ...
  caption={"Good example - Step 1 - Click on \"Schedule out of office\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Step 2 – Enter your reason and an end date. This message will be seen by your colleagues when they email or message you in Teams"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Your new status on Teams will be shared across your Outlook calendar, and your team will see you are not around"}
