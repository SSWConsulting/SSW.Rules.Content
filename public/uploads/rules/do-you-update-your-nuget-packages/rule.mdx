...
<imageEmbed
  ...
  caption={"Good example -  NuGet packages via Package Manager are all up-to-date"}
...
<imageEmbed
  ...
  caption={"Update one package at a time eg. The command 'Update-Package EntityFramework' will update the one NuGet package via the Package Manager Console. Then test"}
