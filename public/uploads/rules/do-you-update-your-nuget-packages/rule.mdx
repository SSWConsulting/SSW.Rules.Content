...
isArchived: false
lastUpdated: 2014-08-21 19:27:35+00:00
...
<imageEmbed
  ...
  figureText={"Good example -  NuGet packages via Package Manager are all up-to-date"}
...
<imageEmbed
  ...
  figureText={"Update one package at a time eg. The command 'Update-Package EntityFramework' will update the one NuGet package via the Package Manager Console. Then test"}
