...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example: Page customized using SharePoint Designer](avoid-errors-sp-migration1.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example: Out of the box list view page](avoid-errors-sp-migration2.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example: Sharegate migration report shows error if MicroFeed(s) have not been removed](avoid-errors-sp-migration3.png)',
  shouldDisplay: true
} } />
