...
<imageEmbed
  ...
  captionText={"Bad example: Page customized using SharePoint Designer"}
...
<imageEmbed
  ...
  captionText={"Good example: Out of the box list view page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example: Sharegate migration report shows error if MicroFeed(s) have not been removed"}
