...
<imageEmbed
  ...
  caption={"Bad example: Page customized using SharePoint Designer"}
...
<imageEmbed
  ...
  caption={"Good example: Out of the box list view page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example: Sharegate migration report shows error if MicroFeed(s) have not been removed"}
