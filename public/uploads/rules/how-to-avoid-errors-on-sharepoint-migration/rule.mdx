...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Page customized using SharePoint Designer"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Out of the box list view page"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Sharegate migration report shows error if MicroFeed(s) have not been removed"
