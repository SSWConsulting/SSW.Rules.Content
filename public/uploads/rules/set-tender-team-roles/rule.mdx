...
lastUpdated: 2026-06-28T22:02:12.353Z
...
**Note: **Using the same metephore as before, this would relate to the role of the [Event Master](https://www.ssw.com.au/rules/event-roles), in that they are in charge of the actual creation of the tender materials (like running an event)
