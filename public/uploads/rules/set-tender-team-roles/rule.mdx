...
lastUpdated: 2026-06-29T03:08:12.141Z
...
**Note:** Using the same metaphore as before, this would relate to the role of the [Event Master](https://www.ssw.com.au/rules/event-roles), in that they are in charge of the actual creation of the tender materials (like running an event)
