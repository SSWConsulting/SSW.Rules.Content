...
lastUpdated: 2026-02-26T04:58:43.058Z
lastUpdatedBy: Michael Qiu
lastUpdatedByEmail: MichaelQiu@ssw.com.au
---

Agentic Workflows integrate AI agents into your CI/CD workflows, allowing you to automate repository tasks which have too much ambiguity to be done programmatically. Instead of needing to write complex YAML following specific syntax, you simply describe what you want done, and an AI agent handles it.
...
You may be thinking “How is this different from incorporating AI agents into my regular CI/CD workflows?" The key differences are the incorporation of an AI agent and the amount of control you have over your AI agents!
...
Agentic Workflows are best suited for repetitive tasks within your development workflow that involve some ambiguity and would benefit from AI reasoning, rather than requiring strict, deterministic outputs. They fit naturally alongside your existing CI/CD pipelines, capable of being triggered by the same events that you already use such as code commits, new PRs, etc.
