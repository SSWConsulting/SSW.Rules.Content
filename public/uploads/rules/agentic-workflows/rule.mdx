...
lastUpdated: 2026-03-09T23:58:03.595Z
...
<youtubeEmbed url="https://youtu.be/I2izVUuT8wg" description="Video - GitHub Agentic Workflows | Eddie Kranz | SSW Rules (8 min)" />
...
<boxEmbed
  body={<>
    **Warning:** GitHub Agentic Workflows is currently a research project from GitHub Next and Microsoft Research. Specifications may change, and human supervision is recommended.
  </>}
  figurePrefix="none"
  figure=""
  style="warning"
...
<boxEmbed
  body={<>
    **Note:** This is the current process, but in the future, the development team plans to simplify Agentic Workflows, requiring only a markdown file in `.github/workflows` to allow “agentic things to just happen”.
  </>}
  figurePrefix="none"
  figure=""
  style="info"
...
Agentic Workflows are **not meant** to **replace** your existing, deterministic workflows. Agentic Workflows really **shine**, in situations where ambiguity exists, and some common sense or reasoning is required. For example, you can instruct an Agentic Workflow to compare two GitHub Issues and determine if they are semantically duplicate - which could not be achieved with a deterministic workflow.

This isn't a programmatic instruction set that needs to be written with GitHub Actions syntax, instead, it's something an AI agent can interpret and execute.
