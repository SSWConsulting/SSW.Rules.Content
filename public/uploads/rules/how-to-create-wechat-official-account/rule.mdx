...
<imageEmbed
  ...
  figureText={"WeChat Official Accounts register page"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Choose which type of account you want to register"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Fill in with required information – each email address can be registered for only one WeChat product which means if you use an email to register WeChat Subscription Account, you can’t use it for WeChat Service Account or WeChat Mini Program registration"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"So far WeChat only accept China mainland, so click “Confirm” to continue"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Choose “Subscription Account” as we planned"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"As a company, we choose “Corporation” to continue"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The admin person of this account should be a Chinese because the verification will need his/her personal ID and WeChat payment account"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"A WeChat Office Account operation interface"}
