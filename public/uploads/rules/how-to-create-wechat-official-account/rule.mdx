...
<imageEmbed
  ...
  caption={"WeChat Official Accounts register page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Choose which type of account you want to register"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Fill in with required information – each email address can be registered for only one WeChat product which means if you use an email to register WeChat Subscription Account, you can’t use it for WeChat Service Account or WeChat Mini Program registration"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"So far WeChat only accept China mainland, so click “Confirm” to continue"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Choose “Subscription Account” as we planned"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"As a company, we choose “Corporation” to continue"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The admin person of this account should be a Chinese because the verification will need his/her personal ID and WeChat payment account"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A WeChat Office Account operation interface"}
