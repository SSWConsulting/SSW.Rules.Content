...
isArchived: false
lastUpdated: 2021-04-26 22:23:42.655000+00:00
...
<imageEmbed
  ...
  captionText={"WeChat Official Accounts register page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Choose which type of account you want to register"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Fill in with required information – each email address can be registered for only one WeChat product which means if you use an email to register WeChat Subscription Account, you can’t use it for WeChat Service Account or WeChat Mini Program registration"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"So far WeChat only accept China mainland, so click “Confirm” to continue"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Choose “Subscription Account” as we planned"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"As a company, we choose “Corporation” to continue"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The admin person of this account should be a Chinese because the verification will need his/her personal ID and WeChat payment account"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"A WeChat Office Account operation interface"}
