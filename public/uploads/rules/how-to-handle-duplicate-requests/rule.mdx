...
**B:** <mark style="background-color: #FEF08A">Recommended</mark> - Keep them all and when you do it, reply to all the emails with your ‘Done’ OR close each of the PBIs. (Of course it is a good idea to relate those tasks by adding links or the email subjects)
...
Not done yet. Closing this, as it will be done in another email subject: **“Form options need refresh”** from Jason
  ...
  figurePrefix="bad"
  figure="This email will never get a ‘done’ when completed"
/>
...
FYI – This was also requested by Bob under subject: **“Update the form options”**
  ...
  figurePrefix="good"
  figure="Both emails got a ‘done’ reply and were referenced to each other"
/>