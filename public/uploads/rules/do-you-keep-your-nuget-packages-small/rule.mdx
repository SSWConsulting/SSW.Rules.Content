...
created: 2015-01-31 05:40:06+00:00
createdBy: Igor Goldobin
createdByEmail: IgorGoldobin@ssw.com.au
guid: ea1f4e40-5317-43b3-8847-50115b665732
isArchived: false
lastUpdated: 2015-01-31 05:40:06+00:00
lastUpdatedBy: Igor Goldobin
lastUpdatedByEmail: IgorGoldobin@ssw.com.au
redirects: []
seoDescription: When creating NuGet packages, it's better to create few small packages
  rather than one large package.
...
<imageEmbed
  ...
  figureText={"Bad Example - One big library with lots of features, where most of them are obsolete with a release of ASP.NET MVC 5"}
...
<imageEmbed
  ...
  figureText={"Good Example - Lots of smaller self contained packaged with a single purpose"}
