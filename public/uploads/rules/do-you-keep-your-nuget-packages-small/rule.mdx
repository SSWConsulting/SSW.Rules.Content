...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="One big library with lots of features, where most of them are obsolete with a release of ASP.NET MVC 5"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Lots of smaller self contained packaged with a single purpose"
