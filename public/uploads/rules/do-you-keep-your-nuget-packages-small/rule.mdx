...
<imageEmbed
  ...
  captionText={"Bad Example - One big library with lots of features, where most of them are obsolete with a release of ASP.NET MVC 5"}
...
<imageEmbed
  ...
  captionText={"Good Example - Lots of smaller self contained packaged with a single purpose"}
