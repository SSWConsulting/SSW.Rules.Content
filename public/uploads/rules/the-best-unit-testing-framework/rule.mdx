...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="MS Test was the default testing library for previous versions of .NET and Visual Studio but lacked many features that were available in more complete tools like NUnit"
