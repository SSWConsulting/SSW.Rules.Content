...
<imageEmbed
  ...
  captionText={"Bad example - Lots of non-descriptive comments cluttering the issue."}
...
<imageEmbed
  ...
  captionText={"Good example - Extra context added via comment."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Important information added to the issue itself with a comment."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Important users CC'd within the issue but addressed to the team."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Important users CC'd within comments added extra context."}
