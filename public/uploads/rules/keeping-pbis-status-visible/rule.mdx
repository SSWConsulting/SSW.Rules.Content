...
created: 2023-10-03 00:48:22.310000+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Lots of non-descriptive comments cluttering the issue."}
...
<imageEmbed
  ...
  figureText={"Good example - Extra context added via comment."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Important information added to the issue itself with a comment."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Important users CC'd within the issue but addressed to the team."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Important users CC'd within comments added extra context."}
