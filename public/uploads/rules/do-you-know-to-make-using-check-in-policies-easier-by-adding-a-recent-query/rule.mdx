...
<imageEmbed
  ...
  figureText={"When you use Check-in policies you often will need to select a work item that you selected recently"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add a query just for your associated check ins"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The query should be sorted by 'Changed Date'"}
