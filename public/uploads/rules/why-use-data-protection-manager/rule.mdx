...
<imageEmbed
  ...
  captionText={"Good example - DPM - Healthy backups show green ticks"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Best example - Different options for different budgets and services on your off-site and cloud backups"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - MSP360 (was CloudBerry) has 2 file servers being backed up to the cloud (using BackBlaze, the simplest cloud backup)"}
