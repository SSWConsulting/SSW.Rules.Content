...
isArchived: false
lastUpdated: 2019-07-25 04:24:34+00:00
...
<imageEmbed
  ...
  figureText={"Good example - DPM - Healthy backups show green ticks"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Best example - Different options for different budgets and services on your off-site and cloud backups"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - MSP360 (was CloudBerry) has 2 file servers being backed up to the cloud (using BackBlaze, the simplest cloud backup)"}
