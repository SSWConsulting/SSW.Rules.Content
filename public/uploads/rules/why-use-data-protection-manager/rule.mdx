...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="DPM - Healthy backups show green ticks"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="MSP360 (was CloudBerry) has 2 file servers being backed up to the cloud (using BackBlaze, the simplest cloud backup)"
