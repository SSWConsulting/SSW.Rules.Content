...
<imageEmbed
  ...
  caption={"The options provided by create-vue for scaffolding a Vue.js project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Top-level options when running \"vue create\" using Vue CLI"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Manual feature selection instead of using a preset in Vue CLI"}
