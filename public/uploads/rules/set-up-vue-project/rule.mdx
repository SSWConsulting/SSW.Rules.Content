...
created: 2023-07-17T17:45:40.000Z
...
<imageEmbed
  ...
  captionText={"The options provided by create-vue for scaffolding a Vue.js project"}
  src="/uploads/rules/set-up-vue-project/create-vue.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Top-level options when running \"vue create\" using Vue CLI"}
  src="/uploads/rules/set-up-vue-project/vue-cli-1.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Manual feature selection instead of using a preset in Vue CLI"}
  src="/uploads/rules/set-up-vue-project/vue-cli-2.png"
/>
