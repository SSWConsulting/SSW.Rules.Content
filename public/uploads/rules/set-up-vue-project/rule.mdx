...
<imageEmbed
  ...
  figureText={"The options provided by create-vue for scaffolding a Vue.js project"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Top-level options when running \"vue create\" using Vue CLI"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Manual feature selection instead of using a preset in Vue CLI"}
