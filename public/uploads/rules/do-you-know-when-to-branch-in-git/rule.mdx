...
<imageEmbed
  ...
  figureText={"Bad example - Committing to main"}
...
<imageEmbed
  ...
  figureText={"Good example - Committing to a new branch"}
...
<imageEmbed
  ...
  figureText={"Great diagram from GitHub"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Each change is well described, small and in its own feature branch"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Lots of stale branches that could cause confusion or potentially take a long time to resolve conflicts when merging"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Automatically delete the branch after the pull request completion in Azure Devops"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Set the whole project to auto-delete branch after merging in GitHub"}
