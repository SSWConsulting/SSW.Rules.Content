...
<imageEmbed
  ...
  caption={"Bad example - Committing to main"}
...
<imageEmbed
  ...
  caption={"Good example - Committing to a new branch"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Great diagram from GitHub"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Each change is well described, small and in its own feature branch"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Lots of stale branches that could cause confusion or potentially take a long time to resolve conflicts when merging"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Automatically delete the branch after the pull request completion in Azure Devops"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Set the whole project to auto-delete branch after merging in GitHub"}
