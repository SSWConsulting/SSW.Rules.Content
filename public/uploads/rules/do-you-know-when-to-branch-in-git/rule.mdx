...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Committing to a new branch"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Each change is well described, small and in its own feature branch"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Lots of stale branches that could cause confusion or potentially take a long time to resolve conflicts when merging"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Automatically delete the branch after the pull request completion in Azure Devops"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Set the whole project to auto-delete branch after merging in GitHub"
