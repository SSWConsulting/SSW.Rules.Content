...
isArchived: false
lastUpdated: 2025-03-04 12:59:32+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - Committing to main"}
...
<imageEmbed
  ...
  captionText={"Good example - Committing to a new branch"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Great diagram from GitHub"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Each change is well described, small and in its own feature branch"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Lots of stale branches that could cause confusion or potentially take a long time to resolve conflicts when merging"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Automatically delete the branch after the pull request completion in Azure Devops"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Set the whole project to auto-delete branch after merging in GitHub"}
