...
<imageEmbed
  ...
  figureText={"Outlook can automatically jump to a specified folder or item from a command line"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Outlook address bar (Web toolbar) shows you the URL for every folder"}
