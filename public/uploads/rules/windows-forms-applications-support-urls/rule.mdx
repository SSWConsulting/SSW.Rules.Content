...
<imageEmbed
  ...
  captionText={"Outlook can automatically jump to a specified folder or item from a command line"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Outlook address bar (Web toolbar) shows you the URL for every folder"}
