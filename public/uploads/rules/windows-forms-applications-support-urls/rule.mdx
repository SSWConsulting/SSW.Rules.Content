---
seoDescription: Windows Forms applications can support URLs by adding registry keys
  and handling extra parameters in the main method. This allows users to jump directly
  to a specific record or "page" using a URL.
type: rule
