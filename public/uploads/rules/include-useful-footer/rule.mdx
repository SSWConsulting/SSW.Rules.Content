...
<imageEmbed
  ...
  caption={"Bad example - This footer doesn't provide any useful information"}
...
<imageEmbed
  ...
  caption={"Good example - Useful and informative information should be displayed in your report footer"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Footer in visual studio designer"}
