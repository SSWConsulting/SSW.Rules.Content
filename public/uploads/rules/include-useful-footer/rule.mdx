...
<imageEmbed
  ...
  figureText={"Bad example - This footer doesn't provide any useful information"}
...
<imageEmbed
  ...
  figureText={"Good example - Useful and informative information should be displayed in your report footer"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Footer in visual studio designer"}
