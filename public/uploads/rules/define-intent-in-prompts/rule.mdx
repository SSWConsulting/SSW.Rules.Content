...
<boxEmbed
  ...
  figureText={"Bad example - The prompt is unclear and doesn't define the intent"}
/>
...
<boxEmbed
  ...
  figureText={"Good example - the prompt clearly defines the intent by asking for specific information"}
/>
