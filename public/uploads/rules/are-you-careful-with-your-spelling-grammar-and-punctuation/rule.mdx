...
<imageEmbed
  ...
  caption={"You should also check “Always check spelling before sending” to ensure your message doesn't have mistakes"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A typo caught by Grammarly plugin"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A typo caught by Grammarly"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Click on \"Spelling & Grammar\" button to check your web content"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Click on \"Spelling\" button to check your web content"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Make sure \"Check grammar with spelling\" is enabled"}
