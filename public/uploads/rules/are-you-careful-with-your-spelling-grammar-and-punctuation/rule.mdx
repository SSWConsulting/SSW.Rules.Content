...
<imageEmbed
  ...
  figureText={"You should also check “Always check spelling before sending” to ensure your message doesn't have mistakes"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"A typo caught by Grammarly plugin"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"A typo caught by Grammarly"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Click on \"Spelling & Grammar\" button to check your web content"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Click on \"Spelling\" button to check your web content"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Make sure \"Check grammar with spelling\" is enabled"}
