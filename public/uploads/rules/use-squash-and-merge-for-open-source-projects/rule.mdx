...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="It's hard to follow the changes since there’s noise from all commits on the merged branches"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This merge will be missing important information from the commit message"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This merge will include all the commit messages as part of the PR commit message"
