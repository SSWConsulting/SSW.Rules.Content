...
lastUpdated: 2026-05-05T17:12:59.125Z
...
1. Ensure that the Sitefinity database is indexed and the Statistics are updated.
...
2. Use a reflection tool like DotTrace that can show you what is slow on application start time.
