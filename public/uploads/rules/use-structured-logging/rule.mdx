...
seoDescription: 'Learn how to implement structured logging with Serilog, correlation IDs for distributed tracing, and best practices for queryable logs in production.'
created: 2026-02-05T00:00:00.000Z
createdBy: Chloe Lin
createdByEmail: chloelin@ssw.com.au
lastUpdated: 2026-08-21T12:47:51.759Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="The error is logged, but there is not enough context to identify what failed" src="/uploads/rules/use-structured-logging/bad-example.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="The log includes enough context to identify the failure and where it occurred" src="/uploads/rules/use-structured-logging/good-example.png" />
