...
<imageEmbed
  ...
  figureText={"Choose to create a new SharePoint site when creating Azure DevOps project"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Once your 'TFS Portal' is ready, add a picture of the team site, prior to letting them know about the new site"}
