...
created: 2021-08-31T21:53:30.000Z
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Choose to create a new SharePoint site when creating Azure DevOps project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Once your 'TFS Portal' is ready, add a picture of the team site, prior to letting them know about the new site"}
