---
archivedreason: Outdated - This is based on legacy TFS work item type XML (WIT) templating and import workflows. For modern guidance, see [DevOps best practices](/rules-to-better-devops).
authors:
- title: Lei Xu
...
isArchived: true
lastUpdated: 2021-03-26 05:06:40.515000+00:00
