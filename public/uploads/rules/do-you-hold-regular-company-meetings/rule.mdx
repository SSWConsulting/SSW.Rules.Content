...
<imageEmbed
  ...
  captionText={"Good example - Use the inbuilt meeting functionality to make sure no one gets left out"}
...
&lt;This is as per the rule [https://ssw.com.au/rules/do-you-hold-regular-company-meetings/](/do-you-hold-regular-company-meetings) &gt;
  ...
  captionStyle="goodExample"
  captionText={"Good example - Email template for the meeting"}
/>