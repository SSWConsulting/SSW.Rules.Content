...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Use the inbuilt meeting functionality to make sure no one gets left out"
...
&lt;This is as per the rule [https://www.ssw.com.au/rules/do-you-hold-regular-company-meetings/](/do-you-hold-regular-company-meetings) &gt;
  </>}
  figurePrefix="good"
  figure="Email template for the meeting"
/>