...
<imageEmbed
  ...
  caption={"Bad example - Only the final solution is committed. Experimentation history not recorded"}
...
<imageEmbed
  ...
  caption={"Good example - Each attempt has a new commit and is not lost when retrieving history"}
