...
<imageEmbed
  ...
  captionText={"Bad example - Only the final solution is committed. Experimentation history not recorded"}
...
<imageEmbed
  ...
  captionText={"Good example - Each attempt has a new commit and is not lost when retrieving history"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Setup pull request for feature branch so that we have a history of the commits"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - PR is abandoned with a deleted branch"}
