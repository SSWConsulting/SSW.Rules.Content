...
isArchived: false
lastUpdated: 2019-04-02 03:35:00+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Only the final solution is committed. Experimentation history not recorded"}
...
<imageEmbed
  ...
  figureText={"Good example - Each attempt has a new commit and is not lost when retrieving history"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Setup pull request for feature branch so that we have a history of the commits"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - PR is abandoned with a deleted branch"}
