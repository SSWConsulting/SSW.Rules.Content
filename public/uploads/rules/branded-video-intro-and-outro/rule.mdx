...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example: Intros can have the video title; event logo; or speaker details (depending on the type of video you\'re making)](Screen Shot 2019-05-30 at 8.42.12 AM.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example: Outros should have your logo and tagline](Screen Shot 2019-05-30 at 8.25.51 AM.png)',
  shouldDisplay: true
} } />
