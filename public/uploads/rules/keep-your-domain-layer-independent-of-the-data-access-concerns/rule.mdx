...
<imageEmbed
  ...
  caption={"Bad Example: Domain is cluttered with data annotations"}
...
<imageEmbed
  ...
  caption={"Good Example: Domain is lean, configuration for entity is contained within a separate configuration type"}
...
<imageEmbed
  ...
  caption={"Database implementation is a Infrastructure concern not a Domain concern"}
