...
isArchived: false
lastUpdated: 2021-03-11 22:49:43.164000+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example: Domain is cluttered with data annotations"}
...
<imageEmbed
  ...
  figureText={"Good Example: Domain is lean, configuration for entity is contained within a separate configuration type"}
...
<imageEmbed
  ...
  figureText={"Database implementation is a Infrastructure concern not a Domain concern"}
