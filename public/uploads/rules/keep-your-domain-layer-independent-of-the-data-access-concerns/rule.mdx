...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example: Domain is cluttered with data annotations](/uploads/rules/keep-your-domain-layer-independent-of-the-data-access-concerns/domain-layer-1.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example: Domain is lean, configuration for entity is contained within a separate configuration type](/uploads/rules/keep-your-domain-layer-independent-of-the-data-access-concerns/domain-layer-3.png)',
  shouldDisplay: true
} } />
