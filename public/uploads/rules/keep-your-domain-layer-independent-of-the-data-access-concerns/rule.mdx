...
<imageEmbed
  ...
  captionText={"Bad Example: Domain is cluttered with data annotations"}
...
<imageEmbed
  ...
  captionText={"Good Example: Domain is lean, configuration for entity is contained within a separate configuration type"}
...
<imageEmbed
  ...
  captionText={"Database implementation is a Infrastructure concern not a Domain concern"}
