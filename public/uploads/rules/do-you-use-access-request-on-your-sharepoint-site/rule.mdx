...
<imageEmbed
  ...
  figureText={"Joanna is requesting access to SharePoint site"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Request Notification Email Sample"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Pending Requests List"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"possible actions for requests (Approve, Decline or start a conversation with the request user)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Open \"Access Request\" setting"}
