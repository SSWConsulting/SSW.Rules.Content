...
<imageEmbed
  ...
  captionText={"Joanna is requesting access to SharePoint site"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Request Notification Email Sample"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Pending Requests List"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"possible actions for requests (Approve, Decline or start a conversation with the request user)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Open \"Access Request\" setting"}
