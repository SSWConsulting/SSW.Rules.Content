...
<imageEmbed
  ...
  caption={"Joanna is requesting access to SharePoint site"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Request Notification Email Sample"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"possible actions for requests (Approve, Decline or start a conversation with the request user)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Open \"Access Request\" setting"}
