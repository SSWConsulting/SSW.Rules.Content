...
<boxEmbed
  ...
  figureText={"Good example – You fixed a usability blocker before it impacted users"}
/>
...
<boxEmbed
  ...
  figureText={"Bad example – Avoidable UX issues caused friction and hurt trust"}
/>
