---
seoDescription: Prevent cross-site scripting (XSS) attacks and double encoding issues
  by using .NET Core's `IHtmlString` interface to safely render HTML strings.
type: rule
...
created: 2023-07-28 07:23:06.201000+00:00
