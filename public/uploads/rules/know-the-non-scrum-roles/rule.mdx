...
<imageEmbed
  ...
  captionText={"Don't forget! You can use reports to identify projects that are being worked on without Tech Leads"}
...
3. Of those bullet points listed on the rule... which is your #1?
  ...
  captionStyle="goodExample"
  captionText={"Good example - copy this as email template and send to the Tech Lead so they know what is involved"}
/>