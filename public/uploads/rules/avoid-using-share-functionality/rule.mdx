...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Sending an email with a file using the 'Share' functionality"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The email sent has a notification-look meaning it may be ignored"
...
-a
  ...
  figurePrefix="good"
  figure="Link and tasks sent in a regular email"
/>
