...
<imageEmbed
  ...
  caption={"Bad example - Sending an email with a file using the 'Share' functionality"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - The email sent has a notification-look meaning it may be ignored"}
...
-a
  ...
  caption={"Good example - Link and tasks sent in a regular email"}
/>
