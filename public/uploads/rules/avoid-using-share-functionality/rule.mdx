...
<imageEmbed
  ...
  figureText={"Bad example - Sending an email with a file using the 'Share' functionality"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - The email sent has a notification-look meaning it may be ignored"}
...
-a
  ...
  figureText={"Good example - Link and tasks sent in a regular email"}
/>
