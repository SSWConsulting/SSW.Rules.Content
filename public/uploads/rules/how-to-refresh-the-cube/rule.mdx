...
<imageEmbed
  ...
  caption={"The report footer tells you that the TFS Warehouse is not up to date"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"You will need to call 2 of these web services"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Call \"ProcessWarehouse\" web service with parameter \"DefaultCollection\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Call \"ProcessAnalysisDatabase\" with parameter \"Full\""}
