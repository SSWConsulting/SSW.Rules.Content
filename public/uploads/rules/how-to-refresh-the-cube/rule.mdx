...
<imageEmbed
  ...
  figureText={"The report footer tells you that the TFS Warehouse is not up to date"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"You will need to call 2 of these web services"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Call \"ProcessWarehouse\" web service with parameter \"DefaultCollection\""}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Call \"ProcessAnalysisDatabase\" with parameter \"Full\""}
