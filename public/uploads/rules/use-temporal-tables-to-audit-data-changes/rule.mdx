...
seoDescription: Use temporal tables to audit data changes and easily restore deleted
  records by querying a history table.
...
[Temporal tables](https://learn.microsoft.com/en-us/sql/relational-databases/tables/temporal-tables?view=sql-server-ver17&WT.mc_id=DP-MVP-33518) were introduced in SQL Server 2016 and enhanced with increased features in SQL Server 2017.
