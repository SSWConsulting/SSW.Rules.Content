...
**Location:** Online
  ...
  captionText={"Bad example – Too vague, doesn't say who else is involved or what it’s about"}
/>
...
**Location:** Teams Meeting
  ...
  captionText={"Good example – Clear topic and attendees included in the subject"}
/>
...
**Location:** Hotel
  ...
  captionStyle="badExample"
  captionText={"Bad example – Generic subject and location—unclear which hotel or where it is"}
/>
...
**Location:** 123 Main St, New York, NY
  ...
  captionStyle="goodExample"
  captionText={"Good example – Provides clear hotel name, duration, and address"}
/>
...
**Location:** Airport
  ...
  captionStyle="badExample"
  captionText={"Bad example – No passenger name, flight number, or route — unclear and unhelpful"}
/>
...
**Location:** Terminal 3, Sydney Airport
  ...
  captionStyle="goodExample"
  captionText={"Good example – Includes all essential details for quick reference"}
/>
