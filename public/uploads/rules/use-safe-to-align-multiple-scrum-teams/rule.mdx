...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using SAFe to align multiple Scrum teams ensures everyone is working towards the same goals, improving efficiency and output"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="SAFe allows for better scalability while maintaining agile principles, making it ideal for large projects"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Ignoring SAFe can lead to poor governance and lack of alignment among teams"
