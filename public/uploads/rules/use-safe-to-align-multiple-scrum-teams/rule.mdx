...
<imageEmbed
  ...
  caption={"Good example - Using SAFe to align multiple Scrum teams ensures everyone is working towards the same goals, improving efficiency and output"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - SAFe allows for better scalability while maintaining agile principles, making it ideal for large projects"}
...
<imageEmbed
  ...
  caption={"Bad example - Ignoring SAFe can lead to poor governance and lack of alignment among teams"}
