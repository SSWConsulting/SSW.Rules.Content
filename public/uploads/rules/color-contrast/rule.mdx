...
created: 2024-01-05 04:08:41+00:00
...
<imageEmbed
  ...
  captionText={"Bad example – Black text on SSW Red fails contrast checks"}
...
<imageEmbed
  ...
  captionText={"Good example – White text on SSW Red passes contrast checks"}
