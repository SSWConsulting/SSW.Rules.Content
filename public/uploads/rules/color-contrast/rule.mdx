...
lastUpdated: 2026-07-31T21:50:21.999Z
...
This is also available in Microsoft Edge and Firefox, although the interface may differ slightly.

<boxEmbed
  body={<>
    **Note:** Changes made in DevTools are temporary and disappear when the page is refreshed.
  </>}
  figurePrefix="none"
  figure=""
  style="info"
