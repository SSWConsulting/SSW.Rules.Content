...
<imageEmbed
  ...
  captionText={"Bad example - Overexposed kitchen"}
...
<imageEmbed
  ...
  captionText={"Good example - Person is the brightest subject in the frame"}
...
<imageEmbed
  ...
  captionText={"See how different lighting setups can impact remote meetings videos"}
