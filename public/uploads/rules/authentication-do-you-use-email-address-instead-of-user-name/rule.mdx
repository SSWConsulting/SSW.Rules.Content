...
<imageEmbed
  ...
  figureText={"Bad example - users have to remember which username applies to this particular website"}
...
<imageEmbed
  ...
  figureText={"Good example - users will always remember their primary email address"}
