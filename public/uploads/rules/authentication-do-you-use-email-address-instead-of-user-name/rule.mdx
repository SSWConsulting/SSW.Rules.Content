...
<imageEmbed
  ...
  caption={"Bad example - users have to remember which username applies to this particular website"}
...
<imageEmbed
  ...
  caption={"Good example - users will always remember their primary email address"}
