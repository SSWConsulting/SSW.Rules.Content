...
<imageEmbed
  ...
  captionText={"Bad example - users have to remember which username applies to this particular website"}
...
<imageEmbed
  ...
  captionText={"Good example - users will always remember their primary email address"}
