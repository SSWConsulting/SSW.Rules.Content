---
archivedreason: Replaced by [ssw.com.au/rules/follow-naming-conventions-for-tests-and-test-projects](/follow-naming-conventions-for-tests-and-test-projects)
authors:
- title: Adam Cogan
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Naming for a Unit Test Project"
