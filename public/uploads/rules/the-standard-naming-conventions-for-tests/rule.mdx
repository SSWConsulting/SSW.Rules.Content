...
<imageEmbed
  ...
  captionText={"Good example - Naming for a Unit Test Project"}
...
<imageEmbed
  ...
  captionText={"This rule is consistent with the Visual Studio default"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Unit Test Wizard 1"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Unit Test Wizard 2"}
