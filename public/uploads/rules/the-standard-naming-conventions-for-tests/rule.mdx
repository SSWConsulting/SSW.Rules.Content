---
archivedreason: The rule has been replaced by [https://ssw.com.au/rules/follow-naming-conventions-for-tests-and-test-projects](/follow-naming-conventions-for-tests-and-test-projects)
authors:
- title: Adam Cogan
