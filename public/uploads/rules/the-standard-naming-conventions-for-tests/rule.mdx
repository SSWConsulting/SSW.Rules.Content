...
<imageEmbed
  ...
  caption={"Good example - Naming for a Unit Test Project"}
...
<imageEmbed
  ...
  caption={"This rule is consistent with the Visual Studio default"}
