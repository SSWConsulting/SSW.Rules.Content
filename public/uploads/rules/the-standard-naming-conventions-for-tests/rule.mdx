...
<imageEmbed
  ...
  figureText={"Good example - Naming for a Unit Test Project"}
...
<imageEmbed
  ...
  figureText={"This rule is consistent with the Visual Studio default"}
