...
created: 2024-09-02 02:45:54+00:00
...
Let me know if you have any issues with this!
  ...
  figureText={"Bad Example - explaining how to solve the problem when there are already documentation"}
/>
...
Here is the link to the documentation: [How to enable co-author on Git commits?](https://tina.io/docs/introduction/faq#7-how-to-enable-co-author-on-git-commits).
  ...
  figureText={"Good Example - Replying with a link"}
/>
...
[https://github.com/tinacms/tinacms/issues/4733](https://github.com/tinacms/tinacms/issues/4733)
  ...
  figurePreset="goodExampleExample"
  figureText={"Good Example - Sending a link to a PBI is also acceptable"}
/>
