...
Let me know if you have any issues with this!
  ...
  figurePrefix="bad"
  figure="Explaining how to solve the problem when there are already documentation"
/>
...
[https://github.com/tinacms/tinacms/issues/4733](https://github.com/tinacms/tinacms/issues/4733)
  ...
  figurePrefix="good"
  figure="Sending a link to a PBI is also acceptable"
/>
