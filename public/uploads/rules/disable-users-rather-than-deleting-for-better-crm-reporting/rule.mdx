...
<imageEmbed
  ...
  captionText={"GUID for User Steven Andrews"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"AD User StevenAndrews is tied to STA Employee ID through AD GUID"}
...
<imageEmbed
  ...
  captionText={"Bad example - Don't delete users!"}
...
<imageEmbed
  ...
  captionText={"Good example - Disable users and move them to a disabled users OU"}
