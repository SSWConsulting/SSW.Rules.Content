...
isArchived: false
lastUpdated: 2019-07-10 22:55:07+00:00
...
<imageEmbed
  ...
  figureText={"GUID for User Steven Andrews"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"AD User StevenAndrews is tied to STA Employee ID through AD GUID"}
...
<imageEmbed
  ...
  figureText={"Bad example - Don't delete users!"}
...
<imageEmbed
  ...
  figureText={"Good example - Disable users and move them to a disabled users OU"}
