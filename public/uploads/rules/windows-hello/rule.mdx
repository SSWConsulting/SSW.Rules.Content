...
<imageEmbed
  ...
  captionText={"Bad example - Type in the Password to Login"}
...
<imageEmbed
  ...
  captionText={"Good example - Windows Hello for Business setup"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Example - Authentication Prompts Analysis filtered to Windows Hello"}
