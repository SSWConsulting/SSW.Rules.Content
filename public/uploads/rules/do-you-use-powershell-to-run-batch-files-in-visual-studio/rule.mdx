...
<imageEmbed
  ...
  captionText={"Bad example - Using Windows Command Processor (cmd.exe) for running batch files."}
...
<imageEmbed
  ...
  captionText={"Good example - Using PowerShell for running batch files"}
