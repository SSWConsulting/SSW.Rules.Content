...
::: bad  
![Bad example - Using Windows Command Processor (cmd.exe) for running batch files.](BadBatch_small.jpg)  
:::

::: good  
![Good example - Using PowerShell for running batch files](goodbatch_small.jpg)  
:::
