...
==As per our conversation,== I am going to offer the client a Spec Review for &#123;&#123; $ &#125;&#125;
  ...
  figureText={"Good example - Using \"As per our conversation\" email"}
/>
...
==I tried calling you but didn't get through.== I am going to offer the client a Spec Review for &#123;&#123; $ &#125;&#125;
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Email when you can't reach the person by calling"}
/>
...
<imageEmbed
  ...
  figureText={"Good example - Using Microsoft Teams when you can't reach the person by calling"}
...
1. ==Can you fix this?==
  ...
  figureText={"Bad example - Reason at the bottom"}
/>
...
![Figure: Screenshot of Power BI error](/uploads/rules/as-per-our-conversation-emails/powerbi-error.png)
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Reason at the top"}
/>
