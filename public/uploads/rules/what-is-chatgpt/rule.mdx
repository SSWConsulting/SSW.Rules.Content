...
<imageEmbed
  ...
  caption={"ChatGPT is built by OpenAI, which has Microsoft as an investor!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"ChatGPT provides human like responses!"}
...
There's no scheduling, no "I'll get back to you next week." You ask, it responds. You iterate until it's "good enough," then move on.
  ...
  captionStyle="default"
  caption={"ChatGPT's response when asked \"Why is ChatGPT cool?\""}
/>
