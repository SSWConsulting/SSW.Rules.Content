...
<imageEmbed
  ...
  captionText={"ChatGPT is built by OpenAI, which has Microsoft as an investor!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"ChatGPT provides human like responses!"}
...
Overall, the ability of ChatGPT to understand and generate human-like text has made it a popular tool for businesses and individuals looking to enhance their conversational interfaces and improve their productivity.
  ...
  captionStyle="default"
  captionText={"ChatGPT's response when asked \"Why is ChatGPT cool?\""}
/>
