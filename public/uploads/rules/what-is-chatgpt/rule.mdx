...
<imageEmbed
  ...
  figureText={"ChatGPT is built by OpenAI, which has Microsoft as an investor!"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"ChatGPT provides human like responses!"}
...
Overall, the ability of ChatGPT to understand and generate human-like text has made it a popular tool for businesses and individuals looking to enhance their conversational interfaces and improve their productivity.
  ...
  figureText={"ChatGPT's response when asked \"Why is ChatGPT cool?\""}
/>
