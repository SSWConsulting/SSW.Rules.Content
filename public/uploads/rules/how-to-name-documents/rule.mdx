...
<boxEmbed
  ...
  captionText={"Bad example - File name using spaces to separate words"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - File name using dots to separate words"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - File name using CamelCase doesn't have spaces but also doesn't contain any separators between words"}
/>
...
<boxEmbed
  ...
  captionText={"Good Example - File name uses kebab-case (dashes to separate words)"}
/>
