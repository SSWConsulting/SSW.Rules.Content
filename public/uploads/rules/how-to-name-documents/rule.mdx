...
<boxEmbed
  ...
  figureText={"Bad example - File name using spaces to separate words"}
/>
...
<boxEmbed
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - File name using dots to separate words"}
/>
...
<boxEmbed
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - File name using CamelCase doesn't have spaces but also doesn't contain any separators between words"}
/>
...
<boxEmbed
  ...
  figureText={"Good Example - File name uses kebab-case (dashes to separate words)"}
/>
