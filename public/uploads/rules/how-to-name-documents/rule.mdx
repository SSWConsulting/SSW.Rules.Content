...
isArchived: false
lastUpdated: 2025-12-17 00:18:30+00:00
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="File name using spaces to separate words"
/>
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="File name using dots to separate words"
/>
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="File name using CamelCase doesn't have spaces but also doesn't contain any separators between words"
/>
...
<boxEmbed
  ...
  figurePrefix="ok"
  figure="Underscored (Snake_Case) URLs have good readability but are not recommended by Google"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="File name uses kebab-case (dashes to separate words)"
/>
...
* 2-design.docx
  ...
  figurePrefix="bad"
  figure="Files without leading zeros sort incorrectly"
/>
...
* 10-summary.docx
  ...
  figurePrefix="good"
  figure="Files with leading zeros sort correctly"
/>
