...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"TFS Scheduled Backups Tool"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"TFS Backup tool failed to restore the Tfs_Configuration DB – known bug in TFS 2012 Power Tools RTM"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Backup all relevant databases"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Add tbl_TfsTransactionLogMark table to every Tfs_* Database"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Add sp_SetTransactionLogMark stored procedure to every Tfs_* Database"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Add additional jobs to SQL Server Agent"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Backup Reporting Services encryption keys"}
