...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"TFS Scheduled Backups Tool"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"TFS Backup tool failed to restore the Tfs_Configuration DB – known bug in TFS 2012 Power Tools RTM"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Backup all relevant databases"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Add tbl_TfsTransactionLogMark table to every Tfs_* Database"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Add sp_SetTransactionLogMark stored procedure to every Tfs_* Database"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Add additional jobs to SQL Server Agent"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Backup Reporting Services encryption keys"}
