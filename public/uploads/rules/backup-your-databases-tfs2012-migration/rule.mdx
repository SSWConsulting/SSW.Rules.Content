...
created: 2015-08-12 16:20:53+00:00
...
<imageEmbed
  ...
  figureText={"TFS Scheduled Backups Tool"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"TFS Backup tool failed to restore the Tfs_Configuration DB – known bug in TFS 2012 Power Tools RTM"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Backup all relevant databases"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add tbl_TfsTransactionLogMark table to every Tfs_* Database"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add sp_SetTransactionLogMark stored procedure to every Tfs_* Database"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add additional jobs to SQL Server Agent"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Backup Reporting Services encryption keys"}
