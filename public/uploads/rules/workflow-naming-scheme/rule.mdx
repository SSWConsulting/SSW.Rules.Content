---
seoDescription: Naming your CI workflows - Follow a clear and descriptive naming convention
  to improve developer experience, reduce confusion, and save time by reflecting the
  purpose and sequence of each workflow.
type: rule
...
- author: brady-stroud
- author: matt-wicks
created: 2023-08-20 02:02:31.620000+00:00
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="It's unclear what the workflow does, the name doesn't reflect the sequence of actions."
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="It's clear that changes to the main branch cause a build and deploy."
/>
