...
<boxEmbed
  ...
  figureText={"Bad Example - It's unclear what the workflow does, the name doesn't reflect the sequence of actions."}
/>
...
<boxEmbed
  ...
  figureText={"Bad Example - It's clear that changes to the main branch cause a build and deploy."}
/>
