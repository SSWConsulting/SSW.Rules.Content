---
type: rule
title: Do you set clear expectations with clients from day one?
...
<imageEmbed alt="Image" size="medium" showBorder={false} figurePrefix="none" figure="Mismatched expectations lead to failure" src="/uploads/rules/do-you-manage-clients-expectations/fail-image.png" />
...
According to a [longitudinal update published by the PM World Library](https://pmworldlibrary.net/wp-content/uploads/2026/01/pmwj160-Jan2026-Arcidiacono-research-on-IT-project-failure-rate-2025-update.pdf), analyzing the Standish Group's 2020–2024 CHAOS data:

* Roughly** 70% of all software development projects experience severe budget/schedule overruns**, or fail to ship entirely (19% outright failures, 50% challenged).
