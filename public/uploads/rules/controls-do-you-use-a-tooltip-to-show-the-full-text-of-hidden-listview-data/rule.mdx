...
<imageEmbed
  ...
  caption={"Bad example - Users can't see all the text and the ListView doesn't use a Tooltip"}
...
<imageEmbed
  ...
  caption={"Good example - Users can't see all the text, but the ListView shows all the text via a Tooltip"}
