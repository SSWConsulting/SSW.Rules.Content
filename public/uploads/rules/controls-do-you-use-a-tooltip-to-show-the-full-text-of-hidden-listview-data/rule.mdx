...
isArchived: false
lastUpdated: 2017-02-23 14:35:59+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Users can't see all the text and the ListView doesn't use a Tooltip"}
...
<imageEmbed
  ...
  figureText={"Good example - Users can't see all the text, but the ListView shows all the text via a Tooltip"}
