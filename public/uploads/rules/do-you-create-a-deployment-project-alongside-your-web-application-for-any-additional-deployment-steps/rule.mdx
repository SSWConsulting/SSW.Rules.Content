...
<imageEmbed
  ...
  captionText={"Good Example - Create a Deployment project alongside your web project."}
...
<imageEmbed
  ...
  captionText={"It is important that each of the batch and parameters files has it ‘Copy to Output Directory’ setting set to ‘Copy Always’"}
