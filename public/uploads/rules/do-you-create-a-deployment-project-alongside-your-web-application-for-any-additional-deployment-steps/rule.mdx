...
<imageEmbed
  ...
  caption={"Good Example - Create a Deployment project alongside your web project."}
...
<imageEmbed
  ...
  caption={"It is important that each of the batch and parameters files has it ‘Copy to Output Directory’ setting set to ‘Copy Always’"}
