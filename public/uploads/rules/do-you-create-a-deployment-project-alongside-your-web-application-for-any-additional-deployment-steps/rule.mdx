...
isArchived: false
lastUpdated: 2013-06-03 19:15:43+00:00
...
<imageEmbed
  ...
  figureText={"Good Example - Create a Deployment project alongside your web project."}
...
<imageEmbed
  ...
  figureText={"It is important that each of the batch and parameters files has it ‘Copy to Output Directory’ setting set to ‘Copy Always’"}
