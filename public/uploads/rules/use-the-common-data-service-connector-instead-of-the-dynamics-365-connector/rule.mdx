...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example: Using the deprecated Dynamics 365 connector](bad-connector-use.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example: Using the Common Data Service connector](good-connector-use.png)',
  shouldDisplay: true
} } />
