...
<imageEmbed
  ...
  captionText={"Always supervise tradespeople on site"}
...
<boxEmbed
  ...
  captionText={"Bad example – Too vague, no confirmation of quality, tidiness, or definition of done"}
/>
...
<boxEmbed
  ...
  captionText={"Good example – Supervised, tidy outcome, and definition of done confirmed with Maintenance Manager"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"How to supervise tradesperson step by step"}
