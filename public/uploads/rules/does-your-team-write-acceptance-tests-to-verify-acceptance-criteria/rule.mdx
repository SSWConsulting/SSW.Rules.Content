...
<imageEmbed
  ...
  captionText={"Acceptance test cases on a PBI (in Azure DevOps)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The tester sees the acceptance test cases in Azure Test Plans"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Open the Test Runner using the \"Run\" menu item from test case(s)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"In the Test Runner, the tester follows each of the test steps and passes or fails them as appropriate (using the tick or cross button)"}
