...
<imageEmbed
  ...
  figureText={"Acceptance test cases on a PBI (in Azure DevOps)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The tester sees the acceptance test cases in Azure Test Plans"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Open the Test Runner using the \"Run\" menu item from test case(s)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"In the Test Runner, the tester follows each of the test steps and passes or fails them as appropriate (using the tick or cross button)"}
