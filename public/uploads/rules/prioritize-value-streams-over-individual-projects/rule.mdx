...
<imageEmbed
  ...
  figureText={"Good Example - Prioritizing value streams ensures that all activities are aligned with delivering customer and business value."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - A value stream focus allows for quicker adaptations to market changes."}
...
<imageEmbed
  ...
  figureText={"Bad Example - Focusing on individual projects can lead to misaligned efforts and lower ROI."}
