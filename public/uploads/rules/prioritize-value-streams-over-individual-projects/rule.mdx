...
<imageEmbed
  ...
  caption={"Good Example - Prioritizing value streams ensures that all activities are aligned with delivering customer and business value."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - A value stream focus allows for quicker adaptations to market changes."}
...
<imageEmbed
  ...
  caption={"Bad Example - Focusing on individual projects can lead to misaligned efforts and lower ROI."}
