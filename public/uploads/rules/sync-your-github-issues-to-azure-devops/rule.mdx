...
<imageEmbed
  ...
  captionText={"Good Example - GitHub Issues Syncing to Azure DevOps"}
...
<imageEmbed
  ...
  captionText={"Add the PBI at the top of your backlog"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Inform users where to add new PBIs"}
