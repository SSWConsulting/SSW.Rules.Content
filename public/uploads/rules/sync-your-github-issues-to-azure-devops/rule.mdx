...
isArchived: false
lastUpdated: 2021-03-11 01:31:30.706000+00:00
...
<imageEmbed
  ...
  figureText={"Good Example - GitHub Issues Syncing to Azure DevOps"}
...
<imageEmbed
  ...
  figureText={"Add the PBI at the top of your backlog"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Inform users where to add new PBIs"}
