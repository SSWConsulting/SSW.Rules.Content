...
<imageEmbed
  ...
  figureText={"Bad example - All the forms in the application are user controls"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - All of the controls on this form are on a user control, but are only used once"}
...
<imageEmbed
  ...
  figureText={"Good example - User controls are only used for shared controls"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - The Address User Control is repeated"}
...
<imageEmbed
  ...
  figureText={"User controls are OK in tab pages (exception)"}
