---
seoDescription: When to use User Controls? Master recurring or shared logic and promote
  code reuse with these reusable UI elements.
type: rule
...
authors:
- author: adam-cogan
created: 2014-03-14 02:45:00+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="All the forms in the application are user controls"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="All of the controls on this form are on a user control, but are only used once"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="User controls are only used for shared controls"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The Address User Control is repeated"
