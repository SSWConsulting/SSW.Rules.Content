...
<imageEmbed
  ...
  caption={"Bad example - All the forms in the application are user controls"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - All of the controls on this form are on a user control, but are only used once"}
...
<imageEmbed
  ...
  caption={"Good example - User controls are only used for shared controls"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - The Address User Control is repeated"}
...
<imageEmbed
  ...
  caption={"User controls are OK in tab pages (exception)"}
