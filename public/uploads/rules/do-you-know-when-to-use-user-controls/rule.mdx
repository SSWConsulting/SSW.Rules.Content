...
created: 2024-03-18T17:58:54.000Z
...
<imageEmbed
  ...
  captionText={"Bad example - All the forms in the application are user controls"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - All of the controls on this form are on a user control, but are only used once"}
...
<imageEmbed
  ...
  captionText={"Good example - User controls are only used for shared controls"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - The Address User Control is repeated"}
...
<imageEmbed
  ...
  captionText={"User controls are OK in tab pages (exception)"}
