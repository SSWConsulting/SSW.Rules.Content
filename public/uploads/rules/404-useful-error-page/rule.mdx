...
<imageEmbed
  ...
  figureText={"Bad example - Unhandled error"}
...
<imageEmbed
  ...
  figureText={"Good example - Custom error page"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Playful branding turns an error case into a less negative experience"}
