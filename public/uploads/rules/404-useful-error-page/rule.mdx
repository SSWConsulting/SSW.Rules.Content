...
<imageEmbed
  ...
  captionText={"Bad example - Unhandled error"}
...
<imageEmbed
  ...
  captionText={"Good example - Custom error page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Playful branding turns an error case into a less negative experience"}
