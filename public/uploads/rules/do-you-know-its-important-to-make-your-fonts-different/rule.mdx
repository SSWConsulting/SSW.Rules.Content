...
<imageEmbed
  ...
  captionText={"Bad Example - The heading and body text is very simlar, only 2px font-size difference."}
...
<imageEmbed
  ...
  captionText={"Good Example - The heading as been bolded and the content font size decreased to make it more obvious that the two are different styles."}
