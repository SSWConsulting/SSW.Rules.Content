...
isArchived: false
lastUpdated: 2014-12-16 18:11:19+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example - The heading and body text is very simlar, only 2px font-size difference."}
...
<imageEmbed
  ...
  figureText={"Good Example - The heading as been bolded and the content font size decreased to make it more obvious that the two are different styles."}
