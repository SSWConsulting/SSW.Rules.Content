...
<imageEmbed
  ...
  captionText={"Good example - A nice link in your LinkedIn profile for easy bookings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Setup - Setting up a new Service in Microsoft Bookings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Setup - Turn on Creator Mode in LinkedIn"}
