...
<imageEmbed
  ...
  figureText={"Good example - A nice link in your LinkedIn profile for easy bookings"}
...
<imageEmbed
  ...
  figureText={"Setup - Setting up a new Service in Microsoft Bookings"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Setup - Turn on Creator Mode in LinkedIn"}
