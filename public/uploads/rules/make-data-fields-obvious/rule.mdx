...
I live at Strathfield and my employment salary will be $100,000. Can you please make me a contract?
  ...
  caption={"Bad example - You have to read carefully to find the key information"}
/>
...
Can you please make me a contract?
  ...
  captionStyle="badExample"
  caption={"Bad example - Labels in bold don't highlight the key information, task at the bottom"}
/>
...
* Salary: **$100,000**
  ...
  caption={"Good example - List with the key information in bold, and the numbered task at the top provide great readability"}
/>