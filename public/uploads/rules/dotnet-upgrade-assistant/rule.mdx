...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Use the CLI version of Upgrade Assistant TESTING123" src="/uploads/rules/dotnet-upgrade-assistant/upgrade-assistant-CLI-TESTING123.png" />
