...
lastUpdated: 2026-08-03T06:22:09.729Z
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Custom signature with name, URL, phone number, and IM link"
/>
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="A great long signature for PC" src="/uploads/rules/great-email-signatures/adam-long-signature.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="PC Short Signature Example" src="/uploads/rules/great-email-signatures/Short-Signature-Example.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="With CodeTwo the correct signature is auto selected" src="/uploads/rules/great-email-signatures/codetwo-adam.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Outlook mobile application settings" src="/uploads/rules/great-email-signatures/outlook-app-settings-1.jpg" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Editable mobile signature on Outlook mobile application" src="/uploads/rules/great-email-signatures/outlook-app-settings-2.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="How to add a signature in Outlook in Windows" src="/uploads/rules/great-email-signatures/screen-shot-2021-10-01-at-11.20.33-am.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="How to add a signature in Outlook in Mac" src="/uploads/rules/great-email-signatures/macoutlooksignature.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Add your 'Email Signature' and save" src="/uploads/rules/great-email-signatures/owa-signatures.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Where to find &#x22;View all Outlook settings&#x22;" src="/uploads/rules/great-email-signatures/outlook-settings-signature.png" />
