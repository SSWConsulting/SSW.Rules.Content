...
<boxEmbed
  ...
  caption={"Bad example - The default signature"}
/>
...
ssw.com.au | [+61 2 9953 3000](tel:+61299533000) | [Ping me on Teams](https://teams.microsoft.com/l/chat/0/0?users=adamcogan@ssw.com.au)
  ...
  caption={"Good example – Custom signature with name, URL, phone number, and IM link"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A great long signature for PC"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"PC Short Signature Example"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"With CodeTwo the correct signature is auto selected"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Outlook mobile application settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Editable mobile signature on Outlook mobile application"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"How to add a signature in Outlook in Windows"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"How to add a signature in Outlook in Mac"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Add your 'Email Signature' and save"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Where to find \"View all Outlook settings\""}
