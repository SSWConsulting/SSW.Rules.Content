...
lastUpdated: 2026-02-13T04:12:44.183Z
...
## Option 3 - Android Work Profile (Test DPC) (best separation for Home vs Work)
...
###### Set up a Work Profile using Test DPC

1. Install Test DPC from Google Play
2. Open your app drawer and launch Set up Test DPC
3. Follow the wizard to create a Work Profile
4. You should now see a Work tab (or Work folder) in your apps list

###### Install a second Home Assistant app inside Work Profile

1. Switch to the Work tab in your apps
2. Open Google Play (Work Play Store)
3. Add a Google account that is not used in your personal profile (work-only account)
4. Install Home Assistant (this will be a separate Work instance)
5. Open the Work Home Assistant app and connect to your Work server (follow Option 1 steps)
