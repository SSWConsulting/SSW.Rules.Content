...
<imageEmbed
  ...
  figureText={"Bad example - Leaving the responsibility to each person to write perfect code"}
...
<imageEmbed
  ...
  figureText={"Good example - Make Pull Requests required"}
...
<imageEmbed
  ...
  figureText={"Pull requests also give version history for rejected code!"}
