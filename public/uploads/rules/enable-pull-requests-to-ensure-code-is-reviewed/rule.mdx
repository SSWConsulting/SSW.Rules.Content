...
<imageEmbed
  ...
  captionText={"Bad example - Leaving the responsibility to each person to write perfect code"}
...
<imageEmbed
  ...
  captionText={"Good example - Make Pull Requests required"}
...
<imageEmbed
  ...
  captionText={"Pull requests also give version history for rejected code!"}
