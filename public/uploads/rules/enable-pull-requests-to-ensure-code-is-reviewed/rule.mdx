...
<imageEmbed
  ...
  caption={"Bad example - Leaving the responsibility to each person to write perfect code"}
...
<imageEmbed
  ...
  caption={"Good example - Make Pull Requests required"}
...
<imageEmbed
  ...
  caption={"Pull requests also give version history for rejected code!"}
