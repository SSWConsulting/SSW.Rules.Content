...
<imageEmbed
  ...
  caption={"SharePoint People Search – Notice the Skills coming from UserProfile Service (aka UPS)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Mockup - Improved SharePoint People Search Results"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"User Profile UI in your SharePoint Admin Centre – generally this is not needed the Delve out of the box experience works for your organisation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Delve profile – Click on “Update Profile” to write data back to SharePoint User Profile Service"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"People’s skills are often stored in Dynamics 365 CRM or Salesforce"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Powershell - Reading skills from UserProfile"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Powershell - Adding “Blazor” to Jean’s skill list"}
