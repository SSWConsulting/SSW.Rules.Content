...
created: 2021-07-30 05:06:33+00:00
...
<imageEmbed
  ...
  figureText={"SharePoint People Search – Notice the Skills coming from UserProfile Service (aka UPS)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Mockup - Improved SharePoint People Search Results"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"User Profile UI in your SharePoint Admin Centre – generally this is not needed the Delve out of the box experience works for your organisation"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Delve profile – Click on “Update Profile” to write data back to SharePoint User Profile Service"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"People’s skills are often stored in Dynamics 365 CRM or Salesforce"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Powershell - Reading skills from UserProfile"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Powershell - Adding “Blazor” to Jean’s skill list"}
