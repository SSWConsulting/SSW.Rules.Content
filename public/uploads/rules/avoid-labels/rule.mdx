...
<imageEmbed
  ...
  figureText={"Bad example - Unnecessary labels"}
...
<imageEmbed
  ...
  figureText={"Good example - Users can easily understand the information without the unnecessary labels"}
