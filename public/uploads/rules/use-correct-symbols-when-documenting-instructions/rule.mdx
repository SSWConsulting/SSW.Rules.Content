...
<boxEmbed
  ...
  figureText={"Bad example - Wrong order and too many words"}
/>
...
<boxEmbed
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - No visual cue is given for separate steps"}
/>
...
<boxEmbed
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - Dashes are easy to glance over"}
/>
...
<boxEmbed
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - This is better but may be interpreted incorrectly"}
/>
...
<boxEmbed
  ...
  figureText={"Good example - Makes it easy to follow"}
/>
