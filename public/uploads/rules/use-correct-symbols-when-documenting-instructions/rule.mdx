...
<boxEmbed
  ...
  captionText={"Bad example - Wrong order and too many words"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - No visual cue is given for separate steps"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - Dashes are easy to glance over"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - This is better but may be interpreted incorrectly"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - Makes it easy to follow"}
/>
