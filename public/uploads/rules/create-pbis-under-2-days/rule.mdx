...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: 'Figure: Bad example - This is a monolithic 8-day task',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: 'Figure: Good example - The same monolithic task, broken down into 4 smaller tasks which can all be shipped incrementally',
  shouldDisplay: true
} } />
