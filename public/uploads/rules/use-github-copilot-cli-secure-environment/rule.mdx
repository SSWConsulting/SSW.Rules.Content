...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - Safe mode asks for confirmation before executing commands on both platforms",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - YOLO mode executes commands without asking for approval on both platforms",
  shouldDisplay: true
} } />
