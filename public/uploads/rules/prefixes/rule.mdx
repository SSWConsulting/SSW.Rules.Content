...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - There is no context provided in the title, it could be about subjects for Meetings, Conferences, Videos or something entirely different](badexamplenocontext.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "okExample",
  figure: '![OK example - The context is included in the title](okayexamplehascontext.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - The prefix very clearly identifies the subject in the title](goodexamplehascontextviaprefix.png)',
  shouldDisplay: true
} } />
