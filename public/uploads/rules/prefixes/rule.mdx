...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="There is no context provided in the title, it could be about subjects for Meetings, Conferences, Videos or something entirely different"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="The context is included in the title"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The prefix very clearly identifies the subject in the title"
