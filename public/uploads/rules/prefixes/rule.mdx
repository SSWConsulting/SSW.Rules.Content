...
* Owner - Assigned to backend team
  ...
  caption={"Prefixes are harder to distinguish"}
/>
...
* **Owner** - Assigned to the backend team
  ...
  caption={"Prefixes stand out in bold making it easier to scan and process"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - There is no context provided in the title, it could be about subjects for Meetings, Conferences, Videos or something entirely different"}
...
<imageEmbed
  ...
  caption={"OK example - The context is included in the title"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - The prefix very clearly identifies the subject in the title"}
