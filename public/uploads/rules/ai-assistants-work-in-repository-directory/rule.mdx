...
created: 2025-10-16 17:01:00+00:00
...
* `~/ai-workspace/temp-queries.sql`
  ...
  captionText={"Bad Example - Files scattered across the system are hard to find, review, and clean up"}
/>
...
```
  ...
  captionText={"Good Example - All temporary files are in one predictable location within the repository"}
/>
