...
* `~/ai-workspace/temp-queries.sql`
  ...
  caption={"Bad Example - Files scattered across the system are hard to find, review, and clean up"}
/>
...
```
  ...
  caption={"Good Example - All temporary files are in one predictable location within the repository"}
/>
