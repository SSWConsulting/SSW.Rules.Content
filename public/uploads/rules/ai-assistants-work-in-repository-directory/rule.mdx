...
* `~/ai-workspace/temp-queries.sql`
  ...
  figurePrefix="bad"
  figure="Files scattered across the system are hard to find, review, and clean up"
/>
...
```
  ...
  figurePrefix="good"
  figure="All temporary files are in one predictable location within the repository"
/>
