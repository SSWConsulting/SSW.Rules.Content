...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Limited SharePoint formatting](/uploads/rules/word-documents-vs-sharepoint-wiki-pages/sharepoint-editor.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Microsoft Word\'s well-known, feature rich formatting options](/uploads/rules/word-documents-vs-sharepoint-wiki-pages/microsoft-ribbon.png)',
  shouldDisplay: true
} } />
