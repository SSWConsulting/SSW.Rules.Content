...
isArchived: false
lastUpdated: 2021-09-17 17:06:54.084000+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Elmah gives you a wall of exceptions and no way to flag exceptions as completed"}
...
&lt; This email is as per [https://ssw.com.au/rules/how-to-handle-errors-in-raygun](/how-to-handle-errors-in-raygun) &gt;
  ...
  figureText={"Good example - Email with Raygun application health report"}
/>