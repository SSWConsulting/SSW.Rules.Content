...
<imageEmbed
  ...
  caption={"Bad example - Elmah gives you a wall of exceptions and no way to flag exceptions as completed"}
...
&lt; This email is as per [https://ssw.com.au/rules/how-to-handle-errors-in-raygun](/how-to-handle-errors-in-raygun) &gt;
  ...
  caption={"Good example - Email with Raygun application health report"}
/>