...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Google trends for the above SSGs. In a substantial lead is NextJS, followed by Gatsby"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"NextJS and Gatsby are the major competitors that have been duking it out, lately Next.js has exploded in popularity"}
