...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Set Anchor property to Top, Bottom, Left, Right in the designer"}
...
<imageEmbed
  ...
  caption={"Good example - Textbox with the wrong anchoring and/or docking properties"}
