...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Set Anchor property to Top, Bottom, Left, Right in the designer"}
...
<imageEmbed
  ...
  captionText={"Good example - Textbox with the wrong anchoring and/or docking properties"}
