...
<imageEmbed
  ...
  captionText={"Bad example - This service is using a built-in local service account"}
...
<imageEmbed
  ...
  captionText={"Good example - Run as Account should use a domain account rather than a built-in account"}
