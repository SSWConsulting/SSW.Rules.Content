...
<imageEmbed
  ...
  captionText={"Bad example – A messy background and bad lighting do not look professional"}
...
<imageEmbed
  ...
  captionText={"OK example – Clean home background with a branded monitor showing off the company website (unnecessarily hard to set up)"}
...
<imageEmbed
  ...
  captionText={"Good example – Clean and simple home background with clear and good lighting"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – Office background with nice lighting ☀️"}
