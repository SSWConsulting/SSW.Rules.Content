...
created: 2020-03-25 02:09:43+00:00
...
<imageEmbed
  ...
  figureText={"Bad example – A messy background and bad lighting do not look professional"}
...
<imageEmbed
  ...
  figureText={"OK example – Clean home background with a branded monitor showing off the company website (unnecessarily hard to set up)"}
...
<imageEmbed
  ...
  figureText={"Good example – Clean and simple home background with clear and good lighting"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – Office background with nice lighting ☀️"}
