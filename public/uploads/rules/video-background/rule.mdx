...
<imageEmbed
  ...
  caption={"Bad example – A messy background and bad lighting do not look professional"}
...
<imageEmbed
  ...
  caption={"OK example – Clean home background with a branded monitor showing off the company website (unnecessarily hard to set up)"}
...
<imageEmbed
  ...
  caption={"Good example – Clean and simple home background with clear and good lighting"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Office background with nice lighting ☀️"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example – 1st screen - Blur was used in the office"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – 1st screen - Without blur, the office background looks professional"}
