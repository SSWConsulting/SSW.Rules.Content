...
<boxEmbed
  ...
  captionText={"Bad example - The verb \"tell\" is vague and could lead to a general or unfocused response"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - The verbs \"summarize\" and \"key\" provide clearer instructions and set expectations for the response."}
/>
