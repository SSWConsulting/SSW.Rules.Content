...
**PR description:** Added missing video caption + removed unnecessary brackets
  ...
  figureText={"OK example - Clear and concise description, however it's not clear what task triggered the change"}
/>
...
From email subject by @bob: **SSW.Rules - Video caption missing**. Done - Added missing video caption + removed unnecessary brackets
  ...
  figureText={"Good example - It's clear what changes are being made and where the task came from"}
/>
