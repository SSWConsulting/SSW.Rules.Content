...
**Pull Request title:** Fix exporting
  ...
  captionText={"Bad example - Pull Request title does not tell what issues have been fixed and how"}
/>
...
**Pull Request title:** 🐛 BUG - Fix desktop app exporting - prevent database concurrent access while exporting
  ...
  captionText={"Good example - Pull Request title briefly describes the fix that it has"}
/>
...
**PR description:**
  ...
  captionStyle="badExample"
  captionText={"Bad example - Cannot tell what was done here"}
/>
...
**PR description:** Added missing video caption + removed unnecessary brackets
  ...
  captionText={"OK example - Clear and concise description, however it's not clear what task triggered the change"}
/>
...
From email subject by @bob: **SSW.Rules - Video caption missing**. Done - Added missing video caption + removed unnecessary brackets
  ...
  captionStyle="goodExample"
  captionText={"Good example - It's clear what changes are being made and where the task came from"}
/>
