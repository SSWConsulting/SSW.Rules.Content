...
* Framework-agnostic: works with Next.js, SvelteKit, Nuxt, Express, Hono, and more
...
* No managed/cloud-hosted option yet (unlike Auth0, there is no hosted SaaS tier)
