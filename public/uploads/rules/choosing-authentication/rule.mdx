...
* Primarily suited to workforce/enterprise identity (for consumer-facing scenarios, Okta offers [Customer Identity Cloud](https://www.okta.com/products/customer-identity/), powered by Auth0)
...
* Red Hat downstream support with commercial SLAs available through [Red Hat build of Keycloak](https://access.redhat.com/products/red-hat-build-of-keycloak/)
...
* No fully hosted tier yet (you still run your own server), though paid [Infrastructure](https://better-auth.com/docs/infrastructure/introduction) add-ons provide a dashboard, abuse protection, and enterprise features
...
[WorkOS](https://workos.com) is a commercial, cloud-hosted identity platform designed primarily for B2B SaaS applications that need enterprise-grade authentication. Its flagship product, [AuthKit](https://workos.com/docs/authkit/overview), provides a hosted authentication UI and API covering the full range of modern auth needs — from simple email/password to Enterprise SSO — with a developer-first approach and one of the most generous free tiers available.
...
* **Option A** <mark style="background-color: #FEF08A">(Recommended)</mark> - [Microsoft Entra ID](https://www.microsoft.com/security/business/microsoft-entra?WT.mc_id=ES-MVP-33518) provides all of the functionality you need and provides all required functionality in the free tier.
...
* **Option A** <mark style="background-color: #FEF08A">(Recommended)</mark> - [Microsoft Entra ID](https://www.microsoft.com/security/business/microsoft-entra?WT.mc_id=ES-MVP-33518) (previously Azure Active Directory) - most of the infrastructure for this is already in place for you, and it already meets all your requirements. We would just need to wire up your application to it.
