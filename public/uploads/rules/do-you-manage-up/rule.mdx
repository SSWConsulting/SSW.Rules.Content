...
<imageEmbed
  ...
  caption={"Hard decision - This guy needs to state why he recommends this option"}
...
<boxEmbed
  ...
  caption={"Bad example - Nothing to approve"}
/>
...
1. Please approve
  ...
  caption={"Good example - Approval request in form of a task"}
/>
 ...
 **Option C** - Build a new solution using a third party company - It will be expensive and it will take a long time.
  ...
  captionStyle="goodExample"
  caption={"Good example - Multiple options with reasons and a recommendation"}
/>
