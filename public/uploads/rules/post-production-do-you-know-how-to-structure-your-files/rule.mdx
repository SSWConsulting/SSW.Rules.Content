...
seoDescription: Organize your video files and workflow with a structured approach
  to streamline editing and collaboration.
...
<imageEmbed
  ...
  captionText={"An efficient way for a team to structure their server and common files/folders"}
