---
seoDescription: Optimize your JavaScript code with Lodash wisely and efficiently to
  streamline array manipulation, object iteration, and more.
type: rule
...
authors:
- author: jack-pettit
created: 2023-08-01 23:51:13.657000+00:00
...
// output: [3, 6, 9]
```  
**❌ Figure: Bad Example - using Lodash's \_.map method**
...
**✅ Figure: Good Example - using the native JavaScript Array.map() method**
...
```  
**❌ Figure: Bad Example - native JavaScript find method**
...
**✅ Figure: Good Example - Lodash's \_.find method**