...
categories:
  - category: categories/software-engineering/rules-to-better-software-development.mdx
related: []
---
...
<boxEmbed type="good" caption="Use AI CLI tools for:">
...
<boxEmbed type="ok" caption="Use IDE extensions for:">
