...
<imageEmbed
  ...
  figureText={"Bad example - Using the default NoRows property of the table control - error message is not clear enough"}
...
<imageEmbed
  ...
  figureText={"Good example - Use a customized textbox and icon to show the error message in red"}
...
<imageEmbed
  ...
  figureText={"NoRow property of Table control only allow simple string"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Adding a custom error message to your report"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The Hidden property of the rectangle"}
