...
<imageEmbed
  ...
  captionText={"Bad example - Using the default NoRows property of the table control - error message is not clear enough"}
...
<imageEmbed
  ...
  captionText={"Good example - Use a customized textbox and icon to show the error message in red"}
...
<imageEmbed
  ...
  captionText={"NoRow property of Table control only allow simple string"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Adding a custom error message to your report"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The Hidden property of the rectangle"}
