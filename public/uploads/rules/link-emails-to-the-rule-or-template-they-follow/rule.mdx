...
created: 2012-03-20T15:13:20.000Z
createdBy: Griffen Edge
createdByEmail: GriffenEdge@ssw.com.au
lastUpdated: 2026-03-30T03:39:50.436Z
...
In order for other people to recognize emails following **rules** and **standards**, it's a good idea to include something like "**\<This email was sent as per {{ LINK }}>**" at the end of your email.
...
<emailEmbed
  ...
  body={<>
    ...
    \<This email was sent as per {{ LINK }}>
    
    ...
  </>}
  figurePrefix="good"
  figure="The email follows a template and include a link to it"
/>
