...
<imageEmbed
  ...
  caption={"Bad example - could the information in this message box be moved into the panel on the right"}
...
<imageEmbed
  ...
  caption={"Good example - An error message that does not pop up and block your user"}
