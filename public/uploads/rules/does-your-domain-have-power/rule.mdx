...
<imageEmbed
  ...
  captionText={"Bad example - What happens when you lose your domain to a prankster and you are the PM"}
...
<imageEmbed
  ...
  captionText={"Good example - This website has its main product 'car' in its domain"}
