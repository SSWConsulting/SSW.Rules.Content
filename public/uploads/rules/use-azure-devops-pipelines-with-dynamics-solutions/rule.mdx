...
<imageEmbed
  ...
  caption={"Sample Azure Pipeline to export solution and commit to source control"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Sample Azure Pipeline to create a managed solution from source"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Sample Release Pipeline to deploy the managed solution to production"}
