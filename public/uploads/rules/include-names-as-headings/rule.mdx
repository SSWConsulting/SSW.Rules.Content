...
2. When finished, please repackage with the new registration
  ...
  captionText={"Bad example - Names as normal text is not the best for readability"}
/>
...
2. When finished, please repackage with the new registration
  ...
  captionText={"Good example - When addressing multiple people, include each addressee's name as a separate heading"}
/>
