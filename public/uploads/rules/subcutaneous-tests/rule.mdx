...
<imageEmbed
  ...
  caption={"Good example - Define your workflows in yml files and containerize your testing"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Your tests can then run in your DevOps pipelines"}
