...
<imageEmbed
  ...
  figureText={"Good example - Define your workflows in yml files and containerize your testing"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Your tests can then run in your DevOps pipelines"}
