...
created: 2021-10-21 03:13:06+00:00
...
<imageEmbed
  ...
  captionText={"Good example - Define your workflows in yml files and containerize your testing"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Your tests can then run in your DevOps pipelines"}
