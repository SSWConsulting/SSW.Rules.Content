...
Attached is my Medical Certificate.
  ...
  captionText={"Email to send if you have any medical condition we should be aware of"}
/>
...
<boxEmbed
  ...
  captionText={"Bad Example - Lack of safety training results in increased workplace accidents."}
/>
...
<boxEmbed
  ...
  captionText={"Good Example - Proactive approach to safety ensures a safe working environment."}
/>
