...
Attached is my Medical Certificate.
  ...
  caption={"Email to send if you have any medical condition we should be aware of"}
/>
...
<boxEmbed
  ...
  caption={"Bad Example - Lack of safety training results in increased workplace accidents."}
/>
...
<boxEmbed
  ...
  caption={"Good Example - Proactive approach to safety ensures a safe working environment."}
/>
