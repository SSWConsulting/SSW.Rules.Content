...
Attached is my Medical Certificate.
  ...
  figureText={"Email to send if you have any medical condition we should be aware of"}
/>
...
<boxEmbed
  ...
  figureText={"Bad Example - Lack of safety training results in increased workplace accidents."}
/>
...
<boxEmbed
  ...
  figureText={"Good Example - Proactive approach to safety ensures a safe working environment."}
/>
