...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="You can pass anything into this method, so you get a bad output at run time (“undefined undefined”)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using types means you get errors and intellisense support"
