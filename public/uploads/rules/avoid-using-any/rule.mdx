...
<imageEmbed
  ...
  captionText={"Bad example – You can pass anything into this method, so you get a bad output at run time (“undefined undefined”)"}
...
<imageEmbed
  ...
  captionText={"Good example – Using types means you get errors and intellisense support"}
