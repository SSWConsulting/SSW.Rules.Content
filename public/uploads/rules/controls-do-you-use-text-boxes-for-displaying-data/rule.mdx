...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Not only is the data cut off when you are using label, but you can't copy and paste the value"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using Textbox controls makes the data obvious to users"
