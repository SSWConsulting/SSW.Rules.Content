...
<imageEmbed
  ...
  captionText={"Bad example - Sentences on slides mean the audience isn't listening"}
...
<imageEmbed
  ...
  captionText={"Good example - Use the designer to make slides more interesting"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="badExample"
  captionText={"Bad example - Bullet points make the intent unclear"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Good example - SmartArt easily converts bullets into a timeline"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Good example - Animations"}
