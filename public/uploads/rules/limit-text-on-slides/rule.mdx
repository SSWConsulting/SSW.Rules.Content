...
created: 2023-11-09 21:46:41+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Sentences on slides mean the audience isn't listening"}
...
<imageEmbed
  ...
  figureText={"Good example - Use the designer to make slides more interesting"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="badExample"
  figureText={"Bad example - Bullet points make the intent unclear"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="goodExample"
  figureText={"Good example - SmartArt easily converts bullets into a timeline"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="goodExample"
  figureText={"Good example - Animations"}
