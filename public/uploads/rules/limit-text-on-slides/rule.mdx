...
<imageEmbed
  ...
  caption={"Bad example - Sentences on slides mean the audience isn't listening"}
...
<imageEmbed
  ...
  caption={"Good example - Use the designer to make slides more interesting"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="badExample"
  caption={"Bad example - Bullet points make the intent unclear"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  caption={"Good example - SmartArt easily converts bullets into a timeline"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  caption={"Good example - Animations"}
