...
<imageEmbed
  ...
  figureText={"This is where you can find your Marketing Lists in Microsoft Dynamics CRM 2016"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Click the ellipsis button to reveal the Mail Merge option"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"This is an example of a configuration to start with"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Follow these steps to start working on the mail merge"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Choose the recipients for your mail merge and proceed"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Convert the mail merge document to the newest version"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The highlighted part will change for every recipient"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example configuration for the email that is about to be sent"}
