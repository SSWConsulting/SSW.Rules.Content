...
<imageEmbed
  ...
  captionText={"This is where you can find your Marketing Lists in Microsoft Dynamics CRM 2016"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Click the ellipsis button to reveal the Mail Merge option"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"This is an example of a configuration to start with"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Follow these steps to start working on the mail merge"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Choose the recipients for your mail merge and proceed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Convert the mail merge document to the newest version"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The highlighted part will change for every recipient"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Example configuration for the email that is about to be sent"}
