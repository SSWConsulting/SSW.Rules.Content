...
<imageEmbed
  ...
  caption={"This is where you can find your Marketing Lists in Microsoft Dynamics CRM 2016"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Click the ellipsis button to reveal the Mail Merge option"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"This is an example of a configuration to start with"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Follow these steps to start working on the mail merge"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Choose the recipients for your mail merge and proceed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Convert the mail merge document to the newest version"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The highlighted part will change for every recipient"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Example configuration for the email that is about to be sent"}
