...
Dave
  ...
  captionText={"Bad example - Dirty URL with superfluous information"}
/>
...
Dave
  ...
  captionText={"Good example – Clean URL on a new line is easy to read and looks much better"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Showing unnecessary extra noise \"https://www.\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Clean links in a presentation"}
