...
Dave
  ...
  caption={"Bad example - Dirty URL with superfluous information"}
/>
...
Dave
  ...
  caption={"Good example – Clean URL on a new line is easy to read and looks much better"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Showing unnecessary extra noise \"https://www.\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Clean links in a presentation"}
