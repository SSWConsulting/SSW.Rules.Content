...
<imageEmbed
  ...
  caption={"❌ Bad Example - A great post on Insta Stories that will disappear after 24 hours. Awesome while it lasts!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"✅ Good Example - If it's a great story share, pin it to your Insta Profile so people can watch it later"}
