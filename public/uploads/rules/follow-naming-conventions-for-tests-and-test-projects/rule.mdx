...
created: 2020-03-24 00:04:12+00:00
createdBy: Tiago Araujo
createdByEmail: TiagoAraujo@ssw.com.au
guid: 1aea50c6-b2cc-4e1e-a483-34b4776e0e1e
isArchived: false
lastUpdated: 2020-06-02 04:20:32+00:00
lastUpdatedBy: Jason Taylor
lastUpdatedByEmail: JasonTaylor@ssw.com.au
redirects:
...
seoDescription: Follow naming conventions for tests and test projects to ensure clarity,
...
<imageEmbed
  ...
  figureText={"In the above project the tests are clearly placed in a separate location, making it easy to deploy to production without them. It’s easy to tell which project is under test and what style of tests will be found in each test project"}
...
<imageEmbed
  ...
  figureText={"Bad example - From the Test Explorer view you cannot tell what a test is meant to test just from its name"}
