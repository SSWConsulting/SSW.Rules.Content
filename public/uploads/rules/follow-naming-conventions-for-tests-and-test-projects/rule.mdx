...
<imageEmbed
  ...
  captionText={"In the above project the tests are clearly placed in a separate location, making it easy to deploy to production without them. It’s easy to tell which project is under test and what style of tests will be found in each test project"}
...
<imageEmbed
  ...
  captionText={"Bad example - From the Test Explorer view you cannot tell what a test is meant to test just from its name"}
