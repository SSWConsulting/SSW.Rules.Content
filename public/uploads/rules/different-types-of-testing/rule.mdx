...
created: 2022-11-15 19:30:26+00:00
...
isArchived: false
lastUpdated: 2025-03-26 23:17:54+00:00
...
seoDescription: Discover the different types of testing to ensure your software meets
  user requirements, including smoke testing, unit testing, integration testing, consumer-driven
  contract testing, regression testing, end-to-end testing, acceptance testing, and
  performance testing.
...
<imageEmbed
  ...
  captionText={"Testing Pyramid - You should have more unit tests than manual tests"}
