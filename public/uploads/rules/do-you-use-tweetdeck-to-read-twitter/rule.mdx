...
<imageEmbed
  ...
  caption={"Bad Example: Using the Twitter webpage is not the best way to use Twitter"}
...
<imageEmbed
  ...
  caption={"Good Example : Using TweetDeck gives you a dashboard to follow topics you are interested in"}
