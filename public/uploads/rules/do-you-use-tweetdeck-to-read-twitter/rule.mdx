...
<imageEmbed
  ...
  captionText={"Bad Example: Using the Twitter webpage is not the best way to use Twitter"}
...
<imageEmbed
  ...
  captionText={"Good Example : Using TweetDeck gives you a dashboard to follow topics you are interested in"}
