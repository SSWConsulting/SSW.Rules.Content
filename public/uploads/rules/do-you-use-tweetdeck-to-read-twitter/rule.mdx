...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Using the Twitter webpage is not the best way to use Twitter"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using TweetDeck gives you a dashboard to follow topics you are interested in"
