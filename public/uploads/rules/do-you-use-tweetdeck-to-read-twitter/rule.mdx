...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example: Using the Twitter webpage is not the best way to use Twitter](twitter-webpage.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example : Using TweetDeck gives you a dashboard to follow topics you are interested in](twitter-tweetdeck.png)',
  shouldDisplay: true
} } />
