...
created: 2024-09-09 00:58:40+00:00
...
<imageEmbed
  ...
  captionText={"Microsoft Defender XDR – Dashboard"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Microsoft Secure Score"}
...
<imageEmbed
  ...
  captionText={"Bad example - High exposure level"}
...
<imageEmbed
  ...
  captionText={"Good example – No High exposure level"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Severity level – High Exposure"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Example email alert from Defender"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Unresolved incidents"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - All incidents resolved"}
