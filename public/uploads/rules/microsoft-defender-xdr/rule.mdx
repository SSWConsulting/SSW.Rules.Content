...
<imageEmbed
  ...
  figureText={"Microsoft Defender XDR – Dashboard"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Microsoft Secure Score"}
...
<imageEmbed
  ...
  figureText={"Bad example - High exposure level"}
...
<imageEmbed
  ...
  figureText={"Good example – No High exposure level"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Severity level – High Exposure"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example email alert from Defender"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Unresolved incidents"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - All incidents resolved"}
