...
title: "Do you add a favicon to your website — favicon?"
categories:
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="When you don't add a favicon the user sees the generic browser's icon"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using the favicon gives your website professional look and feel"
