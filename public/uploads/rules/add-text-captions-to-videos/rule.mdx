...
<imageEmbed
  ...
  captionText={"Bad example of captions - Text is too small and hard to read."}
...
<imageEmbed
  ...
  captionText={"Good example of captions - Text is clear and legible. Provides extra value to the viewer with content not mentioned in the video"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Example 1: SSW Infomercials - Clear, nice effects and well stylized"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Example 2: General SSW TV videos - Corporate branding, clear, eye catching"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Example 3: SSW Rules Videos - This is a good generic title style and works well for documentary style videos"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Example 4: SSW Case Studies - This allows us to represent Scrum roles with an icon"}
