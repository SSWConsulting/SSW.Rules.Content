...
created: 2011-12-05 05:41:15+00:00
...
seoDescription: Adding captions to your video enhances viewer experience by providing
  extra information and context not fully explained by speakers
...
<imageEmbed
  ...
  figureText={"Bad example of captions - Text is too small and hard to read."}
...
<imageEmbed
  ...
  figureText={"Good example of captions - Text is clear and legible. Provides extra value to the viewer with content not mentioned in the video"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Example 1: SSW Infomercials - Clear, nice effects and well stylized"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Example 2: General SSW TV videos - Corporate branding, clear, eye catching"}
  src="/uploads/rules/add-text-captions-to-videos/2021-lower-thirds-greybox-redstripe.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Example 3: SSW Rules Videos - This is a good generic title style and works well for documentary style videos"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Example 4: SSW Case Studies - This allows us to represent Scrum roles with an icon"}
