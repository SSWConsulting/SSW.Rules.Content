...
created: 2022-09-15 17:16:42+00:00
...
<imageEmbed
  ...
  caption={"Bad example - Decision is recorded in notepad"}
...
As per our conversation, the primary button colour does not conform with the Northwind branding. The colour will be updated to #CC4141.
  ...
  captionStyle="badExample"
  caption={"Bad example - Sending an email to confirm updates to the work item"}
/>
...
<imageEmbed
  ...
  caption={"Good example - Decision is documented in the work item"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Moving a PBI to the backlog without documenting the decision"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Moving a PBI to the backlog and documenting the decision"}
