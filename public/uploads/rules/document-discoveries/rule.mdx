...
<youtubeEmbed url="2Ff6NQrWMsY" description="Video: Documenting decisions and discoveries with [Piers Sinclair](https://www.ssw.com.au/people/piers-sinclair) (3 min)" />
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Decision is recorded in notepad"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Decision is documented in the work item"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Moving a PBI to the backlog without documenting the decision"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Moving a PBI to the backlog and documenting the decision"
