...
created: 2022-09-15 14:07:00+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Decision is recorded in notepad"}
...
As per our conversation, the primary button colour does not conform with the Northwind branding. The colour will be updated to #CC4141.
  ...
  figureText={"Bad example - Sending an email to confirm updates to the work item"}
/>
...
<imageEmbed
  ...
  figureText={"Good example - Decision is documented in the work item"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Moving a PBI to the backlog without documenting the decision"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Moving a PBI to the backlog and documenting the decision"}
