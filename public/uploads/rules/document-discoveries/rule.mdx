...
lastUpdated: 2026-09-09T22:25:38.628Z
...
<youtubeEmbed url="2Ff6NQrWMsY" description="Video: Documenting decisions and discoveries with Piers Sinclair (3 min)" />
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="bad" figure="Decision is recorded in Notepad" src="/uploads/rules/document-discoveries/RecordingInNotepad.png" />
...
<emailEmbed
  ...
  figurePrefix="bad"
  figure="Sending an email to confirm updates to the work item"
/>

### ✅ Using Work Item discussions
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Decision is documented in the work item" src="/uploads/rules/document-discoveries/document-discoveries-good-example.png" />
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="bad" figure="Moving a PBI to the backlog without documenting the decision" src="/uploads/rules/document-discoveries/Bad-example-Adding-and-Item-to-the-backlog.jpg" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Moving a PBI to the backlog and documenting the decision" src="/uploads/rules/document-discoveries/Good-example-Adding-and-Item-to-the-backlog.jpg" />
