...
isArchived: false
lastUpdated: 2024-07-04 04:11:29+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - Decision is recorded in notepad"}
...
As per our conversation, the primary button colour does not conform with the Northwind branding. The colour will be updated to #CC4141.
  ...
  captionStyle="badExample"
  captionText={"Bad example - Sending an email to confirm updates to the work item"}
/>
...
<imageEmbed
  ...
  captionText={"Good example - Decision is documented in the work item"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Moving a PBI to the backlog without documenting the decision"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Moving a PBI to the backlog and documenting the decision"}
