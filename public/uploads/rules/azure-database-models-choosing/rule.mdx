...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Using a dedicated database for each of your 500 small tenants results in excessive costs and management overhead"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Elastic Pool efficiently distributes resources among databases with variable workloads"
