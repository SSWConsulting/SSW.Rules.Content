...
<imageEmbed
  ...
  caption={"Bad example - Using a dedicated database for each of your 500 small tenants results in excessive costs and management overhead"}
...
<imageEmbed
  ...
  caption={"Good example - Elastic Pool efficiently distributes resources among databases with variable workloads"}
