...
isArchived: false
lastUpdated: 2025-12-03 00:33:48+00:00
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Use slashes on their own, it’s ambiguous"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure='Use "DD MMM YYYY" and include the abbreviated day of the week'
/>
...
* The user group will start at 6.00 pm (use of dot)
  ...
  figurePrefix="bad"
  figure="Incorrect or ambiguous times"
/>
...
* The user group will start at 6 pm tomorrow (12-hour format)
  ...
  figurePrefix="good"
  figure="Correct formatting for time"
/>
