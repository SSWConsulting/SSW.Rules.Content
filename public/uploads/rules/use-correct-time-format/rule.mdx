...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  caption={"10/05/25 reads differently to Aussie, American and Chinese"}
...
<boxEmbed
  ...
  caption={"Bad example - Use slashes on their own, it’s ambiguous"}
/>
...
<boxEmbed
  ...
  caption={"Good example - Use \"DD MMM YYYY\" and include the abbreviated day of the week"}
/>
...
* The user group will start at 6.00 pm (use of dot)
  ...
  captionStyle="badExample"
  caption={"Bad example - Incorrect or ambiguous times"}
/>
...
* The user group will start at 6 pm tomorrow (12-hour format)
  ...
  captionStyle="goodExample"
  caption={"Good example - Correct formatting for time"}
/>
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  caption={"Will you attend this event on the night of the 14th or the 15th?"}
