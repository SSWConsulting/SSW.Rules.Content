...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"10/05/25 reads differently to Aussie, American and Chinese"}
...
<boxEmbed
  ...
  captionText={"Bad example - Use slashes on their own, it’s ambiguous"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - Use \"DD MMM YYYY\" and include the abbreviated day of the week"}
/>
...
* The user group will start at 6.00 PM (use of dot)
  ...
  captionStyle="badExample"
  captionText={"Bad example - Incorrect or ambiguous times"}
/>
...
* The user group will start at 6 PM tomorrow (12-hour format)
  ...
  captionStyle="goodExample"
  captionText={"Good example - Correct formatting for time"}
/>
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"Will you attend this event on the night of the 14th or the 15th?"}
