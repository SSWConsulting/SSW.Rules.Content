...
created: 2025-10-17 09:52:00+00:00
...
```
  ...
  captionText={"Bad Example - No indication of who checked the AI's work"}
/>
...
* No connection to [task documentation](keep-task-summaries-from-ai-assisted-development) created during the session
  ...
  captionStyle="badExample"
  captionText={"Bad Example - One giant commit makes it hard to understand the work progression and loses the relationship to task docs"}
/>
...
* Easy to understand the implementation sequence
  ...
  captionText={"Good Example - Small, focused commits with proper attribution and documentation"}
/>
...
**Result:** Both the AI implementer and human verifier are visible in GitHub's UI and git log
  ...
  captionStyle="goodExample"
  captionText={"Good Example - You get proper credit for verifying and approving the AI's work"}
/>
...
* Links to Gordon's profile from the commit
  ...
  captionStyle="goodExample"
  captionText={"Good Example - GitHub recognizes and displays all contributors"}
/>
