...
```
  ...
  figurePrefix="bad"
  figure="No indication of who checked the AI's work"
/>
...
* No connection to [task documentation](/keep-task-summaries-from-ai-assisted-development) created during the session
  ...
  figurePrefix="bad"
  figure="One giant commit makes it hard to understand the work progression and loses the relationship to task docs"
/>
...
* Easy to understand the implementation sequence
  ...
  figurePrefix="good"
  figure="Small, focused commits with proper attribution and documentation"
/>
...
**Result:** Both the AI implementer and human verifier are visible in GitHub's UI and git log
  ...
  figurePrefix="good"
  figure="You get proper credit for verifying and approving the AI's work"
/>
...
* Links to Gordon's profile from the commit
  ...
  figurePrefix="good"
  figure="GitHub recognizes and displays all contributors"
/>
