...
<imageEmbed
  ...
  caption={"Bad example - An important task is missing context"}
...
<imageEmbed
  ...
  caption={"Good example - Email is copied to the description"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Related emails are attached to the PBI"}
