...
<imageEmbed
  ...
  captionText={"Bad example - An important task is missing context"}
...
<imageEmbed
  ...
  captionText={"Good example - Email is copied to the description"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Related emails are attached to the PBI"}
