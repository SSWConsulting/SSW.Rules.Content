...
created: 2022-12-01 23:32:41.976000+00:00
...
seoDescription: Manage and report exploratory testing efforts effectively using Session-Based
  Test Management (SBTM).
...
<imageEmbed
  ...
  figureText={"Deep testing requires focus and focus doesn't survive interruption"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Notetaking in a mindmap from a session of exploratory testing"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Debriefing is an opportunity to share your testing story"}
