...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Deep testing requires focus and focus doesn't survive interruption"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Notetaking in a mindmap from a session of exploratory testing"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Debriefing is an opportunity to share your testing story"}
