...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Deep testing requires focus and focus doesn't survive interruption"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Notetaking in a mindmap from a session of exploratory testing"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Debriefing is an opportunity to share your testing story"}
