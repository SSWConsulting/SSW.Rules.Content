...
created: 2010-09-01 02:53:29+00:00
...
Done. Sorry, this wasn't a final decision - I just put it there for testing purposes
  ...
  figureText={"Bad example - There's too much information with no reasonable order"}
/>
...
Sorry, this wasn't a final decision - I just put it there for testing purposes
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - Order is OK, but it's using quotes to reference others' text + no indentation + missing numbers on questions/tasks"}
/>
...
Sorry, this wasn't a final decision - I just put it there for testing purposes
  ...
  figureText={"OK example - Even with \">\", indentation and numbers, without spacing the text becomes cramped and hard to read"}
/>
...
Sorry, this wasn't a final decision - I just put it there for testing purposes
  ...
  figureText={"Good example - You can clearly see the context of each part of the reply"}
/>
...
<imageEmbed
  ...
  figureText={"Indenting tasks in Markdown"}
