...
Done. Sorry, this wasn't a final decision - I just put it there for testing purposes
  ...
  figurePrefix="bad"
  figure="There's too much information with no reasonable order"
/>
...
Sorry, this wasn't a final decision - I just put it there for testing purposes
  ...
  figurePrefix="bad"
  figure="Order is OK, but it's using quotes to reference others' text + no indentation + missing numbers on questions/tasks"
/>
...
Sorry, this wasn't a final decision - I just put it there for testing purposes
  ...
  figurePrefix="good"
  figure="You can clearly see the context of each part of the reply"
/>
