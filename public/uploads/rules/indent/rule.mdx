...
Done. Sorry, this wasn't a final decision - I just put it there for testing purposes
  ...
  captionText={"Bad example - There's too much information with no reasonable order"}
/>
...
Sorry, this wasn't a final decision - I just put it there for testing purposes
  ...
  captionStyle="badExample"
  captionText={"Bad example - Order is OK, but it's using quotes to reference others' text + no indentation + missing numbers on questions/tasks"}
/>
...
Sorry, this wasn't a final decision - I just put it there for testing purposes
  ...
  captionText={"OK example - Even with \">\", indentation and numbers, without spacing the text becomes cramped and hard to read"}
/>
...
Sorry, this wasn't a final decision - I just put it there for testing purposes
  ...
  captionText={"Good example - You can clearly see the context of each part of the reply"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Indenting tasks in Markdown"}
