...
<imageEmbed
  ...
  caption={"Paste image into OneNote and right click on it"}
...
<imageEmbed
  ...
  caption={"Good example - The text pastes below the image. Easy!"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  caption={"Upload your image first"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  caption={"Open your image with Google Docs"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - The text is added to the new document!"}
