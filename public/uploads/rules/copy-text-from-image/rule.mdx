...
created: 2023-07-13 14:05:08+00:00
...
<imageEmbed
  ...
  captionText={"Paste image into OneNote and right click on it"}
...
<imageEmbed
  ...
  captionText={"Good example - The text pastes below the image. Easy!"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"Upload your image first"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"Open your image with Google Docs"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - The text is added to the new document!"}
