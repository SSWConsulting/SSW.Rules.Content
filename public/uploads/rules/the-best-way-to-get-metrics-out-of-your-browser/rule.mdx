...
<imageEmbed
  ...
  figureText={"Good Example - Google Chrome Lighthouse is showing 100%"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - Lighhouse can simulate slow netwrking and CPU when performing tests"}
