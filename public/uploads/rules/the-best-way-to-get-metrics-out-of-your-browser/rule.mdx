...
<imageEmbed
  ...
  captionText={"Good Example - Google Chrome Lighthouse is showing 100%"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - Lighhouse can simulate slow netwrking and CPU when performing tests"}
