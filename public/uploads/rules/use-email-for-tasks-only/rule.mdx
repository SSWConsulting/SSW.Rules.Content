...
Tim
  ...
  figureText={"Bad example - A bad email is one that gives no clear action items and will probably lead to a back and forth thread (potentially with people misunderstanding each other)"}
/>
...
Tim
  ...
  figureText={"Good example - A good email has a clear task to be done (decision was made in-person or via call)"}
/>
