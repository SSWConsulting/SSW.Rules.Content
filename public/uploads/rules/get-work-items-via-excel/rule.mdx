...
<imageEmbed
  ...
  figureText={"Find SSW Template - 'New | My templates... | SSW_Proposal-Project | SSWPrioritiesEstimateTemplate.xltx''"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Copy work items to Release_XX sheet"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Find your project in the list"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Choose 'Input list' to download the empty template"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Click 'Choose columns'"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Select columns in the left list"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Copy work items from Release_XX"}
