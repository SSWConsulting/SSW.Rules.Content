...
<imageEmbed
  ...
  caption={"Find SSW Template - 'New | My templates... | SSW_Proposal-Project | SSWPrioritiesEstimateTemplate.xltx''"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Copy work items to Release_XX sheet"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Find your project in the list"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Choose 'Input list' to download the empty template"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Select columns in the left list"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Copy work items from Release_XX"}
