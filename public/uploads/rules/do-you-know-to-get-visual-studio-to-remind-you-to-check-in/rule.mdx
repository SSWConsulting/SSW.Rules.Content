...
<imageEmbed
  ...
  caption={"Check-in files automatically the 2nd checkbox is very important so you get reminded to check-in your project when closing VS.NET."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"You can also check-in automatically in VB6"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"You can also check-in automatically in Access"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"All the basic functions are easily accessible"}
