...
isArchived: false
lastUpdated: 2014-05-07 04:01:12+00:00
...
<imageEmbed
  ...
  captionText={"Check-in files automatically the 2nd checkbox is very important so you get reminded to check-in your project when closing VS.NET."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"You can also check-in automatically in VB6"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"You can also check-in automatically in Access"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"All the basic functions are easily accessible"}
