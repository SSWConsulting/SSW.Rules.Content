...
<imageEmbed
  ...
  captionText={"Good Example - The invoice notes have date and name followed by details"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - The phone contact notes have date and name followed by details"}
