...
isArchived: false
lastUpdated: 2017-02-23 14:29:24+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example - The DataGrid is ugly"}
...
<imageEmbed
  ...
  figureText={"Good Example - A beautiful ListView - a nicer look over the datagrid"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - The appearance of DataGrid and ListView"}
...
<imageEmbed
  ...
  figureText={"One place when you choose a DataGrid over a ListView is when you have 2 checkbox fields"}
