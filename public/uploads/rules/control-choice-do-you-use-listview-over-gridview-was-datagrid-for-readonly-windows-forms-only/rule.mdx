...
<imageEmbed
  ...
  caption={"Bad Example - The DataGrid is ugly"}
...
<imageEmbed
  ...
  caption={"Good Example - A beautiful ListView - a nicer look over the datagrid"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - The appearance of DataGrid and ListView"}
...
<imageEmbed
  ...
  caption={"One place when you choose a DataGrid over a ListView is when you have 2 checkbox fields"}
