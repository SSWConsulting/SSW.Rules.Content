...
<imageEmbed
  ...
  captionText={"Bad Example - The DataGrid is ugly"}
...
<imageEmbed
  ...
  captionText={"Good Example - A beautiful ListView - a nicer look over the datagrid"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - The appearance of DataGrid and ListView"}
...
<imageEmbed
  ...
  captionText={"One place when you choose a DataGrid over a ListView is when you have 2 checkbox fields"}
