...
<imageEmbed
  ...
  figureText={"ADAudit Plus Dashboard gives you immediate visibility"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Email alert from ADAudit Plus"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"ADAudit Plus gives you 100's of reports - for example, recently modified groups"}
