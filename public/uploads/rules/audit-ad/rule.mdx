...
<imageEmbed
  ...
  captionText={"ADAudit Plus Dashboard gives you immediate visibility"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Email alert from ADAudit Plus"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"ADAudit Plus gives you 100's of reports - for example, recently modified groups"}
