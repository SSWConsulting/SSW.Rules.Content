...
<imageEmbed
  ...
  caption={"ADAudit Plus Dashboard gives you immediate visibility"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Email alert from ADAudit Plus"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"ADAudit Plus gives you 100's of reports - for example, recently modified groups"}
