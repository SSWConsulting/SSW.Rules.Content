...
isArchived: false
lastUpdated: 2021-07-05 21:12:31.484000+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example - using the default relationship name"}
...
<imageEmbed
  ...
  figureText={"Good Example - using a more descriptive relationship name"}
...
<imageEmbed
  ...
  figureText={"Relationship name shown on the other table"}
