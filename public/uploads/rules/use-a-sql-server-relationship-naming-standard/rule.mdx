...
<imageEmbed
  ...
  captionText={"Bad Example - using the default relationship name"}
...
<imageEmbed
  ...
  captionText={"Good Example - using a more descriptive relationship name"}
...
<imageEmbed
  ...
  captionText={"Relationship name shown on the other table"}
