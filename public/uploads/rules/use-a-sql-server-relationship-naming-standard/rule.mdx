...
<imageEmbed
  ...
  caption={"Bad Example - using the default relationship name"}
...
<imageEmbed
  ...
  caption={"Good Example - using a more descriptive relationship name"}
...
<imageEmbed
  ...
  caption={"Relationship name shown on the other table"}
