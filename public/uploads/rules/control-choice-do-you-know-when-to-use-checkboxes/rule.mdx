...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Accepting or refusing to remember accounts when login to SugarLearning (the single selection checkbox)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="CheckBoxes are used to setup the approval workflow in SugarLearning, only need to enter the approv when the checkbox is checked"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Booking.com’s users frequently use the checkbox filters when making a booking"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Radio Buttons are used and aligned vertically"
