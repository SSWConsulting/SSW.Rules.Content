...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="bad"
  figure="User hits &quot;Next&quot; and can't go back to change their answer"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure='"Back" button is clearly visible'
...
* Use [icons to enforce the action meaning](/use-icons-to-reinforce-meaning)
