...
isArchived: false
lastUpdated: 2019-09-17 01:55:43+00:00
...
<imageEmbed
  ...
  figureText={"Giving clients sole access to the deploy button, allows them to take ownership of the decision to deploy"}
