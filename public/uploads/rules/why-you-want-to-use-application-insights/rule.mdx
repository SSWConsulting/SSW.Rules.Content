...
<imageEmbed
  ...
  captionText={"When developing a public website, you wouldn't deploy without Google Analytics to track metrics about user activity."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"For similar reasons, you shouldn't deploy a web application without metric tracking on performance and exceptions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Spikes on an Echidna are dangerous"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Spikes on a graph are dangerous"}
