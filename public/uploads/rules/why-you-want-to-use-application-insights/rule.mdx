...
<imageEmbed
  ...
  figureText={"When developing a public website, you wouldn't deploy without Google Analytics to track metrics about user activity."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"For similar reasons, you shouldn't deploy a web application without metric tracking on performance and exceptions"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Spikes on an Echidna are dangerous"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Spikes on a graph are dangerous"}
