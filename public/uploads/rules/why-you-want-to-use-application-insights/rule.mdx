...
<imageEmbed
  ...
  caption={"When developing a public website, you wouldn't deploy without Google Analytics to track metrics about user activity."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"For similar reasons, you shouldn't deploy a web application without metric tracking on performance and exceptions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Spikes on an Echidna are dangerous"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Spikes on a graph are dangerous"}
