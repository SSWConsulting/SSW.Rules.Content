...
<imageEmbed
  ...
  figureText={"Microsoft Teams Rooms with Logitech setup"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Apple TV with remote"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Samsung Smart TV with built-in AirPlay"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Extron ShareLink Pro 1000 diagram"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Barco USB dongle for the laptop, or an app for your smartphone"}
