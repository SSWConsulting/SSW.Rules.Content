...
<imageEmbed
  ...
  captionText={"Microsoft Teams Rooms with Logitech setup"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Apple TV with remote"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Samsung Smart TV with built-in AirPlay"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Extron ShareLink Pro 1000 diagram"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Barco USB dongle for the laptop, or an app for your smartphone"}
