...
<imageEmbed
  ...
  caption={"Microsoft Teams Rooms with Logitech setup"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Samsung Smart TV with built-in AirPlay"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Extron ShareLink Pro 1000 diagram"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Barco USB dongle for the laptop, or an app for your smartphone"}
