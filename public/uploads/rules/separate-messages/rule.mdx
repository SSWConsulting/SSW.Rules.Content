...
<imageEmbed
  ...
  captionText={"Bad example - This message contains many different subjects! It's informative, but hard to respond to"}
...
<imageEmbed
  ...
  captionText={"Good example - Here, each message is separate, making them individually available for responses"}
