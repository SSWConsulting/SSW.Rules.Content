...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This message contains many different subjects! It's informative, but hard to respond to"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Here, each message is separate, making them individually available for responses"
