...
<imageEmbed
  ...
  figureText={"Bad example - README created without a template"}
...
<imageEmbed
  ...
  figureText={"Good example - The README above clearly outlines the goals of the project and provides new developers with enough context to get started"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - A standard README template on GitHub"}
