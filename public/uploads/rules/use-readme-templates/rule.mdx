...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="README created without a template"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The README above clearly outlines the goals of the project and provides new developers with enough context to get started"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A standard README template on GitHub"
