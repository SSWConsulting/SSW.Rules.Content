...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"With an Apple Watch, you can keep your phone on vibrate 100% of the time and never have to worry about missing a call"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"With a Fitbit, you can keep your phone on vibrate 100% of the time and never have to worry about missing a call"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"With a Microsoft Band, you can keep your phone on vibrate 100% of the time and never have to worry about missing a call"}
