---
seoDescription: Effective Azure DevOps permissions assignment requires granting specific
  access to team members only for necessary areas or iterations, minimizing risks
  and ensuring secure data accessibility.
type: rule
...
created: 2023-05-09 00:20:35.289000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="none"
  figure="Assign limited access to a particular user to create a Sprint"
  src="/uploads/rules/azure-devops-permissions/child_node.jpg"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="none"
  figure="Team Administrator - Who have access to iterations in Azure DevOps"
  src="/uploads/rules/azure-devops-permissions/team-administrator.png"
/>
