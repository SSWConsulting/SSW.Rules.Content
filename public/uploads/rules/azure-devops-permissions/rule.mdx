...
created: 2023-05-09T04:36:29.000Z
...
<imageEmbed
  ...
  captionText={"Assign limited access to a particular user to create a Sprint"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Team Administrator - Who have access to iterations in Azure DevOps"}
