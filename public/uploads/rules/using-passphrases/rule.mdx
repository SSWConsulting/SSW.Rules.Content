...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"This XKCD comic shows why it’s important to use a passphrase, rather than a password"}
...
<boxEmbed
  ...
  caption={"Bad Example – It's a word that other people know"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad Example – It’s the opening to one of Shakespeare’s sonnets so is known to other people (and painful to type in)"}
/>
...
<boxEmbed
  ...
  caption={"OK Example – It's 16 characters, composed of 5 words, is not a phrase that is known by anyone else, and is easy (for you) to remember"}
/>
