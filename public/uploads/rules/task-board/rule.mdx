...
<imageEmbed
  ...
  figureText={"Good example - a virtual client task board in action"}
...
<imageEmbed
  ...
  figureText={"OK example - a physical client task board in operation"}
...
<imageEmbed
  ...
  figureText={"Create an avatar for each person and stick them on the current task. You can find our User Story Cards here. You can write the Azure DevOps Work Item ID on each card"}
