...
<imageEmbed
  ...
  caption={"Good example - a virtual client task board in action"}
...
<imageEmbed
  ...
  caption={"OK example - a physical client task board in operation"}
...
<imageEmbed
  ...
  caption={"Create an avatar for each person and stick them on the current task. You can find our User Story Cards here. You can write the Azure DevOps Work Item ID on each card"}
