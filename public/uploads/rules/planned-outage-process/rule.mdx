...
**Note:** &lt;This is as per rule [Outage - Do you have a planned outage process?](/planned-outage-process) &gt;
  ...
  captionText={"Example planned outage email"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Connected users can be viewed in Task Manager"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Computer Management 'Open Files' View"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"SQL Management Studio 'Active Connections' View"}
