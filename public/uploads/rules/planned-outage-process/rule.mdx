...
**Note:** &lt;This is as per rule [Outage - Do you have a planned outage process?](/planned-outage-process) &gt;
  ...
  caption={"Example planned outage email"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Connected users can be viewed in Task Manager"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Computer Management 'Open Files' View"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"SQL Management Studio 'Active Connections' View"}
