...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="It's October now, so most opportunities have been spoken to in the past month or so. You'd click on the item from July here to make sure you've still got a followupthen scheduled for it"
