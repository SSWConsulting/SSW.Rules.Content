...
<imageEmbed
  ...
  caption={"Bad example, a static blog post. Does not look like it has been updated."}
...
<imageEmbed
  ...
  caption={"Good example, dated and attributed updates give your posts credibility and make them seam alive."}
