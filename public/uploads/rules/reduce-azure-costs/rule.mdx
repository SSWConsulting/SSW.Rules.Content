...
<imageEmbed
  ...
  figureText={"Azure Portal | Cost Analysis | Scoped Area Chart e.g. in February it was deployed and in August a marketing campaign caused more traffic"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Azure Portal | Cost Analysis | Resource Group Breakdown"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Azure Portal | Cost Analysis | Location breakdown"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Azure Portal | Cost Analysis | Service type breakdown"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Azure Portal | Cost Analysis | View | CostByResource | Resource breakdown"}
