...
<imageEmbed
  ...
  captionText={"Bad UI - a nagging message box that forces the User to click OK"}
...
<imageEmbed
  ...
  captionText={"Good UI - Show a Tick when the application is up to date"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good UI - Show a Cross when the application is out of date"}
...
<imageEmbed
  ...
  captionText={"SSW.Framework.WindowsUI.VersionStatus"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Enter the ProductDownloadID and ProductLatestVersionURL"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Include 'Check for Updates' in your applications"}
