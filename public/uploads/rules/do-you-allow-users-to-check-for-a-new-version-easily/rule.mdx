...
isArchived: false
lastUpdated: 2021-06-16 00:20:42.366000+00:00
...
<imageEmbed
  ...
  figureText={"Bad UI - a nagging message box that forces the User to click OK"}
...
<imageEmbed
  ...
  figureText={"Good UI - Show a Tick when the application is up to date"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good UI - Show a Cross when the application is out of date"}
...
<imageEmbed
  ...
  figureText={"SSW.Framework.WindowsUI.VersionStatus"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Enter the ProductDownloadID and ProductLatestVersionURL"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Include 'Check for Updates' in your applications"}
