...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="No Comments against the check-ins we don’t know what changes were made in each revision"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Now we can pin point which revision a particular change has been made"
