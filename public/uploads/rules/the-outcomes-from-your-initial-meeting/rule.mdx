...
seoDescription: Do you know the outcomes of an Initial Meeting (either Specification
  Review or Ad Hoc)?
title: Meetings - Do you know the outcomes of an Initial Meeting (either Spec Review
  or Ad Hoc)?
type: rule
...
<imageEmbed
  ...
  figureText={"Pre-sale meeting - use time wisely"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Send a brief proposal"}
