...
created: 2024-09-11 04:45:47+00:00
...
<imageEmbed
  ...
  captionText={"Staging uses blue background"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Production uses red background"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Changing CRM 2016 UI by using theme feature"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"CRM 2013 with a green navigation bar"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"CRM Ribbon color green to signify production environment"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Color of CRM Development Server - Red"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Color of CRM Test Server - Yellow"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Color of CRM Production Server - Default"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Selecting Red SSW Custom theme for Production"}
