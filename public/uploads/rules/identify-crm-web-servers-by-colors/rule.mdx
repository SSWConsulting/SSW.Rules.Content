...
<imageEmbed
  ...
  caption={"Staging uses blue background"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Production uses red background"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Changing CRM 2016 UI by using theme feature"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"CRM 2013 with a green navigation bar"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"CRM Ribbon color green to signify production environment"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Color of CRM Development Server - Red"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Color of CRM Test Server - Yellow"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Color of CRM Production Server - Default"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Selecting Red SSW Custom theme for Production"}
