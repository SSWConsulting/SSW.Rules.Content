...
<imageEmbed
  ...
  figureText={"Staging uses blue background"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Production uses red background"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Changing CRM 2016 UI by using theme feature"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"CRM 2013 with a green navigation bar"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"CRM Ribbon color green to signify production environment"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Color of CRM Development Server - Red"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Color of CRM Test Server - Yellow"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Color of CRM Production Server - Default"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Selecting Red SSW Custom theme for Production"}
