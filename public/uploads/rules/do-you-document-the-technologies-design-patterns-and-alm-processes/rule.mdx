...
<boxEmbed
  ...
  captionText={"Bad example - you know nothing about how the project will be done"}
/>
...
* **ALM:** Continuous deployment to staging
  ...
  captionText={"Good example - this tells you a lot about the architecture and processes in a few words"}
/>
