...
authors:
- title: Igor Goldobin
  url: https://www.ssw.com.au/people/igor-goldobin
- title: Adam Cogan
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The default dependency injection for ASP.NET Core"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The bad example rewired to utilize AutoFac. Red boxes outline the modified code"
