...
<imageEmbed
  ...
  captionText={"Bad Example - The default dependency injection for ASP.NET Core"}
...
<imageEmbed
  ...
  captionText={"Good Example - The bad example rewired to utilize AutoFac. Red boxes outline the modified code"}
