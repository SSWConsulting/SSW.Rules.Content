...
isArchived: false
lastUpdated: 2021-06-24 23:52:28.643000+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example - The default dependency injection for ASP.NET Core"}
...
<imageEmbed
  ...
  figureText={"Good Example - The bad example rewired to utilize AutoFac. Red boxes outline the modified code"}
