...
authors:
- title: Jord Gui
  url: https://www.ssw.com.au/people/jord-gui
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="TinaCMS media manager window overflowing when open on iPadOS Safari when using view height"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="TinaCMS media manager window responding properly when open on iPadOS Safari when using dynamic view height"
