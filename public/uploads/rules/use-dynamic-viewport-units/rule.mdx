...
<imageEmbed
  ...
  captionText={"Browser compatibility list for dynamic viewport units"}
...
<imageEmbed
  ...
  captionText={"Bad example - TinaCMS media manager window overflowing when open on iPadOS Safari when using view height"}
...
<imageEmbed
  ...
  captionText={"Good example - TinaCMS media manager window responding properly when open on iPadOS Safari when using dynamic view height"}
