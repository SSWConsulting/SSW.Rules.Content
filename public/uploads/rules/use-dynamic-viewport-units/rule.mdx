...
created: 2024-07-16 04:28:49+00:00
...
<imageEmbed
  ...
  figureText={"Browser compatibility list for dynamic viewport units"}
...
<imageEmbed
  ...
  figureText={"Bad example - TinaCMS media manager window overflowing when open on iPadOS Safari when using view height"}
...
<imageEmbed
  ...
  figureText={"Good example - TinaCMS media manager window responding properly when open on iPadOS Safari when using dynamic view height"}
