...
<imageEmbed
  ...
  caption={"Browser compatibility list for dynamic viewport units"}
...
<imageEmbed
  ...
  caption={"Bad example - TinaCMS media manager window overflowing when open on iPadOS Safari when using view height"}
...
<imageEmbed
  ...
  caption={"Good example - TinaCMS media manager window responding properly when open on iPadOS Safari when using dynamic view height"}
