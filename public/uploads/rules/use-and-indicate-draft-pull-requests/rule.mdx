...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The default experience lacks clear indication that this is Draft Pull Request"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Add prefix with 🚧 emoji to clearly indicate it is a Draft Pull Request"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="WIP app catching Draft Pull Request"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Clear naming and indication of a draft pull request"
