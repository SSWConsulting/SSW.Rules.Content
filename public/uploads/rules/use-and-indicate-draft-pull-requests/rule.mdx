...
created: 2024-01-11 04:53:25+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - The default experience lacks clear indication that this is Draft Pull Request"}
...
<imageEmbed
  ...
  figureText={"Good example - Add prefix with 🚧 emoji to clearly indicate it is a Draft Pull Request"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - WIP app catching Draft Pull Request"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Clear naming and indication of a draft pull request"}
