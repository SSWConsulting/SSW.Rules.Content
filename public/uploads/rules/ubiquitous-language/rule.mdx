...
<boxEmbed
  ...
  caption={"Terms in the code do not reflect domain language used by stakeholders"}
/>
...
<boxEmbed
  ...
  caption={"Ubiquitous language is used, and developers and stakeholders are on the same page"}
/>
