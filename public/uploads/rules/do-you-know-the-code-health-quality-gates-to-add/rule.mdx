...
isArchived: true
lastUpdated: 2025-10-13 15:04:27+00:00
...
<imageEmbed
  ...
  caption={"Steps to install NuGet Packages"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"New Roslyn Rule issues raised in Visual Studio Analyzer"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Addition of CSSLint and ESLint to VS Code Project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Steps to edit an existing build definition on VisualStudio.com"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Example completed build definition"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Example directory for TSLint run commands"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Command line step to remove the config file (tslint.json) after the linter has run"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Ensure TSLint actually finds files to scan (if the project includes TSLint files) otherwise it will pass without you noticing"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Steps to add PrimaryBuild variable to build definition"}
...
<imageEmbed
  ...
  caption={"Bad example - Build broke due to compile errors. Must fix to proceed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Successful build with warnings. Should be disabled or set as errors"}
...
<imageEmbed
  ...
  caption={"Good example - Successful build with no warnings"}
