...
<imageEmbed
  ...
  src="/uploads/rules/do-you-know-the-code-health-quality-gates-to-add/VS-InstallNuGetPackages_1710232021935.png"
/>
...
<imageEmbed
  ...
  src="/uploads/rules/do-you-know-the-code-health-quality-gates-to-add/VS-RoslynRules_1710232021936.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Addition of CSSLint and ESLint to VS Code Project"}
  src="/uploads/rules/do-you-know-the-code-health-quality-gates-to-add/vs-code-extensions_1710232021938.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Steps to edit an existing build definition on VisualStudio.com"}
  src="/uploads/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-EditBuild.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example completed build definition"}
  src="/uploads/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-BuildDefinition-V3_1710232021937.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example directory for TSLint run commands"}
  src="/uploads/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-DirectoryExampleV2_1710232021937.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Command line step to remove the config file (tslint.json) after the linter has run"}
  src="/uploads/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-RemoveConfig_1710232021938.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Ensure TSLint actually finds files to scan (if the project includes TSLint files) otherwise it will pass without you noticing"}
  src="/uploads/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-EnsureTSLintRuns.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Steps to add PrimaryBuild variable to build definition"}
  src="/uploads/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-AddVariableTag_1710232021936.png"
/>
...
<imageEmbed
  ...
  figureText={"Bad example - Build broke due to compile errors. Must fix to proceed"}
  src="/uploads/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-BuildResult-BadV3.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Successful build with warnings. Should be disabled or set as errors"}
  src="/uploads/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-BuildResultV3.png"
/>
...
<imageEmbed
  ...
  figureText={"Good example - Successful build with no warnings"}
  src="/uploads/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-BuildResult-GoodV3.png"
/>