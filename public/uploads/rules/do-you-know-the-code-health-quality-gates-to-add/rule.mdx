...
<imageEmbed
  ...
  captionText={"Steps to install NuGet Packages"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"New Roslyn Rule issues raised in Visual Studio Analyzer"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Addition of CSSLint and ESLint to VS Code Project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Steps to edit an existing build definition on VisualStudio.com"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Example completed build definition"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Example directory for TSLint run commands"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Command line step to remove the config file (tslint.json) after the linter has run"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Ensure TSLint actually finds files to scan (if the project includes TSLint files) otherwise it will pass without you noticing"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Steps to add PrimaryBuild variable to build definition"}
...
<imageEmbed
  ...
  captionText={"Bad example - Build broke due to compile errors. Must fix to proceed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Successful build with warnings. Should be disabled or set as errors"}
...
<imageEmbed
  ...
  captionText={"Good example - Successful build with no warnings"}
