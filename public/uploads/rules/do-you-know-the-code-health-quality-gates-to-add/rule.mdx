---
archivedreason: 'Content is covered in the following rule: https://www.ssw.com.au/rules/rules-to-better-code-quality'
authors:
- title: Adam Cogan
...
<mark style="background-color: #FEF08A">Ensure utilisation of TeamBuild2015 or higher (No support for XAML builds).</mark>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Build broke due to compile errors. Must fix to proceed"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Successful build with warnings. Should be disabled or set as errors"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Successful build with no warnings"
