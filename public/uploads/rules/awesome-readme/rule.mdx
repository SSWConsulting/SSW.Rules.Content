...
<imageEmbed
  ...
  caption={"Bad example - We've all seen one of these 🤮"}
...
<imageEmbed
  ...
  caption={"Figure - Sample readme Generated with https://readmi.xyz/"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Not much useful information to anyone looking to contribute to the repository"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - No information for how to contribute or use the repository"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Lots of great information for developers to know what they'd get with the SSW Clean Architecture template"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Plenty of useful information for contributors and customers of TinaCMS"}
