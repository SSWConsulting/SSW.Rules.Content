...
created: 2024-07-18 13:42:55.753000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="We've all seen one of these 🤮"
...
A great tool to help you build your README is [readme.so](https://readme.so). It provides a simple editor to create a README with a live preview, and you can export it to Markdown or HTML.
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Not much useful information to anyone looking to contribute to the repository"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="No information for how to contribute or use the repository"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Lots of great information for developers to know what they'd get with the SSW Clean Architecture template"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Plenty of useful information for contributors and customers of TinaCMS"
