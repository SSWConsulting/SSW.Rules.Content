...
<imageEmbed
  ...
  caption={"Xero Me app available on iOS and Android"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  caption={"Xero Me homepage - complete timesheets, request leave and check payslips on the go"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  caption={"Xero Me Leave Main Page"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  caption={"Approver's leave request page"}
