...
seoDescription: Decouple your API implementation from your Blazor components to achieve
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - Component depends on HttpClient directly",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - Component depends on web API client abstraction",
  shouldDisplay: true
} } />
