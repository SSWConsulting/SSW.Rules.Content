...
\- Friendly licensing model, bloggers even pay $0 for the full version!
  ...
  caption={"Bad example - The original version of content has not been included in the email... it is hard to tell what needs to be changed"}
/>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - Friendly licensing model== - bloggers even pay $0== for the full version!
  ...
  caption={"Good example - 'From' and 'To' changes are highlighted... it is clear what needs to be changed"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Using change from x to y in Microsoft Teams"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Remember when saving the style to select \"New documents based off this template\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The style will show in your styles list to be applied when needed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example – Custom styles are disorganised"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Custom styles are numbered and organised"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A Word document with 'Track Changes' ON is recommended if you have too many changes"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"This visual preview of the changes to a Markdown file in GitHub"}
