...
seoDescription: >-
  Learn how to efficiently request small content changes by using the "Change
  from X to Y" method for clear and effective communication.
created: 2009-03-25T04:50:21.000Z
createdBy: Chloe
createdByEmail: chloelin@ssw.com.au
lastUpdated: 2026-01-26T14:39:16.322Z
lastUpdatedBy: Chloe
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Bad example – Custom styles are disorganised" src="/uploads/rules/change-from-x-to-y/change-from-x-to-y-organising-styles-bad-example.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Good example – Custom styles are numbered and organised" src="/uploads/rules/change-from-x-to-y/change-from-x-to-y-organising-styles-good-example.png" />
