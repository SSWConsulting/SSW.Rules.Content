...
lastUpdated: 2026-07-09T23:07:38.037Z
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="none" figure="A Word document with 'Track Changes' ON is recommended if you have too many changes" src="/uploads/rules/change-from-x-to-y/word-track-changes.jpg" />
