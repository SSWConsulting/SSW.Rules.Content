...
lastUpdated: 2026-07-13T17:47:40.373Z
...
This process consists of including the original version of the content ("X") along with the changes you require ("Y"). It means you easily see the page or file content as it was prior to your changes. 

This history is convenient for **future reference** and also **makes it very clear** to the person doing the changes exactly what the new file is meant to look like.
...
## Using email to request small edits

Make the changes even easier to see and understand by highlighting:

* In <mark style={{ backgroundColor: "#FEF08A" }}>yellow</mark> - Content you want to add/update (only do this on the "To" section)
* In <mark style={{ backgroundColor: "#CC4141" }}>red</mark> (with white and bold text) - Content you want to delete, whether it be specific text or an entire sentence (only do this on the "From" section)
  **Note:** Only indicate in red the content that will **not** be replaced/updated with something correlated.

<boxEmbed
  body={<>
    **Note:** All text we do **not** write ourselves [should be indented](/do-you-use-indentation-for-readability), so this includes paragraphs you are copying and pasting.
  </>}
  figurePrefix="none"
  figure=""
  style="warning"
...
<emailEmbed
  ...
  body={<>
    ...
    Scan all your projects for coding <mark style={{ backgroundColor: "#CC4141" }}>bugs and</mark> errors:
    ...
    - <mark style={{ backgroundColor: "#FEF08A" }}>Guarantee</mark> industry best practices
    
    - Friendly licensing model<mark style={{ backgroundColor: "#FEF08A" }}> - bloggers even pay $0</mark> for the full version!
  </>}
  figurePrefix="good"
...
## Using AI to suggest changes

Don’t tell AI to rewrite your email. Instead use change x to y format too. 

Prompt example:

<boxEmbed
  body={<>
    Check the below email. Number your suggestions in the form of change x to y eg.
  ...
  figurePrefix="good"
  figure="Training AI to use &#x22;from X to Y&#x22;"
/>
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="none" figure="Using change from x to y in Microsoft Teams" src="/uploads/rules/change-from-x-to-y/change-from-x-to-y-microsoft-teams.jpg" />
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="none" figure="Remember when saving the style to select &#x22;New documents based off this template&#x22;" src="/uploads/rules/change-from-x-to-y/change-from-x-to-y-saving-styles.jpg" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="none" figure="The style will show in your styles list to be applied when needed" src="/uploads/rules/change-from-x-to-y/change-from-x-to-y-using-styles.jpg" />
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="bad" figure="Custom styles are disorganised" src="/uploads/rules/change-from-x-to-y/change-from-x-to-y-organising-styles-bad-example.png" />

<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="good" figure="Custom styles are numbered and organised" src="/uploads/rules/change-from-x-to-y/change-from-x-to-y-organising-styles-good-example.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="A Word document with 'Track Changes' ON is recommended if you have too many changes" src="/uploads/rules/change-from-x-to-y/word-track-changes.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="none" figure="This visual preview of the changes to a Markdown file in GitHub" src="https://user-images.githubusercontent.com/79821522/113648341-d15f1c00-96cf-11eb-8357-81a79ac0765d.png" />
