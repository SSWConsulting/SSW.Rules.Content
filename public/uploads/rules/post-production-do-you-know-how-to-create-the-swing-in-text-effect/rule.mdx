...
<imageEmbed
  ...
  captionText={"Bad example - This does not simulate gravity and will be jarring to the viewer"}
...
<imageEmbed
  ...
  captionText={"Good example - Angle/time graphic for \"swing in\" effect"}
