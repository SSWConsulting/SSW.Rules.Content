...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example: All members are Admins](tooManyAdmins.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example: Most users have push access, some can maintain the repo](notManyAdmins.png)',
  shouldDisplay: true
} } />
