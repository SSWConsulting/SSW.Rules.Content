...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example: All members are Admins](/uploads/rules/limit-admin-access/tooManyAdmins.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example: Most users have push access, some can maintain the repo](/uploads/rules/limit-admin-access/notManyAdmins.png)',
  shouldDisplay: true
} } />
