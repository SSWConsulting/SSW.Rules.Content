...
<boxEmbed
  ...
  captionText={"Bad example - You might start with a prompt like this, get sub-optimal output, and then..."}
/>
...
<boxEmbed
  ...
  captionText={"Good example - The prompt has been iterated to be more specific and clear"}
/>
...
<imageEmbed
  ...
  captionText={"Click this button to edit any prompt you've already submitted"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"You can still go back to look at previous versions of the prompt and response"}
