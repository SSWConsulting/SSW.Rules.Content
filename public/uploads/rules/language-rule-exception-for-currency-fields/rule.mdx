...
created: 2024-08-02 11:27:33+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Using default language for currency field"}
...
<imageEmbed
  ...
  figureText={"Good example - This currency field stores Australian Dollars and will always display it that way"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - This currency field stores Chinese Yuan and will always display it that way"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Chinese Yuan currency"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Using specified language as per value of column CurrencyType in table SystemValue"}
