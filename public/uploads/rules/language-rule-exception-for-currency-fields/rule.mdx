...
<imageEmbed
  ...
  caption={"Bad example - Using default language for currency field"}
...
<imageEmbed
  ...
  caption={"Good example - This currency field stores Australian Dollars and will always display it that way"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - This currency field stores Chinese Yuan and will always display it that way"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Using specified language as per value of column CurrencyType in table SystemValue"}
