...
<imageEmbed
  ...
  captionText={"Bad Example - How do you know what machine is what?"}
...
<imageEmbed
  ...
  captionText={"Good Example - It is easy to tell which VM is which when they are named to a standard"}
