...
seoDescription: Master ChatGPT with our cheat sheet, exploring roles, dos, don’ts,
  and effective prompting techniques for better AI interactions.
created: 2023-04-14 19:11:11.002000+00:00
lastUpdated: 2026-01-26 21:51:06.380000+00:00
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="SSW ChatGPT Cheat Sheet" src="/uploads/rules/chatgpt-cheat-sheet/chatgpt-cheat-sheet-bathroom-door.jpg" />

[Download "SSW ChatGPT Cheat Sheet" PDF](/uploads/rules/chatgpt-cheat-sheet/ChatGPT-Cheat-sheet-Bathroom-Door-v2.pdf).

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="SSW ChatGPT Cheat Sheet For Developers" src="/uploads/rules/chatgpt-cheat-sheet/ChatGPT-Cheat-Sheet-Devs-v2-2.jpg" />
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Leading questions bias the AI toward a specific answer"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Open-ended questions let the AI evaluate options objectively"
/>
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Results from the 5 in 1 example prompt" src="/uploads/rules/chatgpt-cheat-sheet/5in1-prompt.png" />
