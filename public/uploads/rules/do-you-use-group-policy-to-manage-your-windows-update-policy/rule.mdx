...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Windows 10 shows a ‘Restart now’ – do not accidentally press it! Your production server and your users won't be happy!"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Remember this nasty one from Vista days?"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The Group Policy locks the Windows Update setting"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="AD shows the Group Policy setting “3 – Auto download and notify for install”. This policy is applied to the specified OU eg. Production Servers joined to this domain"
