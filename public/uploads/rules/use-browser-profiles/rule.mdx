...
<imageEmbed
  ...
  figureText={"Click on your Edge or Chrome profile button"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Select Manage people to create a new person/profile"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"To add a new person/profile, click on the Add Person button"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Fill in the name of the new person/profile and select an icon"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Click on your profile button to switch profiles"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Select the person/profile you want to switch to"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add and manage containers in Firefox"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Containers in action - tabs with different colors showing which container they belong to"}
