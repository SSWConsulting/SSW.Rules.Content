...
<imageEmbed
  ...
  captionText={"Click on your Edge or Chrome profile button"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Select Manage people to create a new person/profile"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"To add a new person/profile, click on the Add Person button"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Fill in the name of the new person/profile and select an icon"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Click on your profile button to switch profiles"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Select the person/profile you want to switch to"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Add and manage containers in Firefox"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Containers in action - tabs with different colors showing which container they belong to"}
