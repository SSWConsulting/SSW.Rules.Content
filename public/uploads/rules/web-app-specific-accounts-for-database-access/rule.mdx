...
- title: Michael Demarco
  url: https://www.ssw.com.au/people/michael-demarco
...
type: rule
uri: web-app-specific-accounts-for-database-access
---
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Contract Manager Web Application using the administrator login in its connection string"
  src="/uploads/rules/web-app-specific-accounts-for-database-access/administratorlogininitsconnectionstring.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Application specific database user configured in the connection string"
  src="/uploads/rules/web-app-specific-accounts-for-database-access/databaseuserconfiguredintheconnectionstring.png"
/>
