...
lastUpdated: 2026-09-20T22:54:13.085Z
...
<imageEmbed alt="Image" size="medium" showBorder={false} figurePrefix="bad" figure="No recent activity" src="/uploads/rules/choose-dependencies-correctly/activity-bad-npm.png" />

<imageEmbed alt="Image" size="medium" showBorder={false} figurePrefix="good" figure="More recent activity" src="/uploads/rules/choose-dependencies-correctly/activity-good-npm.png" />
