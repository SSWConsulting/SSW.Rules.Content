...
created: 2025-12-11 04:11:49+00:00
...
isArchived: false
lastUpdated: 2025-12-12 18:31:21+00:00
...
seoDescription: Learn how to choose safe, reliable, and well-maintained dependencies.
  Reduce security risks, avoid abandoned libraries, and protect your application from
  supply-chain attacks by following a proven checklist for evaluating third-party
  packages.
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="No recent activity"
  src="/uploads/rules/choose-dependencies-correctly/activity-bad-npm.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="More recent activity"
  src="/uploads/rules/choose-dependencies-correctly/activity-good-npm.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Decent amount of uses"
  src="/uploads/rules/choose-dependencies-correctly/popularity-npm-bad.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A lot more popular, battle-tested 💪"
  src="/uploads/rules/choose-dependencies-correctly/popularity-npm-good.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Released ages ago!"
  src="/uploads/rules/choose-dependencies-correctly/last-published-npm-bad.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="More recent release"
  src="/uploads/rules/choose-dependencies-correctly/last-published-npm-good.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Licensing mentioned"
  src="/uploads/rules/choose-dependencies-correctly/licensing-good.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A markdown file should include your reasons to assist future developers"
  src="/uploads/rules/choose-dependencies-correctly/md-decision-reasons.png"
/>
