...
<imageEmbed
  ...
  caption={"‘Customer Type Other’ should be hidden and only displayed when Other is selected"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Show the ‘Customer Type Other’ field when Customer Type equals Other"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Hide the ‘Customer Type Other’ field when Customer Type doesn’t equal Other"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Great. Now ‘Customer Type Other’ is hidden"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"And on the other side ‘Customer Type Other’ is visible"}
