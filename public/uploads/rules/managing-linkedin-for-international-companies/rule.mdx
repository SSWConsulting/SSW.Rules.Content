...
created: 2023-02-02 18:11:54+00:00
...
* SSW Australia, SSW France
  ...
  captionText={"Bad example - Multiple LinkedIn Pages for each region"}
/>
...
* SSW
  ...
  captionText={"Good example - Single LinkedIn page covering all regions"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Microsoft's LinkedIn page shows their jobs from all around the world and their offices 🌍 🏢"}
...
<imageEmbed
  ...
  captionText={"Language, job function, location and industry are some of the options you can select to do a targeted post on your LinkedIn"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"LinkedIn will use your profile information to show targeted posts to you. For example, if you set your language to English, you will be targeted only for English content."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"LinkedIn’s draft post window"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"For a targeted company post, you would select “Targeted audience”"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - LinkedIn’s Target audience is too narrow"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Target Audience Settings Page after your criteria reaches enough target followers"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"If you have a multilingual business, you can select the different languages your clients may speak in this section on LinkedIn"}
