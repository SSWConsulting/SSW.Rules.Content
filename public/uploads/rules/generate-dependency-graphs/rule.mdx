...
<imageEmbed
  ...
  caption={"Good example - The Visual Studio + ReSharper Dependency Graph"}
...
<imageEmbed
  ...
  caption={"OK example- The Rider Dependency Graph"}
...
<imageEmbed
  ...
  caption={"Your Visual Studio need to have these components installed to be able to use architecture tools"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  caption={"OK example- The Visual Studio Dependency Graph"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"nDepend Dependency Graph. Issues are highlighted in red for easy discovery"}
