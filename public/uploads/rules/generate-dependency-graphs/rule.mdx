...
created: 2012-03-16 08:04:49+00:00
...
<imageEmbed
  ...
  figureText={"Good example - The Visual Studio + ReSharper Dependency Graph"}
...
<imageEmbed
  ...
  figureText={"OK example- The Rider Dependency Graph"}
...
<imageEmbed
  ...
  figureText={"Your Visual Studio need to have these components installed to be able to use architecture tools"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="okExample"
  figureText={"OK example- The Visual Studio Dependency Graph"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"nDepend Dependency Graph. Issues are highlighted in red for easy discovery"}
