...
List Views such as in [SSW Diagnostics](https://www.ssw.com.au/ssw/Diagnostics/) can present a wealth of information to the user. But too often, users are unable to copy this information to paste into a support email because the list view doesn't support copying. Instead, the user has to frustratingly retype the information with the risk of introducing errors.
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="List view with only single selection and no copying"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="List view with multiple selection and copying"
