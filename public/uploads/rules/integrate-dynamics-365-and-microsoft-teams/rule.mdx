...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Do not just send a non-descriptive URL"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Dynamics records can be sent directly to chats"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A Dynamics 365 record pinned as a tab for easy access"
