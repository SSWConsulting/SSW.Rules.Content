...
<imageEmbed
  ...
  figureText={"Bad example - Do not just send a non-descriptive URL"}
...
<imageEmbed
  ...
  figureText={"Good example - Dynamics records can be sent directly to chats"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - A Dynamics 365 record pinned as a tab for easy access"}
