...
<imageEmbed
  ...
  caption={"Bad example - Do not just send a non-descriptive URL"}
...
<imageEmbed
  ...
  caption={"Good example - Dynamics records can be sent directly to chats"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - A Dynamics 365 record pinned as a tab for easy access"}
