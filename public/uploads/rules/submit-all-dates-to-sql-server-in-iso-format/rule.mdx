---
archivedreason: Replaced by [ssw.com.au/rules/parameterize-all-input-to-your-database](/parameterize-all-input-to-your-database)
authors:
- title: Adam Cogan
  url: https://ssw.com.au/people/adam-cogan
created: 2019-11-14 22:25:53+00:00
createdBy: Tiago Araujo
createdByEmail: TiagoAraujo@ssw.com.au
guid: bbe5b2b7-2422-4f31-a559-1f32c35965f3
isArchived: true
lastUpdated: 2020-03-18 23:26:22+00:00
...
seoDescription: Submit all dates to SQL Server in ISO format to ensure consistency
  and avoid language or database setting interference.
