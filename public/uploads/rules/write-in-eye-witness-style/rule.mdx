...
<boxEmbed
  ...
  figureText={"Bad example - using 1st person writing makes it sound like opinion"}
/>
...
<boxEmbed
  ...
  figureText={"Good example - using 3rd person writing makes it sound like fact"}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - 1st person in the context of quoting is appropriate"}
/>