...
<boxEmbed
  ...
  caption={"Bad example - using 1st person writing makes it sound like opinion"}
/>
...
<boxEmbed
  ...
  caption={"Good example - using 3rd person writing makes it sound like fact"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - 1st person in the context of quoting is appropriate"}
/>