...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "!\\[Figure: Bad example - Chrome using Chinese as its language setting](2016-3-22 10-43-12.png)",
  shouldDisplay: true
} } />

<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "!\\[Figure: Good example - Chrome using English as its language setting](2016-3-22 14-59-07.png)",
  shouldDisplay: true
} } />
...
<imageEmbed
  ...
  src="/uploads/rules/make-sure-all-software-uses-english/ssw13.png"
/>
