...
<imageEmbed
  ...
  figureText={"OK example - If you are going to have paper business cards, make sure they pop!"}
...
<imageEmbed
  ...
  figureText={"The easiest way to connect on LinkedIn is to open the QR Code and let others scan it"}
...
<imageEmbed
  ...
  figureText={"Good example - Digital business cards such as HiHello are awesome!"}
