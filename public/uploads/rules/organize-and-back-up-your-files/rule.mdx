...
<imageEmbed
  ...
  captionText={"Bad example - The project is messy, without any meaningful or specific labels"}
...
<imageEmbed
  ...
  captionText={"Good example - Folders are clearly labeled, the root file also includes the date"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - A singular project folder, with some project, files also sitting outside it"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - There are dedicated folders for projects that are in progress and completed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Items are not named clearly and it is difficult to know what file is the correct export"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Each file has an appropriate version number"}
