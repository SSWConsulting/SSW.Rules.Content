...
<imageEmbed
  ...
  caption={"Bad example - An email with requirements does not indicate the priority"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - The developer does not get a chance to ask questions and refine it before it hits the backlog"}
...
<imageEmbed
  ...
  caption={"Good example - Email tasks with a Business Value, allow the developer to review before putting it in the backlog"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - The best workflow for sending an email"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - The best workflow for sending an email with multiple recipients"}
