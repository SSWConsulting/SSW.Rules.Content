...
created: 2017-05-02 04:05:56+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - An email with requirements does not indicate the priority"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - The developer does not get a chance to ask questions and refine it before it hits the backlog"}
...
<imageEmbed
  ...
  figureText={"Good example - Email tasks with a Business Value, allow the developer to review before putting it in the backlog"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - The best workflow for sending an email"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - The best workflow for sending an email with multiple recipients"}
