...
<imageEmbed
  ...
  caption={"Bad example - \"Enter\" button causes OK button to be pressed instead of going to next line in the multi-line text box"}
...
<imageEmbed
  ...
  caption={"Good example - \"Enter\" button goes to the next line in the text box"}
...
<imageEmbed
  ...
  caption={"Developer Notes properties details"}
