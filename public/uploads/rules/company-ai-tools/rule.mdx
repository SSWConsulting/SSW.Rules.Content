---
seoDescription: Learn the importance of creating a company-wide directory for GPTs
  and AI tools and why it should be on the intranet home page for maximum visibility.
type: rule
