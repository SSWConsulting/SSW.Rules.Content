...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - One centralized location for team chat, deployment issues, exceptions and TFS changes](/uploads/rules/do-you-use-slack-as-part-of-your-devops/2016-06-06_11-22-03.png)',
  shouldDisplay: true
} } />
