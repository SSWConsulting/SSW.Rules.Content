...
created: 2019-05-20 03:11:17+00:00
createdBy: Ken Shi
createdByEmail: KenShi@ssw.com.au
guid: f7da22d4-20a2-4534-b6da-3e872005c878
isArchived: false
lastUpdated: 2021-05-06 03:23:48.017000+00:00
...
seoDescription: Unlocking the Power of QR Codes - From Payments to Product Information
  Discover the numerous applications of QR codes, from making payments and installing
  apps to verifying product information and unlocking share-bikes. Explore the world
  of offline-to-online transactions, WeChat, Alipay, and more!
...
<imageEmbed
  ...
  captionText={"A QR code on a Microsoft newsletter, which allows customers to scan and follow the business account"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The WeChat app can scan the QR code, which then allows the customer to click the Follow button. They will then receive regular updates"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Customize WeChat’s personal QR code by changing the style"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Tap and hold on a QR image to extract a QR code"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"How to show your \"Pay me\" QR code on Alipay"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"How to show your “Pay Vendor” QR code on WeChat"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"How to show your “Pay Vendor” QR code on Alipay"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Use WeChat to scan the QR code and view product information in a supermarket"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"A government-sponsored billboard in Hangzhou showcasing apps for tourists"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Use WeChat to sign-up and login to Zhihu (a Chinese Quora alternative)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Use the Weibo App to scan a QR code to login to their services on the web"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"How to connect to a public hotspot"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"How to ride a bus using the Alipay QR code in Hangzhou"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Presenting your QR code to a bus scanner"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"How to rent a Hellobike using the Alipay App"}
