...
<imageEmbed
  ...
  figureText={"A QR code on a Microsoft newsletter, which allows customers to scan and follow the business account"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The WeChat app can scan the QR code, which then allows the customer to click the Follow button. They will then receive regular updates"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Customize WeChat’s personal QR code by changing the style"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Tap and hold on a QR image to extract a QR code"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"How to show your \"Pay me\" QR code on Alipay"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"How to show your “Pay Vendor” QR code on WeChat"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"How to show your “Pay Vendor” QR code on Alipay"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Use WeChat to scan the QR code and view product information in a supermarket"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"A government-sponsored billboard in Hangzhou showcasing apps for tourists"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Use WeChat to sign-up and login to Zhihu (a Chinese Quora alternative)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Use the Weibo App to scan a QR code to login to their services on the web"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"How to connect to a public hotspot"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"How to ride a bus using the Alipay QR code in Hangzhou"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Presenting your QR code to a bus scanner"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"How to rent a Hellobike using the Alipay App"}
