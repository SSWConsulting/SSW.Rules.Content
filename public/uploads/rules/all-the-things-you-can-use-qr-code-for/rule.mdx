...
<imageEmbed
  ...
  caption={"A QR code on a Microsoft newsletter, which allows customers to scan and follow the business account"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The WeChat app can scan the QR code, which then allows the customer to click the Follow button. They will then receive regular updates"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Customize WeChat’s personal QR code by changing the style"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Tap and hold on a QR image to extract a QR code"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"How to show your \"Pay me\" QR code on Alipay"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"How to show your “Pay Vendor” QR code on WeChat"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"How to show your “Pay Vendor” QR code on Alipay"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Use WeChat to scan the QR code and view product information in a supermarket"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A government-sponsored billboard in Hangzhou showcasing apps for tourists"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Use WeChat to sign-up and login to Zhihu (a Chinese Quora alternative)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Use the Weibo App to scan a QR code to login to their services on the web"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"How to connect to a public hotspot"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"How to ride a bus using the Alipay QR code in Hangzhou"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Presenting your QR code to a bus scanner"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"How to rent a Hellobike using the Alipay App"}
