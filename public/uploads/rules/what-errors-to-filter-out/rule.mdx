...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Most of these errors are 404s cause by automated tools scanning for vulnerabilities"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Now that the noise is gone, we can see the actual errors"
