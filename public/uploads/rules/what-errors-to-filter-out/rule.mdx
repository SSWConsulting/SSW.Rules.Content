...
<imageEmbed
  ...
  caption={"Bad Example – Most of these errors are 404s cause by automated tools scanning for vulnerabilities"}
...
<imageEmbed
  ...
  caption={"Good example – Now that the noise is gone, we can see the actual errors"}
