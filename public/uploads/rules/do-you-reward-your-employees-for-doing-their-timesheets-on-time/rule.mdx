...
created: 2016-08-08 21:08:18+00:00
...
seoDescription: Incentivize employees to submit timesheets on time with a reward system
  that includes a free lunch for the entire company.
...
1. Timesheets completion
2. [SugarLearning leaderboard](https://www.sugarlearning.com/SSW/Leaderboard)
3. [Chewing the Fat](/continuous-learning) response - we send out a weekly Microsoft Form with some educational or information gathering content. It must be responded to by the deadline

\&lt;This email was sent as per the rule: [https://www.ssw.com.au/rules/do-you-reward-your-employees-for-doing-their-timesheets-on-time/](/do-you-reward-your-employees-for-doing-their-timesheets-on-time)&gt;
  </>}
  figurePrefix="none"
  figure=""
/>
