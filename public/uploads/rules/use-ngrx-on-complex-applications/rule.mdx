...
<imageEmbed
  ...
  figureText={"NgRx supercharges the redux pattern with RxJS"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The redux pattern is a way to implement a predictable state container"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"NGRX pattern with Effect"}
