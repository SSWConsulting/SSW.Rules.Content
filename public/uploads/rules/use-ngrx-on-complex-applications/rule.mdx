...
<imageEmbed
  ...
  caption={"NgRx supercharges the redux pattern with RxJS"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The redux pattern is a way to implement a predictable state container"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"NGRX pattern with Effect"}
