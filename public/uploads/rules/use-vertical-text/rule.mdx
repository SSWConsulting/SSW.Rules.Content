...
<imageEmbed
  ...
  caption={"Bad example - Not using vertical text for headings, when you have lots of thin columns"}
...
<imageEmbed
  ...
  caption={"OK example - Not using ticks and crosses"}
...
<imageEmbed
  ...
  caption={"Good example - Use emojis to improve the quality of your report"}
