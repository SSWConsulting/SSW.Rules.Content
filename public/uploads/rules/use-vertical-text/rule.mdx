...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Not using vertical text for headings, when you have lots of thin columns"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="Not using ticks and crosses"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Use emojis to improve the quality of your report"
