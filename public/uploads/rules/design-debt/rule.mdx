...
created: 2025-04-30 23:52:58+00:00
...
isArchived: false
lastUpdated: 2025-07-29 23:23:41+00:00
...
<imageEmbed
  ...
  captionText={"Bad example – The \"Open\" badge uses a light green background that is not part of the design system. This results in low contrast, negatively impacting accessibility"}
...
<imageEmbed
  ...
  captionText={"Good example – The issue was flagged with a designer, who resolved it by using an accessible color and updating the design system to include the missing component"}
