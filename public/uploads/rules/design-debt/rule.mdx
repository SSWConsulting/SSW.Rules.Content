...
lastUpdated: 2025-07-03T23:48:37.000Z
...
<imageEmbed
  ...
  figureEmbed={{
    preset: "badExample",
    figure: 'Bad example – The Mega Menu has evolved and accumulated inconsistencies that breaks the original design',
    shouldDisplay: true
  }}
  src="/uploads/rules/design-debt/design-debt-bad-ex.png"
/>
...
<imageEmbed
  ...
  figureEmbed={{
    preset: "goodExample",
    figure: 'Good example – The Mega Menu is clean and consistent as originally designed',
    shouldDisplay: true
  }}
  src="/uploads/rules/design-debt/design-debt-good-ex.png"
/>
