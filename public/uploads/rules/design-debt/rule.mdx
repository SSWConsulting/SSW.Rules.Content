...
lastUpdated: 2025-07-08T00:05:10.000Z
...
<imageEmbed
  ...
  figureEmbed={{
    preset: "badExample",
    figure: 'Bad example – Dotted border added to links. The styling don\'t follow the design system or current UI conventions',
    shouldDisplay: true
  }}
...
<imageEmbed
  ...
  figureEmbed={{
    preset: "goodExample",
    figure: 'Good example – Links are using regular CSS underlines aligned with the design system and UI conventions',
    shouldDisplay: true
  }}
