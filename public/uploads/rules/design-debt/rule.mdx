...
<imageEmbed
  ...
  caption={"Bad example – The \"Open\" badge uses a light green background that is not part of the design system. This results in low contrast, negatively impacting accessibility"}
...
<imageEmbed
  ...
  caption={"Good example – The issue was flagged with a designer, who resolved it by using an accessible color and updating the design system to include the missing component"}
