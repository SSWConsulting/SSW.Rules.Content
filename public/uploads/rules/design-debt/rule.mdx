...
lastUpdated: 2026-05-07T20:11:32.073Z
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="bad" figure="The &#x22;Open&#x22; badge uses a light green background that is not part of the design system. This results in low contrast, negatively impacting accessibility" src="/uploads/rules/design-debt/design-debt-bad.png" />

More info on [Do you use enough color contrast?](/color-contrast)

<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="good" figure="The issue was flagged with a designer, who resolved it by using an accessible color and updating the design system to include the missing component" src="/uploads/rules/design-debt/design-debt-good.png" />
