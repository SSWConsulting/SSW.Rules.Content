...
<boxEmbed
  ...
  captionText={"Bad example - Sounds dismissive, as the \"but\" undermines your agreement"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - Keeps the tone neutral and supportive. Both thoughts stand on their own"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example – Sounds apologetic and defensive."}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example – Acknowledges the concern and reinforces the value."}
/>
