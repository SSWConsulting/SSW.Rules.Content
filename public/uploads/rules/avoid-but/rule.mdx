...
<boxEmbed
  ...
  caption={"Bad example - Sounds dismissive, as the \"but\" undermines your agreement"}
/>
...
<boxEmbed
  ...
  caption={"Good example - Keeps the tone neutral and supportive. Both thoughts stand on their own"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example – Sounds apologetic and defensive."}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example – Acknowledges the concern and reinforces the value."}
/>
