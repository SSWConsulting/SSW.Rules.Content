...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: 'Figure: Good example - Using [Bootstrap\'s class "mt-0"](https://getbootstrap.com/docs/4.0/utilities/spacing/) has the same affect without adding any class',
  shouldDisplay: true
} } />
