...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![](/uploads/rules/do-you-add-ssw-code-auditor-nunit-and-microsoft-fxcop-project-files-to-your-solution/CodeAuditorProjectFile.gif)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![](/uploads/rules/do-you-add-ssw-code-auditor-nunit-and-microsoft-fxcop-project-files-to-your-solution/OpenWith.gif)',
  shouldDisplay: true
} } />
