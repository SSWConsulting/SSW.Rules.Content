...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "![CodeAuditorProjectFile](/uploads/rules/do-you-add-ssw-code-auditor-nunit-and-microsoft-fxcop-project-files-to-your-solution/CodeAuditorProjectFile.gif)",
  shouldDisplay: true
} } />
...
10. Right click the newly added file and select " **Open With** "
    ...
    ::: good
    ![OpenWith](/uploads/rules/do-you-add-ssw-code-auditor-nunit-and-microsoft-fxcop-project-files-to-your-solution/OpenWith.gif)
    :::
