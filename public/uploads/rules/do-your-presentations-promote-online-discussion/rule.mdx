...
<imageEmbed
  ...
  captionText={"Bad example – Presentation title slide does not promote attendee involvement"}
...
<imageEmbed
  ...
  captionText={"Good example – Using a hashtag promotes online discussion and feedback"}
