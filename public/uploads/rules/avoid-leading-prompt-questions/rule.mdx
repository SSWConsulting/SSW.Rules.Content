...
<boxEmbed
  ...
  captionText={"Bad example - The prompt is leading and suggests a specific answer"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - The prompt is neutral and encourages a balanced comparison"}
/>
