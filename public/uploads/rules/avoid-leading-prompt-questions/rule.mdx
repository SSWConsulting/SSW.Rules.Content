...
<boxEmbed
  ...
  figureText={"Bad example - The prompt is leading and suggests a specific answer"}
/>
...
<boxEmbed
  ...
  figureText={"Good example - The prompt is neutral and encourages a balanced comparison"}
/>
