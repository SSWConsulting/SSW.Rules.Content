...
<imageEmbed
  ...
  caption={"How to enable ‘Allow Anonymous Preview’ so you can share your URL before going live"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The URL suffix will be similar to this: ‘…?p=1418&preview=true’"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The URL is pretty messy and it is not as simple as just ticking a box. This is a whole other page"}
