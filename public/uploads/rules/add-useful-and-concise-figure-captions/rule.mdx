...
&#123;&#123; CAPTION &#125;&#125;
  ...
  captionText={"Bad example - Caption not bolded can be mixed up with regular content"}
/>
...
**&#123;&#123; CAPTION &#125;&#125;**
  ...
  captionText={"Good example - Caption stands out when bolded"}
/>
...
**Figure: This is the screen**
  ...
  captionStyle="badExample"
  captionText={"Bad example - Vague caption description"}
/>
...
**Figure: On the screen, choose the execution method**
  ...
  captionStyle="goodExample"
  captionText={"Good example - Clear caption description"}
/>
...
**Figure: Scrum video**
  ...
  captionStyle="badExample"
  captionText={"Bad example - Using \"Figure:\" for a video caption + a vague text"}
/>
...
**Video: Intro to Scrum in Under 10 Minutes (9 min)**
  ...
  captionStyle="goodExample"
  captionText={"Good example - Video caption following the standard \"Video: &#123;&#123; VIDEO TITLE &#125;&#125; (&#123;&#123; VIDEO LENGTH&#125;&#125;)\""}
/>
...
**Figure: An AI image of baseball player sliding**
  ...
  captionStyle="badExample"
  captionText={"Bad example - Doesn't educate others about AI images"}
/>
...
**Figure: An AI image of baseball player sliding. Prompt: A realistic image of a baseball player sliding. The uniform is white and the crowd is cheering.**
  ...
  captionStyle="goodExample"
  captionText={"Good example - Readers understand how you made the image, and they improve their own AI image skills by learning from your caption"}
/>
...
**Video: In this video, Bob talks about Outlook**
  ...
  captionStyle="badExample"
  captionText={"Bad example - A vague text with no link to Bob's profile. Also missing the video length"}
/>
...
**Video: How to search on Outlook by [Bob](https://ssw.com.au/people/sample) (2 min)**
  ...
  captionStyle="goodExample"
  captionText={"Good example - A descriptive caption using the video title + profile link + video length at the end"}
/>
...
**Figure: Users | Summary | User Information | LinkedIn URL**
  ...
  captionStyle="badExample"
  captionText={"Bad example - Does not specificy that it is a GIF"}
/>
...
**Figure: Animated GIF - Users | Summary | User Information | LinkedIn URL**
  ...
  captionStyle="goodExample"
  captionText={"Good example - Specificies that it is a GIF"}
/>