...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Cancel button looks like a save button"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Cancel button is less obvious"
...
- [SSW Rule - Do you label web form buttons consistently?](/label-buttons-consistently)