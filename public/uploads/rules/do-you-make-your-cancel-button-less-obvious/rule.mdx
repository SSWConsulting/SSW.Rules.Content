...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example: Cancel button looks like a save button](bad-cancel-button-example.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example: Cancel button is less obvious](good-example-cancel-button.jpg)',
  shouldDisplay: true
} } />
