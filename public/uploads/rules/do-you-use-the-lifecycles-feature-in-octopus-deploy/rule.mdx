...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This lifecycle has two phases: an automatic release to a Staging server, and a manual release to the Production server."
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This combination results in Continuous Deployment to the Staging server when a new package is pushed"
