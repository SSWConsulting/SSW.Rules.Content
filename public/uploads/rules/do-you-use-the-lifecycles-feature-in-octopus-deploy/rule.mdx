...
isArchived: false
lastUpdated: 2016-05-24 20:49:15+00:00
...
<imageEmbed
  ...
  figureText={"Lifecycles can be found in the Library"}
...
<imageEmbed
  ...
  figureText={"Good Example - This lifecycle has two phases: an automatic release to a Staging server, and a manual release to the Production server."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - This combination results in Continuous Deployment to the Staging server when a new package is pushed"}
