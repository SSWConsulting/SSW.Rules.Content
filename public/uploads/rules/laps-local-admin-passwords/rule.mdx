---
seoDescription: Manage local administrator passwords securely with Microsoft LAPS,
  a best practice for limiting admin accounts and ensuring computer accessibility.
type: rule
...
created: 2022-06-03 06:11:56.902000
...
<youtubeEmbed url="https://www.youtube.com/embed/jdEDIXm4JgU?si=P2zwzjXB_EMICojp" description={"✅ Good Example - Video: Managing local admin account passwords in AD and Azure AD (long - 20 min)"} />  
