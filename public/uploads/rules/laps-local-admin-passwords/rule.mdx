...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example - Figure: Legacy LAPS GPO settings](/uploads/rules/laps-local-admin-passwords/laps-gpo.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example - Figure: Legacy LAPS UI](/uploads/rules/laps-local-admin-passwords/laps-ui.png)',
  shouldDisplay: true
} } />
