...
<imageEmbed
  ...
  figureText={"Google Trends (May 2021) show that Hubdoc and Receipt Bank are the most popular apps"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Google Trends (May 2021) show Expensify as the most popular"}
