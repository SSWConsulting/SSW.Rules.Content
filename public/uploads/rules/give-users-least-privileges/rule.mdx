...
<imageEmbed
  ...
  caption={"Bad example - Too many people have Owner permission on the subscription level"}
...
<imageEmbed
  ...
  caption={"Good example - Only Administrators that will be managing overall permissions and content have been given Owner/Co-administrator"}
