...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Too many people have Owner permission on the subscription level"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Only Administrators that will be managing overall permissions and content have been given Owner/Co-administrator"
