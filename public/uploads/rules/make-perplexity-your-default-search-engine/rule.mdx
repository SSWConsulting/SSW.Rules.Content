...
<imageEmbed
  ...
  captionText={"OK Example - If you generally are just trying to navigate to a particular page on the internet, Google is still an ok option"}
...
<imageEmbed
  ...
  captionText={"Good example - Setting Perplexity as your default search engine for AI-driven, personalized search results"}
