...
<imageEmbed
  ...
  captionText={"Bad Example - A message box that does not intuitively alert the user"}
...
<imageEmbed
  ...
  captionText={"Good Example - A message box that is clear, consistent and intuitive"}
