...
isArchived: false
lastUpdated: 2018-10-26 17:44:06+00:00
...
<imageEmbed
  ...
  captionText={"Creating a project using Visual Studio"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"A simple example WebAPI"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"An Angular UI with Twitter Bootstrap styling"}
