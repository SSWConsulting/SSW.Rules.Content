...
created: 2022-12-07T14:38:49.000Z
guid: 77F8E9B0-2BCB-4AFA-B022-3CFDD3B36C56
redirects:
  - do-you-seal-your-classes-by-default
lastUpdated: 2024-04-15T00:24:46.000Z
lastUpdatedBy: Nadeeka Kodituwakku [SSW]
lastUpdatedByEmail: 94897150+NadeekaJK@users.noreply.github.com
...
<imageEmbed
  ...
  captionText={"Array covariance - sealed Vs non-sealed. See the next figure for performance results"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Performance results show arrays with sealed types show improved performance compared to arrays with non-sealed types"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Casting sealed Vs non-sealed. See the next figure for performance results"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Performance results show casting of sealed has improved performance compared to non-sealed"}
