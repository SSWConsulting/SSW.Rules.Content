...
<imageEmbed
  ...
  caption={"Array covariance - sealed Vs non-sealed. See the next figure for performance results"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Performance results show arrays with sealed types show improved performance compared to arrays with non-sealed types"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Casting sealed Vs non-sealed. See the next figure for performance results"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Performance results show casting of sealed has improved performance compared to non-sealed"}
