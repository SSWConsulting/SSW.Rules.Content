...
Warwick
  ...
  caption={"Bad example - This requires manual changes by a SysAdmin"}
/>
...
<imageEmbed
  ...
  caption={"Navigate to myaccess.microsoft.com"}
...
<imageEmbed
  ...
  caption={"Search for the required resource"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Navigate to Azure portal | Access packages | New Access package"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Fill out the details and choose a catalog"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Add the required resources"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Choose the types of users that can request access"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Choose policies that match the level of access"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Review the settings and create the policy"}
