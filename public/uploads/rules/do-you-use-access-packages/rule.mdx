...
Warwick
  ...
  figureText={"Bad example - This requires manual changes by a SysAdmin"}
/>
...
<imageEmbed
  ...
  figureText={"Navigate to myaccess.microsoft.com"}
...
<imageEmbed
  ...
  figureText={"Search for the required resource"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Navigate to Azure portal | Access packages | New Access package"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Fill out the details and choose a catalog"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add the required resources"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Choose the types of users that can request access"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Choose policies that match the level of access"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Review the settings and create the policy"}
