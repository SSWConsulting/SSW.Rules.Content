...
seoDescription: Learn how to run large language models locally using Ollama and Microsoft
  Foundry Local for enhanced privacy, control, and offline capabilities.
...
<imageEmbed
  ...
  captionText={"Will local LLMs catch up with cloud-based?"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Chat interfaces in LM Studio (left), and Ollama (right)"}
