...
<boxEmbed
  ...
  captionText={"Bad example - prompt is vague and lacking context"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - prompt contains context, goal, and constraint"}
/>
