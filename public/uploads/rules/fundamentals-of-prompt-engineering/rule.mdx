...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Another good example" src="/uploads/rules/fundamentals-of-prompt-engineering/prompt-good-example-testing.png" />
