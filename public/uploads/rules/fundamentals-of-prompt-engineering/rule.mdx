...
lastUpdated: 2026-02-19T09:34:26.852Z
...
* **Result** - The result refers to the desired outcome or specific information the user seeks to obtain from the interaction with ChatGPT. This tells the model exactly what you're hoping for as an output
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Prompt is vague and lacking context"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Prompt contains context, goal, and constraint"
/>
...
By specifying the role, result, intent, context, and constraint in the prompt, you can guide ChatGPT to deliver a more relevant and targeted response, addressing your specific needtests and expectations.

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Another good example" src="/uploads/rules/fundamentals-of-prompt-engineering/new-prompt-engineering-only-prompt.png" />
