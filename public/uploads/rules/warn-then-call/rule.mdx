...
<imageEmbed
  ...
  figureText={"Good example - A screenshot and subject includes context and makes it easy to search a inbox"}
...
<imageEmbed
  ...
  figureText={"In Outlook | Share to Teams"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Includes a task, and gives context by sharing the email to a teams chat using Outlook | Share to Teams"}
