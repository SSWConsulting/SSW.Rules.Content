...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A screenshot and subject includes context and makes it easy to search a inbox"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Includes a task, and gives context by sharing the email to a teams chat using Outlook | Share to Teams"
