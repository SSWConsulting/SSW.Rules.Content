...
isArchived: false
lastUpdated: 2024-11-07 00:55:10+00:00
...
<boxEmbed
  ...
  captionText={"Bad example - The recipient has no idea what you are calling about"}
/>
...
<boxEmbed
  ...
  captionText={"OK example - Includes context although the other person can't easily find out more"}
/>
...
**&#123;&#123; URL &#125;&#125;**
  ...
  captionStyle="goodExample"
  captionText={"Good example - Includes PBI/Issue link for reference and doesn't leave anyone waiting"}
/>
...
**&#123;&#123; EMAIL SUBJECT &#125;&#125;**
  ...
  captionStyle="goodExample"
  captionText={"Good example - Includes email subject for reference"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - Includes priority order numbers to share how many other approvers you have attempted to contact"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - A screenshot and subject includes context and makes it easy to search a inbox"}
...
1. Please update [https://ssw.com.au/rules/warn-then-call](https://ssw.com.au/rules/warn-then-call) rule with a good example
  ...
  captionStyle="goodExample"
  captionText={"Good example - Forwarding then copying an email includes context by sharing the email and providing participant details"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"In Outlook | Share to Teams"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Includes a task, and gives context by sharing the email to a teams chat using Outlook | Share to Teams"}
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - Send them a message indicating you will try again later"}
/>
...
Please get back to me if you prefer another way."
  ...
  captionStyle="goodExample"
  captionText={"Good example - Send them a message explaining how the next steps will move forward"}
/>