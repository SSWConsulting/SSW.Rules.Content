...
<imageEmbed
  ...
  figureText={"See your team's upcoming or outstanding recurring tasks"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Limit the due dates so you don't have to look at tasks that are not due for ages"}
