...
<imageEmbed
  ...
  caption={"Bad example - the version number is too large, too dark and too obvious"}
...
<imageEmbed
  ...
  caption={"Good example - the text is small, barely visible and would only be noticeable if you're looking for it"}
