...
<imageEmbed
  ...
  caption={"A Dependency Injection based architecture gives us great maintainability"}
...
<imageEmbed
  ...
  caption={"Good Example - The Solution and Projects are named consistently and the Solution Folders organize the projects so that they follow the Onion Architecture"}
