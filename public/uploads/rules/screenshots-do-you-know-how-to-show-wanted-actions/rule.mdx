...
<imageEmbed
  ...
  caption={"Bad example – There is no visual difference between different actions"}
...
<imageEmbed
  ...
  caption={"Good example – This screenshot tells that the user should be on the \"Message\" tab, click on \"Attach File\" and edit the subject to be \"Button types\""}
