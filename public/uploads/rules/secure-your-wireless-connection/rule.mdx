...
isArchived: false
lastUpdated: 2020-06-22 01:57:38+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Unsecured network (OK for guest networks with a Captive Portal)"}
...
<imageEmbed
  ...
  figureText={"Good example - WPA3 Enterprise"}
...
<imageEmbed
  ...
  figureText={"UniFi RADIUS settings"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Radius client settings"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"How to register NPS server with AD"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Group policy settings"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"GP link and scope settings"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Connection security settings with WPA3"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"✅ OK example - Windows 11 | Group Policy Management | Wifi Settings | Security Settings | Authentication shows WPA2 - aim is WPA3, but some devices are still not ready for it"}
