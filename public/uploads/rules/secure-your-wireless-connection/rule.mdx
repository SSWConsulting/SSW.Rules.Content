...
<imageEmbed
  ...
  captionText={"Bad example - Unsecured network (OK for guest networks with a Captive Portal)"}
...
<imageEmbed
  ...
  captionText={"Good example - WPA3 Enterprise"}
...
<imageEmbed
  ...
  captionText={"UniFi RADIUS settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Radius client settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"How to register NPS server with AD"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Group policy settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"GP link and scope settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Connection security settings with WPA3"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"✅ OK example - Windows 11 | Group Policy Management | Wifi Settings | Security Settings | Authentication shows WPA2 - aim is WPA3, but some devices are still not ready for it"}
