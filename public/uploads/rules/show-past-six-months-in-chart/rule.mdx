...
<imageEmbed
  ...
  figureText={"Good example - Use of bar chart to show the past 6 months of totals at the end of your report for easy comparison"}
...
<imageEmbed
  ...
  figureText={"Change Data Type to DateTime and assign to the proper default values"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Build up the column chart in layout view"}
