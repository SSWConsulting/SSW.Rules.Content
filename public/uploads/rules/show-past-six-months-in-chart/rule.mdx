...
<imageEmbed
  ...
  caption={"Good example - Use of bar chart to show the past 6 months of totals at the end of your report for easy comparison"}
...
<imageEmbed
  ...
  caption={"Change Data Type to DateTime and assign to the proper default values"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Build up the column chart in layout view"}
