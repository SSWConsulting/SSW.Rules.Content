...
<imageEmbed
  ...
  captionText={"Good example - Use of bar chart to show the past 6 months of totals at the end of your report for easy comparison"}
...
<imageEmbed
  ...
  captionText={"Change Data Type to DateTime and assign to the proper default values"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Build up the column chart in layout view"}
