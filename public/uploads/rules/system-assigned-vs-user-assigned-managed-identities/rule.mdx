...
<imageEmbed alt="Type of managed identities in Azure" size="large" showBorder={false} figurePrefix="none" figure="Select the managed identity type in the Azure portal" src="/uploads/rules/system-assigned-vs-user-assigned-managed-identities/user-assigned-vs-system-assigned.png" />
