...
isArchived: false
lastUpdated: 2021-03-09 00:34:10.794000+00:00
...
<imageEmbed
  ...
  figureText={"Anything wrong this Gender column?"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Caster Semenya was the first to teach us a thing or two about the right data type for Gender"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Changing the data type and data required a \"Data Motion Script\""}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Don't use Visual Studio Schema Compare Tool (aka Data Dude)"}
