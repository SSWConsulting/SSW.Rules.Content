...
<imageEmbed
  ...
  captionText={"Bad example - Aliexpress get a mark of 6/12 (see tooltip) and cannot be used as a PWA"}
...
<imageEmbed
  ...
  captionText={"Accessing a PWA on your mobile will prompt adding it on your Home screen. E.g. https://blog.mikemjharris.com"}
...
<imageEmbed
  ...
  captionText={"Good example - Aim for a good Progressive Web App score"}
