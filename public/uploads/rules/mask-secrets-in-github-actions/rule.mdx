...
created: 2023-10-10 03:58:44+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - The secret is exposed in the GitHub logs"}
...
<imageEmbed
  ...
  captionText={"Good example - The secret is masked in the GitHub logs"}
