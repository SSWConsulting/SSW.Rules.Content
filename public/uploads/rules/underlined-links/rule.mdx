...
<boxEmbed
  ...
  captionText={"Good example - The link is nice and clear"}
/>
...
<boxEmbed
  ...
  captionText={"Bad example - Never underline the text when it isn't a link"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - Using bold for emphasis"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Using bold on hovering may cause a text shift"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - The different border size pushes the content down"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Borders going over the text area"}
