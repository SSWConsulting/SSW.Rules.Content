...
<boxEmbed
  ...
  figureText={"Good example - The link is nice and clear"}
/>
...
<boxEmbed
  ...
  figureText={"Bad example - Never underline the text when it isn't a link"}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Using bold for emphasis"}
/>
...
<imageEmbed
  ...
  figureText={"Bad example - Using bold on hovering may cause a text shift"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - The different border size pushes the content down"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Borders going over the text area"}
