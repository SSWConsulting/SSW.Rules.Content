...
created: 2015-02-16T01:26:10.000Z
createdBy: 'Harkirat Singh [SSW]'
createdByEmail: sandhukirat23@gmail.com
lastUpdated: 2026-07-29T06:30:43.417Z
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="The link is nice and clear"
/>
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Never underline the text when it isn't a link"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Using bold for emphasis"
/>
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Using bold on hovering may cause a text shift" src="/uploads/rules/underlined-links/bad-example-bold-hover.gif" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="The different border size pushes the content down" src="/uploads/rules/underlined-links/border-problem-1.gif" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Borders going over the text area" src="/uploads/rules/underlined-links/border-problem-2.png" />
