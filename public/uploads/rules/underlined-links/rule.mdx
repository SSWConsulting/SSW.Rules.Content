...
<boxEmbed
  ...
  caption={"Good example - The link is nice and clear"}
/>
...
<boxEmbed
  ...
  caption={"Bad example - Never underline the text when it isn't a link"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Using bold for emphasis"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Using bold on hovering may cause a text shift"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - The different border size pushes the content down"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Borders going over the text area"}
