...
seoDescription: Do you use the best deployment tool? Automate your deployments with
  Octopus Deploy and ensure that you're deploying tested builds to each environment
  separately.
...
<imageEmbed
  ...
  figureText={"Good Example - SSW uses Octopus Deploy to deploy Sugar Learning"}
