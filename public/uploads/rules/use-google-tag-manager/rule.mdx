...
<imageEmbed
  ...
  captionText={"Bad example – Vimeo tracking code added in the head of the source code"}
...
<imageEmbed
  ...
  captionText={"Good example – Reference to the Google Tag Manager"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – Vimeo tracking code added through Google Tag Manager"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"All tags are added in new SSW.Website using GTM"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Universal Analytics is collecting data from the website"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"GA4 is collecting data from the website"}
