...
created: 2025-06-23 10:32:00+00:00
...
**Notes:** Planning to deploy to staging today if tests pass.
  ...
  figureText={"Good example – concise bullet points shared before the meeting allow the team to be informed without time-wasting status updates."}
/>
