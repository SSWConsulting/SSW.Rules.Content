...
<imageEmbed
  ...
  captionText={"BREAD Daily Scrums"}
...
**Notes:** Planning to deploy to staging today if tests pass.
  ...
  captionText={"Good example – concise bullet points shared before the meeting allow the team to be informed without time-wasting status updates."}
/>
