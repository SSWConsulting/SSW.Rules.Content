...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="A tester or a Product Owner who comes to this page may believe that it is broken, or that the developers have 'missed' it. Always be clear about what parts of your application are not yet ready for feedback"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="It is clear to testers and to the Product Owner that this page is incomplete, but they can get more details from the Product Backlog"
