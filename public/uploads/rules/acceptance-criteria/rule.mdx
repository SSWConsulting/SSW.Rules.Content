...
<imageEmbed
  ...
  captionText={"A PBI with Acceptance Criteria in Azure DevOps"}
...
<boxEmbed
  ...
  captionText={"Bad example of Acceptance Criteria - Incomplete"}
/>
...
* When I enter ‘zzz’ in the Search box and click ‘Search’ I will see **no** entries in the Grid
  ...
  captionText={"OK example of Acceptance Criteria - However the Product Owner probably hasn't included all of their requirements"}
/>
...
* If a large set of results is returned, display pagination with page numbers and ‘Prev’, ‘Next’ links
  ...
  captionText={"Good example of Acceptance Criteria"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Discussion about changes to the Description and Acceptance Criteria captured in the PBI"}
