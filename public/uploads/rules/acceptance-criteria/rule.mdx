...
<imageEmbed
  ...
  caption={"A PBI with Acceptance Criteria in Azure DevOps"}
...
<boxEmbed
  ...
  caption={"Bad example of Acceptance Criteria - Incomplete"}
/>
...
* When I enter ‘zzz’ in the Search box and click ‘Search’ I will see **no** entries in the Grid
  ...
  caption={"OK example of Acceptance Criteria - However the Product Owner probably hasn't included all of their requirements"}
/>
...
* If a large set of results is returned, display pagination with page numbers and ‘Prev’, ‘Next’ links
  ...
  caption={"Good example of Acceptance Criteria"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Discussion about changes to the Description and Acceptance Criteria captured in the PBI"}
