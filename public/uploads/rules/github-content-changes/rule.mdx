...
<imageEmbed
  ...
  figureText={"Reviewing tabs in a GitHub Pull Request"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The view via \"Display the rich diff\" button"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Steps for submitting a Pull Request review"}
