...
<imageEmbed
  ...
  captionText={"Reviewing tabs in a GitHub Pull Request"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The view via \"Display the rich diff\" button"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Steps for submitting a Pull Request review"}
