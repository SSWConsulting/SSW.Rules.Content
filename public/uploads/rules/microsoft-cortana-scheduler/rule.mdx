...
==Cortana, schedule a meeting.==
  ...
  captionStyle="default"
  caption={"after your message, add some request to Cortana as you would a PA"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Cortana will find a time that suits everyone and send the appointment"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Cortana added as a contact"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Microsoft Scheduler – Fully works on mobile phone"}
