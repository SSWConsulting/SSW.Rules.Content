...
==Cortana, schedule a meeting.==
  ...
  figurePreset="defaultExample"
  figureText={"after your message, add some request to Cortana as you would a PA"}
/>
...
<imageEmbed
  ...
  figureText={"Cortana will find a time that suits everyone and send the appointment"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Cortana added as a contact"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Microsoft Scheduler – Fully works on mobile phone"}
