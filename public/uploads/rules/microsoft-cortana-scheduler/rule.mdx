...
==Cortana, schedule a meeting.==
  ...
  captionStyle="default"
  captionText={"after your message, add some request to Cortana as you would a PA"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Cortana will find a time that suits everyone and send the appointment"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Cortana added as a contact"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Microsoft Scheduler – Fully works on mobile phone"}
