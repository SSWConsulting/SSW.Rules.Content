...
created: 2022-10-07 04:30:16.588000+00:00
...
<imageEmbed
  ...
  figureText={"The whole team needs to take on responsibility to achieve great quality (source: infamous-labyrinth.flywheelsites.com/about/microsoft-awards)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Wise words from Deming on achieving higher quality"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The Agile Testing Manifesto, by Karen Greaves & Samantha Laing"}
