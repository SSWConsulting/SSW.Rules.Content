...
<imageEmbed
  ...
  caption={"The whole team needs to take on responsibility to achieve great quality (source: infamous-labyrinth.flywheelsites.com/about/microsoft-awards)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Wise words from Deming on achieving higher quality"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The Agile Testing Manifesto, by Karen Greaves & Samantha Laing"}
