...
created: 2022-10-14 16:17:46+00:00
...
seoDescription: Scrum teams can boost quality by adopting a whole-team approach, focusing
  on shared understanding, diverse perspectives, and collaborative testing.
...
<imageEmbed
  ...
  captionText={"The whole team needs to take on responsibility to achieve great quality (source: infamous-labyrinth.flywheelsites.com/about/microsoft-awards)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Wise words from Deming on achieving higher quality"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The Agile Testing Manifesto, by Karen Greaves & Samantha Laing"}
