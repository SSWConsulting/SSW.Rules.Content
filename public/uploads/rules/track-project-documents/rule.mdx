...
<imageEmbed
  ...
  figureText={"Bad example - You shouldn't look for files on network shares"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - You shouldn't create files locally first and then copy them"}
...
<imageEmbed
  ...
  figureText={"Good example - You can use the files tab in Teams (without leaving the app)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - You can have a conversation about a file"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - You can open the files in SharePoint"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - You can sync the files in SharePoint with your current machine through OneDrive. A toast notification should popup indicating that files will be synced"}
