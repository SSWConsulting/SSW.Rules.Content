...
<imageEmbed
  ...
  caption={"Bad example - You shouldn't look for files on network shares"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - You shouldn't create files locally first and then copy them"}
...
<imageEmbed
  ...
  caption={"Good example - You can use the files tab in Teams (without leaving the app)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - You can have a conversation about a file"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - You can open the files in SharePoint"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - You can sync the files in SharePoint with your current machine through OneDrive. A toast notification should popup indicating that files will be synced"}
