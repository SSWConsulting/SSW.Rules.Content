...
seoDescription: >-
  Microsoft Teams is an ideal platform to store project documents due to its
  integration with SharePoint, real-time collaboration features, and seamless
  sharing capabilities.
created: 2018-07-30T01:05:41.000Z
createdBy: MatthewWicks
createdByEmail: MatthewWicks@ssw.com.au
lastUpdated: 2025-11-21T13:30:08.689Z
...
<imageEmbed
  ...
  figureEmbed={{
    preset: "badExample",
    figure:
      "Bad example - You shouldn't create files locally first and then copy them",
    shouldDisplay: true
  }}
...
<imageEmbed
  ...
  figureEmbed={{
    preset: "goodExample",
    figure:
      "Good example - You can use the files tab in Teams (without leaving the app)",
    shouldDisplay: true
  }}
...
<imageEmbed
  ...
  figureEmbed={{
    preset: "goodExample",
    figure:
      "Good example - You can sync the files in SharePoint with your current machine through OneDrive. A toast notification should popup indicating that files will be synced",
    shouldDisplay: true
  }}
