...
==1096==
  ...
  figureText={"Have a look at the dogfoodstats you ran before"}
/>
...
23723
  ...
  figurePreset="defaultExample"
  figureText={"You should get the same number or more for your TFS2010 server. We’re not worried unless it’s slightly less"}
/>