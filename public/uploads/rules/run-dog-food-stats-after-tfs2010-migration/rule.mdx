---
archivedreason: Outdated - Specific to TFS 2010 migration validation (end-of-life). For modern guidance, see [Steps required when migrating to the cloud](/steps-required-when-migrating-to-the-cloud).
isArchived: true
authors: []
...
1 <mark style="background-color: #FEF08A">28052</mark>

2 <mark style="background-color: #FEF08A">335168</mark>
...
<mark style="background-color: #FEF08A">1096</mark>
  </>}
  figurePrefix="none"
...
<mark style="background-color: #FEF08A">347629</mark>
