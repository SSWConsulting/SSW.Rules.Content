...
<boxEmbed
  style="info"
  body={<>
    SSW has built an estimates calculator to assist in creating estimates. See the [Estimates Calculator](/uploads/rules/include-general-project-costs-to-estimates/Estimates_Calculator.xlsx) here.
  </>}
  figurePrefix="none"
  figure=""
/>
