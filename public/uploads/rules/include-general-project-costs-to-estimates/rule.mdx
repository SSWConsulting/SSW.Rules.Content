...
created: 2009-09-16 02:44:19+00:00
...
<boxEmbed
  style="info"
  body={<>
    SSW has built an estimates calculator to assist in creating estimates. See the [Estimates Calculator](https://github.com/SSWConsulting/SSW.Rules.Content/raw/main/rules/spec-do-you-know-how-to-estimate-a-project-that-include-the-general-project-costs/Estimates_Calculator.xlsx) here.
  </>}
  figurePrefix="none"
  figure=""
/>
