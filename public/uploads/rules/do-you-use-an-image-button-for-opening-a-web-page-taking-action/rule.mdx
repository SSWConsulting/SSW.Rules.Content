...
<imageEmbed
  ...
  caption={"Simple hyperlink not taking action"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Hyperlink on a button"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Normal button"}
...
<imageEmbed
  ...
  caption={"Good example - XP button with image"}
