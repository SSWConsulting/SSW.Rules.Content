...
<imageEmbed
  ...
  figureText={"Simple hyperlink not taking action"}
...
<imageEmbed
  ...
  figureText={"Bad example - Hyperlink"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Hyperlink on a button"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Normal button"}
...
<imageEmbed
  ...
  figureText={"Good example - XP button with image"}
