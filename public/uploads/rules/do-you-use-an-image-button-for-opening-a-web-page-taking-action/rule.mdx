...
<imageEmbed
  ...
  captionText={"Simple hyperlink not taking action"}
...
<imageEmbed
  ...
  captionText={"Bad example - Hyperlink"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Hyperlink on a button"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Normal button"}
...
<imageEmbed
  ...
  captionText={"Good example - XP button with image"}
