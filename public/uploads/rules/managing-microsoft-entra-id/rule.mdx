...
lastUpdated: 2026-03-17T06:36:31.785Z
...
## 7. Use Company Branding

* Security: Adding a branded login screen assists users with correctly identifying the correct login page for their tenant. It also adds polish to the portal.

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="SSW Branding added to the sign in portal" src="/uploads/rules/managing-microsoft-entra-id/Branded Login Screen.png" />

## 8. Use Clear Access Group Naming Conventions
