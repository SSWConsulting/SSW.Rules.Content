...
isArchived: true
lastUpdated: 2020-07-29 22:32:09+00:00
...
<boxEmbed
  style="greybox"
  body={<>
    &lt;p&gt;Your <mark style="background-color: #FEF08A">e-mail</mark> address must match your confirm <mark style="background-color: #FEF08A">e-mail</mark> address&lt;/p&gt;
...
<boxEmbed
  style="greybox"
  body={<>
    &lt;p&gt;Your <mark style="background-color: #FEF08A">email</mark> address must match your confirm <mark style="background-color: #FEF08A">email</mark> address&lt;/p&gt;
...
We have a rule in [SSW Code Auditor](https://codeauditor.com) and [SSW Link Auditor](https://sswlinkauditor.com/) to check for this.