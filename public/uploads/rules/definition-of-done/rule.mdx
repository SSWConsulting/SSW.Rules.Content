...
created: 2023-03-07 23:32:10+00:00
...
<imageEmbed
  ...
  captionText={"Good example - Add check-in policies to enforce your Definition of Done"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Organize tests in suites with built-in E2E traceability across requirements, test artifacts and defects"}
