...
<imageEmbed
  ...
  figureText={"Good example - Add check-in policies to enforce your Definition of Done"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Organize tests in suites with built-in E2E traceability across requirements, test artifacts and defects"}
