...
created: 2010-02-10 00:09:02+00:00
...
<boxEmbed
  style="tips"
  body={<>
    **Tip:** When an AI agent makes a UI change, it can produce the screenshots and short videos itself. Get it to verify the change in a real browser, fix what it finds, and keep the capture for the PR and the Done comment. See [Do you get your AI agent to capture its own UI changes?](/done-video-by-ai).
  </>}
  figurePrefix="none"
  figure=""
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Add check-in policies to enforce your Definition of Done"
