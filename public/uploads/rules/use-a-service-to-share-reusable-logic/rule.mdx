...
seoDescription: Learn how to share reusable logic across your Angular application
  using a Service and Dependency Injection.
...
<imageEmbed
  ...
  figureText={"Bad Example - Code that is reusable should be placed in a Service"}
...
<imageEmbed
  ...
  figureText={"Good Example -  Reusable code is placed in a Service and the component calls the Service"}
