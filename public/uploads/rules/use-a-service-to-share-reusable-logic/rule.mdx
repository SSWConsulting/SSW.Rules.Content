...
<imageEmbed
  ...
  captionText={"Bad Example - Code that is reusable should be placed in a Service"}
...
<imageEmbed
  ...
  captionText={"Good Example -  Reusable code is placed in a Service and the component calls the Service"}
