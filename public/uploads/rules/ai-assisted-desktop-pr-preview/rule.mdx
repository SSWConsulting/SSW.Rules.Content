...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Manual local branch switching, building, and running every time you want to test a change"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Switch your desktop app to the PR pre-release channel in Settings, install, and test instantly in the real app environment"
...
* Use screenshots or short videos for reviewers. The agent can [capture these itself](/done-video-by-ai) while it verifies the change
