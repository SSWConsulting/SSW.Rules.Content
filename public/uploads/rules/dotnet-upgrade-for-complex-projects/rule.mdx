...
<imageEmbed
  ...
  figureText={"Git changes for targeting to multiple target frameworks"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Visual Studio context menu."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example results from an Upgrade Assistant upgrade."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The new project architecture and request flow."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Context menu on the project to be migrated."}
  src="https://github.com/SSWConsulting/SSW.Rules.Content/assets/3699937/3303daaf-0dea-4b34-9f59-53fd55acf2ef"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Upgrade Assistant's Summary page."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Endpoint Explorer showing the endoints between the old .NET Framework project and the new .NET Core project."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Upgrade Assistant progress upgrading a controller."}
