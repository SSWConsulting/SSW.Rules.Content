...
<imageEmbed
  ...
  figureText={"Create a new project"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="default"
  figureText={"Select the Scrum template"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="default"
  figureText={"Product backlog has Product Backlog Items (PBIs)"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="default"
  figureText={"PBI states are terms which are Scrum terms"}
