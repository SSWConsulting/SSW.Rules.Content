...
<imageEmbed
  ...
  captionText={"Create a new project"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"Select the Scrum template"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"Product backlog has Product Backlog Items (PBIs)"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"PBI states are terms which are Scrum terms"}
