...
<imageEmbed
  ...
  caption={"Bad example - A lookup field is the first column"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - A regular field is the first column"}
...
<imageEmbed
  ...
  caption={"Good example - Primary Field is the first column"}
