...
<imageEmbed
  ...
  captionText={"Bad example - A lookup field is the first column"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - A regular field is the first column"}
...
<imageEmbed
  ...
  captionText={"Good example - Primary Field is the first column"}
