...
<imageEmbed
  ...
  figureText={"Bad example - A lookup field is the first column"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - A regular field is the first column"}
...
<imageEmbed
  ...
  figureText={"Good example - Primary Field is the first column"}
