---
seoDescription: When making significant changes to your pipeline, it's crucial to
  test them in a separate repository first to avoid unintended deployments and ensure
  a thorough test.
type: rule
...
created: 2023-09-14 04:26:51.981000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure='This should read "needs: approval-gate"'
  src="/uploads/rules/complete-major-changes-on-another-repo/2023-09-14_14-05-04.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Pipeline Graph shows the issue instantly - Prod deployment and approval-gate in the wrong order"
  src="/uploads/rules/complete-major-changes-on-another-repo/2023-09-14_14-11-09.png"
/>
