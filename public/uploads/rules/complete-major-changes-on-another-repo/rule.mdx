...
<imageEmbed
  ...
  figureText={"Bad example - This should read \"needs: approval-gate\""}
...
<imageEmbed
  ...
  figureText={"Good example - Pipeline Graph shows the issue instantly - Prod deployment and approval-gate in the wrong order"}
