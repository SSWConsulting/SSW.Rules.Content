...
<imageEmbed
  ...
  caption={"Bad example - This should read \"needs: approval-gate\""}
...
<imageEmbed
  ...
  caption={"Good example - Pipeline Graph shows the issue instantly - Prod deployment and approval-gate in the wrong order"}
