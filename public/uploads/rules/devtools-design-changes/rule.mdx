...
<emailEmbed
  ...
  figurePrefix="bad"
  figure="Vague request with no specific guidance. The developer is left guessing what the designer means"
/>
...
<boxEmbed
  style="tips"
  body={<>
    **Tip:** The same principle works in the other direction. When an AI agent implements the change, get it to capture a screenshot or short video of the result so the designer can check it without running the app. See [Do you get your AI agent to capture its own UI changes?](/done-video-by-ai).
  </>}
  figurePrefix="none"
  figure=""
/>
