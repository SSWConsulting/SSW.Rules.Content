...
created: 2019-11-12 22:20:33+00:00
...
- stored-procedures-do-you-use-scope_identity()-to-get-the-most-recent-row-identity
seoDescription: Use SCOPE_IDENTITY() instead of @@IDENTITY to safely get the most
  recent row identity in SQL Server and avoid trigger-related bugs.
title: Stored Procedures - Do you use SCOPE_IDENTITY() to get the most recent row
  identity?
type: rule
