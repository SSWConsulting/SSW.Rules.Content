...
<imageEmbed
  ...
  figureText={"Bad example - Shared link has no image and the title was \"guessed\" by LinkedIn"}
...
<imageEmbed
  ...
  figureText={"Good example - Shared link has a nice image and title, both defined via Open Graph tags"}
