...
<imageEmbed
  ...
  captionText={"Bad example - Shared link has no image and the title was \"guessed\" by LinkedIn"}
...
<imageEmbed
  ...
  captionText={"Good example - Shared link has a nice image and title, both defined via Open Graph tags"}
