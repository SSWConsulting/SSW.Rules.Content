...
<imageEmbed
  ...
  caption={"Bad example - The Windows Snipping Tool isn't powerful enough for most business use cases"}
...
<imageEmbed
  ...
  caption={"Good example - Snagit is the gold standard and provides tonnes of user friendly features"}
...
<imageEmbed
  ...
  caption={"Lightshot is the most popular screenshot tool"}
