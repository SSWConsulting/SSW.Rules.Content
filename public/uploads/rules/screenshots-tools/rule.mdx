...
<imageEmbed
  ...
  captionText={"Bad example - The Windows Snipping Tool isn't powerful enough for most business use cases"}
...
<imageEmbed
  ...
  captionText={"Good example - Snagit is the gold standard and provides tonnes of user friendly features"}
...
<imageEmbed
  ...
  captionText={"Lightshot is the most popular screenshot tool"}
