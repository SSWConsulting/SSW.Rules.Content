...
<imageEmbed
  ...
  caption={"Bad example - Missing weekday"}
...
<imageEmbed
  ...
  caption={"Good example - Abbreviated weekday"}
...
<imageEmbed
  ...
  caption={"SharePoint date format option 1"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"SharePoint date format option 2"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Calculated column with Formula code"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Replace the old Date column (Date) with new calculated column (WeekDate)"}
