...
<imageEmbed
  ...
  figureText={"Bad example - Missing weekday"}
...
<imageEmbed
  ...
  figureText={"Good example - Abbreviated weekday"}
...
<imageEmbed
  ...
  figureText={"SharePoint date format option 1"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"SharePoint date format option 2"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Calculated column with Formula code"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Replace the old Date column (Date) with new calculated column (WeekDate)"}
