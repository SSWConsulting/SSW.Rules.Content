...
related: []
redirects: []
lastUpdated: 2014-11-19T07:16:41.000Z
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "![Good example – an application should never automatically delete a database, not even a sample database](/uploads/rules/sample-do-you-avoid-dropping-a-users-database-when-you-attempt-to-create-a-database/../../assets/InterfacesDBAlreadyExists.gif)",
  shouldDisplay: true
} } />
