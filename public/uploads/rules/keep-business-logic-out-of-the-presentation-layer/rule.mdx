...
<imageEmbed
  ...
  captionText={"Bad example - Although this application clearly has repository and business logic layers, the logic that orchestrates these dependencies is in the ASP.NET Controller and is difficult to reuse"}
...
<imageEmbed
  ...
  captionText={"(from MediatR docs) A Simple Request class"}
