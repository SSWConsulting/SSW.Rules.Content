...
<imageEmbed
  ...
  captionText={"Find reports creators by clicking \"Details View\" inside report folder"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Send an email to ask permission"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Email received with permission to delete from creator"}
