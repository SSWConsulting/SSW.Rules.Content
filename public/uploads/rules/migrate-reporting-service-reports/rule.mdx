...
<imageEmbed
  ...
  caption={"Find reports creators by clicking \"Details View\" inside report folder"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Send an email to ask permission"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Email received with permission to delete from creator"}
