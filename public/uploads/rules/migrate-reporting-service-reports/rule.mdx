...
<imageEmbed
  ...
  figureText={"Find reports creators by clicking \"Details View\" inside report folder"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Send an email to ask permission"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Email received with permission to delete from creator"}
