...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Optimizilla reduced the image in 31%" src="/uploads/rules/optimize-your-images/optimizeexample.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="WP Smush plugin saved 9.4MB from one website" src="/uploads/rules/optimize-your-images/wp-smush.jpg" />
