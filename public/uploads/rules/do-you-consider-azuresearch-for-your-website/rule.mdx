...
isArchived: false
lastUpdated: 2021-03-18 21:44:55.650000+00:00
...
<imageEmbed
  ...
  figureText={"Good example - Azure website using AzureSearch for what it can deliver today"}
...
<imageEmbed
  ...
  figureText={"Bad example - Azure website using ElasticSearch for a simple search that AzureSearch can do"}
