...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Azure website using AzureSearch for what it can deliver today"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Azure website using ElasticSearch for a simple search that AzureSearch can do"
