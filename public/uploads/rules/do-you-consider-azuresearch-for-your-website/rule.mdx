...
<imageEmbed
  ...
  caption={"Good example - Azure website using AzureSearch for what it can deliver today"}
...
<imageEmbed
  ...
  caption={"Bad example - Azure website using ElasticSearch for a simple search that AzureSearch can do"}
