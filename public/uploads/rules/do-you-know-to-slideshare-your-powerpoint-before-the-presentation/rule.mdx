...
<imageEmbed
  ...
  figureText={"SlideShare ranks well in google searches"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Interestingly, keyword heavy slides from your PowerPoint will rank highly on Google image search"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add the version number on the bottom right corner of your first or second slide"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Adding the version number to the title (after uploading) won’t affect the URL"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"the SSW example of a SlideShare link slide"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"If you presentation is being recorded be sure to send yourself a reminder email to embedd the video in to the SlideShare."}
