...
<imageEmbed
  ...
  captionText={"Good example - Manage deployments to multiple environments, view deployed versions"}
...
<imageEmbed
  ...
  captionText={"Bad example – Creating a branch per feature leads to lots of merging (Image from paulhammant.com blog)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example – Creating a branch per Sprint has everyone working on the same code but requires at least one merge every Sprint"}
