...
<imageEmbed
  ...
  figureText={"Good example - Manage deployments to multiple environments, view deployed versions"}
...
<imageEmbed
  ...
  figureText={"Bad example – Creating a branch per feature leads to lots of merging (Image from paulhammant.com blog)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – Creating a branch per Sprint has everyone working on the same code but requires at least one merge every Sprint"}
