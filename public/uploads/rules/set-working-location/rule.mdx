...
<imageEmbed
  ...
  captionText={"Outlook on the web | Work hours and location settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Classic Outlook | Calendar with locations set"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Microsoft Places | Show in office summary"}
