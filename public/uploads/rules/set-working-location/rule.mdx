...
<imageEmbed
  ...
  figureText={"Outlook on the web | Work hours and location settings"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Classic Outlook | Calendar with locations set"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Microsoft Places | Show in office summary"}
