archivedreason: Outdated (Legacy) - “Who hasn’t checked in” reporting is TFVC/TFS-era. Prefer small, frequent commits and PR visibility; see [Check-in before lunch and dinner – Do you work in small chunks & check in after completing each one?](/check-in-before-lunch-and-dinner-do-you-work-in-small-chunks-check-in-after-completing-each-one) and [Do you enable pull requests to ensure code is reviewed?](/enable-pull-requests-to-ensure-code-is-reviewed).
authors:
- noimage: true
  title: David Klein
