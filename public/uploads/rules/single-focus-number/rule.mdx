...
<imageEmbed
  ...
  captionText={"Good Example - One number at the top right sums up the whole report in a single number"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Another good example"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"OK Example - This one showsthe number without the KPI... styill useful but not quite as good"}
