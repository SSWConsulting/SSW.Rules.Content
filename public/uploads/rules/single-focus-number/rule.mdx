...
<imageEmbed
  ...
  figureText={"Good Example - One number at the top right sums up the whole report in a single number"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Another good example"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"OK Example - This one showsthe number without the KPI... styill useful but not quite as good"}
