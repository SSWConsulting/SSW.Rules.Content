...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="One number at the top right sums up the whole report in a single number"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="This one showsthe number without the KPI... styill useful but not quite as good"
