...
<imageEmbed
  ...
  caption={"Bad Example: Rebasing master onto a feature branch can cause project history to become confused."}
...
<imageEmbed
  ...
  caption={"To get it wrong in Visual Studio you would need to change the current branch to master and then choose rebase. While this is possible, the VS team have done a good job making it hard to do the wrong thing"}
...
<imageEmbed
  ...
  caption={"Good Example - Rebase your Feature branch onto Master"}
