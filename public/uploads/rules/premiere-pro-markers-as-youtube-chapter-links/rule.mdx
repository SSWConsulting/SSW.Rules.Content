...
<imageEmbed
  ...
  caption={"Good example - Chapter Links created for a Tech News"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Introduction marker for 00:00"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Markers appear above the timeline"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"It is good practice to save it to an export folder"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"File | Make a copy | Save in your Google Drive"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"CSV file exported from Premiere Pro"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Paste text into cell A1 of this sheet"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Click the second sheet “Youtube Chapter Links”"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Editing the description of a YouTube video"}
