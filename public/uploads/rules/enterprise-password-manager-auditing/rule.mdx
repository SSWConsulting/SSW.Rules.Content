...
<imageEmbed
  ...
  caption={"Good example - Keeper auditing shows exactly who opened what record"}
...
<imageEmbed
  ...
  caption={"First get the UID of the Folder/item for report"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Filter by the Event Type"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Filter by Attributes - Category first"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Filter by Shared Folder / Item UID (Obtained from step 1)"}
