...
created: 2023-10-11 23:12:41.583000+00:00
...
<imageEmbed
  ...
  figureText={"Good example - Keeper auditing shows exactly who opened what record"}
...
<imageEmbed
  ...
  figureText={"First get the UID of the Folder/item for report"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Filter by the Event Type"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Filter by Attributes - Category first"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Filter by Shared Folder / Item UID (Obtained from step 1)"}
