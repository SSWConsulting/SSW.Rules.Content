...
<imageEmbed
  ...
  captionText={"Good example - Keeper auditing shows exactly who opened what record"}
...
<imageEmbed
  ...
  captionText={"First get the UID of the Folder/item for report"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Filter by the Event Type"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Filter by Attributes - Category first"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Filter by Shared Folder / Item UID (Obtained from step 1)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"View the audit log"}
  src="/uploads/rules/enterprise-password-manager-auditing/keeper-good-example-auditreport_1716517805958.png"
/>
