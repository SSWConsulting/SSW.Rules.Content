...
<emailEmbed
  ...
  body={<>
    <mark style="background-color: #FEF08A">Test Please</mark>
...
* Add <mark style="background-color: #FEF08A">'Test Please'</mark> highlighted in yellow to the top of the email body
