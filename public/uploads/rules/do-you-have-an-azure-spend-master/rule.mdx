...
<imageEmbed
  ...
  captionText={"Bad example - Contributor access to the Developers group"}
...
<imageEmbed
  ...
  captionText={"Good example - Reader access to the Developers group"}
