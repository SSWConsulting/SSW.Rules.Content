...
<imageEmbed
  ...
  captionText={"Bad Example - A too specific Contact Detail table"}
...
<imageEmbed
  ...
  captionText={"Good Example - A general Contact Detail table"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - Details of Contact Detail Category table"}
