...
<imageEmbed
  ...
  figureText={"Bad Example - A too specific Contact Detail table"}
...
<imageEmbed
  ...
  figureText={"Good Example - A general Contact Detail table"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - Details of Contact Detail Category table"}
