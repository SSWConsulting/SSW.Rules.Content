...
<imageEmbed
  ...
  caption={"Bad Example - A too specific Contact Detail table"}
...
<imageEmbed
  ...
  caption={"Good Example - A general Contact Detail table"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - Details of Contact Detail Category table"}
