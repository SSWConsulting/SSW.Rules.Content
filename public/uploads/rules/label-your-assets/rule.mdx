...
<imageEmbed
  ...
  figureText={"Bad example - Asset Tracking on spreadsheets is bad"}
...
<imageEmbed
  ...
  figureText={"Good example - A professional label printed with the important asset info e.g. ID, name and serial number"}
