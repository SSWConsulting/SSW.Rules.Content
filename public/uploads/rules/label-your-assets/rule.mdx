...
created: 2021-10-15T00:43:02.000Z
...
<imageEmbed
  ...
  captionText={"Bad example - Asset Tracking on spreadsheets is bad"}
...
<imageEmbed
  ...
  captionText={"Good example - A professional label printed with the important asset info e.g. ID, name and serial number"}
