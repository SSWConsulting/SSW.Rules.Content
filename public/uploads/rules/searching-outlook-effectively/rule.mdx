...
<imageEmbed
  ...
  figureText={"There are several scoping options available"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Outlook Options for Search, have been changed to “Current Folder”"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Easily find your recent searches"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Outlook has a lot of meta data filtering options"}
