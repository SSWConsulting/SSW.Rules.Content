...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"There are several scoping options available"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Outlook Options for Search, have been changed to “Current Folder”"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Easily find your recent searches"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Outlook has a lot of meta data filtering options"}
