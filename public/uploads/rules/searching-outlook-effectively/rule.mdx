...
created: 2022-03-10T00:19:16.000Z
...
<youtubeEmbed url="https://www.youtube.com/embed/g8gVTw3rHqE" description={"Video: Searching Outlook Effectively with [Ulysses Maclaren](https://ssw.com.au/people/ulysses-maclaren/) (9 min)"} />
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"There are several scoping options available"}
  src="/uploads/rules/searching-outlook-effectively/search-scope.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Outlook Options for Search, have been changed to “Current Folder”"}
  src="/uploads/rules/searching-outlook-effectively/outlook-search-options.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Easily find your recent searches"}
  src="/uploads/rules/searching-outlook-effectively/outlook-recent-search.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Outlook has a lot of meta data filtering options"}
  src="/uploads/rules/searching-outlook-effectively/email-metadata.png"
/>
