...
seoDescription: Identify and troubleshoot SQL Server performance issues by monitoring
  CPU, memory, and I/O pressures using Task Manager and Perfmon.
...
[What to do about CPU pressure](https://www.ssw.com.au/rules/sql-server-cpu-pressure)
...
Otherwise: [What to do about memory pressure](https://www.ssw.com.au/rules/sql-server-memory-pressure)
...
If not then try [What to do about IO pressure](https://www.ssw.com.au/rules/sql-server-io-pressure)