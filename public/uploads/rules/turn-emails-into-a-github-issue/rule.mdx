...
created: 2021-11-03 22:45:01.584000+00:00
...
isArchived: false
lastUpdated: 2021-11-03 22:45:01.584000+00:00
...
<imageEmbed
  ...
  figureText={"Power Automate | Connectors | Github"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Configure Flow connectors to create a new Github Issue from Outlook"}
...
<imageEmbed
  ...
  figureText={"Good Example - Github issue created from Outlook using Flow connectors"}
...
<imageEmbed
  ...
  figureText={"Bad Example - Github issue created using Flow - inline attachment shows up as junk characters"}
