...
<imageEmbed
  ...
  captionText={"Power Automate | Connectors | Github"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Configure Flow connectors to create a new Github Issue from Outlook"}
...
<imageEmbed
  ...
  captionText={"Good Example - Github issue created from Outlook using Flow connectors"}
...
<imageEmbed
  ...
  captionText={"Bad Example - Github issue created using Flow - inline attachment shows up as junk characters"}
