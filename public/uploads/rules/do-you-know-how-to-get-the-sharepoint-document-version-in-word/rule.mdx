...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example](/uploads/rules/do-you-know-how-to-get-the-sharepoint-document-version-in-word/BadVersioning.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example](/uploads/rules/do-you-know-how-to-get-the-sharepoint-document-version-in-word/GoodVersioning.png)',
  shouldDisplay: true
} } />
