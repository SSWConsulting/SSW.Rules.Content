...
For example, take [smh.com.au](https://www.smh.com.au), a leading Australian news website. If you search on the keywords 'Australia' and 'news' you won't find it on the first page, but if you add 'Sydney' (a word from the company name) then you're number 1...
