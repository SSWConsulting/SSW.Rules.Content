...
<imageEmbed
  ...
  figureText={"#1 Create an appsettings.Local.json file. Set this to be ignored by your source code control system"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"#2 Add code to apply this configuration file in Program.cs"}
