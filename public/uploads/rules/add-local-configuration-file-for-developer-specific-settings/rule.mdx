...
isArchived: false
lastUpdated: 2019-01-11 19:54:58+00:00
...
<imageEmbed
  ...
  captionText={"#1 Create an appsettings.Local.json file. Set this to be ignored by your source code control system"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"#2 Add code to apply this configuration file in Program.cs"}
