...
<imageEmbed
  ...
  captionText={"Bad example - Form is too large to fit inside 1024x768px resolution"}
...
<imageEmbed
  ...
  captionText={"Good example - Form fits inside any screen resolution"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"The Surface screen allows you to place two apps side by side"}
