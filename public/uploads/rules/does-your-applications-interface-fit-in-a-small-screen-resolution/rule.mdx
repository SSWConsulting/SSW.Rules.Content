...
<imageEmbed
  ...
  caption={"Bad example - Form is too large to fit inside 1024x768px resolution"}
...
<imageEmbed
  ...
  caption={"Good example - Form fits inside any screen resolution"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"The Surface screen allows you to place two apps side by side"}
