...
lastUpdated: 2026-08-19T23:50:25.890Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Github project without any documentation or instructions" src="/uploads/rules/awesome-documentation/documentation__level2__bad-example-gh.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Azure DevOps project without any documentation or instructions" src="/uploads/rules/awesome-documentation/azuredevops-bad.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="ok" figure="Github project with README instructions on how to compile and run the project (but still has a TODO)" src="/uploads/rules/awesome-documentation/documentation__level2__good-example-1-gh.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Azure DevOps project with README instructions on how to compile and run the project" src="/uploads/rules/awesome-documentation/azuredevops-good.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Github project with Wiki instructions for Product Owners, stakeholders, or public consumption (Source: https://github.com/christoment/Northwind/wiki)" src="/uploads/rules/awesome-documentation/documentation__level2__good-example-2-gh.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Azure DevOps project with Wiki instructions for Product Owners, stakeholders, or public consumption" src="/uploads/rules/awesome-documentation/azuredevops-wiki-good.png" />

**Tip:** Use your documentation for onboarding developers

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="No documentation, go and sit with another developer" src="/uploads/rules/awesome-documentation/sit-dev-bad.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Developer onboarding can be self-guided by good documentation, and offers a structure for feedback and improvement if the developer hits any issues" src="/uploads/rules/awesome-documentation/documentation__level2__onboarding-pbi-3.png" />
