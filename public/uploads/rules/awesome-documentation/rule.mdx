...
lastUpdated: 2026-08-19T06:00:02.010Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="The dinosaur’s method of documentation" src="/uploads/rules/awesome-documentation/old-documentation.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Documentation can take the form of Sequence Diagrams" src="/uploads/rules/awesome-documentation/enterprisearchitect1.jpg" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Use Case Diagrams are even worse!" src="/uploads/rules/awesome-documentation/EnterpriseArchitectUseCases.jpg" />
