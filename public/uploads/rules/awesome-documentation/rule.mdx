...
lastUpdated: 2026-08-20T02:21:11.749Z
...
Good documentation helps teams understand, maintain, and evolve a solution without creating unnecessary overhead. The best documentation is useful, lightweight, easy to maintain, and evolves alongside the solution.

<endIntro />

## Old school

<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="bad" figure="The dinosaur’s method of documentation" src="/uploads/rules/awesome-documentation/old-documentation.png" />
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="bad" figure="Documentation can take the form of Sequence Diagrams" src="/uploads/rules/awesome-documentation/enterprisearchitect1.jpg" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="bad" figure="Use Case Diagrams are even worse!" src="/uploads/rules/awesome-documentation/EnterpriseArchitectUseCases.jpg" />
...
### In the repository (for developers) - The 8 important documents
...
### Publishing your documentation with GitHub Pages

When you want to make your documentation visible to a wider audience, for example with an open source project, consider publishing your documentation using [GitHub Pages](https://pages.github.com)

<boxEmbed
  body={<>
    **Tip:** Check out this great example [SSW Clean Architecture Template](https://sswconsulting.github.io/SSW.CleanArchitecture/)
  </>}
  figurePrefix="none"
  figure=""
  style="tips"
...
<boxEmbed
  body={<>
    If you do not have at least a GitHub Team subscription, you cannot use GitHub Pages for private repos
  </>}
  figurePrefix=""
  figure=""
  style="warning"
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="bad" figure="Github project without any documentation or instructions" src="/uploads/rules/awesome-documentation/documentation__level2__bad-example-gh.png" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="bad" figure="Azure DevOps project without any documentation or instructions" src="/uploads/rules/awesome-documentation/azuredevops-bad.png" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="ok" figure="Github project with README instructions on how to compile and run the project (but still has a TODO)" src="/uploads/rules/awesome-documentation/documentation__level2__good-example-1-gh.png" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Azure DevOps project with README instructions on how to compile and run the project" src="/uploads/rules/awesome-documentation/azuredevops-good.png" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Github project with Wiki instructions for Product Owners, stakeholders, or public consumption (Source: https://github.com/christoment/Northwind/wiki)" src="/uploads/rules/awesome-documentation/documentation__level2__good-example-2-gh.png" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Azure DevOps project with Wiki instructions for Product Owners, stakeholders, or public consumption" src="/uploads/rules/awesome-documentation/azuredevops-wiki-good.png" />
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="bad" figure="No documentation, go and sit with another developer" src="/uploads/rules/awesome-documentation/sit-dev-bad.png" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Developer onboarding can be self-guided by good documentation, and offers a structure for feedback and improvement if the developer hits any issues" src="/uploads/rules/awesome-documentation/documentation__level2__onboarding-pbi-3.png" />
...
* A. One way is quick but messy - it will make further changes harder in the future (i.e. quick and dirty)
* B. The other way is cleaner – it will make changes easier to do in the future but will take longer to put in place
