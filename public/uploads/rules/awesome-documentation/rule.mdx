...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The dinosaur’s method of documentation"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Use Case Diagrams are even worse!"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Github project without any documentation or instructions"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Azure DevOps project without any documentation or instructions"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="Github project with README instructions on how to compile and run the project (but still has a TODO)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Azure DevOps project with README instructions on how to compile and run the project"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Github project with Wiki instructions for Product Owners, stakeholders, or public consumption (Source: https://github.com/christoment/Northwind/wiki)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Azure DevOps project with Wiki instructions for Product Owners, stakeholders, or public consumption"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="No documentation, go and sit with another developer"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Developer onboarding can be self-guided by good documentation, and offers a structure for feedback and improvement if the developer hits any issues"
