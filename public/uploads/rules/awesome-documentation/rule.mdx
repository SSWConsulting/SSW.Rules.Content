...
<imageEmbed
  ...
  caption={"Bad example - The dinosaur’s method of documentation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Documentation can take the form of Sequence Diagrams"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Use Case Diagrams are even worse!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Github project without any documentation or instructions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Azure DevOps project without any documentation or instructions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"OK example - Github project with README instructions on how to compile and run the project (but still has a TODO)"}
...
<imageEmbed
  ...
  caption={"Good example - Azure DevOps project with README instructions on how to compile and run the project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Github project with Wiki instructions for Product Owners, stakeholders, or public consumption (Source: https://github.com/christoment/Northwind/wiki)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Azure DevOps project with Wiki instructions for Product Owners, stakeholders, or public consumption"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - No documentation, go and sit with another developer"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Developer onboarding can be self-guided by good documentation, and offers a structure for feedback and improvement if the developer hits any issues"}
