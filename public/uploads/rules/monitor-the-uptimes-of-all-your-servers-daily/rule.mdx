...
isArchived: false
lastUpdated: 2021-02-27 02:42:14.350000+00:00
...
<imageEmbed
  ...
  figureText={"Good example - WhatsUp Gold - Green indicates servers are healthy"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"OK Example - Editing WUG's email action is simple, but HTML skills are necessary to make a good looking report"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Email - Nicely branded email, red indicates servers are not healthy"}
