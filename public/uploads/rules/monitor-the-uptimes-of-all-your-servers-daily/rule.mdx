...
<imageEmbed
  ...
  captionText={"Good example - WhatsUp Gold - Green indicates servers are healthy"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"OK Example - Editing WUG's email action is simple, but HTML skills are necessary to make a good looking report"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Email - Nicely branded email, red indicates servers are not healthy"}
