...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="WhatsUp Gold - Green indicates servers are healthy"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="Editing WUG's email action is simple, but HTML skills are necessary to make a good looking report"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Email - Nicely branded email, red indicates servers are not healthy"
