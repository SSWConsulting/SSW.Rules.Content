...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example: Using regular CSS, you repeat yourself a lot](RulesLESS - css.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example: Using LESS, we can structure our CSS better](RulesLESS - less.png)',
  shouldDisplay: true
} } />
