...
<imageEmbed
  ...
  caption={"Bad Example - The progress bar does not indicate completed nor next steps"}
...
<imageEmbed
  ...
  caption={"Good Example - This wizard form shows all steps and indicates where the user is up to"}
