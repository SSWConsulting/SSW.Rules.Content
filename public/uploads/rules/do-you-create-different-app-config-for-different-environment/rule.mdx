...
![](/uploads/rules/do-you-create-different-app-config-for-different-environment/AppConfigBad.jpg)

<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: 'Figure: Bad Example - Only 1 App.config provided',
  shouldDisplay: true
} } />


![](/uploads/rules/do-you-create-different-app-config-for-different-environment/App.config.jpg)
