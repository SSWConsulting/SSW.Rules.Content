...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Asking a screening question is a good way to separate real people with a genuine interest from those who just want to spam the group"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"an example of a suspicious profile"}
