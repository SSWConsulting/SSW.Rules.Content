...
<imageEmbed
  ...
  captionText={"Infrastructure Health Checks"}
...
<imageEmbed
  ...
  captionText={"Good example - AspNetCore.HealthChecks.UI gives you a healthcheck dashboard OOTB"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - SSWTimePro has a Health Check page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Tina.io has a Health Check page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Performing a health check on an azure app service"}
...
<imageEmbed
  ...
  captionText={"Bad example – The user is given the chance to interact with a feature that is currently unavailable"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – The user is pre-emptively shown a message that shows this feature is currently unavailable"}
