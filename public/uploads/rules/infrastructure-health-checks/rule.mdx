...
<imageEmbed
  ...
  figureText={"Infrastructure Health Checks"}
...
<imageEmbed
  ...
  figureText={"Good example - AspNetCore.HealthChecks.UI gives you a healthcheck dashboard OOTB"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - SSWTimePro has a Health Check page"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Tina.io has a Health Check page"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Performing a health check on an azure app service"}
...
<imageEmbed
  ...
  figureText={"Bad example – The user is given the chance to interact with a feature that is currently unavailable"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – The user is pre-emptively shown a message that shows this feature is currently unavailable"}
