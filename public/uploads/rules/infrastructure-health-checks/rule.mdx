...
- author: luke-cook
- author: ben-neoh
- author: toby-churches
created: 2020-03-12 20:57:37+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="AspNetCore.HealthChecks.UI gives you a healthcheck dashboard OOTB"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="SSWTimePro has a Health Check page"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Tina.io has a Health Check page"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Performing a health check on an azure app service"
...
* Use caching and timeout strategies. To avoid excessive load, health checks can timeout gracefully and cache results to prevent redundant checks under high traffic. 

See more details on [Microsoft's documentation - Aspire | Fundamentals | Health checks](https://aspire.dev/fundamentals/health-checks/)
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The user is given the chance to interact with a feature that is currently unavailable"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The user is pre-emptively shown a message that shows this feature is currently unavailable"
