...
<imageEmbed
  ...
  caption={"Install necessary .NET 8 runtimes"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The differences between the legacy csproj file and the new SDK csproj file"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Bad and good examples when targeting multiple target frameworks"}
