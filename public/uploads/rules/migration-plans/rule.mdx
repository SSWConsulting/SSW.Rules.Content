...
<imageEmbed
  ...
  figureText={"Install necessary .NET 8 runtimes"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The differences between the legacy csproj file and the new SDK csproj file"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Bad and good examples when targeting multiple target frameworks"}
