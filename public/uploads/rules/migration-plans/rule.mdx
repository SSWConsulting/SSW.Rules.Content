...
<imageEmbed
  ...
  captionText={"Install necessary .NET 8 runtimes"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The differences between the legacy csproj file and the new SDK csproj file"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Bad and good examples when targeting multiple target frameworks"}
