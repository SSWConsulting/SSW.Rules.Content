...
seoDescription: Create a migration plan by targeting multiple target frameworks (TFMs)
  to avoid introducing breaking changes while migrating from .NET Framework to .NET.
created: 2023-09-06 23:08:53.979000+00:00
createdBy: Kaha Mason
createdByEmail: kahamason@ssw.com.au
lastUpdated: 2026-01-29 03:10:33.748000+00:00
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Install necessary .NET 10 runtimes" src="/uploads/rules/migration-plans/related-runtimes-net10.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="The differences when migrating from legacy csproj to the new SDK style" src="/uploads/rules/migration-plans/legacy-to-sdk.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Multi-targeting .NET Framework and .NET 10" src="/uploads/rules/migration-plans/multi-targeting-frameworks.png" />
...
* [Do you know the different ways to modernize your application?](https://www.ssw.com.au/rules/modernize-your-app)
