...
<boxEmbed
  ...
  caption={"Bad example – The client finds out by surprise and feels left out of the loop"}
/>
...
<boxEmbed
  ...
  caption={"Good example – Client feels respected and part of the transition process"}
/>
