...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="While this name suggests that it might have something to do with orders, it doesn’t clarify how it interacts with them. Creating orders? Updating them? Processing payments? All of the above?"
/>
...
Using **`ShippingOrderHandler`** or **`OrderShipmentService`** specifically handles only one aspect of the order - sending for shipment
  ...
  figurePrefix="good"
  figure="This name directly reflects its purpose, making it immediately clear what the class is responsible for"
/>
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="The name 'data' could mean just about anything"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Immediately tells us the scope and purpose of the class"
/>