...
<boxEmbed
  ...
  caption={"Bad example - While this name suggests that it might have something to do with orders, it doesn’t clarify how it interacts with them. Creating orders? Updating them? Processing payments? All of the above?"}
/>
...
Using **`ShippingOrderHandler`** or **`OrderShipmentService`** specifically handles only one aspect of the order - sending for shipment
  ...
  caption={"Good example - This name directly reflects its purpose, making it immediately clear what the class is responsible for"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - The name 'data' could mean just about anything"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Immediately tells us the scope and purpose of the class"}
/>