...
<imageEmbed
  ...
  caption={"Bad example - Keep your Data Roaming on"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Exorbitant Telstra bills upon returning home due to roaming data usage of 120 GB"}
...
<imageEmbed
  ...
  caption={"Good example - Paying $129 AUD for 200 GB of data on a travel SIM to Europe"}
