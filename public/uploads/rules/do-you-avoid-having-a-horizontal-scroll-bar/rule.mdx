...
<imageEmbed
  ...
  captionText={"Bad Example - Using pre code tags and having lines exceed screen size"}
...
<imageEmbed
  ...
  captionText={"Good Example - Using pre code tags and having lines not exceed screen size"}
