...
<imageEmbed
  ...
  caption={"Bad Example - Using pre code tags and having lines exceed screen size"}
...
<imageEmbed
  ...
  caption={"Good Example - Using pre code tags and having lines not exceed screen size"}
