...
<imageEmbed
  ...
  caption={"Choosing a group type in On-Premises Active Directory"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Choosing a group type in Microsoft 365"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Shared mailboxes are created in their own section under the Teams & groups heading"}
