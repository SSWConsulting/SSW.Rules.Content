...
<imageEmbed
  ...
  figureText={"Choosing a group type in On-Premises Active Directory"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Choosing a group type in Microsoft 365"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Shared mailboxes are created in their own section under the Teams & groups heading"}
