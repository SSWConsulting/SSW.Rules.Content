...
This will create a new .NET 10 project _and_ include YARP. For functionalities that have not yet been migrated, YARP will redirect them to the .NET Framework web application.
