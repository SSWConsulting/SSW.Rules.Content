...
isArchived: false
lastUpdated: 2015-05-01 14:52:53+00:00
lastUpdatedBy: Daniel Smon
lastUpdatedByEmail: danielsmon@ssw.com.au
redirects: []
...
<imageEmbed
  ...
  figureText={"Bad example - No '-All-' option so the user cannot select all data"}
...
<imageEmbed
  ...
  figureText={"Good example - Having an '-All-' option gives a user a chance to select all data"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - '-All Stores-' isn't needed"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Keep it as a simple '-All-'"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Keeping it simple makes it easy to spot (that there is no filter) when you have multiple fields."}
