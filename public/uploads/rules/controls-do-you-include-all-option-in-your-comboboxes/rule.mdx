...
<imageEmbed
  ...
  captionText={"Bad example - No '-All-' option so the user cannot select all data"}
...
<imageEmbed
  ...
  captionText={"Good example - Having an '-All-' option gives a user a chance to select all data"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - '-All Stores-' isn't needed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Keep it as a simple '-All-'"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Keeping it simple makes it easy to spot (that there is no filter) when you have multiple fields."}
