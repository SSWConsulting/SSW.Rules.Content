...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="No '-All-' option so the user cannot select all data"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Having an '-All-' option gives a user a chance to select all data"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="'-All Stores-' isn't needed"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Keep it as a simple '-All-'"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Keeping it simple makes it easy to spot (that there is no filter) when you have multiple fields."
