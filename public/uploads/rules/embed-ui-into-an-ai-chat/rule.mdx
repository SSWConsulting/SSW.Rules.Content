...
<imageEmbed
  ...
  captionText={"OK example - using only text-based responses can make the conversation less engaging and efficient"}
...
<imageEmbed
  ...
  captionText={"Good example - embedding visual UI elements like images can make the conversation much more engaging"}
