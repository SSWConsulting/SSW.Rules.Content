...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="Using only text-based responses can make the conversation less engaging and efficient"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Embedding visual UI elements like images can make the conversation much more engaging"
