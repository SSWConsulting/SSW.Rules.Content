...
title: Do you always share the source files with your video editor?
categories:
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Only the exported video file (.mp4) is shared"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Clipchamp - The 2 video files are shared"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Camtasia - The source file and project file are shared"
