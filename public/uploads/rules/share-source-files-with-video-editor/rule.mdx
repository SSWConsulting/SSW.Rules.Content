...
<imageEmbed
  ...
  caption={"Bad example - Only the exported video file (.mp4) is shared"}
...
<imageEmbed
  ...
  caption={"Good example - Clipchamp - The 2 video files are shared"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Camtasia - The source file and project file are shared"}
