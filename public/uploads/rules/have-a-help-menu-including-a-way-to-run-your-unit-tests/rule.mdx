...
<imageEmbed
  ...
  figureText={"Standard Help menu should give you an option to Run Unit Tests to check the users' environment (Good)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Obviously the red indicates that there is a problem with a Unit Test (Good)"}
