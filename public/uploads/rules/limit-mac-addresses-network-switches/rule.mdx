...
<imageEmbed
  alt="Network switch port with continuous learn mode enabled, allowing unlimited MAC addresses"
  size="large"
  showBorder={false}
  figurePrefix="bad"
...
<imageEmbed
  alt="Network switch port configured with MAC address restrictions and security settings"
  size="large"
  showBorder={false}
  figurePrefix="good"
