...
created: 2024-12-06T10:52:05-03:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="An access port with continuous learn mode, meaning any device can connect to it and no security traps will be raised"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A switch port accepts only predefined MAC addresses, or is limited on the number of MAC addresses it can learn. Unauthorized devices are immediately blocked, safeguarding the network’s perimeter"
