...
seoDescription: Data validation and date range constraints ensure valid dates in your
  SQL Server database, preventing nonsensical dates from being entered.
