...
lastUpdated: 2026-05-07T02:27:09.718Z
lastUpdatedBy: Hark
...
<boxEmbed
  body={<>
    **Docs:** [https://playwright.dev/docs/test-agents](https://playwright.dev/docs/test-agents)
    ...
    **Video walkthrough: **[**Playwright v1.56: From MCP to Playwright Agents (6 min)**](https://www.youtube.com/watch?v=_AifxZGxwuk)** **
  </>}
  figurePrefix="none"
  figure=""
  style="tips"
...
<boxEmbed
  body={<>
    ...
    *   **CLI:** stateless scripted automation (CI runs, scheduled tests)
