...
lastUpdated: 2026-05-13T07:46:48.565Z
...
<youtubeEmbed url="https://www.youtube.com/watch?v=F5Sv0mpN3-o" description="Video: Playwright MCP vs. CLI: Stop Wasting Your AI Context! | Hark Singh | SSW Rules (6 min)" />
...
<boxEmbed
  body={<>
    These Playwright Test Agents are custom agents, and you can call them via the CLI definition of your AI of choice (e.g. using `@AGENT_NAME` when working with Claude)
  </>}
  figurePrefix="none"
  figure=""
  style="tips"
