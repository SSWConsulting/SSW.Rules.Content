...
lastUpdated: 2026-05-13T07:15:49.671Z
...
<boxEmbed
  body={<>
    These Playwright Test Agents are custom agents, and you can call them via the CLI definition of your AI of choice (e.g. using `@ &#123;&#123; AGENT NAME &#125;&#125;` when working with Claude)
  </>}
  figurePrefix="none"
  figure=""
  style="tips"
