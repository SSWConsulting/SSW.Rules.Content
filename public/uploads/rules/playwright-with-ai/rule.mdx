...
lastUpdated: 2026-05-14T08:03:58.402Z
...
<imageEmbed
  alt="Venn diagram comparing the tools provided by Playwright MCP and Playwright Test MCP, with shared browser automation tools in the overlap"
  size="large"
  showBorder={false}
  figurePrefix="none"
  ...
  src="/uploads/rules/playwright-with-ai/playwright-mcp-test-mcp-venn.png"
/>
