...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="bad"
  figure="A screenshot of the Azure resources used helps, but doesn't show data flows or dependencies"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="bad"
  figure="The .NET dependency diagram shows code dependencies, but not the application's architecture"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="ok"
  figure="Shows the technologies and data flows (from the data --&gt; Azure Data Factory --&gt; Azure Databricks --&gt; Power BI). This gives an overview of the whole application in one diagram"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="SugarLearning (an Angular + .NET project) - data flows from top to bottom, with exceptions (e.g. Application Insights / Raygun, not part of the main data flow) perpendicular to the primary direction"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="SSW Rewards (Xamarin with Entra ID B2C) - Consistent styling is used. E.g. as well as all the icons and typography being consistent, you can see that data is a solid line and auth traffic is a dotted line"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="Auctions (a Blazor + .NET + Cosmos DB project) - architecture diagram created within VS Code and checked into the repo in the same commit as the relevant code changes. Blazor UI layer encapsulated in thematic color"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="SSW People (a Static Site - Gatsby and React with Dynamics 365 and SharePoint Online) - you can just as easily create colorful, engaging diagrams suitable for all of your project stakeholders"
...
## Tip 11: Use Azure Architecture Center
