...
<imageEmbed
  ...
  captionText={"Bad example - A screenshot of the Azure resources used helps, but doesn't show data flows or dependencies"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="badExample"
  captionText={"Bad example - The .NET dependency diagram shows code dependencies, but not the application's architecture"}
...
<imageEmbed
  ...
  captionText={"OK example - Shows the technologies and data flows (from the data --&gt; Azure Data Factory --&gt; Azure Databricks --&gt; Power BI). This gives an overview of the whole application in one diagram"}
...
<imageEmbed
  ...
  captionText={"Good example - SugarLearning (an Angular + .NET project) - data flows from top to bottom, with exceptions (e.g. Application Insights / Raygun, not part of the main data flow) perpendicular to the primary direction"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Good example - SSW Rewards (Xamarin with Entra ID B2C) - Consistent styling is used. E.g. as well as all the icons and typography being consistent, you can see that data is a solid line and auth traffic is a dotted line"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="okExample"
  captionText={"SSW Rewards - Start out with a hand-drawn sketch if that's easier for you, but don't consider this your final architecture diagram"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Better example - SSW Rewards - The same sketch but captured with Office Lens. How much clearer and more vibrant is this!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"When SSW developers were surveyed, draw.io was the clear winner (see green) for building architecture diagrams"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Better example - TimePro (an Angular &plus; .NET project with Hangfire) - You can create diagrams quickly and easily with draw.io that still look very professional. This one is in the style of a technical document"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Great example - Auctions (a Blazor + .NET + Cosmos DB project) - draw.io integrated directly into VS Code"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Good example - Auctions (a Blazor + .NET + Cosmos DB project) - architecture diagram created within VS Code and checked into the repo in the same commit as the relevant code changes. Blazor UI layer encapsulated in thematic color"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Good example - SSW People (a Static Site - Gatsby and React with Dynamics 365 and SharePoint Online) - you can just as easily create colorful, engaging diagrams suitable for all of your project stakeholders"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"An Azure Architecture Diagram created in Miro"}
