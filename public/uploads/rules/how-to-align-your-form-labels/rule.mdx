...
<imageEmbed
  ...
  figureText={"Bad example - Inconsistent spacing between labels and input fields"}
...
<imageEmbed
  ...
  figureText={"OK example - If aligning labels inline is necessary, opt for right-aligned labels"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="okExample"
  figureText={"OK example - Top-aligned labels are space-efficient, making it adaptable to all resolutions"}
...
<imageEmbed
  ...
  figureText={"Good example - Using adaptive placeholders"}
