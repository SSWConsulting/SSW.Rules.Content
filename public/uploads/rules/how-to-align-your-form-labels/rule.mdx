...
<imageEmbed
  ...
  caption={"Bad example - Inconsistent spacing between labels and input fields"}
...
<imageEmbed
  ...
  caption={"OK example - If aligning labels inline is necessary, opt for right-aligned labels"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  caption={"OK example - Top-aligned labels are space-efficient, making it adaptable to all resolutions"}
...
<imageEmbed
  ...
  caption={"Good example - Using adaptive placeholders"}
