...
isArchived: false
lastUpdated: 2024-12-19 10:32:23+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - Inconsistent spacing between labels and input fields"}
...
<imageEmbed
  ...
  captionText={"OK example - If aligning labels inline is necessary, opt for right-aligned labels"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  captionText={"OK example - Top-aligned labels are space-efficient, making it adaptable to all resolutions"}
...
<imageEmbed
  ...
  captionText={"Good example - Using adaptive placeholders"}
