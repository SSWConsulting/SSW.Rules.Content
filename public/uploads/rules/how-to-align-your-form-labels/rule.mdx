...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Inconsistent spacing between labels and input fields"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="If aligning labels inline is necessary, opt for right-aligned labels"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="Top-aligned labels are space-efficient, making it adaptable to all resolutions"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using adaptive placeholders"
