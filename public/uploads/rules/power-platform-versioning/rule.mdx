...
<boxEmbed
  ...
  figureText={"Bad example - Bob didn't use a version number and it came back to bite him"}
/>
...
<boxEmbed
  ...
  figureText={"Good example - Alice versioned her solution nicely and she was able to resolve reported issues quickly and easily"}
/>
