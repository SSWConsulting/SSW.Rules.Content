...
<imageEmbed
  ...
  captionText={"Bad example - SQL Report Manager (which requires Visual Studio and TFS if you want source control)"}
...
<imageEmbed
  ...
  captionText={"Good example - SharePoint Integration (you get nice source control via SharePoint and you can use the nice Report Builder 3)"}
