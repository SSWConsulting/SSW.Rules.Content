...
created: 2023-08-17 21:44:23+00:00
...
seoDescription: Automating tests effectively requires evaluating whether a test is
  a good candidate for automation. Consider factors such as scale, subjectivity, and
  value to determine if a test should be automated.
...
<imageEmbed
  ...
  captionText={"Making wise decisions about what to automate can prevent you from wasting valuable time automating less valuable tests"}
...
**Reason:** In this case, the computer won't be able to easily judge whether the audio is clear or unclear.
  ...
  captionText={"Bad example - Testing video playback"}
/>
...
**Reason:** The test is a maths problem which is easy for a computer to evaluate.
  ...
  captionText={"Good example - Testing a GST calculation"}
/>
...
**Reason:** It's easy to evaluate the expected output with objective criteria.
  ...
  captionStyle="goodExample"
  captionText={"Good example - Testing a save button"}
/>
