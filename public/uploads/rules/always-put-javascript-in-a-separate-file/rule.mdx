...
<imageEmbed
  ...
  captionText={"Bad Code - Using Inline JavaScript"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad Code - On PostBack Line numbers are changed for Inline JavaScript"}
...
<imageEmbed
  ...
  captionText={"Good Code - Using JavaScript on Separate file"}
