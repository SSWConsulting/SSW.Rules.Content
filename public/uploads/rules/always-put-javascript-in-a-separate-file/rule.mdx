...
<imageEmbed
  ...
  caption={"Bad Code - Using Inline JavaScript"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad Code - On PostBack Line numbers are changed for Inline JavaScript"}
...
<imageEmbed
  ...
  caption={"Good Code - Using JavaScript on Separate file"}
