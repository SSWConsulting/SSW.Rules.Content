...
<imageEmbed
  ...
  caption={"Example of Tax Invoices"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Example of Eftpos Payment Receipt"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"✅ Good example - Tax invoice submitted with Eftpos receipt together"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"❌ Bad example - An Eftpos receipt doesn't tell you details on its own, and can't be used for tax deductions."}
