...
<imageEmbed
  ...
  figureText={"Example of Tax Invoices"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example of Eftpos Payment Receipt"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"✅ Good example - Tax invoice submitted with Eftpos receipt together"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"❌ Bad example - An Eftpos receipt doesn't tell you details on its own, and can't be used for tax deductions."}
