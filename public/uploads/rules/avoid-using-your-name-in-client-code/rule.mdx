...
<boxEmbed
  ...
  caption={"Bad example - Naming client IP after yourself or your company is not cool"}
/>
...
<boxEmbed
  ...
  caption={"Good example - Naming client IP with the client's branding is better"}
/>
