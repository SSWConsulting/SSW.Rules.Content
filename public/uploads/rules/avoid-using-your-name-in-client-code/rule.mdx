...
<boxEmbed
  ...
  captionText={"Bad example - Naming client IP after yourself or your company is not cool"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - Naming client IP with the client's branding is better"}
/>
