...
<imageEmbed
  ...
  captionText={"Bad example - Attaching documents to emails when sending internally"}
...
<imageEmbed
  ...
  captionText={"Good example - Sharing documents in SharePoint so the team can access and work on the same document"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example – Added the file as a link for external users. This requires adding them as guests to Teams, or having to make the file an anonymous link"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – Added file as an attachment for external users"}
