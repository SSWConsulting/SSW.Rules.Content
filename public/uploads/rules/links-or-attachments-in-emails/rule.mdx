...
created: 2009-04-08 09:35:54+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Attaching documents to emails when sending internally"}
...
<imageEmbed
  ...
  figureText={"Good example - Sharing documents in SharePoint so the team can access and work on the same document"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – Added the file as a link for external users. This requires adding them as guests to Teams, or having to make the file an anonymous link"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – Added file as an attachment for external users"}
