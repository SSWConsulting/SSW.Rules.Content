...
created: 2023-09-20T16:44:00.000Z
guid: 41304829-c730-411c-b725-016882082231
lastUpdated: 2023-10-05T22:26:02.000Z
...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: 'Figure: Bad Example - This prompt doesn\'t engage the LLM in a Reflexion loop and misses the opportunity for iterative improvement',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: 'Figure: Good Example - This prompt initiates a Reflexion loop by asking the LLM to evaluate and critique its output',
  shouldDisplay: true
} } />
...
<imageEmbed
  ...
  figureEmbed={{
    preset: "default",
    figure: 'GPT-4 was found to be 30% more accurate on coding tests when asked to critique itself in self-reflective loops',
    shouldDisplay: true
  }}
  src="/uploads/rules/reflexion/reflexion-figure.png"
/>
