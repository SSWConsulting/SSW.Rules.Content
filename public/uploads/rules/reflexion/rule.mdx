...
<boxEmbed
  ...
  figurePrefix="none"
  figure="Why 'Reflexion' is a proper noun"
/>

As per the [MIT, Princeton, and Northeastern research](https://arxiv.org/pdf/2303.11366.pdf).
...
See more on [Do you ask for pros and cons and a rating when seeking advice or comparing options?](https://www.ssw.com.au/rules/pros-and-cons-and-ratings/)

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="GPT-4 was found to be 30% more accurate on coding tests when asked to critique itself in self-reflective loops" src="/uploads/rules/reflexion/reflexion-figure.png" />

See more on [GPT-4 becomes 30% more accurate when asked to critique itself](https://newatlas.com/technology/gpt-4-reflexion/).
