...
created: 2024-03-18T18:04:22.000Z
...
<imageEmbed
  ...
  captionText={".NET ErrorProvider Control with a custom balloon tooltip"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"SSW Extended Provider controls and properties on a TextBox"}
