...
Dave
  ...
  captionText={"**Figure: Better example - run SQL scripts using another package**"}
/>
...
Dave
  ...
  captionStyle="okExample"
  captionText={"**Figure: Better example - run SQL scripts in the application. There is a tool called [SQL Deploy | Reconcile](https://sqldeploy.com/)**"}
/>
...
Dave
  ...
  captionText={"**Figure: Good example - All done as part of the release pipeline**"}
/>