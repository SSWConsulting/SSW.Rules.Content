---
seoDescription: Run write application to run with UAC turn on requires adding App.Manifest
  and setting project settings for WindowsUI using requestedExecutionLevel level="requireAdministrator".
type: rule
