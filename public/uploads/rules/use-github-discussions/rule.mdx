...
<imageEmbed
  ...
  figureText={"SSW Rules | GitHub | Discussions"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"1 of 2 - SSW Rules | GitHub | Discussions - Convert a Discussion to an issue"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"2 of 2 - SSW Rules Content Discussion Converted To Issue"}
...
<imageEmbed
  ...
  figureText={"Good example - TinaCMS use GitHub Discussions well"}
