...
<imageEmbed
  ...
  caption={"SSW Rules | GitHub | Discussions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"1 of 2 - SSW Rules | GitHub | Discussions - Convert a Discussion to an issue"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"2 of 2 - SSW Rules Content Discussion Converted To Issue"}
...
<imageEmbed
  ...
  caption={"Good example - TinaCMS use GitHub Discussions well"}
