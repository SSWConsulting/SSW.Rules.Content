...
<imageEmbed
  ...
  captionText={"This is Zendesk UI to help you reply to comments on social media - You can reply, mark as solved, open or pending through the platform"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"This is Hootsuite UI to manage comments (more expensive)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Facebook allows you to hide or report a comment"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"A few options Facebook gives you when reporting a comment"}
