...
<imageEmbed
  ...
  figureText={"This is Zendesk UI to help you reply to comments on social media - You can reply, mark as solved, open or pending through the platform"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"This is Hootsuite UI to manage comments (more expensive)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Facebook allows you to hide or report a comment"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"A few options Facebook gives you when reporting a comment"}
