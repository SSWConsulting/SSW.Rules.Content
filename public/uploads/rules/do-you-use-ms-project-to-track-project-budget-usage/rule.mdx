...
created: 2009-11-27 08:35:41+00:00
createdBy: Lei Xu
createdByEmail: LeiXu@ssw.com.au
guid: d7c9d502-42fd-4d64-ac5a-41ba7ff84efd
isArchived: false
lastUpdated: 2021-07-02 01:38:45.084000+00:00
lastUpdatedBy: Tiago Araújo [SSW]
lastUpdatedByEmail: tiagov8@gmail.com
redirects: []
seoDescription: Do you use MS Project to track project budget usage? Learn how to
  calculate project budget usage in real-time using MS Project and VSTS 2010.
...
<imageEmbed
  ...
  captionText={"Click “Choose Team Project” and choose the project you want to track"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"To select the work items that you want to use you should click on “Get Work Items” and choose a query"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Arrange your work items so we can easily track their progress"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Assign resource rates"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Showing the cost columns"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Create a summary task at the top"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Don’t publish and refresh this summary task"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Total cost is calculated"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Choose “Baseline” and click ok"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Baseline Cost is showing $"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Click the “Refresh” button to update your project file"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Budget usage is calculated"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"set the calculation mode to “Automatic”"}
