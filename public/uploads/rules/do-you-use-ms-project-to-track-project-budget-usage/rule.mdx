...
<imageEmbed
  ...
  caption={"Click “Choose Team Project” and choose the project you want to track"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"To select the work items that you want to use you should click on “Get Work Items” and choose a query"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Arrange your work items so we can easily track their progress"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Showing the cost columns"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Create a summary task at the top"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Don’t publish and refresh this summary task"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Total cost is calculated"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Choose “Baseline” and click ok"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Baseline Cost is showing $"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Click the “Refresh” button to update your project file"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Budget usage is calculated"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"set the calculation mode to “Automatic”"}
