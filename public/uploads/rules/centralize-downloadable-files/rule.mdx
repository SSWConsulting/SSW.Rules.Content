...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Saving the same file in multiple places (cumbersome to update)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Single URL for file, referenced across websites (simplifies updates and generates backlinks)"
