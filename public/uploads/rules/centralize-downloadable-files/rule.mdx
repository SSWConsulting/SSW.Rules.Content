...
created: 2024-01-04 05:00:00+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Saving the same file in multiple places (cumbersome to update)"}
...
<imageEmbed
  ...
  figureText={"Good example - Single URL for file, referenced across websites (simplifies updates and generates backlinks)"}
