...
<imageEmbed
  ...
  captionText={"Bad example - Saving the same file in multiple places (cumbersome to update)"}
...
<imageEmbed
  ...
  captionText={"Good example - Single URL for file, referenced across websites (simplifies updates and generates backlinks)"}
