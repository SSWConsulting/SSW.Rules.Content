...
<imageEmbed
  ...
  figureText={"Who created this file?"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Terminal into your file server using Terminal Services"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Select the folder you want to configure auditing for"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Select Everyone so that anyone who modifies any of the files will be logged"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Select these 4 options (only audit the events you need to audit - there's no need to log when someone opens a file)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Keep your log file to about 250MB - otherwise, your system performance may suffer"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Any creates, deletes and updates now get logged to the Event Log"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Caught an action on remote server and logged it to database"}
