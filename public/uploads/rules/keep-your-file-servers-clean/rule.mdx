...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Terminal into your file server using Terminal Services"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Select the folder you want to configure auditing for"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Select Everyone so that anyone who modifies any of the files will be logged"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Select these 4 options (only audit the events you need to audit - there's no need to log when someone opens a file)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Keep your log file to about 250MB - otherwise, your system performance may suffer"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Any creates, deletes and updates now get logged to the Event Log"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Caught an action on remote server and logged it to database"}
