...
* [PostgreSQL MCP](https://github.com/modelcontextprotocol/servers/tree/main/src/postgres) - Connects AI tools to PostgreSQL databases, enabling them to explore schemas, run read-only queries, and analyze data directly.
* [MySQL MCP](https://github.com/modelcontextprotocol/servers/tree/main/src/mysql) - Provides AI tools with access to MySQL databases for schema exploration, query execution, and data analysis.
