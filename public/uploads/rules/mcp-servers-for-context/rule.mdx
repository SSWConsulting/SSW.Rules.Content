...
lastUpdated: 2026-02-09T06:34:37.100Z
...
<boxEmbed
  body={<>
    When using skills, make sure to do your due diligence in checking skills before using them. Generally avoid avenues such as skill marketplaces unless you are certain there are no malicious prompts within the skills.
  </>}
  figurePrefix="none"
  figure=""
  style="warning"
