...
created: 2009-12-04 08:53:27+00:00
...
redirects: []
seoDescription: Keep clean on imports of project property by removing default imports
  that aren't used frequently in your Dot Net code.
...
<imageEmbed
  ...
  captionText={"Using aliases with the Imports Statement"}
