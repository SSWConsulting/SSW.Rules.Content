...
seoDescription: Handle customer complaints efficiently to retain loyalty and gain
  new customers by following a structured approach that prioritizes understanding
  the issue, isolating the problem, and providing a solution.
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Conference in another person to solve the problem - it's a lot easier than it used to be"}
