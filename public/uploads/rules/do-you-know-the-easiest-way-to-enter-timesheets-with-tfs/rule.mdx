...
<imageEmbed
  ...
  figureText={"Our Office Manager chasing up timesheets"}
...
<imageEmbed
  ...
  figureText={"Project Server 2013 pulls work items from TFS and updates the actual and remaining hours"}
