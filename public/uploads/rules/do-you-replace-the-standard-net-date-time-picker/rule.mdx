---
seoDescription: Replace the standard .NET Date Time Picker with Infragistics' UltraDatePicker
  to handle null date values and simplify DataBinding.
type: rule
...
<imageEmbed
  ...
  src="/uploads/rules/do-you-replace-the-standard-net-date-time-picker/datetimepickerproperties.gif"
/>
