...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This is a paste from the tool, but the action points are unclear"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This is a paste from the tool, but with the modifications at the end, the action points are clear"
