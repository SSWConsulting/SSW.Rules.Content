...
created: 2010-05-06 03:18:17+00:00
...
<imageEmbed
  ...
  figureText={"The Scrum Master can inspect the Sprint Backlog for items which are \"Not Done\" at the end of a Sprint"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The Scrum Master can inspect the team’s velocity over multiple Sprints"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The Scrum Master can inspect the team’s Sprint Burndown for insight into how work progressed through the Sprint"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The Scrum Master can inspect the team’s Code Coverage for an insight into code quality"}
...
<imageEmbed
  ...
  figureText={"Bad example – This is a paste from the tool, but the action points are unclear"}
...
<imageEmbed
  ...
  figureText={"Good example – This is a paste from the tool, but with the modifications at the end, the action points are clear"}
