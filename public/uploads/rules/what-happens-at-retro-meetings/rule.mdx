...
<imageEmbed
  ...
  captionText={"The Scrum Master can inspect the Sprint Backlog for items which are \"Not Done\" at the end of a Sprint"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The Scrum Master can inspect the team’s velocity over multiple Sprints"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The Scrum Master can inspect the team’s Sprint Burndown for insight into how work progressed through the Sprint"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The Scrum Master can inspect the team’s Code Coverage for an insight into code quality"}
...
<imageEmbed
  ...
  captionText={"Bad example – This is a paste from the tool, but the action points are unclear"}
...
<imageEmbed
  ...
  captionText={"Good example – This is a paste from the tool, but with the modifications at the end, the action points are clear"}
