...
<imageEmbed
  ...
  captionText={"Read Write indicates that the Query Store is setup to help us a few days later"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"A couple of days later… Query Store can now be queried to determine which queries are now performing poorly"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The query store can show the top 25 regressed queries in the last 2 weeks and give suggestions on how to improve them"}
