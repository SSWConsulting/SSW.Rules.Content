...
<imageEmbed
  ...
  figureText={"Read Write indicates that the Query Store is setup to help us a few days later"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"A couple of days later… Query Store can now be queried to determine which queries are now performing poorly"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The query store can show the top 25 regressed queries in the last 2 weeks and give suggestions on how to improve them"}
