...
<boxEmbed
  ...
  caption={"Bad example - No appointment sent"}
/>
...
_"Don't forget you can cancel or reschedule it anytime."_
  ...
  caption={"Good example - Proactively sending an appointment, bringing up urgency and options"}
/>
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  caption={"Plan ahead at the end of your last day at the client"}
