...
<imageEmbed
  ...
  caption={"A Secret or Variable with special characters can cause issues if improperly handled"}
...
<imageEmbed
  ...
  caption={"Bad example - Accessing this Secret as-is will lead to a syntax error in our Action"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A syntax error is thrown due to the special characters"}
...
<imageEmbed
  ...
  caption={"Good example - Wrapping our Secret in quotes means it will be correctly treated as text"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Our Secret is now handled correctly when wrapped in quotes"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Trying to wrap this Secret in double quotes will lead to an error"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The lone double quote character means this string cannot be interpreted correctly"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good (best) example - Escaping the special characters mean this string will be interpreted correctly"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The escaped characters mean our string is now interpreted correctly without the need to wrap in quotes"}
