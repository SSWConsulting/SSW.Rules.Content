---
seoDescription: GitHub Secrets and Variables store sensitive information, but handling
  special characters is crucial to avoid workflow issues.
type: rule
...
authors:
- author: zach-keeping
created: 2023-08-21 01:00:02.774000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Accessing this Secret as-is will lead to a syntax error in our Action"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Wrapping our Secret in quotes means it will be correctly treated as text"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Trying to wrap this Secret in double quotes will lead to an error"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Escaping the special characters mean this string will be interpreted correctly"
