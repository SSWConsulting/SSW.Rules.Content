...
<imageEmbed
  ...
  figureText={"Abstract includes all the tools for smooth collaboration"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Click to open the project in Sketch"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The 'Commit Changes' popup bar and button"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The 'Merge Branch' button"}
