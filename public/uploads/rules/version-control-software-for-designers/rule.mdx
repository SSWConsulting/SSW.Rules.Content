...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Abstract includes all the tools for smooth collaboration"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Click to open the project in Sketch"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The 'Commit Changes' popup bar and button"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The 'Merge Branch' button"}
