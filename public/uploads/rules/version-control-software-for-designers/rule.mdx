...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Abstract includes all the tools for smooth collaboration"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Click to open the project in Sketch"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The 'Commit Changes' popup bar and button"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The 'Merge Branch' button"}
