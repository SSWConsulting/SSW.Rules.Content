...
<imageEmbed
  ...
  figureText={"Bad Example – ASP.NET Yellow Screen of Death"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad Example - Default exception page"}
...
<imageEmbed
  ...
  figureText={"Good Example - GitHub custom error page"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"This is how you set it up in .NET 5"}
