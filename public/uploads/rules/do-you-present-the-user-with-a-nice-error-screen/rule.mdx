...
<imageEmbed
  ...
  caption={"Bad Example – ASP.NET Yellow Screen of Death"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad Example - Default exception page"}
...
<imageEmbed
  ...
  caption={"Good Example - GitHub custom error page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"This is how you set it up in .NET 5"}
