...
<imageEmbed
  ...
  captionText={"Bad Example – ASP.NET Yellow Screen of Death"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad Example - Default exception page"}
...
<imageEmbed
  ...
  captionText={"Good Example - GitHub custom error page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"This is how you set it up in .NET 5"}
