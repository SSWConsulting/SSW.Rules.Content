...
* Extreme Emails version 1.2.doc
  ...
  captionText={"Bad examples - File names have spaces or dots"}
/>
...
* Extreme-Emails-v1-2.doc
  ...
  captionText={"Good examples - File names have dashes instead of spaces"}
/>
...
* fileserver/Shared%20Documents/Ignite%20Brisbane%20Talk&#46;docx
  ...
  captionStyle="badExample"
  captionText={"Bad examples - File names have been published to the web with spaces so the URLs look ugly and are hard to read"}
/>
...
* fileserver/Shared-Documents/Ignite-Brisbane-Talk&#46;docx"
  ...
  captionStyle="goodExample"
  captionText={"Good examples - File names have no spaces so are much easier to read"}
/>