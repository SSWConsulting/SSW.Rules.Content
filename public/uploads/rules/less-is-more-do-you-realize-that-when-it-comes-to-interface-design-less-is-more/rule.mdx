...
isArchived: false
lastUpdated: 2014-06-11 06:17:34+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - An example of a poor UI"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Functional overload (a programmer probably designed this one)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Another example of Functional overload"}
...
<imageEmbed
  ...
  figureText={"Good example - Outlook.com (the replacement to Hotmail), streamlined functionality and minimal"}
