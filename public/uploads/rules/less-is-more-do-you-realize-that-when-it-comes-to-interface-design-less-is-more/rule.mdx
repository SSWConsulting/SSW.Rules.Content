...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="An example of a poor UI"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Functional overload (a programmer probably designed this one)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Another example of Functional overload"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Outlook.com (the replacement to Hotmail), streamlined functionality and minimal"
