...
<imageEmbed
  ...
  captionText={"Bad example - An example of a poor UI"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Functional overload (a programmer probably designed this one)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Another example of Functional overload"}
...
<imageEmbed
  ...
  captionText={"Good example - Outlook.com (the replacement to Hotmail), streamlined functionality and minimal"}
