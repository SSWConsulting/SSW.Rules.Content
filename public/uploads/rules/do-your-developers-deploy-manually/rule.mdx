...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Click on the \"Reconcile\" button to update your local files"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Right click on your last successful build and choose \"Reconcile Workspace\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"See the build failing and who requested it"}
