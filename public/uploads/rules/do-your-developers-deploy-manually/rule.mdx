...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Click on the \"Reconcile\" button to update your local files"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Right click on your last successful build and choose \"Reconcile Workspace\""}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"See the build failing and who requested it"}
