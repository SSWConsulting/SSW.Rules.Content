...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Click on the \"Reconcile\" button to update your local files"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Right click on your last successful build and choose \"Reconcile Workspace\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"See the build failing and who requested it"}
