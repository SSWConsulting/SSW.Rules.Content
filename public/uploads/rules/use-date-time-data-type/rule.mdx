...
<imageEmbed
  ...
  figureText={"Bad example - Using the String data type for date parameter"}
...
<imageEmbed
  ...
  figureText={"Good example - Use DateTime data type for the date parameter - you will not get internationalization bugs and it gives users a calendar control"}
