...
<imageEmbed
  ...
  captionText={"Bad example - Using the String data type for date parameter"}
...
<imageEmbed
  ...
  captionText={"Good example - Use DateTime data type for the date parameter - you will not get internationalization bugs and it gives users a calendar control"}
