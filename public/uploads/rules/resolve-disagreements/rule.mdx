...
The conversation ended, but the disagreement didn't. Nothing was actually agreed, so the issue lives on.
...
<boxEmbed
  ...
  body={<>
    ...
    **Sam:** I don't see any problem

    **Alex:** Please don't deploy on a Friday afternoon again because a bad deployment could cause the stress of fixing it on the weekend

    **Sam:** Still don't see a problem, this was a little change

    **Alex:** I have just checked with the CTO. Please please don't deploy on a Friday arvo.

    **Sam:** 👍
  </>}
  figurePrefix="bad"
  figure="The conversation went back and forth, ended on a 👍, and nothing was agreed - so it will happen again"
/>
...
* **Option A** - An explicit agreement - a clear yes or no, in words
* **Option B** - A booked follow-up - a specific time to finish the conversation

Anything else is kicking the can down the road.

<imageEmbed
  alt="A frustrated man in business clothes kicking a tin can further down an empty road"
  size="large"
  showBorder={false}
  figurePrefix="none"
  figure="Ending a disagreement without an agreement or a follow-up is just kicking the can down the road"
  src="/uploads/rules/resolve-disagreements/kicking-the-can-down-the-road.jpg"
/>

## Option A - Ask for an explicit agreement
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Names the disagreement, gives the reason, and asks for a yes or no"
/>
...
<boxEmbed
  ...
  body={<>
    ...
    **Good:** "I can see we're not seeing eye to eye on this one. It is an important one for me, so can we grab 15 minutes on Monday at 10am to sort it out?"
  </>}
  figurePrefix="good"
  figure="A follow-up with a real time beats a vague promise that never happens"
/>
...
The goal is agreement, not surrender. Shutting the conversation down wins the exchange and loses the person - they will comply while it is fresh, then quietly go back to their own way later. Leaning on seniority has the same problem. It ends the discussion without ever getting a genuine yes.
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Rank closes the conversation, but leaves the disagreement intact"
/>
