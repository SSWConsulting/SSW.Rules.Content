...
<imageEmbed
  ...
  caption={"Bad example - Tracking list of packages manually"}
...
<imageEmbed
  ...
  caption={"OK example - This npm audit command informs that there is 1 package with a high severity vulnerability"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  caption={"OK example - This dotnet command informs that there is 1 package with a high severity vulnerability"}
...
<imageEmbed
  ...
  caption={"Good example - Dependabot produces a vulnerability report periodically (and can raise a PR for you)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Snyk produces a vulnerability detection alert email"}
