...
created: 2022-05-20 01:38:10.095000+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Tracking list of packages manually"}
...
<imageEmbed
  ...
  figureText={"OK example - This npm audit command informs that there is 1 package with a high severity vulnerability"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="okExample"
  figureText={"OK example - This dotnet command informs that there is 1 package with a high severity vulnerability"}
...
<imageEmbed
  ...
  figureText={"Good example - Dependabot produces a vulnerability report periodically (and can raise a PR for you)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Snyk produces a vulnerability detection alert email"}
