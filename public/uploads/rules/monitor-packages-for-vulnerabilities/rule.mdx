...
lastUpdated: 2026-09-18T01:49:39.211Z
lastUpdatedBy: 'Zeno Wang [SSW]'
lastUpdatedByEmail: ZenoWang@ssw.com.au
isArchived: false
---
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Tracking list of packages manually" src="/uploads/rules/monitor-packages-for-vulnerabilities/screen-shot-2022-05-20-at-12.11.25.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Snyk produces a vulnerability detection alert email" src="/uploads/rules/monitor-packages-for-vulnerabilities/screen-shot-2022-05-20-at-12.38.26.png" />
