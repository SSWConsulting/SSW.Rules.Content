...
isArchived: false
lastUpdated: 2025-12-11 22:14:09+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Tracking list of packages manually"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="This npm audit command informs that there is 1 package with a high severity vulnerability"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="This dotnet command informs that there is 1 package with a high severity vulnerability"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Dependabot produces a vulnerability report periodically (and can raise a PR for you)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Snyk produces a vulnerability detection alert email"
