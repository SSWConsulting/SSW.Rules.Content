...
created: 2022-07-28 09:37:35+00:00
...
seoDescription: Monitor packages for vulnerabilities and ensure your applications
  stay secure by using modern package managers or third-party tools to automate scanning
  and alerting.
...
<imageEmbed
  ...
  captionText={"Bad example - Tracking list of packages manually"}
...
<imageEmbed
  ...
  captionText={"OK example - This npm audit command informs that there is 1 package with a high severity vulnerability"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  captionText={"OK example - This dotnet command informs that there is 1 package with a high severity vulnerability"}
...
<imageEmbed
  ...
  captionText={"Good example - Dependabot produces a vulnerability report periodically (and can raise a PR for you)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Snyk produces a vulnerability detection alert email"}
