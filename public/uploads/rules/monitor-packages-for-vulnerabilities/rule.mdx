...
lastUpdated: 2026-09-21T23:26:02.401Z
...
Manual tracking consists of: 

* Listing all installed packages 
* Cross-check with the [advisory board](https://github.com/advisories)
* Googling for CVE's
* Updating versions one at a time 
