...
<boxEmbed
  ...
  captionText={"Bad example - A modifier that doesn't tell you what has been modified is of no value"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - A modifier that clearly conveys what is different from the original can save developers time reading through the code"}
/>