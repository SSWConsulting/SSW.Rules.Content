...
seoDescription: Meaningful modifiers for custom controls enhance clarity and prevent naming conflicts, ensuring developers understand their unique functionality and purpose.
  in the name.
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="A modifier that doesn't tell you what has been modified is of no value"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="A modifier that clearly conveys what is different from the original can save developers time reading through the code"
/>