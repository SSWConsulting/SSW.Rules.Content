...
lastUpdated: 2025-10-28T18:33:02.000Z
...
<imageEmbed
  ...
  caption={"Bad example - No locations setup"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Every location that your users work from"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Add a conditional access policy"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Exclude good locations"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Choose report only until you are sure that your rules work"}
...
<imageEmbed
  ...
  caption={"Good example - Inform of your travel using an easy form"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - You get this error message: \"You cannot access this right now\""}
