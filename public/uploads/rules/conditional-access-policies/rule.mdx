...
<imageEmbed
  ...
  captionText={"Bad example - No locations setup"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Every location that your users work from"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Add a conditional access policy"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Add all cloud apps"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Choose any location"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Exclude good locations"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Add a grant with MFA"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Choose report only until you are sure that your rules work"}
...
<imageEmbed
  ...
  captionText={"Good example - Inform of your travel using an easy form"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - You get this error message: \"You cannot access this right now\""}
