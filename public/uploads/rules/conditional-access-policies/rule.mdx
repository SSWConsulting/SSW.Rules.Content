---
seoDescription: Microsoft endpoint security uses Conditional Access policies to restrict
  user access to Azure and Office365 resources based on location, device types, and
...
created: 2022-04-13 01:19:59.907000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Inform of your travel using an easy form"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure='You get this error message: "You cannot access this right now"'
