...
<imageEmbed
  ...
  figureText={"Bad example - No locations setup"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Every location that your users work from"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add a conditional access policy"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Choose any location"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Exclude good locations"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add a grant with MFA"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Choose report only until you are sure that your rules work"}
...
<imageEmbed
  ...
  figureText={"Good example - Inform of your travel using an easy form"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - You get this error message: \"You cannot access this right now\""}
