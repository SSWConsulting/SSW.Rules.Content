...
<imageEmbed
  ...
  figureText={"Bad example - Files are stored on the desktop. Even though it is backed up by OneDrive, the files are not easily accessed by other team members if needed"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – It might be easy to use File Shares, your Local C:, or emails – but don’t. They don’t work in a team environment as they aren’t easy for others to access"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – SharePoint integrated into Azure DevOps (was VSTS/TFS) is not supported via Visual Studio anymore"}
...
<imageEmbed
  ...
  figureText={"Good example - Use Microsoft Teams and it will automatically create a Site for the Team (and that includes a document library which you can connect to with OneDrive)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Files are stored in a folder in SharePoint. Other team members can easily find these documents"}
