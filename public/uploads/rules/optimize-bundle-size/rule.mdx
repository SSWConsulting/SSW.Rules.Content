...
<imageEmbed
  ...
  caption={"Bad example - 4.9 megabytes of unused bytes can contribute to slower loading times"}
...
<imageEmbed
  ...
  caption={"Good example - After optimization it is down to 2.5 unused megabytes"}
