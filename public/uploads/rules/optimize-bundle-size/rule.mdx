...
<imageEmbed
  ...
  figureText={"Bad example - 4.9 megabytes of unused bytes can contribute to slower loading times"}
...
<imageEmbed
  ...
  figureText={"Good example - After optimization it is down to 2.5 unused megabytes"}
