...
<imageEmbed
  ...
  figureText={"There is no way to delete the Team Project Collection from the TFS Administration console"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Use the TFSConfig tool to delete a Team Project Collection (If you created a SharePoint Portal for your Team Project Collection, you should clean it up as well)"}
