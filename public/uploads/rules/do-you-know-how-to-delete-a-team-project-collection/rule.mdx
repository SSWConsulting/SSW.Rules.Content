...
isArchived: false
lastUpdated: 2021-04-20 00:02:46.771000+00:00
...
<imageEmbed
  ...
  captionText={"There is no way to delete the Team Project Collection from the TFS Administration console"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Use the TFSConfig tool to delete a Team Project Collection (If you created a SharePoint Portal for your Team Project Collection, you should clean it up as well)"}
