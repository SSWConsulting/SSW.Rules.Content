...
<boxEmbed
  style="info"
  body={<>
    If there has been less than 5 man-days of effort during the Sprint (e.g. due to leave or interruptions), keep adding 1 week to the Sprint until you have at least 5 man-days of effort worked. For example, if you do 1 day a week internally, then schedule it after 5 weeks, or if there are 2 on the team doing 2 days internally, then schedule it after 2 weeks.
  </>}
  figurePrefix="none"
  figure=""
/>
