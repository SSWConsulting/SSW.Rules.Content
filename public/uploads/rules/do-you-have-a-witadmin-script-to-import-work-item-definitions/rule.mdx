---
archivedreason: Outdated - This is based on legacy TFS work item customization via WitAdmin and WIT XML import scripts. For modern guidance, see [DevOps best practices](/rules-to-better-devops).
authors:
- title: Lei Xu
