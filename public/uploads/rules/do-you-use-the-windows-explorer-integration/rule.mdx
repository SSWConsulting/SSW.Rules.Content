archivedreason: Outdated (Legacy) - TFS Power Tools / Windows Explorer integration is legacy. For modern source control tooling, see [Do you use Source Control tools?](/source-control-tools).
authors:
- noimage: true
  title: David Klein
...
isArchived: true
lastUpdated: 2014-05-07 04:07:27+00:00
