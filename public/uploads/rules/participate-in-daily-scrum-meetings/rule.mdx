...
<imageEmbed
  ...
  caption={"Schedule your Scrum meetings to take place at the same time each day. If sending Daily Scrum by email or Teams, make sure to schedule it in your calendar the same time each day, just as you would a normal Daily Scrum meeting"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Daily Scrums can be sent to a company 'Daily Scrum' inbox account where you can check which staff have sent them and which ones are missing"}
