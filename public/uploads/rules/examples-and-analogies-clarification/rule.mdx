...
<boxEmbed
  ...
  figureText={"Bad example - The prompt is vague and does not request an example or analogy to clarify the complex concept"}
/>
...
“Provide an example of how the butterfly effect can be observed in real-life situations.”
  ...
  figureText={"Good examples - Asking for an example or analogy to illustrate a complex concept"}
/>
