...
3. Implement the interface from step 1 and refactor entities
   ...
   3. Make any other necessary refactors
      ...
      5. Use `.AsEnumerable()` deliberately (and measure), use raw SQL, or change how the query works
      6. Add a **TechDebt** comment and PBI - [Do you know the importance of paying back Technical Debt?](/technical-debt/)
