...
<imageEmbed
  ...
  caption={"Bad example - Relying solely on AI without any oversight can lead to errors"}
...
<imageEmbed
  ...
  caption={"Good example - Using Rask to translate an English voiceover into French in the speakers own voice"}
