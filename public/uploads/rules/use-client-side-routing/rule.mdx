...
<imageEmbed
  ...
  figureText={"Bad example - The blog post component is choosing components based on the state of the component"}
...
<imageEmbed
  ...
  figureText={"Good: Setting up declarative routes and outlets gives a good user experience, persistent URLs, and fewer moving parts"}
