...
<imageEmbed
  ...
  caption={"Indicate someone to enter the mobile field. Do you use a red arrow?"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Or do you like the red box?"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Or do you like the yellow highlight?"}
