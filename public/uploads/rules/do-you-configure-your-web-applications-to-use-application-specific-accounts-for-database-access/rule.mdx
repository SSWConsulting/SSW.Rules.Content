...
<imageEmbed
  ...
  captionText={"Bad example – Contract Manager Web Application using the administrator login in its connection string"}
...
<imageEmbed
  ...
  captionText={"Good example – Application specific database user configured in the connection string"}
...
<boxEmbed
  ...
  captionText={"Example connection string"}
/>