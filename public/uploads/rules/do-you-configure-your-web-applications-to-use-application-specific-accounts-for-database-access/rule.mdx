...
createdBy: Michael Demarco
createdByEmail: michaelDemarco@ssw.com.au
guid: 7a886ddf-5a56-48cb-89bd-3b47fd90e329
isArchived: false
lastUpdated: 2015-02-19 03:21:51+00:00
lastUpdatedBy: Michael Demarco
lastUpdatedByEmail: michaelDemarco@ssw.com.au
redirects: []
...
<imageEmbed
  ...
  figureText={"Bad example – Contract Manager Web Application using the administrator login in its connection string"}
...
<imageEmbed
  ...
  figureText={"Good example – Application specific database user configured in the connection string"}
...
<boxEmbed
  ...
  figureText={"Example connection string"}
/>