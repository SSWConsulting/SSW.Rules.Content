---
seoDescription: Learn why using module templates in your Bicep code improves maintainability,
  reusability, and consistency across your infrastructure-as-code projects.
type: rule
