...
<imageEmbed
  ...
  figureText={"Bad example - Teams Channel names without emojis"}
...
<imageEmbed
  ...
  figureText={"Good example - Teams Channel names with emojis"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Control4 automation UI is more friendly with emojis"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Some appointments can benefit from an emoji too, like using a 🏃‍♂️ for a Sprint meeting"}
