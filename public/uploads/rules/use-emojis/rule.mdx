...
<imageEmbed
  ...
  captionText={"Bad example - Teams Channel names without emojis"}
...
<imageEmbed
  ...
  captionText={"Good example - Teams Channel names with emojis"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Control4 automation UI is more friendly with emojis"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Some appointments can benefit from an emoji too, like using a 🏃‍♂️ for a Sprint meeting"}
...
* Maintenance of needing to upload to server
  ...
  captionStyle="badExample"
  captionText={"Bad example - Regular list items"}
/>
...
❌ Maintenance of needing to upload to server
  ...
  captionStyle="goodExample"
  captionText={"Good example - Emojis give context to each item"}
/>
