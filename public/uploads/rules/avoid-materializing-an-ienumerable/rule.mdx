...
created: 2021-12-22T05:27:11.000Z
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - This creates a list with all of the products in RAM before iterating over them. This can very easily cause an OutOfMemoryException.",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - Doesn't force the data to be read into memory before iterating. This will behave nicely even for an infinite enumerator.",
  shouldDisplay: true
} } />
