---
seoDescription: Avoid materializing large IEnumerables to prevent memory and CPU issues,
  instead iterate through them directly.
type: rule
...
created: 2021-12-22 05:11:19.642000+00:00
