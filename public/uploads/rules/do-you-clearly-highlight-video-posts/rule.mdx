...
<imageEmbed
  ...
  caption={"Bad example: From the title, you would be unable to tell that this has a video"}
...
<imageEmbed
  ...
  caption={"Good example: From the title, it is easy to see that this includes a video"}
