...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example: From the title, you would be unable to tell that this has a video](Stevo-Bad-blog.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example: From the title, it is easy to see that this includes a video](Chris-Good-blog.png)',
  shouldDisplay: true
} } />
