...
lastUpdated: 2026-07-28T16:32:42.266Z
...
* Ask your favorite LLM or Agent ([Do you know what you can use ChatGPT for?](https://www.ssw.com.au/rules/chatgpt-skills-weaknesses) or [Do you use AI to explore unfamiliar code?](https://www.ssw.com.au/rules/ai-investigation-prompts))
...
<boxEmbed
  body={<>
    If you can’t get a hold of them, send a message with the prefix “⚠️ Blocked” to ensure the other person knows that you can’t proceed without them.
  </>}
  figurePrefix="none"
  figure=""
  style="warning"
