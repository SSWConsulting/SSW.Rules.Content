...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="By default CRM uses option group for contact's and account's contact methods."
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Checkboxes are used for contact methods because they're clear and simple."
