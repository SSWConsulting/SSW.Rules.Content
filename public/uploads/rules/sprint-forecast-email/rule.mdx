...
<emailEmbed
  ...
  body={<>
    ...
    **Figure: The Sprint Backlog with the important items bolded**
    ...
    &lt;This is as per rule: [Do you create a Sprint Forecast?](/sprint-forecast)&ft;
  </>}
  figurePrefix="good"
...
<boxEmbed
  ...
  body={<>
    **Tip:** You can copy and paste the Sprint Backlog as a table into the email body:
    ...
    1. Go to GitHub and navigate to the Sprint's Backlog view at **GitHub | Organisation | Repository | Projects | Project | Current Sprint **or Go to Azure DevOps and navigate to the Sprint's Backlog view at** Azure DevOps | Project | Sprints | Backlog**
