...
You can augment the summary by using AI tools like Copilot to extract additional insights from a meeting transcript.
...
<emailEmbed
  ...
  body={<>
    ...
    ****![](/uploads/rules/sprint-forecast-email/copilot-stats.png)
    
    **Figure: Main item to do next**
