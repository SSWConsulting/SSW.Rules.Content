...
<imageEmbed
  ...
  figureText={"Bad Example – No audiences were set up yet"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Good Example – Add specific audiences and increase the engagement on your campaigns with your target audience"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Find your excluded audience so you won't waste any money for useless clicks"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"In-Market audiences that might be your right target"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Affinity audiences suggestions from Google"}
