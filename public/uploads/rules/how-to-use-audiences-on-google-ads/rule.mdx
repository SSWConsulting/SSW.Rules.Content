...
<imageEmbed
  ...
  captionText={"Bad Example – No audiences were set up yet"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Good Example – Add specific audiences and increase the engagement on your campaigns with your target audience"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Find your excluded audience so you won't waste any money for useless clicks"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"In-Market audiences that might be your right target"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Affinity audiences suggestions from Google"}
