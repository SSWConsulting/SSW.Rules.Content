...
<imageEmbed
  ...
  caption={"Bad example - To contact this person via the phone I will have to ask them for their number"}
...
<imageEmbed
  ...
  caption={"Good example - People are showing their phone numbers to allow urgent issues to be resolved"}
...
<imageEmbed
  ...
  caption={"Phone number is easy to access in Microsoft Teams' profiles"}
