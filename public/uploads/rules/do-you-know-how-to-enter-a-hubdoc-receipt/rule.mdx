...
<imageEmbed
  ...
  caption={"Users to accept invite to use Hubdoc"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Take a photo with the Mobile Hubdoc app"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Photo of Receipt and submitting basic invoice details - generally is read by OCR of the software"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Details that can be automated for Accounting reconciliation purposes"}
