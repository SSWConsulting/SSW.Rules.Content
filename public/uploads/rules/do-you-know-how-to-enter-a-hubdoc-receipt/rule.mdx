...
isArchived: false
lastUpdated: 2020-11-25 05:49:22+00:00
lastUpdatedBy: Nick Viet
lastUpdatedByEmail: NicholasViet@sswcom.onmicrosoft.com
redirects:
...
<imageEmbed
  ...
  captionText={"Users to accept invite to use Hubdoc"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Take a photo with the Mobile Hubdoc app"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Photo of Receipt and submitting basic invoice details - generally is read by OCR of the software"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Details that can be automated for Accounting reconciliation purposes"}
