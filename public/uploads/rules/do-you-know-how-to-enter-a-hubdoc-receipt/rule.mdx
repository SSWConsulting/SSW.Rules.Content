...
<imageEmbed
  ...
  figureText={"Users to accept invite to use Hubdoc"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Take a photo with the Mobile Hubdoc app"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Photo of Receipt and submitting basic invoice details - generally is read by OCR of the software"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Details that can be automated for Accounting reconciliation purposes"}
