---
archivedreason: Outdated - Validation steps for a TFS 2015 migration (end-of-life). For modern guidance, see [Steps required when migrating to the cloud](/steps-required-when-migrating-to-the-cloud).
isArchived: true
authors:
- title: Adam Cogan
