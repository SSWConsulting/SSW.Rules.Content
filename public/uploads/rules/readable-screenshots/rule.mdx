...
<imageEmbed
  ...
  figureText={"Bad example - The contents of the screenshots are difficult to read"}
...
<imageEmbed
  ...
  figureText={"Good example - The contents of the screenshots are readable, since the image was cropped to the relevant part"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Too much white space"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Screen resized to the relevant part"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad Example - mobile screenshot is way too big"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="goodExample"
  figureText={"Good Example - mobile screenshot is smaller and easier to follow"}
