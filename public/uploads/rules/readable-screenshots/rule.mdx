...
<imageEmbed
  ...
  captionText={"Bad example - The contents of the screenshots are difficult to read"}
...
<imageEmbed
  ...
  captionText={"Good example - The contents of the screenshots are readable, since the image was cropped to the relevant part"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Too much white space"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Screen resized to the relevant part"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad Example - mobile screenshot is way too big"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Good Example - mobile screenshot is smaller and easier to follow"}
