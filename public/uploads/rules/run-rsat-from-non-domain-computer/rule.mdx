...
<imageEmbed
  ...
  captionText={"Bad example - RDP directly to the domain controller"}
...
<imageEmbed
  ...
  captionText={"Managing AD in Windows Admin Center"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"MMC | Add or Remove Snap-ins"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"ADUC | Change domain"}
