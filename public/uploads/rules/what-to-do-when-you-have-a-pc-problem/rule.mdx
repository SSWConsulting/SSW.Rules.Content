...
created: 2016-10-30 10:50:22+00:00
...
seoDescription: PC problems? Follow these steps to troubleshoot Windows updates, driver
  upgrades, and firmware updates before reporting issues to SysAdmins.
...
<imageEmbed
  ...
  captionText={"Windows additional optional updates"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Lenovo System Update - Install updates (Recommended)"}
