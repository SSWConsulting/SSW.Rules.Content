...
created: 2022-03-17 05:06:21.573000+00:00
...
<imageEmbed
  ...
  figureText={"OK example - SMS is less secure than other methods"}
...
<imageEmbed
  ...
  figureText={"Microsoft's Authenticator app in action"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"MFA sign-in | Use an app instead"}
...
<imageEmbed
  ...
  figureText={"Good example - Microsoft Authenticator app with Passwordless sign-in (recommended)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Google authenticator 2FA enabled and saved in Keeper"}
