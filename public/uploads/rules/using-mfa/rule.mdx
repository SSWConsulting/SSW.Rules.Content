...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="SMS is less secure than other methods"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Microsoft Authenticator app with Passwordless sign-in (recommended)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Google authenticator 2FA enabled and saved in Keeper"
