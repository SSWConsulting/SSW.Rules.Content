...
<imageEmbed
  ...
  captionText={"OK example - SMS is less secure than other methods"}
...
<imageEmbed
  ...
  captionText={"Microsoft's Authenticator app in action"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"MFA sign-in | Use an app instead"}
...
<imageEmbed
  ...
  captionText={"Good example - Microsoft Authenticator app with Passwordless sign-in (recommended)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Google authenticator 2FA enabled and saved in Keeper"}
