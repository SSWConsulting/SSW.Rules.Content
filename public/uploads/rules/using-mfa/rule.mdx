...
<imageEmbed
  ...
  caption={"OK example - SMS is less secure than other methods"}
...
<imageEmbed
  ...
  caption={"Microsoft's Authenticator app in action"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"MFA sign-in | Use an app instead"}
...
<imageEmbed
  ...
  caption={"Good example - Microsoft Authenticator app with Passwordless sign-in (recommended)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Google authenticator 2FA enabled and saved in Keeper"}
