...
This negatively impacts user experience and potential conversions.
  ...
  figurePrefix="bad"
  figure="Things that will negatively impact the website UX"
/>
...
* Increasing the chances of retaining visitors and conversions
  ...
  figurePrefix="good"
  figure="Good performance will improve the website's UX"
/>
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="bad"
  figure="Slow LCP, leading to a poor user experience"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="Fast LCP shown in Chrome DevTools Performance tab"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="Lighthouse audit with high performance and SEO scores, plus actionable insights"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="Lighthouse Audit in GitHub pull-request"
