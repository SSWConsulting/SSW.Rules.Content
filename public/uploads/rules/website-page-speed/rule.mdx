...
<imageEmbed
  ...
  figureText={"Bad example - Slow LCP, leading to a poor user experience"}
...
<imageEmbed
  ...
  figureText={"Good example - Fast LCP shown in Chrome DevTools Performance tab"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="goodExample"
  figureText={"Good example - Lighthouse audit with high performance and SEO scores, plus actionable insights"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="goodExample"
  figureText={"Good example - Lighthouse Audit in GitHub pull-request"}
