...
isArchived: false
lastUpdated: 2025-07-17 21:19:14+00:00
...
This negatively impacts user experience and potential conversions.
  ...
  captionText={"Bad example - Things that will negatively impact the website UX"}
/>
...
* Increasing the chances of retaining visitors and conversions
  ...
  captionText={"Good example - Good performance will improve the website's UX"}
/>
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="badExample"
  captionText={"Bad example - Slow LCP, leading to a poor user experience"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Good example - Fast LCP shown in Chrome DevTools Performance tab"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Good example - Lighthouse audit with high performance and SEO scores, plus actionable insights"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Good example - Lighthouse Audit in GitHub pull-request"}
