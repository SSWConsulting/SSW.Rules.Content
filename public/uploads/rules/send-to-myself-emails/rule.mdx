...
created: 2009-03-26 02:29:14+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Writing yourself a \"Post-It Note\" is not the best method"}
...
It's estimated to take **2 hours** and I'll make it my #1 priority on the next Sprint, starting tomorrow
  ...
  figureText={"Good example - Send yourself an email with estimate and prioritization"}
/>
...
Done - This change has been made and can be found at &#123;&#123; URL &#125;&#125;
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Replying to a 'To myself' email showing done evidence and correctly replying to the person who requested the task"}
/>