...
It's estimated to take **2 hours** and I'll make it my #1 priority on the next Sprint, starting tomorrow
  ...
  figurePrefix="good"
  figure="Send yourself an email with estimate and prioritization"
/>
...
Done - This change has been made and can be found at &#123;&#123; URL &#125;&#125;
  ...
  figurePrefix="good"
  figure="Replying to a 'To myself' email showing done evidence and correctly replying to the person who requested the task"
/>