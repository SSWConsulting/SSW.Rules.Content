...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "![Bad example – ANZAlerter.com is NOT owned by ANZ](/uploads/rules/recognizing-phishing-urls/bad-whois.png)",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "![Good example – The domain ANZ.com.au is owned by ANZ](/uploads/rules/recognizing-phishing-urls/good-whois.png)",
  shouldDisplay: true
} } />
