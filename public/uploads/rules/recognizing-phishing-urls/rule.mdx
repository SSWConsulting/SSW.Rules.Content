...
<boxEmbed
  ...
  caption={"Bad example – The address has LinkedIn in it, but it is a sub-domain, not the domain"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example – The address has LinkedIn in it, but it is in the path, not the FQDN. The FQDN is also suspicious"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example – The address has LinkedIn in it, but is not a legitimate LinkedIn site"}
/>
...
<boxEmbed
  ...
  caption={"Good example – LinkedIn is a secure domain"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example – ANZAlerter.com is NOT owned by ANZ"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – The domain ANZ.com.au is owned by ANZ"}
