...
<boxEmbed
  body={<>
    ...
    <imageEmbed
      alt="YouTube playlist listing Sprint Summary recordings for TinaCMS"
      size="medium"
      showBorder={false}
      figurePrefix="good"
      figure="YouTube playlist of our Open Source TinaCMS Sprint Summaries"
      src="/uploads/rules/what-happens-at-a-sprint-review-meeting/sprint-summaries-youtube-playlist.png"
    />
    
    Alternatively, you can post your video to an internal site. e.g. By posting to SharePoint or Microsoft Stream
    
    <imageEmbed
      alt="SharePoint page showing internal Sprint Summary videos"
      size="medium"
      showBorder={false}
      figurePrefix="good"
      figure="Internal Sprint Summaries stored on SharePoint"
      src="/uploads/rules/what-happens-at-a-sprint-review-meeting/sprint-summaries-internal.png"
    />
  </>}
  figurePrefix="none"
  figure=""
