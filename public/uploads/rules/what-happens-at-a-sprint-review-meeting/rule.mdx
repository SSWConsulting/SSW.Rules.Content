...
seoDescription: 'Understand what happens in a Sprint Review meeting, including how PBIs are presented, accepted, and how to keep stakeholders informed and engaged.'
created: 2024-10-09T00:02:42.000Z
createdBy: 'Tiago Araújo [SSW]'
createdByEmail: tiagov8@gmail.com
lastUpdated: 2026-05-11T13:40:34.310Z
...
1. The Team prepares all of the PBIs for review according to the [Definition of Done](/definition-of-done)
2. Draft the [Sprint Review + Retrospective email](/sprint-review-retro-email) 📩
3. Draft the [Sprint Planning email](/sprint-forecast-email) 📩
4. Host the Sprint Review meeting with the Team and the Product Owner (Should be around 1 hour, but for some teams it might take longer)
5. Record the meeting to capture the discussion and gather AI-generated insights
6. Stop recording
7. *Ask Claude or Copilot to analyse the recording (Optional, but recommended)*
8. While waiting, host a Retrospective and include the result in the email 📩 above
9. *Include the AI-generated insights into the email* 📩 *above (Optional, but recommended)*
10. Host a [Sprint Planning meeting](/what-happens-at-a-sprint-planning-meeting)
11. Call relevant Stakeholders in. Host and record a Sprint Summary meeting with the Team and Product Owner (aim to spend 15 minutes or less)
12. Post the Sprint Summary recording on an internal or public video hosting service
13. Send out the email 📩 with the results of the Sprint Review to the Stakeholders
14. Send out the Sprint Planning email 📩

<boxEmbed
  body={<>
    If it makes sense to share the video with the general public - upload it to the YouTube channel of your project/organisation. e.g. We have a playlist of our Sprint Summaries for our Open Source [TinaCMS](https://www.youtube.com/playlist?list=PLPar4H9PHKVrahKk4PzKtcEstFDDMlxzr).
    
    <imageEmbed alt="YouTube playlist listing Sprint Summary recordings for TinaCMS" size="medium" showBorder={false} figurePrefix="good" figure="YouTube playlist of our Open Source TinaCMS Sprint Summaries" src="/uploads/rules/what-happens-at-a-sprint-review-meeting/sprint-summaries-youtube-playlist.png" />
    
    Alternatively, you can post your video to an internal site. e.g. By posting to SharePoint or Microsoft Stream
    
    <imageEmbed alt="SharePoint page showing internal Sprint Summary videos" size="medium" showBorder={false} figurePrefix="good" figure="Internal Sprint Summaries stored on SharePoint" src="/uploads/rules/what-happens-at-a-sprint-review-meeting/sprint-summaries-internal.png" />
  </>}
  figurePrefix="none"
  figure=""
  style="info"
...
[What happens at Sprint Summary meetings?](/summary-recording-sprint-reviews)
...
<boxEmbed
  style="info"
  body={<>
    **Tip**: (Optional) Ask stakeholders for Copilot AI images 🤖 **before the Sprint Summary meeting** to include in the Sprint Summary email 📩.
  </>}
  figurePrefix="none"
  figure=""
/>
