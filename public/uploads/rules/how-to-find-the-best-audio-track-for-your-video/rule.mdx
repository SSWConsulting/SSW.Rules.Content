...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Ripping someone's song can result in your video being taken down by YouTube"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Scanning Audionetwork song descriptions can be faster than listening to each song - you can listen and jump forward along the waveform to quickly get the gist of it, then find the perfect powerful crescendo to finish off your video"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Artlist - for a low annual subscription cost you get unlimited access to really awesome quality music."
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="AudioJungle.net - you can pay $1 for a laugh track"
