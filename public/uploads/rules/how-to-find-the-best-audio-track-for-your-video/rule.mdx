...
<imageEmbed
  ...
  caption={"Bad example - Ripping someone's song can result in your video being taken down by YouTube"}
...
<imageEmbed
  ...
  caption={"Good example - Scanning Audionetwork song descriptions can be faster than listening to each song - you can listen and jump forward along the waveform to quickly get the gist of it, then find the perfect powerful crescendo to finish off your video"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Artlist - for a low annual subscription cost you get unlimited access to really awesome quality music."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - AudioJungle.net - you can pay $1 for a laugh track"}
