...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="PascalCase (better readability and still works in small caps, but other people might share it without the MixedCase)"
/>
...
northwind&#46;com/**page20%on20%word20%documentation**
  ...
  figurePrefix="bad"
  figure="Spaces it will show up in your URL structure as 20%, which is bad for readability and SEO"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Kebab-case is recommended by Google. Note: Don't use any uppercase"
/>
