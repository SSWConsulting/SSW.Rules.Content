...
<boxEmbed
  ...
  captionText={"Bad example - No kebab-case in URL"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - PascalCase (better readability and still works in small caps, but other people might share it without the MixedCase)"}
/>
...
northwind&#46;com/**page20%on20%word20%documentation**
  ...
  captionStyle="badExample"
  captionText={"Bad example - spaces it will show up in your URL structure as 20%, which is bad for readability and SEO"}
/>
...
<boxEmbed
  ...
  captionText={"OK example - underscored (snake_case) URLs have good readability but are not recommended by Google"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - kebab-case is recommended by Google. Note: Don't use any uppercase"}
/>
