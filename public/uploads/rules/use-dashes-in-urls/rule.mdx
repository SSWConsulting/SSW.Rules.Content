...
<boxEmbed
  ...
  caption={"Bad example - No kebab-case in URL"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - PascalCase (better readability and still works in small caps, but other people might share it without the MixedCase)"}
/>
...
northwind&#46;com/**page20%on20%word20%documentation**
  ...
  captionStyle="badExample"
  caption={"Bad example - spaces it will show up in your URL structure as 20%, which is bad for readability and SEO"}
/>
...
<boxEmbed
  ...
  caption={"Good example - kebab-case is recommended by Google. Note: Don't use any uppercase"}
/>
