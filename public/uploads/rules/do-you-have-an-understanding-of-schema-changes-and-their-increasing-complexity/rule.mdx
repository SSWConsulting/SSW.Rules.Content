...
isArchived: false
lastUpdated: 2021-02-26 01:16:07.024000
lastUpdatedBy: Christian Morford-Waite [SSW]
lastUpdatedByEmail: ChristianMWaite@ssw.com.au
redirects: []
seoDescription: Mastering schema changes and their increasing complexity requires
  understanding low-impact alterations and high-risk operations involving existing
  data.
...
**Figure: Change data type (Hard) e.g. Bit to Integer. The above is abbreviated, see [the full .SQL file](EmployeesBitToInt.sql)**
...
**Figure: Change data type (Very Hard) e.g. Text to Integer. Text to Integer and data conversion requires ["Data Motion Scripts"](/do-you-understand-a-data-type-change-data-motion-scripts). The above is abbreviated, see [the full .SQL file](EmployeesCharToInt.sql)**
