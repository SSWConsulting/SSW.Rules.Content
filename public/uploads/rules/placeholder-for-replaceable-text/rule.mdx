...
\[Your name\]
  ...
  captionText={"Bad example - Using square brackets for replaceable text"}
/>
...
&#123;&#123; YOUR NAME &#125;&#125;
  ...
  captionText={"Good example - Using double curly brackets for replaceable text... with spaces, and words in UPPERCASE"}
/>
