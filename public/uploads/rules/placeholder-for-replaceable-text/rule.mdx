...
\[Your name\]
  ...
  figureText={"Bad example - Using square brackets for replaceable text"}
/>
...
&#123;&#123; YOUR NAME &#125;&#125;
  ...
  figureText={"Good example - Using double curly brackets for replaceable text... with spaces, and words in UPPERCASE"}
/>