---
type: rule
title: Do you use the right placeholder format for replaceable text?
...
seoDescription: Use a consistent placeholder format to mark replaceable text so readers know exactly what to substitute.
