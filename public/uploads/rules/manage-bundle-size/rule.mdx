...
<imageEmbed
  ...
  captionText={"A list of the unused dependencies in a project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The list of packages from the package.json file, sorted by size"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The extension in action - shows you how large each package is, as you import it"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The bundle map for the NextJS SSW Website"}
