...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="none" figure="Dashboard showing highest-cost SQL queries" src="/uploads/rules/database-query-costops/query-dashboard.jpeg" />
