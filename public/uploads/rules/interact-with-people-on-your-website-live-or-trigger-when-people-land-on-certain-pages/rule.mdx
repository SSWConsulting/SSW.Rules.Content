...
seoDescription: Proactively interact with website visitors using Zendesk Chat triggers,
  reducing cart abandonment and providing support on critical pages.
title: Do you know how to interact with people on your website live, or trigger when
  people land on certain pages?
type: rule
