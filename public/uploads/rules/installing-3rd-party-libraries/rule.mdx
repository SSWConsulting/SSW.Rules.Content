...
<imageEmbed
  ...
  caption={"Bad example - Unmaintained library - little to no activity - https://github.com/douglasgsouza/mat-row-keyboard-selection/pulse/monthly"}
...
<imageEmbed
  ...
  caption={"Good example #1 - Popular npm library with lots of stars and recently updated- https://github.com/date-fns/date-fns"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example #2 - Well maintained and active library - https://github.com/date-fns/date-fns/pulse/monthly"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - npm - uncommon license, need to check for conditions and fees - https://npmjs.com/package/highcharts"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - NuGet – uncommon license, need to check for conditions and fees - https://nuget.org/packages/PDFTron.NET.x64"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - npm - MIT License, free to use - https://npmjs.com/package/date-fns"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - NuGet – MIT License, free to use - https://nuget.org/packages/Newtonsoft.Json/13.0.1"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - A markdown file should include your reasons to assist future developers"}
