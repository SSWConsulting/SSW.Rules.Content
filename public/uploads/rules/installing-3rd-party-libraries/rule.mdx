...
created: 2022-09-30 07:08:57+00:00
...
isArchived: true
lastUpdated: 2025-12-11 06:27:58+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Unmaintained library - little to no activity - https://github.com/douglasgsouza/mat-row-keyboard-selection/pulse/monthly"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Popular npm library with lots of stars and recently updated- https://github.com/date-fns/date-fns"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Well maintained and active library - https://github.com/date-fns/date-fns/pulse/monthly"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Npm - uncommon license, need to check for conditions and fees - https://npmjs.com/package/highcharts"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="NuGet – uncommon license, need to check for conditions and fees - https://nuget.org/packages/PDFTron.NET.x64"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Npm - MIT License, free to use - https://npmjs.com/package/date-fns"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="NuGet – MIT License, free to use - https://nuget.org/packages/Newtonsoft.Json/13.0.1"
