...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Investment returns compounding annually at 6% for 30 years (that’s without contributing any more $)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"It looks the same but increasing the investment return rate from 6% to 7% over 30 years will increase your ending balance for almost $20k (a slightly better fund, can give you higher returns)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Salary Sacrificing $50 per week, with a 7% investment return over 30 years will increase your compounded interest by almost $170k"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Look at the best performing non-excluded Super funds"}
