...
<imageEmbed
  ...
  captionText={"An SEO expert hard at work"}
...
<imageEmbed
  ...
  captionText={"Bad example - Website with a missing meta description tag"}
...
<imageEmbed
  ...
  captionText={"Good example - SSW Dory's website has a meta description tag"}
