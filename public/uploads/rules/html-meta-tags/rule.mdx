...
<imageEmbed
  ...
  caption={"An SEO expert hard at work"}
...
<imageEmbed
  ...
  caption={"Bad example - Website with a missing meta description tag"}
...
<imageEmbed
  ...
  caption={"Good example - SSW Dory's website has a meta description tag"}
