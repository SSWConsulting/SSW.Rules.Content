...
<boxEmbed
  style="greybox"
  body={<>
    SSW Rules - Add 'please update this rule' button <mark style="background-color: #FEF08A">#1</mark>
  </>}
  figurePrefix="none"
  figure=""
/>
...
<boxEmbed
  style="greybox"
  body={<>
    SSW Rules - Add 'please update this rule' button <mark style="background-color: #FEF08A">#2</mark>
  </>}
  figurePrefix="none"
  figure=""
/>
