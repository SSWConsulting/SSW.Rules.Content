...
Thanks
  ...
  figurePrefix="bad"
  figure="This email isn't going to help the developer much - it is vague, has no screen capture or other details to help reproducing the error"
/>
...
Thanks
  ...
  figurePrefix="good"
  figure="This email includes the product name and version, the category of the issue (BUG), a screen capture, and informs the user's system"
/>
...
Adam
  ...
  figurePrefix="good"
  figure="We can easily identify more the one way to improve the UX and there's a clear suggestion to action"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using a tool to record steps replicating an issue is a great and simple way to report a problem that's easy for a developer to understand and reproduce"
