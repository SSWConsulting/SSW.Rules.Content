...
<imageEmbed
  ...
  caption={"Bad example - Sharing URL via Share email invite"}
...
<imageEmbed
  ...
  caption={"Good example - Get URL from SharePoint top bar"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Get URL by right-clicking a file in SharePoint"}
...
<imageEmbed
  ...
  caption={"OK example - Set file sharing permission to \"People with existing access\" each time you share"}
