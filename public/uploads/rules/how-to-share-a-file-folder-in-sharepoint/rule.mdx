...
<imageEmbed
  ...
  figureText={"Bad example - Sharing URL via Share email invite"}
...
<imageEmbed
  ...
  figureText={"Good example - Get URL from SharePoint top bar"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Get URL by right-clicking a file in SharePoint"}
...
<imageEmbed
  ...
  figureText={"OK example - Set file sharing permission to \"People with existing access\" each time you share"}
