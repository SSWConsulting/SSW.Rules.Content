...
created: 2025-10-16 16:49:00+00:00
...
- `add-missing-semicolon.md`
  ...
  captionText={"Bad Example - Too many documentation files for trivial changes creates noise and makes important documentation harder to find"}
/>
...
- `20250115-DM-02-add-tenant-isolation-integration-tests.md`
  ...
  captionText={"Good Example - Clear, organized, and meaningful documentation that's easy to navigate and understand"}
/>
