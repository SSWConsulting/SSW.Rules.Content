...
- `add-missing-semicolon.md`
  ...
  figurePrefix="bad"
  figure="Too many documentation files for trivial changes creates noise and makes important documentation harder to find"
/>
...
- `20250115-DM-02-add-tenant-isolation-integration-tests.md`
  ...
  figurePrefix="good"
  figure="Clear, organized, and meaningful documentation that's easy to navigate and understand"
/>
