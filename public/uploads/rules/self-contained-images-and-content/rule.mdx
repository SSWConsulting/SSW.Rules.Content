...
seoDescription: Best practices for keeping your content and images self-contained
  in TinaCMS + Next.js, with three options and a recommended setup.
tips: ''
...
You can find more details on [this repository](https://github.com/tinacms/demo-storing-images-and-content-together) (archived July 2025, but still available for reference)
...
**Note:** This approach is not officially supported by the TinaCMS core team but is widely used in the community.
