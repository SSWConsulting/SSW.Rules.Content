...
<imageEmbed
  ...
  captionText={"Option 2 - Folder structure - rules example"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Option 3 - Folder structure - rules example"}
