...
lastUpdated: 2026-08-18T03:13:43.938Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Option 2 - Folder structure - rules example" src="/uploads/rules/self-contained-images-and-content/option-2-structure.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Option 3 - Folder structure - rules example" src="/uploads/rules/self-contained-images-and-content/option-3-structure.png" />
