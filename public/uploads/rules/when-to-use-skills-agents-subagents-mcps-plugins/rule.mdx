...
lastUpdated: 2026-02-18T03:20:54.277Z
...
Skills are reusable prompts and scripts that standardize how AI approach a repeatable procedure. Like AGENTS.md, skills also use markdown files, but their purpose is to be situationally invoked when relevant and be portable across codebases.
