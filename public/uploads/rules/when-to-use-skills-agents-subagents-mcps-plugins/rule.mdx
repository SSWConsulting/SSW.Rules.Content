...
lastUpdated: 2026-02-17T06:18:36.165Z
...
<boxEmbed
  body={<>
    **Use Case:** You want your agent to query your internal SQL database. You install an SQL MCP server to your agent, and it is able to interact with the database.
  </>}
  figurePrefix="none"
  figure=""
  style="greybox"
