...
lastUpdated: 2026-02-18T06:33:49.534Z
...
<boxEmbed
  body={<>
    Concepts/terms such as reusable prompts, and custom slash commands have since been superseded by skills, which acts as an open standard for achieving the same result more efficiently.
  </>}
  figurePrefix="none"
  figure=""
  style="info"
