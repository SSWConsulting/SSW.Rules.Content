...
<boxEmbed
  body={<>
    `AGENTS.md` is the cross-platform convention for providing project context to most AI coding tools. However, some tools still use their own file e.g. Claude Code uses `CLAUDE.md`
