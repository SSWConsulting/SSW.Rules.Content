...
lastUpdated: 2026-02-17T06:17:48.487Z
...
<boxEmbed
  body={<>
    **Use Case:** You want your agent to query your internal Postgres database. You install a Postgres MCP server to your agent, and it is able to interact with the database.
  </>}
  figurePrefix="none"
  figure=""
  style="greybox"
