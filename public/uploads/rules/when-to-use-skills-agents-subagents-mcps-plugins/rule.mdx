...
lastUpdated: 2026-02-18T04:07:23.997Z
...
At its core, skills are folders that contain a SKILL.md file. This file includes metadata such as its name, description, and a set of instructions that tell an agent how to perform a specific task. Skills can also bundle together scripts, templates, and reference material.
