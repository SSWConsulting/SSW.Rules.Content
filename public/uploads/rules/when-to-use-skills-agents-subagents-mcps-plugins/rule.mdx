...
lastUpdated: 2026-02-18T00:21:05.409Z
...
This reduces the fluff inside of the main conversation window, with the primary process only receiving summaries of results of the subagents.
...
Skills are reusable prompts that standardize how AI approach a repeatable procedure. Like AGENTS.md, skills are also markdown files, but their purpose is to be situationally invoked when relevant and be portable across codebases.
