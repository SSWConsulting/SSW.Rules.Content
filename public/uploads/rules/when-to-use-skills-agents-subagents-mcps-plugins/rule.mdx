---
title: 'Do you know when to use agents, subagents, skills, and MCPs?'
...
lastUpdated: 2026-02-20T01:27:58.962Z
lastUpdatedBy: Sam Wagner
lastUpdatedByEmail: SamWagner@ssw.com.au
---

AI coding tools like Claude Code, GitHub Copilot, and OpenCode offer several ways to extend their capabilities: **skills**, **custom agents**, **subagents**, and **MCP servers**. Each solves a different problem, and choosing the wrong one can introduce unnecessary complexity or limitations. Knowing which mechanism to use saves time and keeps your setup maintainable.
...
<boxEmbed
  body={<>
    **Use Case:** You need to implement a new feature on your website that touches your whole tech stack. Using a single agent here is great, as it can hold all of the context needed to build that feature well.
  </>}
  figurePrefix="none"
  figure=""
/>
...
<boxEmbed
  body={<>
    ...
    **Example:** During a large refactor, one subagent scans backend APIs, another reviews frontend components, and a third checks tests. Each works independently and returns summaries to the main agent for consolidation.
  </>}
  figurePrefix="none"
  figure=""
  style="greybox"
