...
lastUpdated: 2026-02-17T05:59:32.406Z
...
Use Case: In a monorepo with React frontend and Python backend. Each directory has an AGENTS.md tells agents the local rules: "use pytest," "all routes need auth middleware." This allows the context to be injected into every conversation, introducing consistency without requiring users to repeat themselves constantly.
