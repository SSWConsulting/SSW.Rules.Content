...
lastUpdated: 2026-02-18T06:32:41.332Z
...
<boxEmbed
  body={<>
    Concepts such as GitHub Copilot instruction files, reusable prompts, and custom slash commands have since been superseded by skills, which acts as an open standard for achieving the same result more efficiently.
  </>}
  figurePrefix="none"
  figure=""
  style="info"
