...
<imageEmbed
  ...
  caption={"Bad example - This does display decimal place"}
...
<imageEmbed
  ...
  caption={"Good example - This avoid displaying decimal place"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Add a parameter to set the decimal places format"}
