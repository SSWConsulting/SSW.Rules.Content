...
<imageEmbed
  ...
  captionText={"Bad example - This does display decimal place"}
...
<imageEmbed
  ...
  captionText={"Good example - This avoid displaying decimal place"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Add a parameter to set the decimal places format"}
