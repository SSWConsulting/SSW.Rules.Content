...
<imageEmbed
  ...
  figureText={"Bad example - This does display decimal place"}
...
<imageEmbed
  ...
  figureText={"Good example - This avoid displaying decimal place"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Add a parameter to set the decimal places format"}
