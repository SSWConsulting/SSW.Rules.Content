...
created: 2021-10-15T06:12:32.419Z
createdBy: Luke Parker
createdByEmail: 10430890+Hona@users.noreply.github.com
lastUpdated: 2026-05-20T06:41:12.222Z
...
* [Selenium](https://www.selenium.dev/) (was the gold standard)
* Several others: [Telerik Test Studio](https://www.telerik.com/teststudio/), [Cypress](https://www.cypress.io/), or [Puppeteer](https://pptr.dev/), to name a few.

#### Playwright

<boxEmbed
  body={<>
    With the latest AI tooling, Playwright can now be connected via **MCP**, **CLI**, and **specialized Test Agents** to help write better UI tests.
