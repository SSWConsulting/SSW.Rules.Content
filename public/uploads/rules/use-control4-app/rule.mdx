...
<imageEmbed
  ...
  figureText={"Bad example - Using any pysical remote control instead of the Control4 app"}
...
<imageEmbed
  ...
  figureText={"Good Example - Turning on the air conditioner using Control4"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="default"
  figureText={"SSW reception controls"}
