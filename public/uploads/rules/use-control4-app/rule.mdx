...
<imageEmbed
  ...
  caption={"Bad example - Using any pysical remote control instead of the Control4 app"}
...
<imageEmbed
  ...
  caption={"Good Example - Turning on the air conditioner using Control4"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  caption={"SSW reception controls"}
