...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="Data Annotation attributes decorate model properties to make them required"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This razor view binds to a strongly typed model object and uses HTML helpers."
