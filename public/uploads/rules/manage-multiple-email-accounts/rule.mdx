...
<imageEmbed
  ...
  captionText={"Bad example - No one knows who made the purchase"}
...
<imageEmbed
  ...
  captionText={"Change the sender to personal email"}
...
<imageEmbed
  ...
  captionText={"Good example - Reply from your personal email, then keep the public email cc'd so the thread is tracked"}
