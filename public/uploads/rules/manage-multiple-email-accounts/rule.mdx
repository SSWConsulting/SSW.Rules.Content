...
<imageEmbed
  ...
  figureText={"Bad example - No one knows who made the purchase"}
...
<imageEmbed
  ...
  figureText={"Change the sender to personal email"}
...
<imageEmbed
  ...
  figureText={"Good example - Reply from your personal email, then keep the public email cc'd so the thread is tracked"}
