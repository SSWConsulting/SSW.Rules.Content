...
archivedreason: Deprecated by Microsoft - It is recommended to use a [screen recorder
  instead](https://www.ssw.com.au/rules/recording-screen). See [the deprecation info](https://prod.support.services.microsoft.com/en-us/windows/steps-recorder-deprecation-a64888d7-8482-4965-8ce3-25fb004e975f).
authors:
