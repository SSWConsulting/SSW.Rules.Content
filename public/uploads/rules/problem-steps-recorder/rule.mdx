...
<imageEmbed
  ...
  caption={"To start Problem Steps recorder, type PSR into the start | run box"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"then click 'Start Record'"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"User behavior is captured along with full screenshots. This can be saved and attached to a Bug PBI"}
