...
<imageEmbed
  ...
  captionText={"To start Problem Steps recorder, type PSR into the start | run box"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"then click 'Start Record'"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"User behavior is captured along with full screenshots. This can be saved and attached to a Bug PBI"}
