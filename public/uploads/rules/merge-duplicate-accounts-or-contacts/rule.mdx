...
isArchived: false
lastUpdated: 2018-03-26 23:00:13+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example – a developer would not know which record to use to track timesheets against"}
...
<imageEmbed
  ...
  figureText={"Good Example – records merged to remove duplicates"}
