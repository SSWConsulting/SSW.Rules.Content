...
<imageEmbed
  ...
  captionText={"Bad Example – a developer would not know which record to use to track timesheets against"}
...
<imageEmbed
  ...
  captionText={"Good Example – records merged to remove duplicates"}
