...
lastUpdated: 2026-01-09T02:04:21.997Z
lastUpdatedBy: Mike
...
### Structure your tender content as modular attachments

In addition to maintaining a comprehensive master tender document, structure your content so it can be broken into short, standalone attachments. These attachments can then be selectively included depending on the requirements of each tender.

Rather than forcing every submission to include a large, monolithic document, create focused attachments that cover common tender areas. This allows the submission writer to choose only what is relevant, keeps responses concise, and avoids overwhelming evaluators with unnecessary material.

#### Typical attachments may include (but are not limited to):

* Company Overview – background, values, governance, certifications
* Services & Delivery – service offerings, delivery approach, methodologies
* Support & Maintenance – SLAs, support model, escalation paths
* Security & Compliance – security posture, policies, standards, risk management
* Financial & Commercial – pricing models, commercial terms, financial stability
* Case Studies & References – relevant experience and outcomes
* Team & Capability – key personnel, skills, and certifications

Each attachment should be:

Short and focused on a single theme Able to stand alone if submitted independently, Versioned, branded, and kept up to date.

This approach aligns with the goal of creating reusable tender content, while giving flexibility to tailor each submission precisely to the client’s evaluation criteria. It reduces duplication, improves consistency across tenders, and makes it easier to respond quickly and professionally.
