...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A hand-drawn mockup. Nice and quick for early concept design"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Example of wireframes (created in Figma)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="High fidelity mockup for SSW Rewards App - recommended as quick to update when changes are requested"
