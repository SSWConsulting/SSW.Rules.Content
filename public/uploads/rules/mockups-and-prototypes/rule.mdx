...
created: 2023-09-04 07:37:31.732000+00:00
...
<imageEmbed
  ...
  figureText={"Good Example - A hand-drawn mockup. Nice and quick for early concept design"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – Example of wireframes (created in Figma)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – High fidelity mockup for SSW Rewards App - recommended as quick to update when changes are requested"}
