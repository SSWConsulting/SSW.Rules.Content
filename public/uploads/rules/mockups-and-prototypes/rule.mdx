...
<imageEmbed
  ...
  captionText={"Good Example - A hand-drawn mockup. Nice and quick for early concept design"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – Example of wireframes (created in Figma)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – High fidelity mockup for SSW Rewards App - recommended as quick to update when changes are requested"}
