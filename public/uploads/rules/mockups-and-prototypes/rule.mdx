...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="A hand-drawn mockup. Nice and quick for early concept design" src="/uploads/rules/mockups-and-prototypes/handdrawnui.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Example of wireframes (created in Figma)" src="/uploads/rules/mockups-and-prototypes/figma_wireframe_app_screenshot.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="High fidelity mockup for SSW Rewards App - recommended as quick to update when changes are requested" src="/uploads/rules/mockups-and-prototypes/high-fedelity-ui.png" />
...
<youtubeEmbed url="https://www.youtube.com/embed/-d6zNGeF59M" description="Video: Figma Tutorial: Prototyping & Transitions (4 min)" />
