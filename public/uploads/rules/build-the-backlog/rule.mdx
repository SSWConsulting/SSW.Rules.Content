...
seoDescription: Does your Product Owner know how to maintain a backlog effectively
  by recording conversations as Product Backlog Items (PBIs) or Issues?
...
<imageEmbed
  ...
  figureText={"Get typing during a conversation to make the meeting tangible"}
...
<imageEmbed
  ...
  figureText={"Bad example - This is a poor way to add a PBI/Issue as you can’t order emails by the business priority"}
...
<imageEmbed
  ...
  figureText={"Good example - Github Issues"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Azure DevOps allows you to enter an item into the backlog, in any priority order"}
