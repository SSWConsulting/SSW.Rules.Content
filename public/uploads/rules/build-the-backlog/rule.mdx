...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This is a poor way to add a PBI/Issue as you can’t order emails by the business priority"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Azure DevOps allows you to enter an item into the backlog, in any priority order"
