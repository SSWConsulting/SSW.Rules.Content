---
archivedreason: Outdated - Applies to upgrading TFS 2010 to TFS 2012 (end-of-life). For modern guidance, see [Steps required when migrating to the cloud](/steps-required-when-migrating-to-the-cloud).
authors:
- title: Damian Brady
  url: https://www.ssw.com.au/people/damian-brady
created: 2012-06-11 00:04:57+00:00
...
seoDescription: Upgrading TFS 2010 databases to a new environment with Team Foundation
  Server 2012 or Update 1.
