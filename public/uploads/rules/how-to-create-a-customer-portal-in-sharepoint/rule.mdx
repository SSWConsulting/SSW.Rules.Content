...
<imageEmbed
  ...
  caption={"The first step to creating a 'Customer Portal' is to select 'Manage Content and Structure' to view site collection"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Fill in the appropriate info then click \"Create\""}
...
<imageEmbed
  ...
  caption={"Create a 'new group' or select an 'existing group' for the newly created site"}
