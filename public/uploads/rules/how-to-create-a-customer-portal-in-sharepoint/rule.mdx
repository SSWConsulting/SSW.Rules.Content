...
- do-you-know-how-to-create-a-customer-portal-in-sharepoint
- do-you-know-how-to-create-a-customer-portal-(in-sharepoint)
seoDescription: Discover how to create a Customer Portal in SharePoint for seamless
...
<imageEmbed
  ...
  figureText={"The first step to creating a 'Customer Portal' is to select 'Manage Content and Structure' to view site collection"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Fill in the appropriate info then click \"Create\""}
...
<imageEmbed
  ...
  figureText={"Create a 'new group' or select an 'existing group' for the newly created site"}
