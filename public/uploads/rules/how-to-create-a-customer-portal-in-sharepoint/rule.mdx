...
isArchived: false
lastUpdated: 2022-05-16 22:37:39+00:00
...
<imageEmbed
  ...
  captionText={"The first step to creating a 'Customer Portal' is to select 'Manage Content and Structure' to view site collection"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Fill in the appropriate info then click \"Create\""}
...
<imageEmbed
  ...
  captionText={"Create a 'new group' or select an 'existing group' for the newly created site"}
