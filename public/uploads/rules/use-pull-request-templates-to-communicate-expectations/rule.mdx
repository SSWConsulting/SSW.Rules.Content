...
<imageEmbed
  ...
  captionText={"Bad example - There is no information to guide developers"}
...
<imageEmbed
  ...
  captionText={"OK example - The PR template contains handy links to guidance for creating great PRs ⭐"}
...
<imageEmbed
  ...
  captionText={"Good example - This PR template asks for context (to help reviewers), along with guidance links for creating great PRs ⭐"}
