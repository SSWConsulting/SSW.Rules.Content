...
<imageEmbed
  ...
  caption={"Bad example - Never share secrets using email"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Email + SMS is better but still insecure"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - One Time Secret sharing via a 3rd party is better"}
...
<imageEmbed
  ...
  caption={"Good example - Create a One Time Secret using Keeper Enterprise"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Generate an email, link or QR Code directly from Keeper Enterprise"}
