...
<imageEmbed
  ...
  captionText={"Bad example - Never share secrets using email"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Email + SMS is better but still insecure"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - One Time Secret sharing via a 3rd party is better"}
...
<imageEmbed
  ...
  captionText={"Good example - Create a One Time Secret using Keeper Enterprise"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Generate an email, link or QR Code directly from Keeper Enterprise"}
