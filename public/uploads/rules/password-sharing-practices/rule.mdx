...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Never share secrets using email"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Email + SMS is better but still insecure"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="One Time Secret sharing via a 3rd party is better"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Create a One Time Secret using Keeper Enterprise"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Generate an email, link or QR Code directly from Keeper Enterprise"
