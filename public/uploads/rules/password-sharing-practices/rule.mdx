...
created: 2023-02-01 10:45:51.141000+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Never share secrets using email"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Email + SMS is better but still insecure"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - One Time Secret sharing via a 3rd party is better"}
...
<imageEmbed
  ...
  figureText={"Good example - Create a One Time Secret using Keeper Enterprise"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Generate an email, link or QR Code directly from Keeper Enterprise"}
