...
<imageEmbed
  ...
  captionText={"The developer thinks \"what could be wrong\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The developer tests then replies \"Works on my machine\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Adam makes all his new developers swear in and repeat this"}
