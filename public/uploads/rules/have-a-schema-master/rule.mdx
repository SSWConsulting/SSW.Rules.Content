...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"One person should be the 'Schema Master', on an average sized project (of 5-10 devs)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The Applications Database stores version info in a table called _zsVersion"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Only a \"Schema Master\" checks in the .sql files"}
