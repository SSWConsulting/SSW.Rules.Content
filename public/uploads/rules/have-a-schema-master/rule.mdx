...
<imageEmbed
  ...
  figureText={"The db_owner role is granted for one person only – the \"Schema Master\""}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"One person should be the 'Schema Master', on an average sized project (of 5-10 devs)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The Applications Database stores version info in a table called _zsVersion"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Only a \"Schema Master\" checks in the .sql files"}
