...
<imageEmbed
  ...
  caption={"The db_owner role is granted for one person only – the \"Schema Master\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"One person should be the 'Schema Master', on an average sized project (of 5-10 devs)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The Applications Database stores version info in a table called _zsVersion"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Only a \"Schema Master\" checks in the .sql files"}
