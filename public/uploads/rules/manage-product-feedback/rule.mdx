...
<imageEmbed
  ...
  captionText={"Using GitHub Discussions to gather feedback for Next.js"}
...
<imageEmbed
  ...
  captionText={"Google Trends shows that \"UserVoice\" is declining in popularity (see trend line), while \"GitHub Discussions\" is slowly growing"}
