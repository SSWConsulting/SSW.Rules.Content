...
**Subtitle:** How AI Innovations Are Transforming Industries and Society
  ...
  captionText={"Bad example - Inconsistency on words' capitalization and capitalized subtitle"}
/>
...
**Subtitle:**  How AI innovations are transforming industries and society
  ...
  captionText={"Good example - Consistent and correct capilalization on title and subtitle"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - The main title has capitalization and the subtitles don't"}
