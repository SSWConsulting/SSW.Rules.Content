...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="It looks and feels like an app" src="/uploads/rules/install-chatgpt-as-an-app/chatgpt-app-4.png" />
