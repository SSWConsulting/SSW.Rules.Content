...
lastUpdated: 2026-09-24T07:38:56.524Z
...
<youtubeEmbed url="https://www.youtube.com/watch?v=F3YXg7AaKWE" description="Jev is incredible | Theo - t3.gg (Watch from 3:01 - 7:42)" />
...
<imageEmbed alt="Image" size="medium" showBorder={false} figurePrefix="none" figure="Duplicate PBI checker - on TinaCMS" src="/uploads/rules/system-1-vs-system-2-ai/Screenshot-2026-09-24-at-5.13.20-pm.png" />

Find it here: [https://github.com/tinacms/tinacms/actions/workflows/dedupe-issue.yml](https://github.com/tinacms/tinacms/actions/workflows/dedupe-issue.yml)
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="ChatGPT fighting Jev 🤖" src="/uploads/rules/system-1-vs-system-2-ai/Neon-AI-Mascot-Showdown.png" />
...
* **Measure 3 things** - Accuracy, p50/p95 latency, and cost per 1,000 calls
