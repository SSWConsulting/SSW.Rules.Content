...
created: 2023-07-06 23:11:00+00:00
...
<imageEmbed
  ...
  figureText={"Numbering tasks in PBIs works but isn't fully utilizing the platform"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"You can click the tasks toolbar button or simple type in a task which is recognized as \"- [ ]\""}
...
<imageEmbed
  ...
  figureText={"OK example - Using tasks we can easily see which are completed"}
...
<imageEmbed
  ...
  figureText={"Good example - Create issues from tasks to get an immutable reference"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"When you have more checkboxes, e.g. for bug reports. Your task indicator will not be accurate"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Using tasklist requires a little extra markdown around your checkboxes"}
