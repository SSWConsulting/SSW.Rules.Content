...
isArchived: false
lastUpdated: 2023-09-25 06:09:10+00:00
...
seoDescription: Use tasklists to organize and track progress of PBIs effectively,
  avoiding unintentional tasks and promoting a clear visual representation of completed
  tasks.
...
<imageEmbed
  ...
  captionText={"Numbering tasks in PBIs works but isn't fully utilizing the platform"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"You can click the tasks toolbar button or simple type in a task which is recognized as \"- [ ]\""}
...
<imageEmbed
  ...
  captionText={"OK example - Using tasks we can easily see which are completed"}
...
<imageEmbed
  ...
  captionText={"Good example - Create issues from tasks to get an immutable reference"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"When you have more checkboxes, e.g. for bug reports. Your task indicator will not be accurate"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Using tasklist requires a little extra markdown around your checkboxes"}
