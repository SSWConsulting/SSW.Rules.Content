...
created: 2024-11-18 00:43:28+00:00
...
<imageEmbed
  ...
  figureText={"Good example - We use QR codes in our banners in conference, making attendees more likely to open the website on their phones"}
...
<imageEmbed
  ...
  figureText={"Bad example - A long URL is impossible to note down"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - A QR code is easier for the audience to quickly scan during a talk"}
