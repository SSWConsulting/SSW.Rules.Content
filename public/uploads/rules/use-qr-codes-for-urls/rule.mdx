...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="We use QR codes in our banners in conference, making attendees more likely to open the website on their phones"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="A long URL is impossible to note down"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A QR code is easier for the audience to quickly scan during a talk"
