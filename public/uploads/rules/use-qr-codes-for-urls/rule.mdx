...
<imageEmbed
  ...
  caption={"Good example - We use QR codes in our banners in conference, making attendees more likely to open the website on their phones"}
...
<imageEmbed
  ...
  caption={"Bad example - A long URL is impossible to note down"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - A QR code is easier for the audience to quickly scan during a talk"}
