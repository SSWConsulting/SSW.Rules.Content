...
<imageEmbed
  ...
  caption={"PR Metrics gives warnings with suggested actions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"It's easy to see at a glance when PRs have been around for a while"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A gentle reminder helps remind developers the next day that their pull request needs attention"}
