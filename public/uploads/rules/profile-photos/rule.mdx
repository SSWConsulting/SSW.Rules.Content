...
<imageEmbed
  ...
  figureText={"Noise/grain levels increasing as the ISO increases"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Bad example – Subject’s body goes beyond the edges of the white background."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Good example – Subject has all sides within the white background & lit with 3-point lighting."}
...
<imageEmbed
  ...
  figureText={"Good example - 3-point lighting plan"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – A direct and professional look."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – a more dynamic and friendly (but still professional) look."}
