...
<imageEmbed
  ...
  captionText={"Noise/grain levels increasing as the ISO increases"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Bad example – Subject’s body goes beyond the edges of the white background."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Good example – Subject has all sides within the white background & lit with 3-point lighting."}
...
<imageEmbed
  ...
  captionText={"Good example - 3-point lighting plan"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – A direct and professional look."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – a more dynamic and friendly (but still professional) look."}
