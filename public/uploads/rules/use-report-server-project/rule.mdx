...
<imageEmbed
  ...
  captionText={"Bad example – C# project with reports opening as XML"}
...
<imageEmbed
  ...
  captionText={"Checking Microsoft Reporting Services Projects is installed"}
...
<imageEmbed
  ...
  captionText={"Good Example – Report Server project with reports opening in the design/preview view"}
