...
lastUpdated: 2026-04-16T01:35:55.710Z
...
Even with [tracking added via GTM](https://measureu.com/track-mailto-email-links-google-analytics-4/) or `gtag.js`, all that can be captured is intent. Whether the user actually composed and sent the email is unknowable.
