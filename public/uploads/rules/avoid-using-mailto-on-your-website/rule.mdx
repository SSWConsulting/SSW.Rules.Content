...
lastUpdated: 2026-04-17T04:31:52.748Z
...
<imageEmbed alt="email address displayed as selectable text with a Copy button" size="medium" showBorder={false} figurePrefix="ok" figure="Show the email as visible text and let users copy it with one click" src="/uploads/rules/avoid-using-mailto-on-your-website/mailto_good-button.jpg" />
...
**🙂 Figure: OK example – Address is copyable, no `mailto:` used**

<boxEmbed
  body={<>
    **Note:** On a mobile-first website, if not using a form, a `mailto:` link is acceptable. Mobile email apps handle `mailto:` well, and **over 41%** of email opens are on mobile. Be sure to obfuscate the email address to avoid spam.
  </>}
  figurePrefix="none"
  figure=""
  style="info"
