...
* Company Icon
* Remembering its size and location - Code sample <mark style="background-color: #CC4141">to come</mark>  in the [SSW .NET Toolkit](https://www.ssw.com.au/ssw/NETToolkit)
...
We have a program called [SSW .NET Toolkit](https://www.ssw.com.au/ssw/NETToolkit) that implements inherited forms.
