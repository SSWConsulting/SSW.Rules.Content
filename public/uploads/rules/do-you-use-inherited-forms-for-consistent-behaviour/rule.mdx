...
created: 2024-03-18T17:56:02.000Z
...
<imageEmbed
  ...
  captionText={"Base Form for all SSW applications with SSW icon"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Base data entry form with menu, toolbar and OK, Cancel & Apply buttons"}
