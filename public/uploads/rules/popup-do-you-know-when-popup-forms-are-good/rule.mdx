...
<imageEmbed
  ...
  caption={"Bad example - if this was a popup form it would be easier to focus on where to look (as a minimum you would be looking at half the screen)"}
...
<imageEmbed
  ...
  caption={"Good example - the popup with the dimmed background is much more intuitive"}
