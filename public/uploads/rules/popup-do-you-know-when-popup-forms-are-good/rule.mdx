...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="If this was a popup form it would be easier to focus on where to look (as a minimum you would be looking at half the screen)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The popup with the dimmed background is much more intuitive"
