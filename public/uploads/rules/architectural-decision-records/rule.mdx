...
created: 2023-06-26 06:03:20.995000+00:00
...
seoDescription: Architectural Decision Records (ADRs) streamline decision-making by
  documenting key choices and rationale, helping teams avoid repetition and aid future
  developers.
...
<imageEmbed
  ...
  captionText={"SSW.CleanArchitecture KB showing all ADRs"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Example of a single ADR from SSW.CleanArchitecture"}
