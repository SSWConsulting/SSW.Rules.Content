...
For all subsequent logins, employ the [`FindAsync(new UserLoginInfo())`](https://learn.microsoft.com/en-us/previous-versions/dn497529(v=vs.108)?redirectedfrom=MSDN) method.
