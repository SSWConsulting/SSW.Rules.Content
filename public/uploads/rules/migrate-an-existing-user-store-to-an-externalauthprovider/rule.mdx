---
seoDescription: Migrating an existing user store to an ExternalAuthProvider, such
  as IdentityServer or Azure AD, requires mapping users and handling pre-existing
  company users and new registrants.
type: rule
...
- author: dhruv-mathur
- author: matt-goldman
created: 2023-10-31 04:31:12.396000+00:00
