...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Unnecessary blank space makes screenshots hard to read"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Focus on what matters makes screenshots clear"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The email is using a screenshot so that is good, but you need to read the text and relate it to the image"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The balloon with text on the screenshot, makes it quicker to understand"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="See 3 balloons were not needed"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Sometimes an arrow is all that is needed"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Arrow might make people think 'chat' and the direction it points are related"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="If you just want to emphasize what you're pointing to, start drawing the arrow from an empty space"
