...
<imageEmbed
  ...
  captionText={"Bad example – Unnecessary blank space makes screenshots hard to read"}
...
<imageEmbed
  ...
  captionText={"Good example – Focus on what matters makes screenshots clear"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example – The email is using a screenshot so that is good, but you need to read the text and relate it to the image"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – The balloon with text on the screenshot, makes it quicker to understand"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example – Balloon overload"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – See 3 balloons were not needed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - Sometimes an arrow is all that is needed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example – Arrow might make people think 'chat' and the direction it points are related"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - If you just want to emphasize what you're pointing to, start drawing the arrow from an empty space"}
