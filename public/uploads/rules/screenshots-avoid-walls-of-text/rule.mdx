...
created: 2009-03-25 05:07:01+00:00
...
<imageEmbed
  ...
  figureText={"Bad example – Unnecessary blank space makes screenshots hard to read"}
...
<imageEmbed
  ...
  figureText={"Good example – Focus on what matters makes screenshots clear"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – The email is using a screenshot so that is good, but you need to read the text and relate it to the image"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – The balloon with text on the screenshot, makes it quicker to understand"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – Balloon overload"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – See 3 balloons were not needed"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - Sometimes an arrow is all that is needed"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – Arrow might make people think 'chat' and the direction it points are related"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - If you just want to emphasize what you're pointing to, start drawing the arrow from an empty space"}
