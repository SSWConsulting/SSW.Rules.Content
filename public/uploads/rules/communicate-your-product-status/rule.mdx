...
created: 2024-03-25 05:28:50+00:00
...
seoDescription: Stay updated on SugarLearning's product progress, roadmap changes,
  and metrics with our bi-weekly review email.
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Progress for SSW.EagleEye epics in GitHub Projects"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Progress for SugarLearning epics in Azure DevOps"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"A graph helps demonstrate trends affecting the Product"}
...
&lt; Sent as per the rule [https://www.ssw.com.au/rules/communicate-your-product-status/](https://www.ssw.com.au/rules/communicate-your-product-status/) &gt;
  ...
  captionStyle="default"
  captionText={"Template for Product Status Review email"}
/>