...
created: 2024-03-25 10:39:38+00:00
...
<imageEmbed
  ...
  figureText={"Progress for SSW.EagleEye epics in GitHub Projects"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Progress for SugarLearning epics in Azure DevOps"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"A graph helps demonstrate trends affecting the Product"}
...
&lt; Sent as per the rule [https://www.ssw.com.au/rules/communicate-your-product-status/](https://www.ssw.com.au/rules/communicate-your-product-status/) &gt;
  ...
  figurePreset="defaultExample"
  figureText={"Template for Product Status Review email"}
/>