...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "default",
    figure: "For Product Roadmap see &#123;&#123; LINK TO ROADMAP IN AZURE DEVOPS &#125;&#125;",
    shouldDisplay: true
  } }
  src="/uploads/rules/communicate-your-product-status/product-roadmap.png"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "default",
    figure: "Graph of user statistics - users increased from 168 in February to 175 in March",
    shouldDisplay: true
  } }
  src="/uploads/rules/communicate-your-product-status/user-metrics.png"
/>
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "default",
    figure: "Graph of availability - drop in availability due to outage on 10 April",
    shouldDisplay: true
  } }
  src="/uploads/rules/communicate-your-product-status/sugarlearning-availability.png"
/>
