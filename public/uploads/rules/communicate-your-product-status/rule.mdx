...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Progress for SSW.EagleEye epics in GitHub Projects"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Progress for SugarLearning epics in Azure DevOps"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A graph helps demonstrate trends affecting the Product"}
...
&lt; Sent as per the rule [https://www.ssw.com.au/rules/communicate-your-product-status/](https://www.ssw.com.au/rules/communicate-your-product-status/) &gt;
  ...
  captionStyle="default"
  caption={"Template for Product Status Review email"}
/>