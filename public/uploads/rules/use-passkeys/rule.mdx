...
created: 2024-09-17 00:00:00+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Traditional password vulnerable to phishing, are often used across many accounts, and you may forget it over time"}
...
<imageEmbed
  ...
  figureText={"Good example - Passkey authentication is phishing-resistant and convenient (in this example using Windows PIN)"}
...
<imageEmbed
  ...
  figureText={"Passkey created successfully"}
