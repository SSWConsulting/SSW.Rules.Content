...
<imageEmbed
  ...
  caption={"Bad example - Traditional password vulnerable to phishing, are often used across many accounts, and you may forget it over time"}
...
<imageEmbed
  ...
  caption={"Good example - Passkey authentication is phishing-resistant and convenient (in this example using Windows PIN)"}
...
<imageEmbed
  ...
  caption={"Passkey created successfully"}
