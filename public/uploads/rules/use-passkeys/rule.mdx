...
<asideEmbed
  variant="info"
  body={<>
    **Note:** These steps are for a work or school Microsoft account (Microsoft Entra ID). For a personal Microsoft account, please visit your security dashboard at [https://account.microsoft.com/security](https://account.microsoft.com/security).
  </>}
  figureEmbed={{
    preset: "default",
    figure: "XXX",
