...
<imageEmbed
  ...
  captionText={"Bad example - Traditional password vulnerable to phishing, are often used across many accounts, and you may forget it over time"}
...
<imageEmbed
  ...
  captionText={"Good example - Passkey authentication is phishing-resistant and convenient (in this example using Windows PIN)"}
...
<imageEmbed
  ...
  captionText={"Passkey created successfully"}
