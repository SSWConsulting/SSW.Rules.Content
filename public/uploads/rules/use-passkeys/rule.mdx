...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="bad"
  figure="Traditional password vulnerable to phishing, are often used across many accounts, and you may forget it over time"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="Passkey authentication is phishing-resistant and convenient (in this example using Windows PIN)"
