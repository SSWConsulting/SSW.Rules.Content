...
- rule: public/uploads/rules/do-you-know-these-important-git-commands/rule.mdx
seoDescription: Learn why and how to use .gitignore to manage clean repositories.
  Understand key patterns and explore gitignore templates for different projects.
