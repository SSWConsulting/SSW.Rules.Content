...
<imageEmbed
  ...
  captionText={"Display the ICP filing number on bottom of website and link to https://beian.miit.gov.cn/"}
...
<imageEmbed
  ...
  captionText={"The website will be redirected to the exception page without ICP filing"}
