...
<imageEmbed
  ...
  caption={"Bad Example - Click New, enter relevant contact information, and click \"Save and Close\""}
...
<imageEmbed
  ...
  caption={"Good Example - open the Account and create the contact from there"}
