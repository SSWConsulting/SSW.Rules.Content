...
<imageEmbed
  ...
  captionText={"Bad Example - Stop is an ambiguous term and can be momentarily confusing"}
...
<imageEmbed
  ...
  captionText={"Good Example - Cancel leaves little room for miscommunication"}
