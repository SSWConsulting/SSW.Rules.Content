...
<imageEmbed
  ...
  captionText={"Bad example - there is no indication of the total size of the download or                         the percent complete, thus no estimate of how long left"}
...
<imageEmbed
  ...
  captionText={"Good example - percent complete, time left, total size and a progress bar                         are all shown"}
