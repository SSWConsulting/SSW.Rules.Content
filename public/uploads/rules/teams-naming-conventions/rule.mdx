...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example: Client team without the "Client –" prefix](/uploads/rules/teams-naming-conventions/client-naming-bad.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example: Well prefixed Teams make Client-related teams easier to identify](/uploads/rules/teams-naming-conventions/client-naming-good.jpg)',
  shouldDisplay: true
} } />
