...
<imageEmbed
  ...
  captionText={"Bad Example - Long drop down menu requires scrolling and difficult to see at a glance."}
...
<imageEmbed
  ...
  captionText={"Good Example - Links are grouped into distinct category"}
...
<imageEmbed
  ...
  captionText={"Bear in mind that mobile menus are limited"}
