...
<imageEmbed
  ...
  caption={"Bad Example - Long drop down menu requires scrolling and difficult to see at a glance."}
...
<imageEmbed
  ...
  caption={"Good Example - Links are grouped into distinct category"}
...
<imageEmbed
  ...
  caption={"Bear in mind that mobile menus are limited"}
