...
created: 2023-09-04 07:01:43+00:00
...
<imageEmbed
  ...
  captionText={"Reviewing your access is as simple as clicking a link in an email"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Access Reviews | Review type"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Access Review | Stages"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Access Reviews | recurrence & reviewees"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Access Reviews | Upon completion"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Access Reviews | Advanced settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Access Review | Review + Create"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"At the conclusion we see these great stats!!"}
