...
<imageEmbed
  ...
  figureText={"Reviewing your access is as simple as clicking a link in an email"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Access Reviews | Review type"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Access Review | Stages"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Access Reviews | recurrence & reviewees"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Access Reviews | Upon completion"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Access Reviews | Advanced settings"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Access Review | Review + Create"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"At the conclusion we see these great stats!!"}
