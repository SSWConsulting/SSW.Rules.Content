---
archivedreason: Outdated - TFS 2010 migration validation steps reference end-of-life tooling (e.g. VS 2008 Team Explorer). For modern guidance, see [Steps required when migrating to the cloud](/steps-required-when-migrating-to-the-cloud).
isArchived: true
authors:
