...
<imageEmbed
  ...
  caption={"Bad example - your users should never have unhandled exceptions in Windows Forms"}
...
<imageEmbed
  ...
  caption={"Good example - your users get a nice professional error reporting window"}
