...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example: Version 1.0.0.0, No changelog](change-log-bad.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example: Solution has up to date versioning with detailed changelog](change-log-good.png)',
  shouldDisplay: true
} } />
