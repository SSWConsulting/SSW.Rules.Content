...
<boxEmbed
  ...
  figureText={"Bad example - The prompt is vague and lacks context"}
/>
...
<boxEmbed
  ...
  figureText={"Good example - The prompt invites ChatGPT to ask for clarification if needed"}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - using all the tips for a streamlined experience"}
/>
