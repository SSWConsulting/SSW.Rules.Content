...
<boxEmbed
  ...
  captionText={"Bad example - The prompt is vague and lacks context"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - The prompt invites ChatGPT to ask for clarification if needed"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - using all the tips for a streamlined experience"}
/>
