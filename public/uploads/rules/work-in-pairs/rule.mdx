...
<imageEmbed
  ...
  captionText={"Bad example - This is normal ‘pair programming’, two people working at one PC"}
...
<imageEmbed
  ...
  captionText={"Good example - This is ‘working in pairs’, two devs working on the same project, with their own laptops, but sitting very close to each other"}
