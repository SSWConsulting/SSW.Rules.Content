...
<imageEmbed
  ...
  figureText={"Bad example - Does not show the change between the previous and current data"}
...
<imageEmbed
  ...
  figureText={"Good example - Shows the change between the previous and current data"}
