...
seoDescription: >-
  Train your GPT model to unlock its full potential and generate accurate
  responses for complex or highly specific use cases.
created: 2023-07-11T05:29:16.000Z
...
test content change in staging
...
<imageEmbed
  ...
  figureEmbed={{
    preset: "badExample",
    figure:
      "Bad example - The untrained GPT model doesn't know what format to create a rule in",
    shouldDisplay: true
  }}
  src="/uploads/rules/train-gpt/untrainedgpt3badexample.png.png"
/>
...
<imageEmbed
  ...
  figureEmbed={{
    preset: "goodExample",
    figure:
      "Good example - The trained GPT model knows how to format the rule, and the style rules are written in",
    shouldDisplay: true
  }}
  src="/uploads/rules/train-gpt/trainedgpt3goodexample.png"
/>
