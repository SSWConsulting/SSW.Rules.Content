---
seoDescription: Train your GPT model to unlock its full potential and generate accurate
...
- author: jack-reimers
created: 2023-02-08 04:53:29.524000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The untrained GPT model doesn't know what format to create a rule in"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The trained GPT model knows how to format the rule, and the style rules are written in"
