...
<imageEmbed
  ...
  caption={"Bad example - The untrained GPT model doesn't know what format to create a rule in"}
...
<imageEmbed
  ...
  caption={"Good example - The trained GPT model knows how to format the rule, and the style rules are written in"}
