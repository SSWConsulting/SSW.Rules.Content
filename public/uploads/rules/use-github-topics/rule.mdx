...
<imageEmbed
  ...
  figureText={"Searching for repositories by topic"}
...
<imageEmbed
  ...
  figureText={"Bad Example – no repositories tagged with topics on the first page"}
...
<imageEmbed
  ...
  figureText={"Great example – every repository is meticulously tagged with topics"}
