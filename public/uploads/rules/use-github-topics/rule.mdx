...
<imageEmbed
  ...
  captionText={"Searching for repositories by topic"}
...
<imageEmbed
  ...
  captionText={"Bad Example – no repositories tagged with topics on the first page"}
...
<imageEmbed
  ...
  captionText={"Great example – every repository is meticulously tagged with topics"}
