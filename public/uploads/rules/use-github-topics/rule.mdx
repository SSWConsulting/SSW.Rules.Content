...
<imageEmbed
  ...
  caption={"Searching for repositories by topic"}
...
<imageEmbed
  ...
  caption={"Bad Example – no repositories tagged with topics on the first page"}
...
<imageEmbed
  ...
  caption={"Great example – every repository is meticulously tagged with topics"}
