...
<imageEmbed
  ...
  captionText={"Bad Example - Low contrast between disabled and active button styles."}
...
<imageEmbed
  ...
  captionText={"Good Example - High contrast creates distinct visual hierarchy"}
