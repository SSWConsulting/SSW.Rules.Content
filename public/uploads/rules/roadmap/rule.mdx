...
created: 2016-03-18 04:30:18+00:00
...
<imageEmbed
  ...
  figureText={"Good example - A small team might have something like the SophieBot product roadmap"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - A large team might have something like the Microsoft365 product roadmap"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - GitHub maintains their product roadmap using GitHub Projects and GitHub Issues"}
