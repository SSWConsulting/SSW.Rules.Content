...
<imageEmbed
  ...
  captionText={"Good example - A small team might have something like the SophieBot product roadmap"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - A large team might have something like the Microsoft365 product roadmap"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - GitHub maintains their product roadmap using GitHub Projects and GitHub Issues"}
