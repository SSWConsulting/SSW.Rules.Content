...
<imageEmbed
  ...
  caption={"You wouldn't play cricket without protective gear and you shouldn't code without protective tools"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"ReSharper will show Orange when it detects that there is code that could be improved"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"ReSharper will show green when all code is tidy"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"CodeAuditor shows a lot of warnings in this test project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"StyleCop shows a lot of warnings in this test project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Run Code Analysis in Visual Studio"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The Code Analysis results indicate there are 17 items that need fixing"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Start with the Minimum Recommended Rules, and then ratched up."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The suppressions file tells Code Analysis which rules it should disable for specific code blocks"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"SonarQube workflow with Visual Studio and Azure DevOps"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"SonarQube gives you the changes in code analysis results between each check-in"}
