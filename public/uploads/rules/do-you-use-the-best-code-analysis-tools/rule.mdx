...
<imageEmbed
  ...
  figureText={"You wouldn't play cricket without protective gear and you shouldn't code without protective tools"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"ReSharper will show Orange when it detects that there is code that could be improved"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"ReSharper will show green when all code is tidy"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"CodeAuditor shows a lot of warnings in this test project"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"StyleCop shows a lot of warnings in this test project"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Run Code Analysis in Visual Studio"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The Code Analysis results indicate there are 17 items that need fixing"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Start with the Minimum Recommended Rules, and then ratched up."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The suppressions file tells Code Analysis which rules it should disable for specific code blocks"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"SonarQube workflow with Visual Studio and Azure DevOps"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"SonarQube gives you the changes in code analysis results between each check-in"}
