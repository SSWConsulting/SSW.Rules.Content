...
<imageEmbed
  ...
  captionText={"Bad example - The person might spend unnecessary time pondering and then typing a reply"}
...
<imageEmbed
  ...
  captionText={"Good example - The question and options are easy for a busy person to action"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"How to add a Voting Table Loop component in Teams"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - This will result in a confusing spam of messages"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - This easily shows everybody's replies and is editable in real time"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - A small thumbs up can result in a big miscommunication"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Having a live conversation and sending a follow up email makes sure there is no uncertainty"}
