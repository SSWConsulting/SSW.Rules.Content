...
created: 2023-07-10 12:00:00+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - The person might spend unnecessary time pondering and then typing a reply"}
...
<imageEmbed
  ...
  figureText={"Good example - The question and options are easy for a busy person to action"}
...
<imageEmbed
  ...
  figureText={"How to add a Voting Table Loop component in Teams"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - This will result in a confusing spam of messages"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - This easily shows everybody's replies and is editable in real time"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - A small thumbs up can result in a big miscommunication"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Having a live conversation and sending a follow up email makes sure there is no uncertainty"}
