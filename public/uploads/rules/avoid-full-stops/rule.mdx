...
* Sentence three.
  ...
  captionText={"Bad example - Too much punctuation"}
/>
...
* Sentence three
  ...
  captionText={"Good example - Clean with no full stops"}
/>
...
* Sentence seven
  ...
  captionStyle="badExample"
  captionText={"Bad example - A multi-sentence item becomes a mini-paragraph - not ending it with a full stop looks inconsistent"}
/>
...
* Sentence seven
  ...
  captionStyle="goodExample"
  captionText={"Good example - Multi-sentence items should end with a full stop for consistency"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - Full stop at the end can break the link"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - No full stop after the URL"}
/>