...
* Sentence three.
  ...
  caption={"Bad example - Too much punctuation"}
/>
...
* Sentence three
  ...
  caption={"Good example - Clean with no full stops"}
/>
...
* Sentence seven
  ...
  captionStyle="badExample"
  caption={"Bad example - A multi-sentence item becomes a mini-paragraph - not ending it with a full stop looks inconsistent"}
/>
...
* Sentence seven
  ...
  captionStyle="goodExample"
  caption={"Good example - Multi-sentence items should end with a full stop for consistency"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - Full stop at the end can break the link"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - No full stop after the URL"}
/>