...
Subject: **📃 Northwind website - Invoice for March \[WAS: Invoice]**
  ...
  captionText={"Good example - We still retain the origninal subject but now we know it's been changed."}
/>
...
Subject: **🏫 Next Years Conference \[WAS: Field of Study]**
  ...
  captionStyle="goodExample"
  captionText={"Good example - Email subject has been changed as the original topic is no longer relevant."}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Keep your email subject description up-to-date. Sarah Palin isn’t even a governor anymore"}
