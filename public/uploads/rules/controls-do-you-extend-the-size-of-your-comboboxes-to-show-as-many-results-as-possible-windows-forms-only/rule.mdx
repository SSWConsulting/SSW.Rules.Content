...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="You have to scroll to see all the result, and the long results are cut off"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The size of the drop down has been extended to allow user to see as much as possible"
