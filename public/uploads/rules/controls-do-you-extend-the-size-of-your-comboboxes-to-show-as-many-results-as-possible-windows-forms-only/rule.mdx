...
<imageEmbed
  ...
  captionText={"Bad example - You have to scroll to see all the result, and the long results are cut off"}
...
<imageEmbed
  ...
  captionText={"Good example - The size of the drop down has been extended to allow user to see as much as possible"}
