...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Not clear if the author should make the change or not"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Clear that the change should be made before the PR will be approved"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="The reviewer has left a suggestion, but it's up to the author do change or not"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="This change doesn't need to be done now, but should be added to the backlog with a comment in the code"
/>