...
<boxEmbed
  ...
  caption={"Bad example - not clear if the author should make the change or not"}
/>
...
<boxEmbed
  ...
  caption={"Good example - clear that the change should be made before the PR will be approved"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - the reviewer has left a suggestion, but it's up to the author do change or not"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - This change doesn't need to be done now, but should be added to the backlog with a comment in the code"}
/>