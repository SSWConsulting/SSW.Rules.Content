...
created: 2024-10-28 05:54:05+00:00
...
isArchived: false
lastUpdated: 2024-10-28 05:54:05+00:00
...
<boxEmbed
  ...
  captionText={"Bad example - not clear if the author should make the change or not"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - clear that the change should be made before the PR will be approved"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - the reviewer has left a suggestion, but it's up to the author do change or not"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - This change doesn't need to be done now, but should be added to the backlog with a comment in the code"}
/>