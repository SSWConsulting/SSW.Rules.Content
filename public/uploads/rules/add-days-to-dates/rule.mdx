...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="good" figure="Good example - Apple’s date formatting in the top-right corner of the desktop" src="/uploads/rules/add-days-to-dates/apple_date_good_example.png" />
