...
Penny
  ...
  figureText={"Bad example - The team know what dates you're coming, but it's not clear in which days of the week"}
/>
...
Penny
  ...
  figureText={"Good example - Having the day of the week next to the date makes it easy for the team to know exactly when you're visting"}
/>
