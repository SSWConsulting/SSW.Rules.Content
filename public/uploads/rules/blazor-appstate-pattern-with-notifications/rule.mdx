...
seoDescription: Learn how to implement `INotifyPropertyChanged` for efficient state
  management in your Blazor applications.
title: State Management - Do you use the AppState pattern with State Change Notification?
type: rule
