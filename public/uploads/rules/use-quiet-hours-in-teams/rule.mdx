...
<boxEmbed
  ...
  figureText={"Bad Example - Notifications during personal time without Quiet Hours enabled"}
/>
...
<boxEmbed
  ...
  figureText={"Good Example - Quiet Hours helps maintain boundaries for better work-life balance"}
/>
