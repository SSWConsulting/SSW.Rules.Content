...
<boxEmbed
  style="greybox"
  body={<>
    ❌ Using Interactive Server for everything "because it's easier"<br />
    ❌ Using WebAssembly for pages that need server data access<br />
    ❌ Not considering the user's network reliability<br />
    ❌ Ignoring the ~2-3 MB initial download cost of WASM<br />
