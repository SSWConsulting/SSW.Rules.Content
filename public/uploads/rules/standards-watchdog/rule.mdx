...
lastUpdated: 2026-03-10T01:30:45.434Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Receiving corrections is never easy and often received more harshly than the giver intended" src="/uploads/rules/standards-watchdog/watchdog-mean.jpg" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Go super gentle when people make mistakes. Correct them as though they’re a soft cute puppy 🐶" src="/uploads/rules/standards-watchdog/watchdog-watchdog.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Seeing a mistake and not pointing it out doesn't improve a person. Allow them to benefit from your experience!" src="/uploads/rules/standards-watchdog/watchdog-ghost.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="The example prompt generates a fun email" src="/uploads/rules/standards-watchdog/Correct-someone-nicely.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Be thankful... it all helps you to improve" src="/uploads/rules/standards-watchdog/watchdog-thankyou.jpg" />
...
<emailEmbed
  ...
  figurePrefix="good"
  figure="Nicely informing of a standards violation"
/>
