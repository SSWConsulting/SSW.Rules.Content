...
<imageEmbed
  ...
  caption={"Bad example - Receiving corrections is never easy and often received more harshly than the giver intended"}
...
<imageEmbed
  ...
  caption={"Good example - Go super gentle when people make mistakes. Correct them as though they’re a soft cute puppy 🐶"}
...
1. Please fix asap
  ...
  captionStyle="goodExample"
  caption={"Good example - Nicely informing of a critical mistake"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Seeing a mistake and not pointing it out doesn't improve a person. Allow them to benefit from your experience!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"The example prompt generates a fun email"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Be thankful... it all helps you to improve"}
...
John
  ...
  captionStyle="goodExample"
  caption={"Good example - Nicely informing of a standards violation"}
/>