...
created: 2009-03-10 07:08:39+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Receiving corrections is never easy and often received more harshly than the giver intended"}
...
<imageEmbed
  ...
  figureText={"Good example - Go super gentle when people make mistakes. Correct them as though they’re a soft cute puppy 🐶"}
...
1. Please fix asap
  ...
  figureText={"Good example - Nicely informing of a critical mistake"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Seeing a mistake and not pointing it out doesn't improve a person. Allow them to benefit from your experience!"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"The example prompt generates a fun email"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Be thankful... it all helps you to improve"}
...
John
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Nicely informing of a standards violation"}
/>