...
<imageEmbed
  ...
  captionText={"Bad example - Users would expect all these hyperlinks to work the same way"}
...
<imageEmbed
  ...
  captionText={"Good example - The PDF icon indicates one of the links is not a webpage"}
