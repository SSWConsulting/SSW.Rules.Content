...
created: 2015-02-16 02:46:02+00:00
...
| **PDF**                                                           | [This is a PDF file](/uploads/rules/use-icons-to-not-surprise-users/Sample-PDF.pdf)                                             | ![](/uploads/rules/use-icons-to-not-surprise-users/pdf-icon.png)       |
| **DOC**                                                           | [This is a Word Document file](/uploads/rules/use-icons-to-not-surprise-users/Sample-DOC.docx)                                  | ![](/uploads/rules/use-icons-to-not-surprise-users/docx-icon.png)      |
| **XLS**                                                           | [This is an Excel Spreadsheet file](/uploads/rules/use-icons-to-not-surprise-users/Sample-XLS.xlsx)                             | ![](/uploads/rules/use-icons-to-not-surprise-users/xls-file.png)       |
| **PPT**                                                           | [This is a PowerPoint file](/uploads/rules/use-icons-to-not-surprise-users/Sample-PPT.pptx)                                     | ![](/uploads/rules/use-icons-to-not-surprise-users/ppt-file.png)       |
| **TXT**                                                           | [This is a text file](/uploads/rules/use-icons-to-not-surprise-users/Sample-TXT.txt)                                            | ![](/uploads/rules/use-icons-to-not-surprise-users/txt-file.png)       |
...
| **ZIP**                                                           | [This is a zip file](/uploads/rules/use-icons-to-not-surprise-users/Sample-ZIP.zip)                                             | ![](/uploads/rules/use-icons-to-not-surprise-users/zip-file.png) |
...
<imageEmbed
  ...
  figureText={"Bad example - Users would expect all these hyperlinks to work the same way"}
...
<imageEmbed
  ...
  figureText={"Good example - The PDF icon indicates one of the links is not a webpage"}
