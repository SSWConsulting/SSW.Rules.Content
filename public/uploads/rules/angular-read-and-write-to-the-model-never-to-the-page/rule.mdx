...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Using jQuery on Angular views will lead to worlds of pain"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="In both AngularJs & Angular 2.0 jQuery is not required on the view. The view binds to properties on a JavaScript model"
