...
<boxEmbed
  ...
  caption={"Bad example #1 - Generic words on links won't help your website rankings"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example #2 - Generic words on links won't help your website rankings"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example #3 - Generic words on links won't help your website rankings"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example #4 - Whole URL on links won't help your users"}
/>
...
<boxEmbed
  ...
  caption={"Good example - Descriptive links will help your website rankings and the users"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Give users context with a link at the end to get more information on the topic"}
/>
