...
/1.0.0.356
  ...
  caption={"Bad example - SVN conventions are a dated and ignore releases, hotfixes and Service Packs"}
/>
...
<imageEmbed
  ...
  caption={"Good example - This makes a lot more sense"}
...
<imageEmbed
  ...
  caption={"A good format for all your Products/Projects makes it easy to know where things are and what they are for"}
