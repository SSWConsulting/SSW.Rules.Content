...
<imageEmbed
  ...
  caption={"A Typical ASP.NET Controller using Mediator"}
...
<imageEmbed
  ...
  caption={"Bad Example - The request is contained within CreateProductCommand.cs"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad Example - The request handler is contained within CreateProductCommandHandler.cs"}
...
<imageEmbed
  ...
  caption={"Good Example - Nesting the Request Handler within the Request Improves Discoverability of Command and Associated Command Logic"}
