...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The request is contained within CreateProductCommand.cs"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The request handler is contained within CreateProductCommandHandler.cs"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Nesting the Request Handler within the Request Improves Discoverability of Command and Associated Command Logic"
