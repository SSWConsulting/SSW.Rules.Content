...
<imageEmbed
  ...
  figureText={"Good Example - SSW Link Auditor Wizard's                                 better flow of information"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - SSW Code Auditor Wizard featuring                                 \"Start\" and \"Skip\" options"}
