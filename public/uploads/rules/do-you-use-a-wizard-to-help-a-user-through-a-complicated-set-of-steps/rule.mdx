...
<imageEmbed
  ...
  caption={"Good Example - SSW Link Auditor Wizard's                                 better flow of information"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - SSW Code Auditor Wizard featuring                                 \"Start\" and \"Skip\" options"}
