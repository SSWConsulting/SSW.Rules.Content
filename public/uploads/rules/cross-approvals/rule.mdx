...
lastUpdated: 2026-05-13T09:18:05.804Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Approval hell!" src="/uploads/rules/cross-approvals/approval-hell.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Scaled approvals - The group of people in charge of a cross approval are called a XXX Master" src="/uploads/rules/cross-approvals/cross-approvals.png" />
...
### 1. Identify - Find tasks causing "approval hell"
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Adam approves the completion of everyone's induction" src="/uploads/rules/cross-approvals/induction-bad.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="There are 10 Induction Masters responsible for approving everyone's induction - in this case I would start with Brady" src="/uploads/rules/cross-approvals/induction-good.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Read the employee instructions to see how to get it approved" src="/uploads/rules/cross-approvals/v2-bench-masters-good.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="A report tracking how many approvals people do from the Teams Approvals app (structured data). Inside the form there are the right people to approve" src="/uploads/rules/cross-approvals/teams-approvals-report.jpg" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Instead of using an approvals app, this is a report tracking how many approvals people do from company emails (unstructured data). Each person needs to first manually look up who is the employee responsible for approving the email" src="/uploads/rules/cross-approvals/eagle-eye-report.jpg" />
