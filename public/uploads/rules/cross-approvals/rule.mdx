...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Scaled approvals - The group of people in charge of a cross approval are called a XXX Master"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Adam approves the completion of everyone's induction"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="There are 10 Induction Masters responsible for approving everyone's induction - in this case I would start with Brady"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Read the employee instructions to see how to get it approved"
