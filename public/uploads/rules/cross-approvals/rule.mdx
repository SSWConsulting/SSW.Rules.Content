...
<imageEmbed
  ...
  caption={"Bad example - Approval hell!"}
...
<imageEmbed
  ...
  caption={"Good example - Scaled approvals - The group of people in charge of a cross approval are called a XXX Master"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Adam approves the completion of everyone's induction"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - There are 10 Induction Masters responsible for approving everyone's induction - in this case I would start with Brady"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Read the employee instructions to see how to get it approved"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A report tracking how many approvals people do from the Teams Approvals app (structured data). Inside the form there are the right people to approve"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Instead of using an approvals app, this is a report tracking how many approvals people do from company emails (unstructured data). Each person needs to first manually look up who is the employee responsible for approving the email"}
