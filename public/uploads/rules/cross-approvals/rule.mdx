...
created: 2023-08-14 10:45:45+00:00
...
isArchived: false
lastUpdated: 2025-06-18 05:18:04+00:00
...
seoDescription: Cross-approvals - Streamline your company's aspproval process with
  expert guidance.
...
<imageEmbed
  ...
  captionText={"Bad example - Approval hell!"}
...
<imageEmbed
  ...
  captionText={"Good example - Scaled approvals - The group of people in charge of a cross approval are called a XXX Master"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Adam approves the completion of everyone's induction"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - There are 10 Induction Masters responsible for approving everyone's induction - in this case I would start with Brady"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Read the employee instructions to see how to get it approved"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"A report tracking how many approvals people do from the Teams Approvals app (structured data). Inside the form there are the right people to approve"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Instead of using an approvals app, this is a report tracking how many approvals people do from company emails (unstructured data). Each person needs to first manually look up who is the employee responsible for approving the email"}
