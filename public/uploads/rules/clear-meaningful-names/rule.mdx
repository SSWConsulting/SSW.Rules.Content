...
<boxEmbed
  ...
  caption={"Bad example - Being clever for you can cause confusion to others. They might misinterpret \"energy\" as something else, like power or ammo. Then if you add enemies, would you name their energy variable `nmeNrg`?"}
/>
...
<boxEmbed
  ...
  caption={"Good example - Instantly understandable to anyone reading the code"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - Others will have fun deciphering this one"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Leaves no room for misinterpretation and makes the purpose obvious"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - Validating what exactly? Login credentials? Profile information? Something else?"}
/>
...
Using **`UserEmailFormatValidator`** to ensure email contains "@" and a domain.
  ...
  captionStyle="goodExample"
  caption={"Good example - The definition of the classes is in their names"}
/>