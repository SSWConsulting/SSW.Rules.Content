...
<imageEmbed
  ...
  figureText={"Bad example - It is hard to understand what issues are being worked on"}
...
<imageEmbed
  ...
  figureText={"Good example - It is very simple to understand if an issue has received attention"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - The `Needs Refinement` labels are still on closed issues"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Labels are relevant"}
