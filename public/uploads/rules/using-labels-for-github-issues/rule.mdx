...
seoDescription: Learn how to use labels for GitHub issues and streamline your open-source
  project's workflow.
created: 2019-11-15 04:19:40+00:00
createdBy: Chloe
createdByEmail: chloelin@ssw.com.au
lastUpdated: 2026-01-27 14:31:08.635000+00:00
lastUpdatedBy: Chloe
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="It is hard to understand what issues are being worked on"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="It is very simple to understand if an issue has received attention"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The `Needs Refinement` labels are still on closed issues"
