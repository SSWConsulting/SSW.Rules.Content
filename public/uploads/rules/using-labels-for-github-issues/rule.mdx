...
seoDescription: >-
  Learn how to use labels for GitHub issues and streamline your open-source
  project's workflow.
created: 2019-11-15T04:19:40.000Z
createdBy: Chloe
createdByEmail: chloelin@ssw.com.au
lastUpdated: 2026-01-27T14:31:08.635Z
lastUpdatedBy: Chloe
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Bad example - It is hard to understand what issues are being worked on" src="/uploads/rules/using-labels-for-github-issues/issues_bad_example.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Good example - It is very simple to understand if an issue has received attention" src="/uploads/rules/using-labels-for-github-issues/issues_good_example.png" />

## Use effort/size labels to estimate work and find low hanging fruit

Add a consistent set of effort/size labels to your backlog so the team can quickly see what is small vs large work.

These labels are especially useful to find low hanging fruit (e.g. picking up several small items to deliver quick wins):

| Label         | Typical effort    |
| ------------- | ----------------- |
| 01-small      | Less than 1 day   |
| 02-medium     | 2 to 4 days       |
| 03-large      | 5 days to 2 weeks |
| 04-very-large | 2 to 4 weeks      |
| Epic          | 1 month +         |

**Tip**: Keep “effort/size” labels mutually exclusive (an issue should have only one of these at a time).

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Quick wins are easier to spot with effort/size labels" src="/uploads/rules/using-labels-for-github-issues/rules-backlog-label.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Bad example - The `Needs Refinement` labels are still on closed issues" src="/uploads/rules/using-labels-for-github-issues/label_bad_example.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Good example - Labels are relevant" src="/uploads/rules/using-labels-for-github-issues/label_good_example.png" />
