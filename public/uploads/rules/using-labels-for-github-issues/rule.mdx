...
<imageEmbed
  ...
  captionText={"Bad example - It is hard to understand what issues are being worked on"}
...
<imageEmbed
  ...
  captionText={"Good example - It is very simple to understand if an issue has received attention"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - The `Needs Refinement` labels are still on closed issues"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Labels are relevant"}
