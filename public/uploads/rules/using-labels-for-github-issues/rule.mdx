...
created: 2025-10-16 23:19:28+00:00
...
<imageEmbed
  ...
  caption={"Bad example - It is hard to understand what issues are being worked on"}
...
<imageEmbed
  ...
  caption={"Good example - It is very simple to understand if an issue has received attention"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - The `Needs Refinement` labels are still on closed issues"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Labels are relevant"}
