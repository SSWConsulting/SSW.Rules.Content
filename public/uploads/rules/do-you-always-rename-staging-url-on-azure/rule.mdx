...
sugarlearning**-staging**&#46;azurewebsites&#46;net
  ...
  captionText={"Bad example - Site using the default URL (hard to remember!!)"}
/>
...
**staging**&#46;sugarlearning&#46;com
  ...
  captionText={"Good example - Staging URL with \"staging&#46;\" prefix"}
/>
...
<imageEmbed
  ...
  captionText={"CName being added to DNS for the default URL"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Azure being configured to accept the CName"}
