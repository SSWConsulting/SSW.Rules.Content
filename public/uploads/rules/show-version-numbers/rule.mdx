...
<imageEmbed
  ...
  captionText={"Good example - Version number on the RHS of a design document"}
...
codeauditor\file_latest.pdf
  ...
  captionText={"Bad example - Internal file names do not show any version information"}
/>
...
codeauditor\file_v3.pdf
  ...
  captionStyle="goodExample"
  captionText={"Good example - Internal file names show the version information"}
/>