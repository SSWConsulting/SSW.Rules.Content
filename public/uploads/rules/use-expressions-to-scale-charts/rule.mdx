...
created: 2024-03-26 03:40:03+00:00
...
seoDescription: Data Layout - Use expressions to show the correct scale on charts,
  ensuring accurate visualization of data in Reporting Services 2005.
...
<imageEmbed
  ...
  captionText={"Bad example - With no scale value set, the charts do not display based on the correct scale"}
...
<imageEmbed
  ...
  captionText={"Add a new row to your table and set the max value"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Set the maximum value to the value of the textbox"}
...
<imageEmbed
  ...
  captionText={"Good example - The scale is now correct"}
