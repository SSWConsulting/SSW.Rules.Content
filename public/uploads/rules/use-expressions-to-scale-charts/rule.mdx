...
<imageEmbed
  ...
  figureText={"Bad example - With no scale value set, the charts do not display based on the correct scale"}
...
<imageEmbed
  ...
  figureText={"Add a new row to your table and set the max value"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Set the maximum value to the value of the textbox"}
...
<imageEmbed
  ...
  figureText={"Good example - The scale is now correct"}
