...
<imageEmbed
  ...
  caption={"Bad example - With no scale value set, the charts do not display based on the correct scale"}
...
<imageEmbed
  ...
  caption={"Add a new row to your table and set the max value"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Set the maximum value to the value of the textbox"}
...
<imageEmbed
  ...
  caption={"Good example - The scale is now correct"}
