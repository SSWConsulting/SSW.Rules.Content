...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Non-semantic colours cause confusion"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Obvious colours used for Cold, Warm, and Hot"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using the correct state colours (e.g. In Australia: NSW = light blue, QLD = maroon, VIC = dark blue, etc)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The black stands out as everything else looks translucent"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Inconsistent palette feel like the colours clash"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Consistent colour palette"
