...
<imageEmbed
  ...
  caption={"Bad example – Non-semantic colours cause confusion"}
...
<imageEmbed
  ...
  caption={"Good example – Obvious colours used for Cold, Warm, and Hot"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Using the correct state colours (e.g. In Australia: NSW = light blue, QLD = maroon, VIC = dark blue, etc)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – The black stands out as everything else looks translucent"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example – Inconsistent palette feel like the colours clash"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Consistent colour palette"}
