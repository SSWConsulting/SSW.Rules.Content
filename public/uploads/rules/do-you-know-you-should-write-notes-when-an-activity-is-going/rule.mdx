...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Notepad is not a good tool as it does not automatically save to the cloud"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Notes from the meeting with a client were written in OneNote"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Notes from a conversation organising presenters for upcoming user groups. The sessions are listed in month order and the speakers have been tagged in their respective events."
