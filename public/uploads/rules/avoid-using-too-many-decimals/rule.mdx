...
AUD $==51,110.00== + GST is approved by Bob
  ...
  figureText={"Bad example - Having 0 cents is not necessary"}
/>
...
AUD $==51,110== + GST is approved by Bob
  ...
  figureText={"Good example - Ditch the 0 cents and have a clear number"}
/>
...
<imageEmbed
  ...
  figureText={"Good example - Having $350.1k would not be useful information. $350k is sufficient"}
