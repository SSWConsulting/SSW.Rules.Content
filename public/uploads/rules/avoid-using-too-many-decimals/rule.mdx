...
AUD $==51,110.00== + GST is approved by Bob
  ...
  caption={"Bad example - Having 0 cents is not necessary"}
/>
...
AUD $==51,110== + GST is approved by Bob
  ...
  caption={"Good example - Ditch the 0 cents and have a clear number"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Having $350.1k would not be useful information. $350k is sufficient"}
