...
created: 2018-09-06 07:16:45+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - No Microsoft Passwordless phone sign-in registered"}
...
<imageEmbed
  ...
  figureText={"Good example - Microsoft Passwordless phone sign-in registered"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="goodExample"
  figureText={"Turning on Authenticator app backup on iCloud (or equivalent on Android)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Email as a backup to Microsoft Authenticator App"}
