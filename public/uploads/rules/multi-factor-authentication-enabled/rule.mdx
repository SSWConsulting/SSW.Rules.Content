...
<imageEmbed
  ...
  caption={"Bad example - No Microsoft Passwordless phone sign-in registered"}
...
<imageEmbed
  ...
  caption={"Good example - Microsoft Passwordless phone sign-in registered"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  caption={"Turning on Authenticator app backup on iCloud (or equivalent on Android)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Email as a backup to Microsoft Authenticator App"}
