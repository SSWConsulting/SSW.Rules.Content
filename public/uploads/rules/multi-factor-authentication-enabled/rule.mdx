...
seoDescription: Ensure you have robust multi-factor authentication (MFA) enabled to
  protect your users and administrator accounts from unauthorized access.
...
<imageEmbed
  ...
  captionText={"Bad example - No Microsoft Passwordless phone sign-in registered"}
...
<imageEmbed
  ...
  captionText={"Good example - Microsoft Passwordless phone sign-in registered"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Turning on Authenticator app backup on iCloud (or equivalent on Android)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Email as a backup to Microsoft Authenticator App"}
