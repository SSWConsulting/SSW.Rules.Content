...
3.  Choose "Read-only (blocks additions, updates, and deletions)", then click "OK".
    ![](/uploads/rules/do-you-lock-the-sharepoint-content-database-before-making-a-backup/read-only-status.jpg) Note: Read more at [Manage the lock status for site collections in SharePoint 2013](https://technet.microsoft.com/en-us/library/cc263238%28v=office.15%29.aspx?f=255&MSPPError=-2147217396)
