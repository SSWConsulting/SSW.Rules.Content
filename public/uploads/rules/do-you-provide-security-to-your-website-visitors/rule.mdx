...
<imageEmbed
  ...
  captionText={"Bad example – As you can see, your web-browser will let you know if the website you’re accessing is not secure"}
...
<imageEmbed
  ...
  captionText={"Good example – SSW’s website is secure and does not share your information"}
