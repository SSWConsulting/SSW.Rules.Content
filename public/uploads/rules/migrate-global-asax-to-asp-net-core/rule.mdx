...
The [`Global.asax`]([https://learn.microsoft.com/en-us/previous-versions/dotnet/netframework-4.0/2027ewzw(v=vs.100?WT.mc_id=DT-MVP-33518)](https://learn.microsoft.com/en-us/previous-versions/dotnet/netframework-4.0/2027ewzw(v=vs.100?WT.mc_id=DT-MVP-33518))) is an optional file that dictates how an ASP.NET application handles application, session and request events. The code for handling those events is written in `Global.asax.cs`, and when migrating to ASP.NET Core this code will need to be restructured.
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Basic example application code from a `Global.asax.cs` file.",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: The above code migrated to ASP.NET Core.",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Basic example request lifecycle code from a `Global.asax.cs` file.",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Using middleware to execute logic before and after a request.",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Basic example error handling code from a `Global.asax.cs` file.",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Using exception handling middleware.",
  shouldDisplay: true
} } />
