...
<imageEmbed
  ...
  caption={"This website template, along with many others is available as a starting point for building Bootstrap-based sites"}
...
<imageEmbed
  ...
  caption={"Bad example - Many websites built by using tables for positioning would render poorly on smaller devices, and be hard to use"}
...
<imageEmbed
  ...
  caption={"Good example - Bootstrap uses many techniques to help make your site look great on different browsers, on all devices"}
