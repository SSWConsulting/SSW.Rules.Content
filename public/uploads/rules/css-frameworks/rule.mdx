...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Many websites built by using tables for positioning would render poorly on smaller devices, and be hard to use"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Bootstrap uses many techniques to help make your site look great on different browsers, on all devices"
