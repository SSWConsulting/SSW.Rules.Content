...
created: 2012-07-23 16:04:48+00:00
...
<imageEmbed
  ...
  figureText={"This website template, along with many others is available as a starting point for building Bootstrap-based sites"}
...
<imageEmbed
  ...
  figureText={"Bad example - Many websites built by using tables for positioning would render poorly on smaller devices, and be hard to use"}
...
<imageEmbed
  ...
  figureText={"Good example - Bootstrap uses many techniques to help make your site look great on different browsers, on all devices"}
