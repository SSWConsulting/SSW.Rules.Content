...
<imageEmbed
  ...
  captionText={"Good example - Using a good teams structure to organize access"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Using teams to assign roles in a repository"}
...
<imageEmbed
  ...
  captionText={"Bad example - Individuals should not have Admin access to a repository"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Teams should have Maintainer access to a repository"}
