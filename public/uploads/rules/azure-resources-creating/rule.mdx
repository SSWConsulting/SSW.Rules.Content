...
<imageEmbed
  ...
  captionText={"Figure (animated gif): Bad example - Creating resources manually"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example – Exporting your Resource Group as an ARM template defined in JSON"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Warning - The templates are crazy verbose. They often don't work and need to be manually tweaked"}
...
<imageEmbed
  ...
  captionText={"Good example - Author your own Bicep templates in Visual Studio Code using the Bicep Extension"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Code from the Pulumi Azure NextGen provider demo with Azure resources defined in C#"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - From the console simply run 'pulumi up' to deploy your resources to Azure"}
