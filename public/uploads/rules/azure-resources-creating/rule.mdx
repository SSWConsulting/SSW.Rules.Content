...
lastUpdated: 2024-11-01T05:49:53.000Z
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "![Figure (animated gif): Bad example - Creating resources manually](/uploads/rules/azure-resources-creating/azure resources.gif)",
  shouldDisplay: true
} } />
