...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Exporting your Resource Group as an ARM template defined in JSON"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Author your own Bicep templates in Visual Studio Code using the Bicep Extension"
...
* Terraform uses [HashiCorp Configuration Language HCL](https://developer.hashicorp.com/terraform/language/syntax/configuration)
  * It's like YAML but much more powerful
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Code from the Pulumi Azure NextGen provider demo with Azure resources defined in C#"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="From the console simply run 'pulumi up' to deploy your resources to Azure"
