...
<imageEmbed
  ...
  caption={"Figure (animated gif): Bad example - Creating resources manually"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example – Exporting your Resource Group as an ARM template defined in JSON"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Warning - The templates are crazy verbose. They often don't work and need to be manually tweaked"}
...
<imageEmbed
  ...
  caption={"Good example - Author your own Bicep templates in Visual Studio Code using the Bicep Extension"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Code from the Pulumi Azure NextGen provider demo with Azure resources defined in C#"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - From the console simply run 'pulumi up' to deploy your resources to Azure"}
