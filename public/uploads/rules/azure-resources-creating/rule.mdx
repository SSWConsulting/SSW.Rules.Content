...
seoDescription: Azure resources creation - Learn how to create and manage Azure resources
  efficiently with Farmer or Bicep, rather than manual creation.
...
<imageEmbed
  ...
  figureText={"Figure (animated gif): Bad example - Creating resources manually"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – Exporting your Resource Group as an ARM template defined in JSON"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Warning - The templates are crazy verbose. They often don't work and need to be manually tweaked"}
...
<imageEmbed
  ...
  figureText={"Good example - Author your own Bicep templates in Visual Studio Code using the Bicep Extension"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Code from the Pulumi Azure NextGen provider demo with Azure resources defined in C#"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - From the console simply run 'pulumi up' to deploy your resources to Azure"}
