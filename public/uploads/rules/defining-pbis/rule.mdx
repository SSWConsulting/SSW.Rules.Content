...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - The PBI has no information beyond a title](r1rmwbe9ak.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - The PBI has a description, acceptance criteria, and more](xlwwtinlrk.png)',
  shouldDisplay: true
} } />
