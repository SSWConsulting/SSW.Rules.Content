...
<boxEmbed
  ...
  captionText={"Bad example - The user is referred in two ways and flow is broken"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - There is no noticeable break in the reading flow"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - It is unclear who the \"we\" is"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - These instructions are clear and direct"}
/>