...
isArchived: false
lastUpdated: 2021-09-17 16:41:54.484000+00:00
...
<boxEmbed
  ...
  figureText={"Bad example - The user is referred in two ways and flow is broken"}
/>
...
<boxEmbed
  ...
  figureText={"Good example - There is no noticeable break in the reading flow"}
/>
...
<boxEmbed
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - It is unclear who the \"we\" is"}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - These instructions are clear and direct"}
/>