...
<imageEmbed
  ...
  captionText={"Bad example - Issue created without a Template"}
...
<imageEmbed
  ...
  captionText={"Good example - Issue created from a Template"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - All the available Issue Template"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Issue Forms make reporting bugs easy"}
