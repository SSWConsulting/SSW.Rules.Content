...
<imageEmbed
  ...
  figureText={"Bad example - Issue created without a Template"}
...
<imageEmbed
  ...
  figureText={"Good example - Issue created from a Template"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - All the available Issue Template"}
...
<imageEmbed
  ...
  figureText={"Issue Forms make reporting bugs easy"}
