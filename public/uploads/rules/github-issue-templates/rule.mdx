...
<imageEmbed
  ...
  caption={"Bad example - Issue created without a Template"}
...
<imageEmbed
  ...
  caption={"Good example - Issue created from a Template"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - All the available Issue Template"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Issue Forms make reporting bugs easy"}
