...
<imageEmbed
  ...
  caption={"The iconic M.J. signature method"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Getting the client's signature ensures more accurate requirements"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  caption={"A signature from Michael Jackson is very valuable but hard to obtain"}
