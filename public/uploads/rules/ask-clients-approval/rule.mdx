...
seoDescription: Get client approval on specifications to avoid disputes. Use signatures
  or initials for clear communication and accurate requirements.
...
<imageEmbed
  ...
  captionText={"The iconic M.J. signature method"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Getting the client's signature ensures more accurate requirements"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"A signature from Michael Jackson is very valuable but hard to obtain"}
  src="/uploads/rules/ask-clients-approval/SuccessfulProjects_Signature.jpg"
/>