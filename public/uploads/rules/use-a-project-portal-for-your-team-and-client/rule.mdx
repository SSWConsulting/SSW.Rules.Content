...
<imageEmbed
  ...
  caption={"Bad example - Don't stick with the default dashboard, it's almost useless"}
...
<imageEmbed
  ...
  caption={"Good example - This dashboard contains all the information a new team member would need to get started"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"SugarLearning induction tool"}
