...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Don't stick with the default dashboard, it's almost useless"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This dashboard contains all the information a new team member would need to get started"
