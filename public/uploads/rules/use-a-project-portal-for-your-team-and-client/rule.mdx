...
<imageEmbed
  ...
  figureText={"Bad example - Don't stick with the default dashboard, it's almost useless"}
...
<imageEmbed
  ...
  figureText={"Good example - This dashboard contains all the information a new team member would need to get started"}
...
<imageEmbed
  ...
  figureText={"SugarLearning induction tool"}
