...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Here Greg Harris has not checked in a file"}
...
*-- Powered by Power Automate, Job: SSW.Dory*
  ...
  captionStyle="default"
  captionText={"An example of the reminder email that all users receive"}
/>