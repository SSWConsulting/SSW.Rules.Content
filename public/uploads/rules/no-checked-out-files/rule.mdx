...
created: 2012-05-31 03:08:59+00:00
...
<imageEmbed
  ...
  figureText={"Here Greg Harris has not checked in a file"}
...
*-- Powered by Power Automate, Job: SSW.Dory*
  ...
  figurePreset="defaultExample"
  figureText={"An example of the reminder email that all users receive"}
/>