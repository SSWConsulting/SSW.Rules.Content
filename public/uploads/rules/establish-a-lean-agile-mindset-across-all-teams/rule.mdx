...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Consistency in mindset leads to better alignment and easier management."
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Teams without a Lean-Agile mindset may focus on tasks that don't deliver maximum value."
