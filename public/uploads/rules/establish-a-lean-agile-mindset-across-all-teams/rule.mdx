...
<imageEmbed
  ...
  captionText={"Good Example - Consistency in mindset leads to better alignment and easier management."}
...
<imageEmbed
  ...
  captionText={"Bad Example - Teams without a Lean-Agile mindset may focus on tasks that don't deliver maximum value."}
