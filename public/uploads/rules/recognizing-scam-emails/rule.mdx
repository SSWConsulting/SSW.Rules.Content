...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "![Bad example – The name says Adam Cogan, but the email address is a Gmail account](/uploads/rules/recognizing-scam-emails/email-scam-name.png)",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "![Good example – The email address is correct, and in this case as it’s internal, the sender’s profile picture is shown](/uploads/rules/recognizing-scam-emails/good-email-example.png)",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "![Bad example – The attacker has referred to the recipient as ‘Matt’, which the sender does not call him](/uploads/rules/recognizing-scam-emails/bad-language-example.png)",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "![Good example – Easy to distinguish as the sender refers to the recipient as ‘Goldie’ and includes the sender’s signature use of emoji](/uploads/rules/recognizing-scam-emails/good-language-example.png)",
  shouldDisplay: true
} } />
