...
<imageEmbed
  ...
  caption={"Bad example – The name says Adam Cogan, but the email address is a Gmail account"}
...
<imageEmbed
  ...
  caption={"Good example – The email address is correct, and in this case as it’s internal, the sender’s profile picture is shown"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example – The attacker has referred to the recipient as ‘Matt’, which the sender does not call him"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Easy to distinguish as the sender refers to the recipient as ‘Goldie’ and includes the sender’s signature use of emoji"}
...
<imageEmbed
  ...
  caption={"Some URLs are harder to identify because of a safelink service"}
