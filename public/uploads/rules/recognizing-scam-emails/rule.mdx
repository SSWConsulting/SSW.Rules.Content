...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The name says Adam Cogan, but the email address is a Gmail account"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The email address is correct, and in this case as it’s internal, the sender’s profile picture is shown"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The attacker has referred to the recipient as ‘Matt’, which the sender does not call him"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Easy to distinguish as the sender refers to the recipient as ‘Goldie’ and includes the sender’s signature use of emoji"
