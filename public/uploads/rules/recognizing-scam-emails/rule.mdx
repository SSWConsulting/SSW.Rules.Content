...
created: 2022-03-17 05:39:07.720000+00:00
guid: ef89a713-c51d-45e0-8c14-2ca010eec387
related:
- rule: public/uploads/rules/recognizing-phishing-urls/rule.mdx
seoDescription: Discover essential tips to identify and avoid email scams while enhancing
  your email security. Learn how to spot phishing attempts and protect yourself from
  malicious threats.
...
<imageEmbed
  ...
  figureText={"Bad example – The name says Adam Cogan, but the email address is a Gmail account"}
...
<imageEmbed
  ...
  figureText={"Good example – The email address is correct, and in this case as it’s internal, the sender’s profile picture is shown"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – The attacker has referred to the recipient as ‘Matt’, which the sender does not call him"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – Easy to distinguish as the sender refers to the recipient as ‘Goldie’ and includes the sender’s signature use of emoji"}
...
<imageEmbed
  ...
  figureText={"Some URLs are harder to identify because of a safelink service"}
