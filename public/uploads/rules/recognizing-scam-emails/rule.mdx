...
created: 2022-03-17 06:51:09+00:00
...
<imageEmbed
  ...
  captionText={"Bad example – The name says Adam Cogan, but the email address is a Gmail account"}
...
<imageEmbed
  ...
  captionText={"Good example – The email address is correct, and in this case as it’s internal, the sender’s profile picture is shown"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example – The attacker has referred to the recipient as ‘Matt’, which the sender does not call him"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – Easy to distinguish as the sender refers to the recipient as ‘Goldie’ and includes the sender’s signature use of emoji"}
...
<imageEmbed
  ...
  captionText={"Some URLs are harder to identify because of a safelink service"}
