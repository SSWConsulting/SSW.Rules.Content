...
<imageEmbed
  ...
  captionText={"In Google webmaster tools you can see all broken URLs, and even the pages who are linking to them (known as referrer, found in the 'Linked From' column)"}
...
<imageEmbed
  ...
  captionText={"In Bing webmaster centre you can find the broken URL which is linked by the above URL"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"SSW Link Auditor automatically locate broken links"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Using SSW Code Auditor's broken link dashboard"}
