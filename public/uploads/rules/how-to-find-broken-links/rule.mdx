...
isArchived: false
lastUpdated: 2017-03-02 21:52:57+00:00
...
<imageEmbed
  ...
  figureText={"In Google webmaster tools you can see all broken URLs, and even the pages who are linking to them (known as referrer, found in the 'Linked From' column)"}
...
<imageEmbed
  ...
  figureText={"In Bing webmaster centre you can find the broken URL which is linked by the above URL"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"SSW Link Auditor automatically locate broken links"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Using SSW Code Auditor's broken link dashboard"}
