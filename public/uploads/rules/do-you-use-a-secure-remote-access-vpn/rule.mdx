...
<imageEmbed
  ...
  figureText={"Bad example: PPTP should not be used, it is old and no longer secure"}
...
<imageEmbed
  ...
  figureText={"Good example: Cisco AnyConnect configured with Azure AD SSO and MFA"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example: Fortinet have their own MFA solution for VPN, FortiToken"}
...
<imageEmbed
  ...
  figureText={"Adding Cisco AnyConnect as an Enterprise Application in Azure AD"}
