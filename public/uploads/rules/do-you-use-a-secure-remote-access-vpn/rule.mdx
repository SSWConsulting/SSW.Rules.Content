...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example: PPTP should not be used, it is old and no longer secure](vpn-pptp.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example: Cisco AnyConnect configured with Azure AD SSO and MFA](cisco-vpn.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example: Fortinet have their own MFA solution for VPN, FortiToken](fortitoken-vpn.png)',
  shouldDisplay: true
} } />
