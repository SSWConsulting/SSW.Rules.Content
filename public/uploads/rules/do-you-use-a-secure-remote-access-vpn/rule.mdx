...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="PPTP should not be used, it is old and no longer secure"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Cisco AnyConnect configured with Azure AD SSO and MFA"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Fortinet have their own MFA solution for VPN, FortiToken"
