...
<imageEmbed
  ...
  caption={"Bad example: PPTP should not be used, it is old and no longer secure"}
...
<imageEmbed
  ...
  caption={"Good example: Cisco AnyConnect configured with Azure AD SSO and MFA"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example: Fortinet have their own MFA solution for VPN, FortiToken"}
...
<imageEmbed
  ...
  caption={"Adding Cisco AnyConnect as an Enterprise Application in Azure AD"}
