...
<imageEmbed
  ...
  captionText={"Bad example: PPTP should not be used, it is old and no longer secure"}
...
<imageEmbed
  ...
  captionText={"Good example: Cisco AnyConnect configured with Azure AD SSO and MFA"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example: Fortinet have their own MFA solution for VPN, FortiToken"}
...
<imageEmbed
  ...
  captionText={"Adding Cisco AnyConnect as an Enterprise Application in Azure AD"}
