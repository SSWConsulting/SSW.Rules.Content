...
<imageEmbed
  ...
  captionText={"Good - TypeScript is very similar to JavaScript so it’s easy to learn, and also helps developers learn proper JavaScript coding practices"}
...
<imageEmbed
  ...
  captionText={"Bad – CoffeeScript syntax is very different from JavaScript so it takes longer to learn"}
