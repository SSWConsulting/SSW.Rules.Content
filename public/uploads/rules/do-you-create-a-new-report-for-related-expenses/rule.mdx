...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="bad"
  figure="Two unrelated expenses in the same folder, this can be confusing to Accounts Staff"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="Expenses separated into different folders - easier to claim and track what your receipts were for!"
