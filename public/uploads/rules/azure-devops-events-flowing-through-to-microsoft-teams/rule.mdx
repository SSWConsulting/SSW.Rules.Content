...
<imageEmbed
  ...
  caption={"How to setup Azure DevOps Events on Microsoft Teams"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"It's nice to be able to converse about the project and see notifications such as PR coming through"}
