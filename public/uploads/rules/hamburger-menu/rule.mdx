---
seoDescription: Learn when and where to use the hamburger menu icon. Understand platform
  conventions, user expectations, and when it's best to avoid hiding navigation.
type: rule
...
- author: tiago-araujo
created: 2025-06-23 12:55:00+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="On desktop, navigation should be visible when screen space allows. Hiding it behind a hamburger reduces usability"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="On mobile, screen space is limited, so hiding the nav behind a hamburger is appropriate"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="Microsoft keeps its hamburger menu in the top-left corner, following established UX patterns for consistency and familiarity"
