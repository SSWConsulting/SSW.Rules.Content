...
<imageEmbed
  ...
  figureText={"Bad Example - Installing Web Deploy from the Web Platform Installer does not install all the components required for continuous deployment"}
...
<imageEmbed
  ...
  figureText={"Good Example - Install Web Deploy 3.0 by downloading the package from        http://www.iis.net/downloads/microsoft/web-deploy"}
