...
created: 2009-12-04 08:32:35+00:00
createdBy: System Account
createdByEmail: Unknown@ssw.com.au
guid: 8b78be7a-6ce0-4391-b4be-8650f0a0ba4d
isArchived: false
lastUpdated: 2012-05-23 16:53:02+00:00
lastUpdatedBy: Tiago Araujo
lastUpdatedByEmail: TiagoAraujo@ssw.com.au
redirects: []
seoDescription: Learn how to optimize SharePoint web parts by configuring settings
  like XSL paths, item limits, view fields, and query overrides before developing
  custom solutions.
