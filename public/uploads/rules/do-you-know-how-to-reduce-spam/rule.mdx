...
<imageEmbed
  ...
  captionText={"Good example - Report a message as \"Junk\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Quarantine Email - 'Review Message', 'Release' or 'Block Sender'"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Release or delete quarantined emails"}
