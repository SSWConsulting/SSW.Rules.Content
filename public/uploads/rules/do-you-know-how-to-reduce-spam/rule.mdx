...
isArchived: false
lastUpdated: 2021-06-08 01:05:00.959000+00:00
...
<imageEmbed
  ...
  figureText={"Good example - Report a message as \"Junk\""}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Quarantine Email - 'Review Message', 'Release' or 'Block Sender'"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Release or delete quarantined emails"}
