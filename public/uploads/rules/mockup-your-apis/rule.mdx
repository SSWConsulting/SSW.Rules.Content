...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Adding a new Operation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Add a representation for your response with fake data"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Operation added successfully"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Add the Mock Response policy"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Choose the response representation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Testing the mocked api operation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Response from the mocked operation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Calling our Data API from a REST Client"}
