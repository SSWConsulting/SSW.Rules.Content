...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Adding a new Operation"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add a representation for your response with fake data"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Operation added successfully"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add the Mock Response policy"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Choose the response representation"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Testing the mocked api operation"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Response from the mocked operation"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Calling our Data API from a REST Client"}
