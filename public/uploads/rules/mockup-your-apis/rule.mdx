...
isArchived: false
lastUpdated: 2021-07-07 21:23:27.134000+00:00
...
<imageEmbed
  ...
  captionText={"Create a blank API"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Adding a new Operation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Add a representation for your response with fake data"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Operation added successfully"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Add the Mock Response policy"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Choose the response representation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Testing the mocked api operation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Response from the mocked operation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Calling our Data API from a REST Client"}
