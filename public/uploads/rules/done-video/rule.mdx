...
<imageEmbed
  ...
  caption={"Bad example - Camera is below eye level"}
...
<imageEmbed
  ...
  caption={"Good example - Good framing, lights and background"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Inbox messages are showing, and reminder has not been cleared"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Email is popped out to hide messages, and reminder has been cleared"}
