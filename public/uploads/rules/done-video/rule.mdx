...
isArchived: false
lastUpdated: 2025-10-08 21:43:37+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - Camera is below eye level"}
...
<imageEmbed
  ...
  captionText={"Good example - Good framing, lights and background"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Inbox messages are showing, and reminder has not been cleared"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Email is popped out to hide messages, and reminder has been cleared"}
