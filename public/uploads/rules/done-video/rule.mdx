...
created: 2016-05-10 09:09:50+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Camera is below eye level"}
...
<imageEmbed
  ...
  figureText={"Good example - Good framing, lights and background"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Inbox messages are showing, and reminder has not been cleared"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Email is popped out to hide messages, and reminder has been cleared"}
