...
seoDescription: Record a 'Done Video' to showcase key PBIs, validate functionality,
  and create useful documentation or release notes.
created: 2025-07-22 01:20:07
createdBy: Tiago Araújo [SSW]
createdByEmail: tiagov8@gmail.com
lastUpdated: 2026-01-11 21:26:32.942000
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Bad example - Camera is below eye level" src="/uploads/rules/done-video/bad-seth-camera.jpg" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Good example - Good framing, lights and background" src="/uploadshttps://github.com/user-attachments/assets/204f8986-5146-4e0c-9c5f-34985728d03d" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Bad example - Inbox messages are showing, and reminder has not been cleared" src="/uploads/rules/done-video/bad_example_email.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Good example - Email is popped out to hide messages, and reminder has been cleared" src="/uploads/rules/done-video/good_example_email.png" />
