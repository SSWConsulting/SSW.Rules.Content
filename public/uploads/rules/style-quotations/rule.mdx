...
<boxEmbed
  ...
  caption={"Bad example - The quotation is mixed up with main text"}
/>
...
&nbsp;&nbsp;&nbsp;"Software development **is** painful and costly"
  ...
  caption={"OK example - The quotation has quote marks, on a new line and indented"}
/>
...
&nbsp;&nbsp;&nbsp;&gt; Software development **is** painful and costly
  ...
  captionStyle="goodExample"
  caption={"Good example - The quotation has greater-than sign, on a new line and indented"}
/>
...
<imageEmbed
  ...
  caption={"Replying feature in IM helps keeping the conversation organized"}
...
Sure! I’ll send it over by end of day.
  ...
  captionStyle="goodExample"
  caption={"Good example - This simple formatting makes conversations easier to follow, especially in long email threads"}
/>
