...
<boxEmbed
  ...
  figureText={"Bad example - The quotation is mixed up with main text"}
/>
...
&nbsp;&nbsp;&nbsp;"Software development **is** painful and costly"
  ...
  figureText={"OK example - The quotation has quote marks, on a new line and indented"}
/>
...
&nbsp;&nbsp;&nbsp;&gt; Software development **is** painful and costly
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - The quotation has greater-than sign, on a new line and indented"}
/>
...
<imageEmbed
  ...
  figureText={"Replying feature in IM helps keeping the conversation organized"}
...
Sure! I’ll send it over by end of day.
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - This simple formatting makes conversations easier to follow, especially in long email threads"}
/>
