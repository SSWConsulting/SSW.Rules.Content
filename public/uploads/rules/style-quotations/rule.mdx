...
created: 2023-09-22 21:20:05+00:00
...
isArchived: false
lastUpdated: 2025-05-17 00:53:30+00:00
...
<boxEmbed
  ...
  captionText={"Bad example - The quotation is mixed up with main text"}
/>
...
&nbsp;&nbsp;&nbsp;"Software development **is** painful and costly"
  ...
  captionText={"OK example - The quotation has quote marks, on a new line and indented"}
/>
...
&nbsp;&nbsp;&nbsp;&gt; Software development **is** painful and costly
  ...
  captionStyle="goodExample"
  captionText={"Good example - The quotation has greater-than sign, on a new line and indented"}
/>
...
<imageEmbed
  ...
  captionText={"Replying feature in IM helps keeping the conversation organized"}
...
Sure! I’ll send it over by end of day.
  ...
  captionStyle="goodExample"
  captionText={"Good example - This simple formatting makes conversations easier to follow, especially in long email threads"}
/>
