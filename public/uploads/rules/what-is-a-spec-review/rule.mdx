...
lastUpdated: 2026-03-01T22:28:35.092Z
lastUpdatedBy: Josh Berman
lastUpdatedByEmail: JoshBerman@ssw.com.au
---

You would never build a house without getting an architect to create a plan first. Usually, a specification process is done with the client before beginning work on a project.     dsad
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="You would never build a house without an architect" src="/uploads/rules/what-is-a-spec-review/workers022.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="The initial wireframe from the Spec Review" src="/uploads/rules/what-is-a-spec-review/image002-52-copy.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="The final product based on these wireframes" src="/uploads/rules/what-is-a-spec-review/biocurate_final_product.png" />
