...
<imageEmbed
  ...
  caption={"You would never build a house without an architect"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The initial wireframe from the Spec Review"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The final product based on these wireframes"}
