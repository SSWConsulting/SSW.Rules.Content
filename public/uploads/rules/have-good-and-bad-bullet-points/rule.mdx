...
<imageEmbed
  ...
  captionText={"Bad example - it's not clear which are good and bad points"}
...
<imageEmbed
  ...
  captionText={"Good example - It's far more obvious which ones are the good points and which are the bad"}
