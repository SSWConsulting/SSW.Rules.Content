...
<imageEmbed
  ...
  figureText={"Bad example - it's not clear which are good and bad points"}
...
<imageEmbed
  ...
  figureText={"Good example - It's far more obvious which ones are the good points and which are the bad"}
