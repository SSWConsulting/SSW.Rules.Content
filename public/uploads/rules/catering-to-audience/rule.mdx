...
created: 2022-08-25 01:03:37+00:00
...
seoDescription: Tailor your communication for Product Owners, Developers, and Designers
  to ensure clarity and alignment across roles.
...
Overall, I think the PBI is going to take a few more hours than we thought due to these roadblocks.
  ...
  captionText={"Bad example - The message's audience is not targeted, making it hard for others to decipher"}
/>
...
Would you like to know more technical details, or should I get cracking?
  ...
  captionText={"Good example - Targeting the message towards the Product Owner"}
/>
...
Do you think I should add it?
  ...
  captionStyle="goodExample"
  captionText={"Good example - Targeting the message towards the Developer"}
/>
...
Do you think that is the right place?
  ...
  captionStyle="goodExample"
  captionText={"Good example - Targeting the message towards the Designer"}
/>
