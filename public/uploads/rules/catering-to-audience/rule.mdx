...
Overall, I think the PBI is going to take a few more hours than we thought due to these roadblocks.
  ...
  caption={"Bad example - The message's audience is not targeted, making it hard for others to decipher"}
/>
...
Would you like to know more technical details, or should I get cracking?
  ...
  caption={"Good example - Targeting the message towards the Product Owner"}
/>
...
Do you think I should add it?
  ...
  captionStyle="goodExample"
  caption={"Good example - Targeting the message towards the Developer"}
/>
...
Do you think that is the right place?
  ...
  captionStyle="goodExample"
  caption={"Good example - Targeting the message towards the Designer"}
/>
