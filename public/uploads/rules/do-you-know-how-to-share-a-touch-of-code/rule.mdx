...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Figure - Using images for code snippets is difficult to maintain.](2014-03-08_19-49-571.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Figure - Easy to review your Gists.](2015-12-03_15-46-34.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Figure - Embeded Gist with JavaScript provided by Github](2015-12-03_15-50-42.png)',
  shouldDisplay: true
} } />
