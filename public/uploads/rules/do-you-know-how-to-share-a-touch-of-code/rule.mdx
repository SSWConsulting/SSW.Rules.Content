...
<imageEmbed
  ...
  captionText={"Figure - Using images for code snippets is difficult to maintain."}
...
<imageEmbed
  ...
  captionText={"Figure - Easy to review your Gists."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Figure - Embeded Gist with JavaScript provided by Github"}
