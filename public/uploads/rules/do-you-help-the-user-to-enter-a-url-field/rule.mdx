...
<imageEmbed
  ...
  caption={"Bad example - Using a validation message to tell the user to enter a correct                         URL"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - The user has a good chance of entering the URL in the incorrect format"}
...
<imageEmbed
  ...
  caption={"Good example - User immediately knows the format expected"}
