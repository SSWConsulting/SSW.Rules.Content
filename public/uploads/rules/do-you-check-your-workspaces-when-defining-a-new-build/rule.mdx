...
<imageEmbed
  ...
  captionText={"Bad example – Several workspaces from other team projects are included by default"}
...
<imageEmbed
  ...
  captionText={"Good example – Only the relevant workspace has been included in this build definition"}
