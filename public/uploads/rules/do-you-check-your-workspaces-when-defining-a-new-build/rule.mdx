...
<imageEmbed
  ...
  caption={"Bad example – Several workspaces from other team projects are included by default"}
...
<imageEmbed
  ...
  caption={"Good example – Only the relevant workspace has been included in this build definition"}
