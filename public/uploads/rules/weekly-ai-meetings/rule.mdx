...
seoDescription: >-
  Weekly AI meetings with the AI evangelists in your company can help stay up to
...
lastUpdated: 2025-09-15T08:29:01.675Z
lastUpdatedBy: Chloe
...
<emailEmbed
  ...
  figureEmbed={{
    preset: "okExample",
    figure:
      "Ok example - Notes from an AI meeting - sharing learnings 🧠 but the meeting is quite long",
    shouldDisplay: true
  }}
/>
...
<emailEmbed
  ...
  figureEmbed={{
    preset: "goodExample",
    figure:
      "Good example - Quicker meeting that gets down to the important part - what's new in AI? 🧠",
    shouldDisplay: true
  }}
/>
