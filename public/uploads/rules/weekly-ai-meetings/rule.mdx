...
&lt;This email is as per [ssw.com.au/rules/weekly-ai-meetings](/weekly-ai-meetings)&gt;
  ...
  caption={"Ok example - Notes from an AI meeting - sharing learnings 🧠 but the meeting is quite long"}
/>
...
&lt;This email is as per [ssw.com.au/rules/weekly-ai-meetings](/weekly-ai-meetings)&gt;
  ...
  caption={"Good example - Quicker meeting that gets down to the important part - what's new in AI? 🧠"}
/>