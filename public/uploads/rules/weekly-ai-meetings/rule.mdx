...
When people experiment with new tools, they can often learn from each other, which helps everybody. Typically, a company will have some people who are more enthusiastic about AI "AI evangelists" - and they are in a natural place to lead the exploration of AI productivity.
...
<emailEmbed
  ...
  figurePrefix="ok"
  figure="Notes from an AI meeting - sharing learnings 🧠 but the meeting is quite long"
/>
...
<emailEmbed
  ...
  figurePrefix="good"
  figure="Quicker meeting that gets down to the important part - what's new in AI? 🧠"
/>
