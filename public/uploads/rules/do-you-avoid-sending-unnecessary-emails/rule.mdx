...
<boxEmbed
  ...
  captionText={"Bad example - Unnecessary email"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - Sending an email expressing gratitude and providing words of encouragement holds value"}
/>