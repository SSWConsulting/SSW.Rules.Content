...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="New button should open another form, and Delete button should be on that new form"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Outlook opens multiple instances of the data entry form (email message)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Each form instance is shown in the taskbar, and easily opened again"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="New and Delete buttons docked in the Toolbar providing easy data entry for new Timesheets"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Save Changes Dialog must appear when form is dirty"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This implementation of a search utility is on the same form"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This implementation of Search feature is on a separate form"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="No Delete button for Sub forms"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Error Provider Icon next to a required field"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Action and Tools are irrelevant on this form"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This form has no information to indicate who created this entry and who last modified it"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This form contains Created by/Updated by fields used in a standard control which is put into all forms"
