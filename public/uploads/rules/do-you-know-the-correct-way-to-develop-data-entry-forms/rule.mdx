...
<imageEmbed
  ...
  captionText={"Bad Example - New button should open another form, and Delete button should be on that new form"}
...
<imageEmbed
  ...
  captionText={"Good Example - Outlook opens multiple instances of the data entry form (email message)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Each form instance is shown in the taskbar, and easily opened again"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - New and Delete buttons docked in the Toolbar providing easy data entry for new Timesheets"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Save Changes Dialog must appear when form is dirty"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - This implementation of a search utility is on the same form"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - This implementation of Search feature is on a separate form"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - No Delete button for Sub forms"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Error Provider Icon next to a required field"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Action and Tools are irrelevant on this form"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Menus are relevant"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - This form has no information to indicate who created this entry and who last modified it"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - This form contains Created by/Updated by fields used in a standard control which is put into all forms"}
...
<imageEmbed
  ...
  captionText={"Data Binding using the Designer"}
