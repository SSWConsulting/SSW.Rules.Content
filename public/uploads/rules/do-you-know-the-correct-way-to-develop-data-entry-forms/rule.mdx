...
isArchived: false
lastUpdated: 2021-03-31 21:17:10.085000+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example - New button should open another form, and Delete button should be on that new form"}
...
<imageEmbed
  ...
  figureText={"Good Example - Outlook opens multiple instances of the data entry form (email message)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Each form instance is shown in the taskbar, and easily opened again"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - New and Delete buttons docked in the Toolbar providing easy data entry for new Timesheets"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Save Changes Dialog must appear when form is dirty"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - This implementation of a search utility is on the same form"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - This implementation of Search feature is on a separate form"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - No Delete button for Sub forms"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Error Provider Icon next to a required field"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Action and Tools are irrelevant on this form"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Menus are relevant"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - This form has no information to indicate who created this entry and who last modified it"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - This form contains Created by/Updated by fields used in a standard control which is put into all forms"}
...
<imageEmbed
  ...
  figureText={"Data Binding using the Designer"}
