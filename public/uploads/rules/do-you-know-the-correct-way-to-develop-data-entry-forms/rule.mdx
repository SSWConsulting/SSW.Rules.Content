...
created: 2014-12-01 00:38:53+00:00
...
redirects: []
seoDescription: Learn the correct approach to developing data entry forms with proper
  multiple instance handling and user-friendly workflows for efficient data input.
...
<imageEmbed
  ...
  caption={"Bad Example - New button should open another form, and Delete button should be on that new form"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/BadAddDeleteSubForm.gif"
/>
...
<imageEmbed
  ...
  caption={"Good Example - Outlook opens multiple instances of the data entry form (email message)"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/Outlookemails.jpg"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Each form instance is shown in the taskbar, and easily opened again"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/outlooktaskbar.jpg"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - New and Delete buttons docked in the Toolbar providing easy data entry for new Timesheets"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/GoodAddDeleteSubForm.jpg"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Save Changes Dialog must appear when form is dirty"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/SaveChangesDialog.jpg"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - This implementation of a search utility is on the same form"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/BadSearch.gif"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - This implementation of Search feature is on a separate form"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/SearchForm.gif"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - No Delete button for Sub forms"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/SubFormsExample.gif"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Error Provider Icon next to a required field"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/ErrorProviderIconExample.jpg"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Action and Tools are irrelevant on this form"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/MenuBadExample.jpg"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Menus are relevant"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/MenuGoodExample.jpg"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - This form has no information to indicate who created this entry and who last modified it"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/BadCreatedUpdated.jpg"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - This form contains Created by/Updated by fields used in a standard control which is put into all forms"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/GoodCreatedUpdated.jpg"
/>
...
<imageEmbed
  ...
  caption={"Data Binding using the Designer"}
  src="/uploads/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/CommonFieldsDB.gif"
/>
