archivedreason: Outdated (Legacy) - TFS Build Controller/Agent guidance. For modern CI with Azure DevOps using self-hosted/on-prem build servers, see [Do you know when to use an on-premises build server with Azure DevOps?](/on-premise-build-server-with-azure-devops).
authors:
- title: Danijel Malik
