...
lastUpdated: 2026-09-14T23:04:34.973Z
...
<emailEmbed
  ...
  body={<>
    ...
    * Bob Northwind - Claude, Copilot CLI
    ...
    ![](/uploads/rules/sprint-review-retro-email/ssw-tiger-preview.png)
    
    **Figure: AI Powered Meeting Intelligence with [SSW Tiger](https://sswtiger.com/) 🐅**
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="TinaCloud team Sprint Review email using SSW Halfback" src="/uploads/rules/sprint-review-retro-email/ssw-halfback-prev.png" />
