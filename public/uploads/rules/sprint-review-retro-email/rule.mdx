---
type: rule
title: "Do you create a Sprint Review/Retro email \U0001F4E9?"
...
lastUpdated: 2026-07-08T01:29:20.247Z
...
Learn more on what happens at [**Sprint Review** meetings](/what-happens-at-a-sprint-review-meeting) and [**Sprint Retrospective** meetings](/what-happens-at-retro-meetings).
...
<emailEmbed
  ...
  body={<>
    ...
    **Figure: Timesheet data for the SSW Website**
    ...
    | 23120  | UX Improvements                     | Bob Northwind | 👀 In Review    | 4          |
    ...
    **Note:** Yakshaver.ai has a feature on their [roadmap](https://yakshaver.ai/roadmap) that will do this automatically
    ...
    **Figure: Health metrics**
    ...
    ![Figure: Deployments from &#123;&#123; DEPLOYMENT SERVICE &#125;&#125;](/uploads/rules/sprint-review-retro-email/production-deploy-new.png)
    ...
    *Add this for each current epic in your backlog*
    ...
    &#123;&#123; INSERT DETAILS of any trial/error processes, and ensure all detail is captured as per [https://www.ssw.com.au/rules/do-you-record-your-failures](/do-you-record-your-failures) &#125;&#125;
    
    &#123;&#123; INSERT DETAILS of any problems for which no solutions existed, and ensure detail is captured as per [https://www.ssw.com.au/rules/do-you-record-your-research-under-the-pbi](/do-you-record-your-research-under-the-pbi) &#125;&#125;
    ...
    * Bob Northwind - Claude, Copilot CLI
    ...
    ### AI Stats - Claude **🤖**![Figure: Claude-created meeting overview - Image from Product Owner](/uploads/rules/sprint-review-retro-email/claude-stats.png)
    ...
    **Definition of Done** *(Optional)*
    ...
    Did anyone look at /insights? Any suggestions to share with the team?
    
    &lt; This is as per the rule [https://www.ssw.com.au/rules/sprint-review-retro-email](/sprint-review-retro-email) &gt;
  </>}
  figurePrefix="good"
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="TinaCloud team Sprint Review email 📩" src="/uploads/rules/sprint-review-retro-email/tina-sprint-email.png" />
