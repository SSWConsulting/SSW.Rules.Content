...
<imageEmbed
  ...
  captionText={"Data from the form responses"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Transformed data makes it easy to allocate teams"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Pre-allocate teams's location"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"GitHub Discussion - Team allocations"}
