...
<imageEmbed
  ...
  captionText={"Bad example - four images, one for each icon"}
...
<imageEmbed
  ...
  captionText={"Good Example - one image contains all the icons and CSS selectors make the browser display only the part you need"}
