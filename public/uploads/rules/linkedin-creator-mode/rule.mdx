...
created: 2023-11-27 04:42:22+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - no hashtags"}
...
<imageEmbed
  ...
  figureText={"Good example - profile with hashtags"}
...
<imageEmbed
  ...
  figureText={"Where to find 'creator mode' on LinkedIn"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Hashtags to include on Creator mode"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Profile with Creator mode enabled"}
