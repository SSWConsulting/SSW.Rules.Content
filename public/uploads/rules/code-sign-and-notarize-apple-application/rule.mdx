...
2. In the menu bar, select:
   **Keychain Access → Certificate Assistant → Request a Certificate From a Certificate Authority…**
   ...
   ![keychain-create-csr-1](/uploads./keychain-create-csr-1.png)
3. Fill in the form:
   ...
   * **Request is** — Save to disk
   ![keychain-create-csr-2](/uploads./keychain-create-csr-2.png)
...
2. Navigate to **Certificates, Identifiers & Profiles**, then select **Certificates**.
   ...
   ![portal-certificate](/uploads./portal-certificate.png)
3. Click the **➕ (Add)** button to create a new certificate.

   ![portal-add-button](/uploads./portal-add-button.png)
4. Under **Software**, select **Developer ID Application**, then click **Continue**.

   ![portal-developer-id-application](/uploads./portal-developer-id-application.png)
5. When prompted, upload your CSR file:
   * Select the `.csr` file you created earlier
   * Click **Continue**
   ![portal-choose-certificate](/uploads./portal-choose-certificate.png)
...
![keychain-access-developer-id-application](/uploads./keychain-access-developer-id-application-certificate.png)
...
2. In the Sign-In and Security section, select App-Specific Passwords.
   ...
   ![appleid-app-specific-pw](/uploads./appleid-appp-specific-pw.png)
3. Select Generate an app-specific password or select the Add button(+).

   ![app-specific-1](/uploads./app-specific-1.png)
4. Then give a name for the password and click "Create".

   ![app-specific-2](/uploads./app-specific-2.png)
