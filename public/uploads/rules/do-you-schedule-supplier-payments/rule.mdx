...
<imageEmbed
  ...
  figureText={"Use Xero's bill creation via email forwarding process"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Use Xero Expense for capturing bills or money spent"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Scheduling area of unpaid bills"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Prepare batch payment for scheduled payments on a specific date"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Emailing Remittance Advice from Xero"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Emailing the remittance advice to the Xero user's email address"}
