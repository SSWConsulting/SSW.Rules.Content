...
<imageEmbed
  ...
  caption={"Use Xero's bill creation via email forwarding process"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Use Xero Expense for capturing bills or money spent"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Scheduling area of unpaid bills"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Prepare batch payment for scheduled payments on a specific date"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Emailing Remittance Advice from Xero"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Emailing the remittance advice to the Xero user's email address"}
