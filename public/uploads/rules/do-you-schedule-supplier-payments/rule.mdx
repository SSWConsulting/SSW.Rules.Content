...
isArchived: false
lastUpdated: 2021-05-28 23:19:08.705000+00:00
...
<imageEmbed
  ...
  captionText={"Use Xero's bill creation via email forwarding process"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Use Xero Expense for capturing bills or money spent"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Scheduling area of unpaid bills"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Prepare batch payment for scheduled payments on a specific date"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Emailing Remittance Advice from Xero"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Emailing the remittance advice to the Xero user's email address"}
