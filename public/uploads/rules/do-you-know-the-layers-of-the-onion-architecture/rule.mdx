...
<youtubeEmbed url="https://www.youtube.com/embed/FcuFya8vud8?rel=0&controls=0&showinfo=0" description="Further Reading:" /> [Do You Use a Dependency Injection Centric Architecture?](/do-you-use-a-dependency-injection-centric-architecture)
