...
2. Removed the unecessary closing brackets from:
  ...
  caption={"OK example - What was done is clear, but both editor and reviewer may spend too much time on the description of such simple changes"}
/>
...
**PR description:** Added missing video caption + removed unnecessary brackets
  ...
  caption={"Clear and concise description"}
/>
