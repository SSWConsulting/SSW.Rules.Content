...
<boxEmbed
  ...
  captionText={"Bad example – Unclear which Copilot and where the bugs live"}
/>
...
<boxEmbed
  ...
  captionText={"Good example – Specifies the flavor and the data source"}
/>