...
<imageEmbed
  ...
  caption={"OK example - Using the VS Code extension GitLens, can see commits on hover within the code"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  caption={"OK example - Packages documented within package.json"}
...
<imageEmbed
  ...
  caption={"Both Git commits with GitLens and package.json comments"}
