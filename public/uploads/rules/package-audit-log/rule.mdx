...
created: 2022-10-27 05:23:16.827000+00:00
...
<imageEmbed
  ...
  figureText={"OK example - Using the VS Code extension GitLens, can see commits on hover within the code"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="okExample"
  figureText={"OK example - Packages documented within package.json"}
...
<imageEmbed
  ...
  figureText={"Both Git commits with GitLens and package.json comments"}
