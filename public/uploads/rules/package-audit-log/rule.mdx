...
created: 2022-10-27 08:25:05+00:00
...
seoDescription: Maintaining a package audit log helps developers track why packages
  are added, who added them, and who approved them. By keeping track of package details,
  you can reduce technical debt and ensure transparency within your team.
...
<imageEmbed
  ...
  captionText={"OK example - Using the VS Code extension GitLens, can see commits on hover within the code"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  captionText={"OK example - Packages documented within package.json"}
...
<imageEmbed
  ...
  captionText={"Both Git commits with GitLens and package.json comments"}
