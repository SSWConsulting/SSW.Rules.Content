...
lastUpdated: 2025-09-30T09:30:02.000Z
lastUpdatedBy: Chloe Lin [SSW]
lastUpdatedByEmail: chloelin@ssw.com.au
created: 2025-09-26T13:31:56.000Z
...
/>
<youtubeEmbed url="https://www.youtube.com/watch?v=-m9KHI1Fg0w" description={"Video: Introduction to Internationalization -i18n (4mn)"} />
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "default",
    figure: "Arabic Facebook homepage",
    shouldDisplay: true
  } }
  src="/uploads/rules/why-your-website-might-break-for-global-users/facebook_arabic.png"
/>

Interesting article about mirroring design for Arabic users: [https://blog.prototypr.io/mirroring-how-to-design-for-arabic-users-a1dbcd3aa566](https://blog.prototypr.io/mirroring-how-to-design-for-arabic-users-a1dbcd3aa566)
...
Internationalized Domain Names (IDN) allow non-Latin URLs like [https://例え.jp](https://例え.jp) or [https://مثال.السعودية](https://مثال.السعودية). But your regex validation probably breaks on these. Your sitemap generator might crash. Your analytics will show garbage.
...
Have a look at : [https://www.speedtest.net/global-index](https://www.speedtest.net/global-index)
...
Check out that rule about CDN and Interalization: [https://www.ssw.com.au/rules/use-a-cdn/](https://www.ssw.com.au/rules/use-a-cdn/)

We also have a set of rule about internalization and China that might interest you: [https://www.ssw.com.au/rules/search/?keyword=chinafy](https://www.ssw.com.au/rules/search/?keyword=chinafy)
