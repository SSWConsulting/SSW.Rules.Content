...
lastUpdated: 2019-12-31T02:36:43.000Z
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: 'Advantage: Simplifies ORM Mapping',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: 'Advantage: Maintains Complete Referential Integrity without the need for triggers',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: 'Advantage: You can add new columns specific to each lookup table',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: 'Disadvantage: Multiple tables make maintenance slightly more difficult, especially when making changes directly via Management Studio',
  shouldDisplay: true
} } />
