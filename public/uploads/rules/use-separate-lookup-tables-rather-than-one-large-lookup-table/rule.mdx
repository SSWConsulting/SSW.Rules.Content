...
created: 2019-11-07 20:11:31+00:00
...
seoDescription: Separate lookup tables simplify ORM mapping, maintain referential
  integrity and allow adding unique columns to each table.
title: Schema - Do you use separate lookup tables rather than one large lookup table
  for your lookup data?
categories:
