...
<emailEmbed
  ...
  caption={"Bad example - This is a monolithic 8-day task"}
/>
...
<emailEmbed
  ...
  caption={"Good example - The same monolithic task, broken down into 4 smaller tasks which can all be shipped incrementally"}
/>