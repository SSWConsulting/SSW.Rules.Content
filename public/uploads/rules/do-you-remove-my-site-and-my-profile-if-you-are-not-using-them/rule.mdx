...
<imageEmbed
  ...
  figureText={"Links need to be hidden"}
...
<imageEmbed
  ...
  figureText={"Bad example - Choose “default” link"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Uncheck the association for \"User Profile Service\""}
...
<imageEmbed
  ...
  figureText={"OK example - “User Profile Service Application” manage page"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="okExample"
  figureText={"OK example - Customize \"User Profile Permissions\""}
...
<imageEmbed
  ...
  figureText={"Good example - Delete \"User Profile Service\""}
