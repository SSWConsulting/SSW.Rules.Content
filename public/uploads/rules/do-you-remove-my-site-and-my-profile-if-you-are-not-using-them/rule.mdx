...
<imageEmbed
  ...
  caption={"Links need to be hidden"}
...
<imageEmbed
  ...
  caption={"Bad example - Choose “default” link"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Uncheck the association for \"User Profile Service\""}
...
<imageEmbed
  ...
  caption={"OK example - “User Profile Service Application” manage page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  caption={"OK example - Customize \"User Profile Permissions\""}
...
<imageEmbed
  ...
  caption={"Good example - Delete \"User Profile Service\""}
