...
<imageEmbed
  ...
  captionText={"Links need to be hidden"}
...
<imageEmbed
  ...
  captionText={"Bad example - Choose “default” link"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Uncheck the association for \"User Profile Service\""}
...
<imageEmbed
  ...
  captionText={"OK example - “User Profile Service Application” manage page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  captionText={"OK example - Customize \"User Profile Permissions\""}
...
<imageEmbed
  ...
  captionText={"Good example - Delete \"User Profile Service\""}
