...
<imageEmbed
  ...
  captionText={"Bad example - using Effort labels is not ideal for GitHub Issues"}
...
<imageEmbed
  ...
  captionText={"Good example -  Add a few labels beyond the ones that are set based on the Issue Templates"}
