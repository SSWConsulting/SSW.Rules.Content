...
created: 2021-11-04 02:41:47+00:00
...
<imageEmbed
  ...
  caption={"Bad example - using Effort labels is not ideal for GitHub Issues"}
...
<imageEmbed
  ...
  caption={"Good example -  Add a few labels beyond the ones that are set based on the Issue Templates"}
