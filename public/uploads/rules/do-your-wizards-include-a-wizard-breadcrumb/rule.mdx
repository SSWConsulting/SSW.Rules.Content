...
<imageEmbed
  ...
  figureText={"Good example - SugarLearning's \"Create your company\" wizard"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - The heading from booking.com shows the user at what stage of the ordering process they are at, and what they can expect next. This covers the whole billing process"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Virgin Australia uses a more subtle but also effective approach"}
