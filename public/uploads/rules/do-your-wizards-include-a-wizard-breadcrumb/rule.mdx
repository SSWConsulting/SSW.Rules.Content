...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="SugarLearning's &#x22;Create your company&#x22; wizard" src="/uploads/rules/do-your-wizards-include-a-wizard-breadcrumb/sugarlearning-wizard.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="The heading from booking.com shows the user at what stage of the ordering process they are at, and what they can expect next. This covers the whole billing process" src="/uploads/rules/do-your-wizards-include-a-wizard-breadcrumb/booking-wizard.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Virgin Australia uses a more subtle but also effective approach" src="/uploads/rules/do-your-wizards-include-a-wizard-breadcrumb/virginblue-wizard.png" />
