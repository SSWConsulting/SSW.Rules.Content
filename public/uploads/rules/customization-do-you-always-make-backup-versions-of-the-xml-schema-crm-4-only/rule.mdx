...
**Tip #1:** Export only the customizations of entities that you customize and keep each entity customizations in a separate file, see the rule:[Customization](/crm-export-only-related-customizations) - Do you export only the customizations of entities that you did customize?
