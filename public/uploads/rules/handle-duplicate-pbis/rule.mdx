...
<imageEmbed
  ...
  captionText={"Good example - A clean and well-defined PBI is a good candidate for the main PBI to keep"}
...
<boxEmbed
  ...
  captionText={"Bad example - The issue is closed abruptly without context, which confuses the reporter"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - Using the built-in GitHub duplicate workflow keeps issues linked and easy to trace"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Using the built-in \"Close as duplicate of...\" button is an easy way to close an item while linking to the main PBI. It can be helpful to leave comment here for additional context"}
...
&gt; "@jane thanks for reporting this! We've got a few open issues reporting this problem, so we're going to consolidate them into a single issue here - #103. Feel free to subscribe to it to follow along!"
  ...
  captionStyle="goodExample"
  captionText={"Good example - All reporters are acknowledged and invited to join the discussion on the main issue"}
/>
...
&gt; Thanks for your contribution 🙏"
  ...
  captionStyle="goodExample"
  captionText={"Best example - Users are kept informed that the work is done, even when they didn't subscribe to the main issue"}
/>
