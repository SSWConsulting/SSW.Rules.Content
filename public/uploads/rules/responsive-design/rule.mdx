...
created: 2023-08-24 20:22:21+00:00
...
seoDescription: Responsive web design ensures a seamless user experience across various
  devices and screen sizes by dynamically adjusting layout and content presentation
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Google PageSpeed Insights provides both lab and field data about your site's loading speed on mobile devices, along with actionable recommendations to improve performance"}
