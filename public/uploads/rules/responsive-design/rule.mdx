...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Google PageSpeed Insights provides both lab and field data about your site's loading speed on mobile devices, along with actionable recommendations to improve performance"}
