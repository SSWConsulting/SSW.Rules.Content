...
<imageEmbed
  ...
  caption={"Bad example - Feels fake due to the flat background"}
...
<imageEmbed
  ...
  caption={"Good example – Feels genuine with just a twist of the camera"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - 2 lines of irrelevant reminders in Outlook"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Clean Outlook UI"}
