...
created: 2023-10-10T00:19:33.000Z
...
Account Manager: _"No problem, we can re-evaluate the backlog and adjust the estimates accordingly."_
  ...
  captionText={"Good example - Adapting to client’s evolving priorities maintains alignment and trust"}
/>
...
Regards,
  ...
  captionText={"Follow up appointment after a Spec Review"}
/>
