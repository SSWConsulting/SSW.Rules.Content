...
<boxEmbed
  ...
  captionText={"Bad example - The prompt is overly long, vague, and difficult to understand"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - Concise, clear, and directly asks for the desired information"}
/>
