...
<boxEmbed
  ...
  caption={"Bad example - The prompt is overly long, vague, and difficult to understand"}
/>
...
<boxEmbed
  ...
  caption={"Good example - Concise, clear, and directly asks for the desired information"}
/>
