...
<imageEmbed
  ...
  figureText={"Exchange admin center | Manage mailbox archive"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Outlook | Online Archive mailbox"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Default Online Archive policy options"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Microsoft Purview | MRM Retention tags"}
