...
<imageEmbed
  ...
  caption={"Exchange admin center | Manage mailbox archive"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Outlook | Online Archive mailbox"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Default Online Archive policy options"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Microsoft Purview | MRM Retention tags"}
