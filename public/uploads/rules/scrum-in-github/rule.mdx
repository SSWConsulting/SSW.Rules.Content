...
<imageEmbed
  ...
  captionText={"Good example - GitHub Projects gives you much more powerful project management ability"}
...
<imageEmbed
  ...
  captionText={"Create a new GitHub Project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Choose template to create a new project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Creating Sprint irterations in a new GitHub project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Pick the name and the dates via the Iteration field options"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"SSW.Website view bar"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Finding the Insights Screen"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Example custom chart displaying workload for the current Sprint"}
