...
created: 2021-10-28 01:49:43.558000+00:00
...
<imageEmbed
  ...
  figureText={"Good example - GitHub Projects gives you much more powerful project management ability"}
...
<imageEmbed
  ...
  figureText={"Create a new GitHub Project"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Choose template to create a new project"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Creating Sprint irterations in a new GitHub project"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Pick the name and the dates via the Iteration field options"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"SSW.Website view bar"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Finding the Insights Screen"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example custom chart displaying workload for the current Sprint"}
