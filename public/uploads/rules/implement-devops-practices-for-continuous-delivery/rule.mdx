...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="DevOps practices enable faster, more reliable deployments."
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="DevOp\\s practices reduce the time from code commit to deployment."
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Lack of DevOps practices can lead to risky deployments and frequent rollbacks."
