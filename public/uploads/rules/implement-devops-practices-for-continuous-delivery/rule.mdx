...
created: 2023-10-13 17:26:00+00:00
...
<imageEmbed
  ...
  figureText={"Good Example - DevOps practices enable faster, more reliable deployments."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - DevOp\\s practices reduce the time from code commit to deployment."}
...
<imageEmbed
  ...
  figureText={"Bad Example - Lack of DevOps practices can lead to risky deployments and frequent rollbacks."}
