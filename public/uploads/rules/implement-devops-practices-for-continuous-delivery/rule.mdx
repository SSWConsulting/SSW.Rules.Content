...
<imageEmbed
  ...
  captionText={"Good Example - DevOps practices enable faster, more reliable deployments."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - DevOp\\s practices reduce the time from code commit to deployment."}
...
<imageEmbed
  ...
  captionText={"Bad Example - Lack of DevOps practices can lead to risky deployments and frequent rollbacks."}
