...
title: Do you purge WordPress cache after making changes?
categories:
...
**WP Engine** - After you make a change on any WordPress site:
...
More information: [WP Engine documentation - Purge Server Caches](https://wpengine.com/support/cache/#Purge_Server_Caches).
