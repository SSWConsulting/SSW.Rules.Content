...
<imageEmbed
  ...
  figureText={"What information should you include when reporting a defect"}
...
<boxEmbed
  ...
  figureText={"Bad example – Too vague; missing location, urgency, and who it’s reported to"}
/>
...
<imageEmbed
  ...
  figureText={"Good example- Clear and includes all the essential details for fast action and tracking"}
