...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"What information should you include when reporting a defect"}
...
<boxEmbed
  ...
  captionText={"Bad example – Too vague; missing location, urgency, and who it’s reported to"}
/>
...
<imageEmbed
  ...
  captionText={"Good example- Clear and includes all the essential details for fast action and tracking"}
