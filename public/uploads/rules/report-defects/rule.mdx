...
lastUpdated: 2026-01-30 09:22:26.953000+00:00
lastUpdatedBy: Chloe
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="What information should you include when reporting a defect" src="/uploads/rules/report-defects/ssw-rules-best-way-to-report-an-office-defect-v3.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Clear and includes all the essential details for fast action and tracking" src="/uploads/rules/report-defects/defects-pbi-example.png" />
