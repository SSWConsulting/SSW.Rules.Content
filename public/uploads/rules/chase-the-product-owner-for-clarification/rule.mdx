...
<boxEmbed
  ...
  caption={"The worst example - not reaching out to your Product Owner or manager at all. You should be in regular contact with them"}
/>
...
Jason
  ...
  captionStyle="badExample"
  caption={"Bad example - you shouldn't have to ask that!"}
/>
...
Jason
  ...
  caption={"Good example - Actively reaching out to your Product Owner"}
/>