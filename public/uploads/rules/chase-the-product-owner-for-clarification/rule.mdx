...
<boxEmbed
  ...
  figureText={"The worst example - not reaching out to your Product Owner or manager at all. You should be in regular contact with them"}
/>
...
Jason
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - you shouldn't have to ask that!"}
/>
...
Jason
  ...
  figureText={"Good example - Actively reaching out to your Product Owner"}
/>