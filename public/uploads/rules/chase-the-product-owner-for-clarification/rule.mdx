...
<boxEmbed
  ...
  captionText={"The worst example - not reaching out to your Product Owner or manager at all. You should be in regular contact with them"}
/>
...
Jason
  ...
  captionStyle="badExample"
  captionText={"Bad example - you shouldn't have to ask that!"}
/>
...
Jason
  ...
  captionText={"Good example - Actively reaching out to your Product Owner"}
/>