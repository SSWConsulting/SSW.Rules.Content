...
<imageEmbed
  ...
  figureText={"Bad Example - Storing an AD Account as a String (AD Account is a complex type)"}
...
<imageEmbed
  ...
  figureText={"Good Example - Storing an AD Account as a Value Object to Support Logic and Validation"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - Implementation of the AdAccount Value Object Supports Logic and Validation"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Using Entity Framework Core to Configure Value Objects as Owned Entity Types"}
