...
<imageEmbed
  ...
  caption={"Bad Example - Storing an AD Account as a String (AD Account is a complex type)"}
...
<imageEmbed
  ...
  caption={"Good Example - Storing an AD Account as a Value Object to Support Logic and Validation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - Implementation of the AdAccount Value Object Supports Logic and Validation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Using Entity Framework Core to Configure Value Objects as Owned Entity Types"}
