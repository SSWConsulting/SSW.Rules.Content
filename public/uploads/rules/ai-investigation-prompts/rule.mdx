...
lastUpdated: 2026-01-28T02:23:20.265Z
...
<boxEmbed
  body={<>
    I am working on the Xero integration. Give me a detailed breakdown of how Xero integration is currently implemented, along with all configuration values that are used (and where to find them). Additionally, highlight the code paths that touch the Xero integrations.
  </>}
  figurePrefix="ok"
