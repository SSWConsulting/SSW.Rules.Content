...
lastUpdated: 2026-01-28T04:20:42.474Z
...
These 3 strategies combined will produce exceptional results, and are used by SSW daily. 
...
<boxEmbed
  body={<>
    ...
    Problem statement: {{ Write your statement here. E.g., "I am working on the Xero integration. Give me a an architectural overview of how Xero integration is currently implemented, along with all configuration values that are used (and where to find them). Additionally, highlight the code paths that touch the Xero integrations." }}
  </>}
  figurePrefix="good"
  figure="A re-usable Investigation Prompt template 👑"
  style="greybox"
/>
...
Typing is hard. You may miss out on details that you would otherwise explain if you were speaking to another person. Try using a dictation tool (or a speech-to-text app) to reduce the friction in getting your thoughts into the prompt. Don't worry too much on wordsmithing the perfect sentence - AI is good at working around word salads.
