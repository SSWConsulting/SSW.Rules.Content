...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="'Language' setting is set to a specific culture"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="'Language' setting is set to '=User!Language' to detect user's culture automatically"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The data respects user's Language preference of IE in this case English (Australia)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Likewise the data also respects user's Language preference of IE in this case Chinese (China)"
