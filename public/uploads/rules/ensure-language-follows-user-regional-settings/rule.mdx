...
isArchived: false
lastUpdated: 2025-02-05 12:22:27+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - 'Language' setting is set to a specific culture"}
...
<imageEmbed
  ...
  captionText={"Good example - 'Language' setting is set to '=User!Language' to detect user's culture automatically"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - The data respects user's Language preference of IE in this case English (Australia)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Likewise the data also respects user's Language preference of IE in this case Chinese (China)"}
