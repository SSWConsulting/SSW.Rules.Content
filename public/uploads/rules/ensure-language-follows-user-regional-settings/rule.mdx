...
<imageEmbed
  ...
  caption={"Bad example - 'Language' setting is set to a specific culture"}
...
<imageEmbed
  ...
  caption={"Good example - 'Language' setting is set to '=User!Language' to detect user's culture automatically"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - The data respects user's Language preference of IE in this case English (Australia)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Likewise the data also respects user's Language preference of IE in this case Chinese (China)"}
