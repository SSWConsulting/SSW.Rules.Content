...
<imageEmbed
  ...
  figureText={"A simple blog post with your video embeded will help expand the audience for your video/content"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"A blog post that includes a video, keywords and the complete thought process will be seen with more authority by Google and give you more views"}
