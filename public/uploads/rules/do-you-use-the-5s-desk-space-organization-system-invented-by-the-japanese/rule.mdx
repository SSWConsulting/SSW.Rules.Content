...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - A messy desk is a messy head](Apply-5S_Desk-01_GoLeanSixSigma.com_.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - A clean and productive workspace following the 5S methodology](Apply-5S_Desk-04_GoLeanSixSigma.com_.jpg)',
  shouldDisplay: true
} } />
