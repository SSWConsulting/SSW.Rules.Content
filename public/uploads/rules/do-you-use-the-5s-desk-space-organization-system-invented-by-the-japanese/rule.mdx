...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - A messy desk is a messy head](/uploads/rules/do-you-use-the-5s-desk-space-organization-system-invented-by-the-japanese/Apply-5S_Desk-01_GoLeanSixSigma.com_.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - A clean and productive workspace following the 5S methodology](/uploads/rules/do-you-use-the-5s-desk-space-organization-system-invented-by-the-japanese/Apply-5S_Desk-04_GoLeanSixSigma.com_.jpg)',
  shouldDisplay: true
} } />
