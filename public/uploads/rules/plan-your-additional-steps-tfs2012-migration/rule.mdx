---
archivedreason: Outdated - Applies to TFS 2012 migration (end-of-life). For modern guidance, see [Do you know all the ways you can migrate to the cloud?](/the-ways-you-can-migrate-to-the-cloud).
isArchived: true
authors:
- title: Damian Brady
