...
isArchived: false
lastUpdated: 2018-10-26 16:31:39+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Having just 3 components for the page makes it difficult to reuse, maintain and test"}
...
<imageEmbed
  ...
  figureText={"Good example - Splitting up the page into 11 components means they are small and targeted - and thus easy to maintain and test. Components can be reused on other pages"}
