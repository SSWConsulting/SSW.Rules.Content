...
<imageEmbed
  ...
  captionText={"Bad example - Having just 3 components for the page makes it difficult to reuse, maintain and test"}
...
<imageEmbed
  ...
  captionText={"Good example - Splitting up the page into 11 components means they are small and targeted - and thus easy to maintain and test. Components can be reused on other pages"}
