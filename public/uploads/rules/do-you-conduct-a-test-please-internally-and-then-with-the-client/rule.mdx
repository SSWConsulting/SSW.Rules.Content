...
seoDescription: Comprehensive guide to software development testing processes, emphasizing
  the importance of internal and client-facing 'test please' procedures for ensuring
...
<imageEmbed
  ...
  figureText={"Do you want users to have good first impressions?"}
  src="/uploads/rules/do-you-conduct-a-test-please-internally-and-then-with-the-client/pic16-TestingDoYouWantThemT.gif"
/>
...
(as per critical bugs reported in other emails)
  ...
  figurePreset="defaultExample"
  figureText={"This is how to reply failed to a \"test please\" email"}
/>
