...
<imageEmbed
  ...
  figureText={"Good Example - If you want to avoid migrating then SSW Access Reporter delivers your Access reports online so you can view them anywhere"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - Reporting Services has built-in support for importing your Access reports"}
