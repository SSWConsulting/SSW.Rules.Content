...
isArchived: false
lastUpdated: 2024-08-19 22:54:19+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - Search is not reminding the user about the fact that a built-in filter is applied to the search result"}
...
<imageEmbed
  ...
  captionText={"Good example - Search reminds the user that the search criteria can be widen to show more result"}
