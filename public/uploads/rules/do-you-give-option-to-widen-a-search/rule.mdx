...
<imageEmbed
  ...
  figureText={"Bad example - Search is not reminding the user about the fact that a built-in filter is applied to the search result"}
...
<imageEmbed
  ...
  figureText={"Good example - Search reminds the user that the search criteria can be widen to show more result"}
