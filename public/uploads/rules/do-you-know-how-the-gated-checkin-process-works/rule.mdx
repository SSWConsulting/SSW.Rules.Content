...
<imageEmbed
  ...
  captionText={"The developer is notified if a gated check-in resulted in a commit"}
...
<imageEmbed
  ...
  captionText={"Bad Example - Reconcile by clicking \"Check In\" again.  This will fail, but any files you're trying to check in will be reconciled."}
...
<imageEmbed
  ...
  captionText={"OK Example – Open the Build and choose Actions | Reconcile Workspace..."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example #1 – Click the link in the notification after clicking Check In"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example #2 – Click on the link in the notification to open the build, then click Reconcile Workspace when the build finishes"}
