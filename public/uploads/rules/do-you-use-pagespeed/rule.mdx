...
<imageEmbed
  ...
  figureText={"Install PageSpeed Insights (with PNaCl)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Start your PageSpeed by clicking \"Analyze\""}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Some files can be compressed more than 80%"}
