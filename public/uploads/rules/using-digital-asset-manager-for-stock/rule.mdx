...
created: 2023-08-09 02:20:28.506000+00:00
...
seoDescription: Learn how to efficiently organize and manage your video assets using
  a Digital Asset Manager like Adobe Bridge for better searchability and streamlined
  workflows.
...
<imageEmbed
  ...
  figureText={"Bad example - Untreated clip with unhelpful file name E.g. \"ssw-Broll\""}
...
<imageEmbed
  ...
  figureText={"Good example - Treated clip lip with usable section and searchable file name E.g. \"2020-01-17-SSW-Brisbane-close-up-over-the-shoulder-jk-dev-talking\""}
...
<imageEmbed
  ...
  figureText={"Adobe Bridge metadata tab"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Adobe Bridge keyword list tab"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Adobe Bridge Keywords tab location"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Export keywords list"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Import keywords list"}
