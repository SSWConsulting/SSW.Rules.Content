...
seoDescription: Learn how to efficiently organize and manage your video assets using
  ...
  workflows.
title: Video data - Do you manage your video assets with a Digital Asset Manager (DAM)?
categories:
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure='Untreated clip with unhelpful file name E.g. "ssw-Broll"'
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure='Treated clip lip with usable section and searchable file name E.g. "2020-01-17-SSW-Brisbane-close-up-over-the-shoulder-jk-dev-talking"'
