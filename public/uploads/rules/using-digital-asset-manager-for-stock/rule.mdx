...
<imageEmbed
  ...
  captionText={"Bad example - Untreated clip with unhelpful file name E.g. \"ssw-Broll\""}
...
<imageEmbed
  ...
  captionText={"Good example - Treated clip lip with usable section and searchable file name E.g. \"2020-01-17-SSW-Brisbane-close-up-over-the-shoulder-jk-dev-talking\""}
...
<imageEmbed
  ...
  captionText={"Adobe Bridge metadata tab"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Adobe Bridge keyword list tab"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Adobe Bridge Keywords tab location"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Export keywords list"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Import keywords list"}
