...
<imageEmbed
  ...
  caption={"Bad example - Untreated clip with unhelpful file name E.g. \"ssw-Broll\""}
...
<imageEmbed
  ...
  caption={"Good example - Treated clip lip with usable section and searchable file name E.g. \"2020-01-17-SSW-Brisbane-close-up-over-the-shoulder-jk-dev-talking\""}
...
<imageEmbed
  ...
  caption={"Adobe Bridge metadata tab"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Adobe Bridge keyword list tab"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Adobe Bridge Keywords tab location"}
