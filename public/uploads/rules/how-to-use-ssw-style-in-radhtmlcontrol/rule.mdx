...
<imageEmbed
  ...
  caption={"Copy content in the notepad"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Start copying content over"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Apply style to the image"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Apply style to the figure"}
  src="/uploads/rules/how-to-use-ssw-style-in-radhtmlcontrol/ApplyStyleImageArea.jpg"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Apply yellow border box to the content"}
