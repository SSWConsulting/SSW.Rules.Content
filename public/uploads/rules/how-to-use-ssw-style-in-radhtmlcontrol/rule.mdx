...
``` html
<span class="ms-rteCustom-YellowBorderBox">We have a program called <a href="https://www.ssw.com.au/LookOut"> SSW LookOut! for Outlook</a> to check for this rule.
<br />
<span class="ms-rteCustom-ImageArea">
  <img style="border-bottom: 0px solid; border-left: 0px solid; border-top: 0px solid; border-right: 0px solid;" border="0" alt="Lookout Reply All BCC Warning" src="https://www.ssw.com.au/LookOut/images/lookout-logo.jpg" />
<br />
</span>
<br />
