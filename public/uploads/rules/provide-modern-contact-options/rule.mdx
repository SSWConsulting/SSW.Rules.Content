...
<imageEmbed
  ...
  caption={"Bad example - The only way to contact the company is via email"}
...
<imageEmbed
  ...
  caption={"Good example - Chat is available along with other ways of contact, such as voip, IM, KB etc"}
