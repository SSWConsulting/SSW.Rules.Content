...
lastUpdated: 2026-04-17T22:17:31.451Z
...
Clearly show when a field fails (with a helpful message and visual cue) and confirm when it passes, so users know they can move forward with confidence.
