...
<imageEmbed
  ...
  captionText={"Bad example - No visual indication for required fields when a user first sees the form"}
...
<imageEmbed
  ...
  captionText={"Good Example - A visual indication of what fields are required (use a red asterisk if you are not a designer)"}
