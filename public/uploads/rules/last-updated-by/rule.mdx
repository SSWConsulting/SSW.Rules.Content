...
<imageEmbed
  ...
  figureText={"Bad example - No clue who changed this page or when it was last updated"}
...
<imageEmbed
  ...
  figureText={"Good example - Showing the last updated by and a history link"}
