...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Bad example - No clue who changed this page or when it was last updated" src="/uploads/rules/last-updated-by/how-tinacms-works-bad-example.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Good example - Showing the last updated by and a history link" src="/uploads/rules/last-updated-by/how-tinacms-works-good-example.png" />
