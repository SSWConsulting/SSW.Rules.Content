...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - No information. Not relevant for all staff to see](bad1.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - This should have been shared in a group. Not via a group email](bad2.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - Clearly talks about an outage that will affect all users](good1.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - Gets the information out to all staff so that they can respond if they can assist](good2.png)',
  shouldDisplay: true
} } />
