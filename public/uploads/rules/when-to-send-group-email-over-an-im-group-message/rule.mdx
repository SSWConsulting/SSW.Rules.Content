...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - No information. Not relevant for all staff to see](/uploads/rules/when-to-send-group-email-over-an-im-group-message/bad1.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - This should have been shared in a group. Not via a group email](/uploads/rules/when-to-send-group-email-over-an-im-group-message/bad2.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - Clearly talks about an outage that will affect all users](/uploads/rules/when-to-send-group-email-over-an-im-group-message/good1.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - Gets the information out to all staff so that they can respond if they can assist](/uploads/rules/when-to-send-group-email-over-an-im-group-message/good2.png)',
  shouldDisplay: true
} } />
