...
<imageEmbed
  ...
  captionText={"Bad example - No information. Not relevant for all staff to see"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - This should have been shared in a group. Not via a group email"}
...
<imageEmbed
  ...
  captionText={"Good example - Clearly talks about an outage that will affect all users"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Gets the information out to all staff so that they can respond if they can assist"}
