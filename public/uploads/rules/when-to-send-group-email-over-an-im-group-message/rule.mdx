...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="No information. Not relevant for all staff to see"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This should have been shared in a group. Not via a group email"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Clearly talks about an outage that will affect all users"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Gets the information out to all staff so that they can respond if they can assist"
