---
seoDescription: Blazor doesn't support stopping event propagation, making it difficult
  to prevent unwanted events from triggering.
type: rule
...
created: 2022-08-17 18:40:42.796000+00:00
