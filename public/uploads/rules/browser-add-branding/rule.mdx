...
<imageEmbed
  ...
  captionText={"Bad example - Default new tab"}
...
<imageEmbed
  ...
  captionText={"Good example - Branded new tab"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Opening new tab settings in a Microsoft Edge browser"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Where to make changes"}
