...
<imageEmbed
  ...
  caption={"Bad example - Default new tab"}
...
<imageEmbed
  ...
  caption={"Good example - Branded new tab"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Opening new tab settings in a Microsoft Edge browser"}
