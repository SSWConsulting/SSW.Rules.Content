...
<imageEmbed
  ...
  figureText={"Bad example - Default new tab"}
...
<imageEmbed
  ...
  figureText={"Good example - Branded new tab"}
...
<imageEmbed
  ...
  figureText={"Opening new tab settings in a Microsoft Edge browser"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Where to make changes"}
