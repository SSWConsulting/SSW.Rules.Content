...
<imageEmbed alt="Screenshot of a SugarLearning task list with completed items shown with strike-through formatting" size="large" showBorder={true} figurePrefix="good" figure="SugarLearning's completed items are struck-through" src="/uploads/rules/do-you-strike-through-completed-items/sugarlearning-task.png" />

<imageEmbed alt="Screenshot of Microsoft Outlook To Do showing completed tasks with strike-through formatting" size="large" showBorder={true} figurePrefix="good" figure="Microsoft Outlook Todo's completed tasks are struck-through" src="/uploads/rules/do-you-strike-through-completed-items/outlook-todo.png" />
