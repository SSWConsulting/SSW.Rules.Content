...
<imageEmbed
  ...
  captionText={"Good example - SugarLearning's completed items are struck-through"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Microsoft Outlook Todo's completed tasks are struck-through"}
