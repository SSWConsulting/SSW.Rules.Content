...
<imageEmbed
  ...
  captionText={"Bad example - Multiline TextBox without \"Vertical\" scroll bar."}
...
<imageEmbed
  ...
  captionText={"Good example - Multiline TextBox with \"Vertical\" scroll bar"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Set the ScrollBars property to \"Vertical\" if the TextBox is Multiline"}
