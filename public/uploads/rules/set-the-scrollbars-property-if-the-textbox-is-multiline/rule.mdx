...
<imageEmbed
  ...
  figureText={"Bad example - Multiline TextBox without \"Vertical\" scroll bar."}
...
<imageEmbed
  ...
  figureText={"Good example - Multiline TextBox with \"Vertical\" scroll bar"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Set the ScrollBars property to \"Vertical\" if the TextBox is Multiline"}
