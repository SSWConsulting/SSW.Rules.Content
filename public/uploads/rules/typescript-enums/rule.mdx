...
<imageEmbed
  ...
  captionText={"Working VSCode Intellisense that works with all const assertions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Using the Icon type from above"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The IconKey type from above"}
