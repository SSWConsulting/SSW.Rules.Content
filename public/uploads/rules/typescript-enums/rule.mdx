...
<imageEmbed
  ...
  figureText={"Working VSCode Intellisense that works with all const assertions"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Using the Icon type from above"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The IconKey type from above"}
