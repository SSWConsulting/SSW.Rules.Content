...
<boxEmbed
  ...
  figureText={"Bad example - These instructions are in reverse and needs to be processed by the user."}
/>
...
<boxEmbed
  ...
  figureText={"Good example - These instructions are in order and do not require any effort from the user."}
/>