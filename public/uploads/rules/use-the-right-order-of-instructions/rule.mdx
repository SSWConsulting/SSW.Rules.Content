...
isArchived: true
lastUpdated: 2023-02-09 00:24:03+00:00
...
<boxEmbed
  ...
  captionText={"Bad example - These instructions are in reverse and needs to be processed by the user."}
/>
...
<boxEmbed
  ...
  captionText={"Good example - These instructions are in order and do not require any effort from the user."}
/>