...
<imageEmbed
  ...
  caption={"Good Example - GitHub Discussion with the update + useful info"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - A tweet with a link to the GitHub Discussion"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Announcing the upgrade with a short note of the new feature"}
