...
<imageEmbed
  ...
  captionText={"Good Example - GitHub Discussion with the update + useful info"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - A tweet with a link to the GitHub Discussion"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Announcing the upgrade with a short note of the new feature"}
