...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="GitHub Discussion with the update + useful info"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A tweet with a link to the GitHub Discussion"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Announcing the upgrade with a short note of the new feature"
