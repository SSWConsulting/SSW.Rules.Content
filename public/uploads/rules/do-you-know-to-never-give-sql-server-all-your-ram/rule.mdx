...
created: 2010-05-27 08:55:53+00:00
createdBy: CindyWang
...
<imageEmbed
  ...
  captionText={"SQL Server Management Studio - Login Screen"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"SQL Database options and properties menu"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Server Properties showing the ridiculously large value set for the maximum server memory"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Maximum server memory settings in server properties"}
