...
<imageEmbed
  ...
  caption={"SQL Server Management Studio - Login Screen"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"SQL Database options and properties menu"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Server Properties showing the ridiculously large value set for the maximum server memory"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Maximum server memory settings in server properties"}
