...
<imageEmbed
  ...
  figureText={"SQL Server Management Studio - Login Screen"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"SQL Database options and properties menu"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Server Properties showing the ridiculously large value set for the maximum server memory"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Maximum server memory settings in server properties"}
