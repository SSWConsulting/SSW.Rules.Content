...
<imageEmbed
  ...
  caption={"Bad example - Having a drawer and a mailbox takes too much space (2 different locations) and larger packages won't fit"}
...
<imageEmbed
  ...
  caption={"OK example - Stepped lockers are great as they allow jackets (however missing the mail hole"}
...
<imageEmbed
  ...
  caption={"Good example - A locker with mail slot is ideal for both mail and packages"}
