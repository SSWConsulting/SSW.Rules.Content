...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Having a drawer and a mailbox takes too much space (2 different locations) and larger packages won't fit"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="Stepped lockers are great as they allow jackets (however missing the mail hole"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A locker with mail slot is ideal for both mail and packages"
