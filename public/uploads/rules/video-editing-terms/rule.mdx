...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Scrubbing this YouTube video 10s"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Scrubbing this Premiere Pro video in the timeline"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Aspect ratio example"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The bad example and good example of white balance"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Clapping at the beginning of the recording can help synchronize the audio"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The speaker's face was away from the microphone"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Cross dissolution makes the video transition more natural"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Fade to black at the end of the scene"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Sample email when sending video feedback including timestamps"}
