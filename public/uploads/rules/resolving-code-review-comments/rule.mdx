...
* **For change requests** - Implement the change and reply "Done" or explain why it will not be implemented
* **For questions** - Reply without resolving to allow conversation continuation
