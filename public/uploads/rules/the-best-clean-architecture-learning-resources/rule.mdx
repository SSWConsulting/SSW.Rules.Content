...
<imageEmbed
  ...
  caption={"Clean Architecture: A Craftsman's Guide to Software Structure and Design"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Architecting Modern Web Applications with ASP.NET Core and Microsoft Azure"}
