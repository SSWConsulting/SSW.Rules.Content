...
seoDescription: Learn Clean Architecture principles through Jason Taylor's videos
  and Robert C Martin's blog post, then dive into Uncle Bob's book or Steve Smith's
  e-book for in-depth guidance on software structure and design.
...
<imageEmbed
  ...
  captionText={"Clean Architecture: A Craftsman's Guide to Software Structure and Design"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Architecting Modern Web Applications with ASP.NET Core and Microsoft Azure"}
