...
<imageEmbed
  ...
  figureText={"Clean Architecture: A Craftsman's Guide to Software Structure and Design"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Architecting Modern Web Applications with ASP.NET Core and Microsoft Azure"}
