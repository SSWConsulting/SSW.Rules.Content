...
<boxEmbed
  ...
  caption={"Bad example - The long URL makes it hard to clearly see what it will take you. People can’t easily type or remember it"}
/>
...
<boxEmbed
  ...
  caption={"Good example - The nice and clean URL makes it easy to see what the link is about"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - The filler words remain"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - The filler words removed and only 'juicy' words remain"}
/>
...
<boxEmbed
  ...
  caption={"OK example - Auto-generated shorten URL - It's short but hard to remember"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Short URL, and easier to remember"}
/>