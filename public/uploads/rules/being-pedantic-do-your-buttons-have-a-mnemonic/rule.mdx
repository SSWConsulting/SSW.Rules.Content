...
<imageEmbed
  ...
  captionText={"Bad example - All buttons without Mnemonic"}
...
<imageEmbed
  ...
  captionText={"Good example - All buttons with Mnemonic - user can easily choose which button they want without a click"}
