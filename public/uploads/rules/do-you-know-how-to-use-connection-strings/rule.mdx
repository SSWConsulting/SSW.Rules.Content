...
seoDescription: Learn best practices for using connection strings in .NET applications,
  including Azure Managed Identities and secure configuration management.
created: 2021-05-09 23:41:49+00:00
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Key Vault Access Policies - Setting permissions for Applications and/or Users" src="/uploads/rules/do-you-know-how-to-use-connection-strings/access_policies.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Enabling the System assigned identity for your App Service - this is required for adding it to Key Vault via Access Policies" src="/uploads/rules/do-you-know-how-to-use-connection-strings/identity.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Creating the SqlConnectionString secret in Key Vault." src="/uploads/rules/do-you-know-how-to-use-connection-strings/add-a-secret.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="SqlConnectionString stored in Key Vault" src="/uploads/rules/do-you-know-how-to-use-connection-strings/secrets.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Your WebApp Configuration - No passwords or secrets, just a name of the Key vault that it needs to access" src="/uploads/rules/do-you-know-how-to-use-connection-strings/configuration.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Settings in Project Properties" src="/uploads/rules/do-you-know-how-to-use-connection-strings/ConnStringNET2_Settings.jpg" />
