...
<imageEmbed
  ...
  figureText={"Key Vault Access Policies - Setting permissions for Applications and/or Users"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Enabling the System assigned identity for your App Service - this is required for adding it to Key Vault via Access Policies"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Creating the SqlConnectionString secret in Key Vault."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"SqlConnectionString stored in Key Vault"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Your WebApp Configuration - No passwords or secrets, just a name of the Key vault that it needs to access"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Settings in Project Properties"}
