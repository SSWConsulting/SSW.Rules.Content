...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Key Vault Access Policies - Setting permissions for Applications and/or Users"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Enabling the System assigned identity for your App Service - this is required for adding it to Key Vault via Access Policies"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Creating the SqlConnectionString secret in Key Vault."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"SqlConnectionString stored in Key Vault"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Your WebApp Configuration - No passwords or secrets, just a name of the Key vault that it needs to access"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Settings in Project Properties"}
