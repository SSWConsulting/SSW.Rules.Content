...
seoDescription: Learn how to optimize your SharePoint search experience with expert
  tips on using categories, filters, and advanced operators for better results
...
<imageEmbed
  ...
  figureText={"Example of using Filetype: filter"}
