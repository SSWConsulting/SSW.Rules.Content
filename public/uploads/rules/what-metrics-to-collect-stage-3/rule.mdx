...
<imageEmbed
  ...
  captionText={"Application Insights gives you information about how things are running and whether there are detected abnormalities in the telemetry"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Azure can render the Application Insights data on a nice dashboard so you can get a high level view of your application"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"App Center can let you monitor app install stats, usage and errors from phones just like an app running in Azure"}
