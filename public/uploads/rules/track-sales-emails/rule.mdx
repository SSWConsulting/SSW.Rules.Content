...
<imageEmbed
  ...
  caption={"This email should be tracked in CRM using the Add-in \"Track without regarding\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Activities Report - Ulysses was the hardest worker for this month. Print this and put it on the wall and it will encourage everyone to log their calls"}
