...
lastUpdated: 2026-01-15T01:30:48.355Z
...
<imageEmbed alt="ScreenCloud Playlist" size="large" showBorder={false} figurePrefix="good" figure="Creating a new Playlist" src="/uploads/rules/screencloud-channels-playlists/screencloud-playlist.png" />
...
More info on [ScreenCloud Studio: Playlists](https://help.screencloud.com/en/articles/10120006-screencloud-studio-playlists).

<imageEmbed alt="ScreenCloud Channel" size="large" showBorder={false} figurePrefix="good" figure="Creating a new Channel" src="/uploads/rules/screencloud-channels-playlists/screencloud-channel.png" />
...
More info on [Channels Setup Guide: Scheduling Content, Using Layouts, and Adding Music to Your Screens](https://help.screencloud.com/en/articles/10110358-channels-setup-guide-scheduling-content-using-layouts-and-adding-music-to-your-screens).
