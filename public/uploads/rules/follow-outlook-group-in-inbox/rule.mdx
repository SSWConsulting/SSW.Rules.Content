...
<imageEmbed
  ...
  caption={"Good Example - Selecting \"Receive all email and events\" ensures you never miss group messages"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example – Admins can set group conversations to be received in inboxes by default"}
