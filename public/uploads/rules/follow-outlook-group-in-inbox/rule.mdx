...
seoDescription: Prevent missing emails from Outlook Groups by ensuring you're following
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure='Selecting "Receive all email and events" ensures you never miss group messages'
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Admins can set group conversations to be received in inboxes by default"
