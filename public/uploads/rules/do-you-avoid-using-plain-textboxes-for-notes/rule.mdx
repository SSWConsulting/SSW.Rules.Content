...
<imageEmbed
  ...
  captionText={"Bad Example - use of a plain textbox limits the detail of the user's notes"}
...
<imageEmbed
  ...
  captionText={"Good Example - with use of a rich textbox, you can use features such as bold, underline, highlighting and hyperlinks."}
