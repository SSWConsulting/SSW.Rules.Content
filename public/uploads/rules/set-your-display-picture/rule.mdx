...
<imageEmbed
  ...
  captionText={"Bad example - Using default display image"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Picture taken from too far away"}
...
<imageEmbed
  ...
  captionText={"Good example - A nice profile image"}
