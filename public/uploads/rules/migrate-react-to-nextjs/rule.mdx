...
<imageEmbed
  ...
  caption={"example terminal output in converting CRA applications to Next.js"}
...
<imageEmbed
  ...
  caption={"Bad example - keeping `react-router-dom` in the Next.js app"}
...
<imageEmbed
  ...
  caption={"Good example - adapting your project to use Next.js file-based routing"}
