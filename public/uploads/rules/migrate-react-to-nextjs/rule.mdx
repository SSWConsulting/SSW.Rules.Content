...
created: 2023-08-01 01:09:00+00:00
...
<imageEmbed
  ...
  figureText={"example terminal output in converting CRA applications to Next.js"}
...
<imageEmbed
  ...
  figureText={"Bad example - keeping `react-router-dom` in the Next.js app"}
...
<imageEmbed
  ...
  figureText={"Good example - adapting your project to use Next.js file-based routing"}
