...
<imageEmbed
  ...
  captionText={"example terminal output in converting CRA applications to Next.js"}
...
<imageEmbed
  ...
  captionText={"Bad example - keeping `react-router-dom` in the Next.js app"}
...
<imageEmbed
  ...
  captionText={"Good example - adapting your project to use Next.js file-based routing"}
