...
<boxEmbed
  ...
  caption={"Bad example – Being overly optimistic leads to missed deadlines and client disappointment"}
/>
...
<boxEmbed
  ...
  caption={"Good example – A realistic buffer results in a pleasant overdelivery and increased client trust"}
/>
