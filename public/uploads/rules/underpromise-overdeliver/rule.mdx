...
<boxEmbed
  ...
  captionText={"Bad example – Being overly optimistic leads to missed deadlines and client disappointment"}
/>
...
<boxEmbed
  ...
  captionText={"Good example – A realistic buffer results in a pleasant overdelivery and increased client trust"}
/>
