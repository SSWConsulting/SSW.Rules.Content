...
<boxEmbed
  ...
  figureText={"Bad example – Being overly optimistic leads to missed deadlines and client disappointment"}
/>
...
<boxEmbed
  ...
  figureText={"Good example – A realistic buffer results in a pleasant overdelivery and increased client trust"}
/>
