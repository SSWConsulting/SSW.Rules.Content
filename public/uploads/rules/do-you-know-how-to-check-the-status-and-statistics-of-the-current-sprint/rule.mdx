...
<imageEmbed
  ...
  caption={"Progress Report showing that this Sprint currently has 2 'Failed' tests (red) and 2 'Passed' tests (green)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Adding a test result chart to visualise test status in Azure Test Plans"}
...
<imageEmbed
  ...
  caption={"Good example - Different charts visualise test status in different ways"}
