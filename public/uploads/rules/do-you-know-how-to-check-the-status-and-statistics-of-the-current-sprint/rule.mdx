...
<imageEmbed
  ...
  captionText={"Progress Report showing that this Sprint currently has 2 'Failed' tests (red) and 2 'Passed' tests (green)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Adding a test result chart to visualise test status in Azure Test Plans"}
...
<imageEmbed
  ...
  captionText={"Good example - Different charts visualise test status in different ways"}
