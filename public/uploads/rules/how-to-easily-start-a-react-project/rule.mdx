...
<imageEmbed
  ...
  caption={"Bad example: Using the create-react-app npm package"}
...
<imageEmbed
  ...
  caption={"Good example: Use Vite to generate a react-ts project"}
...
<imageEmbed
  ...
  caption={"The framework options with Vite"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The variant options with Vite"}
