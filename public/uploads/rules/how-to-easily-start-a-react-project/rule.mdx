...
<imageEmbed
  ...
  captionText={"Bad example: Using the create-react-app npm package"}
...
<imageEmbed
  ...
  captionText={"Good example: Use Vite to generate a react-ts project"}
...
<imageEmbed
  ...
  captionText={"The framework options with Vite"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The variant options with Vite"}
