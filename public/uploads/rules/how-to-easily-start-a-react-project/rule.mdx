...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example: Using the create-react-app npm package](new-create-react-app.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example: Use Vite to generate a react-ts project](vite.png)',
  shouldDisplay: true
} } />
