...
isArchived: false
lastUpdated: 2021-03-12 22:52:50.902000+00:00
...
<imageEmbed
  ...
  figureText={"Bad example: Using the create-react-app npm package"}
...
<imageEmbed
  ...
  figureText={"Good example: Use Vite to generate a react-ts project"}
...
<imageEmbed
  ...
  figureText={"The framework options with Vite"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The variant options with Vite"}
