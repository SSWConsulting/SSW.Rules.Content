...
<imageEmbed
  ...
  figureText={"Bad example - Trying to find taxi receipts and how to get them reimbursed"}
...
<imageEmbed
  ...
  figureText={"Predefined rules that allow staff travelling to and from airports and within ACT"}
...
<imageEmbed
  ...
  figureText={"Good example - Using Uber for Business by a simple toggle of a button"}
