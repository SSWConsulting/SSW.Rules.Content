...
<imageEmbed
  ...
  caption={"Bad Example - The mobile view on the right has a large unnecessary title"}
...
<imageEmbed
  ...
  caption={"Good example - The mobile view is now leaner and cleaner thanks to Bootstrap display classes"}
