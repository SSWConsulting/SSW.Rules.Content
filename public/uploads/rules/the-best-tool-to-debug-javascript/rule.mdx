...
<imageEmbed
  ...
  caption={"Bad code - Using console.log() to debug your JavaScript"}
...
<imageEmbed
  ...
  caption={"Old school JavaScript debugging with Chrome Dev Tools is still the best and most versatile tool"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Visual Studio Chrome Debugger with breakpoint set"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Example of redux based time travel debugging"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Hot module reloader documentation from WebPack website"}
