...
isArchived: false
lastUpdated: 2021-03-12 00:29:41.278000+00:00
...
<imageEmbed
  ...
  figureText={"Bad code - Using console.log() to debug your JavaScript"}
...
<imageEmbed
  ...
  figureText={"Old school JavaScript debugging with Chrome Dev Tools is still the best and most versatile tool"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Visual Studio Chrome Debugger with breakpoint set"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example of redux based time travel debugging"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Hot module reloader documentation from WebPack website"}
