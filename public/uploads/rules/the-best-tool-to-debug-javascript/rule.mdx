...
<imageEmbed
  ...
  captionText={"Bad code - Using console.log() to debug your JavaScript"}
...
<imageEmbed
  ...
  captionText={"Old school JavaScript debugging with Chrome Dev Tools is still the best and most versatile tool"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Visual Studio Chrome Debugger with breakpoint set"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Example of redux based time travel debugging"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Hot module reloader documentation from WebPack website"}
