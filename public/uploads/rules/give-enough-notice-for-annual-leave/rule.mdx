...
Thanks, Patricia
  ...
  captionText={"Bad Example - not enough notice for substantial leave"}
/>
...
Thanks, Patricia
  ...
  captionText={"Good Example - appropriate notice given"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Did you give enough notice, or do we need to track you down?"}
