...
Thanks, Patricia
  ...
  caption={"Bad Example - not enough notice for substantial leave"}
/>
...
Thanks, Patricia
  ...
  caption={"Good Example - appropriate notice given"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Did you give enough notice, or do we need to track you down?"}
