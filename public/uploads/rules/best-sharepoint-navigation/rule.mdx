...
<imageEmbed
  ...
  captionText={"Bad example – Viewing"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad Example - Editing (No customizations)"}
...
<boxEmbed
  ...
  captionText={"Good example – Customizing is easy"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – Custom icons and built-in icons that look nice"}
