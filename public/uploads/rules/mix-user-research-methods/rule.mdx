...
<boxEmbed
  ...
  captionText={"Good example – Combines depth from interviews with breadth from group insight"}
/>
...
<boxEmbed
  ...
  captionText={"Bad example – Designs based on limited or biased input"}
/>
