...
<imageEmbed
  ...
  captionText={"Open the appointment in your Calendar (You should already have Invited all the required people to attend)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Click on \"Contact Attendees\" | \"Reply to All with Email\" if you created the appointment, or \"Respond\" | \"Reply All\" if you were invited"}
...
<imageEmbed
  ...
  captionText={"Good example – This friendly reminder has the right history (the appointment)"}
