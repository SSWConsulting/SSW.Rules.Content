...
<imageEmbed
  ...
  caption={"Open the appointment in your Calendar (You should already have Invited all the required people to attend)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Click on \"Contact Attendees\" | \"Reply to All with Email\" if you created the appointment, or \"Respond\" | \"Reply All\" if you were invited"}
...
<imageEmbed
  ...
  caption={"Good example – This friendly reminder has the right history (the appointment)"}
