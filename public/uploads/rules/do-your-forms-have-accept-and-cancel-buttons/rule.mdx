---
seoDescription: Ensure your forms have both Accept and Cancel buttons to provide users
  with control using "Enter" and "Esc".
type: rule
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Next button is set as the accept button"
