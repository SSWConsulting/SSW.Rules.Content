...
<imageEmbed
  ...
  captionText={"Good example - The text is taken from where the \"More on SSW Chinafy\" link at the end goes"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - You can see the text again here, at the link's destination"}
