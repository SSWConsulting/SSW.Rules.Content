...
As an example, the [SSW website](https://www.ssw.com.au) follows a consistent order: a summary of the product/service and its benefit, followed by a link for more information on that topic.
