...
<imageEmbed
  ...
  caption={"Bad example, labels can be edited after the fact (they are mutable)"}
...
<imageEmbed
  ...
  caption={"Good example, branches give absolute certainty of versions (they are immutable)"}
