...
<imageEmbed
  ...
  figureText={"Bad example, labels can be edited after the fact (they are mutable)"}
...
<imageEmbed
  ...
  figureText={"Good example, branches give absolute certainty of versions (they are immutable)"}
