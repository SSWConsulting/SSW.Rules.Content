...
<boxEmbed
  ...
  caption={"Bad example – Ambiguous and easy to tamper with"}
/>
...
<boxEmbed
  ...
  caption={"Good example – Clear, unchangeable, ISO standard"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example – Uses 3-letter month for clarity across regions"}
/>
