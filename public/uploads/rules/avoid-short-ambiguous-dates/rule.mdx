...
<boxEmbed
  ...
  captionText={"Bad example – Ambiguous and easy to tamper with"}
/>
...
<boxEmbed
  ...
  captionText={"Good example – Clear, unchangeable, ISO standard"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example – Uses 3-letter month for clarity across regions"}
/>
