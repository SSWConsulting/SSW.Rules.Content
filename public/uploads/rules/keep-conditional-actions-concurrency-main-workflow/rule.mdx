...
<imageEmbed
  ...
  caption={"Bad example - Conditionals and concurrency in main workflow"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Conditionals and concurrency in called workflow"}
...
<imageEmbed
  ...
  caption={"Good example - Only the main workflow has conditional and concurrency"}
  src="/uploads/rules/keep-conditional-actions-concurrency-main-workflow/github-concurrency-main-pipeline.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Called workflow doesn't contain conditionals or concurrency groups"}
