...
created: 2023-10-19 00:39:49.331000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Conditionals and concurrency in main workflow"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Conditionals and concurrency in called workflow"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Only the main workflow has conditional and concurrency"
  src="/uploads/rules/keep-conditional-actions-concurrency-main-workflow/github-concurrency-main-pipeline.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Called workflow doesn't contain conditionals or concurrency groups"
