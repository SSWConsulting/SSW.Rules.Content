...
<imageEmbed
  ...
  figureText={"Bad example - Conditionals and concurrency in main workflow"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Conditionals and concurrency in called workflow"}
...
<imageEmbed
  ...
  figureText={"Good example - Only the main workflow has conditional and concurrency"}
  src="/uploads/rules/keep-conditional-actions-concurrency-main-workflow/github-concurrency-main-pipeline.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Called workflow doesn't contain conditionals or concurrency groups"}
