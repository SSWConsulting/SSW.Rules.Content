...
created: 2022-06-22 02:31:57.025000+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - No budget has been set up, disaster could be imminent and no one would know 🥶!"}
...
<imageEmbed
  ...
  figureText={"Good example - Budgets have been set up 😎"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - No cost alerts, a recipe for disaster 😞!"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Cost alerts have been set up ✨"}
...
<imageEmbed
  ...
  figureText={"Daily costs by category"}
