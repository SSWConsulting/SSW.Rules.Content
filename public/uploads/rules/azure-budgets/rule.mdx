...
<imageEmbed
  ...
  captionText={"Bad example - No budget has been set up, disaster could be imminent and no one would know 🥶!"}
...
<imageEmbed
  ...
  captionText={"Good example - Budgets have been set up 😎"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - No cost alerts, a recipe for disaster 😞!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Cost alerts have been set up ✨"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Daily costs by category"}
