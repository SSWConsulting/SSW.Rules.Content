...
<imageEmbed
  ...
  caption={"Bad example - No budget has been set up, disaster could be imminent and no one would know 🥶!"}
...
<imageEmbed
  ...
  caption={"Good example - Budgets have been set up 😎"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - No cost alerts, a recipe for disaster 😞!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Cost alerts have been set up ✨"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Daily costs by category"}
