...
<imageEmbed
  ...
  caption={"Bad example - What will happen for the poor user that forgot their password?"}
...
<imageEmbed
  ...
  caption={"Good example - Users have an option if they forget their password"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Users enter their email to get a new password"}
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - Unnecessary text for a common action"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Short, clean, standard on most sites"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Displaying information whether a user exists or not"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Do not disclose whether a user is registered with your site"}
