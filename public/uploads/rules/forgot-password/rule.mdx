...
<imageEmbed
  ...
  figureText={"Bad example - What will happen for the poor user that forgot their password?"}
...
<imageEmbed
  ...
  figureText={"Good example - Users have an option if they forget their password"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Users enter their email to get a new password"}
...
<boxEmbed
  ...
  figureText={"Bad example - Unnecessary text for a common action"}
/>
...
<boxEmbed
  ...
  figureText={"Good example - Short, clean, standard on most sites"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Displaying information whether a user exists or not"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Do not disclose whether a user is registered with your site"}
