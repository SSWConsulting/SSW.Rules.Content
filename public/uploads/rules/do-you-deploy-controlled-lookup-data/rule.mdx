...
seoDescription: Controlled Lookup Data deployment and testing ensure application functionality
  without relying on records being present in lookup tables.
...
<imageEmbed
  ...
  figureText={"This combo looks innocent. However if it is \"Billable\" then the calendar goes yellow"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Billable days are shown in yellow"}
