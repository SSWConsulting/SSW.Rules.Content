...
<imageEmbed
  ...
  caption={"Bad Example - Custom database connection screen in Speed Ferret"}
...
<imageEmbed
  ...
  caption={"Good Example - Standard Microsoft UDL dialog"}
...
<imageEmbed
  ...
  caption={"Coming in Visual Studio .NET 2005 Microsoft are yet to release an API to do this"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"SQL Deploy uses its own custom form for \"selecting\" a database name"}
