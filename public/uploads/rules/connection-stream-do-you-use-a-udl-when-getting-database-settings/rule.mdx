...
<imageEmbed
  ...
  figureText={"Bad Example - Custom database connection screen in Speed Ferret"}
...
<imageEmbed
  ...
  figureText={"Good Example - Standard Microsoft UDL dialog"}
...
<imageEmbed
  ...
  figureText={"Coming in Visual Studio .NET 2005 Microsoft are yet to release an API to do this"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"SQL Deploy uses its own custom form for \"selecting\" a database name"}
