...
5. Click around until the app is in the right state to test the functionality
  ...
  caption={"Bad example - Many hours each week are wasted just waiting for the code you wrote to run"}
/>
...
3. Already be at the component required, ready to check it works
  ...
  caption={"Good example - No time is wasted doing repetitive and slow tasks"}
/>
