...
isArchived: false
lastUpdated: 2019-12-23 05:58:59+00:00
...
5. Click around until the app is in the right state to test the functionality
  ...
  captionText={"Bad example - Many hours each week are wasted just waiting for the code you wrote to run"}
/>
...
3. Already be at the component required, ready to check it works
  ...
  captionText={"Good example - No time is wasted doing repetitive and slow tasks"}
/>
