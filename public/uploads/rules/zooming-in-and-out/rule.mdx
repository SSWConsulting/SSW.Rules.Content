...
<boxEmbed
  ...
  caption={"Bad example - The listener has no idea what screen or problem is being talked about"}
/>
...
<boxEmbed
  ...
  caption={"Good example 1/3 - Now a baseline for what we are talking about has been established"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example 2/3 - This sentence helps the listener understand the specific difficulties being faced"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example 3/3 - A baseline context and the challenge have been established, so the listener can understand the original question"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - The context and challenge haven't been explained yet, making it confusing"}
/>
...
I think the audio is good enough, are you happy for me to run with it or do you want me to re-record?
  ...
  captionStyle="goodExample"
  caption={"Good example - The context was explained, then the challenge, then the core question"}
/>
