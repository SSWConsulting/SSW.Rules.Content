...
<imageEmbed
  ...
  captionText={"Bad example - This expense will not be reimbursed"}
...
<imageEmbed
  ...
  captionText={"Good example - This expense will be reimbursed, if David gets an approval from Adam"}
