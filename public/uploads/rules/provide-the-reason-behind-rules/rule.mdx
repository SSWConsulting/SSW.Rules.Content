...
You didn't send a "test please" email. Please do that next time.
  ...
  figureText={"Bad example - This email doesn't explain why this is so important"}
/>
...
Please make sure this is part of your workflow ;)
  ...
  figureText={"Good example - Provide a link to your standard and the main reason(s) why it is important"}
/>