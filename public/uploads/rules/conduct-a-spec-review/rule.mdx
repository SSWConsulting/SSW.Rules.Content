...
created: 2023-10-31 00:44:48+00:00
...
- spec-do-you-conduct-a-specification-review-ask-for-a-coffee-not-a-marriage
seoDescription: Conduct a specification review to provide clients with a clear understanding
  of project costs and timelines, ensuring realistic expectations and avoiding misunderstandings.
...
<imageEmbed
  ...
  captionText={"A ballpark or proposal should start small and not be a big commitment"}
...
<boxEmbed
  ...
  captionText={"Bad example - Big scary figure"}
/>
...
This first step is $8k - a 2-day Specification Review"
  ...
  captionText={"Good example - Work in small chunks of work with details about what you will do"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - Far too firm a price when you don't know any of the detail"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - Leaves some wriggle room at these initial phases"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"You wouldn't want these numbers combined, as it may look like a budget overrun"}
