...
<imageEmbed
  ...
  figureText={"A ballpark or proposal should start small and not be a big commitment"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"You wouldn't want these numbers combined, as it may look like a budget overrun"}
