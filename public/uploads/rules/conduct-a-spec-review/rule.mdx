...
<imageEmbed
  ...
  caption={"A ballpark or proposal should start small and not be a big commitment"}
...
<boxEmbed
  ...
  caption={"Bad example - Big scary figure"}
/>
...
This first step is $8k - a 2-day Specification Review"
  ...
  caption={"Good example - Work in small chunks of work with details about what you will do"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - Far too firm a price when you don't know any of the detail"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Leaves some wriggle room at these initial phases"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"You wouldn't want these numbers combined, as it may look like a budget overrun"}
