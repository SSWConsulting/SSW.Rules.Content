...
This first step is $8k - a 2-day Specification Review"
  ...
  figurePrefix="good"
  figure="Work in small chunks of work with details about what you will do"
/>
...
Corridor Conversations are a great way to set the clients expectations so you don't surprise them with a big number at the end of the Spec Review.
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Far too firm a price when you don't know any of the detail"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Leaves some wriggle room at these initial phases"
/>
