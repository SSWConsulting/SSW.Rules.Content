...
<imageEmbed
  ...
  figureText={"Bad example - This PBI is closed with no context around changes made"}
...
<imageEmbed
  ...
  figureText={"Good example - This PBI informs the team that the work is complete and contains some examples of what the changes look like"}
...
<imageEmbed
  ...
  figureText={"For Issues specifically, it's recommended you have workflows configured and enabled"}
