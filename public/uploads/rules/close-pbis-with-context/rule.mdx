...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This PBI is closed with no context around changes made"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This PBI informs the team that the work is complete and contains some examples of what the changes look like"
