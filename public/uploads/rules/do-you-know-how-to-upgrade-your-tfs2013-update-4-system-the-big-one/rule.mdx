---
archivedreason: Outdated - Applies to upgrading to TFS 2015 (end-of-life). For modern guidance, see [Steps required when migrating to the cloud](/steps-required-when-migrating-to-the-cloud).
authors: []
...
isArchived: true
lastUpdated: 2015-08-13 12:55:27+00:00
