...
<imageEmbed
  ...
  captionText={"When merging: a messy merge commit is created any time you need to incorporate upstream changes from the master branch"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Git Rebase moves your new commits to the end of the master branch. This ensure that you don't end up with messy merge commits and you have a clean linear project history"}
