...
<imageEmbed
  ...
  captionText={"Web Compiler can find missing curly braces"}
...
<imageEmbed
  ...
  captionText={"Curly braces in the wrong place, but still compiled successfully"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Gulp couldn't find the curly braces error"}
