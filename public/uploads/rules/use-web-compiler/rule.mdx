...
<imageEmbed
  ...
  figureText={"Web Compiler can find missing curly braces"}
...
<imageEmbed
  ...
  figureText={"Curly braces in the wrong place, but still compiled successfully"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Gulp couldn't find the curly braces error"}
