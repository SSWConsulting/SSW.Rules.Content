...
<imageEmbed
  ...
  caption={"Web Compiler can find missing curly braces"}
...
<imageEmbed
  ...
  caption={"Curly braces in the wrong place, but still compiled successfully"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Gulp couldn't find the curly braces error"}
