...
<imageEmbed
  ...
  figureText={"Custom laptop skin - take every chance to show off your brand"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"We don't need to be promoting Dell - use a branded sticker to cover it up!"}
