...
<imageEmbed
  ...
  captionText={"Turn on DevErrors within Web.Config file to get details of error"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Diagnostics for CRM2011"}
