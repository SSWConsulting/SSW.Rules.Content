...
<imageEmbed
  ...
  figureText={"Beautiful HTML report"}
...
<imageEmbed
  ...
  figureText={"Bad Example – The printed layout looks nothing like the HTML"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Beautiful PowerBI HTML report"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – PowerBI print preview scales everything down to fit on a page, you have no real control over how things flow onto multiple pages"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Add the ReportViewer control"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The final report in an MVC application"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Export your report with the in-build SSRS functionality"}
