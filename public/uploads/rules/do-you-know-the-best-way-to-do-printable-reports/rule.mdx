...
<imageEmbed
  ...
  caption={"Bad Example – The printed layout looks nothing like the HTML"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Beautiful PowerBI HTML report"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example – PowerBI print preview scales everything down to fit on a page, you have no real control over how things flow onto multiple pages"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Add the ReportViewer control"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The final report in an MVC application"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Export your report with the in-build SSRS functionality"}
