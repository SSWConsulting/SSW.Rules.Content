...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The printed layout looks nothing like the HTML"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="PowerBI print preview scales everything down to fit on a page, you have no real control over how things flow onto multiple pages"
