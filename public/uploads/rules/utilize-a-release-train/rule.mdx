...
isArchived: false
lastUpdated: 2024-04-15 10:02:37+00:00
...
seoDescription: Synchronize agile teams and deliver value with a Release Train Engineer
  (RTE), who harmonizes efforts, ensures alignment, and resolves conflicts for a smooth
  project execution.
...
<imageEmbed
  ...
  captionText={"Good Example - An RTE helps in keeping all the agile teams in sync, ensuring smooth delivery of features."}
