...
- customization-do-you-only-export-the-customizations-and-related-ones-that-you-have-made-only-for-crm-4-0
seoDescription: Customize CRM schema wisely, only exporting and importing changes
  to specific entities or relationships to avoid unexpected overriding of existing
  customizations.
title: Customization - Do you only export the customizations and related ones that
  you have made?
categories:
  - category: categories/business-applications/rules-to-better-crm-for-developers.mdx
type: rule
uri: crm-export-only-related-customizations
---
