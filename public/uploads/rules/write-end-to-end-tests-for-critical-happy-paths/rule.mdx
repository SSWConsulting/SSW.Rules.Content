...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="No end-to-end tests, no automatic feedback when things go catastrophically wrong"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="End-to-end Seleno tests run in Continuous-Integration, giving us very rapid feedback when the deployment breaks"
