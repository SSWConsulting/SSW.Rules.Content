...
<imageEmbed
  ...
  figureText={"Show clients that you're more than just an awesome developer"}
...
Thanks,
  ...
  figureText={"Good example – Conversation is documented and the client is triggered to take action"}
/>
