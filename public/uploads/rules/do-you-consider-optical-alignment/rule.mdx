...
<imageEmbed
  ...
  caption={"Bad example - The fields are aligned to the radio buttons, but it doesn't \"look\" good enough"}
...
<imageEmbed
  ...
  caption={"Good example - It seems neater, even though it is no longer technically aligned"}
