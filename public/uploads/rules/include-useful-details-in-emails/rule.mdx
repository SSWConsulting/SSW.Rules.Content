...
related:
  ...
  - rule: >-
      public/uploads/rules/comments-do-you-enforce-comments-with-check-ins/rule.mdx
...
seoDescription: >-
  Make sure to add relevant information such as URLs, screenshots, and code
  snippets to keep others informed about what's been done or needs to be done.
...
* Screenshots
* [Done Videos](https://www.ssw.com.au/rules/send-done-videos/)
* Pieces of code/text
...
<emailEmbed
  ...
  figurePrefix="bad"
  figure="&#x22;Done&#x22; email lacks details"
/>
...
<emailEmbed
  ...
  figurePrefix="good"
  figure="&#x22;Done&#x22; email has a link, a screenshot (showing the URL), and code changes"
/>
