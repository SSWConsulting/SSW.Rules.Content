...
created: 2023-06-01T07:57:43.000Z
...
<imageEmbed
  ...
  captionText={"Bad Example - SQL Server Enterprise Manager is old and outdated"}
  src="/uploads/rules/query-data-tools/enterprise_manager.png"
/>
...
<imageEmbed
  ...
  captionText={"Good Example - SSMS is feature rich"}
  src="/uploads/rules/query-data-tools/ssms.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - Azure Data Studio is lightweight and cross-platform"}
  src="/uploads/rules/query-data-tools/azuredatastudio.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - The VS Code MSSQL extension is embedded right in VS Code"}
  src="/uploads/rules/query-data-tools/vscodemssqlextension.png"
/>
