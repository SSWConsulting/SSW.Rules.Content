...
<imageEmbed
  ...
  figureText={"Bad Example - SQL Server Enterprise Manager is old and outdated"}
...
<imageEmbed
  ...
  figureText={"Good Example - SSMS is feature rich"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - Azure Data Studio is lightweight and cross-platform"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - The VS Code MSSQL extension is embedded right in VS Code"}
