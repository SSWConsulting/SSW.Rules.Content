...
<imageEmbed
  ...
  caption={"Bad Example - SQL Server Enterprise Manager is old and outdated"}
...
<imageEmbed
  ...
  caption={"Good Example - SSMS is feature rich"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - Azure Data Studio is lightweight and cross-platform"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - The VS Code MSSQL extension is embedded right in VS Code"}
