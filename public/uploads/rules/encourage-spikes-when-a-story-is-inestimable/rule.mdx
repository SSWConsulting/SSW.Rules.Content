...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="I want you to implement something, but I am not going to tell you what it is. How long will it take?"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The spike (time boxed investigation) comes first as it is impossible to estimate implementing something you do not know"
