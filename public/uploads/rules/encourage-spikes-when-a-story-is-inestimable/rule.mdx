...
<imageEmbed
  ...
  captionText={"Schedule time to dig a little deeper. There's always another layer to uncover"}
...
<imageEmbed
  ...
  captionText={"Bad example – I want you to implement something, but I am not going to tell you what it is. How long will it take?"}
...
<imageEmbed
  ...
  captionText={"Good example – The spike (time boxed investigation) comes first as it is impossible to estimate implementing something you do not know"}
