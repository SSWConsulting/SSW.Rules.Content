...
<imageEmbed
  ...
  caption={"Audio Technica BPHS1 ‘aviation-style’ headset"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Desktop microphone – plugs into USB and sits in front of you on the desk. Preferred for done videos and is portable"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Professional podcasting mic"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Rode smartLav+ Lapel Microphone for Smart Phones"}
