...
<boxEmbed
  ...
  caption={"Good Example - Unit tests confirm the integrity of domain logic in isolation from external dependencies."}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good Example - Workflow tests simulate full user journeys, giving comprehensive validation of the application’s functionality."}
/>
