...
lastUpdated: 2026-02-03T03:28:59.506Z
...
When you are going to make a decision on whether to approve an employees suggested team or to move them to something else. Here are the key questions to ask before making a decision.
...
2. Admin - If the employee has accrued a lot of administrative tasks while they were on external work. Then, prior to allocating them to a team they should prioritise getting that work done so they can start on a fresher slate. see [https://www.ssw.com.au/rules/dones-is-your-inbox-a-task-list-only/](https://www.ssw.com.au/rules/dones-is-your-inbox-a-task-list-only/)
3. Current skillset - Are they under-equiped for that project?
4. Personal Development - Are they interested learning some of the skills that would be required to work on the project?
5. Long-term Goals - Do they have any long-term goals that they'd like to achieve during their time on the bench?
