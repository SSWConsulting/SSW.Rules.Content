...
SSW is made up of a great team of staff that is passionate about technology and how it meets business needs. Today SSW has offices in Sydney, Melbourne, Brisbane, Newcastle, Strasbourg (France) and Hangzhou (China), with over 100 employees. Want to meet them? Have a look at SSW People.
  ...
  caption={"Bad example - Long block of text"}
/>
...
Want to meet them? Have a look at SSW People.
  ...
  caption={"Good example - The text is separated by paragraphs"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - No line break before the note"}
/>
...
**Note:** Try both valid and invalid credentials.
  ...
  captionStyle="goodExample"
  caption={"Good example - The \"Note\" being on a fresh line and in bold makes it much easier to read"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - No line break before the URL"}
/>
...
[https://www.ssw.com.au/employment#available](https://www.ssw.com.au/employment#available)
  ...
  captionStyle="goodExample"
  caption={"Good example - The URL being on a fresh line makes it much easier to read"}
/>
...
Check out this awesome new video about the SSW Cultural Exchange Program!
  ...
  captionStyle="badExample"
  caption={"Bad example - No spacing after heading"}
/>
...
Check out this awesome new video about the SSW Cultural Exchange Program!
  ...
  captionStyle="goodExample"
  caption={"Good example - Spacing after heading"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - Block of text"}
/>
