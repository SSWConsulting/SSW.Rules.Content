...
SSW is made up of a great team of staff that is passionate about technology and how it meets business needs. Today SSW has offices in Sydney, Melbourne, Brisbane, Newcastle, Strasbourg (France) and Hangzhou (China), with over 100 employees. Want to meet them? Have a look at SSW People.
  ...
  figureText={"Bad example - Long block of text"}
/>
...
Want to meet them? Have a look at SSW People.
  ...
  figureText={"Good example - The text is separated by paragraphs"}
/>
...
<boxEmbed
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - No line break before the note"}
/>
...
**Note:** Try both valid and invalid credentials.
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - The \"Note\" being on a fresh line and in bold makes it much easier to read"}
/>
...
<boxEmbed
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - No line break before the URL"}
/>
...
[https://www.ssw.com.au/employment#available](https://www.ssw.com.au/employment#available)
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - The URL being on a fresh line makes it much easier to read"}
/>
...
Check out this awesome new video about the SSW Cultural Exchange Program!
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - No spacing after heading"}
/>
...
Check out this awesome new video about the SSW Cultural Exchange Program!
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Spacing after heading"}
/>
...
<boxEmbed
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - Block of text"}
/>
