...
<imageEmbed
  ...
  figureText={"Good example - Content is sorted into playlists that have their own unique thumbnail theme"}
...
<imageEmbed
  ...
  figureText={"Viewers want more of what they already like"}
...
<imageEmbed
  ...
  figureText={"Bad example - People leaving YouTube after (or even while) watching one of your videos will rank you (and your content) down"}
...
<imageEmbed
  ...
  figureText={"OK example - People watching another video after yours will give you a little boost"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - People watching a video from your playlist are more likely to keep watching more of your videos, giving you a big boost!"}
