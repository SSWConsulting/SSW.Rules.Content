...
<imageEmbed
  ...
  captionText={"Bad example - The noises will grab your attention and interrupt your daily work"}
...
<imageEmbed
  ...
  captionText={"Good example - Although you’re still getting notifications, hopefully it’s only when you’re taking a break to look at your phone anyway"}
