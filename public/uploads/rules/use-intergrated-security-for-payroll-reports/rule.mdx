...
<imageEmbed
  ...
  caption={"Bad example - Everyone can see others' rate changing history (maybe useful for administrative, but not for your employees)"}
...
<imageEmbed
  ...
  caption={"Good example - The current employee can only see his own record"}
...
<imageEmbed
  ...
  caption={"Specify the filters on your data table and select Globals->User!UserID"}
