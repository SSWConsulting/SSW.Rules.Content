...
<imageEmbed
  ...
  captionText={"Bad example - Everyone can see others' rate changing history (maybe useful for administrative, but not for your employees)"}
...
<imageEmbed
  ...
  captionText={"Good example - The current employee can only see his own record"}
...
<imageEmbed
  ...
  captionText={"Specify the filters on your data table and select Globals->User!UserID"}
