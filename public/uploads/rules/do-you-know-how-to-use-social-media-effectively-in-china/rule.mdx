...
<imageEmbed
  ...
  caption={"According to Social Media experts Hootsuite, there are 911 million active social media users (yellow), 65% of the overall population (red)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Taken from Statistica.com - the Graph shows how much WeChat is growing every year. WeChat is now one of the most popular, well rounded apps available in China, growing in popularity every year"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"SSW's SugarLearning WeChat Mini Program Log-in page & Mini Program"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Youku would have a very familiar feel for our Western audience as seen from this video feed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A search for 'SSW' using Baidu, we are organically No 1 on this page"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Bilibili is continuously growing it's audience becoming a great place to host videos and advertize"}
