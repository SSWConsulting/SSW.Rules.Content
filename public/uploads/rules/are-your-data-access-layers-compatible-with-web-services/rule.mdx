---
seoDescription: Ensure seamless data access layers that seamlessly integrate with
  web services, facilitating cloud-based database connectivity for a future-proof
...
authors:
- author: adam-cogan
created: 2014-03-14 05:37:00+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Options form showing choice of connection"
