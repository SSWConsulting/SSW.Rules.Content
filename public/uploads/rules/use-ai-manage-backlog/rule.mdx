...
lastUpdated: 2026-06-29T08:47:51.088Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="In this case, there are 4 topics that have duplicates" src="/uploads/rules/use-ai-manage-backlog/Big-Backlog.gif" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="AI automatically surfaces duplicates and overlaps" src="/uploads/rules/use-ai-manage-backlog/Duplicates-GitHub.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="AI shows large backlog items and breaks them down into smaller issues" src="/uploads/rules/use-ai-manage-backlog/Large-Items-GitHub.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="AI groups related works under epics" src="/uploads/rules/use-ai-manage-backlog/Grouping-GitHub.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="AI estimates the effort for a given issue" src="/uploads/rules/use-ai-manage-backlog/Estimate-GitHub.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="AI finds related issues for a given issue" src="/uploads/rules/use-ai-manage-backlog/Dependencies-GitHub.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="AI reveals highest priority issues that improves user experience" src="/uploads/rules/use-ai-manage-backlog/Prioritize-GitHub.png" />
