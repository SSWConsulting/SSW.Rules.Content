...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="In this case, there are 4 topics that have duplicates"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="AI automatically surfaces duplicates and overlaps"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="AI shows large backlog items and breaks them down into smaller issues"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="AI groups related works under epics"
...
* **Providing quick estimating (at SSW we use [double estimates](http://www.ssw.com.au/rules/size-pbis-effectively/)) before team refinement** - AI offers rough size estimates upfront, helping teams spot oversized items early and speed up refinement
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="AI estimates the effort for a given issue"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="AI finds related issues for a given issue"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="AI reveals highest priority issues that improves user experience"
