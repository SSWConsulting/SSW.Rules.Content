...
<imageEmbed
  ...
  captionText={"Bad example — In this case, there are 4 topics that have duplicates"}
...
<imageEmbed
  ...
  captionText={"Good example — AI automatically surfaces duplicates and overlaps"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example — AI shows large backlog items and breaks them down into smaller issues"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example — AI groups related works under epics"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example — AI estimates the effort for a given issue"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example — AI finds related issues for a given issue"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example — AI reveals highest priority issues that improves user experience"}
