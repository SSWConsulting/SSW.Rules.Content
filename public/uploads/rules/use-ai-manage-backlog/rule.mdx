...
<youtubeEmbed url="https://www.youtube.com/watch?v=KWjYXYBIIQo" description="Video: Managing 1000+ GitHub Issues with Claude AI – Eli & Gert Reveal the Secret Sauce | SSW Rules (8 mins)" />
...
![](/uploads/rules/use-ai-manage-backlog/Big-Backlog.gif)

❌ Figure: Bad Example — Wasting time manually searching for duplicates

![](/uploads/rules/use-ai-manage-backlog/Duplicates-GitHub.png)
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "default",
    figure: "GitHub MCP Server added to an MCP client",
    shouldDisplay: true
  } }
  src="/uploads/rules/use-ai-manage-backlog/MCP-Servers-Generic.png"
/>
