...
isArchived: false
lastUpdated: 2025-09-24 00:34:01+00:00
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"Image using class \"img-small\""}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"Image using class \"img-medium\""}
  src="https://images.unsplash.com/photo-1513677785800-9df79ae4b10b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80"
/>
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"Image using class \"img-large\""}
  src="https://images.unsplash.com/photo-1513677785800-9df79ae4b10b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Image using class \"no-border\""}
  src="https://images.unsplash.com/photo-1513677785800-9df79ae4b10b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"How a smaller image (400px) works with long caption. Full screen on mobile, real width on larger screens..."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"...and with a short caption"}
  src="https://images.unsplash.com/photo-1528820454441-189cd70a6c3c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=80"
/>
...
<imageEmbed
  ...
  captionText={"Caption for bad images"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Caption for regular images"}
  src="https://images.unsplash.com/photo-1513677785800-9df79ae4b10b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80"
/>
...
<imageEmbed
  ...
  captionText={"Caption for OK images"}
...
<imageEmbed
  ...
  captionText={"Caption for good images"}
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Caption for bad examples"}
/>
...
<boxEmbed
  ...
  captionStyle="default"
  captionText={"Caption for normal examples"}
/>
...
<boxEmbed
  ...
  captionStyle="okExample"
  captionText={"Caption for ok examples"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Caption for good examples"}
/>
...
&#123;&#123; EMAIL CONTENT &#125;&#125;
  ...
  captionStyle="goodExample"
  captionText={"Good example - Nice email template"}
/>
```
