...
lastUpdated: 2025-11-27T14:05:14.420Z
lastUpdatedBy: Chloe
...
To include code block in MDX, start with 3 backticks \`\`\` on a new line, write or paste your code, and then end with 3 backticks on a new line.
