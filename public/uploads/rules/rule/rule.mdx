...
isArchived: false
lastUpdated: 2025-12-04 00:53:15+00:00
...
related:
  ...
  - rule: public/uploads/rules/add-useful-and-concise-figure-captions/rule.mdx
guid: 55db32aa-0718-4868-995c-673d8dd69f62
seoDescription: "I'd be happy to help you generate an SEO description. Please provide the Markdown or MDX content, \"and\" I'll do my best to create a concise, keyword-rich, and user-intent-matching description. \U0001F60A"
created: 2021-02-22T03:20:26.000Z
createdBy: 'Christian Morford-Waite [SSW]'
createdByEmail: ChristianMWaite@ssw.com.au
lastUpdated: 2025-12-04T00:53:15.000Z
lastUpdatedBy: 'Jake Bayliss [SSW]'
lastUpdatedByEmail: 32888060+jakebayliss@users.noreply.github.com
isArchived: false
archivedreason: null
...
<boxEmbed
  style="info"
  body={<>
    Do **not** use Heading 1 (`<h1>`) in the content, even with the good intention of improving SEO. The page title already uses a Heading 1, and adding multiple Heading 1 elements on the same page can harm accessibility and semantic structure. More info on [MDN guidelines - Avoid using multiple `<h1>` elements on one page](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/Heading_Elements#avoid_using_multiple_h1_elements_on_one_page).
  </>}
  figurePrefix="none"
  figure=""
/>
...
And here is somet text after, so you can see how it looks like when rendered.
