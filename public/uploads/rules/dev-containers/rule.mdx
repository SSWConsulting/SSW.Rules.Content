...
created: 2022-11-30 03:26:46.980000+00:00
...
<youtubeEmbed url="Yhp37fPn6dQ" description="Video: Dev Containers from Microsoft (was Remote Containers) with [Piers Sinclair](https://www.ssw.com.au/people/piers-sinclair) (5 min)" />
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Before using Dev Containers you would be missing a lot of pre-requisites!"
