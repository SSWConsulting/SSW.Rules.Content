...
<imageEmbed
  ...
  figureText={"A report from LinkedIn Talent Hub showing the how many people remain in each stage of your recruitment process"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"LinkedIn Hub that is used alongside LinkedIn Recruiter"}
