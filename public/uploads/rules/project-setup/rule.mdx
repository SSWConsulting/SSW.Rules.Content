...
<imageEmbed
  ...
  caption={"Bad example - A project without instructions"}
...
<imageEmbed
  ...
  caption={"Good example - A project with instructions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - After using dev containers you would be as happy as Larry!"}
