...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - A project without instructions](ProjectDocumentationBadExample.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - A project with instructions](ProjectDocumentationGoodExample.png)',
  shouldDisplay: true
} } />
