...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "![Bad example - A project without instructions](/uploads/rules/project-setup/ProjectDocumentationBadExample.png)",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "![Good example - A project with instructions](/uploads/rules/project-setup/ProjectDocumentationGoodExample.png)",
  shouldDisplay: true
} } />
