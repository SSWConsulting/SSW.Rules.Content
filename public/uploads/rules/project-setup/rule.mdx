...
<imageEmbed
  ...
  captionText={"Bad example - A project without instructions"}
...
<imageEmbed
  ...
  captionText={"Good example - A project with instructions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - After using dev containers you would be as happy as Larry!"}
