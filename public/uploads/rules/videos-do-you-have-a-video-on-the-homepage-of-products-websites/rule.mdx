...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "![Good Example - Dropbox homepage has no text but a video that shows nicely how it works](/uploads/rules/videos-do-you-have-a-video-on-the-homepage-of-products-websites/dropbox-homepage.jpg)",
  shouldDisplay: true
} } />
