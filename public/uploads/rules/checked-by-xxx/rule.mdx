...
<imageEmbed
  ...
  figureText={"Consider this the \"four-eye principle\" (also known as the \"two-person rule\" or \"dual control\")"}
...
Dave
  ...
  figureText={"Good example - Use 'Checked by xxx' when sending emails that require a second pair of eyes"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example of a \"Checked by\" report generated by AI"}
