...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example: Details sent via Email](details-sent-bad.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example: Details set as a SharePoint page, visible in a Team’s tab](details-sent-good.jpg)',
  shouldDisplay: true
} } />
