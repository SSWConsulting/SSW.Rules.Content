...
<imageEmbed
  ...
  figureText={"Bad example - Keyboard autocomplete added a trailing space, causing the GitHub URL validation to fail with an error message"}
...
Input validation passes: “github.com/0xharkirat” is accepted
  ...
  figureText={"Good example – Automatically trimming input before validation makes the form behave as expected"}
/>
