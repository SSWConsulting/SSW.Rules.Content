...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Keyboard autocomplete added a trailing space, causing the GitHub URL validation to fail with an error message"
...
Input validation passes: “github.com/0xharkirat” is accepted
  ...
  figurePrefix="good"
  figure="Automatically trimming input before validation makes the form behave as expected"
/>
