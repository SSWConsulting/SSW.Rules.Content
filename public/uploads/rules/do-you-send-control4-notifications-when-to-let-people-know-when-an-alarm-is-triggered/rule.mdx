...
<imageEmbed
  ...
  caption={"Good example - You can also create Push notifications for other purposes"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Creating an action when the alarm state is on, meaning the alarm has been triggered"}
