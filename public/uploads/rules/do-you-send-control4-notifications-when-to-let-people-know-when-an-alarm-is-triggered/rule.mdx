...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="You can also create Push notifications for other purposes"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Creating an action when the alarm state is on, meaning the alarm has been triggered"
