...
created: 2023-10-31T05:02:09.000Z
...
<imageEmbed
  ...
  captionText={"Bad example - Group with no description"}
...
<imageEmbed
  ...
  captionText={"Good example - Group with description"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - Red Box shows the mail tip which is the group description"}
