...
<imageEmbed
  ...
  caption={"Bad example - Group with no description"}
...
<imageEmbed
  ...
  caption={"Good example - Group with description"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - Red Box shows the mail tip which is the group description"}
