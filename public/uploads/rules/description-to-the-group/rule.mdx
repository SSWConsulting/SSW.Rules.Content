---
type: rule
title: 'Do you add a description to Microsoft 365 groups? '
...
lastUpdated: 2026-07-13T17:21:36.851Z
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="bad" figure="Microsoft 365 group with no description" src="/uploads/rules/description-to-the-group/bad-example-no-description.jpg" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Microsoft 365 group with description" src="/uploads/rules/description-to-the-group/good-example-with-description.jpg" />

## Adding MailTips for Internal Groups

A MailTip (or mail tip) is a brief message that appears when someone adds the group to an email. It can provide additional instructions, warnings, or important information about the group. It is better to add the group description as a mail tip.
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Red Box shows the mail tip which is the group description" src="/uploads/rules/description-to-the-group/good-example-mail-tip.jpg" />
...
<boxEmbed
  body={<>
    **Note:** Mail tip maximum length is 175 characters.
  </>}
  figurePrefix="none"
  figure=""
  style="info"
