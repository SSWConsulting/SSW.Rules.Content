...
<imageEmbed
  ...
  captionText={"Bad example – This field is using a \"text\" type and shows a standard keyboard on mobile"}
...
<imageEmbed
  ...
  captionText={"Good example – This field is using the correct field type and shows the keypad on mobile"}
