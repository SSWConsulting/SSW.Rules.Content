...
![](/uploads/rules/do-you-use-the-correct-input-type/field-type-text.png)
...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: 'Figure: Bad example – This field is using a text type and shows a standard keyboard on mobile',
  shouldDisplay: true
} } />


![](/uploads/rules/do-you-use-the-correct-input-type/field-type-tel.png)
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: 'Figure: Good example – This field is using the correct field type and shows the keypad on mobile',
  shouldDisplay: true
} } />
