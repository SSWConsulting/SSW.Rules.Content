...
isArchived: false
lastUpdated: 2015-05-22 03:38:11+00:00
...
<imageEmbed
  ...
  figureText={"Bad example – This field is using a \"text\" type and shows a standard keyboard on mobile"}
...
<imageEmbed
  ...
  figureText={"Good example – This field is using the correct field type and shows the keypad on mobile"}
