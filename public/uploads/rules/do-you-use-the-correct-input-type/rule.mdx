...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="bad"
  figure='This field is using a "text" type and shows a standard keyboard on mobile'
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="This field is using the correct field type and shows the keypad on mobile"
