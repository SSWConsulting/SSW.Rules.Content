...
isArchived: false
lastUpdated: 2021-04-13 02:27:29.889000+00:00
lastUpdatedBy: Olivia Westmacott
lastUpdatedByEmail: 79124359+oliviawestmacottssw@users.noreply.github.com
redirects:
...
<imageEmbed
  ...
  figureText={"Bad example - Recalling a message when you want to change an email after sending"}
...
<imageEmbed
  ...
  figureText={"Good example - Delay sending in 15 minutes (make it less or more if necessary)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Undo Send | 120 Seconds"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Test email to yourself. See the delayed email in drafts"}
