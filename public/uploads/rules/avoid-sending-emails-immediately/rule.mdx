...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Recalling a message when you want to change an email after sending"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Delay sending in 15 minutes (make it less or more if necessary)"
