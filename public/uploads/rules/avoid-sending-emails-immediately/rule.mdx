...
<imageEmbed
  ...
  captionText={"Bad example - Recalling a message when you want to change an email after sending"}
...
<imageEmbed
  ...
  captionText={"Good example - Delay sending in 15 minutes (make it less or more if necessary)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Undo Send | 120 Seconds"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Test email to yourself. See the delayed email in drafts"}
