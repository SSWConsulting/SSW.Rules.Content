...
<imageEmbed
  ...
  caption={"Bad example - Recalling a message when you want to change an email after sending"}
...
<imageEmbed
  ...
  caption={"Good example - Delay sending in 15 minutes (make it less or more if necessary)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Test email to yourself. See the delayed email in drafts"}
