...
<imageEmbed
  ...
  captionText={"Bad Example – Ad doesn't have a clear message about either product or service, there’s no call extension even though it mentions \"Call Now\""}
...
<imageEmbed
  ...
  captionText={"Good Example - Sitelinks and Call extensions on one of our mobile ads"}
