...
<imageEmbed
  ...
  caption={"Setting up deployment from source control is simple from within the Azure portal"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Deployment is available from a number of different source control repositories"}
