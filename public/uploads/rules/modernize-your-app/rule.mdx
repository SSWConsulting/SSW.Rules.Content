...
created: 2022-12-02 06:20:30+00:00
...
<imageEmbed
  ...
  captionText={"OK example - big bang migration"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  captionText={"OK example - evolutionary migration (fitting a square peg in a round hole)"}
...
<imageEmbed
  ...
  captionText={"an actual strangler fig strangling a tree"}
...
<imageEmbed
  ...
  captionText={"Good example - strangler fig pattern in action during a migration"}
