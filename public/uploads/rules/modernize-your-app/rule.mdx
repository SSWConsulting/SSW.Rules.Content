...
<imageEmbed
  ...
  figureText={"OK example - big bang migration"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="okExample"
  figureText={"OK example - evolutionary migration (fitting a square peg in a round hole)"}
...
<imageEmbed
  ...
  figureText={"an actual strangler fig strangling a tree"}
...
<imageEmbed
  ...
  figureText={"Good example - strangler fig pattern in action during a migration"}
