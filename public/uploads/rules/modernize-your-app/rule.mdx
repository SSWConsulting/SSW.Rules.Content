...
<imageEmbed
  ...
  caption={"OK example - big bang migration"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="okExample"
  caption={"OK example - evolutionary migration (fitting a square peg in a round hole)"}
...
<imageEmbed
  ...
  caption={"an actual strangler fig strangling a tree"}
...
<imageEmbed
  ...
  caption={"Good example - strangler fig pattern in action during a migration"}
