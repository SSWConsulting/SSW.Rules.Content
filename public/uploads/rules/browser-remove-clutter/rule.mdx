...
<imageEmbed
  ...
  caption={"Bad example - Settings | Content visible is evil"}
...
<imageEmbed
  ...
  caption={"Good example - Settings | Content off + branding is the way to go!"}
...
<imageEmbed
  ...
  caption={"Change these settings to reduce noise in Edge & Chrome"}
