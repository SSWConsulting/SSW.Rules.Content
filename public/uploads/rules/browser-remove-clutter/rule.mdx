...
<imageEmbed
  ...
  captionText={"Bad example - Settings | Content visible is evil"}
...
<imageEmbed
  ...
  captionText={"Good example - Settings | Content off + branding is the way to go!"}
...
<imageEmbed
  ...
  captionText={"Change these settings to reduce noise in Edge & Chrome"}
