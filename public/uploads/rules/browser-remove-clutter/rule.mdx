...
created: 2023-06-01 20:11:47.494000+00:00
guid: e0ae7ce1-cb42-4270-bec9-4766e536b36b
related:
- rule: public/uploads/rules/browser-add-branding/rule.mdx
seoDescription: Remove browser clutter and boost productivity by turning off unnecessary
  new tab features.
...
<imageEmbed
  ...
  figureText={"Bad example - Settings | Content visible is evil"}
...
<imageEmbed
  ...
  figureText={"Good example - Settings | Content off + branding is the way to go!"}
...
<imageEmbed
  ...
  figureText={"Change these settings to reduce noise in Edge & Chrome"}
