...
<imageEmbed
  ...
  figureText={"Bad example - The percentage change column in this Reporting Services product downloads report is misleading"}
...
<imageEmbed
  ...
  figureText={"Good example - The column works better as just a difference between the current and previous download totals"}
