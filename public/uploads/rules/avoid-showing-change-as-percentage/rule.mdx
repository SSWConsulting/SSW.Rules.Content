...
created: 2024-03-26 04:48:53+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - The percentage change column in this Reporting Services product downloads report is misleading"}
...
<imageEmbed
  ...
  captionText={"Good example - The column works better as just a difference between the current and previous download totals"}
