...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example - "Sure, I\'ll just look up Adam\'s calendar and see when he\'s free. Obviously, it\'s not a good idea to call Adam now as he is on a plane."](adams-calendar.jpg)',
  shouldDisplay: true
} } />
