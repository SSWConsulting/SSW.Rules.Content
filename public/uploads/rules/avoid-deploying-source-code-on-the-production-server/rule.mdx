...
<imageEmbed
  ...
  caption={"How to open Publish Website dialog box"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Publish Website dialog box"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"How to open Publish Web dialog ('WebApp' is the name of this application)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Publish Web dialog box"}
