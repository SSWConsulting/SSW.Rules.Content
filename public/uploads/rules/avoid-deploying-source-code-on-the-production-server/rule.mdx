...
seoDescription: Avoid deploying source code on production servers by using tools like
  Publish utility to precompile and deploy ASP.NET projects, removing source code
...
<imageEmbed
  ...
  captionText={"How to open Publish Website dialog box"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Publish Website dialog box"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"How to open Publish Web dialog ('WebApp' is the name of this application)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Publish Web dialog box"}
