...
<imageEmbed
  ...
  figureText={"How to open Publish Website dialog box"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Publish Website dialog box"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"How to open Publish Web dialog ('WebApp' is the name of this application)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Publish Web dialog box"}
