...
| Role       | Actions |
|------------|---------|
| **Designers**  | - Use accessible colour palettes and check contrast ratios (4.5:nimum for body text)<br>- Ensuont sizes are readable<br>- Clearndicate focus states<br>- Design with text alternatives in mind |
| **Developers** | - Write semantic HTML (e.g., `<button>` `<div>` for buttons)<br>- ARIA only when necessary<br>- Ensure full kerd navigation<br>- Maintain logical tab order |
