...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"GitHub Copilot reviewing a pull request for one of the TinaCMS starter kits"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"GitHub Copilot suggestions being suppressed due to potential inaccuracy"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"PR description suggested by GitHub copilot"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"Cursor's BugBot leaving a comment on a PR"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"CodeRabbit leaving a comment on a PR"}
