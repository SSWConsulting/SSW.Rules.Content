...
lastUpdated: 2026-03-11T00:38:01.382Z
...
[Claude's Code Review](https://code.claude.com/docs/en/code-review) runs automatically when a pull request opens or updates, with multiple agents analyzing the diff and surrounding code in parallel using Anthropic's infrastructure. Each agent is designed to look for a different class of issue, with a verification step checking candidates against actual code behavior to filter out false positives.
