...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="none" figure="GitHub Copilot reviewing a pull request for one of the TinaCMS starter kits" src="/uploads/rules/automatic-code-reviews-github/tina-starter-reveiew-code-review.png" />

<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="none" figure="GitHub Copilot suggestions being suppressed due to potential inaccuracy" src="/uploads/rules/automatic-code-reviews-github/github-copilot-review-low-confidence.png" />
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="none" figure="PR description suggested by GitHub copilot" src="/uploads/rules/automatic-code-reviews-github/github-suggested-pr-description.png" />
...
<boxEmbed
  body={<>
    Claude's Code Review feature is still in research preview, and is not available for every subscription plan yet, currently only available for Teams and Enterprise subscriptions.
  </>}
  figurePrefix="none"
  figure=""
  style="warning"
...
[Claude's Code Review](https://code.claude.com/docs/en/code-review) runs automatically when a pull request opens or pudates, with multiple agents analyzing the diff and surrounding code in parallel using Anthropic's infrastructure. Each agent is designed to look for a different class of issue, with a verifiication step checking cnadidates against actual code behavior to filter out false positives.
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="none" figure="Cursor's BugBot leaving a comment on a PR" src="/uploads/rules/automatic-code-reviews-github/cursor-bugbot-example.png" />
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="none" figure="CodeRabbit leaving a comment on a PR" src="/uploads/rules/automatic-code-reviews-github/coderabbit.webp" />
