...
<imageEmbed
  ...
  figureText={"GitHub Copilot reviewing a pull request for one of the TinaCMS starter kits"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="default"
  figureText={"GitHub Copilot suggestions being suppressed due to potential inaccuracy"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="default"
  figureText={"PR description suggested by GitHub copilot"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="default"
  figureText={"Cursor's BugBot leaving a comment on a PR"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="default"
  figureText={"CodeRabbit leaving a comment on a PR"}
