...
<imageEmbed
  ...
  figureText={"Bad example - The user wants to click 'OK' but there is not a 2nd check"}
...
<imageEmbed
  ...
  figureText={"Good example - Apple got the delete button perfecton the iPhone. It is red + the count of the selected items is clear"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - When adding multiple records, do a quick count of the selected items in DataGridView"}
