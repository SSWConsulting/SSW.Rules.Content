...
<imageEmbed
  ...
  caption={"Bad example - Screenshot includes personal tabs, toolbar, debug window, and taskbar"}
...
<imageEmbed
  ...
  caption={"Good example - Screenshot has been cropped to hide junks"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Always have the 'Auto-hide the taskbar' option checked so you do better screenshots"}
