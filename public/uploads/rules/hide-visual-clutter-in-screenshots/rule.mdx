...
<imageEmbed
  ...
  figureText={"Bad example - Screenshot includes personal tabs, toolbar, debug window, and taskbar"}
...
<imageEmbed
  ...
  figureText={"Good example - Screenshot has been cropped to hide junks"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Always have the 'Auto-hide the taskbar' option checked so you do better screenshots"}
