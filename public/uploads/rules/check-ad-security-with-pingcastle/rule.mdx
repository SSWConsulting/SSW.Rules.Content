...
<imageEmbed
  ...
  figureText={"Bad example - The PingCastle report shows there is a lot of work ahead"}
...
<imageEmbed
  ...
  figureText={"Example item from PingCastle, with detailed description and solution"}
