...
<imageEmbed
  ...
  figureText={"Good Example - Hotmail does this"}
...
<imageEmbed
  ...
  figureText={"Google have done it a different way to provide multiple methods (All, All Read, All Unread, All Starred, and All Unstarred)"}
...
<imageEmbed
  ...
  figureText={"Bad Example - SQL Auditor - No CheckBox for users to perform a \"select all\""}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - SQL Auditor - CheckBox at the top of the column"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Selecting all does this - selects all"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Deselecting all does this - selects none"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Selecting some should show the Indeterminate check state - aka customized selection"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Select all checkboxes in a web form"}
