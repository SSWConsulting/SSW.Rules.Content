...
<imageEmbed
  ...
  captionText={"Good Example - Hotmail does this"}
...
<imageEmbed
  ...
  captionText={"Google have done it a different way to provide multiple methods (All, All Read, All Unread, All Starred, and All Unstarred)"}
...
<imageEmbed
  ...
  captionText={"Bad Example - SQL Auditor - No CheckBox for users to perform a \"select all\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - SQL Auditor - CheckBox at the top of the column"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Selecting all does this - selects all"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Deselecting all does this - selects none"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Selecting some should show the Indeterminate check state - aka customized selection"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Select all checkboxes in a web form"}
