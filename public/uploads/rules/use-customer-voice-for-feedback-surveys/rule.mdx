---
seoDescription: Harness customer feedback to boost client satisfaction and optimize
  your business processes with Dynamics 365's Customer Voice Surveys.
type: rule
...
created: 2022-04-04 21:31:22.712000
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Bad Example - The email a client could receive"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Good Example - It is clear who sent the survey request, how to access the survey and where to find information about the company sending the message"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="none"
  figure="Example survey if they click through"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="none"
  figure="Customer Voice Survey section of Dynamics showing Survey Responses all together"
