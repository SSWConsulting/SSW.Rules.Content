...
created: 2022-04-04T21:51:04.000Z
...
<imageEmbed
  ...
  captionText={"Bad Example - The email a client could receive"}
  src="/uploads/rules/use-customer-voice-for-feedback-surveys/survey-email.png"
/>
...
<imageEmbed
  ...
  captionText={"Good Example - It is clear who sent the survey request, how to access the survey and where to find information about the company sending the message"}
  src="/uploads/rules/use-customer-voice-for-feedback-surveys/good-survey-email.png"
/>
...
<imageEmbed
  ...
  captionText={"Example survey if they click through"}
  src="/uploads/rules/use-customer-voice-for-feedback-surveys/survey.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Survey Creation"}
  src="/uploads/rules/use-customer-voice-for-feedback-surveys/survey-edit-form.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Set up triggers to send out the surveys"}
  src="/uploads/rules/use-customer-voice-for-feedback-surveys/workflow.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Customer Voice Survey section of Dynamics showing Survey Responses all together"}
  src="/uploads/rules/use-customer-voice-for-feedback-surveys/customer-voice-responses-together.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Email notification"}
  src="/uploads/rules/use-customer-voice-for-feedback-surveys/customer-voice-email-notification.png"
/>
