...
<imageEmbed
  ...
  figureText={"Bad Example - The email a client could receive"}
...
<imageEmbed
  ...
  figureText={"Good Example - It is clear who sent the survey request, how to access the survey and where to find information about the company sending the message"}
...
<imageEmbed
  ...
  figureText={"Example survey if they click through"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Set up triggers to send out the surveys"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Customer Voice Survey section of Dynamics showing Survey Responses all together"}
