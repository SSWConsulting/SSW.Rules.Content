...
<imageEmbed
  ...
  caption={"Bad Example - The email a client could receive"}
...
<imageEmbed
  ...
  caption={"Good Example - It is clear who sent the survey request, how to access the survey and where to find information about the company sending the message"}
...
<imageEmbed
  ...
  caption={"Example survey if they click through"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Set up triggers to send out the surveys"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Customer Voice Survey section of Dynamics showing Survey Responses all together"}
