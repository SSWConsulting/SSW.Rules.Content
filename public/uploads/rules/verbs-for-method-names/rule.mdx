...
seoDescription: Naming methods with verbs enhances code clarity, ensuring actions are easily understood, while classes should consistently use nouns for better communication.
  in the name.
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="While 'ship' is a verb, it’s also a noun, making it ambiguous. Plus, it's not very descriptive!"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="A method that is named as a verb clearly tells you that it does something (sends), and what that thing is (a customer order)"
/>
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="It’s a noun, and it’s ambiguous. 'Administration' has multiple meanings, and the method name doesn’t make it clear what this action involves"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Method name describes the action"
/>