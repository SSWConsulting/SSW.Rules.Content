...
seoDescription: Clarify your code by using verbs for method names, ensuring actions are easily understood and preventing confusion with noun-based class names
  in the name.
