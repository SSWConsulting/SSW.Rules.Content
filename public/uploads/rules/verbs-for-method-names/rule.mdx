...
<boxEmbed
  ...
  caption={"Bad example - While 'ship' is a verb, it’s also a noun, making it ambiguous. Plus, it's not very descriptive!"}
/>
...
<boxEmbed
  ...
  caption={"Good example - A method that is named as a verb clearly tells you that it does something (sends), and what that thing is (a customer order)"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - It’s a noun, and it’s ambiguous. 'Administration' has multiple meanings, and the method name doesn’t make it clear what this action involves"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Method name describes the action"}
/>