...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Inconsistent resource names. Do these belong to the same product?"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Consistent names, using lowercase letters and specifying the environment. Easy to find, and easy to manage!"
