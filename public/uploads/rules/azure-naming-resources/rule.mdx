...
<imageEmbed
  ...
  caption={"The scariest resource name you can find"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad Example - Inconsistent resource names. Do these belong to the same product?"}
...
<imageEmbed
  ...
  caption={"Good Example - Consistent names, using lowercase letters and specifying the environment. Easy to find, and easy to manage!"}
