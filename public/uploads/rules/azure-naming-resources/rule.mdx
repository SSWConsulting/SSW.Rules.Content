...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![The scariest resource name you can find](kv-bad-name.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example - Inconsistent resource names. Do these belong to the same product?](bad-azure-name-example-1.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example - Consistent names, using lowercase letters and specifying the environment. Easy to find, and easy to manage!](better-example.png)',
  shouldDisplay: true
} } />
