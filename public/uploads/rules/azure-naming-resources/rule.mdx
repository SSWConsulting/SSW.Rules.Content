...
created: 2020-06-25 22:36:42+00:00
...
<imageEmbed
  ...
  figureText={"The scariest resource name you can find"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad Example - Inconsistent resource names. Do these belong to the same product?"}
...
<imageEmbed
  ...
  figureText={"Good Example - Consistent names, using lowercase letters and specifying the environment. Easy to find, and easy to manage!"}
