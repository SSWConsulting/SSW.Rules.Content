...
created: 2010-07-16 06:49:34+00:00
...
seoDescription: Here's a well-crafted SEO description based on your input - Architectural
  decision documentation and retrospective analysis for significant projects, ensuring
...
<imageEmbed
  ...
  figureText={"Bad example - Never resolve an argument by who gets exhausted first"}
...
<imageEmbed
  ...
  figureText={"Good example - Even though you disagree it's best to still commit and proceed"}
...
"OK, I will just go with the the Product Owner decision."
  ...
  figureText={"Bad example - Just go with the client decision reluctantly"}
/>
...
"Thanks for the chat today. As per our conversation, you'd like us to build this feature using a quick workaround. Just for the record, the best practice would have been to XXX, but since you are the Product Owner, and I understand we're under time pressure, I of course will go with your decision."
  ...
  figureText={"Good example - Documenting that client has asked you to do a shortcut"}
/>
...
That said, you are the Product Owner and have final say in the matter, so we will proceed with React as per your decision."
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - You have politely pointed out they are making a poor technology choice and given empirical evidence."}
/>
...
"I knew it, we should never have used React for the Northwind project."
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - Being improductive and too late"}
/>
...
As per our conversation, we are both happy that the React solution has panned out and there has been some benefits that we didn't think of at the time such as hiring a couple of cool React developers. We agreed that we could have saved some money with Angular, but we don't regret the decision."
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example – 6 month retrospective to analyse the pros and cons of a past decision."}
/>
