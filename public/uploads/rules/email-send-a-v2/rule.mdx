...
&#123;&#123; HISTORY OF THE THREAD, EXCEPT THE PREVIOUS VERSION WITH MISTAKE(S) &#125;&#125;
  ...
  caption={"Good example - Sending a 'v2' when you need to make an update"}
/>
...
<youtubeEmbed url="https://www.youtube.com/embed/2WoDQBhJCVQ" description={"Video: Some jobs give no chance for a v2 (1 min)"} />
...
<imageEmbed
  ...
  caption={"Bad example - Outlook's 'Resend This Message' feature is no longer recommended"}
  src="/uploads/rules/email-send-a-v2/resend-this-message.png"
/>