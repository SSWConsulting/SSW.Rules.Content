...
::: bad
![Figure: Bad example - Outlook's 'Resend This Message' feature is no longer recommended](/uploads/rules/email-send-a-v2/resend-this-message.png)
  </>}
  captionStyle="default"
  captionText={""}
/>
...
&#123;&#123; HISTORY OF THE THREAD, EXCEPT THE PREVIOUS VERSION WITH MISTAKE(S) &#125;&#125;
  ...
  captionText={"Good example - Sending a 'v2' when you need to make an update"}
/>
