...
![Bad example - Outlook's 'Resend This Message' feature is no longer recommended](/uploads/rules/email-send-a-v2/uploads/rules/email-send-a-v2/resend-this-message.png)
  </>}
  figureEmbed={{
    preset: "default",
    figure: "XXX",
