...
* If you see a v2 email, immediately delete the earlier versions, so you can only reply to the new version of the email
...
<emailEmbed
  ...
  figurePrefix="good"
  figure="Sending a 'v2' when you need to make an update"
/>
...
<youtubeEmbed url="https://www.youtube.com/embed/2WoDQBhJCVQ" description="Video: Some tasks give you no chance for a v2 (1 min)" />

***

### Avoid Outlook's 'Resend This Message'

In Outlook, there is an option to use the 'Resend This Message' button from the toolbar. This [used to be the standard practice](https://www.youtube.com/embed/SUo_hOCubeo), however currently it should be avoided as it breaks the thread.

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="bad" figure="Outlook's 'Resend This Message' feature is no longer recommended" src="/uploads/rules/email-send-a-v2/resend-this-message.png" />
