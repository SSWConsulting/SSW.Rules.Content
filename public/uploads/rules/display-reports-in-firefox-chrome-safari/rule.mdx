...
created: 2024-09-16 09:13:00+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - SQL RS does not work in Chrome by default"}
...
<imageEmbed
  ...
  figureText={"Good example - SQL RS fixed to correctly display in Chrome"}
