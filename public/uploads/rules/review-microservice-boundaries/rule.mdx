...
created: 2024-10-25 01:09:23.840000+00:00
...
![Microservice maps can get intense](/uploads/rules/review-microservice-boundaries/bad-example-microservice-map.png)
...
A great way of performing this exercise is using your [event storming](https://www.ssw.com.au/rules/event-storming) artefacts (if you haven't previously gone through an event storming exercise, it's highly recommended you do so).
...
You will often find obvious groupings of Microservices divided by "pivotal moments" in your user journey, with a sprinkling of "shared" or cross-boundary services (like an email notification service). These grouped services may better serve your application by being merged into a singular Microservice (or [Modular Monolith](https://www.ssw.com.au/rules/rules-to-better-modular-monoliths)).
