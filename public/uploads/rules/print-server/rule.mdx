...
<imageEmbed
  ...
  caption={"Add Print servers to AD"}
...
<imageEmbed
  ...
  caption={"Bad example – Windows 11 | Printers & scanners - Users won’t see all the printers by default"}
...
<imageEmbed
  ...
  caption={"Good example - Printers listed in Printer Server"}
