...
<imageEmbed
  ...
  captionText={"Add Print servers to AD"}
...
<imageEmbed
  ...
  captionText={"Bad example – Windows 11 | Printers & scanners - Users won’t see all the printers by default"}
...
<imageEmbed
  ...
  captionText={"Good example - Printers listed in Printer Server"}
