...
lastUpdated: 2020-03-20T01:23:45.000Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Launching the Code Metrics tool within Visual Studio" src="/uploads/rules/know-when-functions-are-too-complicated/calculate_code_metrics.jpg" />

2\. Look at the function with the largest Cyclomatic Complexity number and consider refactoring to make it simpler.

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Results from cyclomatic analysis (and other analyses) give an indication of how complicated functions are" src="/uploads/rules/know-when-functions-are-too-complicated/code_metrics_report.jpg" />
