...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Don't use emails to discuss tasks"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="When adding a GitHub issue, @ mention the Product Owner and other related people so they receive a notification e.g, an email"
