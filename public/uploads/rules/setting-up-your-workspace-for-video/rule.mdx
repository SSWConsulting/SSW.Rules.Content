...
<imageEmbed
  ...
  figureText={"Christian uses this divider to hide his background"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Jason is in a bedroom, however, the angle shows little of the bed"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Logitech Brio 4k webcam"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Rode USB Podcaster microphone"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Ring light for webcam/camera/smartphone"}
