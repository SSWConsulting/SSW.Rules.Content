...
<imageEmbed
  ...
  captionText={"Christian uses this divider to hide his background"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Jason is in a bedroom, however, the angle shows little of the bed"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Logitech Brio 4k webcam"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Rode USB Podcaster microphone"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Ring light for webcam/camera/smartphone"}
