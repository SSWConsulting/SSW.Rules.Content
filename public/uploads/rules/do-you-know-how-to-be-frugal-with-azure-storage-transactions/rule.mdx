...
<imageEmbed
  ...
  figureText={"Check the properties of your web and worker role configuration files"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Disable diagnostics"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"When publishing, ensure that IntelliTrace and Profiling are both disabled"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Place robots.txt in the root of your site to control search engine indexing"}
