...
<imageEmbed
  ...
  captionText={"Check the properties of your web and worker role configuration files"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Disable diagnostics"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"When publishing, ensure that IntelliTrace and Profiling are both disabled"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Place robots.txt in the root of your site to control search engine indexing"}
