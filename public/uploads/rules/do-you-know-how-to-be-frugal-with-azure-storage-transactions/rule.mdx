...
<imageEmbed
  ...
  caption={"Check the properties of your web and worker role configuration files"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"When publishing, ensure that IntelliTrace and Profiling are both disabled"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Place robots.txt in the root of your site to control search engine indexing"}
