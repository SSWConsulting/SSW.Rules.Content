...
<imageEmbed
  ...
  caption={"Bad Example - Appointment field should have addresses in location when appropriate"}
...
<imageEmbed
  ...
  caption={"Good example - Address is clearly identified in the location field, meaning it can be mapped using applications on smartphones"}
