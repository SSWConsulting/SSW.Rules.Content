...
<imageEmbed
  ...
  captionText={"Bad Example - Appointment field should have addresses in location when appropriate"}
...
<imageEmbed
  ...
  captionText={"Good example - Address is clearly identified in the location field, meaning it can be mapped using applications on smartphones"}
