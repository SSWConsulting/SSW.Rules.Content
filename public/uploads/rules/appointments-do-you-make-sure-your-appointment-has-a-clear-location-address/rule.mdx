...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Appointment field should have addresses in location when appropriate"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Address is clearly identified in the location field, meaning it can be mapped using applications on smartphones"
