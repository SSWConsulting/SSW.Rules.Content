...
<imageEmbed
  ...
  caption={"Good example - Teams synced from Azure AD in Keeper"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Keeper Enterprise is certified to FIPS 140-2"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - Simple sharing settings for passwords"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - One-time share a password to external users"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Transfer account enforcement policy"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Reporting in Keeper is excellent"}
