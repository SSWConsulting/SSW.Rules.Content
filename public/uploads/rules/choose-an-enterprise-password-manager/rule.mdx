...
<imageEmbed
  ...
  figureText={"Good example - Teams synced from Azure AD in Keeper"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Keeper Enterprise is certified to FIPS 140-2"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - Simple sharing settings for passwords"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - One-time share a password to external users"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Transfer account enforcement policy"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Reporting in Keeper is excellent"}
