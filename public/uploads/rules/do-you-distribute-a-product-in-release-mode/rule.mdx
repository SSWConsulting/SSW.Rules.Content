...
<imageEmbed
  ...
  captionText={"Set \"Generate Debugging Information\" to True on the project properties page (VS 2003)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Set \"Debug Info\" to \"pdb-only\" on the Advanced Build Settings page (VS 2005)"}
