---
seoDescription: Microsoft Bot Framework's LUIS enables natural language processing
  for conversational AI, offering built-in support and pre-trained entities.
type: rule
...
created: 2021-11-18 06:23:33.649000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Separated intents with overlapping vocabulary"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Combine intents that have same vocabulary and use entities"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="An intent with no feature can lead to low accuracy"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="An intent with features can help LUIS predict more accurately"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure='An empty None intent means no "emergency replies" for unrecognized inputs'
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Add example utterances to None intent with an approximately 1:10 ratio to the utterances in the rest of your LUIS app"
