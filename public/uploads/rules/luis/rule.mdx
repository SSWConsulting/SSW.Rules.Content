...
<imageEmbed
  ...
  figureText={"Bad example - Separated intents with overlapping vocabulary"}
...
<imageEmbed
  ...
  figureText={"Good example - Combine intents that have same vocabulary and use entities"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - An intent with no feature can lead to low accuracy"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - An intent with features can help LUIS predict more accurately"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - An empty None intent means no \"emergency replies\" for unrecognized inputs"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Add example utterances to None intent with an approximately 1:10 ratio to the utterances in the rest of your LUIS app"}
