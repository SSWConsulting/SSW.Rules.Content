...
<imageEmbed
  ...
  caption={"Bad example - Separated intents with overlapping vocabulary"}
...
<imageEmbed
  ...
  caption={"Good example - Combine intents that have same vocabulary and use entities"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - An intent with no feature can lead to low accuracy"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - An intent with features can help LUIS predict more accurately"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - An empty None intent means no \"emergency replies\" for unrecognized inputs"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Add example utterances to None intent with an approximately 1:10 ratio to the utterances in the rest of your LUIS app"}
