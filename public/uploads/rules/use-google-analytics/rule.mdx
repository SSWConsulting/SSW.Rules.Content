...
created: 2014-08-20 02:43:16+00:00
...
<imageEmbed
  ...
  captionText={"Navigate to the Tracking Code property"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Include this JavaScript in your web application"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The JavaScript code in HTML"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Plausible Analytics is an open source project dedicated to making web analytics more privacy-friendly"}
