...
created: 2025-11-11 02:30:09+00:00
createdBy: Louis Roa
...
seoDescription: Install and review Google Analytics to see how people find and use
  your website, and use the data to make smarter decisions.
...
<youtubeEmbed url="https://youtu.be/I3GneD2bPJg" description={"Video: How To Setup Google Analytics In 2025 - Complete Tutorial (9 min)"} />
...
<imageEmbed
  ...
  caption={"Navigate to the Tracking Code property"}
  src="/uploads/rules/use-google-analytics/tracking-code-property.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Include this JavaScript in your web application"}
  src="/uploads/rules/use-google-analytics/20-08-2014-3-30-55-PM-compressor.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The JavaScript code in HTML"}
  src="/uploads/rules/use-google-analytics/20-08-2014-10-53-15-AM-compressor.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Plausible Analytics is an open source project dedicated to making web analytics more privacy-friendly"}
  src="/uploads/rules/use-google-analytics/imgi_2_plausible-analytics.png"
/>
