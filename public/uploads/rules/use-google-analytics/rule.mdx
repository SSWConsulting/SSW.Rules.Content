...
<imageEmbed
  ...
  figureText={"Navigate to the Tracking Code property"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Include this JavaScript in your web application"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The JavaScript code in HTML"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Plausible Analytics is an open source project dedicated to making web analytics more privacy-friendly"}
