...
<imageEmbed
  ...
  captionText={"Multi-tasking can be your deadline's enemy"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The Pomodoro technique uses a timer to break down work into intervals, traditionally 25 minutes in length, separated by short breaks."}
