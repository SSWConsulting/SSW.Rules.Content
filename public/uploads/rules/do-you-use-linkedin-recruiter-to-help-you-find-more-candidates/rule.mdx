...
<imageEmbed
  ...
  caption={"A screenshot of the Recruiter search that you can use. The red box shows you the keyword searches that you can do to filter applicants and suggestions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Showing the non-customizable funnels used by LinkedIn Recruiter"}
