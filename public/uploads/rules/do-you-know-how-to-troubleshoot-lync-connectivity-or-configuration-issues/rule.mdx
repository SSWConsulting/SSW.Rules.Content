...
isArchived: false
lastUpdated: 2017-04-19 18:09:00+00:00
...
<imageEmbed
  ...
  captionText={"Lync Auto-Discovery Mobility DNS record"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"VisualRoute 2010 tool showing a test to a Google DNS server"}
