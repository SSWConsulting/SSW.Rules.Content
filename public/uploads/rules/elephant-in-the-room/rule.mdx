...
<boxEmbed
  ...
  figureText={"Bad example - Client loses trust; slip becomes a surprise"}
/>
...
Which do you prefer?”
  ...
  figureText={"Good example - Clear trade-offs and a decision path"}
/>
...
<boxEmbed
  ...
  figurePreset="badExampleExample"
  figureText={"Bad example - Issue festers; team gossips instead of fixes"}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - A measurable change with shared ownership"}
/>