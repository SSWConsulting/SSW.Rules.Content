...
seoDescription: Address issues early. Naming "the elephant" builds trust, strengthens
  teamwork, and keeps projects moving forward.
tips: ''
...
<boxEmbed
  ...
  caption={"Bad example - Client loses trust; slip becomes a surprise"}
/>
...
Which do you prefer?”
  ...
  caption={"Good example - Clear trade-offs and a decision path"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - Issue festers; team gossips instead of fixes"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - A measurable change with shared ownership"}
/>