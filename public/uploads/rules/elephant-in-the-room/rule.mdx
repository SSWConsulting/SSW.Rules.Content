...
<boxEmbed
  ...
  captionText={"Bad example - Client loses trust; slip becomes a surprise"}
/>
...
Which do you prefer?”
  ...
  captionText={"Good example - Clear trade-offs and a decision path"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - Issue festers; team gossips instead of fixes"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - A measurable change with shared ownership"}
/>