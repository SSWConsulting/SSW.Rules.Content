...
<imageEmbed
  ...
  captionText={"Navigate to Microsoft Teams | Calendar | New Meeting"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Enter the details of the meeting, make sure to add a channel to associate with it!"}
