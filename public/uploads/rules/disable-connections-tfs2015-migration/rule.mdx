...
<imageEmbed
  ...
  figureText={"Stop each Team Project Collection"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"All Team Project Collections are stopped"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Visual Studio shows the message that you entered when you stopped the Team Project Collection"}
