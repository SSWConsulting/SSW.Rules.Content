...
<imageEmbed
  ...
  caption={"Stop each Team Project Collection"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"All Team Project Collections are stopped"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Visual Studio shows the message that you entered when you stopped the Team Project Collection"}
