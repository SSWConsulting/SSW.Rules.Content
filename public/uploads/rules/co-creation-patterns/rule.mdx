...
<imageEmbed
  ...
  captionText={"Bad example - Vicious cycle of being blocked and picking up yet another task"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Inefficiencies caused by asynchronous code reviews"}
