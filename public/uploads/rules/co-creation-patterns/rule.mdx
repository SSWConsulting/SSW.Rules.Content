...
<imageEmbed
  ...
  caption={"Bad example - Vicious cycle of being blocked and picking up yet another task"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Inefficiencies caused by asynchronous code reviews"}
