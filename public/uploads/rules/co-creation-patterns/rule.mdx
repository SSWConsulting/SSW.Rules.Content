...
lastUpdated: 2026-03-04T09:51:38.169Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Vicious cycle of being blocked and picking up yet another task" src="/uploads/rules/co-creation-patterns/co-creation-1.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Inefficiencies caused by asynchronous code reviews" src="/uploads/rules/co-creation-patterns/co-creation-2.png" />
