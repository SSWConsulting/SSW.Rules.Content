...
<imageEmbed
  ...
  caption={"The new Glimpse Heads Up Display"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Glimpse in action - We can see which routes were chosen for this page, and the parameters used by the controller"}
