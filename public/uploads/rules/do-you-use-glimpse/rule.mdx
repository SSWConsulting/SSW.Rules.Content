...
<imageEmbed
  ...
  figureText={"The new Glimpse Heads Up Display"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Glimpse in action - We can see which routes were chosen for this page, and the parameters used by the controller"}
