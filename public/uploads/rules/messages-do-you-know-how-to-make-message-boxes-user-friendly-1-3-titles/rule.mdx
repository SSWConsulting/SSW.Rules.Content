...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Title contains brief description of error, which is already contained in the message box"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure='Title contains Product Name ("SSW eXtreme Emails!") and Product Version ("12.56")'
