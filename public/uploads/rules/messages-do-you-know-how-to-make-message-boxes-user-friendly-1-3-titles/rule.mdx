...
isArchived: false
lastUpdated: 2012-11-27 04:35:58+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example - Title contains brief description of error, which is already contained in the message box"}
...
<imageEmbed
  ...
  figureText={"Good Example - Title contains Product Name (\"SSW eXtreme Emails!\") and Product Version (\"12.56\")"}
