...
created: 2012-11-27 04:34:44+00:00
...
seoDescription: Learn how to create user-friendly message box titles with consistent
...
<imageEmbed
  ...
  captionText={"Bad Example - Title contains brief description of error, which is already contained in the message box"}
...
<imageEmbed
  ...
  captionText={"Good Example - Title contains Product Name (\"SSW eXtreme Emails!\") and Product Version (\"12.56\")"}
