...
seoDescription: Discover the key differences between Canvas Apps and Model-Driven
  Apps in Power Apps to choose the right solution for your needs.
...
<imageEmbed
  ...
  captionText={"Canvas App Example"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Model-Driven App Example"}
