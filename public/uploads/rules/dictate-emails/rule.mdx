...
<imageEmbed
  ...
  figureText={"Press this button in the ribbon to dictate, or use the keyboard shortcut of Alt+`"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"For a full list of available commands, click here (the box that pops up at the bottom of the screen while you dictate)"}
