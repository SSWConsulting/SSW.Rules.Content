...
redirects: []
seoDescription: Customizable and non-customizable settings in .NET are stored in different
  files, including App.config/Web.config, ToolsOptions.config, and UserSession.config.
