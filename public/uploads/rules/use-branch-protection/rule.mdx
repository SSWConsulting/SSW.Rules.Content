...
<imageEmbed
  ...
  captionText={"Bad example: Main branch not protected"}
...
<imageEmbed
  ...
  captionText={"Good Example: Main branch is protected"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Developers can't merge until all checks have passed"}
