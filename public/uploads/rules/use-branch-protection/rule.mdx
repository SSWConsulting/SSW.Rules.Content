...
<imageEmbed
  ...
  figureText={"Bad example: Main branch not protected"}
...
<imageEmbed
  ...
  figureText={"Good Example: Main branch is protected"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Developers can't merge until all checks have passed"}
