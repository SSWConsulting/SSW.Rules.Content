...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "![Bad example: Main branch not protected](/uploads/rules/use-branch-protection/bad-unprotected-main-branch.jpg)",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "![Good Example: Main branch is protected](/uploads/rules/use-branch-protection/branchProtection.png)",
  shouldDisplay: true
} } />
