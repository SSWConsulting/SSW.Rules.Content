...
created: 2021-03-23T04:31:31.048Z
createdBy: Brady Stroud
createdByEmail: bradystroud@me.com
lastUpdated: 2026-07-28T07:02:12.403Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Main branch not protected" src="/uploads/rules/use-branch-protection/bad-unprotected-main-branch.jpg" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Main branch is protected" src="/uploads/rules/use-branch-protection/branchProtection.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Developers can't merge until all checks have passed" src="/uploads/rules/use-branch-protection/requiredChecks.png" />
