...
<boxEmbed
  ...
  figureText={"Bad example - This URL will throw a 404 error rather than redirecting to https://"}
/>
...
<boxEmbed
  ...
  figureText={"Good example - Redirect works fine if the URL doesn't include “+\""}
/>