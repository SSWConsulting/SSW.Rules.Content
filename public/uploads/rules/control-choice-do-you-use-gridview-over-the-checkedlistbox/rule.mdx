...
<imageEmbed
  ...
  captionText={"Bad Example - The CheckedListBox is limited"}
...
<imageEmbed
  ...
  captionText={"Good Example - The DataGrid can show much more information (and if you use a 3rd Party eg. Telerik, then it can be pretty too)"}
