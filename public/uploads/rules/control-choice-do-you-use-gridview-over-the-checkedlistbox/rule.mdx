...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The CheckedListBox is limited"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The DataGrid can show much more information (and if you use a 3rd Party eg. Telerik, then it can be pretty too)"
