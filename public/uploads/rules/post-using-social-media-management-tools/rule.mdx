...
<imageEmbed
  ...
  captionText={"Good example – Ocoya’s calendar view"}
...
<imageEmbed
  ...
  captionText={"To use the Buffer app from your browser, simply click the symbol"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"You can select as many Social Media accounts as required and post to each platform at once using Buffer. You can also use the \"Customize for each network\" button to modify the content for each platform before you post it"}
...
<imageEmbed
  ...
  captionText={"Bad example - only Tweeting using Twitter alone and not using a scheduler to post across the different media platforms at once. This is time-consuming!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - posting using Buffer to modify your content between platforms - much faster than posting individually to each platform every time"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"SocialPilot analytics reporting can help you understand better if your content is working towards achieving your goals"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Hootsuite allows you to add chatbots for Facebook Messenger. You can combine automated and human responses to answer user questions, comments, etc."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Sprout Social has a Listening feature that allows you to build a deeper understanding of your audience, discover trends and apply insights from your social media in your business strategy"}
