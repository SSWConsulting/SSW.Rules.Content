...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example: Default tab – Wiki. There is no offline mobile application](/uploads/rules/the-best-wiki/teams-best-wiki-1.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example: Use OneNote. Now you can use the normal OneNote Desktop and Mobile app for iOS and Android (including offline support)](/uploads/rules/the-best-wiki/teams-best-wiki-2.jpg)',
  shouldDisplay: true
} } />
