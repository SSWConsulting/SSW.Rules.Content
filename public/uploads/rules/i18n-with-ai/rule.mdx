...
9. **RTL layouts** - For instance, Arabic language flip entire UI structures, not just text direction (see image below)
  ...
  figureEmbed={ {
    preset: "default",
    figure: "Arabic is one of the top 5 internet languages with 300M+ speakers. Supporting RTL layouts is essential, the UI looks entirely different when switching to Arabic",
    shouldDisplay: true
  } }
...
<youtubeEmbed url="https://youtu.be/YpVnqI5ljgY?si=jPR7PuV9o6gmneH5&t=491" description={"Video: Apidays Munich 2025 - AI translation + AI agents = i18n made easy By Ben Morss - watch from 8:10 to 16:40 (8 min)"} />
