...
<imageEmbed
  ...
  captionText={"Many top-spoken languages remain underrepresented online, e.g. Chinese represents 13% of the world, but 2.2% of the websites"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"Arabic is one of the top 5 internet languages with ~250M speakers. Supporting RTL layouts is essential, the UI looks entirely different when switching to Arabic"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"i18n Decision Tree"}
