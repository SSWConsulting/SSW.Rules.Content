...
<imageEmbed
  ...
  figureText={"Bad example - Too simple and no helpful information"}
...
<imageEmbed
  ...
  figureText={"Good example - All useful information is maintained and conditional formatting is used to identify significant changes"}
