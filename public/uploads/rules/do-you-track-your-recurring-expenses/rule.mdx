...
<imageEmbed
  ...
  caption={"Bad example - Too simple and no helpful information"}
...
<imageEmbed
  ...
  caption={"Good example - All useful information is maintained and conditional formatting is used to identify significant changes"}
