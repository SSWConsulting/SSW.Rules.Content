...
created: 2022-10-13T00:18:35.000Z
...
<imageEmbed
  ...
  captionText={"Bad example - Manually checking for updates"}
...
<imageEmbed
  ...
  captionText={"OK example - WSUS is a good tool, but it only does Microsoft Updates"}
...
<imageEmbed
  ...
  captionText={"Good example - In Patch Manager Plus, you can set the deployment date based on Patch Tuesday"}
