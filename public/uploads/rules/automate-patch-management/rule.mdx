---
seoDescription: Automate your patch management and ensure seamless updates on Microsoft
  operating systems and third-party apps with recommended solutions.
type: rule
...
created: 2022-06-24 01:21:43.151000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Manually checking for updates"
  src="/uploads/rules/automate-patch-management/windows-update.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="WSUS is a good tool, but it only does Microsoft Updates"
  src="/uploads/rules/automate-patch-management/01_wsus-console.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="In Patch Manager Plus, you can set the deployment date based on Patch Tuesday"
  src="/uploads/rules/automate-patch-management/patch-tuesday.png"
/>
