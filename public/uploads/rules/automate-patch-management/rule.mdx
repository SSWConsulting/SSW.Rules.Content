...
<imageEmbed
  ...
  caption={"Bad example - Manually checking for updates"}
...
<imageEmbed
  ...
  caption={"OK example - WSUS is a good tool, but it only does Microsoft Updates"}
...
<imageEmbed
  ...
  caption={"Good example - In Patch Manager Plus, you can set the deployment date based on Patch Tuesday"}
