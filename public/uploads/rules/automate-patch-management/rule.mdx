...
<imageEmbed
  ...
  figureText={"Bad example - Manually checking for updates"}
...
<imageEmbed
  ...
  figureText={"OK example - WSUS is a good tool, but it only does Microsoft Updates"}
...
<imageEmbed
  ...
  figureText={"Good example - In Patch Manager Plus, you can set the deployment date based on Patch Tuesday"}
