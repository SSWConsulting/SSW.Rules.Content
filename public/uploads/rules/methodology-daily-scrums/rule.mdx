...
seoDescription: Improve daily scrum efficiency and collaboration with these actionable
  tips on sending emails, using IM, and making meetings easy to find.
...
<imageEmbed
  ...
  figureText={"A burndown chart in visualstudio.com"}
...
&lt;This email was sent as per [Do you do Daily Scrums?](/methodology-daily-scrums)&gt;
  ...
  figureText={"Schedule a recurring Daily Scrum meeting in Outlook using this template"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Or you can use Microsoft Teams"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"A Task Board from Azure DevOps"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Call the Product Owner if you have an impediment"}
...
<imageEmbed
  ...
  figureText={"Bad example - Too many Daily Scrum appointments"}
...
<imageEmbed
  ...
  figureText={"Good example - Make Daily Scrums easy to find via the Teams Channel Calendar"}
...
* ❌ Blocked - XXX
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Always include what you previously worked on and what you plan on doing today"}
/>
...
* Tidy inbox
  ...
  figureText={"Bad example - Lack of details... For example, saying \"Yesterday\" - if it's Monday, you wouldn't say “Yesterday was Sunday\"... so if you were sick, it's more useful to go back to the prior day you were working"}
/>
...
* ==Getting my emails on "SSW.com" to zero==
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Clear details"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Daily Scrums will alert everyone if there is a major problem and get all brains aligned in the right direction. There is no sense in putting a Band-Aid on a patient's scraped knee if there is a big knife in his eye!"}
