...
<imageEmbed
  ...
  captionText={"A burndown chart in visualstudio.com"}
...
&lt;This email was sent as per [Do you do Daily Scrums?](/methodology-daily-scrums)&gt;
  ...
  captionText={"Schedule a recurring Daily Scrum meeting in Outlook using this template"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Or you can use Microsoft Teams"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"A Task Board from Azure DevOps"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Call the Product Owner if you have an impediment"}
...
<imageEmbed
  ...
  captionText={"Bad example - Too many Daily Scrum appointments"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Make Daily Scrums easy to find via the Teams Channel Calendar"}
...
* ❌ Blocked - XXX
  ...
  captionStyle="goodExample"
  captionText={"Good example - Always include what you previously worked on and what you plan on doing today"}
/>
...
* Tidy inbox
  ...
  captionStyle="badExample"
  captionText={"Bad example - Lack of details... For example, saying \"Yesterday\" - if it's Monday, you wouldn't say “Yesterday was Sunday\"... so if you were sick, it's more useful to go back to the prior day you were working"}
/>
...
* ==Getting my emails on "SSW.com" to zero==
  ...
  captionStyle="goodExample"
  captionText={"Good example - Clear details"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Daily Scrums will alert everyone if there is a major problem and get all brains aligned in the right direction. There is no sense in putting a Band-Aid on a patient's scraped knee if there is a big knife in his eye!"}
