...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Too many Daily Scrum appointments"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Make Daily Scrums easy to find via the Teams Channel Calendar"
...
<boxEmbed
  style="info"
  body={<>
**Note:** If you don't have a team, include the [Bench Masters](/bench-master) in the email.
  </>}
  figurePrefix="none"
  figure=""
/>
