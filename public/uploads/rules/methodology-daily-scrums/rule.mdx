...
isArchived: false
lastUpdated: 2025-11-04 01:14:24+00:00
lastUpdatedBy: Griffen Edge [SSW]
lastUpdatedByEmail: griffen@griffenedge.com
redirects:
...
<imageEmbed
  ...
  caption={"A burndown chart in visualstudio.com"}
...
&lt;This email was sent as per [Do you do Daily Scrums?](/methodology-daily-scrums)&gt;
  ...
  caption={"Schedule a recurring Daily Scrum meeting in Outlook using this template"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Or you can use Microsoft Teams"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A Task Board from Azure DevOps"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Call the Product Owner if you have an impediment"}
...
<imageEmbed
  ...
  caption={"Bad example - Too many Daily Scrum appointments"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Make Daily Scrums easy to find via the Teams Channel Calendar"}
...
* ❌ Blocked - XXX
  ...
  captionStyle="goodExample"
  caption={"Good example - Always include what you previously worked on and what you plan on doing today"}
/>
...
* Tidy inbox
  ...
  captionStyle="badExample"
  caption={"Bad example - Lack of details... For example, saying \"Yesterday\" - if it's Monday, you wouldn't say “Yesterday was Sunday\"... so if you were sick, it's more useful to go back to the prior day you were working"}
/>
...
* ==Getting my emails on "SSW.com" to zero==
  ...
  captionStyle="goodExample"
  caption={"Good example - Clear details"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Daily Scrums will alert everyone if there is a major problem and get all brains aligned in the right direction. There is no sense in putting a Band-Aid on a patient's scraped knee if there is a big knife in his eye!"}
