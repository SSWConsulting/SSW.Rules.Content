...
lastUpdated: 2026-09-17T21:29:11.676Z
...
<boxEmbed
  style="tips"
  body={<>
    **Hot tip:** Make your Daily Scrum email a breeze with the `/daily-scrum-email` AI skill from [SSW.AISkills](https://github.com/SSWConsulting/SSW.AISkills). It drafts your email from yesterday's GitHub activity (PRs authored, merged and reviewed, plus issues worked on) and copies it to your clipboard, ready to paste into Outlook.

    Install it with `npx skills add SSWConsulting/SSW.AISkills -g -s daily-scrum-email`, then run `/daily-scrum-email` in your AI coding agent (e.g. Claude Code or GitHub Copilot).
  </>}
  figurePrefix="none"
  figure=""
/>
...
<boxEmbed
  ...
  body={<>
    ...
    I have XX days until my next client booking.
    I have XX emails in my inbox.
    <mark style="background-color: #FEF08A">Last Friday</mark> I was on sick leave.
    
    Today I am working on:
    
    * TimePro - <mark style="background-color: #FEF08A">Adding new button to the next day</mark>
    * <mark style="background-color: #FEF08A">Getting my emails on "SSW\.com" to zero</mark>
  </>}
  figurePrefix="good"
