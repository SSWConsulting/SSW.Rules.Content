...
created: 2024-12-19T08:48:34.000Z
guid: 7a96c83a-1d97-4904-a429-c71d5c7f3410
lastUpdated: 2024-12-20T01:41:55.000Z
...
![Figure: Too many lego pieces - Where do you start?](/uploads/rules/aspire/too-complex-aspire.png)
...
<introYoutube url="https://www.youtube.com/watch?v=59G9Cd-rV9w" description={"Video: Cloud Native Aspirations with .NET Aspire | Matt Wicks & Rob Pearson | SSW User Groups (1:28 hr)"} />
  </>}
/>
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad Example - Manually setting up Redis cache 🥱",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "**Figure: Good Example - Simple Redis setup with .NET Aspire 🚀**",
  shouldDisplay: true
} } />
...
[https://learn.microsoft.com/en-us/dotnet/aspire/get-started/aspire-overview?WT.mc_id=DT-MVP-33518](https://learn.microsoft.com/en-us/dotnet/aspire/get-started/aspire-overview?WT.mc_id=DT-MVP-33518)

<asideEmbed
  variant="greybox"
  body={<>
    You can test out Aspire by running the SSW.CleanArchitecture template - Let us know what you think!
[https://github.com/SSWConsulting/SSW.CleanArchitecture?tab=readme-ov-file#installing-the-template](https://github.com/SSWConsulting/SSW.CleanArchitecture?tab=readme-ov-file#installing-the-template)
  </>}
  figureEmbed={{
    preset: "default",
    figure: "XXX",
