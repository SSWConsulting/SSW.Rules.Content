...
<imageEmbed
  ...
  captionText={"Bad example - Pressing commit and forgetting about it. PR has been left open for a over 2 weeks"}
...
<imageEmbed
  ...
  captionText={"Good example - Devs reviewing a PR on a call - no merge debt!"}
