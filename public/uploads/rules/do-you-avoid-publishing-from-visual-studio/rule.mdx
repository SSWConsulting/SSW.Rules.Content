...
<imageEmbed
  ...
  captionText={"Bad Example – Using Publish to deploy"}
...
<imageEmbed
  ...
  captionText={"Good Example – Queuing a new build to deploy your application"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Best example – Use continuous integration to trigger your Continuous Deployment build"}
