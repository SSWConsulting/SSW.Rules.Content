...
isArchived: false
lastUpdated: 2019-09-19 01:31:12+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example – Using Publish to deploy"}
...
<imageEmbed
  ...
  figureText={"Good Example – Queuing a new build to deploy your application"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Best example – Use continuous integration to trigger your Continuous Deployment build"}
