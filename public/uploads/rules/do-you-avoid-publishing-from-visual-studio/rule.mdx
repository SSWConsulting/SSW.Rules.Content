...
<imageEmbed
  ...
  caption={"Bad Example – Using Publish to deploy"}
...
<imageEmbed
  ...
  caption={"Good Example – Queuing a new build to deploy your application"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Best example – Use continuous integration to trigger your Continuous Deployment build"}
