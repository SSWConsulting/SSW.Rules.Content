...
seoDescription: Do you use a Content Delivery Network (CDN) to reduce network latency
  and improve page load times for your users?
created: 2024-09-02 22:09:22+00:00
createdBy: Brady Stroud [SSW]
createdByEmail: bradystroud@ssw.com.au
lastUpdated: 2026-02-02 00:04:48.132000+00:00
...
* **No Azure Service integration** Cloudflare doesn't natively allow you to ingest logs into Azure
...
<boxEmbed
  body={<>
    The pricing below reflects standard rates as of January 2026. Actual costs may vary based on specific usage patterns and regional adjustments.
  </>}
  figurePrefix="none"
  figure=""
  style="info"
...
### Cloudflare (Pro + Workers)

| Service                                                                                        | Monthly Cost                | Annual Cost                 |
| ---------------------------------------------------------------------------------------------- | --------------------------- | --------------------------- |
| [CloudFlare workers standard plan](https://www.cloudflare.com/en-au/plans/developer-platform/) | $5                          | $60                         |
| [CloudFlare Pro Plan (yearly)](https://www.cloudflare.com/en-au/plans/)                        | $20                         | $240                        |
| 10,000,000 requests per month                                                                  | Free \< 10,000,000 requests | Free \< 10,000,000 requests |
| Total                                                                                          | $25                         | $300                        |
...
| Service                                                                                                         | Monthly Cost | Annual Cost |
| --------------------------------------------------------------------------------------------------------------- | ------------ | ----------- |
| [Azure Front Door Premium](https://azure.microsoft.com/en-us/pricing/details/frontdoor/?utm_source=chatgpt.com) | $35          | $420        |
| 10,000,000 requests per month                                                                                   | $9           | $108        |
| Total                                                                                                           | $44          | $528        |
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Jquery.min.js from GoogleAPIs failed to load" src="/uploads/rules/use-a-cdn/5-28.4.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Jquery.min.js from CDNJS isn't blocked and is very fast" src="/uploads/rules/use-a-cdn/5-28.5.png" />
