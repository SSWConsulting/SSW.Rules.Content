...
<imageEmbed
  ...
  figureText={"In Keeper you can see at a glance if insecure passwords are being used"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Keeper quickly shows you if any of your passwords have been released in a breach"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"In Keeper you can lock an account expire a master password or even transfer their passwords"}
