...
<boxEmbed
  ...
  captionText={"OK example - A strong memorable password"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - A strong computer-generated password"}
/>
...
<imageEmbed
  ...
  captionText={"In Keeper you can see at a glance if insecure passwords are being used"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Keeper quickly shows you if any of your passwords have been released in a breach"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"In Keeper you can lock an account expire a master password or even transfer their passwords"}
