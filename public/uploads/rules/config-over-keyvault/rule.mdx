...
<imageEmbed
  ...
  figureText={"Bad example - Having to wire up Key Vault unnecessarily"}
...
<imageEmbed
  ...
  figureText={"Good example - Developers don't need to know anything about Key Vault"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example -  Using Key Vault values in Azure App Service"}
