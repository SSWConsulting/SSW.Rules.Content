...
created: 2023-08-08 23:45:18.798000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Having to wire up Key Vault unnecessarily"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Developers don't need to know anything about Key Vault"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using Key Vault values in Azure App Service"
