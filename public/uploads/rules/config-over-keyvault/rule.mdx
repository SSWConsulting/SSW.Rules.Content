...
<imageEmbed
  ...
  caption={"Bad example - Having to wire up Key Vault unnecessarily"}
...
<imageEmbed
  ...
  caption={"Good example - Developers don't need to know anything about Key Vault"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example -  Using Key Vault values in Azure App Service"}
