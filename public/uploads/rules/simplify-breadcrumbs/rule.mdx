...
<imageEmbed
  ...
  captionText={"Bad example - Long breadcrumb with repeated words"}
...
<imageEmbed
  ...
  captionText={"Good example - Short breadcrumb makes it simple to read"}
