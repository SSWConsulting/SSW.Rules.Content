...
<boxEmbed
  ...
  captionText={"Bad example - SSW main office address not following the standard address formatting"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - SSW main office address following the standard address formatting"}
/>