...
seoDescription: Maintain your professional integrity by using tools and techniques
  to stay organized and committed to your promises.
...
<imageEmbed
  ...
  figureText={"Good example - Create and manage reminders all from your lock screen (no typing needed)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"At your desk, use the Outlook sidebar to know what time your next meeting is"}
