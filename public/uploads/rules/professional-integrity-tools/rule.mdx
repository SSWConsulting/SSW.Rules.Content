...
<imageEmbed
  ...
  caption={"Good example - Create and manage reminders all from your lock screen (no typing needed)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"At your desk, use the Outlook sidebar to know what time your next meeting is"}
