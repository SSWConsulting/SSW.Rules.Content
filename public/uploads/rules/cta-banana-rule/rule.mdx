...
<imageEmbed
  ...
  captionText={"If the monkey can see the banana, they will do whatever it takes to get it"}
...
<imageEmbed
  ...
  captionText={"Bad example – The \"Points+Pay\" red button takes the attention over the red \"Go\" button, which should be the \"banana\""}
...
<imageEmbed
  ...
  captionText={"Good example - SSW always have a good \"banana\""}
