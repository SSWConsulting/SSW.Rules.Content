...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Triggering a group call without warning or context can be jarring and disrespectful to others' schedules and interupts everyone"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The user sends the group a message and then presses the &quot;Meet Now&quot; button which doesn't interupt the entire group"
