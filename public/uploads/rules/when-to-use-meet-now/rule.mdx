...
created: 2024-09-24 14:00:00+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Triggering a group call without warning or context can be jarring and disrespectful to others' schedules and interupts everyone"}
...
<imageEmbed
  ...
  figureText={"Good example - The user sends the group a message and then presses the \"Meet Now\" button which doesn't interupt the entire group"}
