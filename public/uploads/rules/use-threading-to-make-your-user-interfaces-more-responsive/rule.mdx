...
<imageEmbed
  ...
  caption={"Bad example - Unresponsive UI because no threading code"}
...
<imageEmbed
  ...
  caption={"Good example - Responsive UI in progress"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Responsive UI completed"}
