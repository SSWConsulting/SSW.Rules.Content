...
<imageEmbed
  ...
  figureText={"Bad example - Unresponsive UI because no threading code"}
...
<imageEmbed
  ...
  figureText={"Good example - Responsive UI in progress"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Responsive UI completed"}
