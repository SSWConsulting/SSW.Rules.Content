...
<imageEmbed
  ...
  captionText={"Bad example - Unclear labels on the buttons"}
...
<imageEmbed
  ...
  captionText={"Good example - This form uses the standard button naming standards (and has the Default buttons set!)"}
