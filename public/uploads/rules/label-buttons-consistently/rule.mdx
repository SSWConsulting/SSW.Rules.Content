...
<imageEmbed
  ...
  caption={"Bad example - Unclear labels on the buttons"}
...
<imageEmbed
  ...
  caption={"Good example - This form uses the standard button naming standards (and has the Default buttons set!)"}
