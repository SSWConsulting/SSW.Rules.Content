...
<imageEmbed
  ...
  figureText={"In Azure DevOps you can automate application deployment to a staging environment and automatically run tests before deploying to production"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"In GitHub actions you can automate application deployment to a multiple environments and automatically run tests before deploying to production"}
