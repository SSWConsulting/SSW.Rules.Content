...
created: 2014-12-01 00:36:14+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Ambiguous controls"}
...
<imageEmbed
  ...
  figureText={"Good example - Well defined controls and associated actions"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Design fails on smaller views"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Responsive design for smaller views"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - This form has left alignment and non-decimal values"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - These fields have appropriate width for the data"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - This form contains the date as that can be safely prepopulated"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - A scrolling effect added to the validation"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - This form does not contain Created by/Updated by fields"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - This form contains Created by/Updated by fields"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Delete buttons shown"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - This grid contains no delete button, requiring the user to examine the entire record via \"Edit\" before deletion"}
...
<imageEmbed
  ...
  figureText={"Exception - This grid contains delete button because all of the required information can be seen from the main form"}
