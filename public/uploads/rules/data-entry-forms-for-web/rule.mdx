...
<imageEmbed
  ...
  captionText={"Bad example - Ambiguous controls"}
...
<imageEmbed
  ...
  captionText={"Good example - Well defined controls and associated actions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Design fails on smaller views"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Responsive design for smaller views"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - This form has left alignment and non-decimal values"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - These fields have appropriate width for the data"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - This form contains the date as that can be safely prepopulated"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - A scrolling effect added to the validation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - This form does not contain Created by/Updated by fields"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - This form contains Created by/Updated by fields"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Delete buttons shown"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - This grid contains no delete button, requiring the user to examine the entire record via \"Edit\" before deletion"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Exception - This grid contains delete button because all of the required information can be seen from the main form"}
