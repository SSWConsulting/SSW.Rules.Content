...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Well defined controls and associated actions"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Design fails on smaller views"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Responsive design for smaller views"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This form has left alignment and non-decimal values"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="These fields have appropriate width for the data"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This form contains the date as that can be safely prepopulated"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A scrolling effect added to the validation"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This form does not contain Created by/Updated by fields"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This form contains Created by/Updated by fields"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure='This grid contains no delete button, requiring the user to examine the entire record via "Edit" before deletion'
