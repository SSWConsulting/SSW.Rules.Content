...
<boxEmbed
  ...
  captionText={"Highly vague warning, most people will ignore it"}
/>
...
<boxEmbed
  ...
  captionText={"More specific warning, people are more likely to take it seriously"}
/>
...
Bob: I don't know you well, and I have better things to do... approved.
  ...
  captionStyle="badExample"
  captionText={"Random pair reviews, people don't know each other well, so they won't feel accountable"}
/>
...
Bob: Sure, I want to make sure I don't let Alice down, so I'll take a closer look.
  ...
  captionStyle="goodExample"
  captionText={"Pair reviews with people who know each other well, so they feel accountable"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"AI provides a summary, with not much context. People may take it at face value"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"AI has context, and is less likely to make stuff up. People are more likely to critically evaluate the output"}
/>
