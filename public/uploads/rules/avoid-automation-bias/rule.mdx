...
youtube: [https://www.youtube.com/embed/kDS5pwelhNM?si=_nqw5XQWgpib5b8z](https://www.youtube.com/embed/kDS5pwelhNM?si=_nqw5XQWgpib5b8z)
...
<boxEmbed
  ...
  caption={"Bad example - Highly vague warning, most people will ignore it"}
/>
...
<boxEmbed
  ...
  caption={"Good example - More specific warning, people are more likely to take it seriously"}
/>
...
Bob: _"I don't know you well, and I have better things to do... approved ✅"_
  ...
  captionStyle="badExample"
  caption={"Bad example - Random pair reviews, people don't know each other well, so they won't feel accountable"}
/>
...
Bob: _"Sure, I want to make sure I don't let Alice down, so I'll take a closer look 👀"_
  ...
  captionStyle="goodExample"
  caption={"Good example - Pair reviews with people who know each other well, so they feel accountable"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - AI provides a summary, with not much context. People may take it at face value"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - AI has context, and is less likely to hallucinate. You can more easily take ownership of the work."}
/>
