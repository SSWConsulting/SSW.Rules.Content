...
created: 2024-06-02 22:45:28+00:00
...
<imageEmbed
  ...
  captionText={"Once version control has been setup you can see more clearly what changed in the report"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Enable PBIP format in Power BI Desktop"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Convert all .pbix files to PBIP format"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"The .gitignore file"}
