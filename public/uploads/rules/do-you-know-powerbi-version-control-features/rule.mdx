...
<imageEmbed
  ...
  caption={"Once version control has been setup you can see more clearly what changed in the report"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Enable PBIP format in Power BI Desktop"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Convert all .pbix files to PBIP format"}
