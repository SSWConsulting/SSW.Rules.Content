...
[DRY](/avoid-repetition) also applies to how you link between rules. Repeating a link to the same rule more than once **within the same piece of written content** creates clutter and reads like keyword stuffing. Link it once, then refer back to it by name if you mention it again.
