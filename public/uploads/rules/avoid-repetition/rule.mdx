...
<imageEmbed
  ...
  captionText={"Excessive copy-pasting? Rethink your strategy and follow DRY instead"}
...
* Is important to help you reduce stress
  ...
  captionText={"Bad example – Repeating words... Not following DRY :("}
/>
...
* Reduce stress
  ...
  captionText={"Good example – No repeated words by using the DRY principle"}
/>
...
* ❌ Can be challenging to maintain
  ...
  captionStyle="badExample"
  captionText={"Bad example – Using an excessive amount of emojis... Not following DRY :("}
/>
...
* Can be challenging to maintain
  ...
  captionStyle="goodExample"
  captionText={"Good example – Following the DRY principle"}
/>
