...
isArchived: false
lastUpdated: 2021-04-01 19:03:08.542000+00:00
...
<imageEmbed
  ...
  figureText={"Good example - Technical Debt is very visible to the Product Owner"}
...
<imageEmbed
  ...
  figureText={"Professional Developers survey"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Screenshot of code with Technical Debt comment and link to GitHub Issue"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Screenshot of Technical Debt on backlog"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"SugarLearning architecture diagram"}
