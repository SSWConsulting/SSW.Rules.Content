...
<imageEmbed
  ...
  captionText={"Good example - Technical Debt is very visible to the Product Owner"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Professional Developers survey"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Screenshot of code with Technical Debt comment and link to GitHub Issue"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Screenshot of Technical Debt on backlog"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"SugarLearning architecture diagram"}
