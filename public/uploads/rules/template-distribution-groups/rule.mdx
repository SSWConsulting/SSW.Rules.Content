---
seoDescription: Learn how to avoid email template headaches by using distribution
  groups instead of individual names, and discover the benefits of managing roles
  with ease.
type: rule
...
created: 2022-05-23 23:41:13.679000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Someone is directly addressed"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="A distribution group is used"
