...
lastUpdated: 2026-02-13T01:56:40.792Z
...
* Static-Site Generation (SSG) - HTML is generated at build time. Client is provided with static files. Beneficial to the loading speed of pages but restricts dynamic content.  
* Server-Side Rendering (SSR) -  This involves rendering a web page on a server before sending the fully rendered HTML to the client. The server will generate HTML
