...
lastUpdated: 2026-06-22T23:32:59.940Z
...
Use icons to help users understand the message faster, but do not rely on icons alone. Pair them with clear text. See the rule [Do you use icons to reinforce meaning?](https://www.ssw.com.au/rules/use-icons-to-reinforce-meaning).
...
For more information, see [Carbon Design System - Notification style](https://v10.carbondesignsystem.com/components/notification/style/).
