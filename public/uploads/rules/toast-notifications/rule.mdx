...
lastUpdated: 2026-06-22T22:48:03.348Z
...
Toasts are best for lightweight, temporary feedback. They should not be used for messages the user must read, errors that require action, or information that needs to stay visible.

| Situation                                | Toast? | Better pattern                                  |
| ---------------------------------------- | ------ | ----------------------------------------------- |
| “Copied” or “Saved” lightweight feedback | ✅ YES  | Toast/snackbar                                  |
| Message with Undo                        | ✅ YES  | Toast/snackbar, but keep it visible long enough |
...
❌ **Bad example - This should be shown inline, next to the fields that need attention** 

<boxEmbed
  body={<>
    **Note:** Only use a toast when the message is helpful but not critical. If the user needs the information to continue, use a persistent pattern such as an inline message, banner, or dialog.
  </>}
  figurePrefix="none"
  figure=""
  style="info"
