...
<imageEmbed
  ...
  caption={"Bad example – too much dead space, the characters are unevenly placed, there is an uninteresting background, it's side on and the framing is too far out"}
...
<imageEmbed
  ...
  caption={"Good example – the rule of thirds followed, mid-shot, interesting background, no dead space, fairly face on, subject placed on the right side because he's looking from right to left (leading room)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Interviewee (left) is facing toward the interviewer (right) too much and the interviewer is faced towards the camera too much"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - position your subjects properly to create an unbiased interview"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example – looking down at the subject with a wide-angle lens setting"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – level height, zoom level not set to wide-angle"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example – head not close enough to the top and hand gestures not visible"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – head close to the top and hand gestures visible"}
