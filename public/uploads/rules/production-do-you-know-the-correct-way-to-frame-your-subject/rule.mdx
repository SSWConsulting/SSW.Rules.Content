...
created: 2011-12-08 00:30:43+00:00
createdBy: Ulysses Maclaren
createdByEmail: ulyssesmaclaren@ssw.com.au
guid: 2bbd6c36-1fbd-4b51-bb93-cfc408e54c17
isArchived: false
lastUpdated: 2020-10-27 21:08:38+00:00
lastUpdatedBy: Tiago Araujo
lastUpdatedByEmail: TiagoAraujo@ssw.com.au
redirects: []
seoDescription: Discover essential framing techniques to enhance your video production
  by positioning subjects effectively and using engaging backgrounds for professional
  results.
...
<imageEmbed
  ...
  figureText={"Bad example – too much dead space, the characters are unevenly placed, there is an uninteresting background, it's side on and the framing is too far out"}
...
<imageEmbed
  ...
  figureText={"Good example – the rule of thirds followed, mid-shot, interesting background, no dead space, fairly face on, subject placed on the right side because he's looking from right to left (leading room)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Interviewee (left) is facing toward the interviewer (right) too much and the interviewer is faced towards the camera too much"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - position your subjects properly to create an unbiased interview"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – looking down at the subject with a wide-angle lens setting"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – level height, zoom level not set to wide-angle"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – head not close enough to the top and hand gestures not visible"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – head close to the top and hand gestures visible"}
