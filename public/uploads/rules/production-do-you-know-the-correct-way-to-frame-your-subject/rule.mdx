...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Too much dead space, the characters are unevenly placed, there is an uninteresting background, it's side on and the framing is too far out"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The rule of thirds followed, mid-shot, interesting background, no dead space, fairly face on, subject placed on the right side because he's looking from right to left (leading room)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Interviewee (left) is facing toward the interviewer (right) too much and the interviewer is faced towards the camera too much"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Position your subjects properly to create an unbiased interview"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Looking down at the subject with a wide-angle lens setting"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Level height, zoom level not set to wide-angle"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Head not close enough to the top and hand gestures not visible"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Head close to the top and hand gestures visible"
