...
Calling the client when you reach $110k to say you have $20k to go.
  ...
  captionText={"Bad example: Not giving the client enough warning"}
/>
...
Calling the client when you reach $80k to say you have $40k to go, and does he want to continue?
  ...
  captionText={"Good example: Giving the client a warning ahead of time and asking for permission to continue"}
/>