...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example: This banner could be 10 years old...there is no way to know.](bad-banner.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example: The people running this channel must be excited, and the audience should be too!](good-banner.png)',
  shouldDisplay: true
} } />
