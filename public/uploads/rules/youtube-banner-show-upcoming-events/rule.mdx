...
<imageEmbed
  ...
  captionText={"Bad example: This banner could be 10 years old...there is no way to know."}
...
<imageEmbed
  ...
  captionText={"Good example: The people running this channel must be excited, and the audience should be too!"}
