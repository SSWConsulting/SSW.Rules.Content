...
<imageEmbed
  ...
  figureText={"Bad example: This banner could be 10 years old...there is no way to know."}
...
<imageEmbed
  ...
  figureText={"Good example: The people running this channel must be excited, and the audience should be too!"}
