...
<imageEmbed
  ...
  captionText={"Make sure you are logged in and click on \"Site Settings\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Go to \"Content and structure\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Find the rule to be moved and click on the small arrow beside it, then click on \"Move...\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Navigate through categories and click on the place the rule should be moved to and click \"OK\""}
