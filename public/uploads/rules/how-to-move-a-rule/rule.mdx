...
<imageEmbed
  ...
  caption={"Make sure you are logged in and click on \"Site Settings\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Go to \"Content and structure\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Find the rule to be moved and click on the small arrow beside it, then click on \"Move...\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Navigate through categories and click on the place the rule should be moved to and click \"OK\""}
