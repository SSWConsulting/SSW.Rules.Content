...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Intune connected to Entra ID"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Devices managed by Intune"}
...
<imageEmbed
  ...
  caption={"Bad example - Errors in compliance check"}
...
<imageEmbed
  ...
  caption={"Good example - Compliant device"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Jamf architecture to monitor IOS devices"}
