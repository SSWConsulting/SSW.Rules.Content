...
<imageEmbed
  ...
  figureText={"Intune connected to Entra ID"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Devices managed by Intune"}
...
<imageEmbed
  ...
  figureText={"Bad example - Errors in compliance check"}
...
<imageEmbed
  ...
  figureText={"Good example - Compliant device"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Jamf architecture to monitor IOS devices"}
