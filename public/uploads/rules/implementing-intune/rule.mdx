---
seoDescription: Microsoft Intune is a mobile device management (MDM) and application
  management solution that enables organizations to control how devices are used,
  including setting policies for app access and data protection.
type: rule
...
created: 2022-05-13 05:08:59.614000
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Bad example - Errors in compliance check"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Good example - Compliant device"
