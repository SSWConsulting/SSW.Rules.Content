...
isArchived: false
lastUpdated: 2021-02-18 23:36:46+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example - Using a Textbox and Combo to enter list data"}
...
<imageEmbed
  ...
  figureText={"Good Example - Predictive-Text combo with Type Ahead"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - Predictive-Text combo with and without validation"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Best Example - Google search"}
