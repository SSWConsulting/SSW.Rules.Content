...
<imageEmbed
  ...
  caption={"Bad Example - Using a Textbox and Combo to enter list data"}
...
<imageEmbed
  ...
  caption={"Good Example - Predictive-Text combo with Type Ahead"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - Predictive-Text combo with and without validation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Best Example - Google search"}
