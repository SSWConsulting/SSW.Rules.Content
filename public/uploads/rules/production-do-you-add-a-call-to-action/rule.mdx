...
<boxEmbed
  ...
  captionText={"Bad example – No call to action"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - Too many options breeds choice paralysis"}
/>
...
<imageEmbed
  ...
  captionText={"Good example (watch on YouTube) - Very clear 'call to action' that asks for an email address. Only asks for one thing at a time and uses zooming effects. In addition, gives a Twitter option to engage and uses live-action"}
