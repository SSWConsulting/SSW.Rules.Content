...
It can also be achieved using IIS Outbound Rewrite rules. For example `https://www.ssw.com.au` could be change to `https://us.ssw.com.au` and be directed to another IIS server.