...
<imageEmbed
  ...
  figureText={"Bad example - The Product Owner is not sure who to speak to"}
...
<imageEmbed
  ...
  figureText={"Good example - The Product Owner can now see who he should speak to and developers know where to send done emails"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Assignees in GitHub"}
