...
<imageEmbed
  ...
  caption={"Bad example - The Product Owner is not sure who to speak to"}
...
<imageEmbed
  ...
  caption={"Good example - The Product Owner can now see who he should speak to and developers know where to send done emails"}
