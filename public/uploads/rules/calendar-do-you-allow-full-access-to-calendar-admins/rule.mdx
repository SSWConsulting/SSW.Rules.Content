...
seoDescription: Calendar permissions allow you to share your calendar with admin personnel
  and your entire organization, enabling them to view and edit your availability.
...
<imageEmbed
  ...
  captionText={"Click on \"Share Calendar\" in Outlook"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Give admins full access to your calendar in Outlook with \"Can edit\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Give the whole organization access to your calendar in Outlook with \"Can view all details\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Select the calendar to change permissions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Opening a shared calendar"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Find the calendar you want"}
