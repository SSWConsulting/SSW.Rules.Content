...
&gt; Where should the new command go?
  ...
  caption={"Dev has to remember folder conventions, naming, and side‑effects"}
/>
...
Chosen: **A** – one letter, instant alignment.
  ...
  caption={"Dev can easily see the differences and pick the right one"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - These questions are tough to answer"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Easy to answer with a single letter"}
