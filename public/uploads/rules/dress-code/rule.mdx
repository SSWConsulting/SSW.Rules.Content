...
<imageEmbed
  ...
  captionText={"Strong branding makes a difference"}
...
<imageEmbed
  ...
  captionText={"\"There is nothing wrong with being the best-dressed man in the room.\" - Sean Connery"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Why dress up in a flight"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"SSW Dress Code poster"}
...
\&lt;This email was sent as per [https://ssw.com.au/rules/do-you-have-a-dress-code](/do-you-have-a-dress-code)&gt;
  ...
  captionStyle="goodExample"
  captionText={"Good example - Nice \"Shorts Day\" email template by SSW.Shorts"}
/>