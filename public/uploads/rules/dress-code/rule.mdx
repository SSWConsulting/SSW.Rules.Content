...
<imageEmbed
  ...
  caption={"Strong branding makes a difference"}
...
<imageEmbed
  ...
  caption={"\"There is nothing wrong with being the best-dressed man in the room.\" - Sean Connery"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Why dress up in a flight"}
...
\&lt;This email was sent as per [https://ssw.com.au/rules/do-you-have-a-dress-code](/do-you-have-a-dress-code)&gt;
  ...
  captionStyle="goodExample"
  caption={"Good example - Nice \"Shorts Day\" email template by SSW.Shorts"}
/>