...
<imageEmbed
  ...
  figureText={"Strong branding makes a difference"}
...
<imageEmbed
  ...
  figureText={"\"There is nothing wrong with being the best-dressed man in the room.\" - Sean Connery"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Why dress up in a flight"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"SSW Dress Code poster"}
...
\&lt;This email was sent as per [https://ssw.com.au/rules/do-you-have-a-dress-code](/do-you-have-a-dress-code)&gt;
  ...
  figureText={"Good example - Nice \"Shorts Day\" email template by SSW.Shorts"}
/>