...
<imageEmbed
  ...
  figureText={"New Database Diagram"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Selecting tables for diagram"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Changing the database table diagram to Standard View and Autosize"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Show Relationship Labels"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Northwind Database Schema"}
