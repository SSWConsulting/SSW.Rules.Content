...
isArchived: false
lastUpdated: 2020-01-08 22:54:52+00:00
...
<imageEmbed
  ...
  captionText={"New Database Diagram"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Selecting tables for diagram"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Changing the database table diagram to Standard View and Autosize"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Show Relationship Labels"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Northwind Database Schema"}
