...
<boxEmbed
  ...
  caption={"Bad example - Hard to read"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - Readable but missing international format"}
/>
...
<boxEmbed
  ...
  caption={"OK example - International format and readable but brackets/dashes aren't necessary"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Nice and clean with spaces"}
/>
