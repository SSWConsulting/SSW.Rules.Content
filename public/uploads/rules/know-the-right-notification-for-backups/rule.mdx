...
<imageEmbed
  ...
  captionText={"Bad example - an email is sent on completion"}
...
<imageEmbed
  ...
  captionText={"Good example - a record is logged on completion"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Best example - the latest completion is logged in a SharePoint list"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - No critical or warnings in your backups"}
