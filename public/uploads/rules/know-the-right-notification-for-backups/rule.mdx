...
isArchived: false
lastUpdated: 2018-06-04 05:13:40+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - an email is sent on completion"}
...
<imageEmbed
  ...
  figureText={"Good example - a record is logged on completion"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Best example - the latest completion is logged in a SharePoint list"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - No critical or warnings in your backups"}
