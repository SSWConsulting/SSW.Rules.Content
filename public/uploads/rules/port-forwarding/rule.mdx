...
created: 2023-03-01T20:06:47.000Z
...
<youtubeEmbed url="https://www.youtube.com/embed/4Fvq_g8skHE" description={"Video: Simplify Remote Testing with Dev Tunnels | [Daniel Mackay](https://ssw.com.au/people/daniel-mackay/) | SSW Rules (7 min)"} />
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Enabling Dev Tunnels"}
  src="/uploads/rules/port-forwarding/screen1.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Configuring a Dev Tunnel"}
  src="/uploads/rules/port-forwarding/screen2.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Finding the Dev Tunnel URL"}
  src="/uploads/rules/port-forwarding/screen4.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Testing the Dev Tunnel on desktop"}
  src="/uploads/rules/port-forwarding/screen3.png"
/>
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"Testing the Dev Tunnel on mobile"}
  src="/uploads/rules/port-forwarding/screen5.png"
/>
