...
<imageEmbed
  ...
  figureText={"Enabling Dev Tunnels"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Configuring a Dev Tunnel"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Finding the Dev Tunnel URL"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Testing the Dev Tunnel on desktop"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="default"
  figureText={"Testing the Dev Tunnel on mobile"}
