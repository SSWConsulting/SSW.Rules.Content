...
lastUpdated: 2026-08-19T01:11:00.556Z
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="good" figure="Create a Deployment project alongside your web project." src="/uploads/rules/create-deployment-project-alongside-web-app/deployment-project.jpg" />
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="none" figure="It is important that each of the batch and parameters files has it ‘Copy to Output Directory’ setting set to ‘Copy Always’" src="/uploads/rules/create-deployment-project-alongside-web-app/deployment-project-copy.jpg" />
