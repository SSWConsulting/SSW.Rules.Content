...
<imageEmbed
  ...
  captionText={"FYI animators use storyboards to roughly outline a visual storyline before they start creating"}
...
<imageEmbed
  ...
  captionText={"Bad example – using UML makes software specifications hard to understand for clients"}
...
<imageEmbed
  ...
  captionText={"Good example – A simple storyboard makes software requirements easy to digest"}
