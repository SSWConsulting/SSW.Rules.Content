...
lastUpdated: 2026-08-18T23:33:44.345Z
lastUpdatedBy: Tiago Araujo
lastUpdatedByEmail: TiagoAraujo@ssw.com.au
---

In the Face of Armageddon - When there's a major error during deployment or a catastrophic fault happens, what is your first instinct? Is it to hit that Roll Back button?
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="none" figure="" src="https://imgs.xkcd.com/comics/fixing_problems.png" />

## From setback to comeback

To support making decisions, developers should set up robust monitoring systems. Effective monitoring ensures accurate and prompt issue identification, aiding informed decision-making. 

This is particularly important when it comes making the decision to Roll Forward.
