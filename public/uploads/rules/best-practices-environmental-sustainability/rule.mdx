...
<boxEmbed
  ...
  figureText={"Good Example - Utilizing digital reports to reduce paper consumption."}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good Example - Effective recycling setup in the office."}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good Example - LED lighting implementation for energy efficiency."}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good Example - Cloud-based solutions reducing energy consumption."}
/>
