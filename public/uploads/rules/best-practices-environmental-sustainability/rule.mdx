...
<boxEmbed
  ...
  caption={"Good Example - Utilizing digital reports to reduce paper consumption."}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good Example - Effective recycling setup in the office."}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good Example - LED lighting implementation for energy efficiency."}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good Example - Cloud-based solutions reducing energy consumption."}
/>
