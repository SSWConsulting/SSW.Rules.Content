...
lastUpdated: 2026-08-31T14:24:19.332Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="An app built in Swift can run on iOS and macOS (and Apple TV if you need it), but can't run on any other platforms" src="/uploads/rules/maui-cross-platform/tutorial-develop-apps-ios_2x.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="An app built with WinUI can run on Windows, but can't run on any other platforms" src="/uploads/rules/maui-cross-platform/winui3-addnewitem.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="An app built with .NET MAUI can run on Windows, macOS, iOS, Android, and several others" src="/uploads/rules/maui-cross-platform/single_project.png" />
...
<youtubeEmbed url="K9ryHflmQJE" description="Video: Clean Architecture in .NET MAUI and ASP.NET Core with [Matt Goldman](https://www.ssw.com.au/people/matt-goldman) (1 hr 23 min)" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Mobile frameworks all have different strong suits" src="/uploads/rules/maui-cross-platform/cross-platform-apps-pros-and-cons.png" />
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="bad" figure="Web wrappers cause you pain in the long run" src="/uploads/rules/maui-cross-platform/1200px-Ionic-logo-landscape.svg.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Great example - .NET MAUI is the best choice for .NET developers" src="/uploads/rules/maui-cross-platform/maui-sln.png" />
