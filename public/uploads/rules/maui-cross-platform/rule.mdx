...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - An app built in Swift can run on iOS and macOS (and Apple TV if you need it), but can\'t run on any other platforms](/uploads/rules/maui-cross-platform/tutorial-develop-apps-ios_2x.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - An app built with WinUI can run on Windows, but can\'t run on any other platforms](/uploads/rules/maui-cross-platform/winui3-addnewitem.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - An app built with .NET MAUI can run on Windows, macOS, iOS, Android, and several others](/uploads/rules/maui-cross-platform/single_project.png)',
  shouldDisplay: true
} } />
...
::: bad img-medium
![Bad example - Web wrappers cause you pain in the long run](/uploads/rules/maui-cross-platform/1200px-Ionic-logo-landscape.svg.png)
:::

✅ Choose a native executable framework. They let you build the best apps in the long run.

::: good img-medium
![Good example - Choosing a native executable cross-platform framework lets you build the best apps with minimal pain 👍🏻](/uploads/rules/maui-cross-platform/xplat-native.png)
:::
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Great example - .NET MAUI is the best choice for .NET developers](/uploads/rules/maui-cross-platform/maui-sln.png)',
  shouldDisplay: true
} } />
