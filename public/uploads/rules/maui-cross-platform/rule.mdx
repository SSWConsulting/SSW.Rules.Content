...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="An app built in Swift can run on iOS and macOS (and Apple TV if you need it), but can't run on any other platforms"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="An app built with WinUI can run on Windows, but can't run on any other platforms"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="An app built with .NET MAUI can run on Windows, macOS, iOS, Android, and several others"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="bad"
  figure="Web wrappers cause you pain in the long run"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="Choosing a native executable cross-platform framework lets you build the best apps with minimal pain 👍🏻"
