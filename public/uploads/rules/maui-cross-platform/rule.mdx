...
created: 2022-10-28 03:40:19.007000+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - An app built in Swift can run on iOS and macOS (and Apple TV if you need it), but can't run on any other platforms"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - An app built with WinUI can run on Windows, but can't run on any other platforms"}
...
<imageEmbed
  ...
  figureText={"Good example - An app built with .NET MAUI can run on Windows, macOS, iOS, Android, and several others"}
...
<imageEmbed
  ...
  figureText={"Mobile frameworks all have different strong suits"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="badExample"
  figureText={"Bad example - Web wrappers cause you pain in the long run"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="goodExample"
  figureText={"Good example - Choosing a native executable cross-platform framework lets you build the best apps with minimal pain 👍🏻"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Great example - .NET MAUI is the best choice for .NET developers"}
