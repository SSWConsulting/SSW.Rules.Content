...
isArchived: false
lastUpdated: 2025-02-13 00:19:14+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - An app built in Swift can run on iOS and macOS (and Apple TV if you need it), but can't run on any other platforms"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - An app built with WinUI can run on Windows, but can't run on any other platforms"}
...
<imageEmbed
  ...
  captionText={"Good example - An app built with .NET MAUI can run on Windows, macOS, iOS, Android, and several others"}
...
<imageEmbed
  ...
  captionText={"Mobile frameworks all have different strong suits"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="badExample"
  captionText={"Bad example - Web wrappers cause you pain in the long run"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Good example - Choosing a native executable cross-platform framework lets you build the best apps with minimal pain 👍🏻"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Great example - .NET MAUI is the best choice for .NET developers"}
