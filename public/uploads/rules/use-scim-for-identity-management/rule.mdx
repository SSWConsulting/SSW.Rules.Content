...
<imageEmbed
  ...
  captionText={"Bad Example - SysAdmins have to provision each user separately in 3rd party products"}
...
<imageEmbed
  ...
  captionText={"Good Example: SysAdmins only provision into Entra ID the SCIM provisioning does all the work"}
