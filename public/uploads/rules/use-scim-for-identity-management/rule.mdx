...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example - SysAdmins have to provision each user separately in 3rd party products](bad-example-no-scim.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example: SysAdmins only provision into Entra ID the SCIM provisioning does all the work](good-example-scim.jpg)',
  shouldDisplay: true
} } />
