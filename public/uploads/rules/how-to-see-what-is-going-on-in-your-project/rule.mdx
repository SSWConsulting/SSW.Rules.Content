...
<imageEmbed
  ...
  figureText={"Good example - Look on Teams for conversations, builds, and deployments"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Look back over the Sprints you missed to see what was worked on and completed"}
