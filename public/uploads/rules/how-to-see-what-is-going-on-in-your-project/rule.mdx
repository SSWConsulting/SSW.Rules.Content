...
<imageEmbed
  ...
  caption={"Good example - Look on Teams for conversations, builds, and deployments"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Look back over the Sprints you missed to see what was worked on and completed"}
