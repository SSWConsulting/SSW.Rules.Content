...
seoDescription: Prevent secrets from leaking from your code repository by utilizing
  GitHub's Secret Scanning feature for public repositories or GitHub Enterprise with
  Advanced Security.
created: 2022-07-08 03:17:54.935000+00:00
createdBy: Chloe
createdByEmail: chloelin@ssw.com.au
lastUpdated: 2026-01-30 10:11:49.548000+00:00
lastUpdatedBy: Chloe
...
Follow the steps on [GitHub - Configuring secret scanning for your repositories](https://docs.github.com/en/code-security/how-tos/secure-your-secrets/detect-secret-leaks/enabling-secret-scanning-for-your-repository).
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="GitHub found an AWS secret on this push and blocked it" src="/uploads/rules/prevent-secrets-leaking-from-repo/secret-scanning-push-protection-with-link.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Sometimes there are false positives or test data, developers aren't blocked from doing their work. They just need to go out of their way to make sure it isn't a real secret" src="/uploads/rules/prevent-secrets-leaking-from-repo/secret-scanning-unblock-form.png" />
