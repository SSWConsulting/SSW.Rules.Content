...
<imageEmbed
  ...
  captionText={"GitHub found an AWS secret on this push and blocked it"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Sometimes there are false positives or test data, developers aren't blocked from doing their work. They just need to go out of their way to make sure it isn't a real secret"}
