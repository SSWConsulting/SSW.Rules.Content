...
- data-do-you-avoid-deleting-records-by-flagging-them-as-isdeleted-(aka-soft-delete)
seoDescription: Avoid deleting records by flagging them as IsDeleted (aka Soft Delete)
  and instead keep historical data intact.
title: Data - Do you avoid deleting records by flagging them as IsDeleted (aka Soft
  Delete)?
type: rule
