...
seoDescription: How to give customers a ballpark estimate of project costs using Scrum
  and Excel.
...
Open the [Estimates Calculator](/uploads/rules/spec-give-customers-a-ballpark/estimates-calculator.xlsx) and do the following:
...
<imageEmbed
  ...
  captionText={"Set the types and numbers of resources who will be working on the project"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Enter your PBIs and estimates"}
