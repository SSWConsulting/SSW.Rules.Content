...
<boxEmbed
  ...
  caption={"Bad example - The client doesn't know whether it's AUD or USD"}
/>
...
<boxEmbed
  ...
  caption={"Good example - AUD makes it more clear"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - The client will need to convert it"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - AUD gives a clear understanding of the costs"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - USD gives a clear understanding of the costs"}
/>