...
<boxEmbed
  ...
  captionText={"Bad example - The client doesn't know whether it's AUD or USD"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - AUD makes it more clear"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - The client will need to convert it"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - AUD gives a clear understanding of the costs"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - USD gives a clear understanding of the costs"}
/>