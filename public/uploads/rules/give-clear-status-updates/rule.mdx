...
Dave
  ...
  figurePrefix="bad"
  figure="The reply unnecessarily repeats the client’s full message and adds noise."
/>
...
Dave
  ...
  figurePrefix="good"
  figure="Only the essential context and a clear, concise action item"
/>