...
archivedreason:
authors: []
created: 2015-02-13 02:37:11+00:00
createdBy: Rebecca Liu
createdByEmail: RebeccaLiu@ssw.com.au
guid: 43fdc349-09dc-421f-b703-1dc27e78bfa9
isArchived: false
lastUpdated: 2015-11-17 03:51:27+00:00
lastUpdatedBy: Farrukh Khan
lastUpdatedByEmail: FarrukhKhan@ssw.com.au
redirects: []
seoDescription: Discover insights into competitor website critiques focusing on user
  experience, design, and functionality to help improve your digital presence.
...
Some thoughts on a couple of product sites critiqued against your criteria. The following are the first 3 things to look on a product site:
...
See example of a way to report your findings:

<boxEmbed
  style="todo"
  body={<>
    TODO: These examples are dated. They should be updated with current websites.
  </>}
  figurePrefix="none"
  figure="Figure Text"
/>

[Total Access Analyzer](https://www.componentsource.com/product/fms-total-access-analyzer)
...
[SQL Compare](https://www.componentsource.com/product/red-gate-sql-compare-standard)
...
[Rich Text Box](https://help.loftware.com/cloud/en/Designer/Label/Label-Objects/Rich-Text-Box.html)
...
[SSW Code Auditor](https://codeauditor.com)
