...
<imageEmbed
  ...
  caption={"Bad example - No icons to indicate the status"}
...
<imageEmbed
  ...
  caption={"Good example - Green tick and red cross help the user to know what's going on"}
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - No emojis to enforce the meaning"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - The emoji gives extra focus on what is important"}
/>
