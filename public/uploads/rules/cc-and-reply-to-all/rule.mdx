...
<imageEmbed
  ...
  captionText={"Good example - 'Reply All' so that everyone is kept in the loop"}
...
<imageEmbed
  ...
  captionText={"Bad example - 'Little r' should be rarely clicked"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Adding back those incorrectly dropped from the loop"}
