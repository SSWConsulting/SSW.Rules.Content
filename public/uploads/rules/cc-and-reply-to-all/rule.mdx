...
created: 2009-03-26 02:42:00+00:00
...
<imageEmbed
  ...
  figureText={"Good example - 'Reply All' so that everyone is kept in the loop"}
...
<imageEmbed
  ...
  figureText={"Bad example - 'Little r' should be rarely clicked"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Adding back those incorrectly dropped from the loop"}
