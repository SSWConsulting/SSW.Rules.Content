...
<imageEmbed
  ...
  caption={"Bad example - Ask the individual for the tax invoice of a flight"}
...
<imageEmbed
  ...
  caption={"Good example - Retrieve the invoice from Qantas Business Reward in 30 seconds"}
