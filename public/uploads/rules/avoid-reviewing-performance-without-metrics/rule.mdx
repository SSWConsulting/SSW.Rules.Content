...
<imageEmbed
  ...
  captionText={"Good example – Use metrics to check the timing, before fixing any performance issues (An example from SSW CodeAuditor)"}
...
<imageEmbed
  ...
  captionText={"Bad example - Going from 1 to 4 all at once gives you incomplete measurements and data"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Going from 1 to 2, then measuring, then incrementally adding one more, measuring..."}
...
<imageEmbed
  ...
  captionText={"Google Chrome has a handy Performance tab in the DevTools"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Pingdom has advanced tools for diagnosing page performance issue"}
