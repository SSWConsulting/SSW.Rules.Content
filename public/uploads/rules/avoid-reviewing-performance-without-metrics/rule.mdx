...
isArchived: false
lastUpdated: 2025-11-06 05:46:47+00:00
...
<imageEmbed
  ...
  caption={"Good example – Use metrics to check the timing, before fixing any performance issues (An example from SSW CodeAuditor)"}
...
<imageEmbed
  ...
  caption={"Bad example - Going from 1 to 4 all at once gives you incomplete measurements and data"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Going from 1 to 2, then measuring, then incrementally adding one more, measuring..."}
...
<imageEmbed
  ...
  caption={"Google Chrome has a handy Performance tab in the DevTools"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Pingdom has advanced tools for diagnosing page performance issue"}
