...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Use metrics to check the timing, before fixing any performance issues (An example from SSW CodeAuditor)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Going from 1 to 4 all at once gives you incomplete measurements and data"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Going from 1 to 2, then measuring, then incrementally adding one more, measuring..."
