...
<imageEmbed
  ...
  caption={"Bad example - LinkedIn profile is not connected to a Microsoft account"}
...
<imageEmbed
  ...
  caption={"Good example - LinkedIn profile is connected to a Microsoft account"}
...
<imageEmbed
  ...
  caption={"Click the blue LinkedIn logo"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Microsoft account connected"}
