...
<imageEmbed
  ...
  captionText={"Bad example - LinkedIn profile is not connected to a Microsoft account"}
...
<imageEmbed
  ...
  captionText={"Good example - LinkedIn profile is connected to a Microsoft account"}
...
<imageEmbed
  ...
  captionText={"Click the blue LinkedIn logo"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Sign in to LinkedIn"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Microsoft account connected"}
