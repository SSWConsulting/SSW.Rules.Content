...
<imageEmbed
  ...
  caption={"Good Example - An interface describes the methods available on the provider"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - The Product Repository is injected into the ProductService class (via constructor injection)"}
