...
isArchived: false
lastUpdated: 2023-08-14 01:16:50+00:00
...
<imageEmbed
  ...
  captionText={"Good Example - An interface describes the methods available on the provider"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - The Product Repository is injected into the ProductService class (via constructor injection)"}
