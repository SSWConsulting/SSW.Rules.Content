...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="An interface describes the methods available on the provider"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The Product Repository is injected into the ProductService class (via constructor injection)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The code is loosely coupled. The ProductService is dependent on an interface of the Product Repository, which is injected into the ProductService via its constructor. The unit test can easily create a mock object of the Product Repository and substitute it for the dependency. NSubstitute is one of the most popular mocking libraries."
