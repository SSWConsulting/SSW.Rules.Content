...
<imageEmbed
  ...
  figureText={"Initial Meeting created in Outlook and tracked to Dynamics 365 with correct regarding"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Initial meetings report"}
