...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Initial Meeting created in Outlook and tracked to Dynamics 365 with correct regarding"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Time to win report"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Initial meetings report"}
