...
<boxEmbed
  style="greybox"
  body={<>
    **Subject:** <mark style="background-color: #FEF08A">Initial</mark> phone <mark style="background-color: #FEF08A">meeting</mark> with Adam from SSW and Bob from Northwind
  </>}
  figurePrefix="none"
  figure=""
/>
