...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Initial Meeting created in Outlook and tracked to Dynamics 365 with correct regarding"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Initial meetings report"}
