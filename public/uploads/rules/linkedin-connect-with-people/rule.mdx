...
<imageEmbed
  ...
  caption={"Good example - Use \"Personalize invite\" instead of \"Connect\" or \"Follow\""}
...
It was cool to chat. Let's chat more some time!
  ...
  caption={"Bad example - You won't recall how you met this person and have no clue who they are!"}
/>
...
What benefits do you think Angular might have over Vue?
  ...
  captionStyle="goodExample"
  caption={"Good example - You can recall how you met this person, and what they're interested in!"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - The red part will be useful to remember the person, the rest is to create a soft engagement"}
