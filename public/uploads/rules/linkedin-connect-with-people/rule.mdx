...
created: 2024-06-03 06:39:41+00:00
...
<imageEmbed
  ...
  captionText={"Good example - Use \"Personalize invite\" instead of \"Connect\" or \"Follow\""}
...
It was cool to chat. Let's chat more some time!
  ...
  captionText={"Bad example - You won't recall how you met this person and have no clue who they are!"}
/>
...
What benefits do you think Angular might have over Vue?
  ...
  captionStyle="goodExample"
  captionText={"Good example - You can recall how you met this person, and what they're interested in!"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - The red part will be useful to remember the person, the rest is to create a soft engagement"}
