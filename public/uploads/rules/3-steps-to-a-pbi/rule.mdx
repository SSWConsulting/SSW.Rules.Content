...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"\"Testing Task\" added to a PBI. This is the board the team will use for 90% of the Sprint so that testing is visible to everyone"}
...
<imageEmbed
  ...
  captionText={"The important steps in a PBI lifecycle."}
