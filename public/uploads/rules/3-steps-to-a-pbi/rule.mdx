...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"\"Testing Task\" added to a PBI. This is the board the team will use for 90% of the Sprint so that testing is visible to everyone"}
...
<imageEmbed
  ...
  caption={"The important steps in a PBI lifecycle."}
