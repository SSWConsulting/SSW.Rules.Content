...
created: 2023-06-20 14:47:31+00:00
...
<imageEmbed
  ...
  captionText={"Good example - Error Provider Icon with the required field"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Balloon tooltip indicates the validation error"}
