---
type: rule
title: Payroll - Do you take advantages of salary sacrificing electronic devices? (Aussie only)
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Without Salary Sacrificing vs Salary Sacrificing" src="/uploads/rules/salary-sacrificing/salary-sacrafice-rules-graphic-v2-1.png" />
