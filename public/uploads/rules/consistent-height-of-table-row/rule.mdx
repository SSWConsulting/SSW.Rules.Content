...
<imageEmbed
  ...
  captionText={"Bad example - Bad Height"}
...
<imageEmbed
  ...
  captionText={"Good example - Good Height"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Bad Height In Design View"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Good Height In Design View"}
