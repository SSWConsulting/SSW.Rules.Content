...
<imageEmbed
  ...
  caption={"Bad example - Bad Height"}
...
<imageEmbed
  ...
  caption={"Good example - Good Height"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Bad Height In Design View"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Good Height In Design View"}
