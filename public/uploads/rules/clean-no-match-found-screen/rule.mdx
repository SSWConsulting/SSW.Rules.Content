...
isArchived: false
lastUpdated: 2015-08-25 22:00:38+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - The list of \"suggestions\" is just noise and can confuse the user"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Having an icon implies that an error happened which is not the case"}
...
<imageEmbed
  ...
  figureText={"Good example - Plain and clean screen"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Plain and clean screen on mobile"}
