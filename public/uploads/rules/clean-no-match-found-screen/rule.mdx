...
<imageEmbed
  ...
  caption={"Bad example - The list of \"suggestions\" is just noise and can confuse the user"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Having an icon implies that an error happened which is not the case"}
...
<imageEmbed
  ...
  caption={"Good example - Plain and clean screen"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Plain and clean screen on mobile"}
