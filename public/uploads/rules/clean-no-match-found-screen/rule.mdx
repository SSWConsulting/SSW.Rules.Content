...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure='The list of "suggestions" is just noise and can confuse the user'
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Having an icon implies that an error happened which is not the case"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Plain and clean screen on mobile"
