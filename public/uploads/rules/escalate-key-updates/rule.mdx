...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Automated notifications from project management tools can be easily missed or overlooked amidst other notifications"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="For visibility and to ensure all stakeholders are in the loop, you should also send an email to the relevant people"
