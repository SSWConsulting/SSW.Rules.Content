...
created: 2023-06-20 23:53:39+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Automated notifications from project management tools can be easily missed or overlooked amidst other notifications"}
...
<imageEmbed
  ...
  figureText={"Good example - For visibility and to ensure all stakeholders are in the loop, you should also send an email to the relevant people"}
