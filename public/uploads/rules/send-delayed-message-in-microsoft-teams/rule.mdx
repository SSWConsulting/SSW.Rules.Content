...
<imageEmbed
  ...
  caption={"Bad example - Sending Teams message outside of Sue's working hours"}
...
<imageEmbed
  ...
  caption={"How to send a delayed message in Microsoft Teams"}
...
<imageEmbed
  ...
  caption={"Good example - Sending a delayed message to Sue that is to be received at 9 am UK Timezone"}
