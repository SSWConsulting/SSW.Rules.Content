...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "badExample",
    figure: "Bad example - Sending Teams message outside of Sue's working hours",
    shouldDisplay: true
  } }
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - Sending a delayed message to Sue that is to be received at 9 am UK Timezone",
    shouldDisplay: true
  } }
