...
isArchived: false
lastUpdated: 2020-03-20 02:04:36+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example - NUnit In Visual Studio"}
...
<imageEmbed
  ...
  figureText={"Better way - Use TestDriven.Net - it has a 'Run Test(s)' command for a single test (above) or..."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"...you can right-click on a project and select 'Test With > NUnit' to bring up the GUI. It is certainly more convenient"}
