...
created: 2024-08-02 14:52:33+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Avoid using expressions for calculated values"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Avoid using external assemblies for calculated values - it adds an unnecessary level of complexity"}
...
<imageEmbed
  ...
  figureText={"Good example - Use a denormalised database field for calculated values"}
