...
seoDescription: Optimize report calculations by using denormalized database fields
  for calculated values to enhance performance and streamline your data access.
...
<imageEmbed
  ...
  captionText={"Bad example - Avoid using expressions for calculated values"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Avoid using external assemblies for calculated values - it adds an unnecessary level of complexity"}
...
<imageEmbed
  ...
  captionText={"Good example - Use a denormalised database field for calculated values"}
