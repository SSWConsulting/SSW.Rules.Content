...
<imageEmbed
  ...
  caption={"Bad example - Avoid using expressions for calculated values"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Avoid using external assemblies for calculated values - it adds an unnecessary level of complexity"}
...
<imageEmbed
  ...
  caption={"Good example - Use a denormalised database field for calculated values"}
