...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Logic and properties are in the code behind, which decreases maintainability and testability"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Values are bound to properties of the ViewModel, and actions are bound to Commands in the ViewModel"
