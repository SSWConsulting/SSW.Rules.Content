...
<boxEmbed
 ...
 timepro-devs
  ...
  caption={"Bad Example – With no consistency, it is difficult to know the correct name for an AD group"}
/>
...
<boxEmbed
 ...
 SEC_SSWTimeProDevs
  ...
  caption={"Good Example – By standardizing the names of AD groups it saves confusion"}
/>
