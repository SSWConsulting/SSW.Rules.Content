...
<imageEmbed
  ...
  captionText={"Good Example - You want to use your tools safely!"}
...
<imageEmbed
  ...
  captionText={"Toggle Your Name | Settings | Data controls | Improve the model for everyone to stop the model training on your data"}
