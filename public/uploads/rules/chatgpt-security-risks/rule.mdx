...
<imageEmbed
  ...
  figureText={"Good Example - You want to use your tools safely!"}
...
<imageEmbed
  ...
  figureText={"Toggle Your Name | Settings | Data controls | Improve the model for everyone to stop the model training on your data"}
