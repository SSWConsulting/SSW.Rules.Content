...
<imageEmbed
  ...
  caption={"Good Example - You want to use your tools safely!"}
...
<imageEmbed
  ...
  caption={"Toggle Your Name | Settings | Data controls | Improve the model for everyone to stop the model training on your data"}
