...
isArchived: false
lastUpdated: 2020-12-09 18:38:50+00:00
...
<imageEmbed
  ...
  captionText={"Internet Explorer has the Integrated Authentication feature built in"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"We want to avoid authenticating using Firefox (so it works like IE)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Showed how to find \"network.automatic-ntlm-auth.trusted-uris\" by using filter: \"network.automatic\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"To test you will need to clear your \"Authenticated Sessions\" to completely logout from a site (SharePoint, CRM)"}
