...
<imageEmbed
  ...
  figureText={"Internet Explorer has the Integrated Authentication feature built in"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"We want to avoid authenticating using Firefox (so it works like IE)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Showed how to find \"network.automatic-ntlm-auth.trusted-uris\" by using filter: \"network.automatic\""}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"To test you will need to clear your \"Authenticated Sessions\" to completely logout from a site (SharePoint, CRM)"}
