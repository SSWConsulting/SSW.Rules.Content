...
<boxEmbed
  ...
  captionText={"Bad example - You never want them to say no to you. See the [YES ladder](/build-a-yes-ladder-to-your-outbound-script) for more details"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - a warm call"}
/>