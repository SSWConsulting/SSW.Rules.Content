...
lastUpdated: 2026-02-10T06:27:47.311Z
...
| -------- | --------------------------------------------------- | -------------------------------------- |
| Personal | `~/.claude/skills/` or `~/.config/opencode/skills/` | Only yourself and your projects        |
| Project  | `.claude/skills/` in the repository                 | Everyone with access to the repository |
