...
lastUpdated: 2026-02-10T06:22:18.783Z
...
To invoke this skill, type `/review` or `/project:review` {{ TODO: CHECK THE SYNTAX ON THIS }} in Claude Code, `@review` in GitHub Copilot, or simply ask a question that matches the skill's description and the agent will load it automatically.
