...
<imageEmbed
  ...
  captionText={"Bad example - Channel ID is too obstructive and has unusual placement"}
...
<imageEmbed
  ...
  captionText={"Good example - DOG placed in lower right corner where it's not obtrusive"}
