...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example – Calling `SaveChangesAsync()` inside a loop causes multiple database hits",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example – Using `AddRangeAsync()` minimizes database calls and improves performance",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example – Each iteration performs a separate database query, leading to N queries",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example – Fetches all required records in one query, reducing database load",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "okExample",
  figure: "Figure: OK example – Processes data in batches to balance efficiency and memory usage",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example – Unnecessary tracking increases memory usage",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example – `AsNoTracking()` prevents EF Core from tracking entities, reducing memory usage",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example – Calling `SaveChangesAsync()` in a loop causes multiple transactions, slowing down performance",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example – Updates all entities in memory first, then commits changes in a single transaction",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example – Each `SaveChangesAsync()` call inside the loop creates a separate transaction, leading to unnecessary database overhead",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example – Using an explicit transaction ensures all entities are added in a **single** transaction, reducing overhead and improving reliability",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example – Transactions combined with batching allow **efficient processing of large datasets** while keeping database transactions minimal",
  shouldDisplay: true
} } />
