...
created: 2023-11-26 23:10:50.651000+00:00
...
**Note:** If you're on GPT Plus, you can use this custom GPT: [Tree of Thought Problem Solver](https://chatgpt.com/g/g-CIFNL94KS-tree-of-thoughts-problem-solver).
...
<boxEmbed
  style="greybox"
  body={<>
    "Should our team adopt a monorepo or split into multiple repositories?"
  </>}
  figurePrefix="none"
  figure=""
/>
...
<boxEmbed
  style="greybox"
  body={<>
    "Imagine 3 different experts are answering this question: "Should our team adopt a monorepo or split into multiple repositories?"

Consider our context: 6 developers, 4 related services that share types, and frequent cross-service changes.

All experts will write down 1 step of their thinking, then share it with the group. Then all experts will go on to the next step, etc. If any expert realizes they're wrong at any point, then they leave.

Continue this process, until you have a definitive recommendation"
  </>}
  figurePrefix="none"
  figure=""
/>
