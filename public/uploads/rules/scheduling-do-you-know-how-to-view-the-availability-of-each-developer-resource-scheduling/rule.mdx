...
<imageEmbed
  ...
  figureText={"Bad example - Constantly yelling out \"who's free?\""}
...
<imageEmbed
  ...
  figureText={"The Service Calendar in CRM is showing that Drew is available but Mehmet is busy next week"}
