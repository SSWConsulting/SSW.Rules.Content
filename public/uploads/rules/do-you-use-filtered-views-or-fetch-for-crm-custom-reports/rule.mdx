...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Filtered Views in the CRM SQL Database"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Report created using CRM Wizard"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Report updated in Visual Studio"}
  src="/uploads/rules/do-you-use-filtered-views-or-fetch-for-crm-custom-reports/custom-reports-3.jpg"
/>
