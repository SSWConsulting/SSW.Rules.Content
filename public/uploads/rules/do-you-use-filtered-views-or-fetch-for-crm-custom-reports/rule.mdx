...
isArchived: false
lastUpdated: 2021-03-16 23:22:28.654000+00:00
...
<imageEmbed
  ...
  captionText={"The starting point"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Filtered Views in the CRM SQL Database"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Report created using CRM Wizard"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Report updated in Visual Studio"}
  src="/uploads/rules/do-you-use-filtered-views-or-fetch-for-crm-custom-reports/custom-reports-3.jpg"
/>
