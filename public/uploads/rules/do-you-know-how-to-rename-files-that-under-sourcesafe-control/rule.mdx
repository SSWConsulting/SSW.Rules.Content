...
<imageEmbed
  ...
  caption={"Warning message of renaming files under source control."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"You are seeing this as the new file name already exists in SourceSafe, just click \"Continue with change\"."}
