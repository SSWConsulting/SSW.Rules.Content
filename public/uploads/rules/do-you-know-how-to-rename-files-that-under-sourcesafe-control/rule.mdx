...
<imageEmbed
  ...
  figureText={"Warning message of renaming files under source control."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"You are seeing this as the new file name already exists in SourceSafe, just click \"Continue with change\"."}
