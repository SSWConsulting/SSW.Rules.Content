...
<imageEmbed
  ...
  figureText={"Only if it's life and death does it get added \"in this Sprint\""}
...
3. Please use the text Ascending instead of "smallest to Largest" and Descending for "Largest to Smallest"
  ...
  figurePreset="defaultExample"
  figureText={"The above email sample from a customer will, by default, go into a future Sprint, not the current"}
/>