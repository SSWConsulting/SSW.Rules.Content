...
seoDescription: Microsoft-recommended frameworks for automated UI-driven functional
  testing enable efficient and reliable execution of complex user interactions with
  web applications.
title: Do you know the most popular automated UI testing frameworks (aka functional
  testing)?
categories:
