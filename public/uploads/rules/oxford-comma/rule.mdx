...
created: 2022-09-29 00:15:57+00:00
...
<imageEmbed
  ...
  captionText={"Some people love Oxford commas, some hate them"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"A sentence with quite different meaning depending on whether an Oxford comma is used or not"}
...
<boxEmbed
  ...
  captionText={"Bad example - the extra comma after \"Matt\" is unnecessary and just adds clutter"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - without the Oxford comma, it's not clear whether the flavour is strawberry and mango or mango and blueberry"}
/>
