...
created: 2020-03-20 01:05:11+00:00
createdBy: Christian Morford-Waite
createdByEmail: ChristianMWaite@ssw.com.au
guid: a4615006-2250-4e3f-badf-b9822dfec450
isArchived: false
lastUpdated: 2020-03-20 04:40:30+00:00
lastUpdatedBy: Christian Morford-Waite
lastUpdatedByEmail: ChristianMWaite@ssw.com.au
redirects:
- views-do-you-use-sql-views
seoDescription: Do you use SQL Views? Discover how SQL views simplify access to database
  result sets, provide more security options, and reduce data duplication. Learn how
  to create and modify views for improved database management.
...
<imageEmbed
  ...
  figureText={"Northwind traders employees table"}
...
<imageEmbed
  ...
  figureText={"Bad example – Using tables and duplicating data"}
