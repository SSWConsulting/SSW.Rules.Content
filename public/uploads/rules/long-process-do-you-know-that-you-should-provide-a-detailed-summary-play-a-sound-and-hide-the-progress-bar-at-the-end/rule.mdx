...
<boxEmbed
  ...
  captionText={"Bad example – No detailed information"}
/>
...
Time Taken: 15 seconds
  ...
  captionText={"OK Example - A completed progress form"}
/>
...
Time Taken: 10 minutes, 15 seconds
  ...
  captionStyle="goodExample"
  captionText={"Good example – The user can see what has been processed"}
/>