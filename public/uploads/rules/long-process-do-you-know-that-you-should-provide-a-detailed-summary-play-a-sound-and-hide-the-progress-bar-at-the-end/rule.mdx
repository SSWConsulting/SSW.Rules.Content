...
<boxEmbed
  ...
  figureText={"Bad example – No detailed information"}
/>
...
Time Taken: 15 seconds
  ...
  figureText={"OK Example - A completed progress form"}
/>
...
Time Taken: 10 minutes, 15 seconds
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example – The user can see what has been processed"}
/>