...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="There is no way to see version history of a report in Power BI Service"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Even the report settings do not show its version history"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Option 1: Publish reports directly to Power BI Service; however it does not record the history of changes"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Option 2: PBIP method - the PBIP format allows comparing changes made to reports by decomposing it into multiple text files"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="PBIP format allows recording history of changes without saving data into version control"
