...
<imageEmbed
  ...
  figureText={"Bad example - There is no way to see version history of a report in Power BI Service"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Even the report settings do not show its version history"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Option 1: Publish reports directly to Power BI Service; however it does not record the history of changes"}
...
<imageEmbed
  ...
  figureText={"Good example - Option 2: PBIP method - the PBIP format allows comparing changes made to reports by decomposing it into multiple text files"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - PBIP format allows recording history of changes without saving data into version control"}
...
<imageEmbed
  ...
  figureText={"How to sync changes into a workspace in Power BI Service, effectively deploying reports"}
