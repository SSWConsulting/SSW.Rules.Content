...
<imageEmbed
  ...
  captionText={"Bad example - There is no way to see version history of a report in Power BI Service"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Even the report settings do not show its version history"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Option 1: Publish reports directly to Power BI Service; however it does not record the history of changes"}
...
<imageEmbed
  ...
  captionText={"Good example - Option 2: PBIP method - the PBIP format allows comparing changes made to reports by decomposing it into multiple text files"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - PBIP format allows recording history of changes without saving data into version control"}
...
<imageEmbed
  ...
  captionText={"How to sync changes into a workspace in Power BI Service, effectively deploying reports"}
