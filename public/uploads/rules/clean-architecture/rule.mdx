...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="The application directly relies on the infrastructure. This makes the system harder to test and less flexible"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Use the Repository Pattern. This keeps things decoupled and easier to maintain"
/>
