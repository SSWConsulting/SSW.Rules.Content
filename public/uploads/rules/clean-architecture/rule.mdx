...
<imageEmbed
  ...
  caption={"Onion view of Clean Architecture"}
...
<boxEmbed
  ...
  caption={"Bad example - The application directly relies on the infrastructure. This makes the system harder to test and less flexible"}
/>
...
<boxEmbed
  ...
  caption={"Good example - Use the Repository Pattern. This keeps things decoupled and easier to maintain"}
/>
