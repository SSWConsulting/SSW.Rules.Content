...
<imageEmbed
  ...
  captionText={"Bad example - Default Chart - at least half of requests are irrelevant or spam"}
...
<imageEmbed
  ...
  captionText={"Good example - Custom Chart - most of these are real issues"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Split Chart - the fixable 500 responses can be seen in purple"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Default Table - 5 out of top 8 failed requests are irrelevant or spam"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Custom Table - all the top failed requests are real issues"}
