...
created: 2023-09-22 06:44:51+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Default Chart - at least half of requests are irrelevant or spam"}
...
<imageEmbed
  ...
  figureText={"Good example - Custom Chart - most of these are real issues"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Split Chart - the fixable 500 responses can be seen in purple"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Default Table - 5 out of top 8 failed requests are irrelevant or spam"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Custom Table - all the top failed requests are real issues"}
