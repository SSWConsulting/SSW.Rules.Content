...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Default Chart - at least half of requests are irrelevant or spam"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Custom Chart - most of these are real issues"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Split Chart - the fixable 500 responses can be seen in purple"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Default Table - 5 out of top 8 failed requests are irrelevant or spam"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Custom Table - all the top failed requests are real issues"
