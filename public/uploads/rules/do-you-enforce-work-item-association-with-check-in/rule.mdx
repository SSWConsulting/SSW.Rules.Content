...
<imageEmbed
  ...
  caption={"Bad Example: No work item is associated with changeset"}
...
<imageEmbed
  ...
  caption={"Good Example: No work item is associated with changeset"}
...
<imageEmbed
  ...
  caption={"Associate Work Item with Changeset"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Always enable the “Work Items check-in policy”"}
