...
<imageEmbed
  ...
  captionText={"Bad Example: No work item is associated with changeset"}
...
<imageEmbed
  ...
  captionText={"Good Example: No work item is associated with changeset"}
...
<imageEmbed
  ...
  captionText={"Associate Work Item with Changeset"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Always enable the “Work Items check-in policy”"}
