...
<imageEmbed
  ...
  figureText={"Bad Example: No work item is associated with changeset"}
...
<imageEmbed
  ...
  figureText={"Good Example: No work item is associated with changeset"}
...
<imageEmbed
  ...
  figureText={"Associate Work Item with Changeset"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Always enable the “Work Items check-in policy”"}
