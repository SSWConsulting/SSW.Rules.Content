...
<imageEmbed
  ...
  caption={"Bad example - By default you cannot open your files when you have no internet"}
...
<imageEmbed
  ...
  caption={"So check \"Always keep on this device\""}
...
<imageEmbed
  ...
  caption={"Good example – you can now open offline"}
