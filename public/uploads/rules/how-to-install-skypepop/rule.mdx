...
<imageEmbed
  ...
  caption={"Example contact popup on our CRM from incoming caller with the number +61420241201"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"This email will be created – send it to the person you are forwarding the call to"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Right click on the SkypePOP icon in the taskbar"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Copy the Endpoint Address for your Organization Service"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Enter your CRM Connection Details"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Right-click on the icon in the taskbar and select 'Preferences'"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"These are the default SkypePOP settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"These are the default Skype for Business settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Check that you are properly connected - blue is success"}
