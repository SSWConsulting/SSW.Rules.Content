...
<imageEmbed
  ...
  caption={"Bad example - Control sizes are not consistent"}
...
<imageEmbed
  ...
  caption={"Good example - Control sizes are all standard and consistent"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Non-standard size for Add & Delete buttons"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Standard size for Add & Delete buttons"}
