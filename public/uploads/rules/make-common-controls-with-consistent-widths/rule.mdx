...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Control sizes are not consistent"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Control sizes are all standard and consistent"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Non-standard size for Add & Delete buttons"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Standard size for Add & Delete buttons"
  src="/uploads/rules/make-common-controls-with-consistent-widths/adddeletegood.gif"
/>


We have a program called [SSW Code Auditor](https://www.ssw.com.au/ssw/CodeAuditor/Rules.aspx#CommonControl) to check for the following two rules:
