...
<imageEmbed
  ...
  figureText={"Bad example - Control sizes are not consistent"}
...
<imageEmbed
  ...
  figureText={"Good example - Control sizes are all standard and consistent"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Non-standard size for Add & Delete buttons"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Standard size for Add & Delete buttons"}
