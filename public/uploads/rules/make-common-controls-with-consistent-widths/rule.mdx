...
<imageEmbed
  ...
  captionText={"Bad example - Control sizes are not consistent"}
...
<imageEmbed
  ...
  captionText={"Good example - Control sizes are all standard and consistent"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Non-standard size for Add & Delete buttons"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Standard size for Add & Delete buttons"}
