...
<imageEmbed
  ...
  captionText={"Bad example - This graphic is line art, but has mistakenly been saved as a JPEG. It loses resolution"}
...
<imageEmbed
  ...
  captionText={"Good example - The same graphic saved as an SVG, no pixelation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example – Low quality JPG (18k)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example – Uncompressed JPG (100k)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – Compressed JPG (28k)"}
