...
isArchived: false
lastUpdated: 2025-10-10 17:27:56+00:00
...
<imageEmbed
  ...
  caption={"Bad example - This graphic is line art, but has mistakenly been saved as a JPEG. It loses resolution"}
...
<imageEmbed
  ...
  caption={"Good example - The same graphic saved as an SVG, no pixelation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example – Low quality JPG (18k)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example – Uncompressed JPG (100k)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Compressed JPG (28k)"}
