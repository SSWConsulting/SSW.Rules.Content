...
created: 2015-10-13 00:22:31+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - This graphic is line art, but has mistakenly been saved as a JPEG. It loses resolution"}
...
<imageEmbed
  ...
  figureText={"Good example - The same graphic saved as an SVG, no pixelation"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – Low quality JPG (18k)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example – Uncompressed JPG (100k)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – Compressed JPG (28k)"}
