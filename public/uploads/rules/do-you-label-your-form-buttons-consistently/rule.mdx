...
isArchived: false
lastUpdated: 2014-12-01 01:56:22+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example - Unclear labels on the buttons"}
...
<imageEmbed
  ...
  figureText={"Good Example - This form uses the standard button naming standards (and has the Default buttons set!)"}
