...
<imageEmbed
  ...
  caption={"Yellow screen of death"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"An incorrect sum is likely to be a bug"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Adding a bug to the Product Backlog in Azure DevOps"}
