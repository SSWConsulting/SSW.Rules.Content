...
<imageEmbed
  ...
  figureText={"Yellow screen of death"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"An incorrect sum is likely to be a bug"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Adding a bug to the Product Backlog in Azure DevOps"}
