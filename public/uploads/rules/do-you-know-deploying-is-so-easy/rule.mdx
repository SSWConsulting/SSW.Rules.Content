...
<imageEmbed
  ...
  captionText={"Using EF Migrations within your pipeline to apply these changes automatically"}
...
<imageEmbed
  ...
  captionText={"For a web app it is just one click"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"For a Windows clients it is also just one click"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"For the Database it is... well one click is what you need to aim for"}
