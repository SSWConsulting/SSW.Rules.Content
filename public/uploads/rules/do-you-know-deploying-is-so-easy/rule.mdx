...
<imageEmbed
  ...
  figureText={"Using EF Migrations within your pipeline to apply these changes automatically"}
...
<imageEmbed
  ...
  figureText={"For a web app it is just one click"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"For a Windows clients it is also just one click"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"For the Database it is... well one click is what you need to aim for"}
