---
seoDescription: Remove orphaned users from SharePoint and prevent permissions issues
  with ShareGate's easy-to-use solution.
type: rule
...
created: 2021-09-06 23:16:37.291000+00:00
