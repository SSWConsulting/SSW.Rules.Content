...
<imageEmbed
  ...
  captionText={"Good example - Noise reduction applied to low light footage"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Noise reduction applied to high ISO footage"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Removing flickering caused by a light's power frequency"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Removing dust and film grain"}
