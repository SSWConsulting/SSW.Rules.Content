...
<imageEmbed
  ...
  caption={"Good example - Noise reduction applied to low light footage"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Noise reduction applied to high ISO footage"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Removing flickering caused by a light's power frequency"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Removing dust and film grain"}
