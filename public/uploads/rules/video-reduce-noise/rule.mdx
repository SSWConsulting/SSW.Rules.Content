...
<imageEmbed
  ...
  figureText={"Good example - Noise reduction applied to low light footage"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Noise reduction applied to high ISO footage"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Removing flickering caused by a light's power frequency"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Removing dust and film grain"}
