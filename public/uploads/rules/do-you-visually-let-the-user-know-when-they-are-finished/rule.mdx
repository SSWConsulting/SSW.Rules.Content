...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure='This is the last page of the wizard but it is not obvious because the finish flag is small and the "Next" button still enabled'
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Good quality Finish flag on the last page of a wizard."
