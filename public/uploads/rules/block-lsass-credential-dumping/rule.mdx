---
seoDescription: Block credential dumping from lsass.exe and protect user credentials
  with Windows 10's Credential Guard, a feature that runs lsass.exe in an isolated
  virtualized environment without device drivers.
type: rule
...
created: 2022-05-13 05:36:32.525000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Attackers can dump credentials from lsass.exe"
