...
<imageEmbed
  ...
  caption={"Bad Example - Attackers can dump credentials from lsass.exe"}
...
<imageEmbed
  ...
  caption={"Credential Guard enabled in a Group Policy object"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Credential Guard setting in Microsoft Endpoint Manager"}
