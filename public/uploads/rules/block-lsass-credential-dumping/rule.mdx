...
<imageEmbed
  ...
  figureText={"Bad Example - Attackers can dump credentials from lsass.exe"}
...
<imageEmbed
  ...
  figureText={"Credential Guard enabled in a Group Policy object"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Credential Guard setting in Microsoft Endpoint Manager"}
