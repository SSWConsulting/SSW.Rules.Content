...
isArchived: false
lastUpdated: 2019-06-21 23:05:51+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Load all images by default"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Do not load all images by default, only load them when they are visible while scrolling down the browsers"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Load all embedded YouTube videos by default"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Do not load all embedded YouTube videos by default, only load them when they are visible while scrolling down the browsers"
...
2. If the browser supports IntersectionObserver, in your page html, change the “src” of “&lt;img&gt;” to “data-src”
  ...
  ```html
  <img alt="flight.jpg" src="https://www.ssw.com.au/images/flight.jpg" />
  ```

  to

  ```html
  <img alt="flight.jpg" data-src="https://www.ssw.com.au/images/flight.jpg" />
  ```
