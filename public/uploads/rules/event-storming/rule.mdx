...
<imageEmbed
  ...
  caption={"Levels of Event Storming"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Example of Domain Events, Commands, Actors, etc. arranged underneath the Aggregate"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Example events and timeline of a booking system"}
