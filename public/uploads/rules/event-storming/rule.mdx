...
<imageEmbed
  ...
  figureText={"Levels of Event Storming"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example of Domain Events, Commands, Actors, etc. arranged underneath the Aggregate"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example events and timeline of a booking system"}
