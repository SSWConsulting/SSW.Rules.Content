...
<imageEmbed
  ...
  caption={"Good Example - This wizard has an information screen as the first screen"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - Help - About... menu item opening the product information"}
