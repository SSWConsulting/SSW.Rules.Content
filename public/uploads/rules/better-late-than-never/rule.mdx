...
<imageEmbed
  ...
  captionText={"Bad example - Hitting the 'Delete' button without replying"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - A chat with no answer"}
...
Done
  ...
  captionText={"Good example - Getting an old task done"}
/>
...
1. Please let me know if you don't want that
  ...
  captionStyle="goodExample"
  captionText={"Good example - Asking if an old task is still wanted"}
/>
...
I assume this is too late now. Sorry I missed this one
  ...
  captionStyle="goodExample"
  captionText={"Good example - Informing a task is not relevant anymore"}
/>
...
Checked and this task was already done a few months ago
  ...
  captionStyle="goodExample"
  captionText={"Good example - Informing a task was already done"}
/>