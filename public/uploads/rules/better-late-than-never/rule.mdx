...
isArchived: false
lastUpdated: 2020-11-25 00:01:52+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Hitting the 'Delete' button without replying"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - A chat with no answer"}
...
Done
  ...
  figureText={"Good example - Getting an old task done"}
/>
...
1. Please let me know if you don't want that
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Asking if an old task is still wanted"}
/>
...
I assume this is too late now. Sorry I missed this one
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Informing a task is not relevant anymore"}
/>
...
Checked and this task was already done a few months ago
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Informing a task was already done"}
/>