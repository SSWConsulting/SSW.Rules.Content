...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![It is a great idea to run your Scrum meetings through Microsoft Teams, so that the whole team is invited and new developers can easily find the meetings](/uploads/rules/scrum-master-do-you-schedule-the-3-meetings/Screen Shot 2020-04-06 at 4.15.50 PM.png)',
  shouldDisplay: true
} } />
