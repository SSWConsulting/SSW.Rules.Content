...
--Waits for response before continuing--
  ...
  caption={"Bad example - Left waiting for a response"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - No context"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - They're left waiting for you to ask a question"}
/>
...
<boxEmbed
  ...
  caption={"Good example - You have given immediate context"}
/>
