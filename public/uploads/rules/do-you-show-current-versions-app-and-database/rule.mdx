...
<imageEmbed
  ...
  figureText={"Everyone shows the version number somewhere on their app"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example - SSW Link Auditor _zsDataVersion table"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Example - SSW Link Auditor Database version is 62"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The Application keeps all the scripts in a folder called SQLScripts (this allows the application to upgrade itself and give the Reconciliation functionality)"}
