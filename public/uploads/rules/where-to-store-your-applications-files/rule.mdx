...
<imageEmbed
  ...
  figurePrefix="none"
  figure="Caption text"
  src="/uploads/rules/where-to-store-your-applications-files/store-files.jpg"
/>
...
Microsoft's write-up on this subject can be found at [Microsoft API and reference catalog](https://learn.microsoft.com/en-us/previous-versions/iis/microsoft.web/microsoft-api-and-reference-catalog).
