...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "![Good Example: Let's Encrypt Free Certificate Authority](/uploads/rules/do-you-use-free-or-paid-ssl-certificates/letsenc.png)",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "![Good Example: Comodo Paid Certificate Authority](/uploads/rules/do-you-use-free-or-paid-ssl-certificates/comodo.png)",
  shouldDisplay: true
} } />
