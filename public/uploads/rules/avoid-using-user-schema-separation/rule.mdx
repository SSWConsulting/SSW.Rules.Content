...
<imageEmbed
  ...
  figureText={"Bad Example - AdventureWorks using user schema - instead, keep it simple and avoid using user schema unnecessarily"}
...
<imageEmbed
  ...
  figureText={"Good Example - Adventure works with user schema cleaned out. Much simpler and more readable"}
