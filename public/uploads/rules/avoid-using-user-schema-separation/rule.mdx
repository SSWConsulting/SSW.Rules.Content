...
<imageEmbed
  ...
  captionText={"Bad Example - AdventureWorks using user schema - instead, keep it simple and avoid using user schema unnecessarily"}
...
<imageEmbed
  ...
  captionText={"Good Example - Adventure works with user schema cleaned out. Much simpler and more readable"}
