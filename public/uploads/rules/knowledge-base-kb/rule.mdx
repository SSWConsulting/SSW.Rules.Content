...
redirects:
  ...
  - do-you-have-a-knowledge-base-kb
lastUpdated: 2024-09-02T05:21:17.000Z
...
You can easily create a page for a KB in GitHub's Wiki section. E.g. [SSW CodeAuditor KB]([https://github.com/SSWConsulting/SSW.CodeAuditor/wiki/SSW-CodeAuditor-Knowledge-Base-(KB)](https://github.com/SSWConsulting/SSW.CodeAuditor/wiki/SSW-CodeAuditor-Knowledge-Base-(KB))).
...
<imageEmbed
  ...
  figureEmbed={ {
    preset: "goodExample",
    figure: "Good example - CodeAuditor's KB",
    shouldDisplay: true
  } }
  src="/uploads/rules/knowledge-base-kb/https://user-images.githubusercontent.com/67776356/233515514-b81668ee-e0a7-49e5-a09e-595e895ef303.png"
/>
