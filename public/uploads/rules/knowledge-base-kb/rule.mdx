...
Bob
  ...
  figureText={"Good example - Responding to a known issue when the KB is already updated"}
/>
...
Bob
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Responding to a known issue when you need to update to the KB"}
/>
...
Bob
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Responding when you cannot reproduce the issue"}
/>
...
Bob
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Informing user of a fix"}
/>
...
Bob
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Responding to a feature request"}
/>
...
Bob
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Responding to a feature request which is part of the roadmap"}
/>
...
<imageEmbed
  ...
  figureText={"Good example - TinaCMS Docs page"}
