...
Bob
  ...
  caption={"Good example - Responding to a known issue when the KB is already updated"}
/>
...
Bob
  ...
  captionStyle="goodExample"
  caption={"Good example - Responding to a known issue when you need to update to the KB"}
/>
...
Bob
  ...
  captionStyle="goodExample"
  caption={"Good example - Responding when you cannot reproduce the issue"}
/>
...
Bob
  ...
  captionStyle="goodExample"
  caption={"Good example - Informing user of a fix"}
/>
...
Bob
  ...
  captionStyle="goodExample"
  caption={"Good example - Responding to a feature request"}
/>
...
Bob
  ...
  captionStyle="goodExample"
  caption={"Good example - Responding to a feature request which is part of the roadmap"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - TinaCMS Docs page"}
