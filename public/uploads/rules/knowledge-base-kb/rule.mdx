...
created: 2009-03-02 02:45:54+00:00
...
For example, one of the most useful features on Microsoft website is their [knowledge base](https://support.microsoft.com/).
...
Thanks for reporting this issue to TinaCMS. I'm happy to let you know that this is a known issue and has been addressed in our [Knowledge Base](https://tina.io/docs/).

Thanks,
Bob
  </>}
  figurePrefix="good"
  figure="Responding to a known issue when the KB is already updated"
/>
...
Bob
  ...
  figurePrefix="good"
  figure="Responding to a known issue when you need to update to the KB"
/>
...
Bob
  ...
  figurePrefix="good"
  figure="Informing user of a fix"
/>
...
KBs also play a very important role in getting a product released. You will never get every feature done or bug fixed - we all know it
...
This has been added to our [GitHub Discussions](https://github.com/tinacms/tinacms/discussions), where it will be reviewed and considered for inclusion in our backlog.
...
Bob
  ...
  figurePrefix="good"
  figure="Responding to a feature request"
/>
...
Bob
  ...
  figurePrefix="good"
  figure="Responding to a feature request which is part of the roadmap"
/>
