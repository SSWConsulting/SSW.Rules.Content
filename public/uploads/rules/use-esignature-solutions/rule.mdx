...
<boxEmbed
  ...
  figureText={"Good example – It’s essential to choose an eSignature solution that aligns with your business needs."}
/>
...
<imageEmbed
  ...
  figureText={"Bad example - Handwritten signatures cause delays and inefficiencies"}
...
<imageEmbed
  ...
  figureText={"Good example - eSignatures are efficient and easy"}
