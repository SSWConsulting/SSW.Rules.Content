...
<boxEmbed
  ...
  captionText={"Good example – It’s essential to choose an eSignature solution that aligns with your business needs."}
/>
...
<imageEmbed
  ...
  captionText={"Bad example - Handwritten signatures cause delays and inefficiencies"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - eSignatures are efficient and easy"}
