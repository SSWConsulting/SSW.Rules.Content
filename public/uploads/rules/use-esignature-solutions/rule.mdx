...
<boxEmbed
  ...
  caption={"Good example – It’s essential to choose an eSignature solution that aligns with your business needs."}
/>
...
<imageEmbed
  ...
  caption={"Bad example - Handwritten signatures cause delays and inefficiencies"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - eSignatures are efficient and easy"}
