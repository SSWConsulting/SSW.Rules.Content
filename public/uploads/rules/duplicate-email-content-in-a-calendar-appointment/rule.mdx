...
&lt;This email was sent as per [https://www.ssw.com.au/rules/duplicate-email-content-in-a-calendar-appointment](/duplicate-email-content-in-a-calendar-appointment)&gt;
  ...
  captionStyle="default"
  caption={"Calendar appointment with tasks should be copied from an email, so the items assigned get read via the email (better visibility), and also the email can get replied to with a ‘done’"}
/>