...
created: 2022-03-04 23:44:51+00:00
...
&lt;This email was sent as per [https://www.ssw.com.au/rules/duplicate-email-content-in-a-calendar-appointment](/duplicate-email-content-in-a-calendar-appointment)&gt;
  ...
  captionStyle="default"
  captionText={"Calendar appointment with tasks should be copied from an email, so the items assigned get read via the email (better visibility), and also the email can get replied to with a ‘done’"}
/>