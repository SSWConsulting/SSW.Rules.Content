...
created: 2014-12-01 06:06:37+00:00
...
Dimension Caption: "All Geography"
  ...
  figureText={"Bad example (Before adjustment) - In this scenario, the prefix \"All\" followed by a space and the dimension name can make reports look cluttered and does not add meaningful information"}
/>
...
<boxEmbed
  ...
  figureText={"Good example (After adjustment) - In the improved scenario, each dimension's top level simply reads \"All,\" eliminating redundancy and making the data presentation cleaner and more straightforward"}
/>
