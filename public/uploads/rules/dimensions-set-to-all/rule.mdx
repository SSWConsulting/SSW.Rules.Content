...
Dimension Caption: "All Geography"
  ...
  figurePrefix="bad"
  figure='In this scenario, the prefix "All" followed by a space and the dimension name can make reports look cluttered and does not add meaningful information'
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="In the improved scenario, each dimension's top level simply reads &quot;All,&quot; eliminating redundancy and making the data presentation cleaner and more straightforward"
/>
