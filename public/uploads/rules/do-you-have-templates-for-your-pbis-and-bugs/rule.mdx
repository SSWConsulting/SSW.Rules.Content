...
<imageEmbed
  ...
  caption={"Bad example – This new bug template doesn’t make it obvious how the team likes their steps to repro"}
...
<imageEmbed
  ...
  caption={"Good example – This new bug template guides the user to fill in the steps to repro in an ordered list and even prompts them to fill in what they expected to happen (and what actually happened)"}
...
<imageEmbed
  ...
  caption={"Customizing a bug work item"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Set the default value for the Repro Steps field (Tip: use HTML)"}
