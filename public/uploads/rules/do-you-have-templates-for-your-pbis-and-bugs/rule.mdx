...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example – This new bug template doesn’t make it obvious how the team likes their steps to repro](templates for pbis and bugs - bad example.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example – This new bug template guides the user to fill in the steps to repro in an ordered list and even prompts them to fill in what they expected to happen (and what actually happened)](templates for pbis and bugs - good example.png "Good example of a bug template")',
  shouldDisplay: true
} } />
