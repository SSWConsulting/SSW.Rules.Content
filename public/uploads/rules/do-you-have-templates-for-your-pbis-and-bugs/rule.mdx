...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This new bug template doesn’t make it obvious how the team likes their steps to repro"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This new bug template guides the user to fill in the steps to repro in an ordered list and even prompts them to fill in what they expected to happen (and what actually happened)"
