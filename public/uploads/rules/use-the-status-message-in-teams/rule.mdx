...
<imageEmbed
  ...
  figureText={"When people chat with you, they can see what you’re up to"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Edit the Teams status message each day"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Edit the status message"}
