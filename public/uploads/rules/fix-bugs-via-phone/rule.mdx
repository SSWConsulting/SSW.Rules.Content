...
isArchived: false
lastUpdated: 2021-08-16 22:23:42.505000+00:00
...
Then you fix it - if they were able to reproduce the issue.
  ...
  captionText={"Bad example - Time spent trying to reproduce the bug by yourself"}
/>
...
If they are able to reproduce it, then you fix it.
  ...
  captionText={"Good example - Calling the bug reporter if you can't easily reproduce the issue"}
/>
