...
<imageEmbed
  ...
  captionText={"Keeping Teams at the centre of client communication"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Client with open tenant"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Client with a closed tenant"}
...
&#123;&#123; YOUR NAME &#125;&#125;
  ...
  captionStyle="default"
  captionText={"Send an email to your client requesting access to their organization's tenant"}
/>