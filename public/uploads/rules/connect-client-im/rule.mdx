...
created: 2023-10-31 16:50:21+00:00
...
<imageEmbed
  ...
  figureText={"Keeping Teams at the centre of client communication"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Client with open tenant"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Client with a closed tenant"}
...
&#123;&#123; YOUR NAME &#125;&#125;
  ...
  figurePreset="defaultExample"
  figureText={"Send an email to your client requesting access to their organization's tenant"}
/>