...
<imageEmbed
  ...
  figureText={"Outlook on the web | Set your working days, hours, and location"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Grey means people are not available (so set your working hours to be accurate)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"In CRM, Click on the cog in the top right | Personalization Settings"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Go to the Activities tab | Enter your default work hours"}
...
<imageEmbed
  ...
  figureText={"Good example - Only update your work hours if they vary from the usual Mon-Fri, 9-6"}
