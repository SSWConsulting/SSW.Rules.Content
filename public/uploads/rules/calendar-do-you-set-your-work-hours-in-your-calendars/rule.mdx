...
<imageEmbed
  ...
  captionText={"Outlook on the web | Set your working days, hours, and location"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Grey means people are not available (so set your working hours to be accurate)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"In CRM, Click on the cog in the top right | Personalization Settings"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Go to the Activities tab | Enter your default work hours"}
...
<imageEmbed
  ...
  captionText={"Good example - Only update your work hours if they vary from the usual Mon-Fri, 9-6"}
