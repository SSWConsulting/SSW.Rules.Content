...
<imageEmbed
  ...
  caption={"You can create your own nuget server by simply creating a new asp.net web project and adding the Nuget.Server package"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Add your new server as a package source under Tools | Options | Nuget Package Manager | Package Sources"}
