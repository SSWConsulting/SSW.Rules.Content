...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="How can we check the task was done correctly?"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Easy to check what was done"
/>
...
As requested on ssw2&#46;visualstudio&#46;com/Northwind/\_workitems/edit/00001
  ...
  figurePrefix="good"
  figure="Easy to check what was done + includes the context of the task within the Sprint"
/>
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Link is included but changes are not live yet"
/>
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Using the PR link instead of the final page link"
/>
...
Done - Changes will be on ssw&#46;com&#46;au/rules/dones-is-your-inbox-a-task-list-only
  ...
  figurePrefix="ok"
  figure="Changes are not live yet, but people are aware and have the links"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Final link is included and changes are live to be checked"
/>
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Link is included but recipient won't be able to open it, potentially generating more emails"
/>
...
Done - onedrive&#46;live.com/file-name.xls
  ...
  figurePrefix="good"
  figure="Link is included and people are aware of permission issues"
/>
