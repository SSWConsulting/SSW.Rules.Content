...
created: 2023-06-01T02:46:32.000Z
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Figure: Bad example - Using absolute paths for internal links",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Figure: Good example - Using relative paths for internal links",
  shouldDisplay: true
} } />
