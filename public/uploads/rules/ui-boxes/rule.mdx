...
<imageEmbed
  alt="Limited-width callout box with constrained margins and reduced visual impact"
  size="large"
  showBorder={false}
  figurePrefix="bad"
  figure="Box doesn't look right"
  src="/uploads/rules/ui-boxes/limited-width-box.png"
/>


<imageEmbed
  alt="Full-width callout box spanning the entire screen width with maximum visual impact"
  size="large"
  showBorder={false}
  figurePrefix="good"
  figure="Box looks great"
