...
created: 2021-11-17 06:17:05.753000+00:00
...
<imageEmbed
  ...
  figureText={"Access team usage from \"Team Settings\" | \"Manage Team\" | \"Analytics\""}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Access tenant level usage via \"Office 365 Admin Center\" | \"Reports\" | \"Usage\" | \"View More\" (under Microsoft Teams activity section)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Click on column names to sort data (e.g. \"Chat Messages\")"}
