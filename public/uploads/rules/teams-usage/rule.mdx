...
<imageEmbed
  ...
  captionText={"Access team usage from \"Team Settings\" | \"Manage Team\" | \"Analytics\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Access tenant level usage via \"Office 365 Admin Center\" | \"Reports\" | \"Usage\" | \"View More\" (under Microsoft Teams activity section)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Click on column names to sort data (e.g. \"Chat Messages\")"}
