---
seoDescription: Optimize your Control4 smart home network performance by following
  Zigbee design principles, such as never placing mesh controllers in metal racks
  and centrally locating them to ensure reliable communication between devices.
type: rule
...
created: 2023-04-03 23:13:07.414000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="none"
  figure="Mesh controllers and metal racks don't play well together"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="none"
  figure="Use secondary controllers to improve performance"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="none"
  figure="Centrally locate the mesh controller"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="none"
  figure="Keep mesh controllers away from wi-fi access points"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="none"
  figure="Don't overload each mesh controller"
