...
<imageEmbed
  ...
  caption={"Mesh controllers and metal racks don't play well together"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Use secondary controllers to improve performance"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Centrally locate the mesh controller"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Keep mesh controllers away from wi-fi access points"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Don't overload each mesh controller"}
