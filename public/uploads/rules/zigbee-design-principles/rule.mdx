...
<imageEmbed
  ...
  figureText={"Mesh controllers and metal racks don't play well together"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Use secondary controllers to improve performance"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Centrally locate the mesh controller"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Keep mesh controllers away from wi-fi access points"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Don't overload each mesh controller"}
