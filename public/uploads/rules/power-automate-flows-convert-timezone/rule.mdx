...
<imageEmbed
  ...
  figureText={"Bad example - Comparing Datetime in default timezone: UTC with UTC"}
...
<imageEmbed
  ...
  figureText={"Good example - You are comparing it in local timezone (i.e AEST with AEST)"}
