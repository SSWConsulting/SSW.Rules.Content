...
<imageEmbed
  ...
  figureText={"Maximum Cost per Click can be set at the campaign, ad group or ad level"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Negative Keywords ensure your ad is not shown in unrelated searches"}
