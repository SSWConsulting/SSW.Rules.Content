...
<imageEmbed
  ...
  caption={"Bad example - Favicon does not display properly on all devices"}
...
<imageEmbed
  ...
  caption={"Good example - Favicon displays properly on all devices"}
...
<imageEmbed
  ...
  caption={"Choosing our favicon settings"}
