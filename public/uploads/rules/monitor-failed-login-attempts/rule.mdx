...
<imageEmbed
  ...
  captionText={"This Passive Monitor can then be applied to your Servers"}
...
<imageEmbed
  ...
  captionText={"Good example - This Passive Monitor will then record failed login attempts"}
