...
seoDescription: How to migrate your Classic ASP website to Azure, using Azure App
  Service with Docker or Azure Virtual Machines including considerations and best
  practices
uri: host-classic-asp-on-azure
authors:
- author: gordon-beeming
- author: matt-wicks
created: 2024-12-12 16:44:00+00:00
