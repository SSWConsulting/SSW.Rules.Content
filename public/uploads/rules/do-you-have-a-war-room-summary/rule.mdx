...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="No Product Roadmap is on the wall, so people can be out of sync with the future plans of the Product Owner"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The Product Roadmap is visible at a glance"
