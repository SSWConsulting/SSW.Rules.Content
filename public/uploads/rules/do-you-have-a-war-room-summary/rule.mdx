...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad Example – No Product Roadmap is on the wall, so people can be out of sync with the future plans of the Product Owner](war-room-bad-example.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example – The Product Roadmap is visible at a glance ](war-room-good-example.jpg)',
  shouldDisplay: true
} } />
