...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"A user in the People Picker that was deleted from Active Directory"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Searching in Active Directory for the user shows the user is in fact deleted"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"We have found our orphaned user!"}
