...
&lt;This email was sent as per the rule: [https://ssw.com.au/rules/collaborate-across-timezones](/collaborate-across-timezones)&gt;
  ...
  figureText={"Good example – A nice handover email to your coworker in another timezone, repeat this process until the task is complete"}
/>
...
<imageEmbed
  ...
  figureText={"For these locations there are only 2 small green spots that overlap for normal working hours"}
