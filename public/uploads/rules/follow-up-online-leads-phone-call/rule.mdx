...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Bad example - The form misses the opportunity to collect a phone number, reducing follow-up options"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Good example - The form collects all essential contact information, enabling multiple follow-up methods"
