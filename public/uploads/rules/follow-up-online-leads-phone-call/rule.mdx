...
<imageEmbed
  ...
  figureText={"Bad example - The form misses the opportunity to collect a phone number, reducing follow-up options"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - The phone number is not required, leading to many leads without a phone number"}
...
<imageEmbed
  ...
  figureText={"Good example - The form collects all essential contact information, enabling multiple follow-up methods"}
