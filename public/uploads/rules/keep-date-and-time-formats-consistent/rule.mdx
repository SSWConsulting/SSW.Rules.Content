...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Three screens with inconsistent time formats" src="/uploads/rules/keep-date-and-time-formats-consistent/BadExampleTP.gif" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Three screens with consistent formats" src="/uploads/rules/keep-date-and-time-formats-consistent/GoodExampleTP.gif" />
