...
isArchived: false
lastUpdated: 2014-12-01 02:05:58+00:00
...
<imageEmbed
  ...
  figureText={"Use named buttons to navigate around the application (Preferred)"}
...
<imageEmbed
  ...
  figureText={"Good Example - Use ellipses to navigate around the application"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Drill-downs implemented as links (an interesting alternative but a bit too much of a visual impact)"}
