...
<imageEmbed
  ...
  caption={"Use named buttons to navigate around the application (Preferred)"}
...
<imageEmbed
  ...
  caption={"Good Example - Use ellipses to navigate around the application"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Drill-downs implemented as links (an interesting alternative but a bit too much of a visual impact)"}
