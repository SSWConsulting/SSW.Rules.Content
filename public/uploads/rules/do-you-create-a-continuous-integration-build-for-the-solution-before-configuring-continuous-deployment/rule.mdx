---
archivedreason: Outdated - This is written for legacy TFS build definitions and templates. For modern CI/CD guidance, see [DevOps best practices](/rules-to-better-devops) and [Do you use the best deployment tool?](/do-you-use-the-best-deployment-tool).
authors:
