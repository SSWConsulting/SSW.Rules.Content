...
isArchived: false
lastUpdated: 2014-11-27 18:57:24+00:00
...
<imageEmbed
  ...
  captionText={"NuGet package updates"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The NuGet Package Manager in Visual Studio displays a convenient badge with the amount of outdated packages (2 in this example)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The Package Manager Console allows for easy management of packages using the command line"}
