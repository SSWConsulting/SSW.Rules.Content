...
<imageEmbed
  ...
  figureText={"NuGet package updates"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The NuGet Package Manager in Visual Studio displays a convenient badge with the amount of outdated packages (2 in this example)"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The Package Manager Console allows for easy management of packages using the command line"}
