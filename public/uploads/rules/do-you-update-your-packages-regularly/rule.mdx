...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The NuGet Package Manager in Visual Studio displays a convenient badge with the amount of outdated packages (2 in this example)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The Package Manager Console allows for easy management of packages using the command line"}
