...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"✅ Good Example from the TripIt mobile app - it's so easy to see your upcoming trips and share them with others"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"✅ Good Example from the TripIt mobile app - an itinerary shared with fellow travellers so the alerts are seen by everyone"}
