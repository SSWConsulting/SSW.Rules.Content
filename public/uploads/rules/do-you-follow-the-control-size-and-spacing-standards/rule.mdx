...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="See below what is wrong with this form"
...
The good news is that **you don't need to**: Microsoft have gone to a great deal of effort to [define standards](https://learn.microsoft.com/en-us/dotnet/desktop/winforms/controls/layout) for exactly how your form controls should be laid out, and these standards are worth taking into consideration. By all means, if you have disagreements with anything listed here then please discuss it with us and we'll consider changing our own standards (Microsoft have changed theirs over the years, after all), but we recommend using the following as a guide.
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The form follows Standards of good form design discussed below"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Microsoft have defined to exacting measures what spacing should be used in their Microsoft Outlook wizards"
  src="/uploads/rules/do-you-follow-the-control-size-and-spacing-standards/ScreenGoodControls.gif"
/>


Read more about control size on the [Rules to Better Windows Forms](/rules-to-better-windows-forms).
