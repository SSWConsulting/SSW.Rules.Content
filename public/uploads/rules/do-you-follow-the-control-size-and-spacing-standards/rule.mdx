...
<imageEmbed
  ...
  caption={"Bad Example - See below what is wrong with this form"}
...
<imageEmbed
  ...
  caption={"Good Example - The form follows Standards of good form design discussed below"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - Microsoft have defined to exacting measures what spacing should be used in their Microsoft Outlook wizards"}
