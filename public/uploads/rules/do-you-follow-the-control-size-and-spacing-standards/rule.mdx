...
<imageEmbed
  ...
  captionText={"Bad Example - See below what is wrong with this form"}
...
<imageEmbed
  ...
  captionText={"Good Example - The form follows Standards of good form design discussed below"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example - Microsoft have defined to exacting measures what spacing should be used in their Microsoft Outlook wizards"}
