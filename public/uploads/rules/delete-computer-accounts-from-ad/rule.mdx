...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example: Disabled computers in AD](/uploads/rules/delete-computer-accounts-from-ad/disabled-pcs.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example: Only enabled, current computers](/uploads/rules/delete-computer-accounts-from-ad/enabled-pcs.png)',
  shouldDisplay: true
} } />
