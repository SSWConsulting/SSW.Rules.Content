---
seoDescription: Discover how AI enhances Specification Reviews with precise insights
  and expert human touch.
type: rule
...
created: 2023-10-13 00:45:19.179000+00:00
...
Ask sequentially, with each question stemming from the previous response."
  ...
  figurePrefix="good"
  figure="AI adapts and evolves its questions based on ongoing answers, offering more tailored results"
/>
...
"Use these requirements to draft a Specification Review:
  ...
  figurePrefix="bad"
  figure="Missing critical elements like security considerations, data migration paths, or integration with existing systems"
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Visualizing complex system infrastructure using Mermaid for clarity"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using AI to generate a Specification Review on existing architecture"
...
3. Provide the Mermaid syntax to draft both the present and projected architectural flow diagrams."
  ...
  figurePrefix="good"
  figure="A good prompt to get the conversation started"
/>
