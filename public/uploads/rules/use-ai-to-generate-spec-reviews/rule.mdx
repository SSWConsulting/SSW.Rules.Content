...
Ask sequentially, with each question stemming from the previous response."
  ...
  caption={"Good example - AI adapts and evolves its questions based on ongoing answers, offering more tailored results"}
/>
...
"Use these requirements to draft a Specification Review:
  ...
  caption={"Bad example - Missing critical elements like security considerations, data migration paths, or integration with existing systems"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Visualizing complex system infrastructure using Mermaid for clarity"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Using AI to generate a Specification Review on existing architecture"}
...
3. Provide the Mermaid syntax to draft both the present and projected architectural flow diagrams."
  ...
  captionStyle="goodExample"
  caption={"Good example - A good prompt to get the conversation started"}
/>
