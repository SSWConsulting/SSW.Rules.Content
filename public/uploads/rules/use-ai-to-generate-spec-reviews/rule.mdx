...
Ask sequentially, with each question stemming from the previous response."
  ...
  figureText={"Good example - AI adapts and evolves its questions based on ongoing answers, offering more tailored results"}
/>
...
"Use these requirements to draft a Specification Review:
  ...
  figureText={"Bad example - Missing critical elements like security considerations, data migration paths, or integration with existing systems"}
/>
...
<imageEmbed
  ...
  figureText={"Good example - Visualizing complex system infrastructure using Mermaid for clarity"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Using AI to generate a Specification Review on existing architecture"}
...
3. Provide the Mermaid syntax to draft both the present and projected architectural flow diagrams."
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - A good prompt to get the conversation started"}
/>
