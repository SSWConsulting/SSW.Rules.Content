...
lastUpdated: 2026-06-11T02:51:25.340Z
...
* The same component exists five times over, each one slightly different, and nobody can say which is the correct one.
* A "quick" colour change turns into a hunt through the codebase, because the same edit has to be repeated by hand in every copy.
* The designs in Figma and the screens in production have quietly stopped matching.
* Handover meetings get spent arguing about padding and hex codes instead of the actual work.
* Your style guide, if there is one, is out of date or scattered across three different tools.
