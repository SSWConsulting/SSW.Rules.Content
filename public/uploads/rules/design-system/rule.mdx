...
lastUpdated: 2026-06-11T05:06:01.925Z
...
<boxEmbed
  body={<>
    **Tip: **People use "design system" to mean anything from a single Figma file to a full coded platform, so it helps to know which one you actually have.
  </>}
  figurePrefix="none"
  figure=""
  style="tips"
