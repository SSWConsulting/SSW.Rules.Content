...
lastUpdated: 2026-09-10T14:35:02.927Z
...
<boxEmbed
  ...
  figurePrefix="ok"
  figure="Showing the Product Owner the PBI for the first time during the Sprint Review"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Confirming that the PBI has already been reviewed so you can move on"
/>
...
## Common mistakes **on the backlog** in Sprint Reviews

Here's a video highlighting common mistakes that show an unhealthy backlog 🤢, and can slow down Sprint Reviews:

<youtubeEmbed url="https://www.youtube.com/watch?v=-0PUveZg3wk" description="" />
