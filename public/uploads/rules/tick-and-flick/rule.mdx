...
**Developer:** Any questions?
  ...
  caption={"**Figure: OK example - Showing the Product Owner the PBI for the first time during the Sprint Review**"}
/>
...
<boxEmbed
  ...
  caption={"**Figure: Good example - Confirming that the PBI has already been reviewed so you can move on**"}
/>
