...
created: 2023-08-10 12:15:00+00:00
...
seoDescription: Developers can avoid Primitive Obsession by using Strongly Typed IDs,
  which provide a clear representation of domain entity identifiers.
...
Check out the [SSW Clean Architecture template](https://github.com/SSWConsulting/SSW.CleanArchitecture/tree/main?tab=readme-ov-file#ssw-clean-architecture-template) for a few examples of Strongly Typed IDs in action.
