...
<imageEmbed alt="Code Auditor logo visibly stretched out of its natural aspect ratio" size="small" showBorder={true} figurePrefix="bad" figure="Stretched image caused by inline height/width ratio that doesn't match" src="/uploads/rules/avoid-height-width-in-img-tag/streched-image.jpg" />

```html
<img src="images/codeauditor-logo.png" alt="Code Auditor logo" />
```

<imageEmbed alt="Code Auditor logo displayed at its natural aspect ratio" size="small" showBorder={true} figurePrefix="good" figure="Avoiding inline height/width ratio keeps the image as original" src="/uploads/rules/avoid-height-width-in-img-tag/non-streched-image.jpg" />
