...
<imageEmbed
  ...
  caption={"Bad example - Stretched image caused by inline height/width ratio that doesn't match"}
...
<imageEmbed
  ...
  caption={"Good example - Avoiding inline height/width ratio keeps the image as original"}
