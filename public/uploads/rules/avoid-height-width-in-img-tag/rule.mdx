...
<imageEmbed
  ...
  captionText={"Bad example - Stretched image caused by inline height/width ratio that doesn't match"}
...
<imageEmbed
  ...
  captionText={"Good example - Avoiding inline height/width ratio keeps the image as original"}
