...
created: 2023-08-22 06:35:55+00:00
...
<imageEmbed
  ...
  figureText={"Secrets added to each repository"}
...
<imageEmbed
  ...
  figureText={"Secrets added to the GitHub organization"}
...
<imageEmbed
  ...
  figureText={"An enterprise password/secrets manager like Keeper with the Secrets Manager add-on and integration with GA or AzDo"}
