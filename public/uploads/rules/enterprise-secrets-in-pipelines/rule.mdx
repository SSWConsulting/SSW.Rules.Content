...
<imageEmbed
  ...
  caption={"Secrets added to each repository"}
...
<imageEmbed
  ...
  caption={"Secrets added to the GitHub organization"}
...
<imageEmbed
  ...
  caption={"An enterprise password/secrets manager like Keeper with the Secrets Manager add-on and integration with GA or AzDo"}
