...
lastUpdated: 2026-04-07T17:44:10.140Z
...
Use URI
When speaking technically about identifiers
e.g. APIs, specifications
Use URL
When referring to a full web address
e.g. links in pages, emails, or documentation
Use slug
When referring to the editable part of a page path
e.g. in CMS, routing, or SEO
Why this matters
...
Prefer slug when working with content.

It is the most user-friendly term and matches how editors interact with pages in TinaCMS and WordPress.



Figure: URI is the umbrella term, URL is the full address, and slug is the readable end of the path
