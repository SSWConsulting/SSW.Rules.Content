...
<imageEmbed
  ...
  caption={"Look at the manual process in this complicated Excel. If the process has never been done before, do it in Excel first"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"A Journey Map for 2 stakeholders"}
