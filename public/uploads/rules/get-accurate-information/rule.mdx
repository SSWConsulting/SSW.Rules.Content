...
<imageEmbed
  ...
  figureText={"Look at the manual process in this complicated Excel. If the process has never been done before, do it in Excel first"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"A Journey Map for 2 stakeholders"}
