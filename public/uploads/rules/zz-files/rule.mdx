...
created: 2024-01-03 13:49:47+00:00
...
<imageEmbed
  ...
  captionText={"'zz' your files rather than deleting them! Alternatively add a folder named zz and move the outdated files into the new folder"}
...
<imageEmbed
  ...
  captionText={"Good example of the 'zz' process for YouTube videos"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Accessing the latest video from a zz'ed video"}
