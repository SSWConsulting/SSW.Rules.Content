...
seoDescription: >-
  Do you 'zz' old files rather than deleting them? Learn how to preserve your
  outdated .NET application releases and Microsoft Word proposals by prefixing
  filenames with 'zz'.
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="'zz' your files rather than deleting them! Alternatively add a folder named zz and move the outdated files into the new folder" src="/uploads/rules/zz-files/zz-file-example.png" />
...
1. **Title** - Go to the old version and add "zz" at the beginning of the title
2. **Description** - Add a link to the latest version at the top of the description
3. **Visibility** - Set its visibility to "unlisted"

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Good example of the 'zz' process for YouTube videos" src="/uploads/rules/zz-files/zz-process-youtube.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Accessing the latest video from a zz'ed video" src="/uploadshttps://github.com/SSWConsulting/SSW.Rules.Content/assets/147477898/748b40ce-792b-4400-84ca-5c759aa72148" />
...
* In HTML/Markdown content, the keyword "deprecated" is often used
