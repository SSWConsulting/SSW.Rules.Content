...
lastUpdated: 2026-05-14T07:36:57.617Z
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="none" figure="'zz' your files rather than deleting them! Alternatively add a folder named zz and move the outdated files into the new folder" src="/uploads/__staging/tina/kulesy/media-branching-test/__file/rules/zz-files/ObseleteOldFilesAggressively.gif" />
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Good example of the 'zz' process for YouTube videos" src="/uploads/__staging/tina/kulesy/media-branching-test/__file/rules/zz-files/TinaCloud%20Video%20Title%20Card%20106.png" />
