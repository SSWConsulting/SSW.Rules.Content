...
<imageEmbed
  ...
  caption={"'zz' your files rather than deleting them! Alternatively add a folder named zz and move the outdated files into the new folder"}
...
<imageEmbed
  ...
  caption={"Good example of the 'zz' process for YouTube videos"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Accessing the latest video from a zz'ed video"}
