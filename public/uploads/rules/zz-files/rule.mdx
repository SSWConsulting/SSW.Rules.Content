...
lastUpdated: 2026-05-14T05:15:08.644Z
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="none" figure="'zz' your files rather than deleting them! Alternatively add a folder named zz and move the outdated files into the new folder" src="/uploads/__staging/tina/kulesy/media-branching-test/__file/rules/zz-files/zz-file-example.png" />
