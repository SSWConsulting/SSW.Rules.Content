...
In conjunction with [regular check-ins](/work-in-small-chunks-and-check-in), files in source control should never be locked unless absolutely necessary. Use either 'Unchanged - Keep any existing lock' - or 'None - Allow shared checkout'.
