...
<imageEmbed
  ...
  caption={"Bad example - Sprint emails can easily become inconsistent and lost in your inbox"}
...
<imageEmbed
  ...
  caption={"Good example - With GitHub issues it's easy to spin up a Sprint Review or Forecast template"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Editing a Sprint Forecast or Review/Retro is super simple and enabled with Markdown!"}
