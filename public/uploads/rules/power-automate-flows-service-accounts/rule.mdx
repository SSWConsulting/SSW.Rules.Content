...
<imageEmbed
  ...
  captionText={"Bad example – The red arrow shows the user as an owner. It is not shared to a group"}
...
<imageEmbed
  ...
  captionText={"Good example – Groups and Service Accounts cleverly used to not lose any flows"}
