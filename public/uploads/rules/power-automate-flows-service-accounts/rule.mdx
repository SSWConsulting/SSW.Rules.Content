...
<imageEmbed
  ...
  caption={"Bad example – The red arrow shows the user as an owner. It is not shared to a group"}
...
<imageEmbed
  ...
  caption={"Good example – Groups and Service Accounts cleverly used to not lose any flows"}
