---
seoDescription: Get step-by-step answers from ChatGPT and improve response logic with
...
created: 2023-04-12 14:06:25.338000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="It got the answer wrong"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="By getting it to think step by step, it got the answer right"
