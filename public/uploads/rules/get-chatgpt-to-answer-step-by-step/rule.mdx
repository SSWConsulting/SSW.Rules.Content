...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="It got the answer wrong" src="/uploads/rules/get-chatgpt-to-answer-step-by-step/don-t-think.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="By getting it to think step by step, it got the answer right" src="/uploads/rules/get-chatgpt-to-answer-step-by-step/think.png" />
