...
<imageEmbed
  ...
  figureText={"Prioritize effort. More 1:1 at the top, more segmentation at the bottom."}
...
Worth a quick reply if “faster ramp before Q4” is on your list? If not, I’ll leave you in peace.
  ...
  figureText={"Personal detail + timely company priority + soft, single-question CTA"}
/>
...
Open to a quick reply if local visibility is a 2025 focus for you?
  ...
  figurePreset="goodExampleExample"
  figureText={"Industry-specific pain + outcome + 1 easy question"}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Short, direct restatement of the original question"}
/>
...
P.S. If you’re already buried in onboarding fires, just reply with “no” and I’ll vanish faster than free snacks. No hard feelings. 🙂
  ...
  figurePreset="goodExampleExample"
  figureText={"✅ Pattern interruption in the P.S. earns smiles and replies"}
/>
