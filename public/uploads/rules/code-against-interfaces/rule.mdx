...
- author: eric-phan
- author: dhruv-mathur
created: 2024-04-18 02:29:38+00:00
...
seoDescription: Code effectively against interfaces to ensure maintainable and readable
  code, making it easier to swap out implementations without modifying using code.
