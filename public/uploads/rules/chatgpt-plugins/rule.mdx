...
archivedreason: ChatGPT Plugins were retired by OpenAI in April 2024 and replaced by GPTs and Actions
---
<boxEmbed
  style="highlight"
  body={<>
    **This rule is archived.** OpenAI retired ChatGPT Plugins in April 2024 (new plugin conversations stopped on 19 March 2024, and all plugin chats were shut down on 9 April 2024). Plugins were replaced by [GPTs and the GPT Store](https://openai.com/index/introducing-gpts/) plus [Actions](https://platform.openai.com/docs/actions), and modern ChatGPT models now browse the web natively without any plugin. Use a Custom GPT or Actions instead of the plugins described below.
  </>}
  figurePrefix="none"
  figure=""
/>

ChatGPT plugins were tools that extended ChatGPT with abilities like browsing the web, reading digital resources, and performing complex computations. The rundown below is kept for historical reference - the equivalent capabilities now live in GPTs, Actions, and native browsing.
