...
lastUpdated: 2026-07-14T21:40:48.482Z
lastUpdatedBy: Tiago Araujo
lastUpdatedByEmail: TiagoAraujo@ssw.com.au
isArchived: true
archivedreason: 'OpenAI retired ChatGPT Plugins in April 2024 (new plugin conversations stopped on 19 March 2024, and all plugin chats were shut down on 9 April 2024). Plugins were replaced by GPTs and the GPT Store plus Actions, and modern ChatGPT models now browse the web natively without any plugin. Use a Custom GPT or Actions instead of the plugins described below.'
---
