...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: 'Figure: Bad example - Public setters, exposed collections, no constructor',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: 'Figure: Good example - Private setters, read-only collection, factory method',
  shouldDisplay: true
} } />
