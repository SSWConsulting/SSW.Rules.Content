---
type: rule
title: Do you know how to use single codebase for multiple domains with TinaCMS and
  Next.js?
categories:
- category: categories/software-engineering/rules-to-better-code.mdx
seoDescription: Optimize your Next.js and TinaCMS project with a single codebase to
  efficiently manage multiple domains, locations, and content.
uri: single-codebase-for-multiple-domains-with-tinacm-nextjs
authors:
- author: gilles-pothieu
created: 2024-08-28 17:37:00+00:00
