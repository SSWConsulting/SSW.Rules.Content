---
seoDescription: Ensure transparent Long Service Leave (LSL) accruals and compliance
  across various state legislations with automated payslip updates.
type: rule
...
authors:
- author: stephan-fako
created: 2024-04-08 04:12:18.064000+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Employees have to ask HR for their LSL balance, leading to a backlog of inquiries"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="LSL balances are updated regularly and displayed on every payslip"
