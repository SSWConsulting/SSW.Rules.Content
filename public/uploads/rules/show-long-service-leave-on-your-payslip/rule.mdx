...
<imageEmbed
  ...
  captionText={"Bad example - Employees have to ask HR for their LSL balance, leading to a backlog of inquiries"}
...
<imageEmbed
  ...
  captionText={"Good example - LSL balances are updated regularly and displayed on every payslip"}
