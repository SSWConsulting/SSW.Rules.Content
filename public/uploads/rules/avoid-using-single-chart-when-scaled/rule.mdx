...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Just a chart - poor scaling for only 1 record"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Just a chart - poorly scaling when many records"
...
<mark style="background-color: #CC4141">**Warning:** Do not reply to or forward this report in an email - Outlook may slow down or even hang.</mark>
