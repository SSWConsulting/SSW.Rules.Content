...
<imageEmbed
  ...
  captionText={"Bad example - Just a chart - poor scaling for only 1 record"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Just a chart - poorly scaling when many records"}
...
<imageEmbed
  ...
  captionText={"Size property of the chart control"}
...
<imageEmbed
  ...
  captionText={"Good example - A table with chart"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Embedded chart in a table will generate dynamic chart list"}
