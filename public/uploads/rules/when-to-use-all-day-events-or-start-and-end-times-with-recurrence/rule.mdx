...
<imageEmbed
  ...
  captionText={"Bad Example – If a change is needed on Tuesday’s booking, there will an issue"}
...
<imageEmbed
  ...
  captionText={"Good Example – Easy to alter any individual day as needed"}
