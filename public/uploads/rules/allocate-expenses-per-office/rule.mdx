...
created: 2024-01-25 00:00:00+00:00
...
<imageEmbed
  ...
  figureText={"Office can be assigned on each transaction in Xero"}
...
<imageEmbed
  ...
  figureText={"Good example - Software expenses from the company level would be assigned to different offices based on the admin rate"}
