...
created: 2024-01-26 19:36:50+00:00
...
seoDescription: Learn how to accurately allocate expenses per office in a multi-location
  business, improving financial reporting and cost management
...
<imageEmbed
  ...
  captionText={"Office can be assigned on each transaction in Xero"}
...
<imageEmbed
  ...
  captionText={"Good example - Software expenses from the company level would be assigned to different offices based on the admin rate"}
