...
<imageEmbed
  ...
  captionText={"Add a question asking your users for the value of the form (make sure the question is always the same)"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Using Power BI you can check what value you are getting out of your forms"}
