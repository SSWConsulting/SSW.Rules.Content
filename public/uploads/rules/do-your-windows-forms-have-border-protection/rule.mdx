...
isArchived: false
lastUpdated: 2021-04-21 23:31:10.575000+00:00
...
<imageEmbed
  ...
  figureText={"Good example - Good border protection on a form at run time. The only problem is you would have to imagine these blue lines to get consistency"}
...
<imageEmbed
  ...
  figureText={"Bad example - Controls placed very near to the border and not aligned correctly"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - All controls are in the border protection area and aligned correctly"}
