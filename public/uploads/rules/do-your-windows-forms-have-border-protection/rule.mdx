...
<imageEmbed
  ...
  captionText={"Good example - Good border protection on a form at run time. The only problem is you would have to imagine these blue lines to get consistency"}
...
<imageEmbed
  ...
  captionText={"Bad example - Controls placed very near to the border and not aligned correctly"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - All controls are in the border protection area and aligned correctly"}
