...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Good border protection on a form at run time. The only problem is you would have to imagine these blue lines to get consistency"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="All controls are in the border protection area and aligned correctly"
