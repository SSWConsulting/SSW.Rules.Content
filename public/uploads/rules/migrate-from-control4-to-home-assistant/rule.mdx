...
lastUpdated: 2026-03-04T04:04:30.809Z
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="A room with full list of devices and automation (even better if you keep updating the list as you make changes!)" src="/uploads/rules/migrate-from-control4-to-home-assistant/Example-room-devices.jpg" />
