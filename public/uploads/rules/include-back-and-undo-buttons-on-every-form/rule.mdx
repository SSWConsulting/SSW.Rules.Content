---
seoDescription: Mastering forms with intuitive navigation by including "Back" and
  "Undo" buttons to streamline interactions and enhance user experience.
type: rule
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Back & Undo buttons in Outlook Advanced toolbar"
