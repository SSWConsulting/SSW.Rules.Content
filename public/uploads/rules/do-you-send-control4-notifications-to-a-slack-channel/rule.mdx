...
<imageEmbed
  ...
  caption={"Good example - Slack Integration window"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Setting up a Generic TCP Command in Composer"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - You can send any kinds of notifications to Slack"}
