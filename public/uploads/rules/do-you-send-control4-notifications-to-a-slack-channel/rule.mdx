...
isArchived: false
lastUpdated: 2017-11-30 03:17:31+00:00
...
<imageEmbed
  ...
  figureText={"Good example - Slack Integration window"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Setting up a Generic TCP Command in Composer"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - You can send any kinds of notifications to Slack"}
