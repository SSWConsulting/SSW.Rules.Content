...
::: good  
![Figure: Good Example - Read only fields should be greyed out](/GreyField.gif)  
:::

::: good  
![Figure: Good Example - Calculated Fields in Excel should be in Grey](/GreyField-Excel.gif)  
:::
