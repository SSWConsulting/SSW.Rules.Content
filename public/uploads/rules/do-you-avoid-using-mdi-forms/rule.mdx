...
<imageEmbed
  ...
  caption={"Bad example - VS.NET with tabs is cool for developers, but not for the average knowledge worker"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Word 2003 in MDI mode"}
...
<imageEmbed
  ...
  caption={"Good example - Word 2003 with Default Settings"}
