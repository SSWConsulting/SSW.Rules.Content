...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="VS.NET with tabs is cool for developers, but not for the average knowledge worker"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Word 2003 with Default Settings"
