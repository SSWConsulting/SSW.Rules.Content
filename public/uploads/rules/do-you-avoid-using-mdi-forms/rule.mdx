...
<imageEmbed
  ...
  figureText={"Bad example - VS.NET with tabs is cool for developers, but not for the average knowledge worker"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Word 2003 in MDI mode"}
...
<imageEmbed
  ...
  figureText={"Good example - Word 2003 with Default Settings"}
