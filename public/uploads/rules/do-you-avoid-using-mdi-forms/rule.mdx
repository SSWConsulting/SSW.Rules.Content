...
<imageEmbed
  ...
  captionText={"Bad example - VS.NET with tabs is cool for developers, but not for the average knowledge worker"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Word 2003 in MDI mode"}
...
<imageEmbed
  ...
  captionText={"Good example - Word 2003 with Default Settings"}
