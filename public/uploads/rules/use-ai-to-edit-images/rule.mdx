...
<imageEmbed
  ...
  caption={"❌ Bad Example: text to image models often struggle with accuracy, producing distorted anatomy and other artifacts when asked to edit an image, e.g. the terminator only has 3 fingers..."}
  src="/uploads/rules/use-ai-to-edit-images/comewith-me-messed-up.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"✅ Good Example - You can take an existing image and ask Nano Banana to create new images using it as a reference, then refine them conversationally by asking for changes"}
  src="/uploads/rules/use-ai-to-edit-images/penny-nano-banana.png"
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"✅ Good example - You can even ask it to change the perspective of an image"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"✅ Good example - You can isolate a character from an image as seen in this example from Google"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"✅ Good example - from Midjourney's v7 release on X, the images are incredibly realistic"}
  src="/uploads/rules/use-ai-to-edit-images/midjourney-post.png"
/>
...
<imageEmbed
  ...
  src="/uploads/rules/use-ai-to-edit-images/dark-mermaids.png"
/>
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  caption={"✅ Good example - Clear disclosure aligned to asset management and brand guidelines that is added to the metadata"}
...
[https://adamcogan.com/2025/11/17/my-top-3-ai-image-generators/](https://adamcogan.com/2025/11/17/my-top-3-ai-image-generators/)