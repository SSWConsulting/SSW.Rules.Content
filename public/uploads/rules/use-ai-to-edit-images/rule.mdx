...
seoDescription: 'Learn when and how to use AI to edit images—what it’s good for, common pitfalls, ethical labeling, and battle-tested prompt patterns that preserve identity and make precise, localized changes'
created: 2025-09-04T04:35:12.000Z
createdBy: Louis Roa
createdByEmail: 149936952+louisroa8189@users.noreply.github.com
lastUpdated: 2026-03-17T06:09:59.452Z
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="bad" figure="Text to image models often struggle with accuracy, producing distorted anatomy and other artifacts when asked to edit an image, e.g. The Terminator has 6 fingers..." src="/uploads/rules/use-ai-to-edit-images/tti-example_bad.png" />
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="You can even ask it to change the perspective of an image" src="/uploads/rules/use-ai-to-edit-images/nbp-example_good.png" />
