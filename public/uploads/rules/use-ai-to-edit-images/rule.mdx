...
<imageEmbed
  ...
  captionText={"Bad example - Text-to-image models often struggle with accuracy, producing distorted anatomy and other artifacts when asked to edit an image"}
...
<imageEmbed
  ...
  captionText={"Good example - Modern AI editing models can now apply precise, localized changes while preserving subject identity, resulting in natural and consistent outputs."}
...
<imageEmbed
  ...
  captionText={"Hyper-realistic blended environments across multiple images and people. Users can draw colored circles directly on existing images and guide edits with simple English prompts. The level of detail retention is exceptional"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Changing the perspective of an image"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Isolating a character"}
...
**Prompt:** “A model is posing and leaning against a pink bmw. She is wearing the following items, the scene is against a light grey background. The green alien is a keychain and it's attached to the pink handbag. The model also has a pink parrot on her shoulder. There is a pug sitting next to her wearing a pink collar and gold headphones.”
  ...
  captionStyle="default"
  captionText={"Here we have 13 images merged into one using Gemini 2.5 Flash Image (“Nano Banana”). Even at 13 elements, consistency holds up impressively"}
/>
...
**Prompt:** “Relighting Apply: RAW-ISO 100 - F28-1/200 24mm setting"
  ...
  captionStyle="default"
  captionText={"Nano Banana relighting applied. Shot simulated as RAW"}
/>
...
**Prompt:** “Create a Nike ad with this image with text copy"
  ...
  captionStyle="default"
  captionText={"Image models used to butcher text. Now they can drop in clean, ad-ready copy like this Nike caption"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Clear disclosure aligned to asset management and brand guidelines that is added to the metadata"}
