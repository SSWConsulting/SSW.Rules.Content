...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="✅ Good example - You can isolate a character from an image as seen in this example from Google" src="/uploads/rules/use-ai-to-edit-images/gzwtouzbyaamxak.jpg" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="✅ Good example - from Midjourney's v7 release on X, the images are incredibly realistic" src="/uploads/rules/use-ai-to-edit-images/midjourney-post.png" />
