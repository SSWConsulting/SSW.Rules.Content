...
5. Make the headings bold
  ...
  caption={"Bad example - One email for multiple unrelated tasks (domains vs styling)"}
/>
...
2. Make the headings bold
  ...
  caption={"Good example - Separate emails for unrelated tasks. A few related tasks in the same email"}
/>
