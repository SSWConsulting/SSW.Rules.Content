...
created: 2009-03-30 03:26:32+00:00
...
5. Make the headings bold
  ...
  figureText={"Bad example - One email for multiple unrelated tasks (domains vs styling)"}
/>
...
2. Make the headings bold
  ...
  figureText={"Good example - Separate emails for unrelated tasks. A few related tasks in the same email"}
/>
