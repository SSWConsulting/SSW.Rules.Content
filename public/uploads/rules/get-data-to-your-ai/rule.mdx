...
lastUpdated: 2026-07-30T05:52:43.869Z
...
| **Cost driver**    | Re-sent every request - caching only helps if the documents repeat                           | Indexing up front, re-indexing as documents change, plus retrieval per query… often **the cheapest per query** | Tokens and turns while the agent searches            |
