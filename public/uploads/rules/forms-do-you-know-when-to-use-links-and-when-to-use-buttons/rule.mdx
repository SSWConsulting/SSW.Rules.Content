...
isArchived: false
lastUpdated: 2014-12-23 02:43:34+00:00
...
<imageEmbed
  ...
  figureText={"An exception to the rule - an \"Update\" button inside the datagrid would look inconsistent"}
...
<imageEmbed
  ...
  figureText={"Bad example - The \"sign in\" hyperlink should be a button"}
...
<imageEmbed
  ...
  figureText={"Good example - This is a perfect example of how a good sign in screen should look"}
