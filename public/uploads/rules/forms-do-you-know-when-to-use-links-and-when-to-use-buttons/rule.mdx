...
<imageEmbed
  ...
  caption={"An exception to the rule - an \"Update\" button inside the datagrid would look inconsistent"}
...
<imageEmbed
  ...
  caption={"Bad example - The \"sign in\" hyperlink should be a button"}
...
<imageEmbed
  ...
  caption={"Good example - This is a perfect example of how a good sign in screen should look"}
