...
seoDescription: Use high-quality icon libraries like Font Awesome, Bootstrap icons,
  or Google material icons to elevate your website's user experience and improve its
...
<imageEmbed
  ...
  figureText={"Bad example - Using images as icons generates a lot of pain"}
...
<imageEmbed
  ...
  figureText={"Good example - A 5x scaled paper plane icon on the web"}
