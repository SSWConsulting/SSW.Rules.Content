...
<imageEmbed
  ...
  caption={"Bad example - Unorganized tasks written in a notebook"}
...
<imageEmbed
  ...
  caption={"Good example - Organized task list using Loop in a Teams tab"}
