...
<imageEmbed
  ...
  captionText={"Bad example - Unorganized tasks written in a notebook"}
...
<imageEmbed
  ...
  captionText={"Good example - Organized task list using Loop in a Teams tab"}
...
<imageEmbed
  ...
  captionText={"Add Loop to Teams Tab"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"Loop added to Teams"}
