...
<imageEmbed
  ...
  caption={"Power BI report - Snipe showing the oldest laptops that needs to be recycled"}
...
<imageEmbed
  ...
  caption={"Bad example - Old laptops piled up in the server room"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Posted laptop on Ebay to sell"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Drill HDD before disposing of it"}
