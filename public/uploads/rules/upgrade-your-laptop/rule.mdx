...
<imageEmbed
  ...
  figureText={"Power BI report - Snipe showing the oldest laptops that needs to be recycled"}
...
<imageEmbed
  ...
  figureText={"Bad example - Old laptops piled up in the server room"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Posted laptop on Ebay to sell"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Drill HDD before disposing of it"}
