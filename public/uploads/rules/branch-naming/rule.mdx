...
created: 2025-01-02 15:40:00+00:00
...
* fix-stuff
  ...
  figureText={"Bad example - Poorly named branches missing PBI numbers"}
/>
...
* 1299-update-third-party-dependencies
  ...
  figureText={"OK example - Branches with PBI numbers and meaningful names"}
/>
...
* release/2.3.1
  ...
  figureText={"Good example - Branches with category prefixes"}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Recommended naming format"}
/>
