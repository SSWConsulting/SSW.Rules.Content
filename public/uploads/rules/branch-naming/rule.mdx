...
* fix-stuff
  ...
  figurePrefix="bad"
  figure="Poorly named branches missing PBI numbers"
/>
...
* 1299-update-third-party-dependencies
  ...
  figurePrefix="ok"
  figure="Branches with PBI numbers and meaningful names"
/>
...
* release/2.3.1
  ...
  figurePrefix="good"
  figure="Branches with category prefixes"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Recommended naming format"
/>
