...
* fix-stuff
  ...
  captionText={"Bad example - Poorly named branches missing PBI numbers"}
/>
...
* 1299-update-third-party-dependencies
  ...
  captionText={"OK example - Branches with PBI numbers and meaningful names"}
/>
...
* release/2.3.1
  ...
  captionText={"Good example - Branches with category prefixes"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - Recommended naming format"}
/>
