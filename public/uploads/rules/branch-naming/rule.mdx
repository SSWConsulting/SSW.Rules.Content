...
* fix-stuff
  ...
  caption={"Bad example - Poorly named branches missing PBI numbers"}
/>
...
* 1299-update-third-party-dependencies
  ...
  caption={"OK example - Branches with PBI numbers and meaningful names"}
/>
...
* release/2.3.1
  ...
  caption={"Good example - Branches with category prefixes"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Recommended naming format"}
/>
