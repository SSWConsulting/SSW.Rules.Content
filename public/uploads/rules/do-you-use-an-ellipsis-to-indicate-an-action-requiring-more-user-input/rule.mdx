...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Options menu in Outlook, with ellipsis"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Ellipsis on buttons that require further input"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Different ways of using the elipsis"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Elipsis being used on a button requiring user input"
