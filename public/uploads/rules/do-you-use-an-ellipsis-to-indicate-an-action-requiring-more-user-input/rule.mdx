...
<imageEmbed
  ...
  caption={"Good Example - Options menu in Outlook, with ellipsis"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - Ellipsis on buttons that require further input"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - Different ways of using the elipsis"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - Elipsis being used on a button requiring user input"}
