...
<imageEmbed
  ...
  figureText={"Good Example - Options menu in Outlook, with ellipsis"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - Ellipsis on buttons that require further input"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - Different ways of using the elipsis"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - Elipsis being used on a button requiring user input"}
