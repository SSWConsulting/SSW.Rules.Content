...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example - Advanced Lighting agent in Composer Pro showing some nice lighting moods and automation](/uploads/rules/control4-agents/advancedlighting.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example - Scheduled events can happen in any schedule you need, allows you to use time in your automation](/uploads/rules/control4-agents/schedulerss.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example - Different macros created for repetitive tasks](/uploads/rules/control4-agents/macrosss.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example - Custom buttons created to be pressed via the Control4 app](/uploads/rules/control4-agents/custombuttonsss.jpg)',
  shouldDisplay: true
} } />
