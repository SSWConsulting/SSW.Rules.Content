...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example - Advanced Lighting agent in Composer Pro showing some nice lighting moods and automation](advancedlighting.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example - Scheduled events can happen in any schedule you need, allows you to use time in your automation](schedulerss.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example - Different macros created for repetitive tasks](macrosss.jpg)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example - Custom buttons created to be pressed via the Control4 app](custombuttonsss.jpg)',
  shouldDisplay: true
} } />
