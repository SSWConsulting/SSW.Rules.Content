...
seoDescription: 'Discover the benefits of printed itineraries for staying organized
  and stress-free on your next trip. '
uri: do-you-print-your-travel-schedule
authors:
- author: stef-starcevic
- author: adam-cogan
created: 2025-02-17 14:49:00+00:00
...
![1. When you get an appointment, categorise it as "Travel"](/uploads/rules/do-you-print-your-travel-schedule/pa-rule-1.png)

![2. Make a view that shows only your travel appointments](/uploads/rules/do-you-print-your-travel-schedule/pa-rule-2.png)

![3. Set the date period to the end of year:  Print Options | Print Range| End Date](/uploads/rules/do-you-print-your-travel-schedule/pa-rule-3.png)

![4. Print from that view](/uploads/rules/do-you-print-your-travel-schedule/pa-rule-4.png)
...
* If you want to view your boss's calendar to edit:
  ...
  * Alternatively, ask a SysAdmin - This had to be done in PowerShell – as per: [https://learn.microsoft.com/en-us/powershell/module/exchange/add-mailboxfolderpermission?WT.mc_id=M365-MVP-33518](https://learn.microsoft.com/en-us/powershell/module/exchange/add-mailboxfolderpermission?WT.mc_id=M365-MVP-33518)
  * The command is
