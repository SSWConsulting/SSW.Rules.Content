...
<imageEmbed
  ...
  caption={"Good Example - The backlog is constructed during the Spec Review"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - CRM Record showing the sales stage of the Opportunity after the Spec Review has been booked"}
