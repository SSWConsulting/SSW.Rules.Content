...
created: 2009-12-04 08:39:40+00:00
createdBy: SSW2000\cindywang
createdByEmail: CindyWang@ssw.com.au
guid: f355fc30-7a9b-4288-8ef9-2dc8d8366c6b
isArchived: false
lastUpdated: 2016-08-15 18:33:17+00:00
lastUpdatedBy: Tiago Araujo
lastUpdatedByEmail: TiagoAraujo@ssw.com.au
redirects: []
seoDescription: Ensure a smooth user experience by deploying applications correctly,
  avoiding common issues such as inaccessible SQL Server databases or incorrect installation
  directories.
...
<imageEmbed
  ...
  figureText={"Wise Prompts the user for the installation directory and sets the path to a property in wise called \"INSTALLDIR\""}
