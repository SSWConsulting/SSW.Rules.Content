...
<imageEmbed
  ...
  caption={"Main elements of an SSW product logo"}
...
<imageEmbed
  ...
  caption={"Good Example - Colour variations of the SSW TimePro logo"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example - Vertical version of TimePro logo"}
