...
created: 2019-11-12 05:37:38+00:00
...
seoDescription: Create a recognisable product logo that reflects your brand's core
  visual language and colors to make a lasting positive impression on users or customers.
...
<imageEmbed
  ...
  figureText={"Main elements of an SSW product logo"}
...
<imageEmbed
  ...
  figureText={"Good Example - Colour variations of the SSW TimePro logo"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example - Vertical version of TimePro logo"}
