...
<imageEmbed
  ...
  caption={"Bad Example - Managing Request Validation within the Controller"}
...
<imageEmbed
  ...
  caption={"OK Example - Validation Handled Manually within Request Handler Ensuring All Requests are Validated"}
...
<imageEmbed
  ...
  caption={"Good Example - Automatically Validate All Requests By Using a MediatR Pipeline Behaviour"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good Example – Use an ExceptionFilterAttribute to Catch and Handle Exceptions within the Web API"}
