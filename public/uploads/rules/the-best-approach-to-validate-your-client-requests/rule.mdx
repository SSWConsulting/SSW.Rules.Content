...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Managing Request Validation within the Controller"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="ok"
  figure="Validation Handled Manually within Request Handler Ensuring All Requests are Validated"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Automatically Validate All Requests By Using a MediatR Pipeline Behaviour"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Use an ExceptionFilterAttribute to Catch and Handle Exceptions within the Web API"
