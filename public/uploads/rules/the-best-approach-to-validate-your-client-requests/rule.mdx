...
<imageEmbed
  ...
  captionText={"Bad Example - Managing Request Validation within the Controller"}
...
<imageEmbed
  ...
  captionText={"OK Example - Validation Handled Manually within Request Handler Ensuring All Requests are Validated"}
...
<imageEmbed
  ...
  captionText={"Good Example - Automatically Validate All Requests By Using a MediatR Pipeline Behaviour"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good Example – Use an ExceptionFilterAttribute to Catch and Handle Exceptions within the Web API"}
