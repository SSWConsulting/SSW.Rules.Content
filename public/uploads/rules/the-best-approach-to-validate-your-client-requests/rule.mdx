...
<imageEmbed
  ...
  figureText={"Bad Example - Managing Request Validation within the Controller"}
...
<imageEmbed
  ...
  figureText={"OK Example - Validation Handled Manually within Request Handler Ensuring All Requests are Validated"}
...
<imageEmbed
  ...
  figureText={"Good Example - Automatically Validate All Requests By Using a MediatR Pipeline Behaviour"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good Example – Use an ExceptionFilterAttribute to Catch and Handle Exceptions within the Web API"}
