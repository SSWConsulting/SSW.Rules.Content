---
type: rule
title: "Do you >- — shot prompts?"
  Do you know when to use 0-shot, 1-shot, or multi-shot prompts (e.g. give it 1
  or more examples)?
uri: shot-prompts
categories:
  - category: >-
...
seoDescription: >-
  Unlock optimal interactions with ChatGPT by mastering 0-shot, 1-shot, and
  multi-shot prompts.
...
Use 1-shot prompts when a single example will help the model understand the output style.
...
<boxEmbed
  ...
  body={<>
    ...
    'I love playing soccer.' ➡️ 'J'aime jouer au football.'
...
<boxEmbed
  ...
  body={<>
    ...
    * 'I love playing soccer.' ➡️ 'J'aime jouer au football.'
    * 'The weather is nice today.' ➡️ 'Le temps est agréable aujourd'hui.'
