---
type: rule
title: Do you know when to use 0-shot, 1-shot, or multi-shot prompts (e.g. give it
  1 or more examples)?
uri: shot-prompts
categories:
...
seoDescription: Unlock optimal interactions with ChatGPT by mastering 0-shot, 1-shot,
  and multi-shot prompts.
created: 2023-04-12 13:55:36.349000+00:00
