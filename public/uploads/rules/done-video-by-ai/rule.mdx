...
lastUpdated: '2026-09-03T04:48:30.769Z'
...
## How the agent checks its  work and creates a done video
...
## Where your Done screenshots/videos goes
...
<imageEmbed alt="ai-capture-ui-changes" size="large" showBorder={false} figurePrefix="none" figure="Taking advantage of tools that easily integrate with agents allows for automated UI checks" src="/uploads/rules/ai-capture-ui-changes/ai-capture-ui-change.png" />
