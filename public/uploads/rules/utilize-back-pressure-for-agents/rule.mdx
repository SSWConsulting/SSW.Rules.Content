...
seoDescription: Learn how to use back pressure (compilers, linters, tests, MCP servers)
  to improve AI agent reliability and reduce manual review time.
created: 2026-01-29 00:00:00+00:00
createdBy: Eddie Kranz
createdByEmail: EddieKranz@ssw.com.au
lastUpdated: 2026-01-30 06:49:10.035000+00:00
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="The human wastes time acting as the validator"
/>
...
5. Success → Only then does it request human review
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="The agent uses the linter to self-correct before bothering the user"
/>
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Logic errors are caught manually by the human"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="The agent uses tests as back pressure to ensure correctness"
/>
