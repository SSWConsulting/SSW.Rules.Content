...
lastUpdated: 2026-07-14T21:50:33.087Z
...
Say the Product Owner asks you to prioritize and update PBI 1234. Should you send an email OR update the PBI?
...
<emailEmbed
  ...
  figurePrefix="bad"
  figure="Don't use emails for tasks updates"
/>
...
<boxEmbed
  style="greybox"
  body={<>
    *"I have found and updated the PBI and moved it near the top of the backlog"*
  </>}
  figurePrefix="bad"
  figure="Change documented in the backlog, but no @mention tag used"
/>

<boxEmbed
  style="greybox"
  body={<>
    *"I have found and updated the PBI, prioritized it near the top of the backlog, and @mentioned you and relevant team members so you know when it is actioned"*
  </>}
  figurePrefix="good"
  figure="Change documented in the backlog and @mention tag included"
/>
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Using &#x22;Cc&#x22; and greetings as you would in an email. Emojis are helpful too! 😊" src="/uploads/rules/when-you-use-mentions-in-a-pbi/pbi-formatting-mentions.png" />
...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Using @ mentions in GitHub" src="/uploads/rules/when-you-use-mentions-in-a-pbi/MicrosoftTeams-image.png" />

### Azure DevOps PBIs

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="good" figure="Using @mentions in Azure DevOps discussion" src="/uploads/rules/when-you-use-mentions-in-a-pbi/good-mention-pbi.jpg" />

<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="good" figure="Emails are sent to the users who are mentioned in the discussion, so they can still chime in if any details are needed" src="/uploads/rules/when-you-use-mentions-in-a-pbi/pbi-mention-email.png" />
