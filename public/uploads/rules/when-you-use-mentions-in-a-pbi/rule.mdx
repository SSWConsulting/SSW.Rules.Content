...
As per my conversation with the PO, we want to use a third party quiz engine instead of building our own. This is a priority.
  ...
  caption={"Bad example – Don't use emails for tasks updates"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  caption={"Bad example - Change documented in the backlog, but no @mention tag used"}
/>
...
<boxEmbed
  ...
  caption={"Good example - Change documented in the backlog and @mention tag included"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Using \"Cc\" and greetings as you would in an email. Emojis are helpful too! 😊"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Using @ mentions in GitHub"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Using @mentions in Azure DevOps discussion"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example – Emails are sent to the users who are mentioned in the discussion, so they can still chime in if any details are needed"}
