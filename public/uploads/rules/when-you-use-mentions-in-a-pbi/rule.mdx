...
As per my conversation with the PO, we want to use a third party quiz engine instead of building our own. This is a priority.
  ...
  figureText={"Bad example – Don't use emails for tasks updates"}
/>
...
<imageEmbed
  ...
  figureText={"Good example – Using \"Cc\" and greetings as you would in an email. Emojis are helpful too! 😊"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – Using @ mentions in GitHub"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – Using @mentions in Azure DevOps discussion"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example – Emails are sent to the users who are mentioned in the discussion, so they can still chime in if any details are needed"}
