...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure='Using "Cc" and greetings as you would in an email. Emojis are helpful too! 😊'
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using @ mentions in GitHub"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using @mentions in Azure DevOps discussion"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Emails are sent to the users who are mentioned in the discussion, so they can still chime in if any details are needed"
