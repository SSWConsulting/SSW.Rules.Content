...
isArchived: false
lastUpdated: 2025-05-06 10:16:01+00:00
...
As per my conversation with the PO, we want to use a third party quiz engine instead of building our own. This is a priority.
  ...
  captionText={"Bad example – Don't use emails for tasks updates"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - Change documented in the backlog, but no @mention tag used"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - Change documented in the backlog and @mention tag included"}
/>
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – Using \"Cc\" and greetings as you would in an email. Emojis are helpful too! 😊"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – Using @ mentions in GitHub"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – Using @mentions in Azure DevOps discussion"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example – Emails are sent to the users who are mentioned in the discussion, so they can still chime in if any details are needed"}
