...
<imageEmbed
  ...
  figureText={"Use Browse Architectures to find a reference architecture that matches your application"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Use Explore Best Practices to find information on particular best practice"}
