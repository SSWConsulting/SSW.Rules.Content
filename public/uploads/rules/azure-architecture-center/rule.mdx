...
created: 2022-02-17 06:36:44+00:00
...
seoDescription: Azure Architecture Center provides a comprehensive library of reference
  implementations and best practices to help you design and deploy well-architected
  solutions on Azure.
...
<imageEmbed
  ...
  captionText={"Use Browse Architectures to find a reference architecture that matches your application"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Use Explore Best Practices to find information on particular best practice"}
