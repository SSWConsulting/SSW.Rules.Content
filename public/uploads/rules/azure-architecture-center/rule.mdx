...
<imageEmbed
  ...
  caption={"Use Browse Architectures to find a reference architecture that matches your application"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Use Explore Best Practices to find information on particular best practice"}
