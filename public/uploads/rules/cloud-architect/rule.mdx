...
No SpendOps
  ...
  figurePrefix="bad"
  figure="Without a Cloud Architect, teams risk wrong tech choices, security gaps, and wasted spend"
/>
...
* SpendOps
  ...
  figurePrefix="good"
  figure="Even part-time Cloud Architect involvement covers load, security, and SpendOps from day one"
/>
