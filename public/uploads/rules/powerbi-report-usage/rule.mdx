...
created: 2023-10-26 22:54:56+00:00
...
seoDescription: Power BI report usage monitoring provides valuable insights into reporting
  effectiveness, optimizing content and resources, and enhancing user experience.
...
<imageEmbed
  ...
  captionText={"From Workspace - click “More Options (…)” | “View usage metrics report”"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"From Report - click “More Options (…)” | “Open usage metrics”"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Toggle New usage report"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Save a copy of the report - click File | Save a copy"}
