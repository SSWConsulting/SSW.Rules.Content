...
<imageEmbed
  ...
  caption={"From Workspace - click “More Options (…)” | “View usage metrics report”"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"From Report - click “More Options (…)” | “Open usage metrics”"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Toggle New usage report"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Save a copy of the report - click File | Save a copy"}
