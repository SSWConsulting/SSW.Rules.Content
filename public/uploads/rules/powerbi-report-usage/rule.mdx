...
<imageEmbed
  ...
  figureText={"From Workspace - click “More Options (…)” | “View usage metrics report”"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"From Report - click “More Options (…)” | “Open usage metrics”"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Toggle New usage report"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Save a copy of the report - click File | Save a copy"}
