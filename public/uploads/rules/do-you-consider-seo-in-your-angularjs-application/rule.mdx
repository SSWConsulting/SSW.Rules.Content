...
created: 2014-10-31 00:22:28+00:00
...
redirects: []
seoDescription: Optimise your AngularJS Single Page Application (SPA) for search engines
  by pre-rendering HTML and using libraries to help Google bots crawl your site correctly.
...
<imageEmbed
  ...
  figureText={"How to configure your site to pre-render HTML for Google bots."}
