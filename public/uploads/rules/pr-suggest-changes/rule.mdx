...
created: 2024-09-05 04:50:21+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - GitHub - Using change X to Y format (need to copy+paste changes)"}
...
<imageEmbed
  ...
  figureText={"Good example - GitHub - Using the 'Add a suggestion' button"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - GitHub - Easy to see what has changed + awesome 'Commit Suggestion' button ✨"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good exmample - Applying code suggestions in a batch"}
