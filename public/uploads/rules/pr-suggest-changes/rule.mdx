...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="GitHub - Using change X to Y format (need to copy+paste changes)"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="GitHub - Using the 'Add a suggestion' button"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="GitHub - Easy to see what has changed + awesome 'Commit Suggestion' button ✨"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Applying code suggestions in a batch"
