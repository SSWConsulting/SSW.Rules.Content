...
<imageEmbed
  ...
  captionText={"Bad example - GitHub - Using change X to Y format (need to copy+paste changes)"}
...
<imageEmbed
  ...
  captionText={"Good example - GitHub - Using the 'Add a suggestion' button"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - GitHub - Easy to see what has changed + awesome 'Commit Suggestion' button ✨"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good exmample - Applying code suggestions in a batch"}
