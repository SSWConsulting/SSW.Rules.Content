---
seoDescription: Discover how to set up a TFS hosting environment and connect with
  ease. Learn the steps for connecting to your Visual Studio server, accessing project
  portals, reports, and downloading builds from your build server.
type: rule
title: Do you know how to do a TFS hosting setup?
uri: tfs-hosting-setup
authors:
- author: alumni
created: 2021-08-05 18:25:34.531000+00:00
...
![Figure 1 - Click on Connect To Team Foundation Server](/uploads/rules/tfs-hosting-setup/connecttotfs.jpeg)

3. Click on Servers | Add
4. Enter the Server Name of tfs.ssw.com.au

![Figure 2 - Enter the server name](/uploads/rules/tfs-hosting-setup/enterservername.jpeg)
...
![Figure 3 - Select your Team Project Collections and associated Team Projects](/uploads/rules/tfs-hosting-setup/teamproject.jpeg)

7. You should now see the Team Projects you selected in the Team Explorer

![Figure 4 - The Projects now appear in the Team Explorer](/uploads/rules/tfs-hosting-setup/projectinteamexplorer.jpeg)
...
![Figure 5 - Right click on your Project and click Show Project Portal to launch the SharePoint Portal](/uploads/rules/tfs-hosting-setup/findprojectportal.jpeg)
...
![Figure 6 - In your project, right click on Reports and select Show Report Site to view that projects reports](/uploads/rules/tfs-hosting-setup/viewreport.jpeg)
...
![Figure 7 - Fill in Host, Port, Server Type, Login Type, User and Password](/uploads/rules/tfs-hosting-setup/setupsftpsite.jpeg)
