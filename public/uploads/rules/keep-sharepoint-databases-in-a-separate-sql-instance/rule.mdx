...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - mixed with other systems\' database](sharepoint-database-bad.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - SharePoint related databases are in a separate SQL instance from other systems\' databases](sharepoint-database-good.png)',
  shouldDisplay: true
} } />
