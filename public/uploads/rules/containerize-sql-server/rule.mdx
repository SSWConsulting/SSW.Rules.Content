...
created: 2023-05-23 23:26:45.823000+00:00
...
<youtubeEmbed url="fFpDf5si_Hw" description="Video: Run SQL Server in Docker! (5 min)" />
...
For SQL Server with Docker, use the official Microsoft image:

* **Microsoft SQL Server** - `mcr.microsoft.com/mssql/server` (recommended)


<boxEmbed
  style="info"
  body={<>
    **Note:** If you are on Apple Silicon or another ARM machine, check Microsoft's guidance on [running SQL Server in containers on macOS](https://devblogs.microsoft.com/azure-sql/development-with-sql-in-containers-on-macos/) for the current ARM support and workarounds.
  </>}
  figurePrefix="none"
  figure=""
/>
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Running a SQL Server environment outside a container"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Using Docker to containerize a SQL Server environment"
