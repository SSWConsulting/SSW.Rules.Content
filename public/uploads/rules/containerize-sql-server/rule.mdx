...
<imageEmbed
  ...
  figureText={"Bad example - Running a SQL Server environment outside a container"}
...
<imageEmbed
  ...
  figureText={"Good example - Using Docker to containerize a SQL Server environment"}
