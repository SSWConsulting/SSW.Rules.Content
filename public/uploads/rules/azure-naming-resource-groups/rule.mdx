...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="A rogue dev resource in the Production RG"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Staging and Prod resources in the same RG"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="SSW.SQL has all the Databases for different apps in one place"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Resource Group contains all staging resources for this product"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Adding underlying infrastructure to the same Resource Group can save $"
