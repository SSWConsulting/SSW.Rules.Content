...
<imageEmbed
  ...
  caption={"Bad example - A rogue dev resource in the Production RG"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Staging and Prod resources in the same RG"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - SSW.SQL has all the Databases for different apps in one place"}
...
<imageEmbed
  ...
  caption={"Good example (for all the above) - Resource Group contains all staging resources for this product"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Adding underlying infrastructure to the same Resource Group can save $"}
