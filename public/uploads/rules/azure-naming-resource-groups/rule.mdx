...
created: 2022-05-19 02:54:44+00:00
...
isArchived: false
lastUpdated: 2025-03-19 18:45:16+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - A rogue dev resource in the Production RG"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Staging and Prod resources in the same RG"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - SSW.SQL has all the Databases for different apps in one place"}
...
<imageEmbed
  ...
  captionText={"Good example (for all the above) - Resource Group contains all staging resources for this product"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Adding underlying infrastructure to the same Resource Group can save $"}
