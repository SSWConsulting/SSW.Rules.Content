...
<imageEmbed
  ...
  figureText={"Bad example - A rogue dev resource in the Production RG"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Staging and Prod resources in the same RG"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - SSW.SQL has all the Databases for different apps in one place"}
...
<imageEmbed
  ...
  figureText={"Good example (for all the above) - Resource Group contains all staging resources for this product"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Adding underlying infrastructure to the same Resource Group can save $"}
