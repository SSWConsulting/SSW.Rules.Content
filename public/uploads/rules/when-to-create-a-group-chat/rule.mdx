...
created: 2022-06-30 06:48:09+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - Mentioning someone in a chat they are not participating"}
...
<imageEmbed
  ...
  captionText={"Good example - Initiating a group chat with everyone involved"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Not a good time to call Adam and William as they're both \"in a call\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - It's a good time to call Bryden and Lachie as they're both available"}
