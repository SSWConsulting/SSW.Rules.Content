...
<imageEmbed
  ...
  figureText={"Bad example - Mentioning someone in a chat they are not participating"}
...
<imageEmbed
  ...
  figureText={"Good example - Initiating a group chat with everyone involved"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Not a good time to call Adam and William as they're both \"in a call\""}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - It's a good time to call Bryden and Lachie as they're both available"}
