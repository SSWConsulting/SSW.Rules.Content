...
<imageEmbed
  ...
  caption={"Bad example - Mentioning someone in a chat they are not participating"}
...
<imageEmbed
  ...
  caption={"Good example - Initiating a group chat with everyone involved"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad example - Not a good time to call Adam and William as they're both \"in a call\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - It's a good time to call Bryden and Lachie as they're both available"}
