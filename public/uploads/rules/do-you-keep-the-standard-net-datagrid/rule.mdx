...
<imageEmbed
  ...
  figureText={"Bad example - The standard .NET DataGrid in 2003 was ugly and missing combos"}
...
<imageEmbed
  ...
  figureText={"Figure: Better example - Infragistics UltraGrid is better as you get combos"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Janus Grid is even better. A great datagrid has easy grouping, just like Outlook"}
...
<imageEmbed
  ...
  figureText={"The great new Visual Studio 2005 much improved DataGridView"}
