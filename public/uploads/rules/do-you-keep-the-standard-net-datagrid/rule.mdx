---
seoDescription: Upgrade to the improved .NET DataGridView control in Visual Studio
  2005 or explore top-rated third-party alternatives for advanced data grid features.
type: rule
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="The standard .NET DataGrid in 2003 was ugly and missing combos"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Janus Grid is even better. A great datagrid has easy grouping, just like Outlook"
