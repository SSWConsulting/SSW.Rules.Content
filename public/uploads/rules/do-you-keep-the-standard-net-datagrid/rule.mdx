...
<imageEmbed
  ...
  captionText={"Bad example - The standard .NET DataGrid in 2003 was ugly and missing combos"}
...
<imageEmbed
  ...
  captionText={"Figure: Better example - Infragistics UltraGrid is better as you get combos"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Janus Grid is even better. A great datagrid has easy grouping, just like Outlook"}
...
<imageEmbed
  ...
  captionText={"The great new Visual Studio 2005 much improved DataGridView"}
