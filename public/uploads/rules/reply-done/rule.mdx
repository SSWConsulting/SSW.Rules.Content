...
lastUpdated: 2026-03-30T02:01:04.073Z
lastUpdatedBy: Josh Berman
lastUpdatedByEmail: JoshBerman@ssw.com.au
archivedreason: null
---

This is some randomThis is some randomThis is some randomThis

 is some random

This is some randomThis is some randomThis is some rando
mThis is some randomThis is some random
...
* If you don't agree with the task or are unable to complete the task:
  ...
  2. If you still don't agree or the task is still blocked, reply "<mark style="background-color: #FEF08A">Not done - </mark><mark style="background-color: #FEF08A">[as per our conversation](/as-per-our-conversation-emails)</mark><mark style="background-color: #FEF08A">, the reason is XXX</mark>"
