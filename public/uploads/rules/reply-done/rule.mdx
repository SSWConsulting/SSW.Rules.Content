...
seoDescription: >-
  When reassigning tasks, reply with "Done" and provide a URL link if
  applicable.
...
Read about the [Definition of Done](/definition-of-done) for more information about the steps that need to be finished before replying to a done email.
...
* If you have added the email to your backlog or to-do list, then say "Added to backlog – {{ URL }}". You should still reply "Done" when you complete the task
...
* If you don't agree with the task or are unable to complete the task:
  ...
  2. If you still don't agree or the task is still blocked, reply "Not done - [as per our conversation](/as-per-our-conversation-emails), the reason is {{ REASON }}"
...
When replying 'Done' to a bug or issue someone reported, **remember to thank the person** for taking the time to send it. A short "Thank you for reporting this" helps to make your response warmer.
