...
Not done - as per our conversation, I've checked with Northwind and they're happy with the form as it is
  ...
  caption={"Good example - \"Not done\" email"}
/>
...
Bob
  ...
  caption={"Original email with the client request"}
/>
...
Jason
  ...
  caption={"Bad example – It is not clear which tasks have been done and which haven't"}
/>
...
Bob
  ...
  captionStyle="badExample"
  caption={"Bad example – It is clear which tasks have been done, however, [replying inline should be avoided](/email-avoid-inline) as it messes up the history"}
/>
...
Bob
  ...
  captionStyle="badExample"
  caption={"Bad example – You can imply which tasks have been done by looking at the history, however it is painful, and [numbered lists are for tasks only](/number-tasks-questions)"}
/>
...
1. Action \#2 above once I get the camera from Peter tomorrow
  ...
  captionStyle="goodExample"
  caption={"Good example – It is very clear which tasks have been done and which haven't. Quoting the original task is only necessary when some tasks are done and some are not see [Do you use indentation for readability?](/indent)"}
/>
...
Jason
  ...
  captionStyle="goodExample"
  caption={"Good example – If multiple tasks are clearly 'done', then replying \"All done\" is a good way to simplify things"}
/>
...
Jason
  ...
  captionStyle="goodExample"
  caption={"Good example - This \"Done\" uses text instead of an image so it is easier to search; to copy and paste; and to reply with a modification"}
/>
