...
<imageEmbed
  ...
  figureText={"Create the Workflow"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Stop and cancel if ‘Est Value’ greater than $100,000"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Lead cannot be saved if Est value is greater than $100,000"}
