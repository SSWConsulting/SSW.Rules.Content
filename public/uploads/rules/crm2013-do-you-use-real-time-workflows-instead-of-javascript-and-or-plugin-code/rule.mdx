...
<imageEmbed
  ...
  captionText={"Create the Workflow"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Stop and cancel if ‘Est Value’ greater than $100,000"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Lead cannot be saved if Est value is greater than $100,000"}
