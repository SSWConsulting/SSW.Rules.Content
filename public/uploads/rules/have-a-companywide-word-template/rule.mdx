...
<imageEmbed
  ...
  captionText={"Bad example - Creating an email/document does not have the company templates"}
...
<imageEmbed
  ...
  captionText={"Good example - Creating an email/document with the company templates"}
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - New Login script on Github"}
/>
