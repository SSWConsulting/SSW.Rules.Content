...
isArchived: false
lastUpdated: 2020-07-11 05:17:31+00:00
...
<imageEmbed
  ...
  figureText={"Bad example - Creating an email/document does not have the company templates"}
...
<imageEmbed
  ...
  figureText={"Good example - Creating an email/document with the company templates"}
