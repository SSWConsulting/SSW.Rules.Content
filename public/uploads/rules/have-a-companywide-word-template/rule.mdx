...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Creating an email/document does not have the company templates"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Creating an email/document with the company templates"
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="New Login script on Github"
/>
