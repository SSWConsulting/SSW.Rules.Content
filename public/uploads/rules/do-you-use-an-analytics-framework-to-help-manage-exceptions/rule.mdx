...
isArchived: false
lastUpdated: 2025-10-29 21:14:34+00:00
...
<imageEmbed
  ...
  caption={"PostHog dashboard showing key metrics at a glance"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Session replay in PostHog helps you see exactly what the user experienced"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Track feature adoption and performance in real-time with custom events"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Exception reporting with full context helps you fix issues faster"}
