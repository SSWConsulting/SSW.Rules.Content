...
seoDescription: Use an analytics framework to gain control over your application's
  performance, exceptions, and usage, allowing you to identify and address issues
  effectively.
...
<imageEmbed
  ...
  captionText={"PostHog dashboard showing key metrics at a glance"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Session replay in PostHog helps you see exactly what the user experienced"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Track feature adoption and performance in real-time with custom events"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Exception reporting with full context helps you fix issues faster"}
