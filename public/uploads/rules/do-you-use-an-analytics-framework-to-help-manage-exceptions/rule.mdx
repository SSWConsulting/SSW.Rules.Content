...
<imageEmbed
  ...
  figureText={"PostHog dashboard showing key metrics at a glance"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Session replay in PostHog helps you see exactly what the user experienced"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Track feature adoption and performance in real-time with custom events"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Exception reporting with full context helps you fix issues faster"}
