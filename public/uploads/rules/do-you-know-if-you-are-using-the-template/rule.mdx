...
<imageEmbed
  ...
  figureText={"Bad example - Not using the corporate template (in this case not SSW)"}
...
<imageEmbed
  ...
  figureText={"Good example - That's a mighty fine looking template you got there"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Your custom template appears in PowerPoint"}
