---
type: rule
title: Do you use PowerPoint templates?
...
lastUpdated: 2026-04-15T22:25:26.227Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Not using the corporate template (in this case not SSW)" src="/uploads/rules/do-you-know-if-you-are-using-the-template/bad_cover.gif" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="That's a mighty fine looking template you got there" src="/uploads/rules/do-you-know-if-you-are-using-the-template/goodcoverv2.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Your custom template appears in PowerPoint" src="/uploads/rules/do-you-know-if-you-are-using-the-template/DefaultTheme.png" />
