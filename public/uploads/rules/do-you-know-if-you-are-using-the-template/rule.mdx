...
<imageEmbed
  ...
  captionText={"Bad example - Not using the corporate template (in this case not SSW)"}
...
<imageEmbed
  ...
  captionText={"Good example - That's a mighty fine looking template you got there"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Your custom template appears in PowerPoint"}
