...
isArchived: false
lastUpdated: 2020-12-21 15:36:42+00:00
...
<boxEmbed
  style="greybox"
  body={<>
    This new feature is important if the user runs long tasks. At the end of a process, <mark style="background-color: #FEF08A">he</mark> will know the amount of time spent. Now that the status bar shows the time taken and progress percentage, <mark style="background-color: #FEF08A">he</mark> can evaluate how long it will take beforehand. Then <mark style="background-color: #FEF08A">he</mark> can go get a cup of coffee.
  </>}
  figurePrefix="bad"
  figure='User referred to as "he"'
/>
...
<boxEmbed
  style="greybox"
  body={<>
    This new feature is important if the user runs long tasks. At the end of a process, <mark style="background-color: #FEF08A">they</mark> will know the amount of time spent. Now that the status bar shows the time taken and progress percentage, <mark style="background-color: #FEF08A">they</mark> can evaluate how long it will take beforehand. Then <mark style="background-color: #FEF08A">they</mark> can go get a cup of coffee.
  </>}
  figurePrefix="good"
  figure='User referred to as "they"'
/>
