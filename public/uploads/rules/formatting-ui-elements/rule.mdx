...
<boxEmbed
  ...
  captionText={"Bad Example - It's not clear that \"Save\" is a control"}
/>
...
<boxEmbed
  ...
  captionText={"Good example - Using bold for buttons and menu options"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - Using quotes for exact text users should type"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - Using quotation marks for exact text users may type"}
/>