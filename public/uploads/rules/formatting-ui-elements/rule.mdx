...
<boxEmbed
  ...
  caption={"Bad Example - It's not clear that \"Save\" is a control"}
/>
...
<boxEmbed
  ...
  caption={"Good example - Using bold for buttons and menu options"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Using quotes for exact text users should type"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  caption={"Good example - Using quotation marks for exact text users may type"}
/>