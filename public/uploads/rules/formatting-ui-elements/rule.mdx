...
created: 2016-04-21 02:57:12+00:00
...
<boxEmbed
  ...
  figureText={"Bad Example - It's not clear that \"Save\" is a control"}
/>
...
<boxEmbed
  ...
  figureText={"Good example - Using bold for buttons and menu options"}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Using quotes for exact text users should type"}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - Using quotation marks for exact text users may type"}
/>