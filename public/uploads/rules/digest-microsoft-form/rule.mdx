...
<imageEmbed
  ...
  caption={"Good example - Microsoft Forms is great at displaying structured results like this"}
...
<imageEmbed
  ...
  caption={"Bad example - This tells us nothing about people's answers!"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - The output of our AI survey results digest, much cleaner with a helpful 'sentiment' column!"}
