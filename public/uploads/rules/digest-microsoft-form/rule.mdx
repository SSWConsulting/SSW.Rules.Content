...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Microsoft Forms is great at displaying structured results like this"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This tells us nothing about people's answers!"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="The output of our AI survey results digest, much cleaner with a helpful 'sentiment' column!"
