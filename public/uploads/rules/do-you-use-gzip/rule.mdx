...
<imageEmbed
  ...
  caption={"Choose the website which you want to use Gzip and click on Compression"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Install \"dynamic content compression\" if you haven't installed it"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Click \"OK\" to install it"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Enable dynamic content compression for your site"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"\"Finish configuration like that"}
...
<imageEmbed
  ...
  caption={"Good example - Gzipped files with smaller size and faster load time"}
