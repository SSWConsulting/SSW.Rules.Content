...
<imageEmbed
  ...
  figureText={"Choose the website which you want to use Gzip and click on Compression"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Install \"dynamic content compression\" if you haven't installed it"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Click \"OK\" to install it"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Enable dynamic content compression for your site"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"\"Finish configuration like that"}
...
<imageEmbed
  ...
  figureText={"Good example - Gzipped files with smaller size and faster load time"}
