...
<imageEmbed
  ...
  captionText={"Choose the website which you want to use Gzip and click on Compression"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Install \"dynamic content compression\" if you haven't installed it"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Click \"OK\" to install it"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Enable dynamic content compression for your site"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"\"Finish configuration like that"}
...
<imageEmbed
  ...
  captionText={"Good example - Gzipped files with smaller size and faster load time"}
