...
<imageEmbed
  ...
  figureText={"Create a Lead, then become familiar with the time saving \"Qualify\" button"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"CRM 2013 also checks for existing records before creating new ones"}
