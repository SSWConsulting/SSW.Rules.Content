...
seoDescription: Boost Windows SOE setup speed with package managers like Chocolatey
  and Winget for small to medium-sized companies or BYOD environments.
...
<imageEmbed
  ...
  captionText={"Example login/branding script"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Example package manager - using chocolatey to install required software"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Company branding on laptop"}
