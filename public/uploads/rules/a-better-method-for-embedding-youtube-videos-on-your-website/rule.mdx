...
<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="none" figure="A side by side comparison – everyone wants less requests and a smaller page size" src="/uploads/rules/a-better-method-for-embedding-youtube-videos-on-your-website/video-embed-load-time.png" />

<imageEmbed alt="Image" size="large" showBorder={true} figurePrefix="bad" figure="Don’t add embed code directly from YouTube. For more details read &#x22;A Better Method for Embedding YouTube Videos on your Website&#x22;" src="/uploads/rules/a-better-method-for-embedding-youtube-videos-on-your-website/video-embed-bad.png" />
