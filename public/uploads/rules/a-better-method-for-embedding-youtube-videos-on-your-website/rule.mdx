...
<imageEmbed
  ...
  captionText={"A side by side comparison – everyone wants less requests and a smaller page size"}
...
<imageEmbed
  ...
  captionText={"Bad example - Don’t add embed code directly from YouTube. For more details read \"A Better Method for Embedding YouTube Videos on your Website\""}
