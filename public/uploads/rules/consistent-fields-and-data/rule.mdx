...
<imageEmbed
  ...
  figureText={"Bad example - Fields are unnecessarily wide for their expected (short) values"}
...
<imageEmbed
  ...
  figureText={"Good example - Fields are sized appropriately for their expected values"}
