...
<imageEmbed
  ...
  figureText={"Bad example - Wrong color for a delete button"}
...
<imageEmbed
  ...
  figureText={"Good example - Red is the right color for a delete button"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - Cross icon usually means \"Cancel\" and should be avoided for permanent deletion. The button is also missing a text label"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example -  Button has a Trash/Bin icon positioned to the left of the text labe"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad example - \"Delete\" and \"Save\" are too close together, which can lead to accidental clicks"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - \"Delete\" button in red, with the right icon, and visually isolated from safe actions"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Confirming a deletion"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Tooltip gives clarity to an icon-only delete button"}
