...
lastUpdated: 2026-01-30 09:26:54.791000+00:00
lastUpdatedBy: Chloe
...
<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="bad" figure="Wrong color for a delete button" src="/uploads/rules/destructive-button-ui-ux/destruction-button-bad-color.png" />

<imageEmbed alt="Image" size="medium" showBorder={true} figurePrefix="good" figure="Red is the right color for a delete button" src="/uploads/rules/destructive-button-ui-ux/destruction-button-good-color.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Cross icon usually means &#x22;Cancel&#x22; and should be avoided for permanent deletion. The button is also missing a text label" src="/uploads/rules/destructive-button-ui-ux/destruction-button-bad-icon.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Button has a Trash/Bin icon positioned to the left of the text labe" src="/uploads/rules/destructive-button-ui-ux/destruction-button-good-icon.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="&#x22;Delete&#x22; and &#x22;Save&#x22; are too close together, which can lead to accidental clicks" src="/uploads/rules/destructive-button-ui-ux/destruction-button-bad-positioning.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="&#x22;Delete&#x22; button in red, with the right icon, and visually isolated from safe actions" src="/uploads/rules/destructive-button-ui-ux/destruction-button-good-positioning.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Confirming a deletion" src="/uploads/rules/destructive-button-ui-ux/destruction-button-good-confirmation.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Tooltip gives clarity to an icon-only delete button" src="/uploads/rules/destructive-button-ui-ux/destruction-button-good-tooltip.png" />
...
<boxEmbed
  ...
  body={<>
    ...
    * See [💄 UI/UX - Move "Delete Project" Button to follow destructive actions rule](https://github.com/SSWConsulting/SSW.YakShaver.Desktop/issues/52) for details
