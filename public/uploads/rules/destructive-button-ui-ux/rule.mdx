...
isArchived: false
lastUpdated: 2025-10-08 04:13:07+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - Wrong color for a delete button"}
...
<imageEmbed
  ...
  captionText={"Good example - Red is the right color for a delete button"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - Cross icon usually means \"Cancel\" and should be avoided for permanent deletion. The button is also missing a text label"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example -  Button has a Trash/Bin icon positioned to the left of the text labe"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  captionText={"Bad example - \"Delete\" and \"Save\" are too close together, which can lead to accidental clicks"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - \"Delete\" button in red, with the right icon, and visually isolated from safe actions"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Confirming a deletion"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Tooltip gives clarity to an icon-only delete button"}
