...
<imageEmbed
  ...
  captionText={"Bad example - Using your browser makes it hard to see the video is a mobile phone demo"}
...
<imageEmbed
  ...
  captionText={"Good example - Using Device Mode & Mobile Emulation in Chrome makes it clear the video is a mobile phone demo"}
...
<imageEmbed
  ...
  captionText={"How to adjust the video canvas in Camtasia to export HD video to YouTube"}
