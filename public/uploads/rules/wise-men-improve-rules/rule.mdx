...
A good standard should systemise the routine and humanise the exception. In other words, rules should make common decisions faster and more consistent, while still leaving room for judgement when the situation does not fit the usual pattern.
...
* They help maintain [consistency](/the-value-of-consistency)
...
2. Fix it yourself later if it's too big. In this case, [send yourself an email](/send-to-myself-emails)
3. Ask someone else to fix it following the [change "x" to "y"](/change-from-x-to-y)
