...
A good standard systematizes the routine and humanizes the exception. In other words, rules should make common decisions faster and more consistent, while still leaving room for judgment when the situation does not fit the usual pattern.
