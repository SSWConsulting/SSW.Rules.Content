...
isArchived: false
lastUpdated: 2019-12-23 06:04:02+00:00
...
<imageEmbed
  ...
  figureText={"This component manipulates the DOM directly to show and hide the menu"}
...
<imageEmbed
  ...
  figureText={"This component sets component state, which the template can use.  It is simpler, more descriptive and easier to test"}
