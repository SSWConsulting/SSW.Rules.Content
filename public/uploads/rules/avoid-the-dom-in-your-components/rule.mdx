...
<imageEmbed
  ...
  captionText={"This component manipulates the DOM directly to show and hide the menu"}
...
<imageEmbed
  ...
  captionText={"This component sets component state, which the template can use.  It is simpler, more descriptive and easier to test"}
