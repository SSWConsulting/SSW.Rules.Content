...
How am I supposed to know that? I'm almost certain The PBIs Acceptance Criteria said put it on the right.
  ...
  caption={"**Figure: Bad example - reacting immediately can lead to a bad decision 😡**"}
/>
...
This is quick to fix, so I'll do it now and send you a screenshot.
  ...
  caption={"**Figure: Good example - setting a timer disconnects the urge from the behavior (bad reaction)**"}
/>