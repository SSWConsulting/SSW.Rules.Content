...
lastUpdated: 2026-05-21T06:30:21.792Z
...
Facts get stored as typed nodes and edges. "Bob Northwind" →`WORKS_AT`→ "SSW". "SSW" →`BASED_IN`→ "Brisbane". Some systems layer time on top so relationships have validity windows: "Bob worked at Sydney from X to Y, currently at SSW from Y to now."
