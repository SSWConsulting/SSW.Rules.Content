...
lastUpdated: 2026-05-21T12:39:40.624Z
...
* **Working / in-context** - the current conversation window. RAM. Everything visible to the model right now. Close the session and it's gone. 
  * *Scope: single turn or session.*
* **Episodic** - what happened before. 
  * E.g. "The user asked about Resend in March."
  * E.g. "The build broke last Tuesday when we tried X." Tied to time and context. 
  * *Scope: past interactions.*
* **Semantic** - generalised facts. "Bob Northwind prefers self-hosted tooling." "Our test runner is vitest." Detached from when it was learned. 

*Scope: stable knowledge.*

* **Procedural** - how to do things. Workflows, learned skills, the agent's own operating instructions. The agent's "muscle memory." 
