---
archivedreason: Obsolete - Modern .NET versions (e.g., .NET 6 and later) provide better
  alternatives like DateTimeOffset and DateOnly for handling time zones and serialization.
authors:
- title: Adam Cogan
...
created: 2009-12-04 08:40:28+00:00
createdBy: CindyWang
...
redirects: []
seoDescription: Understand changes on Datetime in .NET 2.0 and .NET 1.1/1.0 for accurate
