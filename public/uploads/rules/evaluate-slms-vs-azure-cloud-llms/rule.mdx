---
seoDescription: Learn how to evaluate the performance of Small Language Models (SLMs)
  compared to Azure AI’s cloud-based LLMs to find the most cost-effective and efficient
  solution.
type: rule
...
authors:
- author: jernej-kavka
created: 2024-10-03 16:15:00+00:00
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Using Azure OpenAI services for simple FAQ tasks incurs high costs, while an SLM would be more cost-effective"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Choosing Azure OpenAI GPT-4o for complex tasks after evaluation provides better customer service and justifies the higher cost"
/>
