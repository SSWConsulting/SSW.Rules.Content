---
seoDescription: When casting IQueryable to IEnumerable and querying data afterwards,
  Entity Framework must collect the data at that point, resulting in significant extra
  database load and processing on the client side. Use AsEnumerable() instead for
...
created: 2021-12-13 17:00:03.219000+00:00
