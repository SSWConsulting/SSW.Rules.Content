...
created: 2021-12-13T23:24:44.000Z
guid: ee5bfbb5-7743-462b-bc8a-f32b3fb015b0
lastUpdated: 2021-12-21T06:30:45.000Z
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example - All these examples read the entire table instead of just returning the count from the database.",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - Only the count is returned by the query",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "badExample",
  figure: "Bad example - The whole table is returned from the database and then discarded in code.",
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "Good example - Filtering is done on the database before returning data.",
  shouldDisplay: true
} } />
