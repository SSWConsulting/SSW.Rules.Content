...
<imageEmbed
  ...
  captionText={"Bad example - Skipping environments"}
...
<imageEmbed
  ...
  captionText={"Good example - Internal or Small Projects have fewer environments"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Large or Multi-Team Projects tend to have more environments"}
