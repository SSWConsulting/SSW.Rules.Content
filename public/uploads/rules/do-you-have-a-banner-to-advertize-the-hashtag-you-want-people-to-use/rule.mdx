...
<imageEmbed
  ...
  captionText={"This Twitter widget shows the hashtags working"}
...
<imageEmbed
  ...
  captionText={"Good Example - SharePoint Conference 2014 banner to advertise the hashtag people should use"}
