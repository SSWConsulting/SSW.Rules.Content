...
<imageEmbed
  ...
  figureText={"Bad example - Storing sensitive data in Dynamics 365's  | Notes is insecure"}
...
<imageEmbed
  ...
  figureText={"Good example - Role based access to sensitive data"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - One-Time Share sensitive data for an hour"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - Keeper allows full auditing of all access"}
