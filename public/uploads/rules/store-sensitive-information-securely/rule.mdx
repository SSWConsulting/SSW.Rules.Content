...
- Using Dynamics 365's notes field for such data means there's no systematic way to track its accuracy, validity, or history.
  ...
  preset: "badExample",
  figure: '![Bad Example: Storing sensitive data in Dynamics 365\'s  | Notes is insecure](/uploads/rules/store-sensitive-information-securely/bad-example-crm-notesfield.png)
  :::
...
- **Role-Based Access Control**: Only authorized personnel can access and manage sensitive data. This ensures that sensitive information is not accidentally or intentionally accessed by unauthorized parties.',
 ...
 good
![Good Example: Role based access to sensitive data](/uploads/rules/store-sensitive-information-securely/keeper-goodexample-sharing.png)
:::
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good Example: One-Time Share sensitive data for an hour](/uploads/rules/store-sensitive-information-securely/keeper-onetime-sharing.png)',
  shouldDisplay: true
} } />
...
- **Auditing and Reporting**: Keeper provides detailed logs and reports, allowing for complete oversight and management of all data stored within.
  ::: good
  ![Good Example: Keeper allows full auditing of all access](/uploads/rules/store-sensitive-information-securely/keeper-good-example-auditreport.png)
  :::
