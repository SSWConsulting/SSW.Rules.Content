...
created: 2023-10-11 23:43:25+00:00
...
isArchived: false
lastUpdated: 2024-03-19 03:57:30+00:00
...
<imageEmbed
  ...
  captionText={"Bad example - Storing sensitive data in Dynamics 365's  | Notes is insecure"}
...
<imageEmbed
  ...
  captionText={"Good example - Role based access to sensitive data"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - One-Time Share sensitive data for an hour"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  captionText={"Good example - Keeper allows full auditing of all access"}
