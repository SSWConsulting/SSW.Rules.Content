...
<imageEmbed
  ...
  caption={"Bad example - Storing sensitive data in Dynamics 365's  | Notes is insecure"}
...
<imageEmbed
  ...
  caption={"Good example - Role based access to sensitive data"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - One-Time Share sensitive data for an hour"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Keeper allows full auditing of all access"}
