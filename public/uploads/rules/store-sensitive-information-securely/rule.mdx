...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Storing sensitive data in Dynamics 365's  | Notes is insecure"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Role based access to sensitive data"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="One-Time Share sensitive data for an hour"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Keeper allows full auditing of all access"
