...
<figureEmbed figureEmbed={{
  preset: "badExample",
  figure: '![Bad example - "Having lunch" is not an interesting tweet](bad-twitter.png)',
  shouldDisplay: true
} } />
...
<figureEmbed figureEmbed={{
  preset: "goodExample",
  figure: '![Good example - An informative tweet with hashtags and relevant links for a targeted audience of IT followers](good-twitter.png)',
  shouldDisplay: true
} } />
