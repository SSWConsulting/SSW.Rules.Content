...
<imageEmbed
  ...
  figureText={"Bad example - \"Having lunch\" is not an interesting tweet"}
...
<imageEmbed
  ...
  figureText={"Good example - An informative tweet with hashtags and relevant links for a targeted audience of IT followers"}
