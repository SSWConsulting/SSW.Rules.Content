...
<imageEmbed
  ...
  captionText={"Bad example - Fingerprint scanners may give an inconsistent User Experience, not fun for your guests"}
...
<imageEmbed
  ...
  captionText={"Good example - Access Systems allow you to use NFC devices to easily access the premises!"}
