...
<imageEmbed
  ...
  caption={"Bad example - Fingerprint scanners may give an inconsistent User Experience, not fun for your guests"}
...
<imageEmbed
  ...
  caption={"Good example - Access Systems allow you to use NFC devices to easily access the premises!"}
