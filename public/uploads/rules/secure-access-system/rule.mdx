...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="bad"
  figure="Fingerprint scanners may give an inconsistent User Experience, not fun for your guests"
...
<imageEmbed
  ...
  showBorder={true}
  figurePrefix="good"
  figure="Access Systems allow you to use NFC devices to easily access the premises!"
