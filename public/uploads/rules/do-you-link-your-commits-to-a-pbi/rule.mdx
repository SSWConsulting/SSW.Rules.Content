...
<imageEmbed
  ...
  caption={"Bad example - No linked commits, branches or pull requests"}
...
<imageEmbed
  ...
  caption={"Good example - Git branch linked to PBI in Azure DevOps"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Using Azure DevOps to link PBI during creation"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - Branch Policy on the master branch to enforce linked work items on pull requests"}
