...
<imageEmbed
  ...
  caption={"Bad example - Presenters View in PowerPoint auto changes the screen mode to 'Extended'"}
...
<imageEmbed
  ...
  caption={"Good example - Hardware capture lets you record exactly what you want, and is ready for editing"}
