...
<imageEmbed
  ...
  captionText={"Bad example - Presenters View in PowerPoint auto changes the screen mode to 'Extended'"}
...
<imageEmbed
  ...
  captionText={"Good example - Hardware capture lets you record exactly what you want, and is ready for editing"}
