...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Presenters View in PowerPoint auto changes the screen mode to 'Extended'"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Hardware capture lets you record exactly what you want, and is ready for editing"
