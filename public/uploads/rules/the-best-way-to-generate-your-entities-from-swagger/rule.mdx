...
<imageEmbed
  ...
  caption={"Good example - NSwag Studio lets you customise your nswag config"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - @JasonTaylorDev's Clean Architecture templace comes with this built in"}
