...
<imageEmbed
  ...
  figureText={"Good example - NSwag Studio lets you customise your nswag config"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="goodExample"
  figureText={"Good example - @JasonTaylorDev's Clean Architecture templace comes with this built in"}
