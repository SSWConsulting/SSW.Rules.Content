...
<imageEmbed
  ...
  figureText={"Bad example - Calling the Directory Object Picker dialog causes crash on x64 platform when using the bad code above"}
...
<imageEmbed
  ...
  figureText={"Good example - The Directory Object Picker dialog works on both x64 and x86 platforms well when using the good code above"}
