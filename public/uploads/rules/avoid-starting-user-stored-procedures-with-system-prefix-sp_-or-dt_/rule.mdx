...
created: 2019-11-12 22:38:15+00:00
...
seoDescription: Avoid naming user stored procedures with sp_ or dt_ prefixes to prevent
  SQL Server performance issues and conflicts with system stored procedures.
title: Stored Procedures - Do you avoid starting user stored procedures with system
  prefix "sp_" or "dt_"?
type: rule
