...
isArchived: false
lastUpdated: 2024-10-09 22:35:18+00:00
...
seoDescription: Create separate virtual directories in Reporting Services to improve
  security and manage public vs admin access effectively.
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Create a separate virtual directory for admin access"}
