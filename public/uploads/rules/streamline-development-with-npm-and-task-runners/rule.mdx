...
<imageEmbed
  ...
  figureText={"Example of NPM in action"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"In short they both perform the same job but Gulp is faster and requires less configuration"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"The updated feature list for Web Essentials 2015"}
