...
<imageEmbed
  ...
  captionText={"Example of NPM in action"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"In short they both perform the same job but Gulp is faster and requires less configuration"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"The updated feature list for Web Essentials 2015"}
