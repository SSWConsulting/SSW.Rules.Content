---
seoDescription: Automate cursor management on Windows applications and simplify your
  code with AutoWaitCursor, a class that sets and restores cursors according to application
  busy status.
type: rule
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Implemented AutoWaitCursor"
