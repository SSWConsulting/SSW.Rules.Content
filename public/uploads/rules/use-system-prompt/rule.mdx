...
lastUpdated: 2026-03-17T12:44:55.296Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="GPT's responses without a system prompt" src="/uploads/rules/use-system-prompt/without-system-prompt.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Responses with a system prompt" src="/uploads/rules/use-system-prompt/with-system-prompt.png" />
