---
seoDescription: Microsoft's open-source Semantic Kernel SDK simplifies AI integration
  by orchestrating services like OpenAI and Azure OpenAI.
type: rule
...
authors:
- author: jack-reimers
created: 2023-09-27 12:00:00+00:00
