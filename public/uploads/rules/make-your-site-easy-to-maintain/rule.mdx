...
The exception to this is if you are using open-source data. [SSW.People](https://www.ssw.com.au/people/) is a good example of this.
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure='"Edit" button on an Open Source page'
