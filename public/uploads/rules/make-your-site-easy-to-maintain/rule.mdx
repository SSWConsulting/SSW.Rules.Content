...
<imageEmbed
  ...
  captionText={"\"New\" and \"Edit\" links allow SSW Employees to maintain testimonial entries easily"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"\"Edit\" button on WordPress admin bar"}
...
<imageEmbed
  ...
  captionText={"Good Example - \"Edit\" button on an Open Source page"}
