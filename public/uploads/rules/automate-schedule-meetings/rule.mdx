...
seoDescription: Automate meeting scheduling effortlessly with AI-powered solutions
  like Outlook 365's Scheduling Poll and FindTime for faster, stress-free coordination
...
<imageEmbed
  ...
  figureText={"Voting options on Scheduling Poll"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"FindTime gives a nice UI for people working in the same org, as you can see times that might be available for all attendees easily (e.g. 8 am above)"}
