...
<imageEmbed
  ...
  caption={"Voting options on Scheduling Poll"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"FindTime gives a nice UI for people working in the same org, as you can see times that might be available for all attendees easily (e.g. 8 am above)"}
