...
lastUpdated: 2026-08-19T23:40:54.029Z
...
<boxEmbed
  body={<>
    This is when dealing with a client that you don’t really have the option to call them and tell them to fix the problem themselves - aka break the emails up or whatever and send a version 2 email
  </>}
  figurePrefix="none"
  figure=""
  style="tips"
