...
<boxEmbed
  body={<>
    This is when dealing with a client that you don’t really have the option to call them and tell them to fix the problem themselves - aka break the emails up and send a version 2 email
  </>}
  figurePrefix="none"
  figure=""
  style="tips"
