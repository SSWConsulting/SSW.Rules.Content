...
<imageEmbed
  alt="A frustrated developer reacting to a cryptic email on his laptop"
  size="medium"
  showBorder={true}
  figurePrefix="bad"
  figure="Bad example - A cryptic email leaves you confused and frustrated, when a quick call could clear it up"
  src="/uploads/rules/seek-clarification-via-phone/wtf-dev.png"
/>
