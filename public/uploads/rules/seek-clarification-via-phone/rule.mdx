...
Denise
  ...
  figureText={"Good example - Send this email and now move on to your tasks"}
/>
...
Denise
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - In case you can't reach the person who sent an unclear email"}
/>
