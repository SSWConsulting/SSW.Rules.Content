...
lastUpdated: 2026-07-27T00:12:04.048Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Add required reviewers" src="/uploads/rules/use-gated-deployments/add-required-reviewers.png" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Waiting for manual approval to deploy to Staging" src="/uploads/rules/use-gated-deployments/waiting-for-manual-approval.png" />
