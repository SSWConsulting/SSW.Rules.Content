...
<imageEmbed
  ...
  caption={"Add required reviewers"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Waiting for manual approval to deploy to Staging"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Manually approving a review before deploying to next environment"}
