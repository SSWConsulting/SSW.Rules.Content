...
lastUpdated: 2026-07-27T02:00:04.030Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Waiting for manual approval to deploy to Prod" src="/uploads/rules/use-gated-deployments/github-approval-gate.png" />
