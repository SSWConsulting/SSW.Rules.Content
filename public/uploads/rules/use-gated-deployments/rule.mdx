...
<imageEmbed
  ...
  figureText={"Add required reviewers"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Waiting for manual approval to deploy to Staging"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Manually approving a review before deploying to next environment"}
