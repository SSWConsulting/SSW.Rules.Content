...
<imageEmbed
  ...
  captionText={"Add required reviewers"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Waiting for manual approval to deploy to Staging"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Manually approving a review before deploying to next environment"}
