...
lastUpdated: 2026-07-27T01:37:45.399Z
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="none" figure="Waiting for manual approval to deploy to Staging" src="/uploads/rules/use-gated-deployments/github-approval-gate.png" />
...
Check out the for an example GitHub workflow with gated deployments.
