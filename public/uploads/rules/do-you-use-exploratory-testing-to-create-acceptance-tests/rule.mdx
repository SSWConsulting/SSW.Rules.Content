...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="Go to the Test tab, choose Do Exploratory Testing, choose a PBI, then click Explore. Too many steps"
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure='Right-click on a requirement in your test suite and choose "Explore requirement"'
