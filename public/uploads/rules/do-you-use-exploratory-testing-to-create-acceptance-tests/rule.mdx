...
<imageEmbed
  ...
  caption={"Bad example - Go to the Test tab, choose Do Exploratory Testing, choose a PBI, then click Explore. Too many steps"}
...
<imageEmbed
  ...
  caption={"Good example - Right-click on a requirement in your test suite and choose \"Explore requirement\""}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Clicking on the title will show you the Acceptance Criteria"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Creating a bug from exploratory test links to the PBI"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"You can change the repro steps captured in the bug very easily"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Click Save and create test to create a matching test case"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"The test steps are prepopulated from the action recording"}
