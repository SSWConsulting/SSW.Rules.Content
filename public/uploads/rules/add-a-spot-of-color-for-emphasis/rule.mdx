...
<imageEmbed
  ...
  figureText={"The TV signage has the important words in red"}
...
<imageEmbed
  ...
  figureText={"See bottom tagline - Don't make the important word “quality software” in red... because you already have red"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="goodExample"
  figureText={"See bottom tagline - Make the important word “quality software” in red... because you do not have red"}
...
<imageEmbed
  ...
  figureText={"Bad example - Text in green is too much"}
...
<imageEmbed
  ...
  showBorder={true}
  figurePreset="goodExample"
  figureText={"Good example - Text in content color (white in this dark mode example) with a green tick"}
