...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  caption={"The TV signage has the important words in red"}
...
<imageEmbed
  ...
  caption={"See bottom tagline - Don't make the important word “quality software” in red... because you already have red"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  caption={"See bottom tagline - Make the important word “quality software” in red... because you do not have red"}
...
<imageEmbed
  ...
  caption={"Bad example - Text in green is too much"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  caption={"Good example - Text in content color (white in this dark mode example) with a green tick"}
