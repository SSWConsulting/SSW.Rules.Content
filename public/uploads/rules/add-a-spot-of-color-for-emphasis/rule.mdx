...
lastUpdated: 2025-07-29T23:49:56.000Z
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="default"
  captionText={"The TV signage has the important words in red"}
...
<imageEmbed
  ...
  captionText={"See bottom tagline - Don't make the important word “quality software” in red... because you already have red"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"See bottom tagline - Make the important word “quality software” in red... because you do not have red"}
...
<imageEmbed
  ...
  captionText={"Bad example - Text in green is too much"}
...
<imageEmbed
  ...
  showBorder={true}
  captionStyle="goodExample"
  captionText={"Good example - Text in content color (white in this dark mode example) with a green tick"}
