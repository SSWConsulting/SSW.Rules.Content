---
type: rule
title: Do you know the best workflow for AI assisted development? (Vibe Coding one bite at a time)
...
lastUpdated: 2026-03-17T08:21:43.994Z
lastUpdatedBy: Gilles Pothieu
lastUpdatedByEmail: gillespothieu.pro@gmail.com
isArchived: false
---

“Vibe coding” means never even looking at - let alone editing - the code. This can be a bad idea, especially if you try one shotting an entire app.
...
It can be tempting to just "vibe" your way through a few features, but if you do not understand **what it does and why**, you are going to get into trouble if bugs start popping up.
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Vibe coding overcooked the solution" src="/uploads/rules/ai-assisted-development-workflow/goofy-ai-car.jpg" />
