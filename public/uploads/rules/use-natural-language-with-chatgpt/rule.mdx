...
<boxEmbed
  ...
  figureText={"Bad example - The prompt uses fragmented language and is difficult to understand."}
/>
...
<boxEmbed
  ...
  figureText={"Good example - The prompt is conversational, clear, and easy to understand."}
/>
