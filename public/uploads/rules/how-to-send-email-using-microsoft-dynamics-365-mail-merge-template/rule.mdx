...
<imageEmbed
  ...
  figureText={"Find your active marketing lists to send out an email blast with mail merge templates"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"selection of marketing list"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Selecting New Quick Campaigns"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Selecting Email as your activity type"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Searching for the template you want to use"}
