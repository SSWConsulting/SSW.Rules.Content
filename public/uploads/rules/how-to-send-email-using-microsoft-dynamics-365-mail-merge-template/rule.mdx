...
created: 2013-03-13 19:30:03+00:00
...
<imageEmbed
  ...
  captionText={"Find your active marketing lists to send out an email blast with mail merge templates"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"selection of marketing list"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Selecting New Quick Campaigns"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Selecting Email as your activity type"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Searching for the template you want to use"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Template selection"}
