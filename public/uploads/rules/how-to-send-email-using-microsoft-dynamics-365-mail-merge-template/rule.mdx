...
<imageEmbed
  ...
  caption={"Find your active marketing lists to send out an email blast with mail merge templates"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"selection of marketing list"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Selecting New Quick Campaigns"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Selecting Email as your activity type"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Searching for the template you want to use"}
