...
1. False certainty
The client gets a fixed number, but that number is based on incomplete knowledge.
...
2. Expensive change requests
Every change becomes a commercial discussion instead of a product decision.

3. Slower feedback
The team spends too long documenting and building before the client sees working software.

4. Scope protection over value delivery
The supplier is incentivised to defend the agreed scope rather than ask, “What gives the client the best outcome?”. This leads to shortcuts being made, which reduces the quality of the software produced.

5. Lower trust
When the real world changes, both sides can feel the other is being unreasonable.
