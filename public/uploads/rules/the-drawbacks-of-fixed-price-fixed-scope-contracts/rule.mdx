...
<imageEmbed
  ...
  figureText={"The cone of uncertainty in software cost and size estimation"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Although Waterfall fixes the scope, it then makes the resources and time variable. If you want to fix those, you need to vary the scope"}
