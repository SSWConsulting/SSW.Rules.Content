...
<imageEmbed
  ...
  caption={"Bad example - there is not enough information for anyone to complete this task"}
...
<imageEmbed
  ...
  caption={"Good example - Azure DevOps - Lots of information so anyone can pick up that task"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="goodExample"
  caption={"Good example - GitHub - Lots of information so anyone can pick up that task"}
