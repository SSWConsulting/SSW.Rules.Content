...
isArchived: false
lastUpdated: 2021-07-05 22:25:00.815000+00:00
...
<imageEmbed
  ...
  figureText={"To add an end screen, go to VIDEO MANAGER | Videos | (select your video) | End screens and Annotations | Add element"}
...
<imageEmbed
  ...
  figureText={"Good example: An example of an end screen featuring a Subscribe button (the SSW logo) and a playlist (which the video is from)"}
