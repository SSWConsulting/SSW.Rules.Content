...
<figureEmbed figureEmbed={ {
  preset: "goodExample",
  figure: "![Good example: An example of an end screen featuring a Subscribe button (the SSW logo) and a playlist (which the video is from)](/uploads/rules/do-you-add-end-screen-to-your-youtube-videos/end screen example.png)",
  shouldDisplay: true
} } />
