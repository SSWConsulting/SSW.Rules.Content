...
<boxEmbed
  ...
  figureText={"Bad example - Makes everyone pause and ask where you went"}
/>
...
<boxEmbed
  ...
  figureText={"OK example - It's good to communicate, but still stops the chat for a bit"}
/>
...
and then _"I’m back"_ when you return.
  ...
  figureText={"Good example - The call can continue smoothly and the team will know when you're back"}
/>
...
<boxEmbed
  ...
  figurePreset="okExampleExample"
  figureText={"OK example - The call can continue smoothly and no one will be guessing where you went"}
/>
...
<boxEmbed
  ...
  figurePreset="goodExampleExample"
  figureText={"Good example - The call can continue smoothly and people still have a chance to talk to you if they need"}
/>
