...
<imageEmbed
  ...
  caption={"Every morning developers check Application Insights for errors"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"Drilling down into an exception to discover more."}
...
<imageEmbed
  ...
  caption={"Bad example - creating all the bugs"}
...
<imageEmbed
  ...
  caption={"Good example - create the first bug (unfortunately bug has to be created manually)"}
