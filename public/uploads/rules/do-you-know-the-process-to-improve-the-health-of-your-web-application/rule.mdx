...
isArchived: false
lastUpdated: 2017-04-04 17:34:08+00:00
...
<imageEmbed
  ...
  figureText={"Every morning developers check Application Insights for errors"}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="default"
  figureText={"Drilling down into an exception to discover more."}
...
<imageEmbed
  ...
  figureText={"Bad example - creating all the bugs"}
...
<imageEmbed
  ...
  figureText={"Good example - create the first bug (unfortunately bug has to be created manually)"}
