...
<imageEmbed
  ...
  captionText={"Every morning developers check Application Insights for errors"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  captionText={"Drilling down into an exception to discover more."}
...
<imageEmbed
  ...
  captionText={"Bad example - creating all the bugs"}
...
<imageEmbed
  ...
  captionText={"Good example - create the first bug (unfortunately bug has to be created manually)"}
