...
created: 2024-03-18T18:11:34.000Z
...
<imageEmbed
  ...
  captionText={"Good example - Another form with the StatusBar that shows the time to load - very slow on dialup."}
...
<imageEmbed
  ...
  captionText={"Add StatusBarPanel to StatusBar"}
