---
seoDescription: Windows Forms application development should include a StatusBar to
  display the time taken to load the form, providing valuable insights for developers
  and users alike.
type: rule
...
authors:
- author: adam-cogan
created: 2014-03-14 05:45:00+00:00
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="Another form with the StatusBar that shows the time to load - very slow on dialup."
  src="/uploads/rules/do-your-windows-forms-have-a-statusbar-that-shows-the-time-to-load/doesntperformsowellwhenrunoveravpn2.jpg"
/>
...
<imageEmbed
  ...
  src="/uploads/rules/do-your-windows-forms-have-a-statusbar-that-shows-the-time-to-load/statusbarpanel.gif"
/>
