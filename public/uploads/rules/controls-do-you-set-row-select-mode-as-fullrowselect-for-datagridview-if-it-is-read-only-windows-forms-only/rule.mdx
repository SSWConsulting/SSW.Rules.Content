...
<imageEmbed
  ...
  src="/uploads/rules/controls-do-you-set-row-select-mode-as-fullrowselect-for-datagridview-if-it-is-read-only-windows-forms-only/../../assets/NoneFullRowSelect.gif"
/>
...
<imageEmbed
  ...
  src="/uploads/rules/controls-do-you-set-row-select-mode-as-fullrowselect-for-datagridview-if-it-is-read-only-windows-forms-only/../../assets/FullRowSelect.gif"
/>
...
<imageEmbed
  ...
  src="/uploads/rules/controls-do-you-set-row-select-mode-as-fullrowselect-for-datagridview-if-it-is-read-only-windows-forms-only/../../assets/setselectmodefull.gif"
/>
