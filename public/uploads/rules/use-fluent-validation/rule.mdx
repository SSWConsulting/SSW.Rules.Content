...
created: 2019-01-07 18:39:14+00:00
createdBy: Tiago Araujo
createdByEmail: TiagoAraujo@ssw.com.au
guid: 376bf9f4-c174-4582-936a-518899200084
isArchived: false
lastUpdated: 2020-10-23 02:48:39+00:00
lastUpdatedBy: Matt Goldman
lastUpdatedByEmail: MattGoldman@ssw.com.au
redirects:
- do-you-use-fluent-validation
seoDescription: Do you use Fluent Validation? Client-side validation provides a great
  user experience but must always be backed up by server-side validation. .NET and
  .NET Core Web APIs provide built-in support for validation using Data Annotations.
...
<imageEmbed
  ...
  captionText={"Client-side validation does not provide effective data security for your Web API endpoints"}
