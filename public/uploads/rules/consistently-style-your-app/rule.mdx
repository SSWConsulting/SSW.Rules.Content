...
<imageEmbed
  ...
  caption={"Bad Example - same styling defined and repeated multiple times"}
...
<imageEmbed
  ...
  caption={"Good Example - Styles defined once in resource dictionary and applied to controls"}
