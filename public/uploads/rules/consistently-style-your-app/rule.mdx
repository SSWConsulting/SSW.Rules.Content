...
<imageEmbed
  ...
  captionText={"Bad Example - same styling defined and repeated multiple times"}
...
<imageEmbed
  ...
  captionText={"Good Example - Styles defined once in resource dictionary and applied to controls"}
