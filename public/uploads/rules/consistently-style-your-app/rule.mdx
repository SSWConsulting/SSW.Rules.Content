...
<imageEmbed
  ...
  figureText={"Bad Example - same styling defined and repeated multiple times"}
...
<imageEmbed
  ...
  figureText={"Good Example - Styles defined once in resource dictionary and applied to controls"}
