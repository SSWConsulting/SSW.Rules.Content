...
<imageEmbed
  ...
  caption={"CRM | Company/Account Form – added Teams URL field"}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="default"
  caption={"PCF control allows you to add a button to create a Team"}
