...
<imageEmbed
  ...
  captionText={"Bad Example – no historical data for your test pass rates for previous milestones"}
...
<imageEmbed
  ...
  captionText={"Good Example -  Create test plans based on your testing goals for a specific Sprint"}
