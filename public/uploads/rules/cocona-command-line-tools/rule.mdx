...
created: 2025-01-03 00:00:00+00:00
createdBy: Chloe
createdByEmail: chloelin@ssw.com.au
lastUpdated: 2026-01-29 16:43:03.774000+00:00
lastUpdatedBy: Chloe
...
<boxEmbed
  style="info"
  body={<>
    **Tip:** Improve your CLI tool's UI with tools like [Colorful.Console](https://github.com/tomakita/Colorful.Console) for colored output, or [Spectre.Console](https://spectreconsole.net/) for rich terminal applications.
  </>}
  figurePrefix="none"
  figure=""
/>
