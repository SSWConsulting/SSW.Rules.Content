...
seoDescription: Learn how to create flight appointments in Outlook with essential
  tips on organizing details and inviting contacts.
...
<imageEmbed
  ...
  captionText={"Good Example - create two appointments for connecting flights."}
...
<imageEmbed
  ...
  captionText={"Bad Example - only one appointment for connecting flights that has two legs."}
