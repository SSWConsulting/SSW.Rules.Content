...
created: 2015-04-28 04:38:52+00:00
...
<imageEmbed
  ...
  figureText={"Good Example - create two appointments for connecting flights."}
...
<imageEmbed
  ...
  figureText={"Bad Example - only one appointment for connecting flights that has two legs."}
