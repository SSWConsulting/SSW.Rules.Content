...
**Product Owner**: Actually, the reason is because .NET 9 comes out in a few months and I want to wait for that version.
  ...
  captionText={"Good example - The Developer identified that the Product Owner had a different reason than they thought"}
/>
...
**Product Owner**: Sure!
  ...
  captionStyle="goodExample"
  captionText={"Good example - The Developer gives a warning to the Product Owner to check if they are in a moment where they are ready to listen to a dissenting opinion"}
/>
...
**Developer**: Well, when I read the .NET 8 release notes I saw they have improved performance by 20%. That's why I want to upgrade now.
  ...
  captionStyle="goodExample"
  captionText={"Good example - The Developer identified a pain point the Product Owner cares about, strengthens their argument"}
/>
...
**Developer**: No, we should upgrade to .NET 8 this Sprint because it will help fix users' performance issues.
  ...
  captionText={"Bad example - The Developer didn't express that it was their opinion"}
/>
...
**Developer**: In my opinion, it's better if we upgrade to .NET 8 this Sprint because it will help fix users' performance issues.
  ...
  captionStyle="goodExample"
  captionText={"Good example - The Developer mentions that it is their opinion leaving the topic open for discussion"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - The Developer made their point and it sounds like a personal attack"}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - The Developer identifies a pain point for the users, rather than making it emotion based"}
/>
...
<boxEmbed
  ...
  captionStyle="badExample"
  captionText={"Bad example - Doesn't leave the power in the stakeholders hands."}
/>
...
<boxEmbed
  ...
  captionStyle="goodExample"
  captionText={"Good example - Clearly expresses that the final decision is up to them"}
/>
