...
**Product Owner**: Actually, the reason is because .NET 11 comes out in a few months and I want to wait for that version.
  ...
  figurePrefix="good"
  figure="The Developer identified that the Product Owner had a different reason than they thought"
/>
...
**Product Owner**: Sure!
  ...
  figurePrefix="good"
  figure="The Developer gives a warning to the Product Owner to check if they are in a moment where they are ready to listen to a dissenting opinion"
/>
...
**Developer**: Well, when I read the .NET 10 release notes I saw they have improved performance by 20%. That's why I want to upgrade now.
  ...
  figurePrefix="good"
  figure="The Developer identified a pain point the Product Owner cares about, strengthens their argument"
/>
...
**Developer**: No, we should upgrade to .NET 10 this Sprint because it will help fix users' performance issues.
  ...
  figurePrefix="bad"
  figure="The Developer didn't express that it was their opinion"
/>
...
**Developer**: In my opinion, it's better if we upgrade to .NET 10 this Sprint because it will help fix users' performance issues.
  ...
  figurePrefix="good"
  figure="The Developer mentions that it is their opinion leaving the topic open for discussion"
/>
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="The Developer made their point and it sounds like a personal attack"
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="The Developer identifies a pain point for the users, rather than making it emotion based"
/>
...
<boxEmbed
  ...
  figurePrefix="bad"
  figure="Doesn't leave the power in the stakeholders hands."
/>
...
<boxEmbed
  ...
  figurePrefix="good"
  figure="Clearly expresses that the final decision is up to them"
/>
