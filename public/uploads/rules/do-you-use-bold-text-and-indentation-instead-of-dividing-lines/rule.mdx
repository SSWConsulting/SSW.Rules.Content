...
isArchived: false
lastUpdated: 2014-12-01 05:04:09+00:00
...
<imageEmbed
  ...
  figureText={"Bad Example - This is the Tools - Options from Internet Explorer and it groups each section in a groupbox - busy UI."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad Example - This is the Tools - Options from Outlook and it uses dividing lines for each section."}
...
<imageEmbed
  ...
  showBorder={false}
  figurePreset="badExample"
  figureText={"Bad Example - This is an old screen from Code Auditor - the dividing lines are not required."}
...
<imageEmbed
  ...
  figureText={"Good Example - This is the new screen from Code Auditor - the bold title and indenting are the best way to show the sections."}
