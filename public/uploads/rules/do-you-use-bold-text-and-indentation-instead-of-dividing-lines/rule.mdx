...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This is the Tools - Options from Internet Explorer and it groups each section in a groupbox - busy UI."
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This is the Tools - Options from Outlook and it uses dividing lines for each section."
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure="This is an old screen from Code Auditor - the dividing lines are not required."
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure="This is the new screen from Code Auditor - the bold title and indenting are the best way to show the sections."
