...
<imageEmbed
  ...
  caption={"Bad Example - This is the Tools - Options from Internet Explorer and it groups each section in a groupbox - busy UI."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad Example - This is the Tools - Options from Outlook and it uses dividing lines for each section."}
...
<imageEmbed
  ...
  showBorder={false}
  captionStyle="badExample"
  caption={"Bad Example - This is an old screen from Code Auditor - the dividing lines are not required."}
...
<imageEmbed
  ...
  caption={"Good Example - This is the new screen from Code Auditor - the bold title and indenting are the best way to show the sections."}
