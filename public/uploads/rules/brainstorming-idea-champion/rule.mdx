...
<imageEmbed
  ...
  captionText={"A Brainstorming \"Idea Champion\" ready to impart their wisdom upon us"}
...
<imageEmbed
  ...
  captionText={"Good example - Using labels to show how an idea is progressing"}
