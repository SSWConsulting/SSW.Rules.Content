---
seoDescription: Best practices dictate renaming "OK" buttons to action verbs like
  "Save," "Open," or others to improve user experience and clarity.
type: rule
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="bad"
  figure='"OK" button which is not an action'
...
<imageEmbed
  ...
  showBorder={false}
  figurePrefix="good"
  figure='"Save" button which is an action'
