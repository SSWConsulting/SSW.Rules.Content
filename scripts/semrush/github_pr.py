...
_PR_BODY_TEMPLATE = """\
Fixes duplicate `seoDescription` frontmatter on {file_count} /rules page(s) flagged by \
SEMrush Site Audit. Only frontmatter was modified — page body and all other fields are unchanged. \
New descriptions were generated by AI.
...
def commit_changes(repo_root: str, changed_files: list[str], commit_msg: str = None) -> bool:
    ...
    if commit_msg is None:
        commit_msg = (
            f"fix(seo): replace duplicate SEO fields [SEMrush audit]\n\n"
            f"Automatically generated by scripts/semrush/run_agent.py.\n"
